...
//return "SELECT wb_crop, wb_variety, wb_ups, wb_lotno, wb_nop, wb_qty, wb_totwt, wb_type FROM tbl_wbqrcode WHERE wb_linklogid='$scode' and wb_mpblinkflg!=1 and wb_mptype='$mptype' and wb_lotno='$wblotno' ";
	...
	public function GetRPSTrList($scode, $mobile1) {
		$plantcode = $this->getPlantcode($scode);
//return "SELECT  packaging_id, packaging_type, packaging_tdate, packaging_tcode, packaging_slipno,  packaging_crop, packaging_variety, packaging_lotno, packaging_upssize, packaging_remarks, packaging_mptype  FROM tbl_rpspackaging WHERE packaging_tflg=2 and packaging_wbactflag=0 and plantcode='$plantcode' ORDER BY packaging_id ASC";
