...
//	private $conn_vnr;
	...
	public function GetTrList($scode, $mobile1) {
		$plantcode = $this->getPlantcode($scode);
//return "SELECT pnpslipmain_id, pnpslipmain_date, pnpslipmain_crop, pnpslipmain_variety, pnpslipmain_promachcode, pnpslipmain_proopr, pnpslipmain_treattype, pnpslipmain_ttype FROM tbl_pnpslipmain WHERE pnpslipmain_tflag=2 and pnpslipmain_trtype='wb' AND plantcode='$plantcode' ORDER BY pnpslipmain_id ASC";
        ...
        if ($stmt->num_rows > 0) {
			...
			$userSR["crop"] = $pnpslipmain_crop;
			$userSR["variety"] = $pnpslipmain_variety;
			$userSR["promachcode"] = $pnpslipmain_promachcode;
			$userSR["trtype"] = $trtyp;
			
			$pnpslipsub_lotno=''; $pnpslipsub_pickpqty=''; $pnpslipsub_ups=''; $pnpslipsub_wtmp=''; $pnpslipsub_nop=''; $pnpslipsub_wbnop=''; $pnpslipsub_wbwt='';  $pnpslipsub_wbinmp='';
