...
//echo "select * from tbl_subbin where sid='".$a."'";
...
if($tpmflg==0)
{
	...
	{
		$tpmflg=1;
		$existview="Seeds Stage not matching";
	}
	else
	{ 
		$tpmflg=0;
...
<td width="50%" align="center"  valign="middle" class="smalltbltext"><input name="<?php echo $id;?>" id="<?php echo $qid;?>" type="text" size="8" class="smalltbltext" tabindex="" maxlength="10"   value=""  onchange="<?php echo $q;?>"  onkeypress="return isNumberKey1(event)" />&nbsp;<font color="#FF0000">* </font>&nbsp;</td>
</tr></table><?php }?>