	...
	if(isset($_POST['frm_action'])=='submit')
	{
		...
		if (($handle = fopen($filepath, "r")) !== FALSE) 
		{
			while (($data = fgetcsv($handle, 1000, ",")) !== FALSE) 
			{
				...
				if($row>2)
				{
					$strdublicate=mysqli_query($link,"select * from tblvariety where popularname='".$data[2]."' ");
					$numofrecords=mysqli_num_rows($strdublicate);
					if($numofrecords > 0)
					{	
						$str="Update tblvariety SET opt='".$data[5]."', gsdis='".$data[7]."', expdt='".$data[9]."', expdtt='".$data[11]."', leduration='".$data[19]."' where  popularname='".trim($data[2])."'";
		...
		?>	
		<script>
			alert('Varieties updated successfully');
		...
		?>
		<script>
			alert('Varieties updated Unsuccessfull. Please Check the Excel file and try again.');
			window.location='index1.php';
		</script>
		<?php
		}
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#2e81c1" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#2e81c1" style="border-bottom:solid; border-bottom-color:#2e81c1" >
	    <tr >
	      <td width="813" height="25" class="Mainheading">&nbsp;Utility - Update Varieties </td>
	    </tr></table></td>
	    	 </tr>
	  </table></td></tr>
...
<tr class="tblsubtitle" height="25">
  <td colspan="4" align="center" class="tblheading"Update Varieties </td>
</tr>
<tr height="15">
    <td colspan="4" align="right" class="tblheading"><font color="#FF0000" >* </font>indicates required field&nbsp;</td>
  </tr>
<tr class="Dark" height="25">
<td width="206"  align="right"  valign="middle" class="tblheading">Update Varieties&nbsp;</td>
