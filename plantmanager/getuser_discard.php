...
$flag=0; 
//echo $a;
$sql_month=mysqli_query($link,"select items_id, stores_item from tbl_stores where classification_id='$a' and plantcode='$plantcode'")or die("Error:".mysqli_error($link));
