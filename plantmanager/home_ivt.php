...
$sql_tbl=mysqli_query($link,"select * from tbl_ivtmain where ivt_logid='".$logid."' and ivt_tflg=0 and plantcode='$plantcode'") or die(mysqli_error($link));
...
<title>Plant -  Transaction - Lot Merger - Home</title>
...
cellpadding="0">
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#2e81c1" >
	  ...
	  <td width="801" class="Mainheading" height="25"><table width="809" border="0" cellpadding="0" cellspacing="0" bordercolor="#2e81c1" style="border-bottom:solid; border-bottom-color:#2e81c1" >
        <tr >
...
$targetpage = $_SERVER['PHP_SELF']; 
  ...
  $sql_arr_home=mysqli_query($link,"select * from tbl_ivtmain where ivt_tflg=1 and plantcode='$plantcode' order by ivt_date desc,ivt_code desc LIMIT $start, $limit") or die(mysqli_error($link));
...
$query = "select * from tbl_ivtmain where ivt_tflg=1 and plantcode='$plantcode' order by ivt_date desc,ivt_code desc";
