...
{	 
	...
	$sql_arr_home=mysqli_query($link,"select * from tbl_softr where softr_date <= '$edate' and softr_date >= '$sdate' and softr_crop='".$itemid."' and softr_variety='".$vv."' and softr_tflg=1 and plantcode='$plantcode' order by softr_date asc ") or die(mysqli_error($link));
}
else
{		
		$tdate=$ddate;
	...
	$sql_arr_home=mysqli_query($link,"select * from tbl_softr where softr_date <= '$ddate' and softr_crop='".$itemid."' and softr_variety='".$vv."' and softr_tflg=1 and plantcode='$plantcode' order by softr_date asc ") or die(mysqli_error($link));
}
...
if($sftyp=="periodical")
{	
	$sql_tbl_sub=mysqli_query($link,"select * from tbl_softr_sub where softr_id='".$arrival_id."' and plantcode='$plantcode'") or die(mysqli_error($link));
}
else
{
