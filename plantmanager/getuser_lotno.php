...
$sss="";
$qr="select distinct(lotldg_lotno) from tbl_lot_ldg where lotldg_crop='".$crop."' and lotldg_variety='".$variety."' and lotldg_sstage!='".$tp."' and lotldg_balqty > 0 $sss and plantcode='$plantcode' order by lotldg_id desc";
