<?php
	...
	$txtplant = $_REQUEST['txtplant'];	
		if($sdate!="" && $edate!="")
		{
		echo "<script>window.location='preport_plant1.php?sdate=$sdate&edate=$edate&txtcrop=$cid&txtvariety=$itemid&txtvisualck=$typ&txtplant=$txtplant'</script>";
		}
		else
		 {?>
		 <script>
...
<td width="297" align="left"  valign="middle" class="tbltext" colspan="3" >&nbsp;<select class="tbltext" name="txtplant" style="width:170px;" >
	<option value="ALL" selected>ALL</option>
