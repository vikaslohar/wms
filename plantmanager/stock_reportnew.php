<?php
	...
	$sql_rep="Delete from tmp_pmstrep where replogid='$logid'";
	...
	if(isset($_POST['frm_action'])=='submit')
	{
		...
		echo "<script>window.location='stock_reportnew1.php?slchk=$slchk&slchk2=$slchk2&txtcrop=$cid&txtvariety=$itemid&sdate=$sdate&txtplant=$txtplant'</script>";
	}
?>
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#2e81c1" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#2e81c1" style="border-bottom:solid; border-bottom-color:#2e81c1" >
	    <tr >
	      <td width="813" height="30"class="Mainheading"  >Stock Report As on - <?php echo date("d-m-Y H:i:s"); ?></td>
	    </tr></table></td>
	  </tr>
	  </table></td></tr>
	  ...
	  <input type="hidden" name="slck" value="no" />
	   ...
	   <input type="hidden" name="txtplant" value="ALL" />
          ...
          <tr>
            ...
            <td><table align="center" border="1" width="600" cellspacing="0" cellpadding="0" bordercolor="#2e81c1" style="border-collapse:collapse" >
                <tr class="tblsubtitle" height="25">
                  <td colspan="2" align="center" class="tblheading">Stock Report As on Date</td>
                </tr>
                <tr height="15">
...
?>
                 <tr class="Dark" height="25">
                  <td width="26%" height="30" align="right" valign="middle" class="tblheading">&nbsp;As on Date&nbsp;</td>
...
<!--
<tr class="Light" height="25">
<td width="297" align="right"  valign="middle" class="tblheading">Plant&nbsp;</td>
<td width="297" align="left"  valign="middle" class="tbltext" >&nbsp;<select class="tbltext" name="txtplant" style="width:170px;" >
	<option value="ALL" selected>ALL</option>
