<?php
	...
	$sql_code="SELECT MAX(ivt_tcode) FROM tbl_ivtmain  where ivt_yearid='$yearid_id' and plantcode='$plantcode' ORDER BY ivt_tcode DESC";
...
<title>Plant -Transaction - Add IVT</title>
...
<table width="1003" height="600" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#2e81c1" >
	  ...
	  <table width="950" border="0" cellpadding="0" cellspacing="0" bordercolor="#2e81c1" style="border-bottom:solid; border-bottom-color:#2e81c1" >
	    <tr >
