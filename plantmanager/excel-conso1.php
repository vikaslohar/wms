<?php
	...
	$dh="Consolidated_Arrival ".$typ1."_From_".$_REQUEST['sdate'];
	$datahead = array($dh);
...
function cleanData(&$str)
	 ...
	 $datatitle3 = array("#","Crop","Variety","Stage","Total Qty","Qty:GOT-R","Qty:GOT-NR");
...
{
$data1[$d]=array($d,$crpname,$variety,$stage,$sqty,$gotrq,$gotnrq); 
$d++;
}
}
}
