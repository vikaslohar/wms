...
<title>Plant -  Transazction - Discard Home</title>
...
$sql_arr_home=mysqli_query($link,"select * from tbl_discard where tdate between '$tdate' and '$pdate' and ddflg=1 and plantcode='$plantcode' order by yearcode desc, dd_code desc LIMIT $from, $max_results") or die(mysqli_error($link));
$tot_arr_home=mysqli_num_rows($sql_arr_home);

$total_results3 =mysqli_query($link,"SELECT COUNT(*)  FROM tbl_discard where tdate between '$tdate' and '$pdate' and ddflg=1 and plantcode='$plantcode'");
...
<tr class="Light">
         ...
         <td width="13%" align="center" valign="middle" class="tblheading"><a href="add_discard_str_view.php?p_id=<?php echo $row_arr_home['tid'];?>"><?php echo "MD".$row_arr_home['dd_code']."/".$row_arr_home['yearcode']."/".$drole;?></a></td>
		 <td width="13%" align="center" valign="middle" class="tblheading"><?php echo $trdate;?></td>
         <td width="37%" align="center" valign="middle" class="tblheading"><?php echo $row_arr_home['party_name'];?></td>
         <td width="16%" align="center" valign="middle" class="tblheading"><?php echo $row_arr_home['drno']?></td>
         <td width="17%" align="center" valign="middle" class="tblheading"><a href="Javascript:void(0)" onClick="openslocpopprint('<?php echo $row_arr_home['tid'];?>');">MDN</a> | <a href="Javascript:void(0)" onClick="openslocpopprint1('<?php echo $row_arr_home['tid'];?>');">Gate Pass</a></td>
</tr>
<?php
}
else
...
{
?>
<table align="center" border="1" cellspacing="0" cellpadding="0" width="600" bordercolor="#ffffff" style="border-collapse:collapse">
