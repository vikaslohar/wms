	  ...
	  $sql_in="update tblopr set login='$login',
		...
		mysqli_query($link,$sql_in)or die(mysqli_error($link));
         ...
         $sql_in1="Update tbluser set	loginid='$login',
										password='$pass',
										email='$email'
										where role='plantmanager' and scode='$scode'";	
...
<title>Plant- Transaction-operator Profile</title>
...
<!-- actual page start--->	
 ...
 <?php
	...
	?>
	 ...
	 <input type="hidden" name="scode" value="<?php echo "PM".$row['code'];?>">
...
<table align="center" border="0" width="650" cellspacing="0" cellpadding="0" bordercolor="#2e81c1"
 style="border-collapse:collapse" > <tr><td>
<table width="700" border="1" cellspacing="0" cellpadding="0" align="center"  bordercolor="#2e81c1"
