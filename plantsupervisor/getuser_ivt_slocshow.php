...
$sql_month24=mysqli_query($link,"SELECT max(SUBSTRING(ivts_nlotno,15,2)) FROM tbl_ivtsub where SUBSTRING(ivts_nlotno,1,13)='$abc' and plantcode='$plantcode'")or die("Error:".mysqli_error($link));
$row_month24=mysqli_fetch_array($sql_month24);
//echo $row_month24[0];
$abc2=0;
if($row_month[0]>$row_month23[0] && $row_month[0]>$row_month24[0])
$abc2=$row_month[0];
else if($row_month[0]<$row_month23[0] && $row_month23[0]>$row_month24[0])
$abc2=$row_month23[0];
else if($row_month[0]<$row_month24[0] && $row_month24[0]>$row_month23[0])
$abc2=$row_month24[0];
else
$abc2=$row_month[0];
//echo $abc2;
...
$abc240=$zzz[0].$zzz[2].$zzz[4].$zzz[6].$zzz[8].$zzz[10].$zzz[12].$zzz[14].$zzz[16].$zzz[18].$zzz[20].$zzz[22].$zzz[24].$zzz[26].$abc2;
...
$sql_issue24=mysqli_query($link,"select distinct lotldg_subbinid, lotldg_whid, lotldg_binid from tbl_lot_ldg where lotldg_crop='".$a."' and lotldg_variety='".$b."' and lotldg_sstage='Condition' and lotldg_lotno='".$f."' and lotldg_qc!='Fail' and lotldg_got!='Fail' and plantcode='$plantcode'") or die(mysqli_error($link));
 while($row_issue24=mysqli_fetch_array($sql_issue24))
 { 

$sql_issue=mysqli_query($link,"select max(lotldg_id) from tbl_lot_ldg where lotldg_subbinid='".$row_issue24['lotldg_subbinid']."' and lotldg_binid='".$row_issue24['lotldg_binid']."' and lotldg_whid='".$row_issue24['lotldg_whid']."' and lotldg_crop='".$a."' and lotldg_variety='".$b."' and lotldg_sstage='Condition' and lotldg_lotno='".$f."' and lotldg_qc!='Fail' and lotldg_got!='Fail' and plantcode='$plantcode'") or die(mysqli_error($link));
$trtr=mysqli_num_rows($sql_issue);
$row_issue=mysqli_fetch_array($sql_issue);

$sql_issue1=mysqli_query($link,"select * from tbl_lot_ldg where lotldg_id='".$row_issue[0]."' and lotldg_variety='".$b."' and lotldg_lotno='".$f."' and plantcode='$plantcode'") or die(mysqli_error($link));
...
<td align="center" valign="middle" class="tbltext"><?php echo $f;?></td>
...
<td align="center" valign="middle" class="smalltbltext"><input type="checkbox" name="srfet" id="srfet" value="<?php echo $srflg?>" <?php if($srflg==0) echo "disabled";?> /><input type="hidden" name="srtyp" value="<?php echo $srtyp?>" /><input type="hidden" name="srflg" value="<?php echo $srflg?>" /></td>
<td width="52" align="center" valign="middle" class="smalltblheading"><input type="radio" name="paceptyp" id="paceptyp" value="E" onclick="pcksel(this.value);" /></td>
	<td width="52" align="center" valign="middle" class="smalltblheading"><input type="radio" name="paceptyp" id="paceptyp" value="P" onclick="pcksel(this.value);"  /></td>
	<td width="146" align="center" valign="middle" class="smalltblheading"><input type="text" name="txtplotno" id="txtplotno" class="smalltbltext" value="<?php echo $abc24;?>" size="16" readonly="true" style="background-color:#CCCCCC" /></td>
</tr>
</table>
<br />
...
$sql_issue=mysqli_query($link,"select distinct lotldg_subbinid, lotldg_whid, lotldg_binid from tbl_lot_ldg where lotldg_lotno='".$f."'  and lotldg_sstage='Condition' and plantcode='$plantcode'") or die(mysqli_error($link));

 while($row_issue=mysqli_fetch_array($sql_issue))
 { 

$sql_issue1=mysqli_query($link,"select max(lotldg_id) from tbl_lot_ldg where lotldg_subbinid='".$row_issue['lotldg_subbinid']."' and lotldg_binid='".$row_issue['lotldg_binid']."' and lotldg_whid='".$row_issue['lotldg_whid']."' and lotldg_lotno='".$f."' and lotldg_sstage='Condition' and plantcode='$plantcode'") or die(mysqli_error($link));
$row_issue1=mysqli_fetch_array($sql_issue1); 
...
$sql_issuetbl=mysqli_query($link,"select * from tbl_lot_ldg where lotldg_id='".$row_issue1[0]."' and lotldg_balqty > 0 and plantcode='$plantcode'") or die(mysqli_error($link)); 
 ...
 { $srno2++;$tqty=0; $tnob=0; 
 //echo $row_issue['lotldg_subbinid']." = ".$row_issuetbl['lotldg_balqty']."<br/>";
...
$tqty=$difq1;
  ...
  <td width="56" align="center" valign="middle" class="smalltblheading" ><?php echo $wareh?></td>
	...
	<td width="54" align="center" valign="middle" class="smalltblheading"><input type="text" name="txttrnob<?php echo $srno2?>" id="txttrnob<?php echo $srno2?>" class="smalltbltext" value="" size="6" readonly="true" style="background-color:#CCCCCC" onkeypress="return isNumberKey(event)" onchange="nobchk(this.value,'<?php echo $srno2?>');" /></td>
   <td width="61" align="center" valign="middle" class="smalltblheading" ><input type="text" name="txttrqty<?php echo $srno2?>" id="txttrqty<?php echo $srno2?>" class="smalltbltext" value="" size="9" readonly="true" style="background-color:#CCCCCC" onkeypress="return isNumberKey1(event)" onchange="qtychk(this.value,'<?php echo $srno2?>');" /></td>
    <td width="78" align="center" valign="middle" class="smalltblheading"><input type="text" name="txtbalnob<?php echo $srno2?>" id="txtbalnob<?php echo $srno2?>" class="smalltbltext" value="" size="6" readonly="true" style="background-color:#CCCCCC" /></td>
	<td width="112" align="center" valign="middle" class="smalltblheading"><input type="text" name="txtbalqty<?php echo $srno2?>" id="txtbalqty<?php echo $srno2?>" class="smalltbltext" value="" size="9" readonly="true" style="background-color:#CCCCCC" /></td>
  </tr>
  <?php
  }
}
?> 
<input type="hidden" name="srno" value="<?php echo $srno;?>" /> <input type="hidden" name="chkbox" value=""/> <input type="hidden" name="srno1" value="<?php echo $srno-1;?>"/><input type="hidden" name="srno2" value="<?php echo $srno2;?>" />
</table>
<br />
<div id="extsloc"></div>
...
<table align="center" border="1" width="950" cellspacing="0" cellpadding="0" bordercolor="#2e81c1" style="border-collapse:collapse" >	
  <tr class="tblsubtitle" height="25">
    <td  align="center" valign="middle" class="tblheading" >&nbsp;IVT Lot SLOC</td>
  </tr>
</table>
