...
<title>Plant - Transaction - Sloc details</title>
...
?>			  
 <tr class="Light" height="20">
			 ...
			 <td width="127" align="center" valign="middle" class="tblheading"><?php echo $row_tbl['lotldg_lotno'];?></td>
			 ...
			 <td align="center" valign="middle" class="tblheading"><?php if($row_tbl_sub['lotldg_moisture']>0) echo $row_tbl_sub['lotldg_moisture'];?></td>
 		<!--/*   /*  <td width="7%" align="center" valign="middle" class="tblheading"><?php echo $row_tbl_sub['lotldg_gemp'];?></td>*/*/-->
             ...
             <td width="95" align="center" valign="middle" class="tblheading"><?php echo $row_tbl_sub['lotldg_got1'];?></td>
