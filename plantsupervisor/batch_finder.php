...
<title>Packaging - Utility - Batch Number Finder</title>
<link href="../include/vnrtrac_plantm.css" rel="stylesheet" type="text/css" />
<script src="utilbatchno.js"></script>
...
function chkvalidity(valval)
{
	...
	{
		if(valval=="E")
		document.from.txtbatchno.value=document.from.lotnmo.value;
		else if(valval=="P")
		document.from.txtbatchno.value=document.from.lotnmb.value;
		else
		document.from.txtbatchno.value="";
	}
	else
	{
		document.from.txtbatchno.value="";
...
<tr class="tblsubtitle" height="20">
  <td colspan="4" align="center" class="tblheading">Batch Number Finder</td>
</tr>
</table>
<table align="center" border="1" width="700" cellspacing="0" cellpadding="0" bordercolor="#2e81c1" style="border-collapse:collapse" > 
