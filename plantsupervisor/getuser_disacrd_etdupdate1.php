...
for($num=0; $num<$numrec; $num++)
{
	$p1_array[$num];
	$p1_array1[$num];
$sql_itmldg=mysqli_query($link,"select stld_balups, stld_balqty, stld_id, stld_whid, stld_binid, stld_subbinid from tbl_stldg_damage where stld_id='".$p1_array[$num]."' and plantcode='$plantcode'") or die(mysqli_error($link));
