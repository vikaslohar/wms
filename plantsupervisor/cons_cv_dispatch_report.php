<?php
	...
	if(isset($_POST['frm_action'])=='submit')
	{
		...
		if($sdate!="")
		{
			echo "<script>window.location='cons_cv_dispatch_report1.php?sdate=$sdate&edate=$edate&txtcrop=$txtcrop&txtvariety=$txtvariety&txtupsdc=$txtupsdc'</script>";
		}
		else
		{
		?>
...
<table align="center" border="1" width="750" cellspacing="0" cellpadding="0" bordercolor="#2e81c1" style="border-collapse:collapse" >
                <tr class="tblsubtitle" height="25">
                  <td colspan="4" align="center" class="tblheading" >Consolidated Crop Variety Wise Dispatch Report</td>
                </tr>
                <tr height="15">
...
?>				
    ...
    <td align="left"  valign="middle" class="smalltbltext" id="vitem2" colspan="3">&nbsp;<select class="smalltbltext" id="upsdc" name="txtupsdc" style="width:120px;" >
<option value="ALL" selected>--ALL--</option>
