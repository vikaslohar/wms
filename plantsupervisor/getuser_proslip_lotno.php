...
<title>Plant- Transaction-Status Reserve</title>
...
{	
	...
	window.location='getuser_proslip_lotno.php?crop='+val3+'&variety='+val4+'&sqq='+txtlot1;
	return true;	
	}
}	
...
$sss="";
$qr="select distinct(orlot) from tbl_lot_ldg where lotldg_crop='".$crop."' and lotldg_variety='".$variety."' and (lotldg_qc='Fail' or lotldg_got='Fail') and lotldg_balqty > 0 $sss and plantcode='$plantcode'";
