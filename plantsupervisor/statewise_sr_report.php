<?php
	...
	if(isset($_POST['frm_action'])=='submit')
	{
		...
		if($txtupstype=="Yes")
		{
		echo "<script>window.location='statewise_sr_report11.php?sdate=$sdate&edate=$edate&txtcrop=$crop&txtvariety=$veriety&txtptype=$txtptype&txtpp=$txtpp&txtstatesl=$txtstatesl'</script>";	
		}
		else
		{
		echo "<script>window.location='statewise_sr_report1.php?sdate=$sdate&edate=$edate&txtcrop=$crop&txtvariety=$veriety&txtptype=$txtptype&txtpp=$txtpp&txtstatesl=$txtstatesl'</script>";	
		}
	}
