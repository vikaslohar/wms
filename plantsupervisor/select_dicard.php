<?php
	...
	$sql_code="SELECT MAX(arr_code) FROM tblarrival where arrival_type='Internalreturn' and plantcode='$plantcode' ORDER BY arr_code DESC";
...
if($printopt == "1" )
{
	echo "<script>window.location='material_discard_note.php?p_id=$pid'</script>";	
}
if($printopt=="2")
{
echo "<script>window.location='gatepass.php?p_id=$pid&tp=Internalreturn'</script>";}
...
<title>Plant - Transction-Add Damage</title>
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#2e81c1" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#2e81c1" style="border-bottom:solid; border-bottom-color:#2e81c1" >
	    <tr >
	      <td width="813" height="25" class="Mainheading">&nbsp;Transaction - Select Material Discard Note </td>
	    </tr></table></td>
...
<table align="center" border="1" width="314" cellspacing="0" cellpadding="0" bordercolor="#2e81c1" style="border-collapse:collapse" > 

<tr class="tblsubtitle" height="25">
  <td colspan="4" align="center" class="tblheading">Select Material Discard <span class="Mainheading"> </span></td>
</tr>
<tr class="Light" height="25">
<td width="85"  align="right"  valign="left" class="tbltext">&nbsp;
  <input type="radio" name="fet" value="1" onClick="test1(this.value);" /></td>
    <td width="223" align="left"  valign="middle" class="tblheading">&nbsp;Material Discard  Note </td>
</tr>
 <tr class="Light" height="25">
