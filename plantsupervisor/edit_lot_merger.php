<?php
	...
	//exit;	
		$sql_ins="Update tbl_mergermain set mergerm_crop='$txtclass', mergerm_variety='$txtitem', mergerm_newlot='$txtlotnumber', mergerm_stage='$txtstage', mergerm_nob='$totalmnob', mergerm_qty='$totalmqty', mergerm_orlot='$orlot', mergerm_oldlot='$txtnlottom', mergerm_remarks='$remarks' where mergerm_id='$pid'";
...
<tr class="Dark" height="25">
           ...
           <td width="214"  align="left" valign="middle" class="tbltext">&nbsp;<?php echo "TLM".$row['mergerm_tcode']."/".$yearid_id."/".$lgnid;?></td>
...
<td align="left" valign="middle" class="tbltext">&nbsp;<input type="text" name="txtnlottom" class="tbltext" size="1" maxlength="2" value="<?php echo $row['mergerm_oldlot'];?>" onchange="chkstate(this.value);" />&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
...
<td align="center" valign="middle" class="tblheading" style="display:none"><input type="checkbox" checked="checked" id="slocissue<?php echo $srno;?>" name="slocissue" value="<?php echo $row_eindent_sub['mergers_lotno'];?>" onclick="checkchk('<?php echo $srno;?>')" /></td>
<td align="center" valign="middle" class="tblheading"><input type="hidden" id="lotno_<?php echo $srno;?>" name="lotno_<?php echo $srno;?>" value="<?php echo $row_eindent_sub['mergers_lotno'];?>" /><?php echo $row_eindent_sub['mergers_lotno'];?></td>
<td align="center" valign="middle" class="tblheading"><input type="hidden" id="qcst_<?php echo $srno;?>" name="qcst_<?php echo $srno;?>" readonly="true" style="background-color:#CCCCCC" value="<?php echo $row_eindent_sub['qcstatus'];?>" size="10" /><?php echo $row_eindent_sub['qcstatus'];?></td>
<td align="center" valign="middle" class="tblheading"><input type="hidden" id="gotst_<?php echo $srno;?>" name="gotst_<?php echo $srno;?>" readonly="true" style="background-color:#CCCCCC" value="<?php echo $row_eindent_sub['gotstatus'];?>" size="10" /><?php echo $row_eindent_sub['gotstatus'];?></td>
<td align="center" valign="middle" class="tblheading"><input type="hidden" id="srst_<?php echo $srno;?>" name="srst_<?php echo $srno;?>" readonly="true" style="background-color:#CCCCCC" value="<?php echo $row_eindent_sub['srstatus'];?>" size="10" /><?php echo $row_eindent_sub['srstatus'];?></td>
<td align="center" valign="middle" class="tblheading"><input type="text" id="upsavl_<?php echo $srno;?>" name="upsavl_<?php echo $srno;?>" readonly="true" style="background-color:#CCCCCC" value="<?php echo $row_eindent_sub['mergers_nob'];?>" size="9" /></td>
<td align="center" valign="middle" class="tblheading"><input type="text" id="qtyavl_<?php echo $srno;?>" name="qtyavl_<?php echo $srno;?>" readonly="true" style="background-color:#CCCCCC" value="<?php echo $row_eindent_sub['mergers_qty'];?>" size="9" /></td>
 </tr>
 <?php
 }
 else
...
<td align="center" valign="middle" class="tblheading" colspan="3">&nbsp;</td>
<td align="center" valign="middle" class="tblheading"><input name="totalmnob" id="totalmnob" class="tbltext" value="<?php echo $rtotalups;?>" readonly="true" style="background-color:#CCCCCC" size="9" /></td>
<td align="center" valign="middle" class="tblheading"><input name="totalmqty" id="totalmqty" class="tbltext" value="<?php echo $rtotalqty;?>" readonly="true" style="background-color:#CCCCCC" size="9" /></td>
 </tr>
</table>
