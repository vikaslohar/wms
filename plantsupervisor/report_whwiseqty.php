<?php
	...
	if(isset($_POST['frm_action'])=='submit')
	{
		...
		echo "<script>window.location='report_whwiseqty1.php?txtslwhg=$txtslwhg&txtcrop=$txtcrop&txtvariety=$txtvariety&txtstage=$txtstage'</script>";
	}
?>
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#2e81c1" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#2e81c1" style="border-bottom:solid; border-bottom-color:#2e81c1" >
	    <tr >
	      <td width="813" height="30"class="Mainheading"  >Warehouse wise Quantity Report</td>
	    </tr></table></td>
	  </tr>
	  </table></td></tr>
...
<tr class="tblsubtitle" height="25">
	<td colspan="2" align="center" class="tblheading">Warehouse wise Quantity Report</td>
</tr>
<tr height="15">
...
<tr class="Dark" height="25">
    ...
    <td align="left"  valign="middle" class="tbltext" id="vitem">&nbsp;<select class="tbltext" id="txtvariety" name="txtvariety" style="width:180px;" >
<option value="ALL" selected>--ALL--</option>
</select>&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
</tr>
<tr class="Dark" height="25">
