<?php
	...
	if(isset($_POST['frm_action'])=='submit')
	{
		...
		if($df!=""){ if($d!=""){$ststus=$df."/".$d; } else { $ststus=$df;} } else { $ststus=$d; }
		if($d=="") $ss=0; else $ss=1;
	 	$sql_main="update tbl_lot_ldg set lotldg_sstatus='$ststus', lotldg_resverstatus='$ss', lotldg_revcomment='$txtremarks'  where lotldg_lotno = '$c'";
  		//exit;
...
*/		  if(document.frmaddDepartment.sstatus.checked == true)
			{
				if(document.frmaddDepartment.foccode.value =="")
				{
				document.frmaddDepartment.foccode.value=document.frmaddDepartment.sstatus.value;
				//document.from.foccode1.value=document.from.sstatus[i].value;
				}
				else
				{
				document.frmaddDepartment.foccode.value = document.frmaddDepartment.foccode.value +'/'+document.frmaddDepartment.sstatus.value;
...
var f=0;
	...
	if(document.frmaddDepartment.foccode.value!="")
	{
		...
		{
			alert("Please enter Reserve Remarks");
			f=1;
			return false;
		} 
	}
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#2e81c1" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#2e81c1" style="border-bottom:solid; border-bottom-color:#2e81c1" >
	    <tr >
	      <td width="813" height="25" class="Mainheading">&nbsp;Transaction - Lot Reserve</td>
	    </tr></table></td>
