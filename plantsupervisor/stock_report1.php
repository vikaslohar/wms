<?php
    ...
    $servername = "192.168.3.18";
    $username = "itadmin";
    $password = "user@2022";

    // Create connection
    $conn = new mysqli($servername, $username, $password, "seedtracwms_hyd");
    ...
    if ($result->num_rows > 0) {
        ...
        while($row = $result->fetch_assoc()) {
            print_r($row); // or use echo $row['column_name'];
        }
    } else {
        echo "0 results";
    }
	...
	/*$connnew = mysqli_connect("192.168.3.18","itadmin","user@2022");
	if (!$connnew) {
	 echo "Not Connected";
	}
	else {
