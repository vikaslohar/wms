...
{
winHandle=window.open('merger_note.php?itmid='+subid,'WelCome','top=20, left=50, width=850, height=850, scrollbars=yes');
if(winHandle==null){
alert("While Launching New Window...\nYour browser maybe blocking up Popup windows. \n\n  Please check your Popup Blocker Settings or ..\n Please hold Ctrl Key and Click on link to open new Browser"); }
//}
}
...
$tid=$pid;
$sql_tbl=mysqli_query($link,"select * from tbl_mergermain where mergerm_id='".$tid."' and plantcode='$plantcode'") or die(mysqli_error($link));
...
<tr class="Light" height="25">
    ...
    <td align="center"  valign="middle" class="tblheading">&nbsp;<a href="Javascript:void(0)" onclick="openslocpopprint1(<?php echo $tid;?>);">Lot Merger Note (LMN)</a></td>
</tr>
</table>
<br />

<table align="center" border="0" cellspacing="0" cellpadding="0" width="850" bordercolor="#2e81c1" style="border-collapse:collapse">
  <tr height="25" >
    <td colspan="8" align="center" class="subheading" style="color:#303918; ">Existing Lots </td>
  </tr>
  </table>
<table align="center" border="1" cellspacing="0" cellpadding="0" width="850" bordercolor="#2e81c1" style="border-collapse:collapse">
  <tr class="tblsubtitle" height="25">
    ...
    <td width="257" align="center" class="tblheading" valign="middle">Lot No.</td>
...
<?php
$sql_tbl=mysqli_query($link,"select * from tbl_lot_ldg where lotldg_trtype='Merger' and lotldg_trid='".$pid."' and lotldg_balqty=0 and plantcode='$plantcode'") or die(mysqli_error($link));
...
<tr class="Light" height="25">
    ...
    <td width="257" align="center" valign="middle" class="tblheading"><?php echo $row_tbl_sub['lotldg_lotno'];?></td>
...
<tr >
<td valign="top" align="center"><a href="home_merger.php"><img src="../images/back.gif" border="0"style="display:inline;cursor:Pointer;" /></a>&nbsp;&nbsp;&nbsp;</td>	
</tr>
</table>
