...
<?php
$qry="select arrival_id, arrival_date from tblarrival where arrival_date <='".$edate."' and arrival_date >='".$sdate."' and arrival_type='Fresh Seed with PDN' and arrtrflag=1 and arrival_id IN($arid) and plantcode='$plantcode'";
