<?php
	...
	if(isset($_POST['frm_action'])=='submit')
	{
		...
		//exit;		
		echo "<script>window.location='report_monthlypacking1.php?txtcrop=$cid&txtvariety=$itemid&financial_year=$financial_year&month=$month&txtplant=$txtplant'</script>";
	}
?>
...
<title>Plant Manager-Report -  Financial Year wise Monthly Packing  Report</title>
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#2e81c1" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#2e81c1" style="border-bottom:solid; border-bottom-color:#2e81c1" >
	    <tr >
	      <td width="813" height="30"class="Mainheading"  >Financial Year wise Monthly Packing Report </td>
	    </tr></table></td>
	  </tr>
	  </table></td></tr>
          ...
          <tr>
            ...
            <td><table align="center" border="1" width="700" cellspacing="0" cellpadding="0" bordercolor="#2e81c1" style="border-collapse:collapse" >
                <tr class="tblsubtitle" height="25">
                  <td colspan="4" align="center" class="tblheading">Financial Year wise Monthly Packing Report</td>
                </tr>
                <tr height="15">
