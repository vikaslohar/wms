<?php
	...
	{
		//exit;
		$sql_srmain=mysqli_query($link,"Select * from tbl_softr2 where softr_id='".$tid."' AND plantcode='$plantcode'") or die(mysqli_error($link));
		$tot_srmain=mysqli_num_rows($sql_srmain);
		$row_srmain=mysqli_fetch_array($sql_srmain);	
		
		$sql_srsub=mysqli_query($link,"SELECT * FROM tbl_softr_sub2 WHERE softr_id='".$tid."' AND plantcode='$plantcode'") or die(mysqli_error($link));
		...
		while($row_srsub=mysqli_fetch_array($sql_srsub))
		{
			...
			$slqty=0;
			$sql_issue=mysqli_query($link,"select distinct lotldg_whid, lotldg_subbinid, lotldg_binid from tbl_lot_ldg where  orlot='".$lotno."'  and lotldg_srflg='0' and lotldg_qc!='Fail' and (lotldg_got='UT' OR lotldg_got='RT') AND plantcode='$plantcode'") or die(mysqli_error($link));
			$zz=mysqli_num_rows($sql_issue);
			while($row_issue=mysqli_fetch_array($sql_issue))
			{ 
				$sql_issue1=mysqli_query($link,"select max(lotldg_id) from tbl_lot_ldg where lotldg_subbinid='".$row_issue['lotldg_subbinid']."' and lotldg_binid='".$row_issue['lotldg_binid']."' and lotldg_whid='".$row_issue['lotldg_whid']."' and orlot='".$lotno."'  and lotldg_srflg='0' and lotldg_qc!='Fail' and (lotldg_got='UT' OR lotldg_got='RT') AND plantcode='$plantcode'") or die(mysqli_error($link));
				$row_issue1=mysqli_fetch_array($sql_issue1); 
				
				$sql_issuetbl=mysqli_query($link,"select * from tbl_lot_ldg where lotldg_id='".$row_issue1[0]."' and lotldg_srflg='0' and lotldg_qc!='Fail' and (lotldg_got='UT' OR lotldg_got='RT') AND plantcode='$plantcode'") or die(mysqli_error($link)); 
			...
			$slqty=0;
			$sql_issue=mysqli_query($link,"select distinct whid, subbinid, binid from tbl_lot_ldg_pack where orlot='".$lotno."' and lotldg_srflg='0' and lotldg_qc!='Fail' and (lotldg_got='UT' OR lotldg_got='RT') AND plantcode='$plantcode'") or die(mysqli_error($link));
			$zz=mysqli_num_rows($sql_issue);
			while($row_issue=mysqli_fetch_array($sql_issue))
			{ 
				$sql_issue1=mysqli_query($link,"select max(lotdgp_id) from tbl_lot_ldg_pack where subbinid='".$row_issue['subbinid']."' and binid='".$row_issue['binid']."' and whid='".$row_issue['whid']."' and orlot='".$lotno."'  and lotldg_srflg='0' and lotldg_qc!='Fail' and (lotldg_got='UT' OR lotldg_got='RT') AND plantcode='$plantcode'") or die(mysqli_error($link));
				$row_issue1=mysqli_fetch_array($sql_issue1); 
				
				$sql_issuetbl=mysqli_query($link,"select * from tbl_lot_ldg_pack where lotdgp_id='".$row_issue1[0]."' and lotldg_srflg='0' and lotldg_qc!='Fail' and (lotldg_got='UT' OR lotldg_got='RT') AND plantcode='$plantcode'") or die(mysqli_error($link)); 
				$xxz=mysqli_num_rows($sql_issuetbl);
				while($row_issuetbl=mysqli_fetch_array($sql_issuetbl))
				{ 
		...
		$sql_code="SELECT MAX(softr_code) FROM tbl_softr2  where yearcode='$yearid_id' AND plantcode='$plantcode' ORDER BY softr_code DESC";
		...
		$sql_srmain="Update tbl_softr2 set softr_code='$code', softr_tflg='1' where softr_id='".$tid."'";
		$xxxx=mysqli_query($link,$sql_srmain) or die(mysqli_error($link));

		echo "<script>window.location='select_softrelease_op2.php?p_id=$tid'</script>";	
	}
?>
...
<title>Plant Manager - Transaction - Super Soft Release</title>
...
winHandle=window.open('print_softrelease2.php?itmid='+tid,'WelCome','top=20,left=50,width=850,height=750,scrollbars=yes');
if(winHandle==null){
...
<tr class="tblsubtitle" height="20">
  <td colspan="6" align="center" class="tblheading">Super Soft Release - Preview</td>
</tr>
...
if($type=="sllot")	
{
$sql="SELECT distinct orlot, lotldg_got1 FROM tbl_lot_ldg WHERE lotldg_crop='".$crop."' and lotldg_variety='".$variety."' and lotldg_srflg='0' and lotldg_qc!='Fail' AND plantcode='$plantcode' order by orlot ";
$sql2="SELECT distinct orlot, lotldg_got1 FROM tbl_lot_ldg_pack WHERE lotldg_crop='".$crop."' and lotldg_variety='".$variety."' and lotldg_srflg='0' and lotldg_qc!='Fail' AND plantcode='$plantcode' order by orlot";
}
else
{
$sql="SELECT distinct orlot, lotldg_got1 FROM tbl_lot_ldg WHERE lotldg_crop='".$crop."' and lotldg_variety='".$variety."' and lotldg_whid='".$wh."' and lotldg_binid='".$bin."' and lotldg_subbinid='".$subbin."' and lotldg_srflg='0' and lotldg_qc!='Fail'  AND plantcode='$plantcode' order by orlot";
$sql2="SELECT distinct orlot, lotldg_got1 FROM tbl_lot_ldg_pack WHERE lotldg_crop='".$crop."' and lotldg_variety='".$variety."' and whid='".$wh."' and binid='".$bin."' and subbinid='".$subbin."' and lotldg_srflg='0' and lotldg_qc!='Fail' AND plantcode='$plantcode' order by orlot";
}
...
$sql_issue=mysqli_query($link,"select distinct lotldg_subbinid, lotldg_binid, lotldg_whid from tbl_lot_ldg where  orlot='".$orlt."'  and lotldg_balqty > 0  and lotldg_srflg='0' and lotldg_qc!='Fail' AND plantcode='$plantcode'  order by orlot") or die(mysqli_error($link));
$zz=mysqli_num_rows($sql_issue);
//if($zz==0)$flg=1;
 while($row_issue=mysqli_fetch_array($sql_issue))
 { 
...
$sql_issue1=mysqli_query($link,"select max(lotldg_id) from tbl_lot_ldg where lotldg_subbinid='".$row_issue['lotldg_subbinid']."' and lotldg_binid='".$row_issue['lotldg_binid']."' and lotldg_whid='".$row_issue['lotldg_whid']."' and orlot='".$orlt."'  and lotldg_srflg='0' and lotldg_qc!='Fail' AND plantcode='$plantcode' order by orlot") or die(mysqli_error($link));
$row_issue1=mysqli_fetch_array($sql_issue1); 

$sql_issuetbl=mysqli_query($link,"select * from tbl_lot_ldg where lotldg_id='".$row_issue1[0]."' and lotldg_balqty > 0 and lotldg_srflg='0' and lotldg_qc!='Fail' AND plantcode='$plantcode' order by orlot") or die(mysqli_error($link)); 
 $xxz=mysqli_num_rows($sql_issuetbl);
//if($xxz==0)$flg=1;
 while($row_issuetbl=mysqli_fetch_array($sql_issuetbl))
 { 
...
$sql_issue=mysqli_query($link,"select distinct subbinid, binid, whid from tbl_lot_ldg_pack where orlot='".$orlt."' and balqty > 0 and lotldg_srflg='0' and lotldg_qc!='Fail' AND plantcode='$plantcode' order by orlot") or die(mysqli_error($link));
$zz=mysqli_num_rows($sql_issue);
//if($zz==0)$flg=1;
 while($row_issue=mysqli_fetch_array($sql_issue))
 { 
...
$sql_issue1=mysqli_query($link,"select max(lotdgp_id) from tbl_lot_ldg_pack where subbinid='".$row_issue['subbinid']."' and binid='".$row_issue['binid']."' and whid='".$row_issue['whid']."' and orlot='".$orlt."' and lotldg_srflg='0' and lotldg_qc!='Fail' AND plantcode='$plantcode' order by orlot") or die(mysqli_error($link));
$row_issue1=mysqli_fetch_array($sql_issue1); 

$sql_issuetbl=mysqli_query($link,"select * from tbl_lot_ldg_pack where lotdgp_id='".$row_issue1[0]."' and balqty > 0 and lotldg_srflg='0' and lotldg_qc!='Fail' AND plantcode='$plantcode' order by orlot") or die(mysqli_error($link)); 
 $xxz=mysqli_num_rows($sql_issuetbl);
//if($xxz==0)$flg=1;
 while($row_issuetbl=mysqli_fetch_array($sql_issuetbl))
 { 
...
if($flg==0)
{
//echo $row_arr_home['orlot'];

$sql_srsub24=mysqli_query($link,"SELECT * FROM tbl_softr_sub2 WHERE softr_id='".$tid."' and softrsub_lotno='".$orlt."' AND plantcode='$plantcode'") or die(mysqli_error($link));
$tot_srsub=mysqli_num_rows($sql_srsub24);
if($tot_srsub > 0)
{
$row_srsub=mysqli_fetch_array($sql_srsub24);
$countrec++;
if($srno%2!=0)
{
?>
