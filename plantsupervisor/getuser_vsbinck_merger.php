...
<td width="50%" align="center"  valign="middle" class="smalltbltext"><input name="<?php echo $id;?>" id="<?php echo $qid;?>" type="text" size="8" class="smalltbltext" tabindex="" maxlength="10"   value=""  onchange="<?php echo $q;?>"  onkeypress="return isNumberKey(event)" />&nbsp;<font color="#FF0000">* </font>&nbsp;</td>
</tr></table><?php }?>