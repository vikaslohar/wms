...
$flag=0; 
//echo $a;
$sql_month=mysqli_query($link,"select varietyid, popularname from tblvariety where cropname='".$a."'  and vertype='PV'  order by popularname Asc")or die(mysqli_error($link));
