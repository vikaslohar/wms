...
function chkbar(mltval,mltno)
{
	...
	if(mltno>1)
	{
		var txtbarws="txtwtws"+(mltno-1);
		if(document.getElementById(txtbarws).value=="")
		{
			var txtbc1="txtbc"+(mltno-1);
			var txtbc="txtbc"+mltno;
			alert("Kindly put the Bag/Carton on Weighing Scale for previous barcode and scan Privious barcode again");
			document.getElementById(txtbc).value="";
			document.getElementById(txtbc1).value="";
	...
	if(flg==0)
	{
		...
		setTimeout(function(){if(mltno!=10)	{ var txtbar="txtbc"+(parseInt(mltno)+1); document.getElementById(txtbar).focus(); }}, 200);
	}
}
...
function callwtfile(mltno)
{
	...
	showUser(mltno,bardet1,'bcwtpd',mltno,'','','','','','','');
	var txtbarws="txtwtws"+(mltno);
	if(document.getElementById(txtbarws).value=="")
	{
		//setTimeout(callwtfile(mltno), 1000);
		setTimeout(function(){showUser(mltno,bardet1,'bcwtpd',mltno,'','','','','','','');}, 200);
	}
	if(document.getElementById(txtbarws).value=="")
	{
		//setTimeout(callwtfile(mltno), 1000);
	...
	{
		//setTimeout(callwtfile(mltno), 1000);
		setTimeout(function(){showUser(mltno,bardet3,'bcwtpdelete',mltno,'','','','','','','');}, 200);
	}
}
...
{ 
    ...
    {alert(file);
        ...
        {alert(file); alert("status " + rawFile.status);
...
<tr class="Light" height="25">
	...
	<td width="147" align="center"  valign="middle" id="wtws1">&nbsp;<input name="txtwtws" id="txtwtws1" type="text" size="15" class="tbltext" tabindex="0" maxlength="15" onchange="chkwtws(this.value, '1');" readonly="true" style="background-color:#CCCCCC" value=""  />&nbsp;<font color="#FF0000">*</font></td>
...
<tr class="Light" height="25">
	...
	<td width="147" align="center"  valign="middle" id="wtws2">&nbsp;<input name="txtwtws" id="txtwtws2" type="text" size="15" class="tbltext" tabindex="0" maxlength="15" onchange="chkwtws(this.value ,'2');" readonly="true" style="background-color:#CCCCCC"  value="" />&nbsp;<font color="#FF0000">*</font></td>
...
<tr class="Light" height="25">
	...
	<td width="147" align="center"  valign="middle" id="wtws3">&nbsp;<input name="txtwtws" id="txtwtws3" type="text" size="15" class="tbltext" tabindex="0" maxlength="15" onchange="chkwtws(this.value, '3');" readonly="true" style="background-color:#CCCCCC" value=""  />&nbsp;<font color="#FF0000">*</font></td>
...
<tr class="Light" height="25">
	...
	<td width="147" align="center"  valign="middle">&nbsp;<input name="txtwtws" id="txtwtws4" type="text" size="15" class="tbltext" tabindex="0" maxlength="15" onchange="chkwtws(this.value, '4');" readonly="true" style="background-color:#CCCCCC" value=""   />&nbsp;<font color="#FF0000">*</font></td>
...
<tr class="Light" height="25">
	...
	<td width="147" align="center"  valign="middle">&nbsp;<input name="txtwtws" id="txtwtws5" type="text" size="15" class="tbltext" tabindex="0" maxlength="15" onchange="chkwtws(this.value, '5');" readonly="true" style="background-color:#CCCCCC" value=""   />&nbsp;<font color="#FF0000">*</font></td>
...
<tr class="Light" height="25">
	...
	<td width="147" align="center"  valign="middle">&nbsp;<input name="txtwtws" id="txtwtws6" type="text" size="15" class="tbltext" tabindex="0" maxlength="15" onchange="chkwtws(this.value, '6');" readonly="true" style="background-color:#CCCCCC" value=""   />&nbsp;<font color="#FF0000">*</font></td>
...
<tr class="Light" height="25">
	...
	<td width="147" align="center"  valign="middle">&nbsp;<input name="txtwtws" id="txtwtws7" type="text" size="15" class="tbltext" tabindex="0" maxlength="15" onchange="chkwtws(this.value, '7');" readonly="true" style="background-color:#CCCCCC" value=""   />&nbsp;<font color="#FF0000">*</font></td>
...
<tr class="Light" height="25">
	...
	<td width="147" align="center"  valign="middle">&nbsp;<input name="txtwtws" id="txtwtws8" type="text" size="15" class="tbltext" tabindex="0" maxlength="15" onchange="chkwtws(this.value, '8');" readonly="true" style="background-color:#CCCCCC" value=""   />&nbsp;<font color="#FF0000">*</font></td>
...
<tr class="Light" height="25">
	...
	<td width="147" align="center"  valign="middle">&nbsp;<input name="txtwtws" id="txtwtws9" type="text" size="15" class="tbltext" tabindex="0" maxlength="15" onchange="chkwtws(this.value, '9');" readonly="true" style="background-color:#CCCCCC" value=""   />&nbsp;<font color="#FF0000">*</font></td>
...
<tr class="Light" height="25">
	...
	<td width="147" align="center"  valign="middle">&nbsp;<input name="txtwtws" id="txtwtws10" type="text" size="15" class="tbltext" tabindex="0" maxlength="15" onchange="chkwtws(this.value, '10');" readonly="true" style="background-color:#CCCCCC" value=""   />&nbsp;<font color="#FF0000">*</font></td>
