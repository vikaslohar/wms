...
$sql_issue=mysqli_query($link,"select distinct lotldg_whid, lotldg_subbinid, lotldg_binid from tbl_lot_ldg where lotldg_lotno='".$row_tbl_sub['lotldg_lotno']."'  and lotldg_balqty > 0  and lotldg_srflg='0' and plantcode='$plantcode'") or die(mysqli_error($link));
$zz=mysqli_num_rows($sql_issue);
if($zz==0)$flg=1;
 while($row_issue=mysqli_fetch_array($sql_issue))
 { 
$sql_issue1=mysqli_query($link,"select max(lotldg_id) from tbl_lot_ldg where lotldg_subbinid='".$row_issue['lotldg_subbinid']."' and lotldg_binid='".$row_issue['lotldg_binid']."' and lotldg_whid='".$row_issue['lotldg_whid']."' and lotldg_lotno='".$row_tbl_sub['lotldg_lotno']."'  and lotldg_srflg='0' and plantcode='$plantcode'") or die(mysqli_error($link));
...
?>
          <tr class="Dark" height="25">
            ...
            <td width="140" align="left"  valign="middle" class="tblheading" >&nbsp;<?php echo $totnob;?></td>
            <td align="right"  valign="middle"  class="tblheading">Qty&nbsp;</td>
            <td align="left"  valign="middle" class="tblheading" >&nbsp;<?php echo $totqty;?></td>
          </tr>
		  <tr class="Dark" height="25">
			   <td align="right"  valign="middle" class="tblheading">SLOC&nbsp;</td>
                 <td align="left"  valign="middle" class="tblheading" colspan="6">&nbsp;<?php echo $sloc?></td>
	      </tr>
