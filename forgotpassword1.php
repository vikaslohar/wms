...
if(isset($_POST['posted']))
{
	if( isset($_POST['username']))
	{
		...
		//if( 'admin' == $radio_button_usertype ) 
			$sql=mysqli_query($link,"select * from tbl_user where loginid='".$loginid."'");
		//else 	
...
<tr><td align="center" colspan="2" valign="middle"><img src="images/logo.gif"></td></tr>
<tr>
...
<?php
	...
	$db = mysql_select_db("years");
 	...
 	$quer3=mysqli_query($link,"select * from tbl_years where years_flg > 0 and years_status='a'"); 
?>
