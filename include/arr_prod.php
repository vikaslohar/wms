<div class="headerwrapper">
			...
			<ul  id="nav"> 
			<?php 
			  /*	$sql_opr=mysqli_query($link,"select * from tbl_viewer where vid='".$loginid."'") or die(mysqli_error());
            ...
            <li><a href="index1.php">Reports</a>
			 ...
			 <?php } else { */?>
			 <li><a href="../production/report_arrivalplcvq.php">&nbsp;Arrival&nbsp;&amp;&nbsp;Processing&nbsp;Report</a></li>
			<!-- <li><a href="../production/report_variety.php">&nbsp;Crop&nbsp;Variety&nbsp;Wise&nbsp;Arrival&nbsp;Report</a></li>
			 <li><a href="../production/report_rawcrop.php">&nbsp;Crop&nbsp;Variety&nbsp;Wise&nbsp;Stock&nbsp;Report</a></li>
			 <li><a href="../production/report_rawcropq.php">&nbsp;Quality&nbsp;based&nbsp;Stock&nbsp;Report</a></li>
			 <li><a href="../production/stock_report.php">&nbsp;Stock&nbsp;Report</a></li>
			 <li><a href="../production/crop_ver_sr_report.php">&nbsp;Crop&nbsp;Variety&nbsp;wise&nbsp;SR&nbsp;Report</a></li>
             <li><a href="../production/partywise_sr_report.php">&nbsp;Party&nbsp;Wise&nbsp;SR&nbsp;Report</a></li>
			 <li><a href="../production/statewise_sr_report.php">&nbsp;State&nbsp;Wise&nbsp;SR&nbsp;Report</a></li>	
			 <li><a href="../production/sr_pwdamage_report.php">&nbsp;Party&nbsp;Wise&nbsp;Damage&nbsp;SR&nbsp;Report</a></li>
			 <li><a href="../production/cvwisedamage_sr_report.php">&nbsp;Crop&nbsp;Variety&nbsp;Wise&nbsp;Damage&nbsp;SR</a></li>
			 <li><a href="../production/usefullstock_report.php">&nbsp;Ready&nbsp;Stock&nbsp;Report</a></li>
			 <li><a href="../production/report_stockladgerbob.php">&nbsp;Stock&nbsp;Ladger&nbsp;Report</a></li>-->
			 <?php //} ?>
              </ul>
            </li>
            <!--<li>
			...
			<ul> <li><a href=" Javascript:void(0)" onClick="window.open('../viewer/utility_lot.php','WelCome','top=10,left=50,width=960,height=400,scrollbars=NO')" >&nbsp;Lot&nbsp;Query</a></li>
              ...
              <ul style="vertical-align:text-top">
   			<li> <a href="../production/operprofile.php" >Profile</a> | </li>
				 <li>&nbsp;<a href="../production/faq.php">FAQ</a> | </li>
				<li>&nbsp; <a href="../production/help.php">Help</a> | </li>
			...
			<!--<div style="border: 0px solid red; float: right; width: 290px; clear: right; font-size:5px; font-weight:bold; list-style-type:none;"/>
			 ...
			 <li style="float:right; position:relative; display:inline; vertical-align:text-top; text-align:left; color:#000000">&nbsp;<?php echo date("l, d-m-Y");?>&nbsp;&nbsp;&nbsp;&nbsp; </li>
			  ...
			  <?php
			  	$sql_plant=mysqli_query($link,"select * from tbl_parameters") or die(mysqli_error());
				...
				{
					$sql_opr=mysqli_query($link,"select * from tblopr where id='".$loginid."' ") or die(mysqli_error());
					$row_opr=mysqli_fetch_array($sql_opr);
