<div class="headerwrapper">
           ...
           <!-- <li><a href="index1.php">Transactions</a>
            ...
            <ul>
				<li><a href="../plantsupervisor/stock_reportnew.php">&nbsp;Stock&nbsp;on&nbsp;Hand&nbsp;Report</a></li>				
				<li><a href="../plantsupervisor/report_rawcropq.php">&nbsp;Quality&nbsp;based&nbsp;Stock&nbsp;Report</a></li>
				<li><a href="../plantsupervisor/preport_plant.php">&nbsp;Consolidated&nbsp;Arrival&nbsp;Report</a></li>
				<li><a href="../plantsupervisor/report_packingperiod.php">&nbsp;Periodical&nbsp;Packing&nbsp;Report</a></li>
				<li><a href="../plantsupervisor/stock_report.php">&nbsp;Stock&nbsp;Report</a></li>
            </ul>
            </li>
            <!--<li>
