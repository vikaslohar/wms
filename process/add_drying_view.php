  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#adad11" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#F1B01E" style="border-bottom:solid; border-bottom-color:#adad11" >
	    <tr >
	      <td width="813" height="25" class="Mainheading">&nbsp;Transaction - Drying slip - View </td>
	    </tr></table></td>
...
$subtid=0;
	...
	$sql_year=mysqli_query($link,"select * from tblyears where years='".$tyear."'") or die(mysqli_error($link));
...
<tr class="tblsubtitle" height="20">
  <td colspan="6" align="center" class="tblheading">Drying View</td>
</tr>

 <tr class="Dark" height="30">
<td width="205" align="right" valign="middle" class="tblheading">&nbsp;Transaction Id &nbsp;</td>
<td width="234"  align="left" valign="middle" class="tbltext">&nbsp;<?php echo "PD".$row_tbl['ar_code']."/".$row_year['ycode']."/".$row_tbl['logid'];?></td>
...
<tr class="light" height="30">
  ...
  <td width="903" align="left" class="smalltbltext">&nbsp;<?php echo $row_tbl['remarks'];?></td>
</tr>
</table>
