<?php
	...
	if(isset($_POST['frm_action'])=='submit')
	{
		...
		$edate="'$edate'";
		$txtpmcode="'$txtpmcode'"; 
		$txtprodper="'$txtprodper'"; 
		if($cid=="ALL")$cid="'ALL'";
		if($itemid=="ALL")$itemid="'ALL'";
		?>
		<script>
		mywindow='excel-prodperwpsr6.php?sdate=';
		mywindow=mywindow+<?php echo $sdate?>;
		mywindow=mywindow+'&edate='+<?php echo $edate?>;
		mywindow=mywindow+'&txtcrop='+<?php echo $cid?>+'&txtvariety='+<?php echo $itemid?>+'&txtpmcode='+<?php echo $txtpmcode?>+'&txtprodper='+<?php echo $txtprodper?>;
...
alert("While Launching New Window...\nYour browser maybe blocking up Popup windows. \n\n  Please check your Popup Blocker Settings or ..\n Please hold Ctrl Key and Click on link to open new Browser"); }
		...
		{
		echo "<script>window.location='report_prodperw_prostatus4.php?sdate=$sdate&edate=$edate&txtcrop=$cid&txtvariety=$itemid&txtpmcode=$txtpmcode&txtprodper=$txtprodper'</script>";
		}
		}
		else
		 {?>
...
{	
	showUser(classval,'orglist','showorglist','','','','','');
}
</script>
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#adad11" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#adad11" style="border-bottom:solid; border-bottom-color:#adad11" >
	    <tr >
	      <td width="813" height="30"class="Mainheading"  >Production Personnel wise Processing Status Report - Pricessing Period</td>
	    </tr></table></td>
	  </tr>
	  </table></td></tr>
	  ...
	  <input name="btnval" value="0" type="hidden">
	    <table  border="0" cellspacing="0" cellpadding="0" align="center" width="974"  style="border-collapse:collapse">
          ...
          <tr>
            <td width="30"></td>
            <td><table align="center" border="1" width="650" cellspacing="0" cellpadding="0" bordercolor="#adad11" style="border-collapse:collapse" >
                <tr class="tblsubtitle" height="25">
                  <td colspan="4" align="center" class="tblheading">Production Personnel wise Processing Status Report</td>
                </tr>
                <tr height="15">
...
?>
                <tr class="Dark" height="25">
                  <td width="33%" height="30" align="right" valign="middle" class="tblheading">Processing Period of Lot(s)&nbsp;&raquo;&nbsp;&nbsp;From&nbsp;</td>
...
<?php
$zzss="";
$sql_sel1="select distinct pper from tblarrival_sub where pper!='$zzss' and pper IS NOT NULL and plantcode='$plantcode' order by pper asc";
$res1=mysqli_query($link,$sql_sel1) or die (mysqli_error($link));
$total1=mysqli_num_rows($res1);
?>
 <tr class="Light" height="25">
<td align="right"  valign="middle" class="tblheading" colspan="2">Production Personnel&nbsp;</td>
<td align="left"  valign="middle" class="tbltext" colspan="2" >&nbsp;<select class="tbltext" name="txtprodper" style="width:170px;" onChange="modetchk5(this.value)">
<option value="" selected>--Select--</option>
 <?php while($noticiaitem1 = mysqli_fetch_array($res1)) { ?>
		<option value="<?php echo $noticiaitem1['pper'];?>" />   
		<?php echo $noticiaitem1['pper'];?>
		<?php } ?>
	</select>&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
</tr>
<tr class="Light" height="25">
<td align="right"  valign="middle" class="tblheading" colspan="2">Organiser&nbsp;</td>
<td align="left"  valign="middle" class="tbltext" colspan="2" id="orglist" >&nbsp;<select class="tbltext" name="txtpmcode" style="width:170px;">
<option value="" selected>--Select--</option>
...
<option value="ALL" selected>ALL</option>
                ...
                <table width="650" align="center" cellpadding="5" cellspacing="5" border="0" >
                  <tr >
                    <td valign="top" align="center"><a href="report_prodperw_prosts.php"><img src="../images/back.gif" border="0"  style="display:inline;cursor:pointer;"/></a>&nbsp;&nbsp;<input name="Submit" type="image" src="../images/submit_1.gif" alt="Submit Value"  border="0" style="display:inline;cursor:pointer;" onClick="return mySubmit();" />&nbsp;&nbsp;<input name="Submit" type="image" src="../images/excelicon1.jpg" alt="Export to Excel"  border="0" style="display:inline;cursor:pointer;" onClick="smpabort('1');" />
