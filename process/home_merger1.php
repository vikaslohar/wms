...
while($row_tbl=mysqli_fetch_array($sql_tbl))
{
	...
	$s_sub_sub="delete from tbl_blendssub where blendm_id='".$arrival_id."'";
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#adad11" >
	  ...
	  <table width="809" border="0" cellpadding="0" cellspacing="0" bordercolor="#adad11" style="border-bottom:solid; border-bottom-color:#adad11" >
	    <tr >
	      <td width="810" class="Mainheading" height="25">&nbsp;Transaction - Lot Blending</td>
	    </tr></table></td>
...
$sql_arr_home=mysqli_query($link,"select * from tbl_blendm where blendm_date<='$pdate' and blendm_date>='$tdate' and blendm_tflg=1 and plantcode='$plantcode' order by blendm_date desc,blendm_code desc LIMIT $from, $max_results") or die(mysqli_error($link));
$tot_arr_home=mysqli_num_rows($sql_arr_home);

$total_results3 =mysqli_query($link,"SELECT COUNT(*)  FROM tbl_blendm where blendm_date<='$pdate' and blendm_date>='$tdate' and blendm_tflg=1 and plantcode='$plantcode'");
...
{
/*if($extlotno!="")
$extlotno=$extlotno."<br/>".$row_eindent_sub['blends_lotno'];
else
$extlotno=$row_eindent_sub['blends_lotno'];
*/
if($extnob!="")
$extnob=$extnob."<br/>".$row_eindent_sub['blends_nob']; 
else
$extnob=$row_eindent_sub['blends_nob']; 

$dq=explode(".",$row_eindent_sub['blends_qty']);
if($dq[1]==000){$extqty1=$dq[0];}else{$extqty1=$row_eindent_sub['blends_qty'];}
...
<tr class="Light">
         ...
         <td width="9%" align="center" valign="middle" class="smalltbltext"><a href="Lot_merger_view.php?p_id=<?php echo $trid;?>"><?php echo "LM".$row_arr_home['blendm_code']."/".$row_arr_home['blendm_yearid']."/".$drole;?></a></td>
         ...
         <td width="11%" align="center" valign="middle" class="smalltbltext"><?php echo $row_arr_home['blendm_newlot'];?></td>
         <td width="5%" align="center" valign="middle" class="smalltbltext"><?php echo $row_arr_home['blendm_nob']?></td>
