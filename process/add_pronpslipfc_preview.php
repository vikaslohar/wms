<?php
	...
	if(isset($_POST['frm_action'])=='submit')
	{
	 ...
	 $sql_main="update tbl_pnpslipmain set pnpslipmain_tflag=2  where pnpslipmain_id ='$pid'";
...
<tr class="tblsubtitle" height="20">
  <td colspan="8" align="center" class="tblheading">Processing and Packing slip FC - MTN Preview</td>
</tr>
...
<td width="146" align="right" valign="middle" class="smalltblheading">Transaction&nbsp;Date&nbsp;</td>
...
<td width="381" align="left" valign="middle" class="smalltbltext">&nbsp;<input name="dopc" id="dopc" type="text" size="10" class="smalltbltext" tabindex="0" value="<?php echo $tdate2;?>" maxlength="10" readonly="true"  style="background-color:#CCCCCC"/>&nbsp;<font color="#FF0000">*</font></td>

<td width="146" align="right"  valign="middle" class="smalltblheading">MTN No.&nbsp;</td>
    <td width="207" align="left"  valign="middle" class="smalltbltext">&nbsp;<input name="txtpsrno" type="text" size="15" class="smalltbltext" tabindex="" value="<?php echo $row_tbl['pnpslipmain_mtnno'];?>" maxlength="15" readonly="true"  style="background-color:#CCCCCC"/>&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
</tr>
<tr class="Light" height="30">
 <?php
...
<table align="center" border="1" cellspacing="0" cellpadding="0" width="970" bordercolor="#adad11" style="border-collapse:collapse">
            ...
            <tr class="tblsubtitle" height="20">
            <td width="20" rowspan="2" align="center" valign="middle" class="smalltblheading">#</td>
	...
	<td width="154" align="center" rowspan="2" valign="middle" class="smalltblheading"> Lot No.</td>
	 <!--<td width="10%" align="center" valign="middle" class="smalltblheading" colspan="2">Raw Seed </td>-->
	 <td width="148" rowspan="2" align="center" valign="middle" class="smalltblheading">Existing NoB</td>
    <td width="145" rowspan="2" align="center" valign="middle" class="smalltblheading">Existing Qty</td>
	 <td width="188" rowspan="2" align="center" valign="middle" class="smalltblheading">E/P</td>
	 <td width="151" rowspan="2" align="center" valign="middle" class="smalltblheading">Picked for Processing NoB</td>
    <td width="148" rowspan="2" align="center" valign="middle" class="smalltblheading">Picked for Processing Qty</td>
...
{
$txtremarks=$row_tbl_sub['pnpslipsub_remarks'];
$difq="";$difq1="";
$sloc=""; $sloc1=""; $cnt++; 
...
<tr class="Light" height="20">
	...
	<td align="center"  valign="middle" class="smalltbltext" ><?php echo $row_tbl_sub['pnpslipsub_clotno'];?></td>
...
<tr >
<td valign="top" align="right"><a href="home_pronpslip_fc.php" tabindex="20"><img src="../images/cancel.gif" border="0"style="display:inline;cursor:Pointer;" onclick="return confirm('Do You wish to Cancel this Transaction?');" /></a>&nbsp;&nbsp;<input name="Submit" type="image" src="../images/finalsubmit.gif" alt="Submit Value"  border="0" style="display:inline;cursor:Pointer;" tabindex="" onClick="return mySubmit();">&nbsp;&nbsp;</td>
</tr>
</table>
</td><td width="30"></td>
</tr>
