...
$flg=0;
	...
	$sql_barcode22=mysqli_query($link,"Select bar_barcodes from tbl_barcodestmp where bar_barcodes='$a' and bar_subid!='".$subtid."' and plantcode='$plantcode'") or die(mysqli_error($link));
