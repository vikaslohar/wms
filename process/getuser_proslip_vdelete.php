...
$s_sub="delete from tbl_proslipsub where proslipsub_id='".$b."'";
mysqli_query($link,$s_sub) or die(mysqli_error($link));

$s_sub1="delete from tbl_proslipsubsub where proslipsub_id='".$b."'";
mysqli_query($link,$s_sub1) or die(mysqli_error($link));

$s_sub2="delete from tbl_proslipsubsub2 where proslipsub_id='".$b."'";
mysqli_query($link,$s_sub2) or die(mysqli_error($link));

$sql_t_sub=mysqli_query($link,"select * from tbl_proslipmain where proslipmain_id='".$a."' and plantcode='$plantcode'") or die(mysqli_error($link));
...
<td width="182" align="left" valign="middle" class="smalltbltext">&nbsp;
  <input name="date" type="text" size="10" class="smalltbltext" tabindex="0" readonly="true"  style="background-color:#CCCCCC" value="<?php echo $tdate;?>" maxlength="10"/>&nbsp;</td>

<td width="137" align="right"  valign="middle" class="smalltblheading">Processing Slip Ref. No.&nbsp;</td>
    <td width="144" align="left"  valign="middle" class="smalltbltext">&nbsp;
    <input name="txtpsrno" type="text" size="15" class="smalltbltext" tabindex="" value="<?php echo $row_tbl['proslipmain_proslipno'];?>" maxlength="15" readonly="true"  style="background-color:#CCCCCC"/>&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
</tr></table>
<table align="center" border="1" width="850" cellspacing="0" cellpadding="0" bordercolor="#adad11" style="border-collapse:collapse" > 
