...
$sql_mps=mysqli_query($link,"Select * from tbl_mpmain where mpmain_trtype='PACKSMC' and mpmain_balqty > 0 and plantcode='$plantcode'") or die(mysqli_error($link));
...
$sql_mpl=mysqli_query($link,"Select * from tbl_mpmain where mpmain_trtype='PACKLMC' and mpmain_balqty > 0 and plantcode='$plantcode'") or die(mysqli_error($link));
...
$sql_mpm=mysqli_query($link,"Select * from tbl_mpmain where mpmain_trtype='PACKMMC' and mpmain_balqty > 0 and plantcode='$plantcode'") or die(mysqli_error($link));
...
?>
<table align="center" border="1" width="550" cellspacing="0" cellpadding="0" bordercolor="#adad11" style="border-collapse:collapse" > 
