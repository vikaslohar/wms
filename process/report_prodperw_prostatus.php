<?php
	...
	if(isset($_POST['frm_action'])=='submit')
	{
		...
		?>
		<script>
		mywindow='excel-prodperwpsr.php?sdate=';
...
alert("While Launching New Window...\nYour browser maybe blocking up Popup windows. \n\n  Please check your Popup Blocker Settings or ..\n Please hold Ctrl Key and Click on link to open new Browser"); }
		...
		{
		echo "<script>window.location='report_prodperw_prostatus1.php?sdate=$sdate&edate=$edate&txtcrop=$cid&txtvariety=$itemid&txtpmcode=$txtpmcode&txtprodper=$txtprodper'</script>";
		}
		}
		else
		 {?>
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#adad11" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#adad11" style="border-bottom:solid; border-bottom-color:#adad11" >
	    <tr >
	      <td width="813" height="30"class="Mainheading"  >Production Personnel wise Processing Status Report - Arrival Period</td>
	    </tr></table></td>
	  </tr>
	  </table></td></tr>
	  ...
	  <input name="btnval" value="0" type="hidden">
	    <table  border="0" cellspacing="0" cellpadding="0" align="center" width="974"  style="border-collapse:collapse">
          ...
          <tr>
            <td width="30"></td>
            <td><table align="center" border="1" width="600" cellspacing="0" cellpadding="0" bordercolor="#adad11" style="border-collapse:collapse" >
