<?php
	...
	{
	//exit;
	$sql_arr=mysqli_query($link,"select * from tbl_pnpslipmain where pnpslipmain_id='".$pid."' and plantcode='$plantcode'") or die(mysqli_error($link));
	while($row_arr=mysqli_fetch_array($sql_arr))
	{
	$sql_arrsub=mysqli_query($link,"select * from tbl_pnpslipsub where pnpslipmain_id='".$pid."' and plantcode='$plantcode'") or die(mysqli_error($link));
	...
	while($row_arrsub=mysqli_fetch_array($sql_arrsub))
	{
		...
		$a="";
		$sql_barcode2=mysqli_query($link,"Select * from tbl_barcodestmp where bar_lotno='".$packlotno."' and bar_psrn='".$drefno."' and plantcode='$plantcode'") or die(mysqli_error($link));
		...
		if($tot_barcode2 > 0)
		{
			while($row_barcode2=mysqli_fetch_array($sql_barcode2))
			{
				...
				$bar_bctyp=$row_barcode2['bar_bctyp'];
		...
		$cnnt=0;
		$otrid=0;
		$sql_arrsubsub=mysqli_query($link,"select * from tbl_pnpslipsubsub where pnpslipmain_id='".$pid."' and pnpslipsub_id='".$row_arrsub['pnpslipsub_id']."' and plantcode='$plantcode'") or die(mysqli_error($link));
		...
		$sql_arrsubsub2=mysqli_query($link,"select * from tbl_pnpslipsubsub2 where pnpslipmain_id='".$pid."' and pnpslipsub_id='".$row_arrsub['pnpslipsub_id']."' and plantcode='$plantcode'") or die(mysqli_error($link));
		...
		while($row_arrsubsub2=mysqli_fetch_array($sql_arrsubsub2))
		{
			...
			$sql_issuetbl22=mysqli_query($link,"select * from tbl_lot_ldg where lotldg_id='".$oldtid."' and plantcode='$plantcode'") or die(mysqli_error($link)); 
			while($row_issuetbl22=mysqli_fetch_array($sql_issuetbl22))
			{
				...
				$sqlisstbl2=mysqli_query($link,"select * from tbl_lemain where le_lotno='".$lotno."' and plantcode='$plantcode'") or die(mysqli_error($link)); 
				...
				$sqlisstbl=mysqli_query($link,"select * from tbl_lemain where le_lotno='".$lot."' and plantcode='$plantcode'") or die(mysqli_error($link)); 
				...
				else*/
				{
					...
					$sampno=$plantcode.$yearid_id.sprintf("%000006d",$ncode2);
		...
		$sql_arrsubsub3=mysqli_query($link,"select * from tbl_pnpslipsubsub3 where pnpslipmain_id='".$pid."' and pnpslipsub_id='".$row_arrsub['pnpslipsub_id']."' and plantcode='$plantcode'") or die(mysqli_error($link));
		...
		while($row_arrsubsub3=mysqli_fetch_array($sql_arrsubsub3))
		{
			...
			foreach($b_arr as $bval1)
			{
				if($bval1<>"")
				{
					...
					$sql_tbl_barsub=mysqli_query($link,"select * from tbl_btslsub where btslsub_barcode='".$bval1."' and plantcode='$plantcode'") or die(mysqli_error($link));
			...
			foreach($zxcd as $bstlval)
			{
				if($bstlval<>"")
				{
					$sqlbstls=mysqli_query($link,"select * from tbl_btslsub where btsl_id='".$bstlval."' and plantcode='$plantcode'") or die(mysqli_error($link));
				...
				{
					$sql_qc2=mysqli_query($link,"Select * from tbl_qctest where tid='".$row_qc1[0]."' and plantcode='$plantcode'") or die(mysqli_error($link));
					$row_qc2=mysqli_fetch_array($sql_qc2);
					$ncode1=$row_qc2['sampleno'];
					$arrivaldate=$row_qc2['srdate'];
					$yrco=$row_qc2['yearid'];
		...
		$sql_code1="SELECT MAX(pnpslipmain_tcode) FROM tbl_pnpslipmain where pnpslipmain_ttype='Processing and Packing Slip' and plantcode='$plantcode' ORDER BY pnpslipmain_tcode DESC";
	$res_code1=mysqli_query($link,$sql_code1)or die(mysqli_error($link));
...
<td width="157" align="right"  valign="middle" class="smalltblheading">Processing Slip Ref. No.&nbsp;</td>
...
?>
    ...
    <?php
$sql_sel1="select * from tbl_rm_promac where promac_id='".$row_tbl['pnpslipmain_promachcode']."' and plantcode='$plantcode' order by promac_type";
...
$query_popr=mysqli_query($link,"SELECT * FROM tbl_rm_proopr where proopr_id='".$row_tbl['pnpslipmain_proopr']."' and plantcode='$plantcode'") or die("Error: " . mysqli_error($link));
...
<td align="center" valign="middle" class="smalltblheading"  colspan="2">Total C. Loss</td>
	...
	<td width="54" rowspan="2" align="center" valign="middle" class="smalltblheading">Pack Details</td>
...
$difq="";$difq1="";
$sloc=""; $sloc1=""; $cnt++; 
$sql_tbl_subsub=mysqli_query($link,"select * from tbl_pnpslipsubsub2 where pnpslipsub_id='".$row_tbl_sub['pnpslipsub_id']."' and pnpslipmain_id='".$arrival_id."' and plantcode='$plantcode' order by pnpslipsubsub_id asc") or die(mysqli_error($link));
...
$sql_whouse=mysqli_query($link,"select perticulars from tbl_warehouse where whid='".$row_tbl_subsub['pnpslipsubsub_wh']."' and plantcode='$plantcode' order by perticulars") or die(mysqli_error($link));
$row_whouse=mysqli_fetch_array($sql_whouse);
$wareh=$row_whouse['perticulars']."/";

$sql_binn=mysqli_query($link,"select binname from tbl_bin where binid='".$row_tbl_subsub['pnpslipsubsub_bin']."' and whid='".$row_tbl_subsub['pnpslipsubsub_wh']."' and plantcode='$plantcode'") or die(mysqli_error($link));
$row_binn=mysqli_fetch_array($sql_binn);
$binn=$row_binn['binname']."/";

$sql_subbinn=mysqli_query($link,"select sname from tbl_subbin where sid='".$row_tbl_subsub['pnpslipsubsub_subbin']."' and binid='".$row_tbl_subsub['pnpslipsubsub_bin']."' and whid='".$row_tbl_subsub['pnpslipsubsub_wh']."' and plantcode='$plantcode'") or die(mysqli_error($link));
...
?>
  <tr class="Light" height="20">
	...
	<td width="50" align="center" valign="middle" class="smalltbltext"><?php echo $row_tbl_sub['pnpslipsub_tlqty'];?></td>
