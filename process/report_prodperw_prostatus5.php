...
<?php
$qry="select arrival_id, arrival_date from tblarrival where arrtrflag=1 and arrival_id IN($arid) and plantcode='$plantcode'";
...
<tr class="tblsubtitle" height="20">
  ...
  <td width="50" align="center" valign="middle" class="smalltblheading" >Days</td>
			...
			<td width="105" align="center" valign="middle" class="smalltblheading">Organizer</td>
			 ...
			 <td width="58" align="center" valign="middle" class="smalltblheading">Bal. Raw<br />Seed Qty</td>
