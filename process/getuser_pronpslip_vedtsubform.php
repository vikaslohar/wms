<?php
	...
	$sql_tbl_sub=mysqli_query($link,"select * from tbl_pnpslipsub where pnpslipsub_id='".$a."' and plantcode='$plantcode'") or die(mysqli_error($link));
...
$lotqry=mysqli_query($link,"select distinct lotldg_whid, lotldg_subbinid, lotldg_binid from tbl_lot_ldg where lotldg_lotno='".$row['pnpslipsub_lotno']."'  and lotldg_balqty > 0 and plantcode='$plantcode'") or die(mysqli_error($link));
...
$nob=0; $qty=0; $softstatus=""; $qc=""; $qcdot=""; $qcdot1=""; $qcdot2=""; $qcdttype="";
 ...
 { 
$sql_issue1=mysqli_query($link,"select max(lotldg_id) from tbl_lot_ldg where lotldg_subbinid='".$row_issue['lotldg_subbinid']."' and lotldg_binid='".$row_issue['lotldg_binid']."' and lotldg_whid='".$row_issue['lotldg_whid']."' and lotldg_lotno='".$row['pnpslipsub_lotno']."' and plantcode='$plantcode'") or die(mysqli_error($link));
...
$tdt="";
$sql_qcs=mysqli_query($link,"Select * from tbl_qctest where oldlot='$ltno' and qcstatus='OK' and plantcode='$plantcode' order by tid desc Limit 0,2") or die(mysqli_error($link));
...
$sql_issue=mysqli_query($link,"select distinct lotldg_whid, lotldg_subbinid, lotldg_binid from tbl_lot_ldg where lotldg_lotno='".$row['pnpslipsub_lotno']."'  and lotldg_balqty > 0 and plantcode='$plantcode'") or die(mysqli_error($link));
...
$sql_tbl_subsub=mysqli_query($link,"select * from tbl_pnpslipsubsub where pnpslipsub_id='".$row['pnpslipsub_id']."' and pnpslipmain_id='".$tid."'  and pnpslipsubsub_wh='".$row_issuetbl['lotldg_whid']."' and pnpslipsubsub_bin='".$row_issuetbl['lotldg_binid']."' and pnpslipsubsub_subbin='".$row_issuetbl['lotldg_subbinid']."' and plantcode='$plantcode'") or die(mysqli_error($link));
...
<table align="center" border="1" width="970" cellspacing="0" cellpadding="0" bordercolor="#adad11" style="border-collapse:collapse" >	
  ...
  <td  align="center"  valign="middle" class="smalltbltext"><input name="picqtyp" id="picqtyp" type="text" size="8" class="smalltbltext" tabindex="" maxlength="10"  onkeypress="return isNumberKey(event)" onchange="pfpchk(this.value)" value="<?php echo $row['pnpslipsub_pickpqty'];?>"  />&nbsp;<font color="#FF0000" >* </font>&nbsp;</td>
...
$sql_tbl_subsub2=mysqli_query($link,"select * from tbl_pnpslipsubsub2 where pnpslipsub_id='".$row['pnpslipsub_id']."' and pnpslipmain_id='".$tid."' and plantcode='$plantcode' order by pnpslipsubsub_id asc") or die(mysqli_error($link));
...
<?php
$bind1_query=mysqli_query($link,"select binid, binname from tbl_bin where whid='".$row_tbl_subsub2['pnpslipsubsub_wh']."' and plantcode='$plantcode' order by binname") or die(mysqli_error($link));
?>
...
<?php
$subbind1_query=mysqli_query($link,"select sid, sname from tbl_subbin where binid='".$row_tbl_subsub2['pnpslipsubsub_bin']."' and plantcode='$plantcode' order by sname") or die(mysqli_error($link));
?>	
...
<td width="53" align="center" valign="middle" class="tbltext"><input type="checkbox" name="mpck_<?php echo $sno?>" id="mpck_<?php echo $sno?>" class="tbltext" value="Yes" onchange="mpchk(this.value, <?php echo $sno;?>)" <?php if($row12['uid']==$row['pnpslipsub_upsid'] && $row['pnpslipsub_convtomp']=="Yes") echo "checked"; else echo "disabled"; ?>  /></td>
...
<?php
$abrc="";
$s_sub3=mysqli_query($link,"select bar_barcodes from tbl_barcodestmp where bar_lotno='".$row['pnpslipsub_plotno']."' and bar_logid='".$logid."' and bar_psrn='".$row_tbl['pnpslipmain_proslipno']."' and plantcode='$plantcode'") or die(mysqli_error($link));
...
<?php
	$abc=""; $abcdef=""; 
	$sql_barcode2=mysqli_query($link,"select bar_barcodes from tbl_barcodestmp where bar_lotno='".$row['pnpslipsub_plotno']."' and bar_logid='".$logid."' and bar_psrn='".$row_tbl['pnpslipmain_proslipno']."' and plantcode='$plantcode'") or die(mysqli_error($link));
...
$sql_tbl_subsub3=mysqli_query($link,"select * from tbl_pnpslipsubsub3 where pnpslipsub_id='".$row['pnpslipsub_id']."' and pnpslipmain_id='".$tid."' and plantcode='$plantcode' order by pnpslipsubsub_id asc") or die(mysqli_error($link));
$rowsubsub3=mysqli_num_rows($sql_tbl_subsub3);
while($row_tbl_subsub3=mysqli_fetch_array($sql_tbl_subsub3))
{ 
$sno3=$sno3+1;
$nobcd="";
	$sql_tbl_bar=mysqli_query($link,"select * from tbl_btslmain where btsl_subbin='".$row_tbl_subsub3['pnpslipsubsub_subbin']."' and plantcode='$plantcode'") or die(mysqli_error($link));
...
$bind1_query=mysqli_query($link,"select binid, binname from tbl_bin where whid='".$row_tbl_subsub3['pnpslipsubsub_wh']."' and plantcode='$plantcode' order by binname") or die(mysqli_error($link));
?>
...
<?php
$subbind1_query=mysqli_query($link,"select sid, sname from tbl_subbin where binid='".$row_tbl_subsub3['pnpslipsubsub_bin']."' and plantcode='$plantcode' order by sname") or die(mysqli_error($link));
?>	
