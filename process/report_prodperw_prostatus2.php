...
<?php
$qry="select arrival_id, arrival_date from tblarrival where arrival_date <='".$edate."' and arrival_date >='".$sdate."'  and arrtrflag=1 and arrival_id IN($arid) ";
...
$cswqty=""; $tplqty=""; 
$sql_rr22=mysqli_query($link,"select * from tbl_proslipmain where proslipmain_crop='".$crp23."' and proslipmain_variety='".$ver23."' and proslipmain_stage='".$row_rr['sstage']."' and proslipmain_tflag=1 and plantcode='$plantcode' order by proslipmain_id asc") or die(mysqli_error($link));
