<?php
	...
	{	
		...
		$sql_ins="Insert into tbl_blendm (blendm_tcode, blendm_date, blendm_crop, blendm_variety, blendm_stage, blendm_nolots, blendm_remarks, blendm_logid, blendm_yearid, blendm_lottype, plantcode) values('$code', '$tdate', '$txtclass', '$txtitem', '$txtstage', '$txtnlottom', '$remarks', '$logid', '$yearid_id', '$lottype', '$plantcode')";
		//exit;
	...
	$sql_code="SELECT MAX(blendm_tcode) FROM tbl_blendm  where blendm_yearid='$yearid_id' and plantcode='$plantcode' ORDER BY blendm_tcode DESC";
		...
		if(mysqli_num_rows($res_code) > 0)
			{
				...
				$t_code=$row_code['0'];
				$code=$t_code+1;
				$code1="TLB".$code."/".$yearid_id."/".$lgnid;
			}
			else
			{
				$code=1;
...
function chkexplots(lotsval)
{
	...
	if(lotsval=="Export")
	{
		...
		{
			alert("Reserve Lot(s) for Export NOT FOUND. Please contact Plant Manager to Reserve Lot(s) for Export.");
			return false;
		}
	}
	else
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#adad11" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#adad11" style="border-bottom:solid; border-bottom-color:#adad11" >
	    <tr >
	      <td width="813" height="25" class="Mainheading">&nbsp;Transaction - Lot Blending - ADD</td>
	    </tr></table></td>
...
<td align="left" valign="middle" class="tbltext">&nbsp;<input type="radio" name="lottype" id="lottype" value="Regular" checked="checked" onclick="chkexplots(this.value)" />&nbsp;Regular&nbsp;&nbsp;<input type="radio" name="lottype" id="lottype" value="Export" onclick="chkexplots(this.value)" />&nbsp;Export</td>

<td align="right" valign="middle" class="tblheading">Select Export Lot&nbsp;</td>
<td align="left" valign="middle" class="tbltext" id="lotnshow" >&nbsp;<select class="tbltext" name="txtexplot" id="txtexplot" style="width:150px;" disabled="disabled" >
<option value="" selected>---Select Export Lot---</option>
</select>&nbsp;<font color="#FF0000">*</font>&nbsp;<input type="hidden" name="totlotnos" value="0" /> </td>

</tr>

<tr class="Dark" height="30" >
<td align="right" valign="middle" class="tblheading">Select Lot(s) for Blending&nbsp;</td>
<td align="left" valign="middle" class="tbltext">&nbsp;<input name="txtlot1" type="hidden" class="tbltext" tabindex="" value=""  >&nbsp;<a href="Javascript:void(0);" onclick="openslocpop();">Select</a></td>

<td align="right" valign="middle" class="tblheading">No. of Lots for Blending&nbsp;</td>
<td align="left" valign="middle" class="tbltext" colspan="3">&nbsp;<input type="text" name="txtnlottom" class="tbltext" size="1" maxlength="2" value="" readonly="true" style="background-color:#CCCCCC"  />&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
