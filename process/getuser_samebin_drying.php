...
$sql_whouse1=mysqli_query($link,"select perticulars from tbl_warehouse where whid='".$b."' and plantcode='$plantcode' order by perticulars") or die(mysqli_error($link));
$row_whouse1=mysqli_fetch_array($sql_whouse1);
$wareh1=$row_whouse1['perticulars'];

$sql_binn1=mysqli_query($link,"select binname from tbl_bin where binid='".$c."' and whid='".$b."' and plantcode='$plantcode'") or die(mysqli_error($link));
$row_binn1=mysqli_fetch_array($sql_binn1);
$binn1=$row_binn1['binname'];

$sql_subbinn1=mysqli_query($link,"select sname from tbl_subbin where sid='".$f."' and binid='".$c."' and whid='".$b."' and plantcode='$plantcode'") or die(mysqli_error($link));
