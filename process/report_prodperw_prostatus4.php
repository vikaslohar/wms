...
<title>Processing - Report - Production Personnel wise Processing Status Report</title>
...
<tr class="tblsubtitle" height="20">
  ...
  <td width="35" align="center" valign="middle" class="smalltblheading" >Days</td>
			...
			<td width="98" align="center" valign="middle" class="smalltblheading">Organizer</td>
			 ...
			 <td width="57" align="center" valign="middle" class="smalltblheading">Bal. Raw<br />Seed Qty</td>
...
//echo "select * from tbl_proslipsub where proslipmain_id='".$row_rr22['proslipmain_id']."' and proslipsub_lotno='".$lotno."' and plantcode='$plantcode' order by proslipsub_lotno asc<br />";
