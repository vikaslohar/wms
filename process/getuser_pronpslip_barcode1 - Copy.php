...
echo "<div id='barserch$ccnt' style='padding:5px,5px,5px,5px;vertical-align:top;'><input type='text' name='confbarcodes$ccnt' id='confbarcodes$ccnt' onkeyup='searchbarcode(this.value,$ccnt)' onkeypress='return isNumberKey24(event)' onblur='chkbalbar(this.value,$ccnt)' size='10' maxlength='9' class='tbltext' value='$sysarr1'><input type='hidden' name='totbarok$ccnt' id='totbarok$ccnt' value='1' /><font color='#FF0000' >* </font> </div>"; } }?><input type="hidden" name="totdupbar" value="<?php echo $count;?>" /></td>
