...
<tr class="tblsubtitle" height="20">
  <td colspan="8" align="center" class="tblheading">Processing and Packing Slip Preview</td>
</tr>
...
<td width="137" align="left"  valign="middle" class="smalltbltext" >&nbsp;<?php echo $noticia['cropname'];?>&nbsp;</td>
			   <?php
...
?>
	<td width="103" align="right"  valign="middle" class="smalltblheading" >Variety&nbsp;</td>
    <td width="170" align="left"  valign="middle" class="smalltbltext" id="vitem">&nbsp;<?php echo $noticia_item['popularname'];?>&nbsp;</td>
	
	<td width="139" align="right"  valign="middle" class="smalltblheading" >Seed Stage&nbsp;</td>
    <td width="154" align="left"  valign="middle" class="smalltbltext" id="vitem">&nbsp;<?php echo $row_tbl['pnpslipmain_stage'];?>&nbsp;</td>
...
?>
  <tr class="Light" height="20">
	...
	<td width="107" align="center" valign="middle" class="smalltbltext">&nbsp;</td>
