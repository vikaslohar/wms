...
//$a="c";
	//$a="c";
	$sql_code="SELECT MAX(arrival_code) FROM tblarrival where arrival_type='Trading' and plantcode='$plantcode' ORDER BY arrival_code DESC";
...
*/--><tr class="Light" height="30">
<td width="203" align="right" valign="middle" class="tblheading">Seed Stage&nbsp;</td>
<td  align="left" valign="middle" class="tbltext"  >&nbsp;<select class="tbltext" name="txtstage" style="width:170px;" onChange="sschk1()">
    <option value="" selected>--Select--</option>
    <option value="Raw Seed" >Raw Seed</option>
    <option value="Conditioned Seed" >Conditioned Seed</option>
	 <option value="Pack Seed" >Pack Seed</option>
  </select>&nbsp;<font color="#FF0000">*</font>	</td>

<td width="131" align="right" valign="middle" class="tblheading">Process Code&nbsp;</td>
...
<table align="center" border="1" cellspacing="0" cellpadding="0" width="850" bordercolor="#adad11" style="border-collapse:collapse">
	...
	<td width="10%" align="center" rowspan="3" valign="middle" class="tblheading"> Lot No.</td>
	 <td width="10%" align="center" valign="middle" class="tblheading" colspan="2">Raw Seed </td>
	 <td width="10%" align="center" valign="middle" class="tblheading" colspan="2">Conditioned Seed </td>
     <td width="10%" align="center" valign="middle" class="tblheading" colspan="3">Remanant</td>

	 	 <td width="10%" align="center" valign="middle" class="tblheading" colspan="2">Inert Matter </td>
<td width="10%" align="center" valign="middle" class="tblheading" colspan="2">Inert Matter </td>
		  <!--/*<td width="9%" rowspan="3" align="center" valign="middle" class="tblheading">QC Status </td>	 
		   <td width="12%" rowspan="3" align="center" valign="middle" class="tblheading">GOT Type </td>*/-->-->
		 	...
		 	<td width="8%" rowspan="3" align="center" valign="middle" class="tblheading">Remarks</td>
...
<tr class="Light" height="30">
<td align="right" width="204" valign="middle" class="tblheading" style="border-color:#adad11">&nbsp;Lot No.&nbsp;</td>
<td align="left" width="272" valign="middle" class="tbltext" style="border-color:#adad11">&nbsp;<input name="txtlot1" type="text" size="20" class="tbltext" tabindex=""  maxlength="20"  value="" onchange="ltchk(this.value);"  onBlur="javascript:this.value=this.value.toUpperCase();">&nbsp;<font color="#FF0000">*</font>&nbsp;<a href="Javascript:void(0);" onclick="openslocpop();">Select</a></td>
<td align="left" width="366" valign="middle" class="tblheading" style="border-color:#adad11">&nbsp;<a href="javascript:void(0);" onclick="getdetails();" >Get details</a></td>
</tr>
</table>
