...
<title>Processing - Transaction - Processing and Packing Slip - Home</title>
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#adad11" >
	  ...
	  <table width="820" border="0" cellpadding="0" cellspacing="0" bordercolor="#adad11" style="border-bottom:solid; border-bottom-color:#adad11" >
	    <tr >
	      <td width="820" height="25" class="Mainheading">&nbsp;Transaction - Processing and Packing slip</td>
	    </tr></table></td>
...
<td align="center" width="100" valign="middle" class="tblbutn" style="cursor:Pointer;"><?php if($flg==0 && $flg1==0 && $flg2==0) { ?><a href="add_pronpslip_ slip.php" style="text-decoration:none; color:#000000">Add </a><?php } else { ?><a href="Javascript:void(0);" onClick="alert('Can not perform Transaction.\nReason:\n1. Todays date is not in Active Current Financial Year.\n2. Transaction after todays date has been made.\n3. Cycle Inventory transaction is under process.');" style="text-decoration:none; color:#000000">Add </a><?php } ?></td>
</tr>
</table></td>
...
$targetpage = $_SERVER['PHP_SELF']; 
  ...
  $sql_arr_home=mysqli_query($link,"select * from tbl_pnpslipmain where pnpslipmain_ttype='Processing and Packing Slip' and pnpslipmain_date>='$tdate' and pnpslipmain_date<='$pdate' and pnpslipmain_tflag=1 and plantcode='$plantcode' order by pnpslipmain_tcode desc LIMIT $start, $limit") or die(mysqli_error($link));
 $tot_arr_home=mysqli_num_rows($sql_arr_home);
...
$query = "select * from tbl_pnpslipmain where pnpslipmain_ttype='Processing and Packing Slip' and pnpslipmain_date>='$tdate' and pnpslipmain_date<='$pdate' and pnpslipmain_tflag=1 and plantcode='$plantcode' order by pnpslipmain_tcode desc";
...
$sql_arr_home=mysqli_query($link,"select * from tbl_pnpslipmain where pnpslipmain_ttype='Processing and Packing Slip' and pnpslipmain_date>='$tdate' and pnpslipmain_date<='$pdate' and pnpslipmain_tflag=1 order by pnpslipmain_tcode desc LIMIT $from, $max_results") or die(mysqli_error($link));
$tot_arr_home=mysqli_num_rows($sql_arr_home);
//$tot_arr_home=0;

$total_results3 =mysqli_query($link,"SELECT COUNT(*)  FROM tbl_pnpslipmain where pnpslipmain_ttype='Processing and Packing Slip' and pnpslipmain_date>='$tdate' and pnpslipmain_date<='$pdate' and pnpslipmain_tflag=1");
$total_results2 = mysqli_fetch_array($total_results3);
$total_results = $total_results2[0]; */
...
<tr class="Light" height="20">
  <td colspan="6" align="center" class="tblheading">Processing and Packing slip</td>
</tr>
</table>
...
<tr class="Light">
         ...
         <td align="center" valign="middle" class="smalltbltext"><a href="add_pronpslip_view.php?p_id=<?php echo $arrival_id;?>"><?php echo "PS".$row_arr_home['pnpslipmain_tcode']."/".$yearid_id."/".$lrole;?></a></td>
...
<tr >
<td valign="top" align="right"><a href="home_pronpslip.php"><img src="../images/back.gif" border="0"style="display:inline;cursor:Pointer;" /></a></td>
</tr>
</table>
