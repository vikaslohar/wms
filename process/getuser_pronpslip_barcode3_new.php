<?php
	...
	$abarc=""; $wtrc=""; $wtdt=''; $opcd=""; $wtmcd=""; $gwt="";
	$sql_barcode24=mysqli_query($link,"Select * from tbl_barcodestmp where bar_lotno='".$lotno."' and bar_tid='".$tid."' and bar_subid='".$subtid."' and bar_logid='".$logid."' and bar_psrn='".$txtpsrn."' and plantcode='$plantcode'") or die(mysqli_error($link));
	...
	{ $cont=0;
		while($row_barcode24=mysqli_fetch_array($sql_barcode24))
		{
			...
			if($row_barcode24['bar_bctyp']=="range")
	...
	{
		$dobg1=explode("-",$wtdt);
		$dobg=$dobg1[2]."-".$dobg1[1]."-".$dobg1[0];
	}

	$zx="";$a="";$b="";
	$sql_barcode=mysqli_query($link,"Select bar_barcode from tbl_barcodes where bar_lotno='".$lotno."' and bar_trid='".$tid."' and bar_subtrid='".$subtid."' and logid='".$logid."' and plantcode='$plantcode'") or die(mysqli_error($link));
...
<td width="50%" align="right" class="tblheading" >No of Barcodes to be entered - as per Master Packs&nbsp;</td><td align="left" class="tblheading">&nbsp;<input type="text" name="nobapmp" id="nobapmp" class="tbltext" value="<?php echo $totnomp;?>" style="background-color:#CCCCCC" readonly="true" size="5" /></td>
</tr>
<tr class="light" height="20">
  <td  align="right" class="tblheading">No of Barcodes entered&nbsp;</td><td  align="left" class="tblheading">&nbsp;<input type="text" name="nobe" id="nobe" class="tbltext" style="background-color:#CCCCCC" readonly="true" size="5" value="<?php echo $nobe;?>" /></td>
</tr>
<!--<tr class="light" height="20">
...
<tr class="light" height="20">
  <td  align="right" class="tblheading">Net Number of Barcodes&nbsp;</td><td  align="left" class="tblheading">&nbsp;<input type="text" name="nnob" id="nnob" class="tbltext" style="background-color:#CCCCCC" readonly="true" size="5" value="<?php echo $nnob-$count;?>" /></td>
</tr>
...
<tr class="light" height="20">
  ...
  <td align="left" class="tblheading">&nbsp;<input type="text" name="gwt" id="gwt" class="tbltext" style="background-color:#CCCCCC" readonly="true" size="5" value="<?php echo $gwt;?>" /></td>
</tr>
<?php
}
?>
<tr class="Dark" height="25">
<td  align="center" valign="middle" class="tblheading" colspan="2">Selected Barcodes</td>
...
<tr class="Dark" height="25">
<td align="center" valign="Top" class="tblheading" colspan="2"><?php $ccnt=0; foreach($main_array1 as $mainarr) if($mainarr<>"") { $ccnt++; echo $mainarr."<br/>"; echo "<input type='hidden' name='confbarcodes$ccnt' id='confbarcodes$ccnt' readonly='true' size='10' maxlength='9' class='tbltext' value='$mainarr'>"; } ?><input type="hidden" name="sysarr" value="<?php echo $ccnt;?>" /></td>
<!--<td width="25%" align="center" valign="Top" class="tblheading"><?php foreach($so_array1 as $soarr) if($soarr<>"") echo $soarr."<br/>"; ?></td>-->
<!--<td width="50%" align="center" valign="Top" class="tblheading" style="padding-top:5px;"><?php $ccnt=0; if($cont > 0){foreach($main_array1 as $sysarr1) { if($sysarr1<>"") { $ccnt++; 
...
<tr >
<td align="center" colspan="3">&nbsp;<img src="../images/close_1.gif" border="0" style="cursor:pointer" onClick="mycancel();" />&nbsp;<!--<input type="image" src="../images/submit.gif" alt="Submit Value" border="0" style="display:inline;cursor:pointer;" onclick="return mySubmit();"/>--></td>
</tr>
</table>
</form>
</td></tr>
