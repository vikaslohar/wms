...
<td align="center" valign="middle" class="smalltblheading"  colspan="2">Total C. Loss</td>
	...
	<td width="108" rowspan="2" align="center" valign="middle" class="smalltblheading">Pack Details</td>
...
?>
  <tr class="Light" height="20">
	...
	<td width="108" align="center" valign="middle" class="smalltbltext"><a href="Javascript:void(0)" onclick="openpackdetails(<?php echo $row_tbl_sub['pnpslipsub_id']?>,<?php echo $arrival_id;?>)">View</a></td>
