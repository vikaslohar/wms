<?php
	...
	//exit;
		...
		if(isset($_REQUEST['sno7'])) { $sno7= $_REQUEST['sno7']; }
...
//echo "<br />";
		...
		if($sno7>0)	
		{
			for($i=1; $i<=$sno7; $i++)
			{
				$txtconstlotx="txtconstlotc".$i;
				$txtconstremx="txtconstremc".$i;
				$txtconstimx="txtconstimc".$i;
				$txtconstplx="txtconstplc".$i;
				$txtconstlossx="txtconstlossc".$i;
				$txtconstperx="txtconstperc".$i;
	...
	//echo "<br />";				
				...
				if($srflg>0)
				{
					...
					if($pcktype=="P")
					{
						...
						{
							$id=mysqli_insert_id($link);
							$sql_srsub="Insert into tbl_softr_sub (softr_id, softrsub_lotno, softrsub_srtyp, softrsub_srflg, plantcode) values('$id', '$orlotnc', '$type', '1', '$plantcode')";
							$ss=mysqli_query($link,$sql_srsub) or die(mysqli_error($link));
						}	
				...
				{
					$sql_sub_sub1244="insert into tbl_qctest(pp, moist, lotno, srdate, crop, variety, sampleno, trstage, qc, state, gs, oldlot, yearid, logid, plantcode) values ('$vchk2', '$moist2', '$clotno', '$arrival_date', '$crop', '$variety', '$ncode1', '$sstage2', '$qc2', '$state',1 ,'$orlot2', '$yearid_id', '$logid', '$plantcode')";
...
function chkconqty()
{
	...
	if(document.frmaddDepartment.txtconper.value!="")
	{
		if(document.frmaddDepartment.blendstage.value!="")
		{
			if(document.frmaddDepartment.blendstage.value=="Raw")
			{
				var rm=0; var im=0; var pl=0; var totpl=0; var totper=0; var exqty=0;
				for(var i=1; i<=document.frmaddDepartment.sno6.value; i++)
				{
					var txtconstlotqty="txtconstlotqty"+i;
					var txtconstrem="txtconstrem"+i;
					var txtconstim="txtconstim"+i;
					var txtconstpl="txtconstpl"+i;
					var txtconstloss="txtconstloss"+i;
					var txtconstper="txtconstper"+i;
					
					document.getElementById(txtconstrem).value=(parseFloat(document.getElementById(txtconstlotqty).value)*parseFloat(document.frmaddDepartment.txtconper.value))/100;
					document.getElementById(txtconstrem).value=parseFloat(document.getElementById(txtconstrem).value).toFixed(3);
					document.getElementById(txtconstim).value=0;
					document.getElementById(txtconstpl).value=0;
					document.getElementById(txtconstloss).value=(parseFloat(document.getElementById(txtconstrem).value)+parseFloat(document.getElementById(txtconstim).value)+parseFloat(document.getElementById(txtconstpl).value));
					document.getElementById(txtconstloss).value=parseFloat(document.getElementById(txtconstloss).value).toFixed(3);
					document.getElementById(txtconstper).value=parseFloat(document.frmaddDepartment.txtconper.value);
					
					exqty=parseFloat(exqty)+parseFloat(document.getElementById(txtconstlotqty).value); 
					rm=parseFloat(rm)+parseFloat(document.getElementById(txtconstrem).value); 
					im=parseFloat(im)+parseFloat(document.getElementById(txtconstim).value); 
					pl=parseFloat(pl)+parseFloat(document.getElementById(txtconstpl).value); 
					totpl=parseFloat(totpl)+parseFloat(document.getElementById(txtconstloss).value); 
					totper=parseFloat(document.getElementById(txtconstper).value);
					
				}
					
					var totconstlotqty="totconstlotqty";
					var totconstrem="totconstrem";
					var totconstim="totconstim";
					var totconstpl="totconstpl";
					var totconstloss="totconstloss";
					var totconstper="totconstper";
					
					document.getElementById(totconstlotqty).value=parseFloat(exqty);
					document.getElementById(totconstrem).value=parseFloat(rm);
					document.getElementById(totconstim).value=parseFloat(im);
					document.getElementById(totconstpl).value=parseFloat(pl);
					document.getElementById(totconstloss).value=parseFloat(totpl);
					document.getElementById(totconstper).value=parseFloat(totper);
...
function calconstlossper(selval)
{
	//alert(selval); alert(document.frmaddDepartment.txtconper.value); alert(document.frmaddDepartment.blendstage.value);
	if(document.frmaddDepartment.txtconper.value=="")
	{
		alert("Please enter Condition Loss of Blended Lot");
		document.frmaddDepartment.txtconstconpersel.selectedIndex=0
		return false;
	}
	if(document.frmaddDepartment.txtconper.value!="")
	{
		if(document.frmaddDepartment.blendstage.value!="")
		{
			if(document.frmaddDepartment.sno7.value>0)
			{
				var rm=0; var im=0; var pl=0; var totpl=0; var totper=0; var exqty=0;
				for(var i=1; i<=document.frmaddDepartment.sno7.value; i++)
				{
					var txtconstlotqty="txtconstlotqtyc"+i;
					var txtconstrem="txtconstremc"+i;
					var txtconstim="txtconstimc"+i;
					var txtconstpl="txtconstplc"+i;
					var txtconstloss="txtconstlossc"+i;
					var txtconstper="txtconstperc"+i;
					
					document.getElementById(txtconstrem).value=(parseFloat(document.getElementById(txtconstlotqty).value)*parseFloat(selval))/100;
					document.getElementById(txtconstrem).value=parseFloat(document.getElementById(txtconstrem).value).toFixed(3);
					document.getElementById(txtconstim).value=0;
					document.getElementById(txtconstpl).value=0;
					document.getElementById(txtconstloss).value=(parseFloat(document.getElementById(txtconstrem).value)+parseFloat(document.getElementById(txtconstim).value)+parseFloat(document.getElementById(txtconstpl).value));
					document.getElementById(txtconstloss).value=parseFloat(document.getElementById(txtconstloss).value).toFixed(3);
					document.getElementById(txtconstper).value=parseFloat(selval);
					...
					var totconstlotqty="totconstlotqtyc";
					var totconstrem="totconstremc";
					var totconstim="totconstimc";
					var totconstpl="totconstplc";
					var totconstloss="totconstlossc";
					var totconstper="totconstperc";
			...
			if(document.frmaddDepartment.sno6.value>0)
			{
				var plper=0;
				for( var i=1; i<=document.frmaddDepartment.srno2.value; i++)
				{
				...
				var newq=(parseFloat(document.frmaddDepartment.txtconloss.value)*parseFloat(selval))/100;
				var newqty=parseFloat(document.frmaddDepartment.txtconloss.value)-parseFloat(newq)
				var newqper=(parseFloat(newqty)/parseFloat(plper))*100;
				newqper=parseFloat(newqper).toFixed(3);
				//alert(newq);alert(newqty);alert(newqper);
				...
				for(var i=1; i<=document.frmaddDepartment.sno6.value; i++)
				{
					...
					document.getElementById(txtconstrem).value=(parseFloat(document.getElementById(txtconstlotqty).value)*parseFloat(newqper))/100;
					document.getElementById(txtconstrem).value=parseFloat(document.getElementById(txtconstrem).value).toFixed(3);
					document.getElementById(txtconstim).value=0;
					document.getElementById(txtconstpl).value=0;
					document.getElementById(txtconstloss).value=(parseFloat(document.getElementById(txtconstrem).value)+parseFloat(document.getElementById(txtconstim).value)+parseFloat(document.getElementById(txtconstpl).value));
					document.getElementById(txtconstloss).value=parseFloat(document.getElementById(txtconstloss).value).toFixed(3);
					document.getElementById(txtconstper).value=parseFloat(newqper);
...
$subtid=0; $txtremarks=''; $blendlot='no'; $ltno=''; $blendstage="";


$qryblendlots=mysqli_query($link,"SELECT blendm_id FROM tbl_blends where blends_newlot='".$row_trdetails_sub['pnpslipsub_lotno']."'  order by blends_lotno Asc"); 
$rowblendlots = mysqli_fetch_array($qryblendlots);

$qryblendm=mysqli_query($link,"SELECT blendm_stage FROM tbl_blendm where blendm_id='".$rowblendlots['blendm_id']."'  order by blendm_id Asc"); 
while($rowblendm = mysqli_fetch_array($qryblendm))
{
	$blendlot="yes"; 
	$blendstage=$rowblendm['blendm_stage'];
}
...
$sql_pnpsubsub=mysqli_query($link,"select * from tbl_pnpslipsubsub where pnpslipsub_id='".$row_trdetails_sub['pnpslipsub_id']."' ") or die(mysqli_error($link));
...
<input type="hidden" name="blendstage" value="<?php echo $blendstage; ?>" />
<br />
<?php 
...
<table align="center" border="1" width="970" cellspacing="0" cellpadding="0" bordercolor="#adad11" style="border-collapse:collapse" >	
  <tr class="tblsubtitle" height="25">
	...
	<td rowspan="2" align="center" valign="middle" class="smalltblheading" >Qty</td>
...
$qry_blendlots=mysqli_query($link,"SELECT * FROM tbl_blends where blends_orlot='".$ltno."'  order by blends_lotno Asc"); 
...
?>
  <tr class="Light" height="25">
    <td width="152" align="center" valign="middle" class="smalltblheading"><input type="text" name="txtconstlot<?php echo $sno6;?>" id="txtconstlot<?php echo $sno6;?>" class="smalltbltext" value="<?php echo $row_blendlots['blends_lotno'];?>" size="18" readonly="true" style="background-color:#CCCCCC"  /></td>
	 <td width="152" align="center" valign="middle" class="smalltblheading"><input type="text" name="txtconstlotqty<?php echo $sno6;?>" id="txtconstlotqty<?php echo $sno6;?>" class="smalltbltext" value="<?php echo $row_blendlots['blends_qty'];?>" size="8" readonly="true" style="background-color:#CCCCCC"  /></td>
	<td align="center" valign="middle" class="smalltblheading"><input type="text" name="txtconstrem<?php echo $sno6;?>" id="txtconstrem<?php echo $sno6;?>" class="smalltbltext" value="" size="8" readonly="true" style="background-color:#CCCCCC"  /></td>
	<td align="center" valign="middle" class="smalltblheading"><input type="text" name="txtconstim<?php echo $sno6;?>" id="txtconstim<?php echo $sno6;?>" class="smalltbltext" value="" size="8"  readonly="true" style="background-color:#CCCCCC"  /></td>
    <td align="center" valign="middle" class="smalltblheading"><input type="text" name="txtconstpl<?php echo $sno6;?>" id="txtconstpl<?php echo $sno6;?>" class="smalltbltext" value="" size="8"  readonly="true" style="background-color:#CCCCCC"  /></td>
...
?>  
<tr class="Light" height="25">
    <td width="152" align="center" valign="middle" class="smalltblheading">Total</td>
	 <td width="152" align="center" valign="middle" class="smalltblheading"><input type="text" name="totconstlotqty" id="totconstlotqty" class="smalltbltext" value="" size="8" readonly="true" style="background-color:#CCCCCC"  /></td>
	<td align="center" valign="middle" class="smalltblheading"><input type="text" name="totconstrem" id="totconstrem" class="smalltbltext" value="" size="8"  readonly="true" style="background-color:#CCCCCC"  /></td>
	<td align="center" valign="middle" class="smalltblheading"><input type="text" name="totconstim" id="totconstim" class="smalltbltext" value="" size="8"  readonly="true" style="background-color:#CCCCCC"  /></td>
    <td align="center" valign="middle" class="smalltblheading"><input type="text" name="totconstpl" id="totconstpl" class="smalltbltext" value="" size="8" readonly="true" style="background-color:#CCCCCC"  /></td>
    <td width="98" align="center" valign="middle" class="smalltblheading" ><input type="text" name="totconstloss" id="totconstloss" class="smalltbltext" value="" size="8" readonly="true" style="background-color:#CCCCCC" /></td>
    <td width="95" align="center" valign="middle" class="smalltblheading"><input type="text" name="totconstper" id="totconstper" class="smalltbltext" value="" size="8" readonly="true" style="background-color:#CCCCCC" /></td>
  </tr>
</table>
<?php
}
...
<table align="center" border="1" width="970" cellspacing="0" cellpadding="0" bordercolor="#adad11" style="border-collapse:collapse" >	
  <tr class="tblsubtitle" height="25">
    <td  align="center" valign="middle" class="tblheading" >&nbsp;Constituent Condition Lots Details</td>
  </tr>
</table>
<table align="center" border="1" width="970" cellspacing="0" cellpadding="0" bordercolor="#adad11" style="border-collapse:collapse" >	
  <tr class="Dark" height="25">
    <td width="50%" align="right" valign="middle" class="tblheading" >Select Processing Loss Percentage for Condition Lots&nbsp;</td>
	<td  align="left" valign="middle" class="tblheading" >&nbsp;<select class="smalltbltext" name="txtconstconpersel" id="txtconstconpersel" style="width:60px;" onchange="calconstlossper(this.value)">
...
<?php 
//echo "SELECT blends_lotno from tbl_blends where blends_orlot='".$ltno."'  order by blends_lotno Asc";
$qry_blendlots=mysqli_query($link,"SELECT * FROM tbl_blends where blends_orlot='".$ltno."' and SUBSTRING(blends_lotno, 17, 1)='C'  order by blends_lotno Asc"); 
while($row_blendlots = mysqli_fetch_array($qry_blendlots))
{
$sno7=$sno7+1;
?>
  <tr class="Light" height="25">
    <td width="152" align="center" valign="middle" class="smalltblheading"><input type="text" name="txtconstlotc<?php echo $sno7;?>" id="txtconstlotc<?php echo $sno7;?>" class="smalltbltext" value="<?php echo $row_blendlots['blends_lotno'];?>" size="18" readonly="true" style="background-color:#CCCCCC"  /></td>
	 <td width="152" align="center" valign="middle" class="smalltblheading"><input type="text" name="txtconstlotqtyc<?php echo $sno7;?>" id="txtconstlotqtyc<?php echo $sno7;?>" class="smalltbltext" value="<?php echo $row_blendlots['blends_qty'];?>" size="8" readonly="true" style="background-color:#CCCCCC"  /></td>
	<td align="center" valign="middle" class="smalltblheading"><input type="text" name="txtconstremc<?php echo $sno7;?>" id="txtconstremc<?php echo $sno7;?>" class="smalltbltext" value="" size="8" readonly="true" style="background-color:#CCCCCC"  /></td>
	<td align="center" valign="middle" class="smalltblheading"><input type="text" name="txtconstimc<?php echo $sno7;?>" id="txtconstimc<?php echo $sno7;?>" class="smalltbltext" value="" size="8" readonly="true" style="background-color:#CCCCCC"  /></td>
    <td align="center" valign="middle" class="smalltblheading"><input type="text" name="txtconstplc<?php echo $sno7;?>" id="txtconstplc<?php echo $sno7;?>" class="smalltbltext" value="" size="8"  readonly="true" style="background-color:#CCCCCC"  /></td>
    <td width="98" align="center" valign="middle" class="smalltblheading" ><input type="text" name="txtconstlossc<?php echo $sno7;?>" id="txtconstlossc<?php echo $sno7;?>" class="smalltbltext" value="" size="8" readonly="true" style="background-color:#CCCCCC" /></td>
    <td width="95" align="center" valign="middle" class="smalltblheading"><input type="text" name="txtconstperc<?php echo $sno7;?>" id="txtconstperc<?php echo $sno7;?>" class="smalltbltext" value="" size="8" readonly="true" style="background-color:#CCCCCC" /></td>
  </tr>
<?php
}
?>  
<tr class="Light" height="25">
    <td width="152" align="center" valign="middle" class="smalltblheading">Total</td>
	 <td width="152" align="center" valign="middle" class="smalltblheading"><input type="text" name="totconstlotqtyc" id="totconstlotqtyc" class="smalltbltext" value="" size="8" readonly="true" style="background-color:#CCCCCC"  /></td>
	<td align="center" valign="middle" class="smalltblheading"><input type="text" name="totconstremc" id="totconstremc" class="smalltbltext" value="" size="8"  readonly="true" style="background-color:#CCCCCC"  /></td>
	<td align="center" valign="middle" class="smalltblheading"><input type="text" name="totconstimc" id="totconstimc" class="smalltbltext" value="" size="8"  readonly="true" style="background-color:#CCCCCC"  /></td>
    <td align="center" valign="middle" class="smalltblheading"><input type="text" name="totconstplc" id="totconstplc" class="smalltbltext" value="" size="8" readonly="true" style="background-color:#CCCCCC"  /></td>
    <td width="98" align="center" valign="middle" class="smalltblheading" ><input type="text" name="totconstlossc" id="totconstlossc" class="smalltbltext" value="" size="8" readonly="true" style="background-color:#CCCCCC" /></td>
    <td width="95" align="center" valign="middle" class="smalltblheading"><input type="text" name="totconstperc" id="totconstperc" class="smalltbltext" value="" size="8" readonly="true" style="background-color:#CCCCCC" /></td>
  </tr>
</table>
...
<table align="center" border="1" width="970" cellspacing="0" cellpadding="0" bordercolor="#adad11" style="border-collapse:collapse" >	
  <tr class="tblsubtitle" height="25">
    <td  align="center" valign="middle" class="tblheading" >&nbsp;Constituent Raw Lots Details</td>
  </tr>
</table>
<table align="center" border="1" width="970" cellspacing="0" cellpadding="0" bordercolor="#adad11" style="border-collapse:collapse" >	
  <tr class="tblsubtitle" height="25">
...
<?php 
//echo "SELECT blends_lotno from tbl_blends where blends_orlot='".$ltno."'  order by blends_lotno Asc";
$qry_blendlots=mysqli_query($link,"SELECT * FROM tbl_blends where blends_orlot='".$ltno."'  and SUBSTRING(blends_lotno, 17, 1)='R'  order by blends_lotno Asc"); 
while($row_blendlots = mysqli_fetch_array($qry_blendlots))
{
$sno6=$sno6+1;
?>
...
?>
<input type="hidden" name="sno6" value="<?php echo $sno6;?>" /> <input type="hidden" name="sno7" value="<?php echo $sno7;?>" />
<br />
