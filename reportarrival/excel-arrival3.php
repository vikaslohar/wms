...
session_start();
	...
	if($typ=="StockTransfer Arrival")	{$tlp="StockTransfer Arrival";}
 		
	$dh="Arrival".$tlp."_From_".$_REQUEST['sdate']."_To_".$_REQUEST['edate'];
	$datahead = array($dh);
	//$datahead1 = array("Arrival Report");
	$datahead2 = array("Arrival Report:",$tlp,"  Period From ",$_REQUEST['sdate'],"  To ",$_REQUEST['edate']);
	$data1 = array();
...
function cleanData(&$str)
 ...
 $datatitle2 = array("","","","","","","","NoB","Qty","NoB","Qty","NoB","Qty");
	 $datatitle3 = array("#","Date of Arrival","Arrival From Plant","Crop","Variety","Lot No.","STN No.","","As Per STN","","As Per Actual","","Difference");
$d=1;
...
$slocs=$wareh.$binn.$subbinn."<br/>";
				...
				*/
				...
				$sql_usr=mysqli_query($link,"select * from tbluser where scode='".$row_arr['logid']."'") or die(mysqli_error($link));
...
if($tot_arr_home > 0)			
{
$data1[$d]=array($d,$trdate,$party,$crop,$variety,$lotno,$stnno,$dcn,$dcq,$acn,$ac,$difn,$difq,$org,$far,$loc); 
$d++;
}
}
}
