...
<title>Lgen- Transaction -Home_tagging</title>
...
<table width="1003" height="600" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#F1B01E" >
	  ...
	  <td width="820" class="Mainheading" height="25"><table width="820" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" style="border-bottom:solid; border-bottom-color:#F1B01E" >
        <tr >
          <td width="820" height="25">&nbsp;Transaction - Lots Import Acknowledgement</td>
        </tr>
	    </table></td>
...
<?php
	$sql_arr_home=mysqli_query($link,"select max(lotimpdate),lotimpid from tbllotimp") or die(mysqli_error($link));
	$tot_arr_home=mysqli_fetch_array($sql_arr_home);
	//echo $tot_arr_home[1];
	
	$sql_tbl=mysqli_query($link,"select * from tbllotimp where lotimpdate='".$tot_arr_home[0]."' order by lotimpid asc") or die(mysqli_error($link));
...
{
						if($lotno!="")
						$lotno=$lotno.", ".$row_arr_home['lotnumber'];
						else
...
<tr class="Light">
         ...
         <td width="9%" align="center" valign="middle" class="tblheading"><a href="add_tagging_lot_list.php?sdate=<?php echo $trdate;?>&edate=<?php echo $trdate;?>"><?php echo $trdate;?></a></td>
...
<table id="dsp" align="center" border="1" cellspacing="0" cellpadding="0" width="750" bordercolor="#4ea1e1" style="border-collapse:collapse; display:none">
