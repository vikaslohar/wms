...
$tot_arr_home=mysqli_num_rows($sql_arr_home);
	...
	$quer2=mysqli_query($link,"SELECT  cropname,cropid FROM tblcrop where cropid='$typ'"); 
...
$crop=$row_dept['cropname'];
	...
	$dh="Unidentified_Arrival_Report".$crop."_From_".$_REQUEST['sdate']."_To_".$_REQUEST['edate'];
	$datahead = array($dh);
	//$datahead1 = array("Arrival Report");
	$datahead2 = array("Unidentified Arrival Report:",$crop,"  Period From: ",$_REQUEST['sdate'],"  To: ",$_REQUEST['edate']);
	$data1 = array();
...
function cleanData(&$str)
  ...
  $datatitle2 = array("","","","","","","","","","","PP","Moist %","","","");
	 $datatitle3 = array("#","DoA","Arrived In","Arrived From","Crop","Variety","Lot No.","NoB","Qty","Stage"," Prel.QC","","QC Status"," Got Status", "SLOC");
$d=1;
...
if($tot_arr_home > 0)			
{
$data1[$d]=array($d,$trdate,$loc1,$location,$crop,$variety,$lotno,$bags,$qty,$stage,$vk,$moist,$qc,$got1,$slocs); 
$d++;
}
}
}
