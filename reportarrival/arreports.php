...
if($printopt<="10"){
echo "<script>window.location='report_tcrop.php'</script>";
}
if($printopt<="11"){
...
<title>PM-Master Reports- Home</title>
...
<table width="1003" height="600" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
      ...
      <table width="100%" style=" z-index:-1;" height="auto" align="center" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
		  ...
		  <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#F1B01E" >
            <tr>
              <td><table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#F1B01E" >
                  <tr style="padding:0px 0px 0px 0px" >
                    <td width="32" height="25"><img src="../images/rupee1.jpg" align="right" width="30" height="30" />&nbsp;</td>
                    <td width="940" class="Mainheading" height="25"><table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#F1B01E" style="border-bottom:solid; border-bottom-color:#F1B01E" >
                        <tr >
  ...
  <td align="center" colspan="4" ><form name="frmaddDepartment" method="post" action="<?php $_SERVER['PHP_SELF']; ?>"  >
    ...
    <table align="center" border="1" width="350" cellspacing="0" cellpadding="0" bordercolor="#F1B01E" style="border-collapse:collapse" >
      ...
      <tr class="Light" height="25">
        <td width="39" align="right"  valign="left" class="tbltext">&nbsp;<input type="radio" name="fet" value="2" onclick="test1(this.value);" /></td>
        <td width="305" align="left"  valign="middle" class="tblheading">&nbsp;Material&nbsp;Transit&nbsp;Difference&nbsp;Report</td>
      </tr>
      <tr class="Light" height="25">
        <td width="39" align="right"  valign="left" class="tbltext">&nbsp;<input type="radio" name="fet" value="3" onclick="test1(this.value);" /></td>
        <td width="305" align="left"  valign="middle" class="tblheading">&nbsp;Organiser&nbsp;Wise&nbsp;Report</td>
      </tr>
      <tr class="Light" height="25">
        <td width="39" align="right"  valign="middle" class="tbltext">&nbsp;<input type="radio" name="fet" value="4" onclick="test1(this.value);" /></td>
        <td width="305" align="left"  valign="middle" class="tblheading">&nbsp;Production&nbsp;Location&nbsp;Wise&nbsp;Report</td >
      </tr>
      <tr class="Light" height="25">
        <td width="39" align="right"  valign="middle" class="tbltext">&nbsp;<input type="radio" name="fet" value="5" onclick="test1(this.value);" /></td>
        <td width="305" align="left"  valign="middle" class="tblheading">&nbsp;Production&nbsp;Personnel&nbsp;Wise&nbsp;Report </td>
      </tr>
      <tr class="Light" height="25">
        <td width="39" align="right"  valign="middle" class="tbltext">&nbsp;<input type="radio" name="fet" value="6" onclick="test1(this.value);" /></td>
        <td width="305" align="left"  valign="middle" class="tblheading">&nbsp;Stock&nbsp;Transfer&nbsp;Crop&nbsp;Variety&nbsp;Report</td>
      </tr>
      <tr class="Light" height="25">
        <td width="39" align="right"  valign="middle" class="tbltext">&nbsp;<input type="radio" name="fet" value="7" onclick="test1(this.value);" /></td>
        <td width="305" align="left"  valign="middle" class="tblheading">&nbsp;Stock&nbsp;Transfer&nbsp;Plant&nbsp;Wise&nbsp;Report</td>
      </tr>
      <tr class="Light" height="25">
        <td width="39" align="right"  valign="middle" class="tbltext">&nbsp;<input type="radio" name="fet" value="8" onclick="test1(this.value);" /></td>
        <td width="305" align="left"  valign="middle" class="tblheading">&nbsp;Trading&nbsp;Vendor Wise&nbsp;Report</td>
      </tr>
     <!-- <tr class="Light" height="25">
        <td width="284" colspan="3" align="right"  valign="middle" class="tbltext">&nbsp;
                <input type="radio" name="fet" value="9" onclick="test1(this.value);" /></td>
        <td width="284" align="left"  valign="middle" class="tblheading">&nbsp;Crop&nbsp;Variety&nbsp;Wise Arrival&nbsp;Report </td>
      </tr>-->
    <tr class="Light" height="25">
<td width="39" align="right"  valign="middle" class="tbltext">&nbsp;<input type="radio" name="fet" value="10" onClick="test1(this.value);" /></td>
    <td width="305" align="left"  valign="middle" class="tblheading">&nbsp;Trading Arrival Crop Variety Wise Report</td>  
</tr>
<tr class="Light" height="25">
<td width="39" align="right"  valign="middle" class="tbltext">&nbsp;<input type="radio" name="fet" value="11" onClick="test1(this.value);" /></td>
...
<td width="284" colspan="3" align="right"  valign="middle" class="tbltext">&nbsp;<input type="radio" name="fet" value="11" onClick="test1(this.value);" /></td>
    ...
    <table align="center" width="350" cellpadding="5" cellspacing="5" border="0" >
      <tr >
        <td valign="top" align="center"><input name="Submit" type="image" src="../images/next.gif" alt="next" onclick="return mySubmit()" border="0" style="display:inline;cursor:pointer;" />
          &nbsp;
