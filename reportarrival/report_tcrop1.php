...
winHandle=window.open('report_tcrop2.php?sdate='+sdate+'&txtcrop='+itemid+'&txtvariety='+vv+'&edate='+edate,'WelCome','top=20,left=80,width=1000,height=900,scrollbars=yes');
if(winHandle==null){
...
?>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#F1B01E" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#F1B01E" style="border-bottom:solid; border-bottom-color:#F1B01E" >
	    <tr >
	      <td width="813" height="25">&nbsp;Crop  Variety wise Trading  Arrivals Report</td>
	    </tr></table></td>
	  </tr>
	  </table></td></tr>
...
<table align="center" border="0" cellspacing="0" cellpadding="0" width="950" style="border-collapse:collapse">
   <!--	<tr height="25" >
    <td align="center" class="subheading" style="color:#303918; ">Lot Destination Report:</td>
  	...
  	<tr height="25">
    <td align="center" class="subheading" style="color:#303918; " colspan="6">Period From 
...
<?php
$srno=1;$ccnntt=0;
 $t=mysqli_num_rows($sql_arr_home);
...
<td align="center" valign="middle" class="smalltbltext"><?php echo $srno?></td>
		 ...
		 <td align="center" valign="middle" class="smalltbltext"><?php echo $per;?></td>
		 <td width="40" align="center" valign="middle" class="smalltbltext"><?php echo $qc;?></td>
		 <td align="center" valign="middle" class="smalltbltext"><?php echo $got;?></td></tr>
<?php
}
$srno=$srno+1;
}
...
<tr >
<td height="49" align="center" valign="top"><a href="report_tcrop.php"><img src="../images/back.gif" border="0"  style="display:inline;cursor:pointer;"/></a>&nbsp;&nbsp;<img src="../images/printpreview.gif" onclick="openprint()" style="cursor:pointer" border="0" />
