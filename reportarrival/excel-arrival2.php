...
function cleanData(&$str)
 ...
 $datatitle2 = array("","","","Name","Variety Name","Vendor Lot No.","","","NoB","Qty","NoB","Qty","NoB","Qty");
	 $datatitle3 = array("#","Date of Arrival","Crop","Vendor","","","Variety","Lot No.","As Per DC","","As Actual","","Difference","");
...
$row_party=mysqli_fetch_array($sql_party);
		...
		$tdate=$row_arr_home['arrival_date'];
...
if($tot_arr_home > 0)			
{
$data1[$d]=array($d,$stlg_trdate,$crop,$party,$partyvariety,$oldlotno,$variety,$lotno,$dcn,$dcq,$acn,$ac,$difn,$difq); 
$d++;
}
}
}
