...
function cleanData(&$str)
 ...
 $datatitle2 = array("","","","","","NoB","Qty","NoB","Qty","NoB","Qty","","","");
	 $datatitle3 = array("#","Date of Arrival","Crop","Variety","Lot No.","As Per PDN","","As Per Actuals","","Difference","","Prod. Loc.","Organiser"," Farmer");
...
if($tot_arr_home > 0)			
{
$data1[$d]=array($d,$trdate,$crop,$variety,$lotno,$dcn,$dcq,$acn,$ac,$difn,$difq,$loc,$org,$far); 
$d++;
}
}
}
