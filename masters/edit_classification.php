...
session_start();
	...
	if(isset($_POST['frm_action'])=='submit')
	{
		...
		<script>
		 ...
		 {
	  $sql_in="UPDATE tblclassification SET classification='$classification',main='$main' where classification_id ='$classification_id'";
...
<title>Administration - Classification Master -Edit Classification</title>
...
{ 
	...
	{
	alert("Please Enter Party Classification ");
	document.frmaddDepartment.txtcla.focus();
	return false;
	}
	if(document.frmaddDepartment.txtcla.value.charCodeAt() == 32)
	{
	alert("Party Classification cannot start with space.");
	document.frmaddDepartment.txtcla.focus();
	return false;
	}
	
	if(document.frmaddDepartment.txtmain.value=="")
	{
	alert("Please Select Category");
	document.frmaddDepartment.txtmain.focus();
	return false;
	}
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" style="border-bottom:solid; border-bottom-color:#4ea1e1" >
	    <tr >
	      <td width="813" height="25" class="Mainheading">&nbsp;Party Classification Master - Edit Classification </td>
	    </tr></table></td>
   ...
   <?php
	 $sql1=mysqli_query($link,"select * from tblclassification where classification_id='$classification_id'")or die(mysqli_error($link));
...
<tr class="tblsubtitle" height="25">
  <td colspan="4" align="center" class="tblheading">&nbsp;Edit Classification</td>
</tr>
<tr height="30">
    <td colspan="4" align="right" class="tblheading"><font color="#FF0000" >* </font>indicates required field&nbsp;</td>
  </tr>
<tr class="Light" height="25">
 <td width="291" align="right"  valign="middle" class="tblheading">&nbsp;Classification&nbsp;</td>
<td width="289" align="left"  valign="middle">&nbsp;<input name="txtcla" type="text" size="30" class="tbltext" tabindex="0" maxlength="30" value="<?php echo $row['classification'];?>" /><font color="#FF0000" >* </font>&nbsp;</td>
</tr>
<tr class="Light" height="25">
          <td align="right" valign="middle" class="tblheading">&nbsp;Category&nbsp;</td>
          <td align="left"  valign="middle" colspan="3">&nbsp;<select name="txtmain" class="tbltext"  style="width:150px;" tabindex="" >
		<option <?php if($row['main']=="Channel")echo "selected";?> value="Channel">Channel</option>
		<option <?php if($row['main']=="Stock Transfer")echo "selected";?> value="Stock Transfer">Stock Transfer</option>
		<option <?php if($row['main']=="Not Applicable")echo "selected";?> value="Not Applicable">Not Applicable</option></select>&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
         </tr>
		 
</table>
<table align="center" width="650" cellpadding="5" cellspacing="5" border="0" >
<tr >
<td valign="top" align="center"><a href="home_classification.php"><img src="../images/back.gif" border="0"  style="display:inline;cursor:hand;"/></a>&nbsp;&nbsp;
