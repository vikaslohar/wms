  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" >
	  ...
	  <table width="809" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" style="border-bottom:solid; border-bottom-color:#4ea1e1" >
	    <tr >
	      <td width="810" height="25">&nbsp;Organiser   Master </td>
	    </tr></table></td>
...
<td align="center" width="130" valign="middle" class="tblbutn" style="cursor:hand;"><a href="add_organiser.php" style="text-decoration:none; color:#FFFFFF">Add </a></td>
</tr>
...
<td width="30">	 </td><td><?php
	...
	$sql_sel="select * from tblorganiser order by orgname LIMIT $from, $max_results";
	$res=mysqli_query($link,$sql_sel) or die (mysqli_error($link));
	
	$total=mysqli_num_rows($res);
	$total_results3 =mysqli_query($link,"SELECT COUNT(*)  FROM tblorganiser");
...
?>
  ...
  <tr class="tblsubtitle" height="25">
    <td colspan="7" align="center" class="subheading">Organiser List (<?php echo $total_results;?>)</td>
  </tr>

<tr class="Dark" height="25">
<td width="38" align="center" class="tblheading" valign="middle">#</td>
<td width="179" align="left" class="tblheading" valign="middle">&nbsp;Organiser</td>
...
$srno=1;
	...
	/*$sql_tra=mysqli_query($link,"select * from tblarrival where farmerid=".$row['farmerid'])or die(mysqli_error($link));
...
<td  valign="middle" class="tbltext" align="left">&nbsp;<?php echo $row['orgname']?></td>
...
<td valign="middle" align="center"><a href="edit_organiser.php?orgid=<?php echo $row['orgid']?>"><img src="../images/edit.png" border="0" /></a></td>
<td valign="middle" align="center"><?php if($num_tra > 0) {?><a href="home_organiser.php" onclick="alert('Cannot be deleted as Transactions are made using this Farmer')"><img border="0" src="../images/delete.png"  /></a><?php } else {?><a href="../include/delete.php?print=orgname&code=<?php echo $row['orgid']?>" onclick="return confirm('Do you really want to Delete this Record?')"><img border="0" src="../images/delete.png"  /></a><?php } ?></td>
</tr>
<?php
	}
	else
