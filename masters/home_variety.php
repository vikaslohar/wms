...
<title>Administration - Variety Master -Variety Master Home</title>
...
<td align="center" width="130" valign="middle" class="tblbutn" style="cursor:pointer;"><a href="add_variety.php" style="text-decoration:none; color:#FFFFFF">Add </a></td>
</tr>
</table></td>
	  </tr>
	  </table></td></tr>
...
$targetpage = $PHP_SELF; 
  ...
  $sql_arr_home=mysqli_query($link,"select * from tblvariety where vertype='PV'  order by cropid, popularname LIMIT $start, $limit") or die(mysqli_error($link));
...
$pagination = "";
	...
	$sql_sel="select * from tblvariety order by cropid, popularname LIMIT $from, $max_results";
...
?>
<table align="center" border="0" cellspacing="0" cellpadding="0" width="950" bordercolor="#4ea1e1" style="border-collapse:collapse"><tr class="light" height="25">
	<tr> 
		<td width="90" align="right" class="tblheading"><a href="home_variety1.php">Search</a>&nbsp;</td>
	</tr>
</table>
