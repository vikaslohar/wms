<?php
	...
	if(isset($_POST['frm_action'])=='submit')
	{
		...
		$query=mysqli_query($link,"SELECT * FROM tbl_warehouse where perticulars='$perticulars'") or die("Error: " . mysqli_error($link));
		 ...
		 {
			 	   $sql_in="insert into tbl_warehouse(perticulars, whdetails, plantcode)values('$perticulars', '$txtdetails', '$txtplant')";
					//exit;							
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" style="border-bottom:solid; border-bottom-color:#4ea1e1" >
	    <tr >
	      <td width="813" height="25" class="Mainheading">&nbsp;SLOC Master - Add Warehouse </td>
	    </tr></table></td>
...
<td width="302" colspan="3" align="left"  valign="middle" class="tbltext">&nbsp;<input name="txtperticulars" type="text" size="5" class="tbltext" tabindex="0" maxlength="5"  value="WH-"  onBlur="javascript:this.value=this.value.toUpperCase();" />
&nbsp;<font color="#FF0000">*</font>&nbsp;eg. AA , A1,11,1A</td>
</tr>
<tr class="Dark" height="25">
<td width="246" align="right"  valign="middle" class="tblheading">Warehouse Details&nbsp;</td>
<td width="302" colspan="3" align="left"  valign="middle" class="tbltext">&nbsp;<input name="txtdetails" type="text" size="35" class="tbltext" tabindex="0" maxlength="35"  value=""   />&nbsp;</td>
</tr>
</table>
