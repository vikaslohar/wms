...
<title>Administration - Master - Domino Machine Code Master - Home</title>
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" >
	  ...
	  <table width="809" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" style="border-bottom:solid; border-bottom-color:#4ea1e1" >
	    <tr >
	      <td width="810" height="25">&nbsp;Domino Machine Code Master</td>
	    </tr></table></td>
...
<td align="center" width="130" valign="middle" class="tblbutn" style="cursor:pointer;"><a href="add_domino_eqp.php" style="text-decoration:none; color:#FFFFFF">Add </a></td>
</tr>
...
<?php
  ...
  $sql_arr_home=mysqli_query($link,"select * from tbl_rm_dommac order by dom_code LIMIT $start, $limit") or die(mysqli_error($link));
 $tot_arr_home=mysqli_num_rows($sql_arr_home);

$total_results3 =mysqli_query($link,"SELECT COUNT(*)  FROM tbl_rm_dommac");
$total_results2 = mysqli_fetch_array($total_results3);
$total_results = $total_results2[0]; 

$query = "select * from tbl_rm_dommac order by dom_code";
...
$pagination = "";
	...
	$sql_sel="select * from tbl_rm_dommac order by dom_code LIMIT $from , $max_results";
...
<table align="center" border="1" cellspacing="0" cellpadding="0" width="500" bordercolor="#4ea1e1" style="border-collapse:collapse"><tr class="tblsubtitle" height="25">
    <td colspan="3" align="center" class="subheading">Domino Machine Code List (<?php echo $total_results;?>)</td>
...
<td width="26" height="36" align="center" valign="middle" class="tblheading">#</td>
<td width="119"  align="center" valign="middle" class="tblheading">Machine Number</td>
<td width="107" align="center" class="tblheading" valign="middle">Code</td>
<td width="128" align="center" class="tblheading" valign="middle">Status</td>
<td width="108" align="center" class="tblheading" valign="middle">Edit</td>
</tr>
<?php
//$srno=1;
...
<td valign="middle" class="tbltext" align="center"><?php echo $row['dom_code'];?></td>
<td valign="middle" align="center"><?php echo $row['dom_mcode']?></td>
<td valign="middle" align="center"><?php echo $row['dom_status']?></td>
<td valign="middle" align="center"><a href="edit_domino_eqp.php?cropid=<?php echo $row['dom_id']?>"><img src="../images/edit.png" border="0" /></a></td>
</tr>
<?php
	}
	else
