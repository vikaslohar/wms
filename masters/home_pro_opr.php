...
<title>Administration -  Master -  Processing Operator Master Home</title>
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" >
	  ...
	  <table width="809" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" style="border-bottom:solid; border-bottom-color:#4ea1e1" >
	    <tr >
	      <td width="810" height="25">&nbsp;Processing Operator Master</td>
	    </tr></table></td>
...
<td align="center" width="130" valign="middle" class="tblbutn" style="cursor:pointer;"><a href="add_pro_opr.php" style="text-decoration:none; color:#FFFFFF">Add </a></td>
</tr>
...
<?php
  ...
  $sql_arr_home=mysqli_query($link,"select * from tbl_rm_proopr order by proopr_srno LIMIT $start, $limit") or die(mysqli_error($link));
 $tot_arr_home=mysqli_num_rows($sql_arr_home);

$total_results3 =mysqli_query($link,"SELECT COUNT(*)  FROM tbl_rm_proopr");
$total_results2 = mysqli_fetch_array($total_results3);
$total_results = $total_results2[0]; 

$query = "select * from tbl_rm_proopr order by proopr_srno";
...
$pagination = "";
	...
	$sql_sel="select * from tbl_rm_proopr order by proopr_srno LIMIT $from , $max_results";
...
<table align="center" border="1" cellspacing="0" cellpadding="0" width="600" bordercolor="#4ea1e1" style="border-collapse:collapse"><tr class="tblsubtitle" height="25">
    <td colspan="7" align="center" class="subheading">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Processing Operator List (<?php echo $total_results;?>)</td>
...
<td valign="middle" class="tbltext" align="left">&nbsp;<?php echo $row['proopr_fname'];?></td>
<td valign="middle" align="left" class="tbltext">&nbsp;<?php echo $row['proopr_lname'];?></td>
<td valign="middle" align="center" class="tbltext"><?php echo $row['proopr_code'];?></td>
<td valign="middle" align="center" class="tbltext"><?php echo $row['proopr_status'];?></td>
<td valign="middle" align="center" class="tbltext"><a href="edit_pro_opr.php?cropid=<?php echo $row['proopr_id']?>"><img src="../images/edit.png" border="0" /></a></td>
...
<?php } else { ?><a href="../include/delete.php?print=proopr&code=<?php echo $row['proopr_id']?>" onclick="return confirm('Do you really want to delete this Record?')"><img border="0" src="../images/delete.png"  /></a> <?php } ?></td>
</tr>
<?php
	}
	else
