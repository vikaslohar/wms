<?php
	...
	if(isset($_POST['frm_action'])=='submit')
	{
		...
		$query=mysqli_query($link,"SELECT * FROM tbl_rm_dommac where dom_mcode='$txtmcode' and dom_id!='$id'") or die("Error: " . mysqli_error($link));
		 ...
		 {
		$sql_in="Update tbl_rm_dommac set dom_status='$codstatus' where dom_id='$id'";
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" style="border-bottom:solid; border-bottom-color:#4ea1e1" >
	    <tr >
	      <td width="813" height="25" class="Mainheading">&nbsp;Domino Machine Code Master - Edit</td>
	    </tr></table></td>
	    	 </tr>
	  </table></td></tr>
...
<tr class="tblsubtitle" height="25">
  <td colspan="4" align="center" class="subheading">Edit Domino Machine Code</td>
</tr>
<tr height="30">
    <td colspan="4" align="right" class="tblheading"><font color="#FF0000" >* </font>indicates required field&nbsp;</td>
  </tr>
<?php
$query=mysqli_query($link,"SELECT * FROM tbl_rm_dommac where dom_id='$id'") or die("Error: " . mysqli_error($link));
$numofrecords=mysqli_num_rows($query);
$row=mysqli_fetch_array($query);
?>  
<tr class="Light" height="25">
<td width="223" align="right" height="30" valign="middle" class="tblheading">Machine Number&nbsp;</td>
<td width="270" align="left"  valign="middle">&nbsp;<input type="text" name="txtmno" class="tbltext" size="1" maxlength="2" readonly="true" value="<?php echo $row['dom_code'];?>" style="background-color:#CCCCCC" /></td>
</tr>
<tr class="Light" height="25">
<td width="223" align="right" height="30" valign="middle" class="tblheading">Code&nbsp;</td>
<td width="270" align="left"  valign="middle">&nbsp;<input type="text" name="txtmcode" class="tbltext" size="1" maxlength="1" onBlur="Javascript:this.value=this.value.toUpperCase();"  onKeyPress="return isCharKey(event)" value="<?php echo $row['dom_mcode'];?>" readonly="true" style="background-color:#CCCCCC" />&nbsp;<font color="#FF0000" >* </font>&nbsp;</td>
</tr>

<tr class="Light" height="25">
<td width="223" align="right" height="30" valign="middle" class="tblheading">Status&nbsp;</td>
<td width="270" align="left"  valign="middle"><input type="radio" name="codstatus" value="Active" class="tbltext" <?php if($row['dom_status']=="Active") echo"checked";?> >Active&nbsp;&nbsp;<input type="radio" name="codstatus" value="Inactive" class="tbltext" <?php if($row['dom_status']=="Inactive") echo"checked";?> >Inactive&nbsp;<font color="#FF0000" >* </font>&nbsp;</td>
</tr>
</table>
