...
if(isset($_REQUEST['binid']))
	...
	if(isset($_POST['frm_action'])=='submit')
	{
	  ...
	  $query=mysqli_query($link,"SELECT * FROM tbl_bin where binname='$perticulars' and whid='$whid' and binid!='$binid'") or die("Error: " . mysqli_error($link));
	  ...
	  $sql_in="UPDATE  tbl_bin SET binname='$perticulars', plantcode='$txtplant' where binid='$binid'";
		...
		{
			echo "<script>window.location='bin_home.php?whid=$whid'</script>";	
		}
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" style="border-bottom:solid; border-bottom-color:#4ea1e1" >
	    <tr >
	      <td width="813" height="25" class="Mainheading">&nbsp;SLOC Master - Edit Bin </td>
	    </tr></table></td>
	    
	  </tr>
	  </table></td></tr>
 <?php
		$sql=mysqli_query($link,"SELECT * FROM tbl_bin where binid='".$binid."'"); 
...
<tr class="Light" height="25">
           ...
           <td align="left"  valign="middle" colspan="3" class="tbltext">&nbsp;<select class="tbltext" name="txtwh" style="width:170px;" tabindex="" >
...
<tr >
<td valign="top" align="center"><a href="bin_home.php?whid=<?php echo $whid;?>"><img src="../images/back.gif" border="0"  style="display:inline;cursor:hand;"/></a>&nbsp;<a href="javascript:document.frmaddDept.reset()"></a>&nbsp;<input name="Submit" type="image" src="../images/submit_1.gif" alt="Submit Value" onClick="return mySubmit();"  border="0" style="display:inline;cursor:hand;"></td>
</tr>
</table>
</td><td width="30"></td>
</tr>
