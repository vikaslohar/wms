...
if(isset($_REQUEST['whid']))
		...
		if(isset($_POST['frm_action'])=='submit')
	{
		...
		$query=mysqli_query($link,"SELECT * FROM tblsrwarehouse where perticulars='$perticulars' and whid!='$whid'")or die("Error: " . mysqli_error($link));
		...
		{
 	   $sql_in="UPDATE  tblsrwarehouse SET perticulars='$perticulars', plantcode='$txtplant' where whid ='$whid'";
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" style="border-bottom:solid; border-bottom-color:#4ea1e1" >
	    <tr >
	      <td width="813" height="25" class="Mainheading">Sales Return - SR&nbsp;SLOC Master - Edit Warehouse </td>
	    </tr></table></td>
	    
	  </tr>
	  </table></td></tr>
<?php
	 $sql1=mysqli_query($link,"select * from tblsrwarehouse where whid='".$whid."'")or die(mysqli_error($link));
...
<td width="302" colspan="3" align="left"  valign="middle" class="tbltext">&nbsp;<input name="txtperticulars" type="text" size="5" class="tbltext" tabindex="0" maxlength="5"  value="<?php echo $row['perticulars'];?>"   onBlur="javascript:this.value=this.value.toUpperCase();" readonly="true" style="background-color:#CCCCCC" />&nbsp;<font color="#FF0000">*</font>&nbsp;eg.AA,A1,11,1A</td>
</tr>
