...
<title>Administration -  Master -  Processing Treatment Type Master Home</title>
...
<td align="center" width="130" valign="middle" class="tblbutn" style="cursor:pointer;"><a href="add_pro_treattyp.php" style="text-decoration:none; color:#FFFFFF">Add </a></td>
</tr>
...
<?php
  ...
  $sql_arr_home=mysqli_query($link,"select * from tbl_rm_treattype order by treatt_type LIMIT $start, $limit") or die(mysqli_error($link));
 $tot_arr_home=mysqli_num_rows($sql_arr_home);

$total_results3 =mysqli_query($link,"SELECT COUNT(*)  FROM tbl_rm_treattype");
$total_results2 = mysqli_fetch_array($total_results3);
$total_results = $total_results2[0]; 

$query = "select * from tbl_rm_treattype order by treatt_type";
...
$pagination = "";
	...
	$sql_sel="select * from tbl_rm_treattype order by treatt_type LIMIT $from , $max_results";
...
<td width="24" height="36" align="center" valign="middle" class="tblheading">#</td>
<td width="81" align="center" class="tblheading" valign="middle">Treatment Type Code</td>
<td width="283" align="left" class="tblheading" valign="middle">&nbsp;Treatment Details</td>
<td width="43" align="center" class="tblheading" valign="middle">Edit</td>
<td width="57" align="center" class="tblheading" valign="middle">Delete</td>
</tr>
<?php
//$srno=1;
...
<td  valign="middle" class="tbltext" align="center"><?php echo $row['treatt_type']?></td>
<td valign="middle" class="tbltext" align="left">&nbsp;<?php echo $row['treatt_details'];?></td>
<td valign="middle" align="center"><a href="edit_pro_treattyp.php?cropid=<?php echo $row['treatt_id']?>"><img src="../images/edit.png" border="0" /></a></td>
...
<?php } else { ?><a href="../include/delete.php?print=protreattyp&code=<?php echo $row['treatt_id']?>" onclick="return confirm('Do you really want to delete this Record?')"><img border="0" src="../images/delete.png"  /></a> <?php } ?></td>
</tr>
<?php
	}
	else
...
<tr >
<td width="489" align="right" valign="top"><a href="home_resource.php"><img src="../images/back.gif" border="0"  style="display:inline;cursor:pointer;"/></a></td>
</tr>
</table>
</td>
