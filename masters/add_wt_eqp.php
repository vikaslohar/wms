<?php
	...
	if(isset($_POST['frm_action'])=='submit')
	{
		...
		$query=mysqli_query($link,"SELECT * FROM tbl_rm_wtmac where wtmac_type='$crop' and wtmac_macid='$sig'") or die("Error: " . mysqli_error($link));
		 ...
		 {
		$sql_in="insert into tbl_rm_wtmac(wtmac_type, wtmac_mac, wtmac_macid) values('$crop', '$mac', '$sig')";
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" style="border-bottom:solid; border-bottom-color:#4ea1e1" >
	    <tr >
	      <td width="813" height="25" class="Mainheading">&nbsp;Weighing Machine Code Master - Add</td>
	    </tr></table></td>
	    	 </tr>
	  </table></td></tr>
...
<tr class="tblsubtitle" height="25">
  <td colspan="4" align="center" class="subheading">Add a NEW Weighing Machine Code</td>
</tr>
<tr height="30">
...
<td width="270" align="left"  valign="middle">&nbsp;<input type="text" name="txtcrop" class="tbltext" size="1" maxlength="2" onChange="chkcode(this.value);" onKeyPress="return isCharKey(event)" />&nbsp;<font color="#FF0000" >* </font>&nbsp;</td>
</tr>
<tr class="Light" height="25">
