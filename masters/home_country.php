...
<title>Administration- Country  Master -Country Home</title>
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" >
	  ...
	  <table width="840" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" style="border-bottom:solid; border-bottom-color:#4ea1e1" >
	    <tr >
	      <td width="840" height="25" class="Mainheading">&nbsp;Country Master </td>
	    </tr></table></td>
...
<?php
  ...
  $sql_arr_home=mysqli_query($link,"select * from tblcountry order by country LIMIT $start, $limit") or die(mysqli_error($link));
 $tot_arr_home=mysqli_num_rows($sql_arr_home);

$total_results3 =mysqli_query($link,"SELECT COUNT(*)  FROM tblcountry");
$total_results2 = mysqli_fetch_array($total_results3);
$total_results = $total_results2[0]; 

$query = "select * from tblcountry order by country";
...
$pagination = "";
	...
	$sql_sel="select * from tblcountry order by country LIMIT $from, $max_results";
...
//$srno=1;
	...
	{
	 $resettargetquery=mysqli_query($link,"select * from tbl_partymaser where country='".$row['c_id']."'");
...
<td valign="middle" class="tbltext" align="center"><a href="edit_country.php?c_id=<?php echo $row['c_id'];?>"><img src="../images/edit.png" border="0" /></a></td>

<td valign="middle" class="tbltext" align="center"><?php if($num_of_records_target_set > 0)
{
?>
<img border="0" src="../images/delete.png" style="cursor:hand" onClick="alert('Cannot be deleted as Parties are  Present under this Country')" />
<?php } else { ?><a href="../include/delete.php?print=country&code=<?php echo $row['c_id']?>" onClick="return confirm('Do you really want to delete this Record?')"><img border="0" src="../images/delete.png"  /></a> <?php } ?></td>
</tr>
<?php
	}
	else
