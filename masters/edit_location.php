...
session_start();
		...
		if(isset($_POST['frm_action'])=='submit')
	{
		...
		$query=mysqli_query($link,"SELECT * FROM tblproductionlocation where productionlocation='$location' and state='$state'and productionlocationid!='$id'") or die("Error: " . mysqli_error($link));
		 ...
		 {
		$sql_in="UPDATE tblproductionlocation SET productionlocation='$location' ,state='$state' where productionlocationid = '$id'";
...
<title>Administration - Location Master -Edit Location</title>
...
<!-- actual page start--->	
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" style="border-bottom:solid; border-bottom-color:#4ea1e1" >
	    <tr >
	      <td width="813" height="25" class="Mainheading">&nbsp;Location Master - Edit  Location </td>
	    </tr></table></td>
  ...
  <?php
	 $sql1=mysqli_query($link,"SELECT * FROM tblproductionlocation where productionlocationid='$id'")or die(mysqli_error($link));
...
<td width="281" align="left"  valign="middle">&nbsp;<input name="txtlocation" type="text" size="35" class="tbltext" tabindex="0" value="<?php echo $row['productionlocation'];?>" onBlur="javascript:this.value=ucwords_w(this.value.toLowerCase());" onKeyPress="return isCharKey(event)" onChange="f2(this.value);" />&nbsp;<font color="#FF0000" >* </font></td>
