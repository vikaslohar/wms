...
<title>Administrator - Viewers Master -Viewers Home</title>
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" >
	  ...
	  <table width="845" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" style="border-bottom:solid; border-bottom-color:#4ea1e1" >
	    <tr >
	      <td width="845" height="25">Report&nbsp;Viewers Master </td>
	    </tr></table></td>
...
<tr height="15" class="tbltitle" ><?php
	...
	$total_results3 =mysqli_query($link,"SELECT COUNT(*)  FROM tbl_viewer");
...
//$srno=1;
	while($row=mysqli_fetch_array($res))
	{
	 ...
	 $resettargetquery=mysqli_query($link,"select * from tbl_viewer where vid='".$row['vid']."'");
...
<tr class="Light" height="25">
 ...
 <td valign="middle" class="tbltext" align="center"><?php echo "RV".$row['vcode'];?></td>
