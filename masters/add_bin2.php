...
if(isset($_REQUEST['whid']))
	...
	if(isset($_POST['frm_action'])=='submit')
	{
		...
		$query=mysqli_query($link,"SELECT * FROM tbldbin where binname='$perticulars' and whid='$whid'") or die("Error: " . mysqli_error($link));
		 ...
		 else 
		{
			 	 	...
			 	 	$sql_in="insert into tbldbin(binname,whid, plantcode)values('$perticulars','$whid','$txtplant')";
					//exit;							
		...
		$sql_in1="insert into tbldsubbin(sname,binid,whid, plantcode)values($i,
											'$id','$whid','$txtplant'
											 )";
		mysqli_query($link,$sql_in1)or die(mysqli_error($link));
		
					echo "<script>window.location='bin_home2.php?whid=$whid'</script>";	
		}
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" style="border-bottom:solid; border-bottom-color:#4ea1e1" >
	    <tr >
	      <td width="813" height="25" class="Mainheading">Damage&nbsp;SLOC Master - Add Bin </td>
	    </tr></table></td>
	    
	  </tr>
	  </table></td></tr>
 <?php
	 $sql1=mysqli_query($link,"select * from tbldbin")or die(mysqli_error($link));
...
<?php } ?>  
   ...
   <?php
$quer3=mysqli_query($link,"SELECT DISTINCT perticulars,whid FROM tbldwarehouse where plantcode='$plantcode' order by perticulars Asc"); 
?>
...
<tr >
<td valign="top" align="center"><a href="bin_home2.php?whid=<?php echo $whid;?>"><img src="../images/back.gif" border="0"  style="display:inline;cursor:hand;"/></a>&nbsp;<a href="javascript:document.frmaddDept.reset()"></a>&nbsp;<input name="Submit" type="image" src="../images/submit_1.gif" alt="Submit Value" onClick="return mySubmit();"  border="0" style="display:inline;cursor:hand;"></td>
</tr>
</table>
</td><td width="30"></td>
</tr>
