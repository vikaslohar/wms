<?php
	...
	if(isset($_REQUEST['productionlocationid']))
	{
	 $id = $_REQUEST['productionlocationid'];
	}
	if(isset($_POST['frm_action'])=='submit')
	{
		...
		$sql_in="insert into tblproductionlocation(productionlocation,state) values(
											  '$location','$state'
												)";
		
		$query=mysqli_query($link,"SELECT * FROM tblproductionlocation where productionlocation='$location' and state='$state'and productionlocationid!='$id'") or die("Error: " . mysqli_error($link));
...
<title>Administration -  Master -Add Location</title>
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="5398ee" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="4ea1e1" style="border-bottom:solid; border-bottom-color:#4ea1e1" >
	    <tr >
	      <td width="813" height="25" class="Mainheading">&nbsp;Location Master - Add New Location </td>
	    </tr></table></td>
...
<tr class="tblsubtitle" height="25">
  <td colspan="4" align="center" class="subheading">Add a NEW Location </td>
</tr>
<tr height="30">
...
<tr >
<td width="489" align="center" valign="top"><a href="home_location.php"><img src="../images/back.gif" border="0"  style="display:inline;cursor:hand;"/></a>&nbsp;&nbsp;<a href="javascript:document.frmprodloc.reset()"><img src="../images/reset.gif" OnClick="myReset()"alt="reset"  border="0" style="display:inline;cursor:hand;"></a>&nbsp;<input name="Submit" type="image" src="../images/submit_1.gif" alt="Submit Value" OnClick="return mySubmit()" border="0" style="display:inline;cursor:hand;"></td>
</tr>
</table>
</td><td width="30"></td>
</tr>
