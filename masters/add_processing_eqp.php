<?php
	...
	if(isset($_POST['frm_action'])=='submit')
	{
		...
		$query=mysqli_query($link,"SELECT * FROM tbl_rm_promac where promac_type='$crop' and promac_macid='$sig'") or die("Error: " . mysqli_error($link));
		 ...
		 {
		$sql_in="insert into tbl_rm_promac(promac_type, promac_mac, promac_macid) values('$crop', '$mac', '$sig')";
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" style="border-bottom:solid; border-bottom-color:#4ea1e1" >
	    <tr >
	      <td width="813" height="25" class="Mainheading">&nbsp;Processing Machine Code Master - Add</td>
	    </tr></table></td>
	    	 </tr>
	  </table></td></tr>
...
<tr class="tblsubtitle" height="25">
  <td colspan="4" align="center" class="subheading">Add a NEW Processing Machine Code</td>
</tr>
<tr height="30">
