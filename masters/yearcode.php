...
if(isset($_REQUEST['yrsid']))
	...
	if(isset($_POST['frm_action'])=='submit')
	{
		...
		$sql_in=mysqli_query($link,"update tblyears set ycode='$locdate' where yearsid='$yrsid'")or die("Error:".mysqli_error($link));
...
<table width="370" height="282" border="0" align="center" cellpadding="0" cellspacing="0" >
  ...
  <td colspan="4" align="center" class="subheading" valign="middle" height="25">Year Code Generation</td>
</tr>
 ...
 <?php
	...
	$sql_yr2=mysqli_query($link,"select * from tblyears where yearsid='$yrid'")or die("Error:".mysqli_error($link));
...
</table><div id="ycds"><input type="hidden" name="yflg" value="0" /></div>
<table cellpadding="5" cellspacing="5" border="0" width="370">
<tr >
<td align="center" colspan="3"><input type="image" src="../images/add.gif" alt="Generate" border="0" style="display:inline;cursor:pointer;" onclick="return mySubmit();"/><input type="hidden" name="lcode" value="<?php echo $lcode;?>" /></td>
</tr>
</table>
</form>
</td></tr>
