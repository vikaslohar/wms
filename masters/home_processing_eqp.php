...
<title>Administration - Master - Processing Machine Code Master - Home</title>
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" >
	  ...
	  <table width="809" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" style="border-bottom:solid; border-bottom-color:#4ea1e1" >
	    <tr >
	      <td width="810" height="25">&nbsp;Processing Machine Code Master</td>
	    </tr></table></td>
...
<td align="center" width="130" valign="middle" class="tblbutn" style="cursor:pointer;"><a href="add_processing_eqp.php" style="text-decoration:none; color:#FFFFFF">Add </a></td>
</tr>
...
<?php
  ...
  $sql_arr_home=mysqli_query($link,"select * from tbl_rm_promac order by promac_type LIMIT $start, $limit") or die(mysqli_error($link));
 $tot_arr_home=mysqli_num_rows($sql_arr_home);

$total_results3 =mysqli_query($link,"SELECT COUNT(*)  FROM tbl_rm_promac");
$total_results2 = mysqli_fetch_array($total_results3);
$total_results = $total_results2[0]; 

$query = "select * from tbl_rm_promac order by promac_type";
...
$pagination = "";
	...
	$sql_sel="select * from tbl_rm_promac order by promac_type LIMIT $from , $max_results";
...
<table align="center" border="1" cellspacing="0" cellpadding="0" width="500" bordercolor="#4ea1e1" style="border-collapse:collapse"><tr class="tblsubtitle" height="25">
    <td colspan="7" align="center" class="subheading">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Processing Machine Code List (<?php echo $total_results;?>)</td>
...
<td width="177" align="left" class="tblheading" valign="middle">&nbsp;Code</td>
...
//$srno=1;
	...
	{
	$num=$row['promac_mac'].$row['promac_macid'];
	$num_v=0;
	if ($srno%2 != 0)
	{
?>
...
<td valign="middle" class="tbltext" align="left">&nbsp;<?php echo $num;?></td>
<td valign="middle" align="center"><a href="edit_processing_eqp.php?cropid=<?php echo $row['promac_id']?>"><img src="../images/edit.png" border="0" /></a></td>
...
<?php } else { ?><a href="../include/delete.php?print=promac&code=<?php echo $row['promac_id']?>" onclick="return confirm('Do you really want to delete this Record?')"><img border="0" src="../images/delete.png"  /></a> <?php } ?></td>
</tr>
<?php
	}
	else
