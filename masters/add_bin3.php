...
if(isset($_REQUEST['whid']))
	...
	if(isset($_POST['frm_action'])=='submit')
	{
		...
		$query=mysqli_query($link,"SELECT * FROM tblpvbin where binname='$perticulars' and whid='$whid'") or die("Error: " . mysqli_error($link));
		 ...
		 else 
		{
			 	 	...
			 	 	$sql_in="insert into tblpvbin(binname,whid, plantcode)values('$perticulars','$whid','$txtplant')";
					//exit;							
		...
		$sql_in1="insert into tblpvsubbin(sname,binid,whid, plantcode)values($i,
											'$id','$whid','$txtplant'
											 )";
		mysqli_query($link,$sql_in1)or die(mysqli_error($link));
		
					echo "<script>window.location='bin_home3.php?whid=$whid'</script>";	
		}
...
<title>Administator - Bin Master - Add Bin</title>
...
{ 
	...
	{
	alert("Enter Bin Number ");
	
	document.frmaddDept.txtperticulars.focus();
	return false;
	}
	if(document.frmaddDept.txtperticulars.value.length < 2)
	{
		alert("Bin can not less than 2 ");
		document.frmaddDept.txtperticulars.focus();
		return(false);
	}
	if(document.frmaddDept.txtperticulars.value.charCodeAt() == 32)
	{
	alert("Bin Number cannot start with space.");
	document.frmaddDept.txtperticulars.focus();
	return false;
	}
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" style="border-bottom:solid; border-bottom-color:#4ea1e1" >
	    <tr >
	      <td width="813" height="25" class="Mainheading">Sales Return - PV&nbsp;SLOC Master - Add Bin </td>
	    </tr></table></td>
	    
	  </tr>
	  </table></td></tr>
 <?php
	 $sql1=mysqli_query($link,"select * from tblpvbin")or die(mysqli_error($link));
...
<tr class="tblsubtitle" height="25">
  <td colspan="4" align="center" class="tblheading">Add Bin </td>
</tr>
  <tr height="15">
    <td colspan="4" align="right" class="tblheading"><font color="#FF0000" >* </font>indicates required field&nbsp;</td>
  </tr>
  <?php
$sql_comp=mysqli_query($link,"Select * from tbl_parameters where plantcode='".$plantcode."' order by pcity asc") or die(mysqli_error($link));
...
<?php } ?>  
   ...
   <?php
$quer3=mysqli_query($link,"SELECT DISTINCT perticulars,whid FROM tblpvwarehouse where plantcode='$plantcode' order by perticulars Asc"); 
?>
<tr class="Light" height="25">
           <td width="318"  align="right"  valign="middle" class="tblheading">&nbsp;Select Warehouse Title &nbsp; </td>
...
<option value="" selected>--Select Warehouse--</option>
	<?php while($noticia = mysqli_fetch_array($quer3)) { ?>
		...
		<tr class="Light" height="25">
           ...
           <td align="left"  valign="middle" colspan="3" class="tbltext">&nbsp;<input name="txtperticulars" type="text" size="3" class="tbltext" tabindex="0" maxlength="3"  onBlur="javascript:this.value=this.value.toUpperCase();"/>
            &nbsp;<font color="#FF0000">*</font>&nbsp;eg.AA,A1,11,1A,AAA,A10,111,1AA</td>
         </tr>
</table>
<table align="center" width="650" cellpadding="5" cellspacing="5" border="0" >
<tr >
<td valign="top" align="center"><a href="bin_home3.php?whid=<?php echo $whid;?>"><img src="../images/back.gif" border="0"  style="display:inline;cursor:hand;"/></a>&nbsp;<a href="javascript:document.frmaddDept.reset()"></a>&nbsp;<input name="Submit" type="image" src="../images/submit_1.gif" alt="Submit Value" onClick="return mySubmit();"  border="0" style="display:inline;cursor:hand;"></td>
</tr>
</table>
</td><td width="30"></td>
</tr>
