<?php
	...
	if(isset($_POST['frm_action'])=='submit')
	{
	 ...
	 $query=mysqli_query($link,"SELECT * FROM tblcountry where country='$classification'") or die("Error: " . mysqli_error($link));
		// exit;
		...
		<script>
		 ...
		 {
	  $sql_in="insert into tblcountry(country) values(
											  '$classification'
														)";
...
<title>Administration-  Master -Add Country</title>
...
if(document.frmaddDepartment.txtcla.value=="")
	...
	if(document.frmaddDepartment.txtcla.value!="")
	{
	 if(document.frmaddDepartment.txtcla.value=="India")
	{
	alert("You can not add  India as country");
		document.frmaddDepartment.txtcla.value="";
		document.frmaddDepartment.txtcla.focus();
		}
		}
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="5398ee" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="4ea1e1" style="border-bottom:solid; border-bottom-color:#4ea1e1" >
	    <tr >
	      <td width="813" height="25" class="Mainheading">&nbsp;Country Master - Add Country </td>
	    </tr></table></td>
...
<tr class="tblsubtitle" height="25">
  <td colspan="4" align="center" class="subheading">Add a NEW Country </td>
</tr> 
<tr height="30">
    <td colspan="4" align="right" class="tblheading"><font color="#FF0000" >* </font>indicates required field&nbsp;</td>
  </tr>
<tr class="Light" height="25">
<td width="298" align="right" height="30" valign="middle" class="tblheading">Country&nbsp;</td>
<td width="269" align="left"  valign="middle">&nbsp;<input name="txtcla" type="text" size="50" class="tbltext" tabindex="0" maxlength="50" onBlur="javascript:this.value=FirstCharCap(this.value);" onKeyPress="return isCharKey(event)" onChange="f1(this.value);"/>&nbsp;<font color="#FF0000" >* </font>&nbsp;</td>
</tr>
</table>
<table align="center" width="509" cellpadding="5" cellspacing="5" border="0" >
<tr >
<td width="489" align="center" valign="top"><a href="home_country.php"><img src="../images/back.gif" border="0"  style="display:inline;cursor:hand;"/></a>&nbsp;&nbsp;<a href="javascript:document.frmaddDepartment.reset()"><img src="../images/reset.gif" OnClick="myReset()"alt="reset"  border="0" style="display:inline;cursor:hand;"></a>&nbsp;
