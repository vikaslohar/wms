...
if(isset($_GET['farmerid']))
	...
	$sql_f="select * from tblfarmer where farmerid='$farmerid'";
	...
	if(isset($_POST['frm_action'])=='submit')
	{
		...
		$mobileno=trim($_POST['mobileno']);
		 ...
		 $sql_in="update tblfarmer set	 	 farmername='$name',
											 fathername='$fname',
											 farmeraddress='$address',
											 farmervillege= '$village',
											 farmerphone='$phoneno',
											 farmermobile='$mobileno',
											 farmerlandholding='$land',
											 productionlocationid='$lo',
											 productionpersonnelid='$person_list'
											 where farmerid='$farmerid'";
		
		$query=mysqli_query($link,"SELECT * FROM tblfarmer where farmername='$name' and productionlocationid='$location' and farmerid!='$farmerid'") or die("Error: " . mysqli_error($link));
...
<!-- actual page start--->	
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" >
	...
	<?php 
	$quer=mysqli_query($link,"SELECT DISTINCT productionlocation,productionlocationid FROM tblproductionlocation where productionlocationid='$location'"); 
	?>
...
<td width="277" align="left"  valign="middle" >&nbsp;<input name="name" type="text" size="35" class="tbltext" tabindex="0" value="<?php echo $row_f['1'];?>" onChange="f1(this.value);"/>  &nbsp;<font color="#FF0000" >*</font></td>
</tr>
<tr class="Light" height="25">
<td align="right" class="tblheading" valign="middle">&nbsp;Father&acute;s Name&nbsp;</td>
<td align="left"  valign="middle" colspan="3">&nbsp;<input name="fname" type="text" size="35" class="tbltext" tabindex="0" value="<?php echo $row_f['2'];?>"/></td>
</tr>
<tr class="Dark" height="25">
...
<td align="left"  valign="middle" colspan="3">&nbsp;<input name="village" type="text" size="35" class="tbltext" tabindex="0" value="<?php echo $row_f['5'];?>"  onChange="f2(this.value);" />&nbsp;<font color="#FF0000" >*</font></td>
</tr>
<tr class="Dark" height="25">
<td align="right" class="tblheading" valign="middle">&nbsp;Land holding&nbsp;</td>
<td align="left"  valign="middle" colspan="3">&nbsp;<input name="land" type="text" size="35" class="tbltext" tabindex="0" value="<?php echo $row_f['8'];?>"  onChange="f3(this.value);" />&nbsp;<font color="#FF0000" >*</font></td>
</tr>
<tr class="Light" height="25">
<td align="right" class="tblheading" valign="middle">&nbsp;Phone Number&nbsp;</td>
<td align="left"  valign="middle" colspan="3">&nbsp;<input name="phoneno" type="text" size="15" maxlength="15" class="tbltext" tabindex="0" value="<?php echo $row_f['6'];?>"  onChange="f4(this.value);"/>&nbsp;<font color="#FF0000" >*</font></td>
</tr>
<tr class="Dark" height="25">
<td align="right" class="tblheading" valign="middle">&nbsp;Mobile Number&nbsp;</td>
<td align="left"  valign="middle" colspan="3">&nbsp;<input name="mobileno" type="text" size="15" maxlength="15" class="tbltext" tabindex="0" value="<?php echo $row_f['7'];?>"  onChange="f5(this.value);"/></td>
</tr>
</table>
<table align="center" border="1" width="650" cellspacing="0" cellpadding="0" bordercolor="#4ea1e1" style="border-collapse:collapse" > 
