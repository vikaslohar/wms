...
require_once("../include/config.php");
	...
	if(isset($_POST['frm_action'])=='submit')
	{
	 ...
	 $sql_in="UPDATE tblfaq SET faq_questions='$questions', faq_role='$role',faq_answer='$answers' where id ='$fid'";
		//exit;
...
<title>Administrator-  Master - Edit FAQ</title>
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" style="border-bottom:solid; border-bottom-color:#4ea1e1" >
	    <tr >
	      <td width="813" height="25" class="Mainheading">&nbsp;<a href="cdinward_home.php" style="text-decoration:underline; cursor:pointer; color:#404d21;"></a>FAQ Master - Edit</td>
	    </tr></table></td>
	    	  </tr>
	  </table></td></tr>
...
<table align="center" border="0" width="507" cellspacing="0" cellpadding="0" bordercolor="#CCCCCC" style="border-collapse:collapse" > 
  <tr><td width="507">
<table width="564" border="1" cellspacing="0" cellpadding="0" align="center"  bordercolor="#4ea1e1" style="border-collapse:collapse">
<?php
 $sql_qry=mysqli_query($link," select * from tblfaq where id='$fid'")or die("Error".mysqli_error($link));
  $row_qry=mysqli_fetch_array($sql_qry);
 $total=mysqli_num_rows($sql_qry);
    $row_qry['faq_role'];
?>
<tr class="tblsubtitle" height="25">
<td colspan="2" align="center" class="tblheading" valign="middle">FAQ Upload </td>
</tr>
<tr class="Dark"  height="25">
<td width="89" align="right" valign="middle" class="tblheading"> Question &nbsp;</td>
<td width="348" align="left" valign="middle" class="tbltext">&nbsp;<textarea name="questions" cols="35" rows="3" tabindex="2"  /><?php echo $row_qry['faq_questions'];?></textarea>&nbsp;</td>
</tr>
<tr class="Dark"  height="25">
<td width="89" align="right" valign="middle" class="tblheading"> Answers &nbsp;</td>
<td width="348" align="left" valign="middle" class="tbltext">&nbsp;<textarea name="answers" cols="35" rows="5" tabindex="2" /><?php echo $row_qry['faq_answer'];?></textarea>&nbsp;</td>
</tr>
...
<td valign="middle" class="tbltext" align="center"><input type="checkbox" name="fet" <?php $p1_array=explode(",",$row_qry['faq_role']);
			$i=0;
			$p1=array();
			foreach($p1_array as $val1)
				{
				 if($val1<>"")
				 {
				if($val1 == $resetresult['department_id']) { $i++;}
				}
				}
				if($i!=0) { echo "checked";}?>  value="<?php echo $resetresult['department_id'];?>"/></td></tr>
<?php
	}
	else 
