...
session_start();
	...
	$ups=trim($_POST['txtups']);
		$wt=trim($_POST['txtwt']);
		 ...
		 $query=mysqli_query($link,"SELECT * FROM tblups where ups='$classification' and classification_id!='$classification_id'") or die("Error: " . mysqli_error($link));
		// exit;
...
<td align="center" width="100" valign="middle" class="tblbutn" style="cursor:hand;"><a href="add_ups.php" style="text-decoration:none; color:#FFFFFF">Add </a></td>
</tr>
...
<td width="30">	 </td><td>
<?php
	$sql_sel="select * from tblups order by uom";
...
$srno=1;$ups="";
	while($row=mysqli_fetch_array($res))
	{
	 ...
	 $reset=mysqli_query($link,"select * from tblvariety ");
	 $ro=0;
  while($row1=mysqli_fetch_array($reset))
	{
	$p_array=explode(",",$row1['gm']);
			$i=0;
			$p=array();
...
<td valign="middle" class="tbltext" align="center"><a href="edit_ups.php?uid=<?php echo $row['uid'];?>"><img src="../images/edit.png" border="0" /></a></td>

<td valign="middle" class="tbltext" align="center"><?php if($ro> 0)
{
?>
...
<?php } else { ?><a href="../include/delete.php?print=ups&code=<?php echo $row['uid']?>" onClick="return confirm('Do you really want to delete this Record?')"><img border="0" src="../images/delete.png"  /></a> <?php } ?></td>
</tr>
<?php
	}
	else
...
?>
<img border="0" src="../images/delete.png" style="cursor:hand" onClick="alert('Cannot be deleted as Transactions are made using this UPS')" />
<?php } else { ?><a href="../include/delete.php?print=ups&code=<?php echo $row['uid']?>" onClick="return confirm('Do you really want to delete this Record?')"><img border="0" src="../images/delete.png"  /></a> <?php } ?></td></tr>
<?php	}
	 $srno=$srno+1;
	}
