...
<title>Administration  -Administrator Profile</title>
...
<!-- actual page start--->	
 ...
 <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" >
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" style="border-bottom:solid; border-bottom-color:#4ea1e1" >
	    <tr >
	      <td width="813" height="25" class="Mainheading">&nbsp;Administrator Profile </td>
	    </tr></table></td>
  ...
  <?php
	$sql = mysqli_query($link,"select * from tbluser where role='$role'") or die(mysqli_error($link)); 
...
<td colspan="2" align="center" class="tblheading" valign="middle">Administrator Profile </td>
</tr>
...
<td width="411" align="left" valign="middle" class="tbltext">&nbsp;<input name="txtId" type="text" class="tbltext" tabindex="0" value="<?php echo $row['loginid'];?>" size="25" maxlength="14"/>&nbsp;<font color="#FF0000" >* </font>&nbsp;Min 6 Max 10</td>
</tr>		
<tr class="Dark" height="25">
<td align="right" valign="middle" class="tblheading">&nbsp;Password&nbsp;</td>
<td align="left" valign="middle" class="tbltext">&nbsp;<input name="txtpass" type="password" class="tbltext" tabindex="" value="<?php echo $row['password'];?>" size="25" maxlength="15"/>&nbsp;<font color="#FF0000" >* </font>&nbsp;Min 6 Max 10</td>
</tr>
<tr class="Light" height="25">
<td align="right" valign="middle" class="tblheading">&nbsp;Retype Password&nbsp;</td>
<td align="left" valign="middle" class="tbltext">&nbsp;<input name="txtrepass" type="password" class="tbltext" tabindex="" value="<?php echo $row['password'];?>" size="25" maxlength="15"/>&nbsp;<font color="#FF0000" >* </font>&nbsp;Min 6 Max 10</td>
</tr>
<tr class="Dark" height="25">
...
<td align="left" valign="middle" class="tbltext">&nbsp;<input tabindex="" name="txtans" type="text" size="25" class="tbltext" value="<?php //=$row['answer'];?>"/>&nbsp;Non-Case Sensitive&nbsp;</td>
</tr>*/-->
</table></td></tr>
</table>
