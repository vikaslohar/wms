<?php
	...
	if(isset($_POST['frm_action'])=='submit')
	{
		...
		$perticulars=trim($_POST['txtperticulars']);
			...
			$query=mysqli_query($link,"SELECT * FROM tblsrwarehouse where perticulars='$perticulars'") or die("Error: " . mysqli_error($link));
   		$numofrecords=mysqli_num_rows($query);
	 	 if( $numofrecords > 0)
		 {
		 ?>
		 <script>
		  alert("This Warehouse Title is already present.");
		  </script>
		 <?php }
		 else 
		 {
			 	   $sql_in="insert into tblsrwarehouse(perticulars, plantcode)values('$perticulars', '$txtplant')";
					//exit;							
		if(mysqli_query($link,$sql_in)or die(mysqli_error($link)))
		{
			echo "<script>window.location='selectbin4.php'</script>";	
		}
...
<title>Administrator -  Master - Add Warehouse</title>
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" style="border-bottom:solid; border-bottom-color:#4ea1e1" >
	    <tr >
	      <td width="813" height="25" class="Mainheading">Sales Return - SR&nbsp;SLOC Master - Add Warehouse </td>
	    </tr></table></td>
	    
	  </tr>
	  </table></td></tr>
 <?php
	 $sql1=mysqli_query($link,"select * from tbl_warehouse")or die(mysqli_error($link));
...
<tr class="tblsubtitle" height="25">
  <td colspan="4" align="center" class="tblheading">Add a NEW Warehouse</td>
</tr>
 <tr height="15">
...
<?php } ?>  
      ...
      &nbsp;<font color="#FF0000">*</font>&nbsp;</td>
		 ...
		 <tr class="Dark" height="25">
<td width="246" align="right"  valign="middle" class="tblheading">Warehouse Title&nbsp;</td>
<td width="302" colspan="3" align="left"  valign="middle" class="tbltext">&nbsp;<input name="txtperticulars" type="text" size="5" class="tbltext" tabindex="0" maxlength="5"  value="WH-SR"  onBlur="javascript:this.value=this.value.toUpperCase();" readonly="true" style="background-color:#CCCCCC" />
&nbsp;<font color="#FF0000">*</font>&nbsp;eg. AA , A1,11,1A</td>
</tr>
...
<tr >
<td valign="top" align="center"><a href="selectbin4.php"><img src="../images/back.gif" border="0"  style="display:inline;cursor:hand;"/></a>&nbsp;<a href="javascript:document.frmaddDept.reset()"></a>&nbsp;<input name="Submit" type="image" src="../images/submit_1.gif" alt="Submit Value" onClick="return mySubmit();"  border="0" style="display:inline;cursor:hand;"></td>
</tr>
</table>
</td><td width="30"></td>
</tr>
