	...
	if(isset($_POST['frm_action'])=='submit')
	{
	 ...
	 $query=mysqli_query($link,"SELECT * FROM tblclassification where classification='$classification'") or die("Error: " . mysqli_error($link));
		...
		<script>
		 ...
		 {
	  $sql_in="insert into tblclassification(classification,main) values(
											  '$classification','$main'
														)";
...
<title>Administration-  Master -Add Classification</title>
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="5398ee" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="4ea1e1" style="border-bottom:solid; border-bottom-color:#4ea1e1" >
	    <tr >
	      <td width="813" height="25" class="Mainheading">&nbsp;Party Classification Master - Add Classification </td>
	    </tr></table></td>
...
<tr class="tblsubtitle" height="25">
  <td colspan="4" align="center" class="subheading">Add a NEW Party Classification </td>
</tr> 
<tr height="30">
    <td colspan="4" align="right" class="tblheading"><font color="#FF0000" >* </font>indicates required field&nbsp;</td>
  </tr>
<tr class="Light" height="25">
<td width="298" align="right" height="30" valign="middle" class="tblheading">Classification&nbsp;</td>
<td width="269" align="left"  valign="middle">&nbsp;<input name="txtcla" type="text" size="25" class="tbltext" tabindex="0" maxlength="30"  />&nbsp;<font color="#FF0000" >* </font>&nbsp;</td>

</tr>
<tr class="Light" height="25">
          <td align="right" valign="middle" class="tblheading">&nbsp;Category&nbsp;</td>
           <td align="left"  valign="middle" colspan="3"  class="tblbutn">&nbsp;<select name="txtmain" class="tbltext"  style="width:170px;" tabindex="" >
...
<tr >
<td width="489" align="center" valign="top"><a href="home_classification.php"><img src="../images/back.gif" border="0"  style="display:inline;cursor:hand;"/></a>&nbsp;&nbsp;<a href="javascript:document.frmaddDepartment.reset()"><img src="../images/reset.gif" OnClick="myReset()"alt="reset"  border="0" style="display:inline;cursor:hand;"></a>&nbsp;
