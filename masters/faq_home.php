...
<title>Administrator - FAQ - Home</title>
...
$srno=1;
	...
	$i=0;	$roles="";
     	$sql_p=mysqli_query($link,"SELECT * FROM tblfaq")or die(mysqli_error($link));
...
<td valign="middle" class="tbltext" align="center"><a href="edit_faq.php?department_id=<?php echo $row['department_id'];?>"><?php echo $i;?></a></td>
