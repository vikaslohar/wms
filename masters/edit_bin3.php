...
if(isset($_REQUEST['binid']))
	...
	if(isset($_POST['frm_action'])=='submit')
	{
		...
		//$id=trim($_POST['tbltext']);
		$txtplant=trim($_POST['txtplant']);
	  $query=mysqli_query($link,"SELECT * FROM tblpvbin where binname='$perticulars' and whid='$whid' and binid!='$binid'") or die("Error: " . mysqli_error($link));
	  ...
	  $sql_in="UPDATE  tblpvbin SET binname='$perticulars', plantcode='$txtplant' where binid='$binid'";
...
<title>Stores - Bin Master -Edit Bin</title>
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" style="border-bottom:solid; border-bottom-color:#4ea1e1" >
	    <tr >
	      <td width="813" height="25" class="Mainheading">Sales Return - PV&nbsp;SLOC Master - Edit Bin </td>
	    </tr></table></td>
	    
	  </tr>
	  </table></td></tr>
 <?php
		$sql=mysqli_query($link,"SELECT * FROM tblpvbin where binid='".$binid."'"); 
        $row=mysqli_fetch_array($sql); 
?> 
	  <?php
$quer3=mysqli_query($link,"SELECT DISTINCT perticulars,whid FROM tblpvwarehouse order by perticulars Asc"); 
?>
...
<tr class="tblsubtitle" height="25">
  <td colspan="4" align="center" class="tblheading">Edit Bin </td>
</tr>
 <tr height="15">
     <td colspan="4" align="right" class="tblheading"><font color="#FF0000" >* </font>indicates required field&nbsp;</td>
  </tr>
  <?php
$sql_comp=mysqli_query($link,"Select * from tbl_parameters where plantcode='".$row['plantid']."' order by pcity asc") or die(mysqli_error($link));
...
<tr class="Light" height="25">
	...
	<?php while($noticia = mysqli_fetch_array($quer3)) { ?>
		<option <?php if($noticia['whid']==$row['whid']) { echo "Selected"; }?> value="<?php echo $noticia['whid'];?>" />  
		...
		<tr class="Light" height="25">
           ...
           <td align="left"  valign="middle" colspan="3" class="tbltext">&nbsp;<input name="txtperticulars" type="text" size="3" class="tbltext" tabindex="0" maxlength="3" value="<?php echo $row['binname'];?>" />&nbsp;<font color="#FF0000">*</font>&nbsp;eg.AA,A1,11,1A,AAA,A10,111,1AA</td>
         </tr>
