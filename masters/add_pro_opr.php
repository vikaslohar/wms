<?php
	...
	if(isset($_POST['frm_action'])=='submit')
	{
		...
		$query=mysqli_query($link,"SELECT * FROM tbl_rm_proopr where proopr_code='$txtshcode'") or die("Error: " . mysqli_error($link));
		 ...
		 {
		$sql_in="insert into tbl_rm_proopr(proopr_srno, proopr_fname, proopr_lname, proopr_code, proopr_status) values('$txtsrno', '$txtfname', '$txtlname', '$txtshcode', '$oprstatus')";
...
<title>Administration - Processing Operator Master - Add Processing Operator</title>
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" style="border-bottom:solid; border-bottom-color:#4ea1e1" >
	    <tr >
	      <td width="813" height="25" class="Mainheading">&nbsp;Processing Operator Master - Add</td>
	    </tr></table></td>
	    	 </tr>
	  </table></td></tr>
...
<tr class="tblsubtitle" height="25">
  <td colspan="4" align="center" class="subheading">Add a NEW Processing Operator</td>
</tr>
<tr height="30">
    <td colspan="4" align="right" class="tblheading"><font color="#FF0000" >* </font>indicates required field&nbsp;</td>
  </tr>
<?php
$sql_code="SELECT MAX(proopr_srno) FROM tbl_rm_proopr ORDER BY proopr_srno DESC";
