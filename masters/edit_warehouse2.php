...
if(isset($_REQUEST['whid']))
		...
		if(isset($_POST['frm_action'])=='submit')
	{
		...
		$query=mysqli_query($link,"SELECT * FROM tbldwarehouse where perticulars='$perticulars'and whid!='$whid'")or die("Error: " . mysqli_error($link));
		...
		{
 	   $sql_in="UPDATE  tbldwarehouse SET perticulars='$perticulars', plantcode='$txtplant' where whid ='$whid'";
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" style="border-bottom:solid; border-bottom-color:#4ea1e1" >
	    <tr >
	      <td width="813" height="25" class="Mainheading">Damage&nbsp;SLOC Master - Edit Warehouse </td>
	    </tr></table></td>
	    
	  </tr>
	  </table></td></tr>
<?php
	 $sql1=mysqli_query($link,"select * from tbldwarehouse where whid='".$whid."'")or die(mysqli_error($link));
