<?php
	...
	if(isset($_POST['frm_action'])=='submit')
	{
		...
		$query=mysqli_query($link,"SELECT * FROM tbl_rm_wtopr where wtopr_code='$txtshcode' and wtopr_id!='$id'") or die("Error: " . mysqli_error($link));
		 ...
		 {
		$sql_in="Update tbl_rm_wtopr set wtopr_srno='$txtsrno', wtopr_fname='$txtfname', wtopr_lname='$txtlname', wtopr_code='$txtshcode', wtopr_status='$oprstatus' where wtopr_id='$id'";
...
<title>Administration - Weighing Machine Operator Master - Edit Processing Operator</title>
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" style="border-bottom:solid; border-bottom-color:#4ea1e1" >
	    <tr >
	      <td width="813" height="25" class="Mainheading">&nbsp;Weighing Machine Operator Master - Edit</td>
	    </tr></table></td>
	    	 </tr>
	  </table></td></tr>
...
<tr class="tblsubtitle" height="25">
  <td colspan="4" align="center" class="subheading">Edit Weighing Machine Operator</td>
</tr>
<tr height="30">
    <td colspan="4" align="right" class="tblheading"><font color="#FF0000" >* </font>indicates required field&nbsp;</td>
  </tr>
<?php
$query=mysqli_query($link,"SELECT * FROM tbl_rm_wtopr where wtopr_id='$id'") or die("Error: " . mysqli_error($link));
$numofrecords=mysqli_num_rows($query);
$row=mysqli_fetch_array($query);
?>  
  <tr class="Light" height="25">
<td width="246" align="right" height="30" valign="middle" class="tblheading">Sr.No.&nbsp;</td>
<td width="247" align="left"  valign="middle">&nbsp;<input type="text" name="txtsrno" class="tbltext" size="10" maxlength="10" readonly="true" value="<?php echo $row['wtopr_srno'];?>" style="background-color:#CCCCCC" /></td>
</tr>
<tr class="Light" height="25">
<td width="246" align="right" height="30" valign="middle" class="tblheading">First Name&nbsp;</td>
<td width="247" align="left"  valign="middle">&nbsp;<input type="text" name="txtfname" class="tbltext" size="20" maxlength="20" value="<?php echo $row['wtopr_fname'];?>" />&nbsp;<font color="#FF0000" >* </font>&nbsp;</td>
</tr>
<tr class="Light" height="25">
<td width="246" align="right" height="30" valign="middle" class="tblheading">Last Name&nbsp;</td>
<td width="247" align="left"  valign="middle">&nbsp;<input type="text" name="txtlname" class="tbltext" size="20" maxlength="20" onChange="fnamechk();" value="<?php echo $row['wtopr_lname'];?>" />&nbsp;<font color="#FF0000" >* </font>&nbsp;</td>
</tr>
<tr class="Light" height="25">
<td width="246" align="right" height="30" valign="middle" class="tblheading">Short Code&nbsp;</td>
<td width="247" align="left"  valign="middle">&nbsp;<input type="text" name="txtshcode" class="tbltext" size="5" maxlength="5" onKeyPress="return isCharKey(event)" onBlur="javascript:this.value=this.value.toUpperCase();" onChange="lnamechk();" value="<?php echo $row['wtopr_code'];?>" />&nbsp;<font color="#FF0000" >* </font>&nbsp;</td>
</tr>
<tr class="Light" height="25">
<td width="246" align="right" height="30" valign="middle" class="tblheading">Status&nbsp;</td>
<td width="247" align="left"  valign="middle" class="tbltext"><input type="radio" name="sstatus" value="Active" onChange="shcodechk(this.value);" <?php if($row['wtopr_status']=="Active") echo "checked"; ?> />Active&nbsp;&nbsp;<input type="radio" name="sstatus" value="Inactive" onChange="shcodechk(this.value);" <?php if($row['wtopr_status']=="Inactive") echo "checked"; ?>  />Inactive&nbsp;<font color="#FF0000" >* </font>&nbsp;</td>
</tr>
<input type="hidden" name="oprstatus" value="<?php echo $row['wtopr_status'];?>" />
