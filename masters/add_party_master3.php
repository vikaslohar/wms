...
<table align="center" border="1" width="624" cellspacing="0" cellpadding="0" bordercolor="#4ea1e1" style="border-collapse:collapse" >
  ...
  <tr height="30">
    ...
    <?php
//$quer3=mysqli_query($link,"SELECT * classification,wheree classification=Import Trader FROM tblclassification order by classification Asc"); 
?>
            <td width="223" align="right"  valign="middle" class="tblheading">&nbsp;Select Party Classification&nbsp;</td>
<td width="395" colspan="3" align="left"  valign="middle">&nbsp;<input name="txtpcla" type="text"  class="tbltext" tabindex=""  maxlength="20"  size="20" value="Import Trader"  readonly="true" style="background-color:#CCCCCC" />&nbsp;<font color="#FF0000" >*</font></td>
