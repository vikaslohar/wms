...
if(isset($_REQUEST['whid']))
	...
	$query=mysqli_query($link,"SELECT * FROM tblclassification where classification='$class'") or die("Error: " . mysqli_error($link));
		...
		{
			echo "<script>window.location='bin_home4.php'</script>";	
		}
		}
	//}
...
<title>Administration- Bin Master -Bin Home</title>
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" >
	  ...
	  <table width="809" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" style="border-bottom:solid; border-bottom-color:#4ea1e1" >
	    <tr >
	      <td width="810" height="25">Sales Return - SR&nbsp;SLOC Master - Bin </td>
	    </tr></table></td>
...
<td align="center" width="130" valign="middle" class="tblbutn" style="cursor:hand;"><a href="add_bin4.php?whid=<?php echo $whid;?>&plantid=<?php echo $row['plantcode']?>" style="text-decoration:none; color:#ffffff">Add </a> </td>
</tr>
...
<?php
	...
	$sql_sel="select * from tblsrbin where whid='".$whid."' order by binname LIMIT $from, $max_results";
	$res=mysqli_query($link,$sql_sel) or die (mysqli_error($link));
	
	 $total=mysqli_num_rows($res);
	 $total_results3 =mysqli_query($link,"SELECT COUNT(*)  FROM tblsrbin where whid='".$whid."'");
$total_results2 = mysqli_fetch_array($total_results3);
$total_results = $total_results2[0]; 
	
	$sql_p=mysqli_query($link,"select * from tblsrwarehouse where whid='".$whid."'");
...
<table align="center" border="0" cellspacing="0" cellpadding="0" width="750" style="border-collapse:collapse">
  <tr height="25" >
    <td colspan="8" align="center" class="subheading" style="color:#303918; ">Bin List (<?php echo $total_results;?>)</td>
  </tr>
  </table>
...
<td width="281" align="left" class="tblheading" valign="middle">&nbsp;Bin Number</td>
<td width="128" align="center" class="tblheading" valign="middle">WH</td>
<td width="171" align="center" class="tblheading" valign="middle">Sub-Bin</td>
...
//$srno=1;
	...
	/*$resettargetquery=mysqli_query($link,"select * from tbl_bin where binid='".$row['whid']."'");
  	$resetresult=mysqli_fetch_array($resettargetquery);
  	$num_of_records_target_set=mysqli_num_rows($resettargetquery);*/
	$sql_v=mysqli_query($link,"select * from tblsrsubbin where binid='".$row['binid']."' and plantcode='".$row['plantcode']."'")or die(mysqli_error($link));
  	$row_v=mysqli_fetch_array($sql_v);
	$num_v=mysqli_num_rows($sql_v);
	$sub_bin_no=$num_v;
	
	$sql_tra=mysqli_query($link,"select * from tbl_gsample where gsbin=".$row['binid'])or die(mysqli_error($link));
...
<td valign="middle" class="tbltext" align="center"><a href="edit_bin4.php?binid=<?php echo $row['binid'];?>&whid=<?php echo $whid;?>&plantid=<?php echo $row['plantcode']?>"><img src="../images/edit.png" border="0" /></a></td>
<td valign="middle" class="tbltext" align="center"><?php if($num_tra == 0) { ?><a href="../include/delete.php?print=bin4&code=<?php echo $row['binid'];?>&id=<?php echo $whid;?>" onclick="return confirm('Do you really want to delete this Record?')"><img border="0" src="../images/delete.png"  /></a><?php } else {?><img border="0" src="../images/delete.png" onclick="alert('Cannot delete Bin.\nReason: Records are present under this Bin')"  /><?php } ?></td>
</tr>
<?php
	}
	else
...
<td valign="middle" class="tbltext" align="center"><?php echo $sub_bin_no;?></td>
<td valign="middle" class="tbltext" align="center"><?php echo $row_comp['pcity'];?></td>
<td valign="middle" class="tbltext" align="center"><a href="edit_bin4.php?binid=<?php echo $row['binid'];?>&whid=<?php echo $whid;?>"><img src="../images/edit.png" border="0" /></a></td>
<td valign="middle" class="tbltext" align="center"><?php if($num_tra == 0) { ?><a href="../include/delete.php?print=bin4&code=<?php echo $row['binid'];?>&id=<?php echo $whid;?>" onclick="return confirm('Do you really want to delete this Record?')"><img border="0" src="../images/delete.png"  /></a><?php } else {?><img border="0" src="../images/delete.png" onclick="alert('Cannot delete Bin.\nReason: Records are present under this Bin')"  /><?php } ?></td>
</tr>
<?php	}
	 $srno=$srno+1;
...
<?php
	...
	{ 
		$prev = ($page - 1); 
		echo "<a href=\"".$_SERVER['PHP_SELF']."?page=$prev&whid=$whid\" STYLE='text-decoration: none'><< Previous </a> "; 
	} 
	...
	{ 
		...
		{ 
		echo "<a href=\"".$_SERVER['PHP_SELF']."?page=$i&whid=$whid\" STYLE='text-decoration: none'>$i</a> "; 
		} 
	} 
	...
	{ 
		$next = ($page + 1); 
		echo "<a href=\"".$_SERVER['PHP_SELF']."?page=$next&whid=$whid\" STYLE='text-decoration: none'>Next>></a>"; 
	} 
		echo "</td></tr></table>"; 
}
else
...
<table align="center" border="1" cellspacing="0" cellpadding="0" width="750" bordercolor="#4ea1e1" style="border-collapse:collapse">
 ...
 <tr class="tblsubtitle" height="25">
<td align="center" class="tblheading" valign="middle">No Records Found.<br />
Add New Bin OR Click on BACK button to go to SLOC Master- Warehouse page.</td>
</tr>
</table>
<?php } ?>
<table align="center" width="650" cellpadding="5" cellspacing="5" border="0" >
<tr >
<td valign="top" align="center"><a href="selectbin4.php"><img src="../images/back.gif" border="0"  style="display:inline;cursor:hand;"/></a>&nbsp;</td>
</tr>
</table>
</td>
<td width="30"></td>
