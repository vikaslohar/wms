...
if(isset($_REQUEST['whid']))
		...
		if(isset($_POST['frm_action'])=='submit')
	{
		...
		$query=mysqli_query($link,"SELECT * FROM tblwarehouse where perticulars='$perticulars'and whid!='$whid'")or die("Error: " . mysqli_error($link));
		...
		{
 	   $sql_in="UPDATE  tblwarehouse SET perticulars='$perticulars', plantcode='$txtplant' where whid ='$whid'";
...
<?php
	 $sql1=mysqli_query($link,"select * from tblwarehouse where whid='".$whid."'")or die(mysqli_error($link));
