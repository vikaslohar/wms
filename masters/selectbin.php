  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="5398ee" >
	...
	<table width="809" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" style="border-bottom:solid; border-bottom-color:#4ea1e1" >
                <tr >
                  <td width="810" height="25">&nbsp;SLOC Master - Warehouse</td>
                </tr>
            </table></td>
            <td width="139" height="25" align="right" class="submenufont" ><table border="3" align="right" bordercolordark="#5b7e1b" cellspacing="0" cellpadding="0" width="130" style="border-collapse:collapse;">
                <tr height="15" class="tbltitle" > 
                  <td align="center" width="130" valign="middle" class="tblbutn" style="cursor:hand;"><a href="add_warehouse.php" style="text-decoration:none; color:#FFFFFF">Add </a></td>
                 </tr>
            </table></td>
          </tr>
      </table></td>
...
<?php
  ...
  $sql_arr_home=mysqli_query($link,"select * from tbl_warehouse order by perticulars LIMIT $start, $limit") or die(mysqli_error($link));
 $tot_arr_home=mysqli_num_rows($sql_arr_home);

$total_results3 =mysqli_query($link,"SELECT COUNT(*)  FROM tbl_warehouse");
$total_results2 = mysqli_fetch_array($total_results3);
$total_results = $total_results2[0]; 

$query = "select * from tbl_warehouse order by perticulars";
...
$pagination = "";
	...
	$sql_sel="select * from tbl_warehouse order by perticulars LIMIT $from, $max_results";
...
?>
                <table align="center" border="0" cellspacing="0" cellpadding="0" width="650" style="border-collapse:collapse">
                  <tr height="25" >
                    <td colspan="8" align="center" class="subheading" style="color:#303918; "> Warehouse List (
          ...
          <table align="center" border="1" cellspacing="0" cellpadding="0" width="650" bordercolor="#4ea1e1" style="border-collapse:collapse">
                  <tr class="tblsubtitle" height="25">
					...
					<td width="150" align="left" class="tblheading" valign="middle">&nbsp;Warehouse Info </td>
                    <td width="110" align="center" class="tblheading" valign="middle">Bin</td>
                    <td width="129" align="center" class="tblheading" valign="middle">Plant</td>
                    <td width="100" align="center" class="tblheading" valign="middle">Edit</td>
	...
	*/
	 $sql_p=mysqli_query($link,"select * from tbl_bin where whid='".$row['whid']."' and  plantcode='".$row['plantcode']."'")or die(mysqli_error($link));
  	 $row_p=mysqli_fetch_array($sql_p);
	$num_of_records_target_set=mysqli_num_rows($sql_p);
	 $bin_no=$num_of_records_target_set;
	 $row['whid'];
	$sql_v=mysqli_query($link,"select * from tbl_subbin where whid='".$row['whid']."' and plantcode='".$row['plantcode']."'")or die(mysqli_error($link));
...
?>
                  <tr class="Light" height="25">
                    ...
                    <td valign="middle" class="tbltext" align="center"><a href="bin_home.php?whid=<?php echo $row['whid'];?>&plantid=<?php echo $row['plantcode']?>"><?php echo $bin_no;?></a> </td>
                    <td valign="middle" class="tbltext" align="center"><?php echo $row_comp['pcity'];?></td>
                    <td valign="middle" class="tbltext" align="center"><a href="edit_warehouse.php?whid=<?php echo $row['whid'];?>"><img src="../images/edit.png" border="0" /></a></td>
                    <td valign="middle" class="tbltext" align="center"><?php if($num_of_records_target_set > 0)
{
?>
<img border="0" src="../images/delete.png" style="cursor:hand" onclick="alert('Cannot be deleted Bin are Present under this Warehouse')"  />
<?php } else { ?><a href="../include/delete.php?print=warehouse&code=<?php echo $row['whid']?>" onclick="return confirm('Do you really want to delete this Record?')"><img border="0" src="../images/delete.png"  /></a> <?php } ?></td>
                  <?php
	}
	else
	{ 
...
?>
	...
	$tono=$srno-1;
	echo "<table width='555' align='center' class='tbltext'><tr><td align='left' >$no - $tono of $total_results Records</td><td align='right'>Select a Page    "; 
