...
if(isset($_POST['frm_action'])=='submit')
	{
		...
		if(mysqli_query($link,$sql_in)or die(mysqli_error($link)))
         ...
         $sql_in1="Update tbluser set	loginid='$login',
										password='$pass',
										email='$email'
										where role='operator' and scode='$scode'";	
...
<title>Administration -operator Profile</title>
...
<td width="327"  align="right" valign="middle" class="tblheading">Name&nbsp;</td>
...
<td width="349" align="left" valign="middle" class="tbltext">&nbsp;<input name="txtId" type="text" class="tbltext" tabindex="0" value="<?php echo $row['login'];?>" size="25" maxlength="14"/>&nbsp;<font color="#FF0000" >* </font></td>
</tr>		
<tr class="Dark" height="25">
<td align="right" valign="middle" class="tblheading">&nbsp;Password&nbsp;</td>
<td align="left" valign="middle" class="tbltext">&nbsp;<input name="txtpass" type="password" class="tbltext" tabindex="" value="<?php echo $row['pass'];?>" size="25" maxlength="15"/>&nbsp;<font color="#FF0000" >* </font></td>
</tr>
<tr class="Light" height="25">
<td align="right" valign="middle" class="tblheading">&nbsp;Retype Password&nbsp;</td>
<td align="left" valign="middle" class="tbltext">&nbsp;<input name="txtrepass" type="password" class="tbltext" tabindex="" value="<?php echo $row['pass'];?>" size="25" maxlength="15"/>&nbsp;<font color="#FF0000" >* </font></td>
</tr>
<tr class="Dark" height="25">
<td align="right" valign="middle" class="tblheading">&nbsp;&nbsp;&nbsp;E-mail&nbsp;</td>
<td align="left" valign="middle" class="tbltext">&nbsp;<input tabindex="" name="txtemail" type="text" size="25" class="tbltext" value="<?php echo $row['email'];?>"/>&nbsp;<font color="#FF0000" >* </font></td>
</tr>		
<!--<tr class="Light" height="25">
...
<td align="left" valign="middle" class="tbltext">&nbsp;<input tabindex="" name="txtans" type="text" size="25" class="tbltext" value="<?php//=$row['answer'];?>"/>&nbsp;<font color="#FF0000" >* </font>&nbsp;</td>
</tr>-->
