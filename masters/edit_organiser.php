...
if(isset($_GET['orgid']))
	...
	$sql_f="select * from tblorganiser where orgid='$orgid'";
	$result_f=mysqli_query($link,$sql_f)or die(mysqli_error($link));
	$row_f=mysqli_fetch_array($result_f);
    $per=explode(";",$row_f['productionpersonnelid']);
	...
	if(isset($_POST['frm_action'])=='submit')
	{
		...
		$mobileno=trim($_POST['mobileno']);
		 ...
		 $sql_in="update tblorganiser set	 	 orgname='$name',
											 fathername='$fname',
											 orgaddress='$address',
											orgvillage= '$village',
											 orgphone='$phoneno',
											orgmobile='$mobileno',
											 orglandholding='$land',
											 productionlocationid='$lo',
											 productionlocationid='$person_list'
											 where orgid='$orgid'";
		
		$query=mysqli_query($link,"SELECT * FROM tblorganiser where orgname='$name' and productionlocationid='$location' and orgid!='$lo'") or die("Error: " . mysqli_error($link));
		...
		{
			echo "<script>window.location='home_organiser.php?print=add'</script>";	
		}
		}
	}
	/*
	$sql_code="SELECT MAX(`farmercode`) FROM tblfarmer  ORDER BY `farmercode` DESC";
...
<title>WMS-Organiser Master -Edit Organiser</title>
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" style="border-bottom:solid; border-bottom-color:#4ea1e1" >
	    <tr >
	      <td width="813" height="25" class="Mainheading">Organiser - Edit </td>
	    </tr></table></td>
	    	 </tr>
	   	  <td align="center" colspan="4" >
	  <form name="frmaddDept" method="post" action="<?php $_SERVER['PHP_SELF']; ?>" onSubmit="return mySubmit();"> 
	 <input name="frm_action" value="submit" type="hidden">
	 <input name="farmerid" value="<?php echo $orgid?>" type="hidden">
...
<tr class="tblsubtitle" height="25">
  <td colspan="4" align="center" class="tblheading">Edit Organiser </td>
</tr>
...
<td align="right" class="tblheading" valign="middle">&nbsp;Select Production Location&nbsp;</td>
<td align="left"  valign="middle" colspan="3">&nbsp;<select class="tbltext" name="produc_location" style="width:170px;" tabindex="" >
		<option value="<?php echo $row['productionlocationid'];?>"--Select--</option>
	<?php while($noticia3 = mysqli_fetch_array($quer)) { ?>
		<option <?php if($noticia3['productionlocationid']==$row['productionlocationid']) { echo "Selected"; }?> value="<?php echo $noticia3['productionlocationid'];?>" />  
		<?php echo $noticia3['productionlocation'];?>
		<?php } ?>
	</select>&nbsp;<font color="#FF0000" >*</font>
<!--select class="Input_Controls" name="produc_location" style="width:220px;" tabindex="19" onchange="loc();"-->
<?php /*
if(!isset($_GET['lo']))
{ */
?>
...
<?php // } ?>		
		...
		<!--option  <?php // if(isset($lo)) { if($noticia['productionlocationid'] == $lo) { echo "selected"; } } ?> value="<?php //=$noticia['productionlocationid'];?>" /-->      
		<?php //=$noticia['productionlocation'];?>
		<?php // } ?>
...
<td width="189" align="right" class="tblheading" valign="middle">&nbsp;Organiser' s Name&nbsp;</td>
<td width="275" align="left"  valign="middle">&nbsp;<input name="name" type="text" size="35" class="tbltext" tabindex="0" value="<?php echo $row_f['1'];?>"/>&nbsp;<font color="#FF0000" >*</font></td><td width="32" class="tblheading" align="right">&nbsp;Code</td>
  <td width="144" align="left">&nbsp;<input name="code" type="text" size="4" class="tbltext" tabindex="0" readonly="true"  value="<?php echo $row_f['orgcode']; ?>" style="background-color:#CCCCCC" /></td>
</tr>
<tr class="Light" height="25">
<td align="right" class="tblheading" valign="middle">&nbsp;Father&acute;s Name&nbsp;</td>
<td align="left"  valign="middle" colspan="3">&nbsp;<input name="fname" type="text" size="35" class="tbltext" tabindex="0" value="<?php echo $row_f['2'];?>"/>&nbsp;<font color="#FF0000" >*</font></td>
</tr>
<tr class="Dark" height="25">
<td align="right" class="tblheading" valign="middle">&nbsp;Address&nbsp;</td>
<td align="left"  valign="middle" colspan="3">&nbsp;<textarea  name="address" rows="4" cols="33" class="tbltext" id="address1" tabindex="7"><?php echo $row_f['4'];?></textarea></td>
</tr>
<tr class="Light" height="25">
<td align="right" class="tblheading" valign="middle">&nbsp;Village&nbsp;</td>
<td align="left"  valign="middle" colspan="3">&nbsp;<input name="village" type="text" size="35" class="tbltext" tabindex="0" value="<?php echo $row_f['5'];?>"  />&nbsp;<font color="#FF0000" >*</font></td>
</tr>
<tr class="Dark" height="25">
<td align="right" class="tblheading" valign="middle">&nbsp;Land holding&nbsp;</td>
<td align="left"  valign="middle" colspan="3">&nbsp;<input name="land" type="text" size="35" class="tbltext" tabindex="0" value="<?php echo $row_f['8'];?>"  />&nbsp;<font color="#FF0000" >*</font></td>
</tr>
<tr class="Light" height="25">
<td align="right" class="tblheading" valign="middle">&nbsp;Phone Number&nbsp;</td>
<td align="left"  valign="middle" colspan="3">&nbsp;<input name="phoneno" type="text" size="15" maxlength="15" class="tbltext" tabindex="0" value="<?php echo $row_f['6'];?>" />&nbsp;<font color="#FF0000" >*</font></td>
</tr>
<tr class="Dark" height="25">
<td align="right" class="tblheading" valign="middle">&nbsp;Mobile Number&nbsp;</td>
<td align="left"  valign="middle" colspan="3">&nbsp;<input name="mobileno" type="text" size="15" maxlength="15" class="tbltext" tabindex="0" value="<?php echo $row_f['7'];?>"  />&nbsp;</td>
</tr>
</table>
<table align="center" border="1" width="650" cellspacing="0" cellpadding="0" bordercolor="#4ea1e1" style="border-collapse:collapse" > 
...
<?php
 if(isset($lo))
 {
 $test=mysqli_query($link,"SELECT * FROM tblproductionpersonnel where productionlocationid =".$lo." order by productionpersonnel");
  }
  else
  {
...
<?php
   ...
   while($rowstr = mysqli_fetch_array($test))
	{
		in_array($rowstr['productionpersonnelid'],$per);
		
	    if(!in_array($rowstr['productionpersonnelid'],$per))
		{
 ?>
...
<?php $sql_p1=mysqli_query($link,"select productionpersonnelid from tblfarmer where farmerid = '$farmerid'");
	$total_pl=mysqli_num_rows($sql_p1);
$row=mysql_fetch_assoc($sql_p1);
 	$person=$row['productionpersonnelid'];
?>
...
<tr height="10"><td colspan="3" height="10"></td></tr>

</table>

<table align="center" width="650" cellpadding="5" cellspacing="5" border="0" >
<tr >
<td valign="top" align="center"><a href="home_organiser.php"><img src="../images/back.gif" border="0"  style="display:inline;cursor:hand;"/></a>&nbsp;<a href="javascript:document.frmaddDept.reset()"></a>&nbsp;<input name="Submit" type="image" src="../images/update.gif" alt="Submit Value" OnClick="return mySubmit()" border="0" style="display:inline;cursor:hand;"></td>
</tr>
</table>
</td><td width="30"></td>
</tr>
