...
if(isset($_REQUEST['binid']))
	...
	if(isset($_POST['frm_action'])=='submit')
	{
	  ...
	  $query=mysqli_query($link,"SELECT * FROM tblbin where binname='$perticulars' and whid='$whid' and binid!='$binid'") or die("Error: " . mysqli_error($link));
	  ...
	  $sql_in="UPDATE  tblbin SET binname='$perticulars', plantcode='$txtplant' where binid='$binid'";
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" style="border-bottom:solid; border-bottom-color:#4ea1e1" >
	    <tr >
	      <td width="813" height="25" class="Mainheading">GS&nbsp;SLOC Master - Edit Bin </td>
	    </tr></table></td>
	    
	  </tr>
	  </table></td></tr>
 <?php
		$sql=mysqli_query($link,"SELECT * FROM tblbin where binid='".$binid."'"); 
        $row=mysqli_fetch_array($sql); 
?> 
	  <?php
$quer3=mysqli_query($link,"SELECT DISTINCT perticulars,whid FROM tblwarehouse order by perticulars Asc"); 
?>
