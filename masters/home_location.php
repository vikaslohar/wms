...
<title>Administration - Location Master - Home</title>
...
$targetpage = $PHP_SELF; 
  ...
  $sql_arr_home=mysqli_query($link,"select * from tblproductionlocation order by state, productionlocation LIMIT $start, $limit") or die(mysqli_error($link));
