<?php
	...
	if(isset($_POST['frm_action'])=='submit')
	{
		...
		$query=mysqli_query($link,"SELECT * FROM tbl_rm_proopr where proopr_code='$txtshcode' and proopr_id!='$id'") or die("Error: " . mysqli_error($link));
   		$numofrecords=mysqli_num_rows($query);
		
	 	 if( $numofrecords > 0)
		 {?>
		 <script>
		  alert("The Processing Operator with this Short Code is already present");
		  </script>
		 <?php }
		 else 
		 {
		$sql_in="Update tbl_rm_proopr set proopr_srno='$txtsrno', proopr_fname='$txtfname', proopr_lname='$txtlname', proopr_code='$txtshcode', proopr_status='$oprstatus' where proopr_id='$id'";
		if(mysqli_query($link,$sql_in)or die(mysqli_error($link)))
		{
			echo "<script>window.location='home_pro_opr.php?print=add'</script>";	
		}
		}
	}
...
<title>Administration - Processing Operator Master - Edit Processing Operator</title>
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" style="border-bottom:solid; border-bottom-color:#4ea1e1" >
	    <tr >
	      <td width="813" height="25" class="Mainheading">&nbsp;Processing Operator Master - Edit</td>
	    </tr></table></td>
	    	 </tr>
	  </table></td></tr>
...
<tr class="tblsubtitle" height="25">
  <td colspan="4" align="center" class="subheading">Edit Processing Operator</td>
</tr>
<tr height="30">
    <td colspan="4" align="right" class="tblheading"><font color="#FF0000" >* </font>indicates required field&nbsp;</td>
  </tr>
<?php
$query=mysqli_query($link,"SELECT * FROM tbl_rm_proopr where proopr_id='$id'") or die("Error: " . mysqli_error($link));
$numofrecords=mysqli_num_rows($query);
$row=mysqli_fetch_array($query);
?>  
  <tr class="Light" height="25">
<td width="246" align="right" height="30" valign="middle" class="tblheading">Sr.No.&nbsp;</td>
<td width="247" align="left"  valign="middle">&nbsp;<input type="text" name="txtsrno" class="tbltext" size="10" maxlength="10" readonly="true" value="<?php echo $row['proopr_srno'];?>" style="background-color:#CCCCCC" /></td>
</tr>
<tr class="Light" height="25">
<td width="246" align="right" height="30" valign="middle" class="tblheading">First Name&nbsp;</td>
<td width="247" align="left"  valign="middle">&nbsp;<input type="text" name="txtfname" class="tbltext" size="20" maxlength="20" value="<?php echo $row['proopr_fname'];?>" />&nbsp;<font color="#FF0000" >* </font>&nbsp;</td>
</tr>
<tr class="Light" height="25">
<td width="246" align="right" height="30" valign="middle" class="tblheading">Last Name&nbsp;</td>
<td width="247" align="left"  valign="middle">&nbsp;<input type="text" name="txtlname" class="tbltext" size="20" maxlength="20" onChange="fnamechk();" value="<?php echo $row['proopr_lname'];?>" />&nbsp;<font color="#FF0000" >* </font>&nbsp;</td>
</tr>
<tr class="Light" height="25">
<td width="246" align="right" height="30" valign="middle" class="tblheading">Short Code&nbsp;</td>
<td width="247" align="left"  valign="middle">&nbsp;<input type="text" name="txtshcode" class="tbltext" size="5" maxlength="5" onKeyPress="return isCharKey(event)" onBlur="javascript:this.value=this.value.toUpperCase();" onChange="lnamechk();" value="<?php echo $row['proopr_code'];?>" />&nbsp;<font color="#FF0000" >* </font>&nbsp;</td>
</tr>
<tr class="Light" height="25">
<td width="246" align="right" height="30" valign="middle" class="tblheading">Status&nbsp;</td>
<td width="247" align="left"  valign="middle" class="tbltext"><input type="radio" name="sstatus" value="Active" onChange="shcodechk(this.value);" <?php if($row['proopr_status']=="Active") echo "checked"; ?> />Active&nbsp;&nbsp;<input type="radio" name="sstatus" value="Inactive" onChange="shcodechk(this.value);" <?php if($row['proopr_status']=="Inactive") echo "checked"; ?>  />Inactive&nbsp;<font color="#FF0000" >* </font>&nbsp;</td>
</tr>
<input type="hidden" name="oprstatus" value="<?php echo $row['proopr_status'];?>" />
...
<tr >
<td width="489" align="center" valign="top"><a href="home_pro_opr.php"><img src="../images/back.gif" border="0"  style="display:inline;cursor:pointer;"/></a>&nbsp;&nbsp;<a href="javascript:document.frmaddcrop.reset()"><img src="../images/reset.gif" OnClick="myReset()"alt="reset"  border="0" style="display:inline;cursor:pointer;"></a>&nbsp;
