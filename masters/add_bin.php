...
if(isset($_REQUEST['whid']))
	...
	if(isset($_POST['frm_action'])=='submit')
	{
		...
		$query=mysqli_query($link,"SELECT * FROM tbl_bin where binname='$perticulars' and whid='$whid'") or die("Error: " . mysqli_error($link));
		 ...
		 else 
		{
			 	 	...
			 	 	$sql_in="insert into tbl_bin(binname,whid, plantcode)values('$perticulars','$whid','$txtplant')";
					//exit;							
		...
		$sql_in1="insert into tbl_subbin(sname,binid,whid, plantcode)values($i,
											'$id','$whid','$txtplant'
											 )";
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" style="border-bottom:solid; border-bottom-color:#4ea1e1" >
	    <tr >
	      <td width="813" height="25" class="Mainheading">&nbsp;SLOC Master - Add Bin </td>
	    </tr></table></td>
