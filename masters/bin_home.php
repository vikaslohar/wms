...
if(isset($_REQUEST['whid']))
	...
	$query=mysqli_query($link,"SELECT * FROM tblclassification where classification='$class'") or die("Error: " . mysqli_error($link));
		...
		{
			echo "<script>window.location='bin_home.php'</script>";	
		}
		}
	//}
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" >
	  ...
	  <table width="809" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" style="border-bottom:solid; border-bottom-color:#4ea1e1" >
	    <tr >
	      <td width="810" height="25">&nbsp;SLOC Master - Bin </td>
	    </tr></table></td>
...
<td align="center" width="130" valign="middle" class="tblbutn" style="cursor:hand;"><a href="add_bin.php?whid=<?php echo $whid;?>&plantid=<?php echo $row['plantcode']?>" style="text-decoration:none; color:#ffffff">Add </a> </td>
</tr>
...
<?php
	...
	$sql_sel="select * from tbl_bin where whid='".$whid."' order by binname LIMIT $from, $max_results";
	$res=mysqli_query($link,$sql_sel) or die (mysqli_error($link));
	
	$total=mysqli_num_rows($res);
	$total_results3 =mysqli_query($link,"SELECT COUNT(*)  FROM tbl_bin where whid='".$whid."'");
$total_results2 = mysqli_fetch_array($total_results3);
$total_results = $total_results2[0]; 
	
	$sql_p=mysqli_query($link,"select * from tbl_warehouse where whid='".$whid."'");
...
//$srno=1;
	...
	$sql_v=mysqli_query($link,"select * from tbl_subbin where binid='".$row['binid']."' and plantcode='".$row['plantcode']."'")or die(mysqli_error($link));
...
<td valign="middle" class="tbltext" align="center"><a href="edit_bin.php?binid=<?php echo $row['binid'];?>&whid=<?php echo $whid;?>&plantid=<?php echo $row['plantcode']?>"><img src="../images/edit.png" border="0" /></a></td>
<td valign="middle" class="tbltext" align="center"><a href="../include/delete1.php?print=bin&code=<?php echo $row['binid'];?>&id=<?php echo $whid;?>" onclick="return confirm('Do you really want to delete this Record?')"><img border="0" src="../images/delete.png"  /></a></td>
</tr>
<?php
	}
	else
...
<td valign="middle" class="tbltext" align="center"><?php echo $sub_bin_no;?></td>
<td valign="middle" class="tbltext" align="center"><?php echo $row_comp['pcity'];?></td>
<td valign="middle" class="tbltext" align="center"><a href="edit_bin.php?binid=<?php echo $row['binid'];?>&whid=<?php echo $whid;?>"><img src="../images/edit.png" border="0" /></a></td>
<td valign="middle" class="tbltext" align="center"><a href="../include/delete1.php?print=bin&code=<?php echo $row['binid'];?>&id=<?php echo $whid;?>" onclick="return confirm('Do you really want to delete this Record?')"><img border="0" src="../images/delete.png"  /></a></td>
</tr>
<?php	}
	 $srno=$srno+1;
...
<tr >
<td valign="top" align="center"><a href="selectbin.php"><img src="../images/back.gif" border="0"  style="display:inline;cursor:hand;"/></a>&nbsp;</td>
</tr>
</table>
</td>
<td width="30"></td>
