...
<title>Administration-  Master -Crop Home</title>
...
<?php
  ...
  $sql_arr_home=mysqli_query($link,"select * from tblcrop order by cropname LIMIT $start, $limit") or die(mysqli_error($link));
...
$pagination = "";
	if($lastpage > 1)
	{	
		$pagination .= "<div class=\"pagination\" align=\"right\" style=\"width:725px\">";
		//previous button
		if ($page > 1) 
	...
	$sql_sel="select * from tblcrop order by cropname LIMIT $from , $max_results";
...
<td width="177" align="left" class="tblheading" valign="middle">&nbsp;Crop Name </td>
<td width="57" align="center" class="tblheading" valign="middle">Variety<br />Number</td>
