<?php
	...
	if(isset($_POST['frm_action'])=='submit')
	{
		...
		$perticulars=trim($_POST['txtperticulars']);
			...
			$query=mysqli_query($link,"SELECT * FROM tblpvwarehouse where perticulars='$perticulars'") or die("Error: " . mysqli_error($link));
		 ...
		 {
			 	   $sql_in="insert into tblpvwarehouse(perticulars, plantcode)values('$perticulars', '$txtplant')";
					//exit;							
		if(mysqli_query($link,$sql_in)or die(mysqli_error($link)))
		{
			echo "<script>window.location='selectbin3.php'</script>";	
		}
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" style="border-bottom:solid; border-bottom-color:#4ea1e1" >
	    <tr >
	      <td width="813" height="25" class="Mainheading">Sales Return - PV&nbsp;SLOC Master - Add Warehouse </td>
	    </tr></table></td>
...
<td width="302" colspan="3" align="left"  valign="middle" class="tbltext">&nbsp;<input name="txtperticulars" type="text" size="5" class="tbltext" tabindex="0" maxlength="5"  value="WH-PV"  onBlur="javascript:this.value=this.value.toUpperCase();" readonly="true" style="background-color:#CCCCCC" />
...
<tr >
<td valign="top" align="center"><a href="selectbin3.php"><img src="../images/back.gif" border="0"  style="display:inline;cursor:hand;"/></a>&nbsp;<a href="javascript:document.frmaddDept.reset()"></a>&nbsp;<input name="Submit" type="image" src="../images/submit_1.gif" alt="Submit Value" onClick="return mySubmit();"  border="0" style="display:inline;cursor:hand;"></td>
</tr>
</table>
</td><td width="30"></td>
</tr>
