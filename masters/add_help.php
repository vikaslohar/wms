...
require_once("../include/config.php");
	...
	if(isset($_POST['frm_action'])=='submit')
	{
		...
		//exit;
		 $parentimage1=trim($_FILES['txtupload']['name']);
		 if($parentimage1<>"")
		{
		 $imagepath1="../help/".$parentimage1;
		copy($_FILES['txtupload']['tmp_name'],$imagepath1);
		}
		  $sql_in="insert into tblhelp(help_title,help_file, help_role) values(
											  '$title',
											  '$imagepath1',
											  '$role1')";
				//exit;						
...
<title>Administrator-  Master - Add Help Manual</title>
...
{ 
	...
	{
	alert("Please enter Help Manual Master ");
	document.frmaddDepartment.title.focus();
	return false;
	}
	...
	if(document.frmaddDepartment.txtupload.value=="")
	{
	alert("Please  select help file");
	document.frmaddDepartment.txtupload.focus();
	return false;
	}
	if(document.frmaddDepartment.txtupload.value.charCodeAt() == 32)
	{
...
if(document.frmaddDepartment.txtupload.value!= "")
	{
		var extArray = new Array(".pdf", ".xls");
				var fileName = document.frmaddDepartment.txtupload.value
...
<td colspan="2" align="center" class="tblheading" valign="middle">Help Manual File Upload </td>
</tr>
<tr class="Dark"  height="25">
<td width="147" align="right" valign="middle" class="tblheading"> Title &nbsp;</td>
<td width="411" align="left" valign="middle" class="tbltext">&nbsp;<input name="title" type="text" class="tbltext" tabindex="0" value="" size="40"/> &nbsp;</td>
</tr>
<tr class="Light"  height="25">
<td width="147" align="right" valign="middle" class="tblheading">Help  File </td>
<td width="411" align="left" valign="middle" class="tbltext">&nbsp;<input name="txtupload" class="tbltext" type="file" size="40"  />  &nbsp;</td>
...
<td valign="middle" class="tbltext" align="center"><input type="checkbox" name="fet"  value="<?php echo $resetresult['id'];?>" /></a></td>
</tr>
<?php
	}
	else
