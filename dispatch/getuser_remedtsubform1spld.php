...
$totsub3=0;
$sql_tbl_subsub3=mysqli_query($link,"select * from tbl_pswrem_bartemp where plantcode='".$plantcode."' and  bar_subid='".$a."' and bar_tid='".$tid."' and bar_lotno='".$row['lotnumber']."'") or die(mysqli_error($link));
$totsub3=mysqli_num_rows($sql_tbl_subsub3);	
$row_subsub=mysqli_fetch_array($sql_tbl_subsub3);
...
<tr class="Light" height="30">
	...
	<td align="center"  valign="middle" class="smalltbltext" id="dtail_<?php echo $srno;?>"><a href="Javascript:void(0);" onclick="barcodupd('<?php echo $row['lotnumber'];?>','edit');">Update</a></td>
</tr>
 <?php
}
else
...
<input type="hidden" name="bacnos" id="bacnos" value="<?php echo $totsub3;?>" />
</table>
<br />
