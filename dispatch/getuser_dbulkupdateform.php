...
//frm_action=submit&txt11=&txt14=&txtid=1&logid=DP1&getdetflg=0&txtconchk=&txtptype=Bulk&txtcountrysl=&txtcountryl=&rettype=&date=16-03-2015&dcdate=16-03-2015&txtdcno=Test&txtpp=Bulk&txtstatesl=West%20Bengal&txtlocationsl=182&locationname=182&txtstfp=551&ecrop1=Bottle%20Gourd&evariety1=Sarita&eupstyp1=NST&eqty1=100%3Cbr%2F%3E&eordno1=OS2390%2FP%2FOB2&rnob1=&rqty1=&bnop1=100%3Cbr%2F%3E&selsh1=1&sn=2&lotsel=DP01536%2F00000%2F00C&sno1=4&txtolotno=DP01536%2F00000%2F00C&txtonob=10&txtoqty=277&extslwhg1=1&extslbing1=23&extslsubbg1=452&txtextnob1=10&txtextqty1=277&recnobp1=4&recqtyp1=100&txtbalnobp1=6&txtbalqtyp1=177.000&srno2=1&maintrid=0
...
<tr class="Dark" height="30">
	...
	<td align="center"  valign="middle" class="tbltext"><input type="radio" name="lotsel" value="<?php echo $lotno?>" onchange="sellot(this.value,<?php echo $sno1;?>,<?php echo $totnob;?>,<?php echo $totqty;?>,<?php echo $sn24;?>,'<?php echo $variety?>')"   /></td>
