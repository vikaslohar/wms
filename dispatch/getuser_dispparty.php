...
$pty="";
$sqlcode="SELECT disp_party FROM tbl_disp where plantcode='".$plantcode."' and  disp_tflg!=1 ORDER BY disp_party ASC";
...
if($t > 0)
{
	...
	{
		if($pty!="")
			$pty=$pty.",".$rowcode['disp_party'];
		else
			$pty=$rowcode['disp_party'];
	}
}
