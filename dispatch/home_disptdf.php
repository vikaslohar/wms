<?php
	...
	$sq=mysqli_query($link,"Select * from tbl_dtdf where plantcode='".$plantcode."' and dtdf_tflg=0 and dtdf_logid='$logid'") or die(mysqli_error($link));
	while($ro=mysqli_fetch_array($sq))
	{
		$arid=$ro['dtdf_id'];
		$s_sub="delete from tbl_dtdf_sub where dtdf_id='".$arid."'";
		mysqli_query($link,$s_sub) or die(mysqli_error($link));	
		$s_sub1="delete from tbl_dtdfsub_sub where dtdf_id='".$arid."'";
		mysqli_query($link,$s_sub1) or die(mysqli_error($link));	
		$s_sub2="delete from tbl_dtdfsub_sub2 where dtdf_id='".$arid."'";
		mysqli_query($link,$s_sub2) or die(mysqli_error($link));	
	}
	
	$ssub="delete from tbl_dtdf where dtdf_logid='".$logid."' and dtdf_tflg=0";
...
<title>Dispatch - Transaction - Dispatch TDF Seed - Home</title>
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#378b8b" >
	  ...
	  <table width="820" border="0" cellpadding="0" cellspacing="0" bordercolor="#378b8b" style="border-bottom:solid; border-bottom-color:#378b8b" >
	    <tr >
	      <td width="820" height="25">&nbsp;Transaction - Dispatch TDF Seed</td>
	    </tr></table></td>
...
<td align="center" width="100" valign="middle" class="tblbutn" style="cursor:Pointer;"><?php if($flg==0 && $flg1==0 && $flg2==0) { ?><a href="add_dispatch_tdf.php" style="text-decoration:none; color:#000000">Add </a><?php } else { ?><a href="Javascript:void(0);" onclick="alert('Can not perform Transaction.\nReason:\n1. Todays date is not in Active Current Financial Year.\n2. Transaction after todays date has been made.\n3. Cycle Inventory transaction is under process.');" style="text-decoration:none; color:#000000">Add </a><?php } ?></td>
</tr>
</table></td>
...
<tr class="Light">
	...
	<td align="center" valign="middle" class="smalltbltext"><?php echo $nqty;?></td>
	<!--<td align="center" valign="middle" class="smalltbltext"><?php echo $sloc;?></td>-->
    <td align="center" valign="middle" class="smalltbltext"><a href="select_disptdf_op.php?p_id=<?php echo $arrival_id;?>" >Outputs</a></td>
</tr>
<?php
}
else
