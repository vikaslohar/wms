<?php
	...
	if(isset($_POST['frm_action'])=='submit')
	{
		...
		$sql_main="update tbl_stoutm set stoutm_fromplant='$pltcode', stoutm_toplant='$plantcodes', stoutm_plant='$txtstfp', stoutm_ramarks='$txtremarks', tmode='$txt11', trans_name='$txttname', trans_lorryrepno='$txtlrn', trans_vehno='$txtvn', trans_paymode='$txt13', courier_name='$txtcname', docket_no='$txtdc', pname_byhand='$txtpname', stoutm_tflg='2' where stoutm_id='$mainid'";
	...
	if(mysqli_num_rows($res_code) > 0)
	{
		...
		$t_code=$row_code['0'];
		$code=$t_code+1;
		$code1="TDS".$code."/".$yearid_id."/".$lgnid;
	}
	else
	{
		$code=1;
