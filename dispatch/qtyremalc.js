...
if(tp=="item1")
{
var url="getuser_disppartyalc.php";
url=url+"?a="+str;
url=url+"&b="+d;
url=url+"&sid="+Math.random();
xmlHttp.onreadystatechange=stateChanged ;
...
xmlHttp.send(null);
 ...
 if(tp=="ordrno")
{
var url="getuser_ordernoalc.php";
url=url+"?a="+str;
url=url+"&sid="+Math.random();
xmlHttp.onreadystatechange=stateChanged ;
xmlHttp.open("GET",url,true);
...
xmlHttp.send(null);
 ...
 if(tp=="ordrbar")
{
var url="getuser_ordrbaralc.php";
url=url+"?a="+str;
url=url+"&b="+d;
url=url+"&c="+e;
url=url+"&h="+i;
...
if(tp=="orderdet")
{
var url="getuser_orderdetalc.php";
url=url+"?a="+str;
url=url+"&sid="+Math.random();
xmlHttp.onreadystatechange=stateChanged ;
xmlHttp.open("GET",url,true);
...
if(tp=="bardet")
{ 
var url="getuser_dispalcdetshow.php";
url=url+"?a="+str;
url=url+"&b="+d;
url=url+"&c="+e;
url=url+"&h="+i;
...
if(tp=="bardetupdate")
{ 
var url="getuser_dispalcdetupdate.php";
url=url+"?a="+str;
url=url+"&b="+d;
url=url+"&c="+e;
url=url+"&h="+i;
...
if(tp=="mainformedt")
{ 
var url="getuser_dispalcedtsubform.php";
url=url+"?a="+str;
url=url+"&b="+d;
url=url+"&c="+e;
url=url+"&h="+i;
...
if(tp=="mbform")
{ 
var url="getuser_dispalcnxtupdateform.php";
url=url+"?a="+str;
url=url+"&b="+d;
url=url+"&c="+e;
url=url+"&h="+i;
...
if(tp=="mbform2")
{ 
var url="getuser_dispalcnxtupdateform2.php";
url=url+"?a="+str;
url=url+"&b="+d;
url=url+"&c="+e;
url=url+"&h="+i;
...
if(tp=="mform")
{ 
var url="getuser_dispalcupdateform.php";
var params=str;
...
if(tp=="showordsel")
{
var url="getuser_showorselalc.php";
url=url+"?a="+str;
url=url+"&b="+d;
url=url+"&c="+e;
url=url+"&h="+i;
