<?php
	...
	$sql_barcode24=mysqli_query($link,"Select * from tbl_pswrem_bartemp where plantcode='".$plantcode."' and  bar_lotno='".$lotno."' and bar_tid='".$tid."' and bar_subid='".$subtid."' and bar_logid='".$logid."' and bar_psrn='".$txtpsrn."'") or die(mysqli_error($link));
	...
	$sql_barcode2=mysqli_query($link,"Select bar_barcodes from tbl_pswrem_bartemp where plantcode='".$plantcode."' and  bar_lotno='".$lotno."' and bar_tid='".$tid."' and bar_subid!='".$subtid."' and bar_logid='".$logid."' and bar_psrn='".$txtpsrn."'") or die(mysqli_error($link));
