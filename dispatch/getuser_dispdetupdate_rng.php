...
if($barcode!="")
{
	...
	$oqqt=$ro333['disps_oqty'];
	
	$ssq="Delete from tbl_dispsub_sub where plantcode='".$plantcode."' and  disp_id='$tid' and dpss_barcode='$barcode'";
...
$sq23=mysqli_query($link,"Select distinct dpss_lotno from tbl_dispsub_sub where plantcode='".$plantcode."' and  disps_id='$sid2' and disp_id='$tid'") or die(mysqli_error($link));
