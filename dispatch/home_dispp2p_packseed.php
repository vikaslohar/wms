<?php
	...
	$sql_tbl=mysqli_query($link,"SELECT   * from tbl_stoutmpack where plantcode='".$plantcode."' and  stoutmp_logid='".$logid."' and stoutmp_tflg=0") or die(mysqli_error($link));
	while($row_tbl=mysqli_fetch_array($sql_tbl))
	{
		$arrival_id=$row_tbl['stoutmp_id'];	
				
		$sql_tbl=mysqli_query($link,"select * from tbl_stoutmpack where plantcode='".$plantcode."' and  stoutmp_id='".$arrival_id."' ") or die(mysqli_error($link));
		while($row_tbl=mysqli_fetch_array($sql_tbl))
		{
			$sql_tblss=mysqli_query($link,"select * from tbl_stoutsspack where plantcode='".$plantcode."' and  stoutmp_id='".$arrival_id."' ") or die(mysqli_error($link));
			while($row_tblss=mysqli_fetch_array($sql_tblss))
			{
				$sql_mpmain="update tbl_mpmain set mpmain_dflg=0 where mpmain_barcode='".$row_tblss['stoutssp_barcode']."'";
				mysqli_query($link,$sql_mpmain) or die(mysqli_error($link));
					
				$sql_barcode="update tbl_barcodes set bar_dispflg=0 where bar_barcode='".$row_tblss['stoutssp_barcode']."' ";
				mysqli_query($link,$sql_barcode) or die(mysqli_error($link));
			}
			
			$s_sub1="delete from tbl_stoutsspack where stoutmp_id='".$arrival_id."'";
			mysqli_query($link,$s_sub1) or die(mysqli_error($link));
		}
		
		$s_sub="delete from tbl_stoutspack where stoutmp_id='".$arrival_id."'";
		mysqli_query($link,$s_sub) or die(mysqli_error($link));
		
		$s_sub="delete from tbl_stoutmpack where stoutmp_id='".$arrival_id."' ";
		mysqli_query($link,$s_sub) or die(mysqli_error($link));
	}
	$s_sub="delete from tbl_stoutmpack where stoutmp_logid='".$logid."' and stoutmp_tflg=0";
	mysqli_query($link,$s_sub) or die(mysqli_error($link));
	
	/*if(isset($_REQUEST['cancel'])) { $cflg = $_REQUEST['cancel']; }
	if(isset($_REQUEST['maintrid'])) { $maintrid = $_REQUEST['maintrid']; }
	
	if($cflg==1)
	{
		$sql_tbl=mysqli_query($link,"select * from tbl_stoutmpack where stoutmp_id='".$maintrid."' ") or die(mysqli_error($link));
		while($row_tbl=mysqli_fetch_array($sql_tbl))
		{
			$arrival_id=$row_tbl['stoutmp_id'];	
			$sql_tblss=mysqli_query($link,"select * from tbl_stoutsspack where stoutmp_id='".$maintrid."' ") or die(mysqli_error($link));
			while($row_tblss=mysqli_fetch_array($sql_tblss))
			{
				$sql_mpmain="update tbl_mpmain set mpmain_dflg=0 where mpmain_barcode='".$row_tblss['stoutssp_barcode']."'";
				mysqli_query($link,$sql_mpmain) or die(mysqli_error($link));
		...
		$s_sub="delete from tbl_stoutspack where stoutmp_id='".$maintrid."'";
		mysqli_query($link,$s_sub) or die(mysqli_error($link));
		
		$s_sub="delete from tbl_stoutmpack where stoutmp_id='".$maintrid."' ";
		mysqli_query($link,$s_sub) or die(mysqli_error($link));
	}*/
...
<title>Dispatch - Transaction - Pack Seed To Plant - Home</title>
...
{
winHandle=window.open('pston.php?itmid='+tid,'WelCome','top=170,left=180,width=820,height=450,scrollbars=yes');
if(winHandle==null){
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#378b8b" >
	  ...
	  <table width="820" border="0" cellpadding="0" cellspacing="0" bordercolor="#378b8b" style="border-bottom:solid; border-bottom-color:#378b8b" >
	    <tr >
	      <td width="820" height="25">&nbsp;Transaction - Dispatch Stock Transfer Pack Seed - Plant</td>
	    </tr></table></td>
...
<td align="center" width="100" valign="middle" class="tblbutn" style="cursor:Pointer;"><?php if($flg==0 && $flg1==0 && $flg2==0) { ?><a href="add_dispp2p_packseed.php" style="text-decoration:none; color:#000000">Add </a><?php } else { ?><a href="Javascript:void(0);" onclick="alert('Can not perform Transaction.\nReason:\n1. Todays date is not in Active Current Financial Year.\n2. Transaction after todays date has been made.\n3. Cycle Inventory transaction is under process.');" style="text-decoration:none; color:#000000">Add </a><?php } ?></td>
</tr>
</table></td>
...
<?php		
$sql_arr_home1=mysqli_query($link,"select * from tbl_stoutmpack where plantcode='".$plantcode."' and  stoutmp_tflg=2  order by stoutmp_id desc") or die(mysqli_error($link));
...
<table align="center" border="1" cellspacing="0" cellpadding="0" width="850" bordercolor="#378b8b" style="border-collapse:collapse">
            ...
            <tr class="tblsubtitle" height="20">
			  ...
			  <td width="82" align="center" valign="middle" class="smalltblheading">Transaction ID</td>
			  <td width="57" align="center" valign="middle" class="smalltblheading">Date</td>
			  <td width="189" align="center" valign="middle" class="smalltblheading">Party Name</td>
              <td width="96" align="center" valign="middle" class="smalltblheading">Crop</td>
              <td width="93" align="center" valign="middle" class="smalltblheading">Variety</td>
			  <td width="109" align="center" valign="middle" class="smalltblheading">Lot No.</td>
			  <td width="32" align="center" valign="middle" class="smalltblheading">NoP</td>
			  <td width="42" align="center" valign="middle" class="smalltblheading">NoMP</td>
			  <td width="50" align="center" valign="middle" class="smalltblheading">Qty</td>
              <td width="58" align="center" valign="middle" class="smalltblheading">Edit</td>
...
{
	$trdate=$row_arr_home1['stoutmp_date'];
	$tryear=substr($trdate,0,4);
	$trmonth=substr($trdate,5,2);
	$trday=substr($trdate,8,2);
	$trdate=$trday."-".$trmonth."-".$tryear;
	
	$lrole=$row_arr_home1['stoutmp_logid'];
	$arrival_id=$row_arr_home1['stoutmp_id'];
	
	
	$nob=""; $qty=""; $tnob=0; $tqty=0;  $crp=""; $ver=""; $ltn="";
	$sql_sub2=mysqli_query($link,"Select * from tbl_stoutspack where plantcode='".$plantcode."' and  stoutmp_id='$arrival_id'") or die(mysqli_error($link));
	$tot_sub2=mysqli_num_rows($sql_sub2);
	if($tot_sub2 > 0)
	{
		while($row_sub2=mysqli_fetch_array($sql_sub2))
		{
		$quer3=mysqli_query($link,"SELECT cropid, cropname FROM tblcrop where cropid='".$row_sub2['stoutsp_crop']."'");
		$noticia = mysqli_fetch_array($quer3);
		$crop=$noticia['cropname'];
		
		$quer4=mysqli_query($link,"SELECT varietyid, popularname FROM tblvariety  where varietyid='".$row_sub2['stoutsp_variety']."'"); 
		$noticia_item = mysqli_fetch_array($quer4);
		$variety=$noticia_item['popularname'];
		
		$lotno=$row_sub2['stoutsp_lotno'];
		//$qty=$row_sub2['stouts_qty'];
		
		if($nop!="")
			$nop=$nop."<br />".$row_sub2['stoutsp_loadnop']; 
		else
			$nop=$row_sub2['stoutsp_loadnop']; 
		
		if($nob!="")
			$nob=$nob."<br />".$row_sub2['stoutsp_loadnomp']; 
		else
			$nob=$row_sub2['stoutsp_loadnomp']; 
			
		if($qty!="")
			$qty=$qty."<br />".$row_sub2['stoutsp_loadqty']; 
		else
			$qty=$row_sub2['stoutsp_loadqty']; 
...
<tr class="Light">
	...
	<td align="center" valign="middle" class="smalltbltext"><?php echo "DS".$row_arr_home1['stoutmp_code']."/".$row_arr_home1['stoutmp_yearid']."/".$row_arr_home1['stoutmp_logid'];?></td>
	<td align="center" valign="middle" class="smalltbltext"><?php echo $trdate;?></td>
	<td align="center" valign="middle" class="smalltbltext"><?php echo $row_arr_home1['stoutmp_plantname'];?></td>
	...
	<td align="center" valign="middle" class="smalltbltext"><?php if($row_arr_home1['stoutmp_logid']==$logid){?><a href="edit_dispp2p_packseed.php?maintrid=<?php echo $arrival_id;?>"><img border="0" src="../images/edit.png"  style="display:inline;cursor:pointer;"  /></a><?php }?></td>
   <!-- <td align="center" valign="middle" class="smalltbltext"><a href="excelstol_packseed.php?pid=<?php echo $arrival_id;?>" target="_blank">Excel</a></td>-->
</tr>
<?php
}
else
...
?>
  ...
  $sql_arr_home=mysqli_query($link,"select * from tbl_stoutmpack where plantcode='".$plantcode."' and  stoutmp_tflg=1 order by stoutmp_id desc LIMIT $start, $limit") or die(mysqli_error($link));
...
$query = "select * from tbl_stoutmpack where plantcode='".$plantcode."' and stoutmp_tflg=1 order by stoutmp_id desc";
...
<table align="center" border="1" cellspacing="0" cellpadding="0" width="850" bordercolor="#378b8b" style="border-collapse:collapse">
            ...
            <tr class="tblsubtitle" height="20">
              <td width="18" align="center" valign="middle" class="smalltblheading">#</td>
			  <td width="80" align="center" valign="middle" class="smalltblheading">Transaction ID</td>
			  <td width="52" align="center" valign="middle" class="smalltblheading">Date</td>
			  <td width="192" align="center" valign="middle" class="smalltblheading">Party Name</td>
              <td width="77" align="center" valign="middle" class="smalltblheading">Crop</td>
              <td width="76" align="center" valign="middle" class="smalltblheading">Variety</td>
			  <td width="101" align="center" valign="middle" class="smalltblheading">Lot No.</td>
			  <td width="37" align="center" valign="middle" class="smalltblheading">NoP</td>
			  <td width="41" align="center" valign="middle" class="smalltblheading">NoMP</td>
			  <td width="46" align="center" valign="middle" class="smalltblheading">Qty</td>
              <td width="54" align="center" valign="middle" class="smalltblheading">PSTON</td>
...
{
	$trdate=$row_arr_home['stoutmp_date'];
	$tryear=substr($trdate,0,4);
	$trmonth=substr($trdate,5,2);
	$trday=substr($trdate,8,2);
	$trdate=$trday."-".$trmonth."-".$tryear;
	
	$lrole=$row_arr_home['stoutmp_logid'];
	$arrival_id=$row_arr_home['stoutmp_id'];
	
	
	$nob=""; $qty=""; $tnob=0; $tqty=0;  $crp=""; $ver=""; $ltn=""; $nop="";
...
<tr class="Light">
	...
	<td align="center" valign="middle" class="smalltbltext"><?php echo "DS".$row_arr_home['stoutmp_code']."/".$row_arr_home['stoutmp_yearid']."/".$row_arr_home['stoutmp_logid'];?></td>
	<td align="center" valign="middle" class="smalltbltext"><?php echo $trdate;?></td>
	<td align="center" valign="middle" class="smalltbltext"><?php echo $row_arr_home['stoutmp_plantname'];?></td>
	<td align="center" valign="middle" class="smalltbltext"><?php echo $crp;?></td>
	<td align="center" valign="middle" class="smalltbltext"><?php echo $ver;?></td>
	<td align="center" valign="middle" class="smalltbltext"><?php echo $ltn;?></td>
	<td align="center" valign="middle" class="smalltbltext"><?php echo $nop;?></td>
	<td align="center" valign="middle" class="smalltbltext"><?php echo $nob;?></td>
	<td align="center" valign="middle" class="smalltbltext"><?php echo $qty;?></td>
	<td align="center" valign="middle" class="smalltbltext"><a href="Javascript:void(0)" onclick="openslocpopprint('<?php echo $arrival_id;?>');">PSTON</a></a></td>
    <td align="center" valign="middle" class="smalltbltext"><a href="excelstol_packseed.php?pid=<?php echo $arrival_id;?>" target="_blank">Excel</a></td>
</tr>
<?php
}
