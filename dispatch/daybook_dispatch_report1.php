...
winHandle=window.open('daybook_dispatch_report2.php?sdate='+sdate+'&edate='+edate+'&txtstate='+txtstate+'&txtloc='+txtloc+'&txtparty='+txtparty+'&txtdisptype='+txtdisptype,'WelCome','top=170,left=180,width=820,height=350,scrollbars=yes');
if(winHandle==null){
alert("While Launching New Window...\nYour browser maybe blocking up Popup windows. \n\n  Please check your Popup Blocker Settings or ..\n Please hold Ctrl Key and Click on link to open new Browser"); }
}	
function mySubmit()
...
<td>
  <?php
	...
	$crp="ALL"; $ver="ALL"; $locname="ALL"; $partyname="ALL"; $totnqty=0; $totnomp=0;  $totgrtotal=0;
...
<tr class="Light">
	...
	<td align="center" valign="middle" class="smalltbltext"><a href="daybook_dispatch_report_output.php?p_id=<?php echo $rowdispm['disp_id']; ?>&optyp=disp" target="_blank">Output</a></td>
</tr>
<?php
$srno=$srno+1;
}
...
<tr class="Light">
	...
	<td align="center" valign="middle" class="smalltbltext"><?php echo $nomp;?></td>
	<td align="center" valign="middle" class="smalltbltext"><?php echo $grwt;?></td>
	<td align="center" valign="middle" class="smalltbltext"><a href="daybook_dispatch_report_output.php?p_id=<?php echo $rowdispm2['dbulk_id']; ?>&optyp=bulk" target="_blank">Output</a></td>
</tr>
<?php
$srno=$srno+1;
}
...
<tr class="Light">
	...
	<td align="center" valign="middle" class="smalltbltext"><?php echo $nomp;?></td>
	<td align="center" valign="middle" class="smalltbltext"><?php echo $grwt;?></td>
	<td align="center" valign="middle" class="smalltbltext"><a href="daybook_dispatch_report_output.php?p_id=<?php echo $rowdispm2['pswrem_id']; ?>&optyp=release" target="_blank">Output</a></td>
</tr>
<?php
$srno=$srno+1;
}
...
<tr class="Light">
	...
	<td align="center" valign="middle" class="smalltbltext"><?php echo $nomp;?></td>
	<td align="center" valign="middle" class="smalltbltext"><?php echo $grwt;?></td>
	<td align="center" valign="middle" class="smalltbltext"><a href="daybook_dispatch_report_output.php?p_id=<?php echo $rowdispm2['dtdf_id']; ?>&optyp=tdf" target="_blank">Output</a></td>
</tr>
<?php
$srno=$srno+1;
}
...
<tr class="Light">
	...
	<td align="center" valign="middle" class="smalltbltext"><?php echo $nomp;?></td>
	<td align="center" valign="middle" class="smalltbltext"><?php echo $grwt;?></td>
	<td align="center" valign="middle" class="smalltbltext"><a href="daybook_dispatch_report_output.php?p_id=<?php echo $rowdispm['tid']; ?>&optyp=discard" target="_blank">Output</a></td>
</tr>
<?php
$srno=$srno+1;
}
...
<tr >
<td height="30" align="center" valign="top"><a href="daybook_dispatch_report.php"><img src="../images/back.gif" border="0"  style="display:inline;cursor:pointer;"/></a>&nbsp;&nbsp;<img src="../images/printpreview.gif" onclick="openprint()" style="cursor:pointer" border="0" /><input type="hidden" name="txtinv" /></td>
</tr>
</table>
