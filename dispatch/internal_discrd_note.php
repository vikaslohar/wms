...
function mmLoadMenus() {if (window.mm_menu_0804145533_0) return;
  window.mm_menu_0804145533_0 = new Menu("root",167,18,"Arial, Verdana, Helvetica, sans-serif",12,"#000000","#FFFFFF","#D2E9FF","#378b8b","left","middle",3,0,1000,-5,7,true,false,true,0,true,true);
  ...
  window.mm_menu_0804150040_0 = new Menu("root",164,18,"Arial, Verdana, Helvetica, sans-serif",12,"#000000","#FFFFFF","#D2E9FF","#378b8b","left","middle",3,0,1000,-5,7,true,false,true,0,true,true);
  ...
  window.mm_menu_0804152609_0 = new Menu("root",231,18,"Arial, Verdana, Helvetica, sans-serif",12,"#000000","#FFFFFF","#D2E9FF","#378b8b","left","middle",3,0,1000,-5,7,true,false,true,0,true,true);
...
<table width="1004" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="1004"><?php require_once("../include/arr_dispatch.php");?></td>
  </tr>
  <tr>
  <td>
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#378b8b" >
	  ...
	  <table width="809" border="0" cellpadding="0" cellspacing="0" bordercolor="#378b8b" style="border-bottom:solid; border-bottom-color:#378b8b" >
	    <tr >
	      <td width="940" height="25">&nbsp;Transction Issue -Internal Discard Note </td>
	    </tr></table></td>
...
<?php
	...
	$sql_sel="select * from tbl_bin where plantcode='".$plantcode."'  order by binname LIMIT $from, $max_results";
	$res=mysqli_query($link,$sql_sel) or die (mysqli_error($link));
	
	$total=mysqli_num_rows($res);
	$total_results3 =mysqli_query($link,"SELECT COUNT(*)  FROM tbl_bin where plantcode='".$plantcode."'");
...
<table align="center" border="1" cellspacing="0" cellpadding="0" width="850" bordercolor="#378b8b" style="border-collapse:collapse">
            <tr class="tblsubtitle" height="35">
              <td colspan="3" height="23" align="center" valign="middle" class="tblheading">Stock</td>
			...
			<tr class="tblsubtitle">
				   ...
				   <td width="16%" align="center" valign="middle" class="tblheading">Qty</td>
				   <td width="16%" align="center" valign="middle" class="tblheading">UPS</td>
				   <td width="16%" align="center" valign="middle" class="tblheading">Qty</td>
              </tr>
			<tr class="<?php echo $trcls;?>" height="25">
              ...
              <td width="16%" align="center" valign="middle" class="smalltbltext">&nbsp;</td>
...
<tr >
<td valign="top" align="center"><a href="home_material_discard.php"><img src="../images/back.gif" border="0"  style="display:inline;cursor:hand;"/></a>&nbsp;<a href="javascript:document.frmaddDept.reset()"></a>&nbsp;</td>
</tr>
</table>
</td>
<td width="30"></td>
