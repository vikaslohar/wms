<?php
	...
	$zx="";$a="";$b="";
	/*$sql_barcode=mysqli_query($link,"Select bar_barcode from tbl_barcodes where bar_barcode IN ($abrc)") or die(mysqli_error($link));
	...
	if(isset($_POST['frm_action'])=='submit')
	{
		...
		opener.document.frmaddDepartment.bacnos.value=<?php echo $totnomp?>;
		var x='dtail_'+<?php echo $dval24?>;
		opener.document.getElementById(x).innerHTML="<a href=Javascript:void(0) onclick=barcodupd('<?php echo $lotno;?>','edit')>Details</a>";
