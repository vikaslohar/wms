...
if($barcodes!="")
{
	...
	$sqlmmc=mysqli_query($link,"Select * from tbl_dallocmmc where plantcode='".$plantcode."' and  dalloc_id='$tid' and dmmc_flg=1 and dmmc_barcode='$barcodes'") or die(mysqli_error($link));
...
<td width="714"  colspan="3" align="left"  valign="middle" class="tbltext" id="vitem1">&nbsp;<?php echo $noticia['business_name'];?></td>
	</tr>
<?php
...
<td align="left"  valign="middle" class="tbltext" colspan="3" id="vaddress"><div style="padding-left:3px"><?php if($row33['city']!=""){ echo $row33['city'];}?>, <?php echo $row33['state'];?></div></td>
</tr>
</table>
<br />
<table align="center" border="1" width="750" cellspacing="0" cellpadding="0" bordercolor="#378b8b" style="border-collapse:collapse" > 
...
<?php
$sno=1;
$sqlbarc1=mysqli_query($link,"Select * from tbl_dallocmmc where plantcode='".$plantcode."' and  dalloc_id='$tid' and dmmc_flg=1 and dmmc_barcode='$barcodes'") or die(mysqli_error($link));
...
while($rowbarc1=mysqli_fetch_array($sqlbarc1))
{
	...
	$subtid=$rowbarc1['dallocs_id'];
	$extslsubbg=$rowbarc1['dmmc_esubbin'];
	$ui1=$rowbarc1['dmmc_eups'];
	$nob=$rowbarc1['dmmc_nolp'];
	$qty=$rowbarc1['dmmc_qty'];
				
	$sqllot2=mysqli_query($link,"Select * from tbl_dalloc_sub where plantcode='".$plantcode."' and  dalloc_id='$tid' and dallocs_id='$subtid'") or die(mysqli_error($link));
