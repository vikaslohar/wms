...
if($barcode!="")
{
	$sq33=mysqli_query($link,"Select * from tbl_dispsub_sub where disp_id='$tid' and dpss_barcode='$barcode'") or die(mysqli_error($link));
	$ro33=mysqli_fetch_array($sq33);
	$sid=$ro33['disps_id'];
	
	$sq333=mysqli_query($link,"Select * from tbl_disp_sub where disp_id='$tid' and disps_id='$sid'") or die(mysqli_error($link));
	...
	//$barcode=""; 
	$sq=mysqli_query($link,"Select * from tbl_dispsub_sub where disp_id='$tid' and disps_id='$sid' and dpss_barcode!='$barcode'") or die(mysqli_error($link));
