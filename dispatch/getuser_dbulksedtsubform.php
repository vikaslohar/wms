...
$sq2=mysqli_query($link,"Select * from tbl_dbulk_sub where plantcode='".$plantcode."' and  dbulks_id='$subtid' and dbulk_id='$tid'") or die(mysqli_error($link));
$nups=""; $nvariety="";
...
$sqq2=mysqli_query($link,"Select * from tbl_dbulksub_sub where plantcode='".$plantcode."' and  dbulks_id='$subtid' and dbss_lotno='$ltn' ") or die(mysqli_error($link));
$roo2=mysqli_fetch_array($sqq2);

$subsubtid=$roo2['dbss_id'];
$sqq24=mysqli_query($link,"Select * from tbl_dbulksub_sub2 where plantcode='".$plantcode."' and  dbulks_id='$subtid' and dbss_is='".$roo2['dbss_id']."' and dbsss_wh='".$row_issuetbl['lotldg_whid']."' and dbsss_bin='".$row_issuetbl['lotldg_binid']."' and dbsss_subbin='".$row_issuetbl['lotldg_subbinid']."' ") or die(mysqli_error($link));
