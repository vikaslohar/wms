...
<!--<table align="center" border="1" cellspacing="0" cellpadding="0" width="700" bordercolor="#378b8b" style="border-collapse:collapse">
  ...
  $sql_arr_home=mysqli_query($link,"select * from tbl_dbulk where plantcode='".$plantcode."' and  dbulk_tflg=2 order by dbulk_id DESC LIMIT $start, $limit") or die(mysqli_error($link));
...
<tr class="Light" height="20">
  <td colspan="6" align="center" class="tblheading">Dispatch Bulk Seed - Pending List</td>
</tr>
</table>
...
<tr class="Light">
    ...
    <td align="center" valign="middle" class="smalltbltext"><a href="edit_dispatch_bulk.php?pid=<?php echo $arrival_id;?>" ><img border="0" src="../images/edit.png"  style="display:inline;cursor:pointer;"  /></a></td>
</tr>
<?php
}
else
...
<?php echo $pagination; }?>
  ...
  $sql_arr_home=mysqli_query($link,"select * from tbl_dbulk where plantcode='".$plantcode."' and  dbulk_tflg=1 order by dbulk_id DESC LIMIT $start2, $limit2") or die(mysqli_error($link));
 $tot_arr_home=mysqli_num_rows($sql_arr_home);
...
$query = "select * from tbl_dbulk where plantcode='".$plantcode."' and dbulk_tflg=1 order by dbulk_id DESC";
$total_pages2 = mysqli_num_rows(mysqli_query($link,$query));
//echo	$total_pages = $total_pages[num];
...
<table align="center" border="0" width="850" cellspacing="0" cellpadding="0" bordercolor="#378b8b" style="border-collapse:collapse" > 
<tr class="Light" height="20">
  <td colspan="6" align="center" class="tblheading">Dispatch Bulk Seed - Completed List</td>
</tr>
</table>
<table align="center" border="1" cellspacing="0" cellpadding="0" width="850" bordercolor="#378b8b" style="border-collapse:collapse">
