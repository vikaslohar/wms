...
$sql_tbl=mysqli_query($link,plantcode='".$plantcode."' and   * from tbl_dtdf where plantcode='".$plantcode."' and  dtdf_id='".$tid."'") or die(mysqli_error($link));
...
<title>Dispatch - Transaction - Dispatch - Allocation Type - Loading Slip</title>
...
$sql23="select * from tbluser where plantcode='".$plantcode."' and  scode='".$row_tbl['dtdf_logid']."'";
...
$code1=$row_param['code']."/"."SD"."/".$ycode."/".$row_code1['dnote_code'];
	
$ordernos=""; $porefno="";
$sql_arrsub=mysqli_query($link,"select * from tbl_dtdf_sub where plantcode='".$plantcode."' and  dtdf_id='".$pid."'") or die(mysqli_error($link));
...
<?php
$sql_arr_home1=mysqli_query($link,"select distinct disps_variety from tbl_dtdf_sub where plantcode='".$plantcode."' and  dtdf_id='$tid' and disps_flg=1 order by disps_variety asc") or die(mysqli_error($link));
$tot_arr_home1=mysqli_num_rows($sql_arr_home1);
if($tot_arr_home1 >0) 
{ 
	while($row_arr_home1=mysqli_fetch_array($sql_arr_home1))
	{
		$sql_arr_home2=mysqli_query($link,"select distinct disps_upstype from tbl_dtdf_sub where plantcode='".$plantcode."' and  dtdf_id='$tid' and disps_flg=1 and disps_variety='".$row_arr_home1['disps_variety']."' order by disps_upstype desc") or die(mysqli_error($link));
		...
		{ 
			while($row_arr_home2=mysqli_fetch_array($sql_arr_home2))
			{
				...
				$sql_arr_home3=mysqli_query($link,"select distinct disps_ups from tbl_dtdf_sub where plantcode='".$plantcode."' and  dtdf_id='$tid' and disps_flg=1 and disps_variety='".$row_arr_home1['disps_variety']."' and disps_upstype='".$row_arr_home2['disps_upstype']."' order by disps_id asc") or die(mysqli_error($link));
				...
				{ 
					while($row_arr_home3=mysqli_fetch_array($sql_arr_home3))
					{
						...
						$sql_arr_home33=mysqli_query($link,"select * from tbl_dtdf_sub where plantcode='".$plantcode."' and  dtdf_id='$tid' and disps_flg=1 and disps_variety='".$row_arr_home1['disps_variety']."' and disps_upstype='".$row_arr_home2['disps_upstype']."' and disps_ups='".$row_arr_home3['disps_ups']."' order by disps_id asc") or die(mysqli_error($link));
						...
						{ 
							while($row_arr_home33=mysqli_fetch_array($sql_arr_home33))
							{
								...
								$sq2=mysqli_query($link,"Select distinct dpss_lotno from tbl_dtdfsub_sub where plantcode='".$plantcode."' and  disps_id='$sid' and dtdf_id='$tid'") or die(mysqli_error($link));
...
<?php
$srno=1;
$sq3=mysqli_query($link,"Select * from tbl_dtdfsub_sub where plantcode='".$plantcode."' and  dpss_lotno='$lot2' and disps_id='$sid' and dtdf_id='$tid'") or die(mysqli_error($link));
