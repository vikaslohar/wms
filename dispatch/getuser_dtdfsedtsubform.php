...
$sq2=mysqli_query($link,"Select * from tbl_dtdf_sub where plantcode='".$plantcode."' and dtdfs_id='$subtid' and dtdf_id='$tid'") or die(mysqli_error($link));
$nups=""; $nvariety="";
...
{ 
	...
	$sqq2=mysqli_query($link,"Select * from tbl_dtdfsub_sub where plantcode='".$plantcode."' and dtdfs_id='$subtid' and dbss_lotno='$ltn' ") or die(mysqli_error($link));
	$roo2=mysqli_fetch_array($sqq2);
	
	$subsubtid=$roo2['dbss_id'];
	$sqq24=mysqli_query($link,"Select * from tbl_dtdfsub_sub2 where plantcode='".$plantcode."' and dtdfs_id='$subtid' and dbss_is='".$roo2['dbss_id']."' and dbsss_wh='".$row_issuetbl['lotldg_whid']."' and dbsss_bin='".$row_issuetbl['lotldg_binid']."' and dbsss_subbin='".$row_issuetbl['lotldg_subbinid']."' ") or die(mysqli_error($link));
	$roo24=mysqli_fetch_array($sqq24);
	

$aldnob=0; $aldqty=0;
$sqq=mysqli_query($link,"Select * from tbl_dtdfsub_sub where plantcode='".$plantcode."' and dtdf_id='$tid' and dbss_lotno='".$row_issuetbl['lotldg_lotno']."' and dtdfs_id!='$subtid' and dbss_id!='$subsubtid'") or die(mysqli_error($link));
while($roo=mysqli_fetch_array($sqq))
{
	$sqq2=mysqli_query($link,"Select * from tbl_dtdfsub_sub2 where plantcode='".$plantcode."' and dtdf_id='$tid' and dbss_is='".$roo['dbss_id']."' and dbsss_subbin='".$row_issuetbl['lotldg_subbinid']."' and dtdfs_id!='$subtid' and dbss_is!='$subsubtid' ") or die(mysqli_error($link));
...
<tr class="Light" height="30">
 ...
 <td  align="center"  valign="middle" class="smalltbltext" ><input name="recnobp<?php echo $srno2?>" id="recnobp<?php echo $srno2?>" type="text" size="7" class="smalltbltext" tabindex=""   maxlength="7" onkeypress="return isNumberKey1(event)" onchange="qtychk1(this.value,<?php echo $srno2?>);" value="<?php echo $roo24['dbsss_nob'];?>"  />&nbsp;<font color="#FF0000" >* </font>&nbsp;</td>

  
  <td  align="center"  valign="middle" class="smalltbltext"><input name="recqtyp<?php echo $srno2?>" id="recqtyp<?php echo $srno2?>" type="text" size="8" class="smalltbltext" tabindex="" maxlength="10" onchange="Bagschk1(this.value,<?php echo $srno2?>);"  onkeypress="return isNumberKey(event)"  value="<?php echo $roo24['dbsss_qty'];?>" />&nbsp;<font color="#FF0000" >* </font>&nbsp;<input type="hidden" name="txtrecoqtyp<?php echo $srno2?>" id="txtrecoqtyp<?php echo $srno2?>" value="<?php echo $roo24['dbsss_qty'];?>" /></td>
  
      <td align="center"  valign="middle" class="smalltbltext"><input name="txtbalnobp<?php echo $srno2?>" id="txtbalnobp<?php echo $srno2?>" type="text" size="7" class="smalltbltext" tabindex="" maxlength="7" onkeypress="return isNumberKey(event)"  value="<?php echo $roo24['dbsss_bnob'];?>" /></td>
       
      <td align="center"  valign="middle" class="smalltbltext"><input name="txtbalqtyp<?php echo $srno2?>" id="txtbalqtyp<?php echo $srno2?>" type="text" size="8" class="smalltbltext" tabindex=""   maxlength="10" onkeypress="return isNumberKey1(event)" style="background-color:#CCCCCC" readonly="true" value="<?php echo $roo24['dbsss_bqty'];?>" /></td>
  </tr>
<?php
}
}
...
$sql_issuetbl=mysqli_query($link,"select * from tbl_lot_ldg_pack where plantcode='".$plantcode."' and lotdgp_id='".$row_issue1[0]."' and balqty > 0") or die(mysqli_error($link)); 
 ...
 { 
	...
	$subsubtid=$roo2['dbss_id'];
	$sqq24=mysqli_query($link,"Select * from tbl_dtdfsub_sub2 where plantcode='".$plantcode."' and dtdfs_id='$subtid' and dbss_is='".$roo2['dbss_id']."'") or die(mysqli_error($link));
	$roo24=mysqli_fetch_array($sqq24);


$aldnob=0; $aldqty=0;
$sqq=mysqli_query($link,"Select * from tbl_dtdfsub_sub where plantcode='".$plantcode."' and dtdf_id='$tid' and dbss_lotno='".$row_issuetbl['lotno']."' and dtdfs_id!='$subtid' and dbss_id!='$subsubtid'") or die(mysqli_error($link));
while($roo=mysqli_fetch_array($sqq))
{
	$sqq2=mysqli_query($link,"Select * from tbl_dtdfsub_sub2 where plantcode='".$plantcode."' and dtdf_id='$tid' and dbss_is='".$roo['dbss_id']."' and dbsss_subbin='".$row_issuetbl['subbinid']."' and dtdfs_id!='$subtid' and dbss_is!='$subsubtid' ") or die(mysqli_error($link));
	while($roo2=mysqli_fetch_array($sqq2))
	{
		$aldnob=$aldnob+$roo2['dbsss_nob'];
		$aldqty=$aldqty+$roo2['dbsss_qty'];
...
?>
 ...
 <td  align="center"  valign="middle" class="smalltbltext" ><input name="recnobp<?php echo $srno2?>" id="recnobp<?php echo $srno2?>" type="text" size="7" class="smalltbltext" tabindex=""   maxlength="7" onkeypress="return isNumberKey1(event)" onchange="qtychk1(this.value,<?php echo $srno2?>);" value="<?php echo $roo24['dbsss_nob'];?>"  />&nbsp;<font color="#FF0000" >* </font>&nbsp;</td>
  <td  align="center"  valign="middle" class="smalltbltext"><input name="recqtyp<?php echo $srno2?>" id="recqtyp<?php echo $srno2?>" type="text" size="8" class="smalltbltext" tabindex="" maxlength="10" onchange="Bagschk1(this.value,<?php echo $srno2?>);"  onkeypress="return isNumberKey(event)"  value="<?php echo $roo24['dbsss_qty'];?>" />&nbsp;<font color="#FF0000" >* </font>&nbsp;<input type="hidden" name="txtrecoqtyp<?php echo $srno2?>" id="txtrecoqtyp<?php echo $srno2?>" value="<?php echo $roo24['dbsss_qty'];?>" /></td>
   <td align="center"  valign="middle" class="smalltbltext"><input name="txtbalnobp<?php echo $srno2?>" id="txtbalnobp<?php echo $srno2?>" type="text" size="7" class="smalltbltext" tabindex="" maxlength="7" onkeypress="return isNumberKey(event)"  value="<?php echo $roo24['dbsss_bnob'];?>" style="background-color:#CCCCCC" readonly="true" /></td>
   <td align="center"  valign="middle" class="smalltbltext"><input name="txtbalqtyp<?php echo $srno2?>" id="txtbalqtyp<?php echo $srno2?>" type="text" size="8" class="smalltbltext" tabindex=""   maxlength="10" onkeypress="return isNumberKey1(event)" style="background-color:#CCCCCC" readonly="true" value="<?php echo $roo24['dbsss_bqty'];?>" /></td>
  </tr>
<?php
}
...
<tr >
<td valign="top" align="right"><img src="../images/update.gif" border="0"style="display:inline;cursor:Pointer;" id="updatebutn" onClick="pformedtup();" />&nbsp;&nbsp;</td>
</tr>
</table>