...
<title>Dispatch - Transaction - Add material Discard</title>
...
<td width="564" align="left"  valign="middle" class="tbltext" style=" border-color:#378b8b" colspan="3">&nbsp;<input type="text" class="tbltext" name="txtaddress" size="70" maxlength="70" value="<?php echo $row['address'];?>" >&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
</tr>
<tr class="Dark" height="30">
<td width="180" align="right"  valign="middle" class="tblheading" style=" border-color:#378b8b">&nbsp;Address 2&nbsp;</td>
<td width="564" align="left"  valign="middle" class="tbltext" style=" border-color:#378b8b" colspan="3">&nbsp;<input type="text" class="tbltext" name="txtaddress1" size="70" maxlength="70" value="<?php echo $row['address1'];?>" >&nbsp;</td>
</tr>
<tr class="Light" height="30">
<td width="180" align="right"  valign="middle" class="tblheading" style=" border-color:#378b8b">&nbsp;City/Town/Village&nbsp;</td>
<td width="564" align="left"  valign="middle" class="tbltext" style=" border-color:#378b8b" colspan="3">&nbsp;<input type="text" class="tbltext" name="txtcity" size="50" maxlength="50" value="<?php echo $row['city'];?>" >&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
</tr>
<tr class="Dark" height="30">
<td width="180" align="right"  valign="middle" class="tblheading" style=" border-color:#378b8b">&nbsp;Pin&nbsp;</td>
<td width="564" align="left"  valign="middle" class="tbltext" style=" border-color:#378b8b" colspan="3">&nbsp;<input type="text" class="tbltext" name="txtpin" size="6" maxlength="6" value="<?php if($row['pin'] > 0){ echo $row['pin'];} else { echo "";}?>" onkeypress="return isNumberKey(event)" >&nbsp;</td>
</tr>
<?php
...
<td width="564" align="left"  valign="middle" class="tbltext" style=" border-color:#378b8b" colspan="3">&nbsp;<input type="text" class="tbltext" name="txtphone" size="15" maxlength="15" value="<?php echo $row['phoneno'];?>" onkeypress="return isNumberKey(event)" >&nbsp;</td>
</tr>
  <tr class="Light" height="25">
...
<table id="transmode" align="center" border="1" width="750" cellspacing="0" cellpadding="0" bordercolor="#378b8b" style="display:<?php if($row['tmode'] != "") { echo "Block"; } else { echo "none";} ?>" > 
<tr class="Dark" height="25">
...
<table id="trans" align="center" border="1" width="750" cellspacing="0" cellpadding="0" bordercolor="#378b8b" style="display:<?php if($row['tmode'] == "Transport"){ echo "block";}else{ echo "none";} ?>" > 
<tr class="Light" height="30">
...
<table id="courier" align="center" border="1" width="750" cellspacing="0" cellpadding="0" bordercolor="#378b8b" style="display:<?php if($row['tmode'] == "Courier"){ echo "block";}else{ echo "none";} ?>" > 
<tr class="Dark" height="30">
...
<table id="byhand" align="center" border="1" width="750" cellspacing="0" cellpadding="0" bordercolor="#378b8b" style="display:<?php if($row['tmode'] == "By Hand"){ echo "block";}else{ echo "none";} ?>" > 
<tr class="Dark" height="30">
...
<td width="656" align="left"  valign="middle" class="tbltext">&nbsp;<textarea name="txtremarks" class="tbltext" cols="100" rows="3"><?php echo $row['remarks'];?></textarea></td>
</tr>
</table>
