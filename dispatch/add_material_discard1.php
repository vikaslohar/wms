...
<title>Dispatch - Transaction - Issue- Material Return to Vendor</title>
...
<table id="trans" align="center" border="1" width="750" cellspacing="0" cellpadding="0" bordercolor="#378b8b" style="display:none" > 
...
<table id="courier" align="center" border="1" width="750" cellspacing="0" cellpadding="0" bordercolor="#378b8b" style="display:none" > 
<tr class="Light" height="30">
...
<table align="center" border="1" width="850" cellspacing="0" cellpadding="0" bordercolor="#378b8b" style="border-collapse:collapse" > 		
 <?php 
$quer3=mysqli_query($link,"select classification_id, classification from tbl_classification") or die(mysqli_error($link));
?>
		 <tr class="Dark" height="25">
...
<table align="center" border="1" width="850" cellspacing="0" cellpadding="0" bordercolor="#378b8b" style="border-collapse:collapse" > <tr class="tblsubtitle" height="20">
...
$srno=1;
 ...
 { 
$sql_issue1=mysqli_query($link,"select max(stlg_id) from tbl_stldg_good where plantcode='".$plantcode."' and   stlg_subbinid='".$row_issue['stlg_subbinid']."' and stlg_binid='".$row_issue['stlg_binid']."' and stlg_whid='".$row_issue['stlg_whid']."'") or die(mysqli_error($link));
$row_issue1=mysqli_fetch_array($sql_issue1); 

$sql_issuetbl=mysqli_query($link,"select * from tbl_stldg_good where plantcode='".$plantcode."' and   stlg_id='".$row_issue1[0]."'") or die(mysqli_error($link)); 
...
$sql_whouse=mysqli_query($link,"select perticulars from tbl_warehouse where plantcode='".$plantcode."' and   whid='".$row_issuetbl['stlg_whid']."'") or die(mysqli_error($link));
