...
<title>Dispatch - Transaction - Pack Seed SP Release Note - PSSPRN</title>
...
?>
<table align="center" border="1" width="780" cellspacing="0" cellpadding="0" bordercolor="#378b8b" style="border-collapse:collapse" > 
<tr class="Light">
...
<HR />
<tr height="20">
  <td colspan="6" align="center" class="Mainheading">Pack Seed SP Release-RO Note (PSSPRN)</td>
</tr>
...
<td width="234"  align="left" valign="middle" class="smalltbltext">&nbsp;<?php echo "CR".$row_tbl['pswrem_code']."/".$yearid_id."/".$lgnid;?></td>

<td width="172" align="right" valign="middle" class="tblheading">&nbsp;Date&nbsp;</td>
<td width="229" align="left" valign="middle" class="smalltbltext">&nbsp;<?php echo $tdate;?>&nbsp;</td>
</tr>
...
<td width="172" align="right" valign="middle" class="tblheading">&nbsp;Party&nbsp;</td>
...
$sql_tbl_subsub=mysqli_query($link,"select * from tbl_pswremsub_sub where pswremsub_id='".$row_tbl_sub['pswremsub_id']."' and pswrem_id='".$row_tbl_sub['pswrem_id']."'") or die(mysqli_error($link));
