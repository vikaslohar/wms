<?php
	...
	{	
		...
		$sql_main="update tbl_discard set  yearcode='$yearid_id', drno='$txtdrno', party_name='$txtparty', address='$txtaddress', address1='$adress1', city='$city', pin='$pin', state='$state', tmode='$txt11', tname='$txttname', lrno='$txtlrn', vno='$txtvn', pmode='$txt14', cname='$txtcname', dcno='$txtdc', pname='$txtpname', rettyp='$rettyp', remarks= '$remarks', phoneno= '$txtphone' where tid = '$p_id'";
$a123456=mysqli_query($link,$sql_main) or die(mysqli_error($link));

		//exit;
		echo "<script>window.location='add_discard_str_preview.php?p_id=$p_id'</script>"; 
}
...
//}}
//}
$sql_code="SELECT MAX(tcode) FROM tbl_discard  where plantcode='".$plantcode."' and  yearcode='$yearid_id'  ORDER BY tcode DESC";
...
<title>Dispatch -Transaction - Material Discard</title>
...
function openslocpop1()
{
	...
	if(document.frmaddDept.txtitem.value!="")
	{
		...
		winHandle=window.open('item_sloc_details.php?itmid='+itm+'&tid='+tid,'WelCome','top=170,left=180,width=420,height=350,scrollbars=yes');
		if(winHandle==null)
		{
...
{
document.frmaddDept.txtappli.value="";
if(optapp!="")
	{
...
<td width="180" align="right"  valign="middle" class="tblheading" style=" border-color:#378b8b">&nbsp;Address 1&nbsp;</td>
<td width="564" align="left"  valign="middle" class="tbltext" style=" border-color:#378b8b" colspan="3">&nbsp;<input type="text" class="tbltext" name="txtaddress" size="70" maxlength="70" >&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
</tr>
<tr class="Light" height="30">
<td width="180" align="right"  valign="middle" class="tblheading" style=" border-color:#378b8b">&nbsp;Address 2&nbsp;</td>
<td width="564" align="left"  valign="middle" class="tbltext" style=" border-color:#378b8b" colspan="3">&nbsp;<input type="text" class="tbltext" name="txtaddress1" size="70" maxlength="70" >&nbsp;</td>
</tr>
<tr class="Dark" height="30">
<td width="180" align="right"  valign="middle" class="tblheading" style=" border-color:#378b8b">&nbsp;City/Town/Village&nbsp;</td>
<td width="564" align="left"  valign="middle" class="tbltext" style=" border-color:#378b8b" colspan="3">&nbsp;<input type="text" class="tbltext" name="txtcity" size="50" maxlength="50" >&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
</tr>
<tr class="Light" height="30">
<td width="180" align="right"  valign="middle" class="tblheading" style=" border-color:#378b8b">&nbsp;Pin&nbsp;</td>
<td width="564" align="left"  valign="middle" class="tbltext" style=" border-color:#378b8b" colspan="3">&nbsp;<input type="text" class="tbltext" name="txtpin" size="6" maxlength="6" onkeypress="return isNumberKey(event)" >&nbsp;</td>
</tr>
<?php
...
?>
<tr class="Dark" height="30">
<td width="180" align="right"  valign="middle" class="tblheading" style=" border-color:#378b8b">&nbsp;State&nbsp;</td>
<td width="564" align="left"  valign="middle" class="tbltext" style=" border-color:#378b8b" colspan="3">&nbsp;<select name="txtstate" class="tbltext"  style="width:170px;" tabindex="">
...
<tr class="Light" height="30">
<td width="180" align="right"  valign="middle" class="tblheading" style=" border-color:#378b8b">&nbsp;Phone No.&nbsp;</td>
<td width="564" align="left"  valign="middle" class="tbltext" style=" border-color:#378b8b" colspan="3">&nbsp;<input type="text" class="tbltext" name="txtphone" size="15" maxlength="15" onkeypress="return isNumberKey(event)" >&nbsp;</td>
</tr>
<tr class="Light" height="25">
...
<table id="transmode" align="center" border="1" width="750" cellspacing="0" cellpadding="0" bordercolor="#378b8b" style="display:none; border-color:#378b8b" > 
<tr class="Light" height="25">
<td width="189" align="right"  valign="middle" class="tblheading" style="border-color:#378b8b">&nbsp;Select Mode of Transit&nbsp;</td>
 <td width="555" colspan="5" align="left"  valign="middle" class="tbltext" style="border-color:#378b8b"><input name="txt1" type="radio" class="tbltext" value="Transport" onClick="clk(this.value);" />Transport&nbsp;<input name="txt1" type="radio" class="tbltext" value="Courier" onClick="clk(this.value);" />Courier&nbsp;<input name="txt1" type="radio" class="tbltext" value="By Hand" onClick="clk(this.value);" />Hand Delivery&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
 </tr>
 </table>
<table id="trans" align="center" border="1" width="750" cellspacing="0" cellpadding="0" bordercolor="#378b8b" style="display:none;border-color:#378b8b" > 
<tr class="Light" height="30">
<td align="right" width="189" valign="middle" class="tblheading" style="border-color:#378b8b">&nbsp;Transport Name&nbsp;</td>
<td align="left"  valign="middle" class="tbltext" style="border-color:#378b8b">&nbsp;<input name="txttname" type="text" size="20" class="tbltext" tabindex="" maxlength="20" />  &nbsp;<font color="#FF0000">*</font>&nbsp;</td>
<td width="124" align="right"  valign="middle" class="tblheading" style="border-color:#378b8b">Lorry Receipt No.&nbsp;</td>
<td align="left" width="191" valign="middle" class="tbltext" colspan="3" style="border-color:#378b8b">&nbsp;<input name="txtlrn" type="text" size="15" class="tbltext" tabindex=""  maxlength="15"/>&nbsp;</td>
</tr>

<tr class="Light" height="25">
<td align="right" width="189" valign="middle" class="tblheading" style="border-color:#378b8b">&nbsp;Vehicle No.&nbsp;</td>
<td align="left" width="236" valign="middle" class="tbltext" style="border-color:#378b8b" >&nbsp;<input name="txtvn" type="text" size="12" class="tbltext" tabindex="" maxlength="12"  />&nbsp;<font color="#FF0000">*</font>&nbsp; </td>
<td align="right"  valign="middle" class="tblheading" style="border-color:#378b8b">&nbsp;Payment Mode&nbsp;</td>
 <td align="left"  valign="middle" class="tbltext"colspan="3" style="border-color:#378b8b">&nbsp;<select class="tbltext" name="txt13" style="width:70px;" onchange="clk1(this.value);" >
...
<table id="courier" align="center" border="1" width="750" cellspacing="0" cellpadding="0" bordercolor="#378b8b" style="display:none; border-color:#378b8b" > 
<tr class="Dark" height="30">
<td align="right" width="189" valign="middle" class="tblheading" style="border-color:#378b8b">&nbsp;Courier Name&nbsp;</td>
<td align="left" width="236" valign="middle" class="tbltext" style="border-color:#378b8b">&nbsp;<input name="txtcname" type="text" size="20" class="tbltext" tabindex=""  maxlength="20" />&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
<td align="right" width="124" valign="middle" class="tblheading" style="border-color:#378b8b">&nbsp;Docket No.&nbsp;</td>
<td align="left" width="191" valign="middle" class="tbltext" colspan="3" style="border-color:#378b8b">&nbsp;<input name="txtdc" type="text" size="15" class="tbltext" tabindex="" maxlength="15"   />&nbsp;<font color="#FF0000">*</font></td>
</tr>
 
</table>
<table id="byhand" align="center" border="1" width="750" cellspacing="0" cellpadding="0" bordercolor="#378b8b" style="display:none; border-color:#378b8b" > 
<tr class="Dark" height="30">
<td align="right" width="189" valign="middle" class="tblheading" style="border-color:#378b8b">&nbsp;Name of Person&nbsp;</td>
<td width="555" colspan="8" align="left" valign="middle" class="tbltext" style="border-color:#378b8b">&nbsp;<input name="txtpname" type="text" size="30" class="tbltext" tabindex=""  maxlength="30" />&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
</tr>
</table><br />
...
<table align="center" border="1" cellspacing="0" cellpadding="0" width="750" bordercolor="#378b8b" style="border-collapse:collapse">
 <tr class="tblsubtitle">
			  ...
			  <td width="17%" align="center" rowspan="2" valign="middle" class="tblheading">Crop</td>
			  <td width="24%" rowspan="2" align="center" valign="middle" class="tblheading">Variety</td>
			  <td width="7%" rowspan="2" align="center" valign="middle" class="tblheading">Lot No.</td>
			  <td colspan="2" align="center" valign="middle" class="tblheading">Existing</td>
...
<input type="hidden" name="srno" value="<?php echo $srno;?>" /> <input type="hidden" name="chkbox" value=""/> <input type="hidden" name="srno1" value=""/></div>
...
<td width="656" align="left"  valign="middle" class="tbltext">&nbsp;<textarea name="txtremarks" class="tbltext" cols="100" rows="3"></textarea></td>
</tr></table>
