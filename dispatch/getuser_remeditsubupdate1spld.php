...
if($z1 == 0)
{
	...
	if(mysqli_query($link,$sql_main) or die(mysqli_error($link)))
	{
		...
		{	
			...
			$sql_bar="update tbl_pswrem_bartemp set  bar_tid='$mainid', bar_subid='$subid' where bar_lotno='$txtlotno_1' and bar_ups='$upspacktype_1'";
			$zasd=mysqli_query($link,$sql_bar) or die(mysqli_error($link));
		}
	}
	$z1=$mainid;
}
...
<tr class="tblsubtitle" height="20">
  <td colspan="6" align="center" class="tblheading">Add Pack Seed SP Release-RO</td>
</tr>
