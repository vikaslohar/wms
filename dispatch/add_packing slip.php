...
//$a="c";
	//$a="c";
	$sql_code="SELECT MAX(arrival_code) FROM tblarrival where plantcode='".$plantcode."' and  arrival_type='Trading'  ORDER BY arrival_code DESC";
...
if(document.frmaddDepartment.txtlot2.value=="")
	...
	/*	else
		{
			var cod="";
			if(stage=="Raw Seed"){cod="R";}else if(stage=="Conditioned Seed"){cod="C";}else{cod="";}
...
{	
	...
	return false;
		 ...
		 if(document.frmaddDepartment.txtgrn.value=="")
	{
		alert("Please enter GRN No.");
		document.frmaddDepartment.txtgrn.focus();
		return false;
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#adad11" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#adad11" style="border-bottom:solid; border-bottom-color:#adad11" >
	      <td width="813" height="25" class="Mainheading">&nbsp;Transaction - Process slip
	        <input type="hidden" name="logid" value="<?php echo $logid?>" /></td>
	    </tr></table></td>
	  </tr>
	  </table></td></tr>
...
<td width="229" align="left" valign="middle" class="tbltext">&nbsp;<input name="date" type="text" size="10" class="tbltext" tabindex="0" readonly="true"  style="background-color:#CCCCCC" value="<?php echo date("d-m-Y");?>" maxlength="10"/>&nbsp;</td>
</tr>
...
<td align="left"  valign="middle" class="tbltext" >&nbsp;<input name="arrivaltype" type="text" size="15" class="tbltext" tabindex="0"  value="Trading Arrival" maxlength="15"/>&nbsp;</td>
	<td align="right"  valign="middle" class="tblheading">Processing slip No.&nbsp;</td>
    <td align="middle"  valign="middle" class="tbltext" colspan="3">&nbsp;<input name="txtgrn" type="text" size="5" class="tbltext" tabindex=""    maxlength="5" value="00000"   readonly="true"  style="background-color:#CCCCCC"/>&nbsp;</td>
           </tr>-->
 
<!--<tr class="Dark" height="30">
<td width="205" align="right"  valign="middle" class="tblheading">DC Date&nbsp;</td>
<td width="275" align="left"  valign="middle" class="tbltext" >&nbsp;<input name="dcdate" id="sdate" type="text" size="10" class="tbltext" tabindex="0" readonly="true"  value="<?php echo date("d-m-Y", time());?>" style="background-color:#EFEFEF" />&nbsp;<a href="javascript:void(0)" onClick="imgOnClick(document.frmaddDepartment.sdate,-100,-100)" tabindex="6"><img src="../images/cal.gif" alt="Calender" border="0" align="absmiddle" /></a><script type="text/javascript" language="javascript" src="../include/popcalender.js"></script>&nbsp;</td>
	<td align="right"  valign="middle" class="tblheading">DC&nbsp;No.&nbsp;</td>
    <td align="left"  valign="middle" class="tbltext">&nbsp;<input name="txtdcno" type="text" size="20" class="tbltext" tabindex=""    maxlength="20" onchange="vendorchk1();"/>&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
           </tr>-->
...
<td align="left"  valign="middle" class="tbltext" >&nbsp;<select class="tbltext" name="txtparty" style="width:190px;" onchange="showUser(this.value,'vaddress','vendor','','','','','');" >
<option value="" selected="selected">--Select--</option>
    ...
    <td align="left"  valign="middle" class="tbltext">&nbsp;<input name="txtor" type="text" size="20" class="tbltext" tabindex=""    maxlength="20" onchange="vendorchk();"/>&nbsp;&nbsp;</td>
           </tr>
		   <tr class="Dark" height="30">
...
<td align="right"  valign="middle" class="tblheading">&nbsp;Mode of Transit&nbsp;</td>
 <td align="left"  valign="middle" class="tbltext" colspan="3" ><input name="txt1" type="radio" class="tbltext" value="Transport" onClick="clk(this.value);" />Transport&nbsp;<input name="txt11" type="radio" class="tbltext" value="Courier" onClick="clk(this.value);" />Courier&nbsp;<input name="txt11" type="radio" class="tbltext" value="By Hand" onClick="clk(this.value);" />Hand Delivery&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
</tr>-->
</table>
<!--<table id="trans" align="center" border="1" width="850" cellspacing="0" cellpadding="0" bordercolor="#F1B01E" style="display:none; border-color:#F1B01E" > 
<tr class="Light" height="30">
<td align="right" width="202" valign="middle" class="tblheading" style="border-color:#F1B01E">&nbsp;Transport Name&nbsp;</td>
<td align="left"  valign="middle" class="tbltext" style="border-color:#F1B01E">&nbsp;<input name="txttname" type="text" size="21" class="tbltext" tabindex="" maxlength="20" />  &nbsp;<font color="#FF0000">*</font>&nbsp;</td>
<td width="116" align="right"  valign="middle" class="tblheading" style="border-color:#F1B01E">Lorry Receipt No.&nbsp;</td>
<td align="left" width="247" valign="middle" class="tbltext" colspan="3" style="border-color:#F1B01E">&nbsp;
  <input name="txtlrn" type="text" size="15" class="tbltext" tabindex=""  maxlength="15"/>&nbsp;</td>
</tr>

<tr class="Dark" height="25">
<td align="right" width="202" valign="middle" class="tblheading" style="border-color:#F1B01E">&nbsp;Vehicle No.&nbsp;</td>
<td align="left" width="275" valign="middle" class="tbltext"  style="border-color:#F1B01E">&nbsp;<input name="txtvn" type="text" size="12" class="tbltext" tabindex="" maxlength="12"  />&nbsp;<font color="#FF0000">*</font>&nbsp; </td>
<td align="right"  valign="middle" class="tblheading" style="border-color:#F1B01E">&nbsp;Payment Mode&nbsp;</td>
 <td align="left"  valign="middle" class="tbltext"colspan="3" style="border-color:#F1B01E">&nbsp;<select class="tbltext" name="txt13" style="width:70px;" onchange="clk1(this.value);" >
<option value="" selected="selected">Select</option>
...
<table id="courier" align="center" border="1" width="850" cellspacing="0" cellpadding="0" bordercolor="#F1B01E" style="display:none; border-color:#F1B01E" > 
<tr class="Dark" height="30">
<td align="right" width="202" valign="middle" class="tblheading" style="border-color:#F1B01E">&nbsp;Courier Name&nbsp;</td>
<td align="left" width="275" valign="middle" class="tbltext" style="border-color:#F1B01E">&nbsp;<input name="txtcname" type="text" size="20" class="tbltext" tabindex=""  maxlength="20" />&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
<td align="right" width="99" valign="middle" class="tblheading" style="border-color:#F1B01E">&nbsp;Docket No.&nbsp;</td>
<td align="left" width="264" valign="middle" class="tbltext" colspan="3" style="border-color:#F1B01E">&nbsp;<input name="txtdc" type="text" size="15" class="tbltext" tabindex="" maxlength="15"   />&nbsp;<font color="#FF0000">*</font></td>
</tr>
</table>
<table id="byhand" align="center" border="1" width="850" cellspacing="0" cellpadding="0" bordercolor="#F1B01E" style="display:none; border-color:#F1B01E" > 
<tr class="Dark" height="30">
<td align="right" width="202" valign="middle" class="tblheading" style="border-color:#F1B01E">&nbsp;Name of Person&nbsp;</td>
<td width="642" colspan="8" align="left" valign="middle" class="tbltext" style="border-color:#F1B01E">&nbsp;<input name="txtpname" type="text" size="31" class="tbltext" tabindex=""  maxlength="30" />&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
</tr>
</table>-->
...
<table align="center" border="1" cellspacing="0" cellpadding="0" width="850" bordercolor="#1dbe03" style="border-collapse:collapse">
	...
	<td width="10%" align="center" rowspan="3" valign="middle" class="tblheading">Old Variety</td>
	<td width="10%" align="center" rowspan="3" valign="middle" class="tblheading">V. Lot No.</td>-->
	<td width="10%" align="center" rowspan="3" valign="middle" class="tblheading"> Lot No.</td>
	 <td width="10%" align="center" valign="middle" class="tblheading" >Conditioned Seed </td>
     <td width="10%" align="center" valign="middle" class="tblheading" >UPS</td>

	 	 <td width="10%" align="center" valign="middle" class="tblheading" colspan="2">No of packets </td>
<td width="10%" align="center" valign="middle" class="tblheading" colspan="2">Packed Quality </td>
		  <!--/*<td width="9%" rowspan="3" align="center" valign="middle" class="tblheading">QC Status </td>	 
		   <td width="12%" rowspan="3" align="center" valign="middle" class="tblheading">GOT Type </td>*/-->-->
		 	
		 	<td width="8%" rowspan="3" align="center" valign="middle" class="tblheading">No. of window Box </td>
			<td width="8%" rowspan="3" align="center" valign="middle" class="tblheading">No. of Carton PP Box </td>
    <td colspan="1" rowspan="2" align="center" valign="middle" class="tblheading">SLOC</td>
    <td width="4%" rowspan="3" align="center" valign="middle" class="tblheading">Edit</td>
...
<td width="275" align="left"  valign="middle" class="tbltext" >&nbsp;<input name="sstatus" class="tbltext" readonly="readonly" style="background-color:#EAEAEA">
...
?>
    ...
    <td width="249" align="left"  valign="middle" class="tbltext" id="vitem">&nbsp;<input name="sstatus" class="tbltext" readonly="readonly" style="background-color:#EAEAEA">&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
           </tr>
		   <tr class="Light" height="30">
 <?php
$quer3=mysqli_query($link,"SELECT cropid, cropname FROM tblcrop  order by cropname Asc"); 
...
$quer4=mysqli_query($link,"SELECT varietyid, popularname FROM tblvariety where actstatus='Active' order by popularname Asc"); 
?>
	<td width="113" align="right"  valign="middle" class="tblheading" >Condition Seed &nbsp;</td>
    <td width="249" align="left"  valign="middle" class="tbltext" id="vitem">&nbsp;<input name="sstatus" class="tbltext" readonly="readonly" style="background-color:#EAEAEA">&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
           </tr>
		   <tr class="Light" height="30">
 <?php
...
<td align="right"  valign="middle" class="tblheading">No. of Pack Size &nbsp;</td>
<td width="275" align="left"  valign="middle" class="tbltext" >&nbsp;<input name="sstatus" class="tbltext" readonly="readonly" style="background-color:#EAEAEA">
              <font color="#FF0000">*</font>&nbsp;</td>
			   <?php
$quer4=mysqli_query($link,"SELECT varietyid, popularname FROM tblvariety where actstatus='Active' order by popularname Asc"); 
?>
	<td width="113" align="right"  valign="middle" class="tblheading" >Unit Pack Size  </td>
    <td width="249" align="left"  valign="middle" class="tbltext" id="vitem">&nbsp;<input name="sstatus" class="tbltext" readonly="readonly" style="background-color:#EAEAEA">&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
           </tr>
		    <tr class="Light" height="30">
 <?php
$quer3=mysqli_query($link,"SELECT cropid, cropname FROM tblcrop  order by cropname Asc"); 
?>
<td align="right"  valign="middle" class="tblheading">No. of Packets  &nbsp;</td>
<td width="275" align="left"  valign="middle" class="tbltext" >&nbsp;<input name="sstatus" class="tbltext" readonly="readonly" style="background-color:#EAEAEA"><font color="#FF0000">*</font>&nbsp;Max. 4</td>
			   <?php
$quer4=mysqli_query($link,"SELECT varietyid, popularname FROM tblvariety where actstatus='Active' order by popularname Asc"); 
?>
	<td width="113" align="right"  valign="middle" class="tblheading" >Packed Quantity </td>
    <td width="249" align="left"  valign="middle" class="tbltext" id="vitem">&nbsp;<input name="sstatus" class="tbltext" readonly="readonly" style="background-color:#EAEAEA">&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
           </tr>
<!--/*          
<tr class="Dark" height="30">
...
*/--><tr class="Light" height="30">
<td width="203" align="right" valign="middle" class="tblheading">No of Window Box &nbsp;</td>
<td  align="left" valign="middle" class="tbltext"  >&nbsp;<input name="sstatus" class="tbltext" >
              &nbsp;<font color="#FF0000">*</font></td>

<td width="131" align="right" valign="middle" class="tblheading">No. of Carton&nbsp;</td>
<td width="229" align="left" valign="middle" class="tbltext">&nbsp;<input name="sstatus" class="tbltext"   />&nbsp;<input type="hidden" name="destid" value="" /></td>
</tr>
<tr class="Light" height="30">
<td align="right"  valign="middle" class="tblheading">Pack Type &nbsp;</td>
    <td align="left"  valign="middle" class="tbltext" colspan="3">&nbsp;<input name="txtdcno" type="text" size="20" class="tbltext" tabindex=""    maxlength="20" onchange="vendorchk1();"/>&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
	</tr>
</table>
