...
$sql_qc=mysqli_query($link,"SELECT distinct(lotldg_variety) FROM tbl_lot_ldg WHERE plantcode='".$plantcode."' and  lotldg_crop='".$a."' and lotldg_variety NOT RLIKE '^[-+0-9.E]+$'");
