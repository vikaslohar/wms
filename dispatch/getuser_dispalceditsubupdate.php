				...
				if($ltchksel!="")
				{
					...
					else
					{
						...
						if(mysqli_query($link,$sql_subsub2) or die(mysqli_error($link)))
						{
							...
							{
								$s_sub="delete from tbl_dbulksub_sub2 where plantcode='".$plantcode."' and  dbss_is='".$subsubtrid."' and dbulks_id='".$sid."'";
