...
<title>Dispatch - Transaction - Dispatch - Direct Loading / Non-Allocation Type - Select output</title>
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#378b8b" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#378b8b" style="border-bottom:solid; border-bottom-color:#378b8b" >
	    <tr >
	      <td width="813" height="25" class="Mainheading">&nbsp;Transaction: Dispatch - Direct Loading / Non-Allocation Type - Output Selection </td>
	    </tr></table></td>
	  </tr>
	  </table></td></tr>
...
<?php
$srno=1;
$sql_arr_home2=mysqli_query($link,"select distinct disps_variety from tbl_disp_sub where disp_id='$tid' and disps_flg=1 order by disps_id asc") or die(mysqli_error($link));
...
<tr >
<td valign="top" align="center"><a href="home_disppack.php"><img src="../images/back.gif" border="0"style="display:inline;cursor:Pointer;" /></a>&nbsp;&nbsp;&nbsp;</td>	
</tr>
</table>
