...
{
winHandle=window.open('pston.php?itmid='+subid,'WelCome','top=20, left=50, width=850, height=850, scrollbars=yes');
if(winHandle==null){
alert("While Launching New Window...\nYour browser maybe blocking up Popup windows. \n\n  Please check your Popup Blocker Settings or ..\n Please hold Ctrl Key and Click on link to open new Browser"); }
//}
}

function exportdata(subid)
{
winHandle=window.open('exportdata.php?itmid='+subid,'WelCome','top=150, left=480, width=350, height=150, scrollbars=yes');
if(winHandle==null){
alert("While Launching New Window...\nYour browser maybe blocking up Popup windows. \n\n  Please check your Popup Blocker Settings or ..\n Please hold Ctrl Key and Click on link to open new Browser"); }
//}
}
...
<tr class="Light" height="25">
    ...
    <td align="center"  valign="middle" class="tblheading">&nbsp;<a href="Javascript:void(0)" onclick="openslocpopprint1(<?php echo $tid;?>);">Stock Transfer Out Note (PSTON)</a></td>
</tr>
<tr class="Light" height="25">

    <td align="center" height="45" valign="middle" class="tblheading">&nbsp;&nbsp;<a href="excelstol_packseed.php?pid=<?php echo $tid;?>" target="_blank"><img src="../images/excelicon1.jpg" border="0" height="30" width="30" class="butn" alt="Export to Excel" style="display:inline;cursor:pointer;" /></a>&nbsp;&nbsp;</td>
</tr>
<!--<tr class="Light" height="25">

    <td align="center" height="45" valign="middle" class="tblheading">&nbsp;&nbsp;<img src="../images/exportdata.gif" border="0" onclick="exportdata('<?php echo $tid;?>');" style="cursor:pointer" />&nbsp;&nbsp;</td>
</tr>-->
</table>
<br />
...
<tr >
<td valign="top" align="center"><a href="home_dispp2p_packseed.php"><img src="../images/back.gif" border="0"style="display:inline;cursor:Pointer;" /></a>&nbsp;&nbsp;&nbsp;</td>	
</tr>
</table>
