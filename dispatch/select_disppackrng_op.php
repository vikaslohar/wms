...
<title>Dispatch - Transaction - Dispatch - Direct Loading / Non-Allocation Type with Barcode Range - Select output</title>
...
winHandle=window.open('loadingslip_rng.php?itmid='+val1,'WelCome','top=170,left=180,width=820,height=450,scrollbars=yes');
if(winHandle==null){
...
{
var itm=document.frmaddDepartment.txtitem.value;
winHandle=window.open('gatepass_rng.php?itmid='+val1,'WelCome','top=170,left=180,width=820,height=450,scrollbars=yes');
if(winHandle==null){
alert("While Launching New Window...\nYour browser maybe blocking up Popup windows. \n\n  Please check your Popup Blocker Settings or ..\n Please hold Ctrl Key and Click on link to open new Browser"); }
}
...
{
winHandle=window.open('psdn_rng.php?itmid='+subid,'WelCome','top=20, left=50, width=850, height=850, scrollbars=yes');
if(winHandle==null){
alert("While Launching New Window...\nYour browser maybe blocking up Popup windows. \n\n  Please check your Popup Blocker Settings or ..\n Please hold Ctrl Key and Click on link to open new Browser"); }
//}
}
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#378b8b" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#378b8b" style="border-bottom:solid; border-bottom-color:#378b8b" >
	    <tr >
	      <td width="813" height="25" class="Mainheading">&nbsp;Transaction: Dispatch - Direct Loading / Non-Allocation Type with Barcode Range - Output Selection </td>
	    </tr></table></td>
	  </tr>
	  </table></td></tr>
...
<tr >
<td valign="top" align="center"><a href="home_disppack_rng.php"><img src="../images/back.gif" border="0"style="display:inline;cursor:Pointer;" /></a>&nbsp;&nbsp;&nbsp;</td>	
</tr>
</table>
