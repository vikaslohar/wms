...
if($h > 0)
{
	$sql_tbl_sub=mysqli_query($link,"select * from tbl_pswrem_sub where plantcode='".$plantcode."' and  pswrem_id='".$h."' and lotnumber='$a'") or die(mysqli_error($link));
	$subtbltot=mysqli_num_rows($sql_tbl_sub);
	if($subtbltot > 0) $tttt=1;
}
$sql_issue=mysqli_query($link,"select distinct whid, binid, subbinid  from tbl_lot_ldg_pack where plantcode='".$plantcode."' and  lotldg_crop ='".$b."' and lotldg_variety='".$c."' and lotno='$a' and packtype='".$f."'") or die(mysqli_error($link));
...
<td align="left"  valign="middle" class="smallsmalltbltext" >&nbsp;<input type="text" name="txtcrop1" readonly="true" style="background-color:#CCCCCC;" value="<?php echo $noticia['cropname'];?>" size="32"  />&nbsp;<font color="#FF0000">*</font>&nbsp;<input type="hidden" name="txtcrop" value="<?php echo $noticia['cropid'];?>" /></td>
<?php
...
?>
    ...
    <td width="158"  align="left"  valign="middle" class="smalltbltext" id="vitem2">&nbsp;<input type="text" class="smalltbltext" name="txtups"  value="<?php echo $f;?>" size="15" readonly="true" style="background-color:#CCCCCC"  />&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
           </tr>
</table>		   
<table align="center" border="1" width="970" cellspacing="0" cellpadding="0" bordercolor="#378b8b" style="border-collapse:collapse" >
<tr class="tblsubtitle" height="20">
...
$sql_issue1=mysqli_query($link,"select max(lotdgp_id) from tbl_lot_ldg_pack where plantcode='".$plantcode."' and  subbinid='".$row_issue['subbinid']."' and binid='".$row_issue['binid']."' and whid='".$row_issue['whid']."'  and lotldg_crop ='".$b."' and lotldg_variety='".$c."' and lotno='$a' and packtype='".$f."'") or die(mysqli_error($link));
...
?>  
  <tr class="Light" height="30">
    ...
    <td align="left"  valign="middle" class="smalltbltext" >&nbsp;<input name="txtlotno_<?php echo $srno;?>" id="txtlotno_<?php echo $srno;?>" type="text" size="15" class="smalltbltext"  maxlength="18" style="background-color:#CCCCCC" value="<?php echo $a;?>"/></td>
<td align="left"  valign="middle" class="smalltbltext" >&nbsp;<?php echo $upspacktype;?><input type="hidden" name="wtinmp_<?php echo $srno;?>" id="wtinmp_<?php echo $srno;?>" value="<?php echo $wtinmp;?>" /><input type="hidden" name="upspacktype_<?php echo $srno;?>" id="upspacktype_<?php echo $srno;?>" value="<?php echo $upspacktype;?>" /></td>
 ...
 <td align="left"  valign="middle" class="smalltbltext" >&nbsp;<input name="txtrecbagp_<?php echo $srno;?>" id="txtrecbagp_<?php echo $srno;?>" type="text" size="3" class="smalltbltext" tabindex=""   maxlength="5" value="0" onkeypress="return isNumberKey1(event)"  onchange="Bagschk1(this.value,'<?php echo $srno;?>');"  style="background-color:#CCCCCC" readonly="true" /></td>
 <td align="left"  valign="middle" class="smalltbltext" >&nbsp;<input name="txtrecnomp_<?php echo $srno;?>" id="txtrecnomp_<?php echo $srno;?>" type="text" size="3" class="smalltbltext" tabindex=""   maxlength="5" onkeypress="return isNumberKey1(event)"  onchange="nompchk1(this.value,'<?php echo $srno;?>');" value=""   />&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
  <td align="left"  valign="middle" class="smalltbltext">&nbsp;<input name="recqtyp_<?php echo $srno;?>" id="recqtyp_<?php echo $srno;?>" type="text" size="7" class="smalltbltext" tabindex="" maxlength="9"  onkeypress="return isNumberKey(event)" onchange="qtychk1(this.value,'<?php echo $srno;?>');"   />&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
      <td align="left"  valign="middle" class="smalltbltext">&nbsp;<input name="txtdbagp_<?php echo $srno;?>" id="txtdbagp_<?php echo $srno;?>" type="text" size="3" class="smalltbltext" tabindex=""   maxlength="5" onkeypress="return isNumberKey1(event)" style="background-color:#CCCCCC" readonly="true" />  &nbsp; </td>
 <td align="left"  valign="middle" class="smalltbltext">&nbsp;<input name="txtdnomp_<?php echo $srno;?>" id="txtdnomp_<?php echo $srno;?>" type="text" size="3" class="smalltbltext" tabindex=""   maxlength="5" onkeypress="return isNumberKey1(event)" style="background-color:#CCCCCC" readonly="true" value="<?php if($nmp>0)echo $nmp; else echo "0";?>" />  &nbsp; </td>       
      <td align="left"  valign="middle" class="smalltbltext">&nbsp;<input name="txtdqtyp_<?php echo $srno;?>" id="txtdqtyp_<?php echo $srno;?>" type="text" size="7" class="smalltbltext" tabindex="" maxlength="9" onkeypress="return isNumberKey(event)" style="background-color:#CCCCCC" readonly="true" /></td>
	  <td align="center"  valign="middle" class="smalltbltext" id="dtail_<?php echo $srno;?>"><a href="Javascript:void(0);" onclick="barcodupd('<?php echo $a;?>','add');">Update</a></td>
  </tr>
 <?php
}
else
...
<td align="left"  valign="middle" class="smalltbltext" >&nbsp;<?php echo $upspacktype;?><input type="hidden" name="wtinmp_<?php echo $srno;?>" id="wtinmp_<?php echo $srno;?>" value="<?php echo $wtinmp;?>" /><input type="hidden" name="upspacktype_<?php echo $srno;?>" id="upspacktype_<?php echo $srno;?>" value="<?php echo $upspacktype;?>" /></td>
	...
	<td width="65"  align="left" valign="middle" class="smalltbltext">&nbsp;<input name="txtnomp_<?php echo $srno;?>" id="txtnomp_<?php echo $srno;?>" type="text" size="3" class="smalltbltext" tabindex="" maxlength="5" onkeypress="return isNumberKey(event)" value="<?php if($nmp>0)echo $nmp; else echo "0";?>" style="background-color:#CCCCCC"  readonly="true" />&nbsp;&nbsp;</td>
    <td width="80" align="left"  valign="middle" class="smalltbltext" id="vitem">&nbsp;<input name="txtqty_<?php echo $srno;?>" id="txtqty_<?php echo $srno;?>" type="text" size="7" class="smalltbltext"  maxlength="9" style="background-color:#CCCCCC" value="<?php echo $row_issuetbl['balqty'];?>"/>&nbsp;</td>
 <td align="left"  valign="middle" class="smalltbltext" >&nbsp;<input name="txtrecbagp_<?php echo $srno;?>" id="txtrecbagp_<?php echo $srno;?>" type="text" size="3" class="smalltbltext" tabindex=""  value="0"  maxlength="5" onkeypress="return isNumberKey1(event)"  onchange="Bagschk1(this.value,'<?php echo $srno;?>');" style="background-color:#CCCCCC" readonly="true"  /></td>
 <td align="left"  valign="middle" class="smalltbltext" >&nbsp;<input name="txtrecnomp_<?php echo $srno;?>" id="txtrecnomp_<?php echo $srno;?>" type="text" size="3" class="smalltbltext" tabindex=""   maxlength="5" onkeypress="return isNumberKey1(event)"  onchange="nompchk1(this.value,'<?php echo $srno;?>');" value=""   />&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
  <td align="left"  valign="middle" class="smalltbltext">&nbsp;<input name="recqtyp_<?php echo $srno;?>" id="recqtyp_<?php echo $srno;?>" type="text" size="7" class="smalltbltext" tabindex="" maxlength="9"  onkeypress="return isNumberKey(event)" onchange="qtychk1(this.value,'<?php echo $srno;?>');"   />&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
      <td align="left"  valign="middle" class="smalltbltext">&nbsp;<input name="txtdbagp_<?php echo $srno;?>" id="txtdbagp_<?php echo $srno;?>" type="text" size="3" class="smalltbltext" tabindex=""   maxlength="5" onkeypress="return isNumberKey1(event)" style="background-color:#CCCCCC" readonly="true" />  &nbsp; </td>
 <td align="left"  valign="middle" class="smalltbltext">&nbsp;<input name="txtdnomp_<?php echo $srno;?>" id="txtdnomp_<?php echo $srno;?>" type="text" size="3" class="smalltbltext" tabindex=""   maxlength="5" onkeypress="return isNumberKey1(event)" style="background-color:#CCCCCC" readonly="true" value="<?php if($nmp>0)echo $nmp; else echo "0";?>" />  &nbsp; </td>       
...
<input type="hidden" name="txtlot1" value="<?php echo $a;?>" />
<input type="hidden" name="srno" value="<?php echo $srno;?>" />
<input type="hidden" name="bacnos" id="bacnos" value="0" />
</table>
