<?php
	...
	if(isset($_REQUEST['h'])) { $enoordno=$_REQUEST['h']; }
	if(isset($_REQUEST['g'])) { $eordno=$_REQUEST['g']; }
	if(isset($_REQUEST['l'])) { $txtallonolp=$_REQUEST['l']; }
	if(isset($_REQUEST['m'])) { $txtallnomp=$_REQUEST['m']; }
	if(isset($_REQUEST['n'])) { $txttobealqty=$_REQUEST['n']; }
	

	$sql_subsub5="update tbl_dalloc_sub set dallocs_alflg=2, dallocs_allocnop='$txtallonolp', dallocs_allocnomp='$txtallnomp', dallocs_allocqty='$txttobealqty' where dallocs_id='$subtrid'";
