<?php
	...
	if(isset($_POST['frm_action'])=='submit')
	{
		...
		if($trsbmval==0)
		{
			...
			echo "<script>window.location='add_disppackalc_preview.php?pid=$mainid'</script>";	
			//exit;
		}
		else
		{
...
<title>Stock Transfer In - Pack Seed</title>
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#378b8b" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#378b8b" style="border-bottom:solid; border-bottom-color:#378b8b" >
	    <tr >
	      <td width="813" height="25" class="Mainheading">&nbsp;Transaction - Dispatch - Stock Transfer In - Pack Seed</td>
	    </tr></table></td>
...
<tr class="tblsubtitle" height="20">
  <td colspan="6" align="center" class="tblheading">Dispatch - Stock Transfer In - Pack Seed </td>
</tr>
...
$sql_month=mysqli_query($link,"select * from tbl_partymaser where classification='Stock Transfer-Plant' order by business_name")or die(mysqli_error($link));
?>
 </table>
...
<tr class="Dark" height="30" >
<td align="right" width="230" valign="middle" class="smalltblheading" >&nbsp;STDN Date&nbsp;</td>
<td align="left" width="262" valign="middle" class="smalltbltext" >&nbsp;<input name="sdate" id="sdate" type="text" size="10" class="tbltext" tabindex="0" readonly="true"  value="<?php echo date("d-m-Y");?>" style="background-color:#EFEFEF" />&nbsp; <a href="javascript:void(0);" onClick="showCalendar('sdate')" tabindex="6"><img src="../images/cal.gif" alt="Calender" border="0" align="absmiddle" /></a>&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
<td align="right" width="192" valign="middle" class="smalltblheading" >&nbsp;STDN No.&nbsp;</td>
...
<table align="center" border="1" width="950" cellspacing="0" cellpadding="0" bordercolor="#378b8b" style="border-collapse:collapse" >
  <tr class="tblsubtitle" height="20">
    <td colspan="14" align="center" class="tblheading">Stock Transfer In Details</td>
  </tr>
  <tr class="Dark" height="30">
    ...
    <td width="275" align="center"  valign="middle" class="smalltblheading">Edit</td>
...
<td align="center"  valign="middle" class="tblheading" colspan="4">Barcode ADD</td></tr>
<tr class="Dark" height="25">
<td width="230"  align="right"  valign="middle" class="smalltblheading">Scan Barcode&nbsp;</td>
<td width="714" colspan="3" align="left"  valign="middle" class="smalltbltext">&nbsp;<input type="text" name="barcode" id="txtbarcod" size="11" maxlength="11" class="smalltbltext"  onkeypress="return isNumberKey24(event)" onChange="chkbarcode1(this.value)" value="" /></td></tr>
</table><br />
<div id="barchk"><input type="hidden" name="brflg" value="" /><input type="hidden" name="brchflg" value="0" /></div>
<br />
<table align="center" border="1" width="950" cellspacing="0" cellpadding="0" bordercolor="#378b8b" style="border-collapse:collapse" > 
<tr class="tblsubtitle" height="25">
<td align="center"  valign="middle" class="tblheading" colspan="4">Barcode Delete</td> </tr>
...
<tr >
<td valign="top" align="right">&nbsp;&nbsp;<img src="../images/cancel.gif" border="0" style="display:inline;cursor:Pointer;" onClick="return mycancel('1');"  />&nbsp;&nbsp;<img src="../images/preview.gif" alt="Submit Value"  border="0" style="display:inline;cursor:Pointer;" tabindex="" onClick="return mySubmit('0');" /></td>
</tr>
</table>
</td><td width="30"></td>
</tr>
