...
<title>Dispatch - Transaction - Dispatch - Allocation Type - <?php echo $ntyps;?></title>
...
<td width="729" align="left" valign="middle" class="smalltblheading"><table align="left" border="0" width="100%" cellpadding="0" cellspacing="0" style="border-collapse:collapse" bordercolor="#378b8b">
<tr class="Light">
<td align="center" valign="middle" class="smalltblheading"><font size="+3" face="Verdana, Arial, Helvetica, sans-serif"><?php echo $row_param['company_name'];?></font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
</tr>
<tr class="Light">
...
<td width="174" align="right" valign="middle" class="smalltblheading">Dispatch&nbsp;Date&nbsp;</td>
<td width="204"  align="left" valign="middle" class="smalltbltext">&nbsp;<?php echo $tdate;?></td>

<td width="168" align="right" valign="middle" class="smalltblheading">&nbsp;<?php echo $ntyps;?> No.&nbsp;</td>
<td width="194" align="left" valign="middle" class="smalltbltext">&nbsp;<?php echo $code1;?></td>
</tr>
<!--<tr class="Light" height="20">
<td width="174" align="right" valign="middle" class="smalltblheading">Dispatch Challan&nbsp;Date&nbsp;</td>
<td width="204"  align="left" valign="middle" class="smalltbltext">&nbsp;<?php echo $tdate2;?></td>

<td width="168" align="right" valign="middle" class="smalltblheading">&nbsp;Dispatch Challan No.&nbsp;</td>
<td width="194" align="left" valign="middle" class="smalltbltext">&nbsp;<?php echo $row_tbl['disp_dcno'];?></td>
</tr>-->
<?php
...
<td width="174"  align="right"  valign="middle" class="smalltblheading">Party Name&nbsp;</td>
<td align="left"  valign="middle"  class="smalltbltext" colspan="3" >&nbsp;<?php echo $noticia['business_name'];?><?php if($noticia['city']!="") { echo " ".$noticia['city']; }?></td>
</tr>
<tr class="Light" height="25">
<td align="right"  valign="middle" class="smalltblheading">Address&nbsp;</td>
<td align="left"  valign="middle" class="smalltbltext" colspan="3" ><div align="justify" class="smalltbltext" style="padding:2px 5px 5px 5px"><?php echo $noticia['address'];?><?php if($noticia['city']!="") { echo ", ".$noticia['city']; }?>, <?php echo $noticia['state'];?><?php if($noticia['pin']!="" && $noticia['pin']>0) { echo " - ".$noticia['pin']."."; }?><?php if($noticia['classification']=="Export Buyer") { echo " (".$country.")"; }?> <?php if($noticia['phone']!="" && $noticia['phone']>0) { echo " Ph - 0".$noticia['std']."-".$noticia['phone']; }?><?php if($noticia['mob']!="" && $noticia['mob']>0) { echo " M - ".$noticia['mob']; }?></div></td>
</tr>
<tr class="Light" height="25">
...
<td align="right"  valign="middle" class="smalltblheading">&nbsp;Mode of Transit&nbsp;</td>
 <td align="left"  valign="middle" class="smalltbltext" colspan="3" >&nbsp;<?php echo $row_tbl['tmode'];?></td>
</tr>
<?php
...
<td align="left"  valign="middle" class="smalltbltext">&nbsp;<?php echo $row_tbl['trans_name'];?></td>
<td align="right" valign="middle" class="smalltblheading">Lorry Receipt No.&nbsp;</td>
<td align="left" valign="middle" class="smalltbltext">&nbsp;<?php echo $row_tbl['trans_lorryrepno'];?></td>
</tr>

<tr class="Light" height="25">
<td align="right" valign="middle" class="smalltblheading">&nbsp;Vehicle No.&nbsp;</td>
<td align="left" valign="middle" class="smalltbltext" >&nbsp;<?php echo $row_tbl['trans_vehno'];?></td>
<td align="right" valign="middle" class="smalltblheading">&nbsp;Payment Mode&nbsp;</td>
 <td align="left" valign="middle" class="smalltbltext">&nbsp;<?php echo $row_tbl['trans_paymode'];?>&nbsp;(Transport)</td>
</tr>
<?php
}
...
<td align="left" valign="middle" class="smalltbltext">&nbsp;<?php echo $row_tbl['courier_name'];?></td>
<td align="right" valign="middle" class="smalltblheading">&nbsp;Docket No. &nbsp;</td>
<td align="left" valign="middle" class="smalltbltext">&nbsp;<?php echo $row_tbl['docket_no'];?></td>
</tr>
<?php
}
else 
...
<td colspan="3" align="left" valign="middle" class="smalltbltext">&nbsp;<?php echo $row_tbl['pname_byhand'];?></td>
</tr>
<?php
}
?>
<tr class="Dark" height="30">
<td align="right" valign="middle" class="smalltblheading">&nbsp;Supplier's Reference No&nbsp;</td>
<td align="left" valign="middle" class="smalltbltext">&nbsp;<?php echo $porefno;?></td>
<td align="right" valign="middle" class="smalltblheading">&nbsp;Order number(s)&nbsp;</td>
<td align="left" valign="middle" class="smalltbltext">&nbsp;<?php echo $ordernos;?></td>
</tr>
</table>
<br />
<?php
...
<tr class="tblsubtitle" height="20">
  <td colspan="14" align="center" class="smalltblheading">Dispatch Details</td>
</tr>
<tr class="Dark" height="30">
	<td width="17"  align="center"  valign="middle" class="smalltblheading">#</td>
	<td width="82" align="center"  valign="middle" class="smalltbltext">Crop</td>
	<td width="111" align="center"  valign="middle" class="smalltbltext">Variety</td>
	<td width="45" align="center"  valign="middle" class="smalltbltext">UPS</td>
	<td width="100" align="center"  valign="middle" class="smalltbltext">Lot No.</td>
	<td width="65" align="center"  valign="middle" class="smalltbltext">DoT</td>
	<td width="65" align="center"  valign="middle" class="smalltbltext">Validity Date</td>
	<td width="36" align="center"  valign="middle" class="smalltbltext">MP Type</td>
	<td width="30" align="center"  valign="middle" class="smalltbltext">NoMP</td>
	<td width="60" align="center"  valign="middle" class="smalltbltext">Qty</td>
	<td width="33" align="center"  valign="middle" class="smalltbltext">Total NoMP</td>
	<td width="80" align="center"  valign="middle" class="smalltbltext">Total Qty</td>
</tr>
<?php 
...
?>
<tr class="Dark" height="30">
	<td width="17"  align="center"  valign="middle" class="smalltbltext"><?php echo $sn;?></td>
	<td width="82" align="center"  valign="middle" class="smalltbltext"><?php echo $crop?></td>
	<td width="111" align="center"  valign="middle" class="smalltbltext"><?php echo $nvariety?></td>
	<td width="45" align="center"  valign="middle" class="smalltbltext"><?php echo $nups;?></td>
	<td width="100" align="center"  valign="middle" class="smalltbltext"><?php echo $lotno1;?></td>
	<td width="65" align="center"  valign="middle" class="smalltbltext"><?php echo $dot;?></td>
	<td width="65" align="center"  valign="middle" class="smalltbltext"><?php echo $dov;?></td>
	<td width="36" align="center"  valign="middle" class="smalltbltext"><?php echo $nobtp;?></td>
	<td width="30" align="center"  valign="middle" class="smalltbltext"><?php echo $nnob1;?></td>
	<td width="60" align="center"  valign="middle" class="smalltbltext"><?php echo $nqty1;?></td>
	<td width="33" align="center"  valign="middle" class="smalltbltext"><?php echo $nnob2;?></td>
	<td width="80" align="center"  valign="middle" class="smalltbltext"><?php echo $nqty2;?>&nbsp;Kgs.</td>
</tr>
<?php
$sn++;
}
...
?>
<tr class="Dark" height="30">
	<td width="205"  align="center"  valign="middle" class="smalltblheading"><?php echo $sn;?></td>
	<td width="275" align="center"  valign="middle" class="smalltbltext"><?php echo $crpval?></td>
	<td width="275" align="center"  valign="middle" class="smalltbltext"><?php echo $verval?></td>
	<td width="275" align="center"  valign="middle" class="smalltbltext"><?php echo $upsval;?></td>
	<td width="275" align="center"  valign="middle" class="smalltbltext"><?php echo $lotno1;?></td>
	<td width="275" align="center"  valign="middle" class="smalltbltext"><?php echo $dot;?></td>
	<td width="275" align="center"  valign="middle" class="smalltbltext"><?php echo $dov;?></td>
	<td width="275" align="center"  valign="middle" class="smalltbltext"><?php echo $nobtp;?></td>
	<td width="275" align="center"  valign="middle" class="smalltbltext"><?php echo $nnob1;?></td>
	<td width="275" align="center"  valign="middle" class="smalltbltext"><?php echo $nqty1;?></td>
	<td width="275" align="center"  valign="middle" class="smalltbltext"><?php echo $nnob2;?></td>
	<td width="275" align="center"  valign="middle" class="smalltbltext"><?php echo $nqty2;?>&nbsp;Kgs.</td>
</tr>
<?php
$sn++;
}
...
$sql_sub=mysqli_query($link,"Select distinct dpss_barcode from tbl_dispsub_sub where plantcode='".$plantcode."' and  disp_id='$tid' and dpss_barcodetype!='SMC' and dpss_barcodetype!='NMC'") or die(mysqli_error($link));
while($row_sub=mysqli_fetch_array($sql_sub))
{
...
if($barcodes!="")
{
	...
	if($totbarc1>0)
	{
		...
		//$nqty1=number_format($nqty1,3);
$totnomp=$totnomp+$nnob2; 
$totqty=$totqty+$nqty2; 
?>
<tr class="Dark" height="30">
	<td width="17"  align="center"  valign="middle" class="smalltbltext"><?php echo $sn;?></td>
	<td width="82" align="center"  valign="middle" class="smalltbltext"><?php echo $cropval?></td>
	<td width="111" align="center"  valign="middle" class="smalltbltext"><?php echo $varietyval?></td>
	<td width="45" align="center"  valign="middle" class="smalltbltext"><?php echo $upsval;?></td>
	<td width="100" align="center"  valign="middle" class="smalltbltext"><?php echo $lotval;?></td>
	<td width="65" align="center"  valign="middle" class="smalltbltext"><?php echo $dotval;?></td>
	<td width="65" align="center"  valign="middle" class="smalltbltext"><?php echo $dovval;?></td>
	<td width="36" align="center"  valign="middle" class="smalltbltext"><?php echo $nobtp;?></td>
	<td width="30" align="center"  valign="middle" class="smalltbltext"><?php echo $nnob1;?></td>
	<td width="60" align="center"  valign="middle" class="smalltbltext"><?php echo $nqty1;?></td>
	<td width="33" align="center"  valign="middle" class="smalltbltext"><?php echo $nnob2;?></td>
...
$sql_arr_home2=mysqli_query($link,"select distinct dpss_barcode from tbl_dispsub_sub where plantcode='".$plantcode."' and  disp_id='$tid' order by dpss_id asc") or die(mysqli_error($link));
...
?>
<tr class="Dark" height="30">
	<td align="right"  valign="middle" class="smalltbltext" colspan="10">Grand Total&nbsp;</td>
	<td width="33" align="center"  valign="middle" class="smalltbltext"><?php echo $totnomp;?></td>
	<td width="80" align="center"  valign="middle" class="smalltbltext"><?php echo $totqty;?>&nbsp;Kgs.</td>
</tr>
...
<tr class="Dark" height="30">
	<td align="right"  valign="middle" class="smalltbltext" colspan="5">Total&nbsp;</td>
	<td align="right"  valign="middle" class="smalltbltext">Carton(s)&nbsp;</td>
	<td width="65" align="center"  valign="middle" class="smalltbltext"><?php echo $tnopc;?></td>
	<td align="right"  valign="middle" class="smalltbltext">Bag(s)&nbsp;</td>
	<td width="30" align="center"  valign="middle" class="smalltbltext"><?php echo $tnopb;?></td>
	<td align="right"  valign="middle" class="smalltbltext" colspan="2">Gross Weight&nbsp;</td>
	<td width="80" align="center"  valign="middle" class="smalltbltext"><?php echo $tgrqty;?>&nbsp;Kgs.</td>
</tr>
</table>
