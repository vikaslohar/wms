...
$sql23="select * from tbluser where plantcode='".$plantcode."' and scode='".$row['disp_logid']."'";
...
$sql_code1="SELECT * FROM tbl_gatepass where plantcode='".$plantcode."' and trid='$tid' and trtype='Dispatch Pack Seed'";
...
$sql_code12="SELECT * FROM tbl_dispnote where plantcode='".$plantcode."' and dnote_trid='$tid' and dnote_trtype='Dispatch Pack Seed' and dnote_ptype='$ptype'";
...
<br />
<?php
$sql_arr_home=mysqli_query($link,"select * from tbl_disp_sub where plantcode='".$plantcode."' and disp_id='$arrival_id' and disps_flg=1 order by disps_id asc") or die(mysqli_error($link));
