<?php
	...
	if(isset($_POST['frm_action'])=='submit')
	{
		...
		if($trsbmval==0)
		{
			...
			echo "<script>window.location='add_disppack_preview.php?pid=$mainid'</script>";	
			//exit;
		}
		else
		{
...
for (var i=0; i<menuids.length; i++){
  var ultags=document.getElementById(menuids[i]).getElementsByTagName("ul")
   ...
   var c=0;
    ...
    this.getElementsByTagName("ul")[0].style.visibility="visible"; c=1;
    }
    ultags[t].parentNode.onclick=function(){
	if(c==1){
  this.getElementsByTagName("ul")[0].style.visibility="hidden"; c=0;}
  else{
  this.getElementsByTagName("ul")[0].style.visibility="visible";c=1;}
    }
    }
...
function chkbarcode1(mltval)
{
	...
	else
	{
		...
		if(flg==0)
		{
			...
			mltval="'"+mltval+"'";
			//alert(mltval);
			setTimeout('showpmode('+mltval+')', 2000);
...
<tr >
<td valign="top" align="right"><img src="../images/back.gif" border="0" style="display:inline;cursor:Pointer;" onClick="return myhome();"  />&nbsp;&nbsp;<img src="../images/preview.gif" alt="Submit Value"  border="0" style="display:inline;cursor:Pointer;" tabindex="" onClick="return mySubmit('0');" /></td>
</tr>
</table>
</td><td width="30"></td>
</tr>
