<?php
	...
	if($a!="")
	{
		$sqlmonth=mysqli_query($link,"select distinct(orderm_id) from tbl_orderm where plantcode='".$plantcode."' and  orderm_party='$a' and orderm_dispatchflag!='1' and orderm_supflag!='1' and orderm_cancelflag!='1' and orderm_tflag=1 and	order_trtype!='Order TDF' order by orderm_id")or die("Error:".mysqli_error($link));
...
if(count($orsid10)>1)
//echo "select distinct order_sub_sub_ups from tbl_order_sub_sub where orderm_id in($arrivalid) and order_sub_id IN ($orsid) and order_sub_subbal_qty>0 order by order_sub_sub_ups";
...
while($rowsloc2=mysqli_fetch_array($sqlsloc2))
{
	...
	if($upt!="")
	$sqlmon=mysqli_query($link,"select * from tbl_order_sub where plantcode='".$plantcode."' and  order_sub_variety='".$verrid."' and orderm_id in($arrivalid) and order_sub_id='".$rowsloc2['order_sub_id']."' and order_sub_totbal_qty>0 and order_sub_ups_type='$upt' and order_sub_hold_flag=0 order by order_sub_id")or die("Error:".mysqli_error($link));
	else
...
<tr class="Dark" height="30">
	...
	<td width="275" align="center"  valign="middle" class="smalltbltext"><?php echo $totrec;?><input type="hidden" name="rnob<?php echo $sn;?>" id="rnob_<?php echo $sn;?>" value="<?php echo $totrec;?>" /></td>
	...
	<td width="275" align="center"  valign="middle" class="smalltbltext"><input type="hidden" name="grswt<?php echo $sn;?>" id="grswt_<?php echo $sn;?>" value="" /></td>
	...
	<td width="275" align="center"  valign="middle" class="smalltbltext"><input type="radio" checked="checked" name="selsh" id="selsh_<?php echo $sn;?>" value="<?php echo $sn;?>" onclick="selitm('<?php echo $sn;?>','<?php echo $variety?>','<?php echo $up1 ?>','<?php echo $qt?>','<?php echo $ordno?>','<?php echo $upstyp?>');" /></td>
</tr>
<input type="hidden" name="mchksel" value="<?php echo $sn?>" /><input type="hidden" name="txtornos" value="<?php echo $ordno;?>" /><input type="hidden" name="txtveridno" value="<?php echo $variety;?>" /><input type="hidden" name="txtupsnos" value="<?php echo $up1;?>" /><input type="hidden" name="txteqty" value="<?php echo $qt;?>" />
<?php
$sn++;
}
}
...
$upz=explode(" ",$up1);
$upsz=explode(".",$upz[0]);
if($upsz[1]=="000")$upsnz=$upsz[0]." ".$upz[1];
else  $upsnz=$up1;
...
<tr class="tblsubtitle" height="30">
	...
	<td width="155" align="center" valign="middle" class="tblheading"><?php echo $upsnz?><input type="hidden" name="txteups" id="txteups" value="<?php echo $up1;?>" /></td>
</tr>
</table>
...
<tr class="Dark" height="30">
	<td width="65" align="center" valign="middle" class="smalltbltext"><?php echo $sstatus;?><input type="hidden" name="txtenop" id="txtenop" value="<?php echo $sstatus;?>" /></td>
	...
	<td width="65" align="center" valign="middle" class="smalltbltext"><?php echo $qt;?><input type="hidden" name="txteoqty" id="txteoqty" value="<?php echo $qt;?>" /></td>
	<td width="60" align="center" valign="middle" class="smalltbltext"><input type="text" class="smalltbltext" size="3" name="txtallonolp" id="txtallonolp" value="<?php echo $enolp;?>" onchange="nompchk2(this.value);" readonly="true" style="background-color:#CCCCCC"  /></td>
	<td width="60" align="center" valign="middle" class="smalltbltext"><input type="text" class="smalltbltext" name="txtallnomp" size="3" id="txtallnomp" value="<?php echo $mpno;?>" readonly="true" style="background-color:#CCCCCC" /></td>
	<td width="70" align="center" valign="middle" class="smalltbltext"><input type="text" class="smalltbltext" name="txttobealqty" size="5" id="txttobealqty" value="<?php echo $qt;?>" onkeypress="return isNumberKey(event)" onchange="itmqtychk(this.value);"  />&nbsp;<font color="#FF0000"> *</font></td>
	<td align="center" valign="middle" class="smalltbltext"><input type="text" class="smalltbltext" size="3" name="txttlonomp" id="txttlonomp" value="0" readonly="true" style="background-color:#CCCCCC" /></td>
	<td align="center" valign="middle" class="smalltbltext"><input type="text" class="smalltbltext" size="3" name="txttlonolp" id="txttlonolp" value="0" readonly="true" style="background-color:#CCCCCC" /></td>
	<td width="84" align="center" valign="middle" class="smalltbltext"><input type="text" class="smalltbltext" size="3" maxlength="5" name="txtloqty" id="txtloqty" value="0" onchange="nompchk(this.value);" readonly="true" style="background-color:#CCCCCC"  /></td>
	<td width="80" align="center" valign="middle" class="smalltbltext"><input type="text" class="smalltbltext" size="5" name="txtlonolots" id="txtlonolots" value="0" readonly="true" style="background-color:#CCCCCC" /></td>
	<td width="91" align="center" valign="middle" class="smalltbltext"><input type="text" class="smalltbltext" size="3" name="txtorblnomp" id="txtorblnomp" value="0" onchange="nompchk2(this.value);" readonly="true" style="background-color:#CCCCCC"  /></td>
	<td width="70" align="center" valign="middle" class="smalltbltext"><input type="text" class="smalltbltext" size="5" name="txtorblnolp" id="txtorblnolp" value="0" onchange="nompchk2(this.value);" readonly="true" style="background-color:#CCCCCC"  /></td>
	<td width="65" align="center" valign="middle" class="smalltbltext"><input type="text" class="smalltbltext" size="5" name="txtorblqty" id="txtorblqty" value="0" onchange="nompchk2(this.value);" readonly="true" style="background-color:#CCCCCC"  /></td>
</tr>
</table>
