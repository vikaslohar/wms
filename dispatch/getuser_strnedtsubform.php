...
$sql_tbl_sub=mysqli_query($link,"select * from tbl_proslipsub where plantcode='".$plantcode."' and  proslipsub_id='".$a."'") or die(mysqli_error($link));
...
$sql_issue=mysqli_query($link,"select distinct lotldg_whid, lotldg_subbinid, lotldg_binid from tbl_lot_ldg where plantcode='".$plantcode."' and  lotldg_lotno='".$row['proslipsub_lotno']."'  and lotldg_balqty > 0") or die(mysqli_error($link));

 while($row_issue=mysqli_fetch_array($sql_issue))
 { 

$sql_issue1=mysqli_query($link,"select max(lotldg_id) from tbl_lot_ldg where plantcode='".$plantcode."' and  lotldg_subbinid='".$row_issue['lotldg_subbinid']."' and lotldg_binid='".$row_issue['lotldg_binid']."' and lotldg_whid='".$row_issue['lotldg_whid']."' and lotldg_lotno='".$row['proslipsub_lotno']."' ") or die(mysqli_error($link));
...
$sql_tbl_subsub=mysqli_query($link,"select * from tbl_proslipsubsub where plantcode='".$plantcode."' and  proslipsub_id='".$row['proslipsub_id']."' and proslipmain_id='".$tid."'  and proslipsubsub_wh='".$row_issuetbl['lotldg_whid']."' and proslipsubsub_bin='".$row_issuetbl['lotldg_binid']."' and proslipsubsub_subbin='".$row_issuetbl['lotldg_subbinid']."'") or die(mysqli_error($link));
...
$sql_tbl_subsub2=mysqli_query($link,"select * from tbl_proslipsubsub2 where plantcode='".$plantcode."' and  proslipsub_id='".$row['proslipsub_id']."' and proslipmain_id='".$tid."' order by proslipsubsub_id asc") or die(mysqli_error($link));
...
<?php
$bind1_query=mysqli_query($link,"select binid, binname from tbl_bin where plantcode='".$plantcode."' and  whid='".$row_tbl_subsub2['proslipsubsub_wh']."' order by binname") or die(mysqli_error($link));
?>
...
<?php
$subbind1_query=mysqli_query($link,"select sid, sname from tbl_subbin where binid='".$row_tbl_subsub2['proslipsubsub_bin']."' order by sname") or die(mysqli_error($link));
?>	
