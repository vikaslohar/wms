...
if($upstyp=="NST")
{
	$sql_lot2=mysqli_query($link,"Select packtype,wtinmp from tbl_lot_ldg_pack where plantcode='".$plantcode."' and  packtype='$ups24' and trtype='NSTPNPSLIP' and balnomp!=0 order by lotdgp_id ASC") or die(mysqli_error($link));
...
<tr class="Dark" height="30">
	...
	<td width="60" align="center"  valign="middle" class="smalltbltext"><input type="text" class="smalltbltext" size="3" name="txtallonolp" id="txtallonolp" value="0" onchange="nompchk2(this.value);" readonly="true" style="background-color:#CCCCCC"  /></td>
