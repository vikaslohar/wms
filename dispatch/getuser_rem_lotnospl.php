...
<td align="right"  valign="middle" class="tbltext"><input type="radio" name="loc" value="<?php echo $row2['lotno'];?>" onclick="clk(this.value,'<?php echo $row2['lotno'];?>','<?php echo $flg1?>');" />&nbsp;</td>
<td align="left"  valign="middle" class="tbltext" >&nbsp;<?php echo $row2['lotno'];?></td>
</tr>
<?php
}
else
