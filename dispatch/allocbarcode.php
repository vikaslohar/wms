...
<tr class="tblsubtitle" height="20">
	...
	<td width="113" align="center" valign="middle" class="tblheading">Barcode</td>
	<!--<td width="134" align="center" valign="middle" class="tblheading">Pack Type</td>-->
	<td width="114" align="center" valign="middle" class="tblheading">Gross Weight</td>
    <td width="88" align="center" valign="middle" class="tblheading">Net Weight</td>
...
<?php
$srno=1;
$sql_baralloc=mysqli_query($link,"select * from tbl_dallocsub_sub3 where plantcode='".$plantcode."' and  dalloc_id='".$ttype."' and dallocss3_lotno='".$pid."' and dallocss3_dflg=0 order by dallocss3_id asc") or die(mysqli_error($link));
while($row_baralloc=mysqli_fetch_array($sql_baralloc))
{
	/*$sql_dispss=mysqli_query($link,"select * from tbl_dispsub_sub where disp_id='".$row_disp['disp_id']."' and dpss_lotno='".$lotno12."' order by dpss_id asc") or die(mysqli_error($link));
	while($row_dispss=mysqli_fetch_array($sql_dispss))
	{*/
?> 
<tr class="Light" height="20">
	<td width="27" align="center" valign="middle" class="smalltbltext"><?php echo $srno;?></td>
	<!--<td width="113" align="center" valign="middle" class="smalltbltext"><?php echo $row_baralloc['dpss_barcode'];?></td>-->
	<td align="center" class="smalltbltext" valign="middle"><?php echo $row_baralloc['dallocss3_barcode'];?></td>
	<td align="center" class="smalltbltext" valign="middle"><?php echo $row_baralloc['dallocss3_grossweight'];?></td>
	<td align="center" class="smalltbltext" valign="middle"><?php echo $row_baralloc['dallocss3_weight'];?></td>
	<!--<td align="center" class="smalltbltext" valign="middle"><?php echo $lotnetwt;?></td>-->
	<td width="110" align="center" valign="middle" class="tbltext"><?php echo $row_baralloc['dallocss3_ups'];?></td>
</tr>
<?php
$srno++;
}//}?>
