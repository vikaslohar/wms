...
<title>Dispatch - Transaction - Dispatch Bulk Print Preview</title>
...
<td width="176" align="right" valign="middle" class="tblheading">&nbsp;Transaction Id&nbsp;</td>
<td width="202"  align="left" valign="middle" class="tbltext">&nbsp;<?php echo "TDB".$row_tbl['dbulk_tcode']."/".$row_tbl['dbulk_yearcode']."/".$row_tbl['dbulk_logid'];?></td>

<td width="147" align="right" valign="middle" class="tblheading">Date&nbsp;</td>
<td width="215" align="left" valign="middle" class="tbltext">&nbsp;<?php echo $tdate;?>&nbsp;</td>
</tr>
<!--<tr class="Dark" height="30">
<td width="176" align="right" valign="middle" class="tblheading">Dispatch Challan Date&nbsp;</td>
<td width="202" align="left" valign="middle" class="tbltext">&nbsp;<?php echo $tdate2;?>
...
<td width="147" align="right" valign="middle" class="tblheading">&nbsp;Dispatch Challan No.&nbsp;</td>
<td width="215" align="left" valign="middle" class="tbltext">&nbsp;<?php echo $row_tbl['dbulk_dcno'];?><input name="txtdcno" type="hidden" size="20" class="tbltext" maxlength="20" onChange="dcdchk();" tabindex="0" value="<?php echo $row_tbl['dbulk_dcno'];?>" /></td>
</tr>-->
...
?>
 <tr class="Dark" height="30">
<td width="176" align="right" valign="middle" class="tblheading">&nbsp;Party Type&nbsp;</td>
...
?>
<tr class="Dark" height="30">
<td width="177"  align="right"  valign="middle" class="tblheading">State&nbsp;</td>
<td width="202" align="left"  valign="middle" class="tbltext">&nbsp;<?php echo $row_tbl['dbulk_state']; ?><input type="hidden"  class="tbltext" name="txtstatesl" style="width:120px;" onchange="locslchk(this.value)" value="<?php echo $row_tbl['dbulk_state']; ?>" /></td>
...
<td width="214" align="left"  valign="middle" class="tbltext" id="locations">&nbsp;<?php echo $noticia3['productionlocation']; ?>
...
<td width="177"  align="right"  valign="middle" class="tblheading">Country&nbsp;</td>
...
?>   
 <tr class="Dark" height="30">
<td width="177"  align="right"  valign="middle" class="tblheading">Party Name&nbsp;</td>
<td  colspan="3" align="left"  valign="middle" class="tbltext" id="vitem1">&nbsp;<?php echo $noticia['business_name'];?>
  <input type="hidden" class="tbltext"  id="itm1" name="txtstfp" style="width:220px;" onChange="showaddr(this.value);" value="<?php echo $row_tbl['dbulk_party'];?>"  /></td>
	</tr>
<?php
...
?>
<tr class="Dark" height="30">
<td width="177" align="right"  valign="middle" class="tblheading">Address&nbsp;</td>
...
<td width="202" align="left"  valign="middle" class="tbltext">&nbsp;<?php echo $row_tbl['trans_name'];?></td>
<td width="147" align="right" valign="middle" class="tblheading">Lorry Receipt No.&nbsp;</td>
<td width="214" align="left" valign="middle" class="tbltext">&nbsp;<?php echo $row_tbl['trans_lorryrepno'];?></td>
</tr>
...
?> 
<tr class="Dark" height="30">
<td align="right" width="177" valign="middle" class="tblheading">&nbsp;Name of Person&nbsp;</td>
...
<tr class="Dark" height="30">
	...
	<td align="center"  valign="middle" class="smalltbltext"><?php echo $nolots;?><input type="hidden" name="txtnolots" id="txtnolots" value="<?php echo $nolots;?>" /></td>
