...
$sq3=mysqli_query($link,"Select * from tbl_dtdfsub_sub where plantcode='".$plantcode."' and dtdfs_id='$subtid' and dtdf_id='$tid' and dbss_lotno='$ltn' and dtdfs_stage='Pack'") or die(mysqli_error($link));
...
$sql_dlsub_sub=mysqli_query($link,"select * from tbl_dtdfsub_sub2 where plantcode='".$plantcode."' and dtdf_id='$tid' and dtdfs_id='$subtid' and dbsss_subbin='".$row_issuetbl['subbinid']."' and dbss_id='$ssid'") or die(mysqli_error($link));
...
$tnob=$ptp1*$row_dllsub_sub['dbsss_mmcqty']; 
$tqty=$qt; 
...
$sql_dlmmc_sub=mysqli_query($link,"select * from tbl_dtdfmmc where plantcode='".$plantcode."' and dmmc_lotno='".$ltn."' and dtdf_id='$tid' and dtdfs_id='$subtid' and dmmc_esubbin='".$row_issuetbl['subbinid']."' and dbss_id='$ssid'") or die(mysqli_error($link));
