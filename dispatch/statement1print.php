<?php
	...
	if(isset($_REQUEST['txtparent1']))
	{
	$txtparent1 = $_REQUEST['txtparent1'];
	}
	if(isset($_REQUEST['txtparent2']))
	{
	$txtparent2 = $_REQUEST['txtparent2'];
	}
	if(isset($_REQUEST['txtswoing']))
	{
	$txtswoing = $_REQUEST['txtswoing'];
	}
	if(isset($_REQUEST['txtperson']))
	{
	$txtperson = $_REQUEST['txtperson'];
	}
$tid=$pid; 
...
<table width="750" height="282" border="0" align="center" cellpadding="0" cellspacing="0" >
  ...
  <form name="form" method="post" action="statement1print.php">
	...
	<input type="hidden" name="" value="<?php echo $_REQUEST['itmid'];?>" />
	<input type="hidden" name="" value="<?php echo $_REQUEST['crop'];?>" />
	<input type="hidden" name="" value="<?php echo $_REQUEST['variety'];?>" />
	<input type="hidden" name="" value="<?php echo $_REQUEST['lotno'];?>" />
	<input type="hidden" name="" value="<?php echo $_REQUEST['relno'];?>" />
	<input type="hidden" name="" value="<?php echo $_REQUEST['dot'];?>" />
	<br />
...
<td width="391" align="left" valign="middle" class="smalltblheading">&nbsp;Female:&nbsp;<?php echo $txtparent1;?>&nbsp;&nbsp;Male:&nbsp;<?php echo $txtparent2;?></td>
</tr>
<tr class="Light" height="35">
...
<td width="391" align="left" valign="middle" class="smalltblheading"><div style="padding-left:3px"><?php echo $txtswoing;?></div></td>
</tr>
<tr class="Light" height="35">
...
<td width="391" align="left" valign="middle" class="smalltblheading"><div style="padding-left:3px"><?php echo $txtperson;?></div></td>
</tr>
