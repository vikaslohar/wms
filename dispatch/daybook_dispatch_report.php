<?php
	...
	if(isset($_POST['frm_action'])=='submit')
	{
		...
		if($sdate!="")
		{
			echo "<script>window.location='daybook_dispatch_report1.php?sdate=$sdate&edate=$edate&txtstate=$txtstate&txtloc=$txtloc&txtparty=$txtparty&txtdisptype=$txtdisptype'</script>";
		}
		else
		{?>
		 <script>
...
function chkstloc(classval)
{
	...
	{	
		document.frmaddDepartment.txtstate.value="ALL";	document.frmaddDepartment.txtstate.selectedIndex=0; document.frmaddDepartment.txtlocationsl.value="ALL"; document.frmaddDepartment.txtlocationsl.selectedIndex=0;
	}	
	document.frmaddDepartment.txtparty.value="ALL";
	document.frmaddDepartment.txtparty.selectedIndex=0;
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#378b8b" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#378b8b" style="border-bottom:solid; border-bottom-color:#378b8b" >
	    <tr >
	      <td width="813" height="30"class="Mainheading"  >&nbsp;Periodical Dispatch Report - DC wise</td>
	    </tr></table></td>
	  </tr>
	  </table></td></tr>
...
<table align="center" border="1" width="750" cellspacing="0" cellpadding="0" bordercolor="#378b8b" style="border-collapse:collapse" >
                <tr class="tblsubtitle" height="25">
                  <td colspan="4" align="center" class="tblheading" >Periodical Dispatch Report - DC wise</td>
                </tr>
                <tr height="15">
...
<?php
$quer_dtyp=mysqli_query($link,"Select * from tblclassification where (main='Channel' OR main='Stock Transfer' OR classification='Stock Transfer-Plant' OR classification='TDF - Individual' OR classification='Discard Buyer') order by classification asc"); 
?>                  
	<td align="right"  valign="middle" class="smalltblheading" >Dispatch Type&nbsp;</td>
    <td align="left"  valign="middle" class="smalltbltext" id="ditem2" colspan="3">&nbsp;<select class="smalltbltext" id="disptype" name="txtdisptype" style="width:170px;" onChange="chkstloc(this.value)" >
<option value="ALL" selected>--ALL--</option>
 <?php while($noticia_dtyp = mysqli_fetch_array($quer_dtyp)) { ?>
          <option value="<?php echo $noticia_dtyp['classification'];?>" />  
          <?php echo $noticia_dtyp['classification'];?>
          <?php } ?>
	</select>&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
                </tr>				
		
	<tr class="Light" height="25" id="stloc">
<?php
$quer4=mysqli_query($link,"SELECT state_id, state_name FROM tbl_state order by state_name Asc"); 
?>	                  
...
<option value="ALL" selected>--ALL--</option>
<?php while($noticia_st = mysqli_fetch_array($quer4)) { ?>
		<option value="<?php echo $noticia_st['state_name'];?>" />   
		<?php echo $noticia_st['state_name'];?>
<?php } ?>
	</select>&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
<?php
...
</tr><input type="hidden" name="locationname" value="ALL" />
<tr class="Light" height="25">
<?php
$querparty=mysqli_query($link,"select * from tbl_partymaser order by business_name"); 
?>                  
	<td align="right"  valign="middle" class="smalltblheading">Party Name&nbsp;</td>
    <td align="left"  valign="middle" class="smalltbltext" id="pitem2" colspan="3">&nbsp;<select class="smalltbltext" id="party" name="txtparty" style="width:170px;" >
<option value="ALL" selected>--ALL--</option>
<?php while($noticia_party = mysqli_fetch_array($querparty)) { ?>
		<option value="<?php echo $noticia_party['p_id'];?>" />   
		<?php echo $noticia_party['business_name'];?>
		<?php } ?>
	</select>&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
	 </tr>
	  <!--<tr class="Light" height="25">   
...
<td align="left"  valign="middle" class="smalltbltext">&nbsp;<select class="smalltbltext" name="txtcrop" style="width:150px;" onChange="modetchk(this.value)">
<option value="ALL" selected>--ALL--</option>
...
<option value="ALL" selected>--ALL--</option>
          <?php while($noticia_item = mysqli_fetch_array($quer_ver)) { ?>
...
?>				
    ...
    <td align="left"  valign="middle" class="smalltbltext" id="vitem2">&nbsp;<select class="smalltbltext" id="upsdc" name="txtupsdc" style="width:120px;" >
<option value="ALL" selected>--ALL--</option>
<?php while($row_ups=mysqli_fetch_array($quer_ups)) { ?>
    ...
    <td align="left"  valign="middle" class="smalltbltext" id="vitem3">&nbsp;<input type="text" class="smalltbltext" id="lotno" name="txtlotno" value="" size="7" maxlength="7" placeholder="DA12345" onChange="chklot(this.value)" /></td>
                </tr>-->
