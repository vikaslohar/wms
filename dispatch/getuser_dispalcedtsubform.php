...
if($upstyp=="NST")
{
	$sql_lot2=mysqli_query($link,"Select packtype,wtinmp from tbl_lot_ldg_pack where packtype='$ups24' and trtype='NSTPNPSLIP' and balnomp!=0 order by lotdgp_id ASC") or die(mysqli_error($link));
	$tot_lot2=mysqli_num_rows($sql_lot2);
	$row_lot2=mysqli_fetch_array($sql_lot2);
