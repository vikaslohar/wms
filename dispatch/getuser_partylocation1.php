...
<td width="262" align="left"  valign="middle" class="smalltbltext">&nbsp;<select class="smalltbltext" name="txtstatesl" style="width:120px;" onchange="locslchk(this.value)">
...
<td width="269" align="left"  valign="middle" class="smalltbltext" id="locations">&nbsp;<select class="smalltbltext" name="txtlocationsl" style="width:160px;" onchange="stateslchk(this.value)">
