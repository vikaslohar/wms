<?php
	...
	$sql_arrsub=mysqli_query($link,"select * from tbl_dalloc_sub where plantcode='".$plantcode."' and  dalloc_id='".$tid."' and dallocs_id='".$subtrid."'") or die(mysqli_error($link));
	$a_arrsub=mysqli_num_rows($sql_arrsub);
	if($a_arrsub==0)
	{
		$s_sub="delete from tbl_dalloc_sub where dallocs_id='".$subtrid."'";
