...
<tr  height="20">
  <td colspan="6" align="center" class="Mainheading"><font color="#000000">QC Sample Dispatch Note </font></td>
</tr>
</table>
<table align="center" border="1" width="750" cellspacing="0" cellpadding="0" bordercolor="#d21704" style="border-collapse:collapse" > 
 <tr class="Dark" height="20">
<td width="102" colspan="1" align="center" valign="middle" class="tblheading">#</td>
			<td width="139" colspan="1" align="center" valign="middle" class="tblheading">Sample No. </td>
			...
			<td width="31" colspan="1" align="center" valign="middle" class="tblheading">Date</td>
		  </tr>
<?php 
$srno=1;
