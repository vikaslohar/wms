...
if(isset($_POST['frm_action'])=='submit')
	...
	//$oref=$row_ck['qcrefno'];
	$ogotdate=$row_ck['gottest_gotdate'];
	...
	if($ores=="RT")
	{
			...
			if($result!="RT")
		{
			...
			if(mysqli_query($link,$sql_sub_sub12) or die(mysqli_error($link)))
			{
				...
				$sql_sub_sub1222="update tbl_qctest set gotstatus='$result', gotdate='$tdate', gotrefno='$loc', gotauth='$total', doswdate='$doswdate', gotflg=1 where sampleno='$osamp22' and yearid='$yearid22'";
		...
		else
		{
			...
			$qq2=mysqli_query($link,$sql_sub2) or die(mysqli_error($link));
			 ...
			 //$sql_sub_sub122="update tbl_qctest set gotflg=1 where sampleno='$osamp22' and yearid='$yearid22'";
	...
	else
	{
		if($result!="RT")
		{
			...
			if(mysqli_query($link,$sql_sub_sub12) or die(mysqli_error($link)))
			{
				...
				$sql_sub_sub1222="update tbl_qctest set gotstatus='$result', gotdate='$tdate', gotrefno='$loc', gotauth='$total', doswdate='$doswdate', gotflg=1, genpurity='$purity' where sampleno='$osamp22' and yearid='$yearid22'";
				$qq222=mysqli_query($link,$sql_sub_sub1222) or die(mysqli_error($link));
		}
		else
		{
...
<td align="left" valign="middle" class="tbltext">&nbsp;<input name="pdate1" id="pdate" type="text" size="10" class="tbltext" tabindex="0" readonly="true"  value="<?php echo date("d-m-Y", time());?>" style="background-color:#EFEFEF"/>&nbsp;<a href="javascript:void(0)" onClick="doschk('pdate')" tabindex="6"><img src="../images/cal.gif" alt="Calender" border="0" align="absmiddle"></a>&nbsp;&nbsp;<font color="#FF0000">*</font>&nbsp;&nbsp;</td>
	          
<td align="right" valign="middle" class="tblheading">Date of Transplant&nbsp;</td>
<td align="left" valign="middle" class="tbltext">&nbsp;<input name="trdate" id="trdate1" type="text" size="10" class="tbltext" tabindex="0" readonly="true"  value="" style="background-color:#EFEFEF" />&nbsp;<a href="javascript:void(0)" onClick="dotchk('trdate1')" tabindex="6"><img src="../images/cal.gif" alt="Calender" border="0" align="absmiddle"></a></td>
</tr>

<tr class="Dark" height="25">
<td align="right" valign="middle" class="tblheading">Bed No.&nbsp;</td>
<td align="left" valign="middle" class="tbltext">&nbsp;<input name="txtbedno" type="text" size="20" class="tbltext" tabindex=""  maxlength="20"  value="" onchange="chk()">&nbsp;&nbsp;<!--<font color="#FF0000">*</font>-->&nbsp;&nbsp;</td>

<td  align="right"  valign="middle" class="tblheading">Direction&nbsp;</td>
<td align="left" valign="middle" class="tbltext" id="direction">&nbsp;<select class="tbltext" name="txtdirection" style="width:100px;" onchange="dirchk()">
...
<td colspan="3" align="left" valign="middle" class="tbltext" >&nbsp;<input name="txtplantpopn" type="text" size="20" class="tbltext" tabindex=""  maxlength="20"  value="" onchange="plantpop()">&nbsp;&nbsp;<font color="#FF0000">*</font>&nbsp;&nbsp;(No. of Plants)</td>
</tr>

<tr class="Dark" height="25">
<td align="right"  valign="middle" class="tblheading"><?php if($crop!="Cluster Bean"){?>Male&nbsp;<?php }else{?>Desi Type&nbsp;<?php }?></td>
<td align="left" valign="middle" class="tbltext">&nbsp;<input name="txtno" type="text" size="3" class="tbltext" tabindex=""  maxlength="20"  value="" >&nbsp;No.&nbsp;&nbsp;&nbsp;<input name="txtper" type="text" size="4" class="tbltext" tabindex=""  maxlength="20"  value="" readonly="true" style="background-color:#CCCCCC" >%</td>

<td align="right" valign="middle" class="tblheading"><?php if($crop!="Cluster Bean"){?>Female&nbsp;<?php }else{?>Branching&nbsp;<?php }?></td>
<td align="left" valign="middle" class="tbltext">&nbsp;<input name="txtno1" type="text" size="3" class="tbltext" tabindex=""  maxlength="20"  value="" >&nbsp;No.&nbsp;&nbsp;&nbsp;<input name="txtper1" type="text" size="4" class="tbltext" tabindex=""  maxlength="20"  value="" readonly="true" style="background-color:#CCCCCC" >%</td>
</tr>

<tr class="Dark" height="25">
<td align="right" valign="middle" class="tblheading">OOF&nbsp;</td>
<td align="left" valign="middle" class="tbltext">&nbsp;<input name="txtoofno" type="text" size="3" class="tbltext" tabindex=""  maxlength="20"  value="" >&nbsp;No.&nbsp;&nbsp;&nbsp;<input name="txtoofper" type="text" size="4" class="tbltext" tabindex=""  maxlength="20"  value="" readonly="true" style="background-color:#CCCCCC" >%</td>

<td align="right" valign="middle" class="tblheading">Total&nbsp;</td>
<td align="left" valign="middle" class="tbltext">&nbsp;<input name="txttotno" type="text" size="3" class="tbltext" tabindex=""  maxlength="20"  value="" >&nbsp;No.&nbsp;&nbsp;&nbsp;<input name="txtper" type="text" size="4" class="tbltext" tabindex=""  maxlength="20"  value="" readonly="true" style="background-color:#CCCCCC" >%</td>
</tr>
...
<td align="right"  valign="middle" class="tblheading" >GOT Result&nbsp;</td>
 <td align="left"  valign="middle" class="tbltext" id="gotresult">&nbsp;<select class="tbltext" name="result" style="width:100px;" onchange="gotres()" >
    <option value="" selected>--Select--</option>
  	<option value="OK" >OK</option>
	<option value="Fail" >Fail</option>
	<option value="RT" >Retest</option>
...
<td align="left"  valign="middle" class="tbltext" colspan="3" >&nbsp;<input name="txttotal" type="text" size="20" class="tbltext" tabindex=""   maxlength="20" onchange="authorised()"/>&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
</tr>	
		  
<tr class="Light" height="30">
<td align="right"  valign="middle" class="tblheading">&nbsp;Remarks&nbsp;</td>
<td align="left"  valign="middle" class="tbltext" colspan="3">&nbsp;
  <input type="text" name="txtremarks" class="tbltext" size="100" maxlength="90" /></td>
</tr></table>
		<br />
