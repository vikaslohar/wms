<?php
	...
	if(isset($_POST['frm_action'])=='submit')
	{
		...
		echo "<script>window.location='report_rawsscrop1.php?txtcrop=$cid&txtvariety=$itemid&txtstage=$txtstage'</script>";
	}
          ...
          <tr>
            ...
            <td><table align="center" border="1" width="600" cellspacing="0" cellpadding="0" bordercolor="#d21704" style="border-collapse:collapse" >
                <tr class="tblsubtitle" height="25">
                  <td colspan="2" align="center" class="tblheading">Crop Variety wise Substandard Seed Report</td>
                </tr>
                <tr height="15">
...
<tr class="Light" height="25">
    ...
    <td align="left"  valign="middle" class="tbltext" id="vitem">&nbsp;<select class="tbltext" id="stage" name="txtstage" style="width:170px;" >
<option value="ALL" selected>--ALL--</option>
