...
//echo "select * from tbl_salesrv_sub where salesr_id!=0 and (salesrs_qc='Fail' OR salesrs_got1='Fail') and salesrs_crop='".$crval."' and salesrs_variety='".$verval."'  order by salesrs_id asc";
...
if($t > 0)
{
	...
	{ 
		...
		{
			$sloc=$sloc.$wareh.$binn.$subbinn." | ".$slqty."<br/>";
			//$sloc1=$sloc.$wareh.$binn.$subbinn;
		}
		else
		{
			$sloc=$wareh.$binn.$subbinn." | ".$slqty."<br/>";
			//$sloc1=$wareh.$binn.$subbinn;
		}
...
//}
	...
	//echo $row_issuetbl['salesrs_newlot']." - ".$slqty." - ".$availflg." - ".$balqtyflg."<br />";	
if($balqtyflg==0 && $slqty>0){$balqtyflg=1;}
/*if($availflg>0 && $balqtypackflg==0 && $balqtyconflg==0)
{
	$slqty=0;
}*/
//echo $cnt; $balqtypackflg $balqtyconflg

if($balqtyflg>0 && $cnt>0)
{
$srno++;
$totalqty=$totalqty+$totqty; 
$totalbags=$totalbags+$totnob;
...
<tr class="Light">
			<td align="center" valign="middle" class="smalltbltext"><?php echo $srno;?></td>
		  	<td align="center" valign="middle" class="smalltbltext"><?php echo $row_issuetbl['salesrs_newlot']?></td>
         	<td align="center" valign="middle" class="smalltbltext"><?php echo $stage;?></td>
         	<td align="center" valign="middle" class="smalltbltext"><?php echo $totnob?></td>
		   	<td align="center" valign="middle" class="smalltbltext"><?php echo $totqty;?></td>
			<td align="center" valign="middle" class="smalltbltext"><?php echo $sloc?></td>
...
?>
<tr class="Dark">
	<td align="center" valign="middle" class="smalltblheading" colspan="14">No records found for this Variety</td>
</tr>
<?php
}
?>
