...
if($printopt == "1" )
{
	echo "<script>window.location='select1.php'</script>";	
}
if($printopt<="2"){
echo "<script>window.location='home_sampling1.php'</script>";	
}
...
<td width="85"  align="right"  valign="left" class="tbltext">&nbsp;
  <input type="radio" name="fet" value="1" onClick="test1(this.value);" /></td>
    <td width="223" align="left"  valign="middle" class="tblheading">&nbsp;GOT Dispatch Pending</td>
</tr>
<tr class="Light" height="25">
<td  align="right"  valign="left" class="tbltext">&nbsp;
  <input type="radio" name="fet" value="2" onClick="test1(this.value);" /></td>
 <td width="223" align="left"  valign="middle" class="tblheading">&nbsp;GOT Dispatch Completed</td>
 </tr>
</table>
