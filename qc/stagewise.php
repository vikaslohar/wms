  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" style="border-bottom:solid; border-bottom-color:#d21704" >
	    <tr >
	      <td width="813" height="25" class="Mainheading">&nbsp;Auto Sampling stagewise </td>
	    </tr></table></td>
...
<tr>
<td width="30">	 </td><td><table align="center" border="1" width="850" cellspacing="0" cellpadding="0" bordercolor="#d21704" style="border-collapse:collapse" > 

<tr class="tblsubtitle" height="25">
			<td align="center" valign="middle" class="tblheading" rowspan="2">stage</td>
			<td align="center" valign="middle" class="tblheading" rowspan="2">PP</td>
			<td height="28" colspan="1" align="center" valign="middle" class="tblheading">MO</td>
			<td align="center" valign="middle" class="tblheading" colspan="1"> GM </td>
			<td align="center" valign="middle" class="tblheading" colspan="1">VI</td>
			<td align="center" valign="middle" class="tblheading" colspan="1">DN</td>
			<td align="center" valign="middle" class="tblheading" colspan="1">Hard</td>
			<td align="center" valign="middle" class="tblheading" colspan="1">GS</td>
			<td align="center" valign="middle" class="tblheading" colspan="1">ObservationPay CS </td>
...
<tr class="Light" height="25">
			<td align="center" valign="middle" class="tblheading"  rowspan="1">Arrival</td>
...
<tr class="Dark" height="25">
			<td align="center" valign="middle" class="tblheading">Processing</td>
			<td align="center" valign="middle" class="tblheading"><?php echo $p_name;?></td>
			<td align="center" valign="middle" class="tblheading"><?php echo $stlg_trups;?></td>
			<td align="center" valign="middle" class="tblheading">&nbsp;</td>
			<td align="center" valign="middle" class="tblheading">&nbsp;</td>
...
?>
<tr class="Dark" height="25">
			<td align="center" valign="middle" class="tblheading" rowspan="1">Lot Merger </td>
			<td align="center" valign="middle" class="tblheading"><?php echo $p_name;?></td>
			<td align="center" valign="middle" class="tblheading"><?php echo $stlg_trups;?></td>
			<td align="center" valign="middle" class="tblheading">&nbsp;</td>
			<td align="center" valign="middle" class="tblheading">&nbsp;</td>
...
?>
<tr class="Dark" height="25">
			<td align="center" valign="middle" class="tblheading" rowspan="1">Packing</td>
			<td align="center" valign="middle" class="tblheading"><?php echo $p_name;?></td>
			<td align="center" valign="middle" class="tblheading"><?php echo $stlg_trups;?></td>
			<td align="center" valign="middle" class="tblheading">&nbsp;</td>
			<td align="center" valign="middle" class="tblheading">&nbsp;</td>
...
<tr class="Dark" height="25">
			<td align="center" valign="middle" class="tblheading" rowspan="2">Sales Ret Stock Transaction </td>
			<td align="center" valign="middle" class="tblheading"><?php echo $p_name;?></td>
			<td align="center" valign="middle" class="tblheading"><?php echo $stlg_trups;?></td>
			<td align="center" valign="middle" class="tblheading">&nbsp;</td>
			<td align="center" valign="middle" class="tblheading">&nbsp;</td>
