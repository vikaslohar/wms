...
<title>Qtyl- Utlity -Qc Biography</title>
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#d21704" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#d21704" style="border-bottom:solid; border-bottom-color:#d21704" >
	    <tr >
	      <td width="813" height="25" class="Mainheading">&nbsp;Utility - GS Query- Preview</td>
	    </tr></table></td>
...
<table align="center" border="0" cellspacing="0" cellpadding="0" width="650" bordercolor="#d21704" style="border-collapse:collapse">
...
$t=mysqli_num_rows($quer4);
if($t > 0)$rowvv=$rowv['popularname'];	else $rowvv=$variety;
	
	$quer3=mysqli_query($link,"SELECT * FROM tblcrop  where cropid='".$crop."'"); 
	$row3=mysqli_fetch_array($quer3);
	 $row31=$row3['cropname'];
	 ?>
  <td align="left" class="subheading" style="color:#303918; " colspan="2">&nbsp;Crop: <?php echo $row31;?></td>
   <td align="center" class="subheading" style="color:#303918; " colspan="2">Variety: <?php echo $rowvv;?></td>
    <td align="right" class="subheading" style="color:#303918; " colspan="2">Lot No: <?php echo $lot;?>&nbsp;&nbsp;</td>
  	</tr>
	</table>
<table align="center" border="1" cellspacing="0" cellpadding="0" width="650" bordercolor="#d21704" style="border-collapse:collapse">
  ...
  <?php
$sql_tb=mysqli_query($link,"select * from tbl_gsample where gscrop='".$row31."' and gsvariety='".$rowvv."' and oldlot='$lot'") or die(mysqli_error($link));
 $tot=mysqli_num_rows($sql_tb);
	?>
<tr class="tblsubtitle" height="20">
  <!--<td width="2%" rowspan="2" align="center" valign="middle" class="tblheading">#</td>
	...
	<td width="17" align="center" valign="middle" class="tblheading">#</td>
			  ...
			  <td width="79" align="center" valign="middle" class="tblheading">GS Date </td>
			...
			<td width="75" align="center" valign="middle" class="tblheading" >Germ %</td>
               ...
               <td width="116" align="center" valign="middle" class="tblheading">SLOC</td>
			   </tr>
  <?php
...
if($tot > 0)
{
while($row_tbl_sub=mysqli_fetch_array($sql_tb))
{


    $tdate=$row_tbl_sub['gsdate'];
	$tyear=substr($tdate,0,4);
	$tmonth=substr($tdate,5,2);
	$tday=substr($tdate,8,2);
	$tdate=$tday."-".$tmonth."-".$tyear;
				
//$binn=$row_tbl_sub['gsbin'];
 $wh=""; $binn=""; $slocs="";
 $wh1=$row_tbl_sub['gswh']."/";
 $binn1=$row_tbl_sub['gsbin'];
...
<tr >
 <td valign="top" align="center"><a href="utility_gs.php" tabindex="20"><img src="../images/back.gif" border="0"style="display:inline;cursor:hand;" /></a>&nbsp;&nbsp;&nbsp;</td>
</tr>
</table>
</td><td width="30"></td>
</tr>
