...
$sql_m=mysqli_query($link,"select distinct lotldg_lotno from tbl_lot_ldg where lotldg_crop='".$a."' and lotldg_variety='".$b."' ") or die(mysqli_error($link));
...
if($qc=="UT" || $qc=="RT" || $qc=="Fail")
{
$vflg++;
}
else
{
	if($qc=="Fail" || $gotres=="UT" || $gotres=="RT" || $gotres=="Fail")
	{
	$vflg++;
	}
}
