...
$targetpage = $PHP_SELF; 
  ...
  $sql_arr_home=mysqli_query($link,"select * from tbl_gottest where gottest_gotflg=0 and gottest_gotsampdflg=1 and (gottest_got='UT' or gottest_got='RT') group by gottest_lotno,gottest_spdate order by gottest_tid asc, gottest_spdate ASC LIMIT $start, $limit") or die(mysqli_error($link));
...
$query = "SELECT COUNT(*) as num FROM tbl_gottest where gottest_gotflg=0 and gottest_gotsampdflg=1 and (gottest_got='UT' or gottest_got='RT')";
