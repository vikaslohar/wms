...
if($tot_arrival)
{
 ...
 $tp;
$sql_tbl_sub=mysqli_query($link,"select distinct(orlot), lotldg_qc, lotldg_got from tbl_lot_ldg where lotldg_crop='".$crop."' and lotldg_variety='".$variety."' and lotldg_balqty > 0 and lotldg_qc!='Fail' and (lotldg_qc='OK' or lotldg_qc='NUT') and lotldg_got!='Fail' $sss")or die(mysqli_error($link));
