...
if($val <> "")
{
$sql_arr_home=mysqli_query($link,"select * from tbl_gottest where gottest_tid='$val' order by gottest_sampleno desc") or die(mysqli_error($link));
while($row_arr_home=mysqli_fetch_array($sql_arr_home))
{
	...
	$sql_tbl_sub=mysqli_query($link,"select * from tbl_gottest where gottest_tid='".$val."'") or die(mysqli_error($link));
	$subtbltot=mysqli_num_rows($sql_tbl_sub);
