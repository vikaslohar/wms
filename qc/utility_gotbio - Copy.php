<?php
	...
	//exit;
		...
		echo "<script>window.location='utility_gotbio1.php?&txtvariety=$txtvariety&txtcrop=$txtcrop&txtlot1=$txtlot1'</script>";	
...
<title>Quality GOT - Utility - GOT Biography</title>
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#e48324" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#e48324" style="border-bottom:solid; border-bottom-color:#d21704" >
	    <tr >
	      <td width="813" height="25" class="Mainheading">&nbsp;Utility - GOT Biography </td>
	    </tr></table></td>
	...
	<?php while($noticia_item = mysqli_fetch_array($sql_month)) { ?>
		...
		<?php } ?></select>&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
         ...
         <tr class="Light" height="30" id="vitem">
           ...
           <td align="left" width="272" valign="middle" class="tbltext" style="border-color:#d21704" colspan="4" >&nbsp;<input name="txtlot1" type="text" size="20" class="tbltext" tabindex=""  maxlength="20"  value="" readonly="true" style="background-color:#ECECEC"  >&nbsp;<font color="#FF0000">*</font>&nbsp;<a href="Javascript:void(0);" onclick="openslocpop();">Select</a></td>
</table>
