	...
	if(isset($_POST['frm_action'])=='submit')
	{
		...
		{		
			...
			if($partyflg>0)
			{
				...
				{
					$gtidd2="gtidd".$i;
					$catalougeid2="catalougeid".$i;
					$totnosamples2="totnosamples".$i;
					$gtidd1=trim($_POST[$gtidd2]);
					$catalougeid1=trim($_POST[$catalougeid2]);
					$totnosamples1=trim($_POST[$totnosamples2]);
					if($gtidd1==$fid)
					{
						$catalougeido=$catalougeid1;
						$totnosampleso=$totnosamples1;
					}
				}
			}
			
			$sql_arr_home3=mysqli_query($link,"select distinct gottest_sampleno, yearid from tbl_gottest where gottest_tid='".$fid."' and gottest_aflg=0 and gottest_bflg=1 and gottest_cflg=0 and gottest_gotflg=0 and gottest_gotsampdflg=0 and gottest_got='UT' order by gottest_sampleno desc") or die(mysqli_error($link));
			$tot_arr_home3=mysqli_num_rows($sql_arr_home3);
			while($row_arr_home3=mysqli_fetch_array($sql_arr_home3))
			{
				$sql_sub_sub12="update tbl_gottest set gottest_dosdate='$date', gottest_gotsampdflg=1, gottest_catid='$catalougeido', gottest_totnosamp='$totnosampleso' where gottest_sampleno='".$row_arr_home3['gottest_sampleno']."' and yearid='".$row_arr_home3['yearid']."'";
...
{ 
	var flg=0;
	if(document.mainform.partyflg.value=="1")
	{
		var cnt=document.mainform.cnt.value;
		for (var i=1; i<=cnt; i++)
		{	
			var catalougeid="catalougeid"+i;
			var totnosamples="totnosamples"+i;
			if(document.getElementById(catalougeid).value=="")
			{
				alert('Catalouge ID cannot be blank');
				document.getElementById(catalougeid).focus();
				flg=1;
				return false;
			}
			if(document.getElementById(totnosamples).value=="")
			{
				alert('Total No. of Samples cannot be blank');
				document.getElementById(totnosamples).focus();
				flg=1;
				return false;
			}
			if(parseInt(document.getElementById(totnosamples).value)<=0)
			{
				alert('Total No. of Samples cannot be ZERO');
				document.getElementById(totnosamples).focus();
				flg=1;
				return false;
			}
...
<table align="center" border="1" cellspacing="0" cellpadding="0" width="900" bordercolor="#d21704" style="border-collapse:collapse">
            ...
            <tr class="tblsubtitle" height="20">
              <td width="25" height="19"align="center" valign="middle" class="tblheading">#</td>
			   <td width="69" align="center" valign="middle" class="tblheading">DOSR</td>
              ...
              <td width="134" align="center" valign="middle" class="tblheading">Variety</td>
              <td width="99" align="center" valign="middle" class="tblheading">Lot No.</td> 
			  <td width="62" align="center" valign="middle" class="tblheading">Stage</td>
			  <td width="53" align="center" valign="middle" class="tblheading">QC Tests </td>
			...
			{
			?>
			  <td width="127" align="center" valign="middle" class="tblheading">Catalouge ID </td>
			  <td width="56" align="center" valign="middle" class="tblheading">Total No. of Samples </td>
			<?php
			}
			?>
				 </tr>
...
<tr class="Light">
         <td width="25" align="center" valign="middle" class="tblheading"><?php echo $srno;?></td>
		  <td width="69" align="center" valign="middle" class="tblheading"><?php echo $trdate;?></td>
		   <td width="69" align="center" valign="middle" class="tblheading"><?php echo $trdate1;?></td>
         ...
         <td width="99" align="center" valign="middle" class="tblheading"><?php echo $lotno?></td>
		 	<td width="62" align="center" valign="middle" class="tblheading"><?php echo $stage?></td>
		 	<td align="center" valign="middle" class="tblheading"><?php echo $pp;?></td>
		  <td width="84" align="center" valign="middle" class="tblheading"><?php echo $tp1?><?php echo $yearid_id?><?php echo sprintf("%000006d",$qc1);?></td>
		  <?php
			if($partytype=="QC Lab")
			{
			$partyflg=1; 
			?>
		  <td  align="left" valign="middle" class="tbltext">&nbsp;<input type="text" name="catalougeid<?php echo $cnt;?>" id="catalougeid<?php echo $cnt;?>" size="15" class="tbltext" />&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
		  <td align="left" valign="middle" class="tbltext" colspan="3">&nbsp;<input type="text" name="totnosamples<?php echo $cnt;?>" id="totnosamples<?php echo $cnt;?>" size="3" class="tbltext" onkeypress="return isNumberKey(event)" />&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
		  <?php
			}
			?>
			<input type="hidden" name="gtidd" id="gtidd<?php echo $cnt;?>" value="<?php echo $row_arr_home['gottest_tid']; ?>"  />
   </tr>
<?php
}
else
...
<tr >
<td valign="top" align="right"><a href="edit_qcrequest.php?p_id=<?php echo $tid;?>"><img src="../images/edit.gif" border="0"style="display:inline;cursor:Pointer;" /></a>&nbsp;&nbsp;<a href="Javascript:void(0)" onclick="openslocpopprint();"><img src="../images/printpreview.gif" border="0"style="display:inline;cursor:Pointer;" /></a>&nbsp;&nbsp;<input name="Submit" type="image" src="../images/finalsubmit.gif" alt="Submit Value"  border="0" style="display:inline;cursor:Pointer;" tabindex="" onClick="return mySubmit();">&nbsp;&nbsp;<input type="hidden" name="partyflg" value="<?php echo $partyflg;?>" /></td>
</tr>
</table>
</td><td width="30"></td>
</tr>
