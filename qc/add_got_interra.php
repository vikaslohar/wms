...
//echo "SELECT * FROM `tbl_gottestsub` where gottest_tid='".$tid."' and gottests_type='IN-TERRA'";
...
//exit;
	echo "<script>window.location='add_got_interra.php?tid=$tid&interra=$interra&interrarepl=$interrarepl'</script>";
}
...
//alert(document.frmaddDept.step.value);
	...
	if(document.frmaddDept.step.value=="PCR")
	{
		...
		/*if(document.frmaddDept.txtstfp.value != "Paddy Seed")
		{
			if(parseInt(document.frmaddDept.txtnoofplants.value)>parseInt(document.frmaddDept.txtnoseeds.value))
			{
...
//alert(document.frmaddDept.itmid.value);
return true;
}
</script>
<body>
<table width="1003" height="600" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#d21704" >
	 ...
	 <input name="itmid" value="<?php echo $_REQUEST['tid'];?>" type="hidden">
...
//echo "SELECT * FROM tbl_gottestsub_sub where gottests_id=$gots_id order by gottestss_id desc limit 0,1";
