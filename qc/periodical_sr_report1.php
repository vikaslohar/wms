...
<tr class="tblsubtitle" height="25">
	...
	<td width="99" align="Center" class="smalltblheading">Lot No.</td>
	<?php if($txtups=="Yes"){?>
...
while($row_srretm=mysqli_fetch_array($sql_srretm))
{
	...
	//echo $mid;
	if($txtups=="Yes")
	$sqlsrrets="select distinct salesrs_variety, salesrs_crop, salesrs_ups, salesrs_newlot, salesrs_id, salesrs_orlot from tbl_salesrv_sub where salesrs_dovfy<='".$edt."' and salesrs_dovfy>='".$sdt."' and salesr_id=$mid  and salesrs_vflg=1 ";
	else
	$sqlsrrets="select distinct salesrs_variety, salesrs_crop, salesrs_ups, salesrs_newlot, salesrs_id, salesrs_orlot from tbl_salesrv_sub where salesrs_dovfy<='".$edt."' and salesrs_dovfy>='".$sdt."' and salesr_id=$mid  and salesrs_vflg=1 ";
	...
	//echo $sqlsrrets." = ".mysqli_num_rows($sql_srrets)."<br />";
	while($row_srrets=mysqli_fetch_array($sql_srrets))
	{
		$cropn=""; $varietyn=""; $totqty=0; $okqty=0; $failqty=0; $utqty=0; $lotnc=""; $lotnp=""; $ups=''; $exshqty="";  $lotnos='';
...
?>
<tr height="25">
	<td align="Center" class="tblheading" colspan="19">Record Not Found.</td>
</tr>
<?php
}
?>
