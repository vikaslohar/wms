...
<title>Quality-Gate Pass Out</title>
...
$row=mysqli_fetch_array($sql_tbl);			
 ...
 $code="GSD"."/".$row['year_code']."/".$row['gsdn'];
 
$sql_code1="SELECT * FROM tbl_gate where trid='$tid' and trtype='GOT Dispatch'";
...
$code1="GP-Q".$row_param['code']."/".$yearid_id."/".$row_code1['gid'];
	?>
...
<td width="173" align="right" valign="middle" class="tblheading">&nbsp;Date&nbsp;</td>
<td width="196"  align="left" valign="middle" class="tbltext">&nbsp;<?php echo $tdate;?></td>
...
<td align="left" width="264" valign="middle" class="tbltext">&nbsp;<?php echo $code1;?></td>
 ...
 <tr class="Dark" height="30">
<td width="173" align="right" valign="middle" class="tblheading">&nbsp;GSDN Ref. No.&nbsp;</td>
...
if($row['pid']=="Yes")
{
 ...
 $business_name=$row3['business_name'];
	...
	{
	$phone="0".$row['std']." ".$row['contactno'].", <b>Mobile No:</b> ".$row['mobileno'];
	}
	}
?>
...
<table align="center" border="1" cellspacing="0" cellpadding="0" width="750" bordercolor="#d21704" style="border-collapse:collapse">
            ...
            <tr class="tblsubtitle" height="20">
              <td height="19" align="center" valign="middle" class="tblheading">Particulars</td>
			   <td align="center" valign="middle" class="tblheading">No. of Units</td>
		  </tr>
		  
<tr class="Light">
         <td width="50%" align="center" valign="middle" class="tblheading">GOT Samples</td>
		  <td align="center" valign="middle" class="tblheading"><?php echo $cnt;?></td>
   </tr>
</table><br />
