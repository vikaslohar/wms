...
$var=$row_crp['cropname']."-Coded";
$var1=$row_crp['cropname']."-Unidentified";

$sql_qc=mysqli_query($link,"SELECT distinct(gsvariety) FROM tbl_gsample WHERE gscrop='".$row_crp['cropname']."' and gsvariety IN('$var', '$var1') ") or die(mysqli_error($link)); 
