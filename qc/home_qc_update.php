...
<tr class="Light">
	...
	<td width="76" align="center" valign="middle" class="tblheading"><a href="edit_update.php?cropid=<?php echo $row_arr_home['tid'];?>&eurl=<?php echo $eurl?>&eurlnew=<?php echo $eurl?>"><?php echo $tp1?><?php echo $row_arr_home['yearid']?><?php echo sprintf("%000006d",$qc1);?></a></td>
