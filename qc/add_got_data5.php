...
function plantpop()
{
	if(parseInt(document.frmaddDept.txtplantpopn.value)>parseInt(document.frmaddDept.txtnoofplants.value))
	{
		alert("Plant Population should be less than or equal to No. of plants");
		document.frmaddDept.txtplantpopn.value="";
...
<td width="98" align="center" valign="middle" class="smalltbltext"><?php echo $rowloc['loc_name']?></td>
 <td width="94" align="center" valign="middle" class="smalltbltext"><input name="txtnoofplants" type="text" size="10" class="tbltext" tabindex=""  maxlength="20"  value="<?php echo $rowss1['gottestss_plantpopln']?>" readonly="true" style="background-color:#EFEFEF">&nbsp;&nbsp;<font color="#FF0000">*</font>&nbsp;&nbsp;</td>
</tr>
</table><br />
