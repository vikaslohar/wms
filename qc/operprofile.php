...
if(isset($_POST['frm_action'])=='submit')
	...
	echo  $sql_in="update tblopr set login='$login',
									pass='$pass',
									email='$email'
									where id='$loginid'";
											//exit;
		...
		{ 
       echo  $sql_in1="Update tbluser set	loginid='$login',
										password='$pass',
										email='$email'
										where role='$role' and scode='$scode'";	
...
<!-- actual page start--->	
 ...
 <?php
 $ssl=mysqli_query($link,"Select * from tbluser where role='".$role."' and scode='".$logid."'") or die(mysqli_error($link));
 $noticia3 = mysqli_fetch_array($ssl);
	...
	?>
	 ...
	 <input type="hidden" name="scode" value="<?php echo $logid;?>">
