...
<title>Administrator-Report - Master Report- Bin Report</title>
...
winHandle=window.open('report_bin1.php?whid='+val,'WelCome','top=20,left=80,width=820,height=600,scrollbars=yes');
if(winHandle==null){
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" >
	  ...
	  <table width="820" border="0" cellpadding="0" cellspacing="0" bordercolor="#4ea1e1" style="border-bottom:solid; border-bottom-color:#4ea1e1" >
	    <tr >
	      <td width="820" height="25">&nbsp;Report- Bin Master </td>
	    </tr></table></td>
...
<table align="center" border="0" cellspacing="0" cellpadding="0" width="750" style="border-collapse:collapse">
  <tr height="25" >
    <td colspan="8" align="center" class="subheading" style="color:#303918; "><?php echo $row_p['perticulars'];?> - Bin List (<?php echo $total_results;?>)<span class="tbltext"> 
      
    </span></td>
  </tr>
  </table>
<table align="center" border="1" cellspacing="0" cellpadding="0" width="443" bordercolor="#4ea1e1" style="border-collapse:collapse">
 
 <tr class="tblsubtitle" height="25">
<td width="52" align="center" class="tblheading" valign="middle">#</td>
<td width="234" align="left" class="tblheading" valign="middle">&nbsp;Bin Number</td>
<td width="149" align="center" class="tblheading" valign="middle">Sub-Bin</td>
</tr>
<?php
//$srno=1;
	...
	$sub_bin_no=$num_v;
	/*$sql_tra=mysqli_query($link,"select * from tblarrival where cropid=".$row['cropid']." and plantcode='$plantcode')or die(mysqli_error($link));
...
<tr >
<td valign="top" align="center"><a href="report_warehouse.php"><img src="../images/back.gif" border="0"style="display:inline;cursor:hand;" /></a>&nbsp;&nbsp;<input name="Submit" type="image" src="../images/printpreview.gif" alt="Submit Value" OnClick="openprint('<?php echo $whid?>')" border="0" style="display:inline;cursor:hand;" tabindex="19"></td>
</tr>
</table>
