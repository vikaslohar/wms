...
<title>Administrator-Master Report -Report - Warehouse Master</title>
...
winHandle=window.open('report_warehouse1.php','WelCome','top=20,left=80,width=820,height=600,scrollbars=yes');
if(winHandle==null){
...
?>
    <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" >
	  ...
	  <table width="820" border="0" cellpadding="0" cellspacing="0" bordercolor="#4ea1e1" style="border-bottom:solid; border-bottom-color:#4ea1e1" >
	    <tr >
	      <td width="820" height="25">&nbsp;Report- Warehouse Master </td>
	    </tr></table></td>
...
?>
          <table align="center" border="0" cellspacing="0" cellpadding="0" width="750" style="border-collapse:collapse">
                  <tr height="25" >
                    <td colspan="8" align="center" class="subheading" style="color:#303918; ">Ware house List (<?php echo $total_results;?>)</td>
                  </tr>
                </table>
...
?>
                  <tr class="Light" height="25">
                    ...
                    <td valign="middle" class="tbltext" align="center"><a href="report_bin.php?whid=<?php echo $row['whid'];?>"><?php echo $bin_no;?></a> </td>
                    <?php
	}
	else
	{ 
...
?>
	...
	$tono=$srno-1;
	echo "<table width='688' align='center' class='tbltext'><tr><td align='left' >$no - $tono of $total_results Records</td><td align='right'>Select a Page    "; 
