...
winHandle=window.open('report_gswarehouse1.php','WelCome','top=20,left=80,width=820,height=600,scrollbars=yes');
if(winHandle==null){
...
?>
    <table  width="800" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" >
	  ...
	  <table width="820" border="0" cellpadding="0" cellspacing="0" bordercolor="#4ea1e1" style="border-bottom:solid; border-bottom-color:#4ea1e1" >
	    <tr >
	      <td width="820" height="25">&nbsp;Report- GS  Warehouse Master </td>
	    </tr></table></td>
...
?>
                  <tr class="Light" height="25">
                    ...
                    <td valign="middle" class="tbltext" align="center"><a href="report_gsbin.php?whid=<?php echo $row['whid'];?>"><?php echo $bin_no;?></a> </td>
