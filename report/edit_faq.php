...
winHandle=window.open('report_faq1.php?department_id=<?php echo $department_id?>','WelCome','top=20,left=80,width=820,height=600,scrollbars=yes');
if(winHandle==null){
...
<tr >
<td valign="top" align="center"><a href="faq_home.php"><img src="../images/back.gif" border="0"  style="display:inline;cursor:hand;" /></a>&nbsp;&nbsp;<input name="Submit" type="image" src="../images/printpreview.gif" alt="" border="0" style="display:inline;cursor:hand;" onclick="openprint();">
  </td>
</tr>
</table>
 <?php// } else { ?>
