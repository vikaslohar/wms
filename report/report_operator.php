  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" >
	  ...
	  <table width="820" border="0" cellpadding="0" cellspacing="0" bordercolor="#4ea1e1" style="border-bottom:solid; border-bottom-color:#4ea1e1" >
	    <tr >
	      <td width="820" height="25">&nbsp;Report- Operator Master </td>
	    </tr></table></td>
...
$total_results = $total_results2[0]; 
	...
	if($total >0) { ?><table align="center" border="0" cellspacing="0" cellpadding="0" width="750" style="border-collapse:collapse">
  <tr height="25" >
    <td colspan="8" align="center" class="subheading" style="color:#303918; ">Operators List (<?php echo $total_results;?>)</td>
  </tr>
  </table>
...
$srno=1;
	...
	{
$sql_p=mysqli_query($link,"SELECT * FROM tblopr where department_id='".$row['department_id']."' and plantcode='".$plantcode."'")or die(mysqli_error($link));
...
<td valign="middle" class="tbltext" align="center"><a href="operator_home.php?department_id=<?php echo $row['department_id'];?>"><?php echo $num_p;?></a></td>
...
<tr >
<td valign="top" align="center"><a href="masterreports.php"><img src="../images/back.gif" border="0"style="display:inline;cursor:pointer;" /></a>&nbsp;&nbsp;<input name="Submit" type="image" src="../images/printpreview.gif" alt="Submit Value" OnClick="openprint()" border="0" style="display:inline;cursor:hand;" tabindex="19"></td>
</tr>
</table>
</form> 
