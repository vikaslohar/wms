...
<title>Administrator-Report - Master Report- Location Master Report</title>
...
winHandle=window.open('report_location1.php?whid='+val,'WelCome','top=20,left=80,width=820,height=600,scrollbars=yes');
if(winHandle==null){
...
<!-- actual page start--->	
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" >
	  ...
	  <td width="840" class="Mainheading" height="25">
	  <table width="813" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" style="border-bottom:solid; border-bottom-color:#4ea1e1" >
	    <tr >
	      <td width="800" height="25">&nbsp;Reports - Location Report </td>
	    </tr></table></td>
	  <td width="110" height="25" align="right" class="submenufont" >
...
<?php
	...
	$sql_sel="select * from tblproductionlocation where plantcode='".$plantcode."' and plantcode='".$plantcode."' order by state, productionlocation ";
	$res=mysqli_query($link,$sql_sel) or die (mysqli_error($link));
	
	$total=mysqli_num_rows($res);
	$total_results3 =mysqli_query($link,"SELECT COUNT(*)  FROM tblproductionlocation WHERE plantcode='".$plantcode."' and plantcode='".$plantcode."'");
