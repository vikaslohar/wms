...
<title>Administrator-Report - Master Report- Country Report</title>
...
winHandle=window.open('report_country1.php?whid='+val,'WelCome','top=20,left=80,width=820,height=600,scrollbars=yes');
if(winHandle==null){
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" >
	  ...
	  <table width="813" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" style="border-bottom:solid; border-bottom-color:#4ea1e1" >
	    <tr >
	      <td width="800" height="25">&nbsp;Reports - Country Report </td>
	    </tr></table></td>
...
<?php
	...
	$sql_sel="select * from tblcountry where plantcode='".$plantcode."' order by country ";
