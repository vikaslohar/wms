<?php
	...
	if(isset($_POST['frm_action'])=='submit')
	{
		...
		$oid = $_POST['txtclass'];
		$state = $_POST['state'];
		$txtorganiser = $_POST['txtorganiser'];
		$txtcrop = $_POST['txtcrop'];
		$txtvariety = $_POST['txtvariety'];
				
		if($sdate!="" && $edate!="")
		{
		echo "<script>window.location='report_arrivalplcvq1.php?sdate=$sdate&edate=$edate&txtclass=$oid&state=$state&txtorganiser=$txtorganiser&txtcrop=$txtcrop&txtvariety=$txtvariety'</script>";
		}
		else
		 {?>
		 <script>
...
<title>Production - Report - Periodical Arrival and Processing Report</title>
...
<script src="locationrep.js"></script>
...
function showlotdest(stateval)
{
	showUser(stateval,'lotdest','lotdesti','','','','','');
}
...
function showorganiser(classval)
{
	var state=document.frmaddDepartment.state.value;
	showUser(classval,'lotorg','lotorganiser',state,'','','','');
}
</script>
...
<table width="1003" height="600" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#ef0388" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" style="border-bottom:solid; border-bottom-color:#ef0388" >
	    <tr >
	      <td width="813" height="30"class="Mainheading"  > Periodical Arrival and Processing Report</td>
	    </tr></table></td>
	  </tr>
	  </table></td></tr>
	  ...
	  <form name="frmaddDepartment" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>" > 
	    <table  border="0" cellspacing="0" cellpadding="0" align="center" width="974"  style="border-collapse:collapse">
          ...
          <tr>
            <td width="30"></td>
            <td><table align="center" border="1" width="574" cellspacing="0" cellpadding="0" bordercolor="#ef0388" style="border-collapse:collapse" >
                <tr class="tblsubtitle" height="25">
                  <td colspan="4" align="center" class="tblheading"> Periodical Arrival and Processing Report </td>
                </tr>
                <tr height="15">
...
<td align="left"  valign="middle" class="tbltext" colspan="3">&nbsp;<select name="state" class="tbltext"  style="width:170px;" tabindex="" onChange="showlotdest(this.value);" >
...
<tr class="Light" height="25">
<td width="318"  align="right"  valign="middle" class="tblheading">&nbsp;Production Location&nbsp; </td>
<td align="left"  valign="middle" colspan="3" id="lotdest">&nbsp;<select class="tbltext" name="txtclass" style="width:170px;" onChange="showorganiser(this.value);"  >
<option value="ALL" >--ALL--</option>
</select>&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
</tr>

<tr class="Light" height="25">
<td width="318"  align="right"  valign="middle" class="tblheading">&nbsp;Production Personnel&nbsp; </td>
<td align="left"  valign="middle" colspan="3" id="lotorg">&nbsp;<select class="tbltext" name="txtorganiser" style="width:170px;"  >
<option value="ALL" >--ALL--</option>
</select>&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
</tr>
<?php
...
<td align="left"  valign="middle" colspan="3">&nbsp;<select class="tbltext" name="txtcrop" style="width:170px;" onChange="modetchk(this.value)">
...
<tr class="Light" height="25">
<td width="318"  align="right"  valign="middle" class="tblheading">&nbsp;Variety&nbsp; </td>
<td align="left"  valign="middle" colspan="3" id="vitem">&nbsp;<select class="tbltext" name="txtvariety" style="width:170px;"  >
<option value="ALL" >--ALL--</option>
</select>&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
</tr>
...
<tr >
<td valign="top" align="center"><input name="Submit" type="image" src="../images/submit_1.gif" alt="Submit Value"  border="0" style="display:inline;cursor:pointer;" onClick="return mySubmit();" /><input type="hidden" name="txtinv" /><input type="hidden" name="flagcode" value=""/><input type="hidden" name="flagcode1" value=""/></td>
</tr>
</table>
</td>
<td ></td>
