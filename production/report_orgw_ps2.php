...
{
if($setlps=="psdone")
	$qry24="select distinct lotcrop from tblarrival_sub where organiser='".$txtpmcode."'  and psflg=1 and plantcode='$plantcode' ";
else if($setlps=="psnotdone")
	$qry24="select distinct lotcrop from tblarrival_sub where organiser='".$txtpmcode."'  and psflg=0 and plantcode='$plantcode' ";
else	
	$qry24="select distinct lotcrop from tblarrival_sub where organiser='".$txtpmcode."' and plantcode='$plantcode'  ";	
...
if($setlps=="psdone")
	$qry23="select distinct lotvariety from tblarrival_sub where organiser='".$txtpmcode."' and lotcrop='".$row_arr_home24['lotcrop']."' and psflg=1 and plantcode='$plantcode' ";
else if($setlps=="psnotdone")
	$qry23="select distinct lotvariety from tblarrival_sub where organiser='".$txtpmcode."' and lotcrop='".$row_arr_home24['lotcrop']."' and psflg=0 and plantcode='$plantcode' ";
else
	$qry23="select distinct lotvariety from tblarrival_sub where organiser='".$txtpmcode."' and lotcrop='".$row_arr_home24['lotcrop']."' and plantcode='$plantcode' ";
...
$arid='';
	if($setlps=="psdone")
	$qry2="select arrival_id from tblarrival_sub where organiser='".$txtpmcode."' and lotcrop='".$row_arr_home24['lotcrop']."' and lotvariety='".$row_arr_home23['lotvariety']."' and sstage='Raw' and psflg=1 and plantcode='$plantcode'";
else if($setlps=="psnotdone")
	$qry2="select arrival_id from tblarrival_sub where organiser='".$txtpmcode."' and lotcrop='".$row_arr_home24['lotcrop']."' and lotvariety='".$row_arr_home23['lotvariety']."' and sstage='Raw' and psflg=0 and plantcode='$plantcode'";
else
...
<?php
$qry="select arrival_id, arrival_date from tblarrival where arrival_type='Fresh Seed with PDN' and arrtrflag=1 and plantcode='$plantcode' and arrival_id IN($arid)";
...
<tr class="tblsubtitle" height="20">
  ...
  <td width="50" align="center" valign="middle" class="smalltblheading" >Days</td>
			...
			<td width="105" align="center" valign="middle" class="smalltblheading">Prod. Personel</td>
			 ...
			 <td width="40"  align="center" valign="middle" class="smalltblheading" >PS</td>
             </tr>
...
if($setlps=="psdone")
	$sql_rr=mysqli_query($link,"select * from tblarrival_sub where arrival_id='".$row_arr_home1['arrival_id']."' and organiser='".$txtpmcode."' and lotcrop='".$row_arr_home24['lotcrop']."' and lotvariety='".$row_arr_home23['lotvariety']."' and sstage='Raw' and psflg=1 and plantcode='$plantcode' order by orlot asc") or die(mysqli_error($link));
else if($setlps=="psnotdone")
	$sql_rr=mysqli_query($link,"select * from tblarrival_sub where arrival_id='".$row_arr_home1['arrival_id']."' and organiser='".$txtpmcode."' and lotcrop='".$row_arr_home24['lotcrop']."' and lotvariety='".$row_arr_home23['lotvariety']."' and sstage='Raw' and psflg=0 and plantcode='$plantcode' order by orlot asc") or die(mysqli_error($link));
else
...
if($row_rr['psflg']==1)
$ps="<img src='../images/tick1.png' width='45%' />";
else
$ps="<img src='../images/delete.png' width='30%' />";
...
<tr class="Light">
  ...
  <td width="50" align="center" valign="middle" class="smallesttbltext"><?php echo $diff;?></td>
			...
			<td align="center" valign="middle" class="smallesttbltext"><?php echo $ps?></td>
</tr>
<?php
}
else
...
<table width="850" border="0" cellpadding="0" cellspacing="0" bordercolor="#ffffff" style="border-collapse:collapse" align="center">
<tr >
<td width="924" align="right">&nbsp;&nbsp;<img src="../images/Vista-printer.png" border="0" class="butn" height="29" width="35" alt="Print" style="display:inline;cursor:pointer;" onclick="javascript:window.print();" />&nbsp;&nbsp;<a href="excel-orgwps.php?txtcrop=<?php echo $crop;?>&sdate=<?php echo $_REQUEST['sdate'];?>&edate=<?php echo $_REQUEST['edate'];?>&txtvariety=<?php echo $_REQUEST['txtvariety'];?>&txtpmcode=<?php echo $_REQUEST['txtpmcode'];?>" target="_blank"><img src="../images/excelicon1.jpg" border="0" height="30" width="30" class="butn" alt="Export to Excel" style="display:inline;cursor:pointer;" /></a>&nbsp;&nbsp;<img src="../images/close_icon2.jpg" border="0" class="butn" height="30"  alt="Close" style="display:inline;cursor:pointer;" onClick="window.close()" />&nbsp;</td>
</tr>
</table>