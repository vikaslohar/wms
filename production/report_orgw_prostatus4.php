...
{	
	$qry24="select distinct lotcrop from tblarrival_sub where organiser='".$txtpmcode."' and lotcrop='".$crp."' and lotvariety='".$ver."' and plantcode='$plantcode'  and sstage='Raw' order by lotcrop";
}
