...
$cnt=1;
$qry="select arrival_id, arrival_date, yearcode from tblarrival where arrival_date <='".$edate."' and arrival_date >='".$sdate."' and arrival_type='Fresh Seed with PDN' and arrtrflag=1 and plantcode='$plantcode' ";
$sql_arr_home1=mysqli_query($link,$qry) or die(mysqli_error($link));
$tot_arr_home=mysqli_num_rows($sql_arr_home1);
	
$datahead3= array("Date of Arrival","FRN No.","Lot No.","Prod. Location","Prod. Personel","Organiser","Farmer","Crop","Type","PDN Qty","Arrival Qty","Raw Seed Qty","Condition Seed Qty","Cond. Loss (RM + IM)","Date of Processing","GOT Result","DOGR","Germination %","Genetic Purity %"); 
...
if($tot_rr > 0)
{
$data1[$d]=array($trdate1,$frn,$lotno1,$ploc,$pper,$orgniser,$farmer,$crpnm,$vernm,$pqty,$arrqty,$rswqty,$cswqty,$tplqty,$prsldate,$gotr,$dogr,$gemp,$genpurity); 
$d++;$cntt++;
}
}
}
