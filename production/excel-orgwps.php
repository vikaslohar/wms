...
$datahead3[$cnt] = array("Date of Arrival","Days","FRN No.","Lot No.","Prod. Location","Prod. Personel","Farmer","PDN Qty","Arrival Qty","Raw Seed Qty","Condition Seed Qty","Cond. Loss (RM + IM)","Date of Processing","GOT Result","DOGR","Physical Purity","Germination %","Genetic Purity %","PS"); 
...
if($flg>0)
{
$data1[$cnt][$d]=array($trdate1,$diff,$frn,$lotno1,$ploc,$pper,$farmer,$pqty,$arrqty,$rswqty,$cswqty,$tplqty,$prsldate,$gotr,$dogr,$seedsstatus,$gemp,$genpurity,$ps); 
$d++;$cntt++;
}
}
