...
var setlps=document.frmaddDepartment.setlps.value;
winHandle=window.open('report_orgw_ps2.php?sdate='+sdate+'&txtcrop='+itemid+'&txtvariety='+vv+'&edate='+edate+'&txtpmcode='+pmc+'&setlps='+setlps,'WelCome','top=20,left=80,width=850,height=600,scrollbars=yes');
if(winHandle==null){
...
?>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#ef0388" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#ef0388" style="border-bottom:solid; border-bottom-color:#ef0388" >
	    <tr >
	      <td width="813" height="25">&nbsp;Organiser wise Settlement Status Report</td>
	    </tr></table></td>
	  </tr>
	  </table></td></tr>
	  ...
	  <td align="center" colspan="4" >
		...
		<input name="txtpmcode" value="<?php echo $txtpmcode;?>" type="hidden">  
		 ...
		 <input name="setlps" value="<?php echo $_REQUEST['setlps'];?>" type="hidden"> 
...
$arid='';
if($setlps=="psdone")
	$qry2="select arrival_id from tblarrival_sub where organiser='".$txtpmcode."' and lotcrop='".$row_arr_home24['lotcrop']."' and lotvariety='".$row_arr_home23['lotvariety']."' and sstage='Raw' and plantcode='$plantcode' and psflg=1";
else if($setlps=="psnotdone")
	$qry2="select arrival_id from tblarrival_sub where organiser='".$txtpmcode."' and lotcrop='".$row_arr_home24['lotcrop']."' and lotvariety='".$row_arr_home23['lotvariety']."' and sstage='Raw' and plantcode='$plantcode' and psflg=0";
else
...
{
if($setlps=="psdone")
	$sql_rr=mysqli_query($link,"select * from tblarrival_sub where arrival_id='".$row_arr_home1['arrival_id']."' and organiser='".$txtpmcode."' and lotcrop='".$row_arr_home24['lotcrop']."' and lotvariety='".$row_arr_home23['lotvariety']."' and sstage='Raw' and plantcode='$plantcode' and psflg=1 order by orlot asc") or die(mysqli_error($link));
else if($setlps=="psnotdone")
	$sql_rr=mysqli_query($link,"select * from tblarrival_sub where arrival_id='".$row_arr_home1['arrival_id']."' and organiser='".$txtpmcode."' and lotcrop='".$row_arr_home24['lotcrop']."' and lotvariety='".$row_arr_home23['lotvariety']."' and sstage='Raw' and plantcode='$plantcode' and psflg=0 order by orlot asc") or die(mysqli_error($link));
else
