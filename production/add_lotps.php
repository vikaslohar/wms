<?php
	...
	if(isset($_POST['frm_action'])=='submit')
	{
		...
		echo "<script>window.location='add_lotps1.php?sdate=$sdate&edate=$edate&txtcrop=$cid&txtvariety=$itemid&txtpmcode=$txtpmcode'</script>";
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#ef0388" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#ef0388" style="border-bottom:solid; border-bottom-color:#ef0388" >
	    <tr >
	      <td width="813" height="30"class="Mainheading"  >Transaction - Settlement</td>
	    </tr></table></td>
	  </tr>
	  </table></td></tr>
...
<?php
$zzss="";
$sql_sel1="select distinct organiser from tblarrival_sub where organiser!='$zzss' and organiser!='NULL' order by organiser asc";
