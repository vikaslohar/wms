<?php
	...
	$dh="Periodical_Party_wise_Sales_Return_Report";
	$datahead = array("Periodical Party wise Sales Return Report");
	$filename=$dh.".xls";  
	...
	$datahead2 = array("State: ",$txtstatesl,"Location: ",$location,"Party: ",$pty);
...
$sql_srretsub=mysqli_query($link,"select * from tbl_salesrv_sub where salesrs_variety='".$row_srrets['salesrs_variety']."' and plantcode='$plantcode' and salesrs_vflg=1") or die(mysqli_error($link));
