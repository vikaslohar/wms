<?php
	...
	if(isset($_POST['frm_action'])=='submit')
	{
		...
		//exit;
		echo "<script>window.location='home_packslipfc.php'</script>";	
	}
?>
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#1dbe03" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#1dbe03" style="border-bottom:solid; border-bottom-color:#1dbe03" >
	    <tr >
	      <td width="813" height="25" class="Mainheading">&nbsp;Transaction - Packing slip (Field Crop) - Preview </td>
	    </tr></table></td>
...
<tr class="tblsubtitle" height="20">
  <td colspan="8" align="center" class="tblheading">Packing Slip (Field Crop) Preview</td>
</tr>
...
<tr class="tblsubtitle" height="20">
	...
	<td width="7%" align="center" valign="middle" class="smalltblheading">NoP in MP </td>
