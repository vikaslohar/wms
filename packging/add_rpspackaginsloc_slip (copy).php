	...
	if(isset($_POST['frm_action'])=='submit')
	{
		...
		if($z1>0)
		{
			...
			for($j=1; $j<=$sno3; $j++)
			{
				...
				{
					$sql_subsub4="insert into tbl_rpspackagingsub_sub (packagingsub_id, packaging_id, packagingsubsub_wh, packagingsubsub_bin, packagingsubsub_subbin, packagingsubsub_lotno, packagingsubsub_upssize, packagingsubsub_nomp, packagingsubsub_nopch, packagingsubsub_totpch, packagingsubsub_totqty, plantcode, packagingsubsub_loosewb) values ('$suid', '$mainid', '$txtwhg', '$txtbing', '$txtsubbg', '$lotno', '$upss', '$nopmpcs', '$noppchs', '$noptpchs', '$noptqtys', '$plantcode', '$loosewb')";
...
<tr class="Light" height="25">  
  ...
  <td  align="center"  valign="middle" class="smalltbltext" ><input name="loosepouches" id="loosepouches" type="text" size="7" class="smalltbltext" tabindex=""   maxlength="7" onkeypress="return isNumberKey1(event)"  value="<?php echo $loosepouches;?>" />&nbsp;</td>
 ...
 <td width="72" align="center" valign="middle" class="tbltext" id="gwupdate" ><?php if($grwtflg>0){?><a href="Javascript:void(0);" onclick="uploadgw();">Upload</a> <?php } if($grwtflg==0){ ?>Updated<?php } ?> </td>
