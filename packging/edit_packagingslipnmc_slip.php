<?php
	...
	if(isset($_POST['frm_action'])=='submit')
	{
		...
		echo "<script>window.location='add_packagingslipnmc_preview.php?p_id=$p_id'</script>";	
	}
...
<title>Packaging - Transaction - Packaging slip - NMC</title>
...
{	
	...
	{	
		...
		//alert(a);
		showUser(a,'postingtable','mformnmc','','','','','');
		}  
	}
}
...
{	
	...
	{	
		...
		var a=formPost(document.getElementById('mainform'));
		//alert(a);
		showUser(a,'postingtable','mformsubedtnmc','','','','','');
		}
	}
}
...
winHandle=window.open('getuser_packagingslipnmc_lotno.php?crop='+crop+'&variety='+variety+'&stage='+stage+'&tid='+tid+'&dop='+dop,'WelCome','top=170,left=180,width=420,height=350,scrollbars=yes');
if(winHandle==null){
...
showUser(edtrecid,'postingsubtable','subformedtnmc','','','','','');
}
...
if(document.frmaddDepartment.txtlot1.value=="")
		...
		showUser(get,'postingsubsubtable','getnmc',crop,variety,tid,lotid,dsrn,stage);
...
function deleterec(v1,v2)
{
	...
	{
		showUser(v1,'postingtable','deletenmc',v2,'','','','');
	}
	else
	{
		return false;
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#1dbe03" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#1dbe03" style="border-bottom:solid; border-bottom-color:#1dbe03" >
	      <td width="813" height="25" class="Mainheading">&nbsp;Transaction - Packaging slip - NMC&nbsp;<input type="hidden" name="logid" value="<?php echo $logid?>" /></td>
	    </tr></table></td>
	  </tr>
	  </table></td></tr>
...
<tr class="tblsubtitle" height="20">
  <td colspan="8" align="center" class="tblheading">Edit Packaging Slip - NMC</td>
</tr>
...
<tr >
<td valign="top" align="right"><a href="home_packaging_nmc.php" tabindex="20"><img src="../images/cancel.gif" border="0"style="display:inline;cursor:Pointer;" onclick="return confirm('Do You wish to Cancel this Transaction?');" /></a>&nbsp;&nbsp;<input name="Submit" type="image" src="../images/preview.gif" alt="Submit Value"  border="0" style="display:inline;cursor:Pointer;" tabindex="" onClick="return mySubmit();">&nbsp;&nbsp;</td>
</tr>
</table>
