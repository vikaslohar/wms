...
<td align="center" valign="middle" class="tblheading">NoP in MP</td>
...
<td width="155" align="center" valign="middle" class="tbltext">&nbsp;<input type="text" size="6" maxlength="6" name="upsval_<?php echo $sno?>" id="upsval_<?php echo $sno?>" value="" onkeypress="return isNumberKey(event)" onchange="upck(this.value,'1')"  />&nbsp;
  <select name="upssizetyp_<?php echo $sno?>" id="upssizetyp_<?php echo $sno?>" style="size:50px" onchange="updmerg(this.value,'1');">
    <option selected="selected" value="">Select</option>
    <option  value="Kgs">Kgs.</option>
    <option value="Gms">Gms.</option>
  </select>
  <input type="hidden" name="upsname_<?php echo $sno?>" id="upsname_<?php echo $sno?>" value="" /></td>
...
<td width="55" align="center" valign="middle" class="tbltext"><input type="text" name="nopinwb_<?php echo $sno?>2" id="nopinwb_<?php echo $sno?>2" size="7" maxlength="7" class="tbltext" value=""  onchange="calnopinwb(this.value)" onkeypress="return isNumberKey1(event)"  /></td>
...
<tr class="tblsubtitle" height="25">
	...
	<td align="left" valign="middle" class="tblheading">&nbsp;NoP in MP</td>
...
<td width="887" align="left" valign="middle" class="tbltext">&nbsp;<?php echo $mptnop;?><input type="hidden" name="nowbinmp_<?php echo $sno?>" id="nowbinmp_<?php echo $sno?>" class="tbltext" value="<?php echo $mptnop;?>"   /></td>
