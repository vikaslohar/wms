<?php
	...
	if(isset($_POST['frm_action'])=='submit')
	{
		...
		if($subflg==0)
		{
			...
			$pnpslipmain_dop=$row_arr['pnpslipmain_dop'];
			if($pnpslipmain_dop=="0000-00-00"){$pnpslipmain_dop=$pnpslipmdt;}
			...
			while($row_arrsub=mysqli_fetch_array($sql_arrsub))
			{
				...
				$sql_barcode2=mysqli_query($link,"Select distinct wb_mpbarcode from tbl_wbqrcode where wb_lotno='".$row_arrsub['pnpslipsub_plotno']."' and wb_pnptrid='".$pid."'") or die(mysqli_error($link));
				...
				if($tot_barcode2 > 0)
				{
					while($row_barcode2=mysqli_fetch_array($sql_barcode2))
					{
						...
						{
						$sql_barcode1=mysqli_query($link,"select * from tbl_wbqrcode where wb_lotno='".$row_arrsub['pnpslipsub_plotno']."' and wb_pnptrid='".$pid."' and  wb_mpbarcode='".$row_barcode2['wb_mpbarcode']."'") or die(mysqli_error($link));
						$row_barcode1=mysqli_fetch_array($sql_barcode1); 
						
						
						$barcode=$row_barcode2['wb_mpbarcode'];
						$grosswt=$row_barcode1['wb_mpgrosswt'];
						$wblinkdt=$row_barcode1['wb_linkdate'];
				...
				$tot_isstblman=mysqli_num_rows($sql_issue1);
				if($tot_isstblman==0)
				{
					...
					while($row_issuetbl22=mysqli_fetch_array($sql_issuetbl22))
					{
						...
						$srflg2=$row_issuetbl22['lotldg_srflg'];
						 ...
						 if($srtype=="Condition" || $srtype=="condition"){ $srtype=""; $srflg=0;}
						  $sql_ins_main22="insert into tbl_lot_ldg (yearcode,lotldg_trtype, lotldg_trid, lotldg_trdate, lotldg_lotno, lotldg_crop, lotldg_variety, lotldg_whid, lotldg_binid, lotldg_subbinid, lotldg_opbags, lotldg_opqty, lotldg_trbags, lotldg_trqty, lotldg_balbags, lotldg_balqty, lotldg_sstage, lotldg_sstatus, lotldg_moisture, lotldg_gemp, lotldg_vchk, lotldg_got1, lotldg_qc, lotldg_got, lotldg_qctestdate, lotldg_gottestdate, orlot, lotldg_gs, lotldg_resverstatus, lotldg_revcomment, lotldg_genpurity, lotldg_srtyp, lotldg_srflg, plantcode) values('$yearcode2','PNPSLIPSUC', '$pid', '$dt', '$packlotno', '$crop', '$variety', '$whid2', '$binid2', '$subbinid2', '$onob2', '$oqty2', '$nob12', '$qty12', '$balups2', '$balqty2', '$sstage2', '$sstatus2', '$moist2', '$gemp2', '$vchk2', '$got12', '$qc2', '$gotstatus2', '$qctestdate2', '$gottestdate2', '$orlot2', '$gs2', '$resverstatus2', '$revcomment2', '$geneticpurity2', '$srtype', '$srflg', '$plantcode')";
						//exit;
			...
			$res_code1=mysqli_query($link,$sql_code1)or die(mysqli_error($link));
			 ...
			 $sql_main="update tbl_pnpslipmain set pnpslipmain_tflag=1, pnpslipmain_tcode=$ncode1, pnpslipmain_date='$dt'  where pnpslipmain_id ='$pid'";
		...
		//exit;
		echo "<script>window.location='home_packslipwb.php'</script>";	
	}
?>
...
<tr class="tblsubtitle" height="20">
  <td colspan="8" align="center" class="tblheading">Packing Slip (Window Box) Preview</td>
</tr>
...
<tr class="tblsubtitle" height="20">
	...
	<td width="5%" colspan="1" align="center" valign="middle" class="smalltblheading">NoWB in MP</td>
	<td width="5%" align="center" valign="middle" class="smalltblheading">MPWT</td>
	<td width="5%" align="center" valign="middle" class="smalltblheading">Pack Details</td>
...
<tr class="Light" height="20">
	...
	<td align="center" valign="middle" class="smalltbltext"><?php echo $row_tbl_sub['pnpslipsub_wbnop'];?></td>
	<td align="center" valign="middle" class="smalltbltext"><?php echo $row_tbl_sub['pnpslipsub_wbwt'];?></td>
	<td align="center" valign="middle" class="smalltbltext"><?php echo $row_tbl_sub['pnpslipsub_wbinmp'];?></td>
	<td align="center" valign="middle" class="smalltbltext"><?php echo $row_tbl_sub['pnpslipsub_wtmp'];?></td>
	...
	<td align="center" valign="middle" class="smalltbltext"><?php if($row_tbl_sub['pnpslipsub_remarks']!=""){ ?><a href="Javascript:void(0)" title="<?php echo $row_tbl_sub['pnpslipsub_remarks'];?>"  onclick="openremarks('<?php echo $row_tbl_sub['pnpslipsub_remarks']?>')"  >Details</a><?php } ?></td>
	</tr>
  <?php
}
else
