<?php
	...
	if(isset($_POST['frm_action'])=='submit')
	{
		...
		echo "<script>window.location='add_packslip_mu_preview.php?p_id=$p_id'</script>";	
	}

	$sql_code="SELECT MAX(pnpslipmain_code) FROM tbl_pnpslipmain where pnpslipmain_ttype='Packing Slip MU' and yearid='$yearid_id'  ORDER BY pnpslipmain_code DESC";
...
<script src="packingslip_mu.js"></script>
...
<tr >
<td valign="top" align="right"><a href="home_packslip_mu.php" tabindex="20"><img src="../images/cancel.gif" border="0"style="display:inline;cursor:Pointer;" onclick="return confirm('Do You wish to Cancel this Transaction?');" /></a>&nbsp;&nbsp;<input name="Submit" type="image" src="../images/preview.gif" alt="Submit Value"  border="0" style="display:inline;cursor:Pointer;" tabindex="" onClick="return mySubmit();">&nbsp;&nbsp;</td>
</tr>
</table>
