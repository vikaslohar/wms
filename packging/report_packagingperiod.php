<?php
	...
	if(isset($_POST['frm_action'])=='submit')
	{
		...
		$withreprint=trim($_POST['withrpt']);	
		//exit;
		if($sdate!="")
		{
			echo "<script>window.location='report_packagingperiod1.php?sdate=$sdate&edate=$edate&txtcrop=$txtcrop&txtvariety=$txtvariety&txtupsdc=$txtupsdc&withreprint=$withreprint'</script>";
		}
		else
		{
		?>
...
{	
	showUser(classval,'vitem2','itemups2','','','','','');
}
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#1dbe03" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#1dbe03" style="border-bottom:solid; border-bottom-color:#1dbe03" >
	    <tr >
	      <td width="813" height="30"class="Mainheading"  >&nbsp;Periodical Packaging Report (LMC/NLC/MMC)</td>
	    </tr></table></td>
	  </tr>
	  </table></td></tr>
...
<table align="center" border="1" width="550" cellspacing="0" cellpadding="0" bordercolor="#1dbe03" style="border-collapse:collapse" >
                <tr class="tblsubtitle" height="25">
                  <td colspan="4" align="center" class="tblheading" >Periodical Packaging Report</td>
                </tr>
                <tr height="15">
...
<option value="ALL" selected>--ALL--</option>
<?php 	
	$sql_ups=mysqli_query($link,"Select * from tblups order by uom ASC") or die(mysqli_error($link));
	...
	<td align="right"  valign="middle" class="tblheading" colspan="2" >Packaging Type&nbsp;</td>
    <td align="left"  valign="middle" class="tbltext" colspan="2">&nbsp;<select class="tbltext" id="withrpt" name="withrpt" style="width:70px;" >
<option value="ALL" selected>--ALL--</option>
...
<table align="center" border="0" cellspacing="0" cellpadding="0" width="550" bordercolor="#1dbe03" style="border-collapse:collapse">
<tr >
	<td align="left" class="smalltbltext" style="color:#303918;"><font color="#FF0000"><b>Note:</b></font> 1. This is NOT a Stock Report</td>
</tr>
<tr >
	<td align="left" class="smalltbltext" style="color:#303918;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 2. This report will be generated for only Packaging Activity for the selected period</td>
</tr>
<tr >
