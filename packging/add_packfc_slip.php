<?php
	...
	if(isset($_POST['frm_action'])=='submit')
	{
		...
		$p_id=$z1;
		echo "<script>window.location='add_packslipfc_preview.php?p_id=$p_id'</script>";	
	}
...
<script src="packingslipfc.js"></script>
...
//alert(variety);
winHandle=window.open('getuser_packslipfc_lotno.php?crop='+crop+'&variety='+variety+'&stage='+stage+'&tid='+tid+'&dop='+dop,'WelCome','top=170,left=180,width=420,height=350,scrollbars=yes');
if(winHandle==null){
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#1dbe03" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#1dbe03" style="border-bottom:solid; border-bottom-color:#1dbe03" >
	      <td width="813" height="25" class="Mainheading">&nbsp;Transaction - Packing slip (Field Crop)&nbsp;<input type="hidden" name="logid" value="<?php echo $logid?>" /></td>
	    </tr></table></td>
	  </tr>
	  </table></td></tr>
...
<tr class="tblsubtitle" height="20">
  <td colspan="8" align="center" class="tblheading">Add Packing Slip (Field Crop) </td>
</tr>
...
<td width="319" align="left" valign="middle" class="smalltbltext">&nbsp;<input name="doind" id="doind" type="text" size="10" class="smalltbltext" tabindex="0" value="<?php echo date("d-m-Y");?>" readonly="true"  style="background-color:#CCCCCC" maxlength="10"/>&nbsp;<!--<a href="javascript:void(0)" onClick="datesel('dopc')" tabindex="6"><img src="../images/cal.gif" border="0" align="absmiddle" /></a>-->&nbsp;<font color="#FF0000">*</font></td>
...
<td width="165" align="left"  valign="middle" class="smalltbltext">&nbsp;<input name="txtindent" type="text" size="15" class="smalltbltext" tabindex=""    maxlength="15" />&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
...
<td width="165"  align="left" valign="middle" class="smalltbltext"  >&nbsp;<select class="smalltbltext" id="txtstage" name="txtstage" style="width:150px;" onchange="modetchk1();" >
...
<td align="left" width="273" valign="middle" class="smalltbltext" style="border-color:#1dbe03">&nbsp;<input name="txtpktype" type="radio" class="smalltbltext" tabindex="" value="Standard" onclick="ptselect(this.value)" />&nbsp;Standard&nbsp;<input name="txtpktype" type="radio" class="smalltbltext" tabindex="" value="Non-standard" onclick="ptselect(this.value)" />&nbsp;Non-standard<font color="#FF0000">*</font>&nbsp;<input type="hidden" name="txtpacktype" value="" /></td>
<td align="right" width="93" valign="middle" class="smalltblheading" style="border-color:#1dbe03">&nbsp;Lot No.&nbsp;</td>
<td align="left" width="200" valign="middle" class="smalltbltext" style="border-color:#1dbe03">&nbsp;
  <input name="txtlot1" type="text" size="20" class="smalltbltext" tabindex=""  maxlength="20"  value="" readonly="true" style="background-color:#CCCCCC" >&nbsp;<font color="#FF0000">*</font>&nbsp;<a href="Javascript:void(0);" onclick="openslocpop();">Select</a></td>
<td align="left" width="272" valign="middle" class="smalltblheading" style="border-color:#1dbe03">&nbsp;<a href="javascript:void(0);" onclick="getdetails();" >Get details</a></td>
</tr>
</table>
...
<tr >
<td valign="top" align="right"><a href="home_packslipfc.php" tabindex="20"><img src="../images/cancel.gif" border="0"style="display:inline;cursor:Pointer;" onclick="return confirm('Do You wish to Cancel this Transaction?');" /></a>&nbsp;&nbsp;<!--<input name="Submit" type="image" src="../images/preview.gif" alt="Submit Value"  border="0" style="display:inline;cursor:Pointer;" tabindex="" onClick="return mySubmit();">&nbsp;&nbsp;--></td>
</tr>
</table>
