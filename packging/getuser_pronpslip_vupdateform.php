...
if(isset($_GET['slocssyncs24'])) { $slocssyncs24= $_GET['slocssyncs24']; } else {$slocssyncs24='';}
...
for ($i=1; $i<=$sno; $i++)
{
	if($upssize==$i)
	{
		...
		$lodednompx="lodednomp_".$i;
		if(isset($_GET[$lodednompx])) { $lodednomps= $_GET[$lodednompx]; }
		$pouchesx="pouches_".$i;
		if(isset($_GET[$pouchesx])) { $pouches= $_GET[$pouchesx]; }
		$upsnamex="upsname_".$i;
		if(isset($_GET[$upsnamex])) { $upsname= $_GET[$upsnamex]; }
	}
}	
...
$zz=str_split($txtlot1);
 $orlot=$zz[0].$zz[1].$zz[2].$zz[3].$zz[4].$zz[5].$zz[6].$zz[7].$zz[8].$zz[9].$zz[10].$zz[11].$zz[12].$zz[13].$zz[14].$zz[15];
	...
	$z1=$maintrid;
		...
		/*$sqlvsriety=mysqli_query($link,"Select * from tblvariety where varietyid='".$txtvariety."' and actstatus='Active'") or die(mysqli_error($link));
...
if($z1 == 0)
{
   $sql_main="insert into tbl_pnpslipmain(pnpslipmain_code, pnpslipmain_date, pnpslipmain_proslipno,  pnpslipmain_crop, pnpslipmain_variety, pnpslipmain_stage, pnpslipmain_promachcode, pnpslipmain_proopr, pnpslipmain_treattype, pnpslipmain_ttype, logid, yearid, pnpslipmain_dop, pnpslipmain_tflag, plantcode) values ('$txtid','$tdate1','$txtpsrn','$txtcrop','$txtvariety','$txtstage', '$txtpromech', '$txtoprname', '$txttreattyp', '$ttype', '$logid', '$yearid_id', '$tdate2', 2, '$plantcode')";
if(mysqli_query($link,$sql_main) or die(mysqli_error($link)))
{
$mainid=mysqli_insert_id($link);

$sql_sub="insert into tbl_pnpslipsub (pnpslipsub_lotno, pnpslipmain_id, pnpslipsub_onob, pnpslipsub_oqty, pnpslipsub_processtype, pnpslipsub_pnob, pnpslipsub_pqty , pnpslipsub_bnob, pnpslipsub_bqty, pnpslipsub_connob, pnpslipsub_conqty, pnpslipsub_rm, pnpslipsub_im, pnpslipsub_pl, pnpslipsub_rpl, pnpslipsub_tlqty, pnpslipsub_tlper, pnpslipsub_packtype, pnpslipsub_availpnob, pnpslipsub_availpqty, pnpslipsub_pickpqty, pnpslipsub_packloss, pnpslipsub_packcc, pnpslipsub_packqty, pnpslipsub_balcnob, pnpslipsub_balcqty, pnpslipsub_ups, pnpslipsub_upsid, pnpslipsub_qty, pnpslipsub_nop, pnpslipsub_lblschar, pnpslipsub_lblsno, pnpslipsub_lbechar, pnpslipsub_lbeno, pnpslipsub_lblschar2, pnpslipsub_lblsno2, pnpslipsub_lbechar2, pnpslipsub_lbeno2, pnpslipsub_convtomp, pnpslipsub_nomp, pnpslipsub_balpouch, pnpslipsub_nobarcodes, pnpslipsub_remarks, pnpslipsub_sstatus, pnpslipsub_orlot, pnpslipsub_valperiod, pnpslipsub_valupto, pnpslipsub_qc, pnpslipsub_qcdot, pnpslipsub_qcdttype, pnpslipsub_sltyp, pnpslipsub_clotno, pnpslipsub_plotno, pnpslipsub_wtmp, pnpslipsub_mptnop, plantcode) values ('$txtlot1', '$mainid', '$txtonob', '$txtoqty', '$protyp', '$pnob', '$pqty', '$txtbalnobp1', '$txtbalqtyp1', '$txtconnob', '$txtconqty', '$txtconrem', '$txtconim', '$pl', '$rpl', '$txtconloss', '$txtconper', '$pcktype', '$avlnobpck', '$avlqtypck', '$picqtyp', '$pckloss', '$ccloss', '$balpck', '$balcnob', '$balcqty', '$upss', '$upsidno', '$packqty', '$nopc', '$domcs_1', '$lbls_1', '$domcs_1', '$lble_1', '$domcs_2', '$lbls_2', '$domcs_2', '$lble_2', '$mpck', '$nomp', '$noofpcks', '$detmpbno', '$txtremarks', '$softstatus', '$orlot', '$validityperiod', '$tdate3', '$qcstatus', '$tdate4', '$qcdttype', '$slocssyncs24', '$txtclotno', '$txtplotno', '$wtmp', '$wtnop', '$plantcode')";
...
<td width="114" align="center" valign="middle" class="tbltext"><input type="text" name="pouches_<?php echo $sno?>" id="pouches_<?php echo $sno?>" size="5"  maxlength="7" class="tbltext" value=""  onkeypress="return isNumberKey1(event)" onchange="poucheschk(this.value,<?php echo $sno?>);"  />&nbsp;<font color="#FF0000" >* </font>&nbsp;</td>
...
<tr class="light" height="25">
	...
	<td width="134" align="left" valign="middle" class="tblheading">&nbsp;<input name="dobg" id="dobg" type="text" size="10" class="smalltbltext" tabindex="0" value="<?php echo date("d-m-Y");?>" maxlength="10" readonly="true" style="background-color:#ECECEC" />&nbsp;<a href="javascript:void(0)" onClick="showCalendar('dobg')" tabindex="6"><img src="../images/cal.gif" border="0" align="absmiddle" /></a>&nbsp;<font color="#FF0000">*</font></td>
<?php
...
?>
	...
	<td width="159" align="left" valign="middle" class="tblheading">&nbsp;<select name="operatorcode" class="tbltext" style="size:100px"  >
	...
	<td width="163" align="left" valign="middle" class="tblheading">&nbsp;<select name="wtmaccode" class="tbltext" style="size:100px" onchange="chkwtfileval(1);"  >
	<option value="" selected="selected">Select</option>
	<?php while($row2=mysqli_fetch_array($query2)) {?>
	<option value="<?php echo $row2['wtmac_mac'].$row2['wtmac_macid'];?>"><?php echo $row2['wtmac_mac'].$row2['wtmac_macid'];?></option>
	<?php } ?>
	</select>&nbsp;<font color="#FF0000">*</font></td>
</tr>
<tr class="light" height="25">
	<td align="right" valign="middle" class="tblheading">Gross Weight Range&nbsp;</td>
	<td align="left" valign="middle" class="tblheading" colspan="5">&nbsp;Min.&nbsp;&nbsp;<input type="text" name="wtrangefr" class="tbltext" value="" size="4" maxlength="6"  />&nbsp;&nbsp;Max.&nbsp;&nbsp;<input type="text" name="wtrangeto" class="tbltext" value="" size="4" maxlength="6"  />&nbsp;in Kgs.</td>
</tr>
<tr class="light" height="25">
    ...
    <td align="left" valign="middle" class="tblheading">&nbsp;<?php $quer3=mysqli_query($link,"SELECT dom_mcode FROM tbl_rm_dommac where plantcode='$plantcode' order by dom_mcode Asc"); ?>
        <select class="smalltbltext" name="domcs_1" id="domcs_1" style="width:40px;" onchange="domcchk(this.value, 1)">
          ...
          <option value="<?php echo $noticia['dom_mcode'];?>" />  
          <?php echo $noticia['dom_mcode'];?>
          <?php } ?>
        </select>&nbsp;<font color="#FF0000" >* </font>&nbsp;<input type="text" name="lbls_1" id="lbls_1" size="5" maxlength="7" class="tbltext" value="" onkeypress="return isNumberKey1(event)" onchange="domchk(1);"  />&nbsp;<font color="#FF0000" >* </font>&nbsp;</td>
    <td width="114" align="center" valign="middle" class="tbltext"><input type="text" name="domce_1" id="domce_1" class="tbltext" size="1" maxlength="1" readonly="true" disabled="disabled" style="background-color:#CCCCCC" value="" />&nbsp;<input type="text" name="lble_1" id="lble_1" size="5"  maxlength="7" class="tbltext" value=""  onkeypress="return isNumberKey1(event)" onchange="domchk1(this.value, 1)" />&nbsp;<font color="#FF0000" >* </font>&nbsp;</td>
    ...
    <td align="left" valign="middle" class="tblheading">&nbsp;<?php $quer33=mysqli_query($link,"SELECT dom_mcode FROM tbl_rm_dommac where plantcode='$plantcode' order by dom_mcode Asc"); ?>
        <select class="smalltbltext" name="domcs_2" id="domcs_2" style="width:40px;" onchange="domcchk(this.value, 2)">
          ...
          <option value="<?php echo $noticia3['dom_mcode'];?>" />  
          <?php echo $noticia3['dom_mcode'];?>
          <?php } ?>
        </select>&nbsp;<font color="#FF0000" >* </font>&nbsp;<input type="text" name="lbls_2" id="lbls_2" size="5" maxlength="7" class="tbltext" value="" onkeypress="return isNumberKey1(event)" onchange="domchk(2);"  />&nbsp;<font color="#FF0000" >* </font>&nbsp;</td>
    <td width="114" align="center" valign="middle" class="tbltext"><input type="text" name="domce_2" id="domce_2" class="tbltext" size="1" maxlength="1" readonly="true" disabled="disabled" style="background-color:#CCCCCC" value="" />&nbsp;<input type="text" name="lble_2" id="lble_2" size="5"  maxlength="7" class="tbltext" value=""  onkeypress="return isNumberKey1(event)" onchange="domchk1(this.value, 2)" />&nbsp;<font color="#FF0000" >* </font>&nbsp;</td>
  </tr>
</table>
<table align="center" border="1" width="970" cellspacing="0" cellpadding="0" bordercolor="#1dbe03" style="border-collapse:collapse" >
...
<tr height="25">
		<td width="7%" align="center" valign="middle" class="smalltbltext"><input type="text" name="slnop_<?php echo $slsrn?>" id="slnop_<?php echo $slsrn?>" size="4" maxlength="6" class="tbltext" value="" /></td>
		<td width="7%" align="center" valign="middle" class="smalltbltext"><input type="text" name="slnomp_<?php echo $slsrn?>" id="slnomp_<?php echo $slsrn?>" size="4" maxlength="6" class="tbltext" value="" readonly="" style="background-color:#CCCCCC" /></td>
		<td width="7%" align="center" valign="middle" class="smalltbltext"><input type="text" name="slqt_<?php echo $slsrn?>" id="slqt_<?php echo $slsrn?>" size="4" maxlength="6" class="tbltext" value="" readonly="" style="background-color:#CCCCCC" /></td>
		</tr></table></td>
