...
$sql_tbl=mysqli_query($link,"select * from tbl_pnpslipmain where plantcode='$plantcode' and logid='".$logid."' and pnpslipmain_trtype='wb' and pnpslipmain_tflag=0") or die(mysqli_error($link));
while($row_tbl=mysqli_fetch_array($sql_tbl))
{
	...
	if(isset($_POST['frm_action'])=='submit')
	{
		...
		if($sdate1!="" && $edate1!="")
		{
		echo "<script>window.location='home_packslipwb1.php?sdate=$sdate1&edate=$edate1'</script>";
		}
		else
		{
...
<title>Packaging - Transaction - Packing Slip - Home</title>
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#1dbe03" >
	  ...
	  <table width="820" border="0" cellpadding="0" cellspacing="0" bordercolor="#1dbe03" style="border-bottom:solid; border-bottom-color:#1dbe03" >
	    <tr >
	      <td width="820" height="25">&nbsp;Transaction - Packing slip (Window Box)</td>
	    </tr></table></td>
...
<td align="center" width="100" valign="middle" class="tblbutn" style="cursor:Pointer;"><?php if($flg==0 && $flg1==0 && $flg2==0) { ?><a href="add_packwb_slip.php" style="text-decoration:none; color:#000000">Add </a><?php } else { ?><a href="Javascript:void(0);" onclick="alert('Can not perform Transaction.\nReason:\n1. Todays date is not in Active Current Financial Year.\n2. Transaction after todays date has been made.\n3. Cycle Inventory transaction is under process.');" style="text-decoration:none; color:#000000">Add </a><?php } ?></td>
</tr>
</table></td>
...
<?php
$sql_arr_home=mysqli_query($link,"select * from tbl_pnpslipmain where plantcode='$plantcode' and (pnpslipmain_ttype='Packing Slip' or pnpslipmain_ttype='NST Packing Slip') and pnpslipmain_trtype='wb' and pnpslipmain_tflag=2 order by pnpslipmain_tcode desc ") or die(mysqli_error($link));
...
<tr class="Light" height="20">
  <td colspan="6" align="center" class="tblheading">Packing slip (Window Box) - Pending List</td>
</tr>
</table>
<table align="center" border="1" cellspacing="0" cellpadding="0" width="970" bordercolor="#1dbe03" style="border-collapse:collapse">
            ...
            <tr class="tblsubtitle" height="20">
			 ...
			 <td width="76" rowspan="2" align="center" valign="middle" class="smalltblheading">Transaction Id</td>
			  ...
			  <td width="46" rowspan="2" align="center" valign="middle" class="smalltblheading">Packing Status</td>
              <td width="25" rowspan="2" align="center" valign="middle" class="smalltblheading">SLOC Updation</td>
              </tr>
            <tr class="tblsubtitle" height="20">
...
<tr class="Light">
         ...
         <td align="center" valign="middle" class="smalltbltext"><a href="add_packslipwb_view.php?p_id=<?php echo $arrival_id;?>"><?php echo "PS".$row_arr_home['pnpslipmain_code']."/".$yearid_id."/".$lrole;?></a></td>
         ...
         <td align="center" valign="middle" class="smalltbltext"><?php if($row_arr_home['pnpslipmain_wbactflag']==0){echo "Pending";} else {?><a href="Javascript:void(0)" onclick="openpackdetails(<?php echo $arrival_id;?>)">View</a><?php } ?></td>
         <td align="center" valign="middle" class="smalltbltext"><?php if($row_arr_home['pnpslipmain_wbactflag']==1){?><a href="add_packwbsloc_slip.php?p_id=<?php echo $arrival_id;?>" >Update</a><?php } ?></td>
</tr>
<?php
}
else
...
<br />
 <?php
  ...
  $sql_arr_home=mysqli_query($link,"select * from tbl_pnpslipmain where plantcode='$plantcode' and pnpslipmain_trtype='wb' and pnpslipmain_tflag=1 order by pnpslipmain_tcode desc LIMIT $start, $limit ") or die(mysqli_error($link));
 $tot_arr_home=mysqli_num_rows($sql_arr_home);
...
$query = "select * from tbl_pnpslipmain where plantcode='$plantcode' and pnpslipmain_trtype='wb' and pnpslipmain_tflag=1 order by pnpslipmain_tcode desc";
...
$sql_arr_home=mysqli_query($link,"select * from tbl_pnpslipmain where pnpslipmain_ttype='Packing Slip' and pnpslipmain_tflag=1 order by pnpslipmain_tcode desc LIMIT $from, $max_results") or die(mysqli_error($link));
$tot_arr_home=mysqli_num_rows($sql_arr_home);
//$tot_arr_home=0;

$total_results3 =mysqli_query($link,"SELECT COUNT(*)  FROM tbl_pnpslipmain where pnpslipmain_ttype='Packing Slip' and pnpslipmain_tflag=1");
$total_results2 = mysqli_fetch_array($total_results3);
$total_results = $total_results2[0]; 
...
<table align="center" border="0" width="600" cellspacing="0" cellpadding="0" bordercolor="#4ea1e1" style="border-collapse:collapse" > 
<tr class="Light" height="20">
  <td colspan="6" align="center" class="tblheading">Packing slip (Window Box) - Completed </td>
</tr>
</table>
<table align="center" border="1" cellspacing="0" cellpadding="0" width="970" bordercolor="#1dbe03" style="border-collapse:collapse">

            <tr class="tblsubtitle" height="20">
              <td width="5" rowspan="2"align="center" valign="middle" class="smalltblheading">#</td>
			 <td width="88" rowspan="2" align="center" valign="middle" class="smalltblheading">Transaction Id</td>
              <td width="60" rowspan="2" align="center" valign="middle" class="smalltblheading">Date</td>
              <td width="95" rowspan="2" align="center" valign="middle" class="smalltblheading">Crop</td>
              <td width="125" rowspan="2" align="center" valign="middle" class="smalltblheading">Variety</td>
              <td width="105" rowspan="2" align="center" valign="middle" class="smalltblheading">Lot No.</td>
...
if($an[1]==000){$oqty=$an[0];}else{$oqty=$row_tbl_sub['pnpslipsub_oqty'];}
		...
		if($lotno!="")
		{
		$lotno=$lotno."<br>".$row_tbl_sub['pnpslipsub_plotno'];
		}
		else
		{
		$lotno=$row_tbl_sub['pnpslipsub_plotno'];
		}
		if($bags1!="")
		{
		$bags1=$bags1."<br>".$onob;
...
<tr class="Light">
         <td align="center" valign="middle" class="smalltbltext"><?php echo $srno;?></td>
	 <td align="center" valign="middle" class="smalltbltext"><a href="add_packslipwb_view.php?p_id=<?php echo $arrival_id;?>"><?php echo "PS".$row_arr_home['pnpslipmain_tcode']."/".$yearid_id."/".$lrole;?></a></td>
         <td align="center" valign="middle" class="smalltbltext"><?php echo $trdate;?></td>
         <td align="center" valign="middle" class="smalltbltext"><?php echo $crop?></td>
         <td align="center" valign="middle" class="smalltbltext"><?php echo $variety?></td>
         <td align="center" valign="middle" class="smalltbltext"><?php echo $lotno?></td>
