<?php
	...
	while($row_arrsub=mysqli_fetch_array($sql_arrsub))
	{
		...
		$a="";
		$sql_barcode2=mysqli_query($link,"Select * from tbl_barcodestmp where bar_lotno='".$row_arrsub['pnpslipsub_plotno']."' and bar_psrn='".$drefno."'") or die(mysqli_error($link));
