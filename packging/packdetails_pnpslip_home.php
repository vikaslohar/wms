...
<td width="144"  align="left" valign="middle" class="smalltbltext">&nbsp;<?php echo "TPS".$row_tbl['pnpslipmain_code']."/".$yearid_id."/".$lgnid;?></td>
...
<td width="137" align="right"  valign="middle" class="smalltblheading">Processing Slip Ref. No.&nbsp;</td>
    <td width="144" align="left"  valign="middle" class="smalltbltext">&nbsp;<?php echo $row_tbl['pnpslipmain_proslipno'];?>&nbsp;</td>
</tr></table>
...
?>
    ...
    <td width="144" align="left"  valign="middle" class="smalltbltext" id="vitem">&nbsp;<?php echo $row_tbl['pnpslipmain_stage'];?>&nbsp;</td>
...
<table align="center" border="1" cellspacing="0" cellpadding="0" width="970" bordercolor="#1dbe03" style="border-collapse:collapse">
	...
	<td width="35" rowspan="2" align="center" valign="middle" class="smalltblheading">Max No. of MP</td>
...
while($row_tbl_sub=mysqli_fetch_array($sql_tbl_sub))
{
	...
	$sql_barcode23=mysqli_query($link,"Select * from tbl_pnpslipsubsub3 where pnpslipsub_id='".$row_tbl_sub['pnpslipsub_id']."' and pnpslipmain_id='".$arrival_id."' ") or die(mysqli_error($link));
	$tot_barcode23=mysqli_num_rows($sql_barcode23);
	while($row_barcode23=mysqli_fetch_array($sql_barcode23))
	{
		$sql_whouse=mysqli_query($link,"select perticulars from tbl_warehouse where plantcode='$plantcode' and whid='".$row_barcode23['pnpslipsubsub_wh']."' order by perticulars") or die(mysqli_error($link));
		$row_whouse=mysqli_fetch_array($sql_whouse);
		$wareh=$row_whouse['perticulars']."/";
		
		$sql_binn=mysqli_query($link,"select binname from tbl_bin where plantcode='$plantcode' and binid='".$row_barcode23['pnpslipsubsub_bin']."' and whid='".$row_barcode23['pnpslipsubsub_wh']."'") or die(mysqli_error($link));
		$row_binn=mysqli_fetch_array($sql_binn);
		$binn=$row_binn['binname']."/";
		
		$sql_subbinn=mysqli_query($link,"select sname from tbl_subbin where plantcode='$plantcode' and sid='".$row_barcode23['pnpslipsubsub_subbin']."' and binid='".$row_barcode23['pnpslipsubsub_bin']."' and whid='".$row_barcode23['pnpslipsubsub_wh']."'") or die(mysqli_error($link));
		$row_subbinn=mysqli_fetch_array($sql_subbinn);
		$subbinn=$row_subbinn['sname'];
		
		$bar_ups=$row_tbl_sub['pnpslipsub_ups'];
		$bar_nop=$row_barcode23['pnpslipsubsub_totpouches'];
		$bar_netweight=$row_barcode23['pnpslipsubsub_totqty'];
		
		$nopmpcs=$nopmpcs+$row_barcode23['pnpslipsubsub_nomp'];
		$noppchs=$bar_nop; 
		$noptpchs=$noppchs; 
		...
		if($sloc!=""){
		$sloc=$sloc."<BR/>".$wareh.$binn.$subbinn." | ".$row_barcode23['pnpslipsubsub_nomp']." | ".$noppchs." | ".$bar_netweight;}
		else{
		$sloc=$wareh.$binn.$subbinn." | ".$row_barcode23['pnpslipsubsub_nomp']." | ".$noppchs." | ".$bar_netweight;}
	}
...
?>
  <tr class="Light" height="20">
    ...
    <td align="center" valign="middle" class="smalltbltext"><?php echo $noptqtys;?></td>
	...
	<td align="center" valign="middle" class="smalltbltext"><?php echo $row_tbl_sub['pnpslipsub_lblschar'].$row_tbl_sub['pnpslipsub_lblsno']." -- ".$row_tbl_sub['pnpslipsub_lbechar'].$row_tbl_sub['pnpslipsub_lbeno'];?></td>
	  <td align="center" valign="middle" class="smalltbltext"><?php echo $row_tbl_sub['pnpslipsub_nomp'];?></td>
	...
	<td width="58" align="center" valign="middle" class="smalltbltext"><?php echo $tot_barcnomp;?></td>
...
<tr class="Light" height="20">
   <td width="18" align="center" valign="middle" class="smalltbltext"><?php echo $srno;?></td>
	...
	<td align="center" valign="middle" class="smalltbltext"><?php echo $row_tbl_sub['pnpslipsub_lblschar'].$row_tbl_sub['pnpslipsub_lblsno']."-".$row_tbl_sub['pnpslipsub_lbechar'].$row_tbl_sub['pnpslipsub_lbeno'];?></td>
	  <td align="center" valign="middle" class="smalltbltext"><?php echo $row_tbl_sub['pnpslipsub_nomp'];?></td>
	<td width="53" align="center" valign="middle" class="smalltbltext"><?php if($row_tbl_sub['pnpslipsub_convtomp']=="Yes") echo $row_tbl_sub['pnpslipsub_balpouch']; else echo $row_tbl_sub['pnpslipsub_nop'];?></td>
	<td width="58" align="center" valign="middle" class="smalltbltext"><?php echo $row_tbl_sub['pnpslipsub_nobarcodes'];?></td>
	<td width="58" align="center" valign="middle" class="smalltbltext"><?php echo $tdate4;?></td>
	<td width="262" align="center" valign="middle" class="smalltbltext"><?php echo $sloc;?></td>
        </tr>
  <?php
