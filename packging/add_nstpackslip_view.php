...
<title>Packaging -Transaction - NST Packing Slip- View</title>
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#1dbe03" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#1dbe03" style="border-bottom:solid; border-bottom-color:#1dbe03" >
	    <tr >
	      <td width="813" height="25" class="Mainheading">&nbsp;Transaction - NST Packing slip - View </td>
	    </tr></table></td>
...
<tr class="tblsubtitle" height="20">
  <td colspan="8" align="center" class="tblheading">NST Packing Slip View</td>
</tr>
 <tr class="Light" height="30">
<td width="319" align="right" valign="middle" class="smalltblheading">&nbsp;Transaction ID &nbsp;</td>
<td width="319"  align="left" valign="middle" class="smalltbltext">&nbsp;<?php echo "NP".$row_tbl['pnpslipmain_tcode']."/".$yearid_id."/".$lgnid;?></td>
