...
?>
&nbsp;<select class="smalltbltext" id="vsubbin_<?php echo $b?>" name="vsubbin_<?php echo $b?>" style="width:60px;" onchange="subbin(this.value,1)" >
<option value="" selected>SubBin</option>
	<?php while($noticia_bing1 = mysqli_fetch_array($sql_month)) { ?>
		<option value="<?php echo $noticia_bing1['sid'];?>" >   
		<?php echo $noticia_bing1['sname'];?></option>
