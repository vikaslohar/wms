...
<table align="center" border="1" cellspacing="0" cellpadding="0" width="700" bordercolor="#1dbe03" style="border-collapse:collapse">
  ...
  $sql_arr_home=mysqli_query($link,"select * from tbl_pnpslipmain where plantcode='$plantcode' and pnpslipmain_ttype='Packing Slip' and pnpslipmain_tflag=1 order by pnpslipmain_tcode desc LIMIT $start, $limit") or die(mysqli_error($link));
...
$query = "select * from tbl_pnpslipmain where plantcode='$plantcode' and pnpslipmain_ttype='Packing Slip' and pnpslipmain_tflag=1 order by pnpslipmain_tcode desc";
