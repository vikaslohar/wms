...
$targetpage = $_SERVER['PHP_SELF']; 
  ...
  $sql_arr_home=mysqli_query($link,"select * from tbl_unpkg where plantcode='$plantcode' and unpkg_tflg=1 order by unpkg_id DESC LIMIT $start, $limit") or die(mysqli_error($link));
...
$query = "select * from tbl_unpkg where plantcode='$plantcode' and unpkg_tflg=1";
...
$sql_arr_home=mysqli_query($link,"select * from tbl_unpkg where unpkg_tflg=1 order by unpkg_id DESC LIMIT $from, $max_results") or die(mysqli_error($link));
$tot_arr_home=mysqli_num_rows($sql_arr_home);
//$tot_arr_home=0;

$total_results3 =mysqli_query($link,"SELECT COUNT(*)  FROM tbl_unpkg where unpkg_tflg=1");
$total_results2 = mysqli_fetch_array($total_results3);
$total_results = $total_results2[0]; 
