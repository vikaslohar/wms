<?php
	...
	while($row_arrsubsub=mysqli_fetch_array($sql_arrsubsub))
	{
		...
		$packnop=$row_arrsubsub['packagingsubsub_nop'];
		...
		if($tot_barcode2 > 0)
		{
			while($row_barcode2=mysqli_fetch_array($sql_barcode2))
			{
				...
				$sql_barcode="Insert into tbl_barcodes (bar_trid, bar_trtype, bar_subtrid, bar_lotno, bar_orlot, bar_barcode, bar_grosswt, bar_wtdate, bar_wttime, bar_poprid, logid, yearid, plantcode) values('$pid', 'PACKMMC', '$subtranid', '$lotno', '$oldlot2', '$barcode', '$grosswt', '$dt', '$tim', '$poprid', '$logid', '$yearid_id', '$plantcode')";
				//echo "<br/>";
				...
				if($pval1<>"")
				{
					...
					while($row_issuetbl22=mysqli_fetch_array($sql_issuetbl22))
					{
						...
						while($row_arrsubsub3=mysqli_fetch_array($sql_arrsubsub3))
						{
							...
							$nomp2=$row_arrsubsub3['packagingsubsub_nop'];
							...
							$sql_ins_main231="insert into tbl_mpmain (mpmain_date, mpmain_trid, mpmain_trtype, mpmain_crop, mpmain_variety, mpmain_lotno, mpmain_upssize, mpmain_barcode, mpmain_wtmp, mpmain_mptnop, mpmain_opnop, mpmain_opqty, mpmain_nop, mpmain_qty, mpmain_balnop, mpmain_balqty, mpmain_wh, mpmain_bin, mpmain_subbin, mpmain_yearcode, mpmain_logid, plantcode) values('$arrival_date', '$pid', 'PACKMMC', '$crop', '$variety', '$lotno2', '$packtype', '$barcodes2', '$wtinmp', '$nopinmp', '0', '0', '$balnop2', '$balqty2', '$balnop2', '$balqty2', '$whid', '$binid', '$subbinid', '$yearcode', '$logid', '$plantcode')";
...
<title>Packaging -Transaction - Packaging Slip MMC - Preview</title>
...
function openslocpopprint()
{
	if(document.frmaddDepartment.txtitem.value!="")
	{
		...
		winHandle=window.open('packagingslipmmc_print.php?itmid='+itm,'WelCome','top=170,left=180,width=820,height=350,scrollbars=yes');
		if(winHandle==null){
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#1dbe03" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#1dbe03" style="border-bottom:solid; border-bottom-color:#1dbe03" >
	    <tr >
	      <td width="813" height="25" class="Mainheading">&nbsp;Transaction - Packaging slip - MMC - Preview </td>
	    </tr></table></td>
...
<tr class="tblsubtitle" height="20">
	<td colspan="8" align="center" class="tblheading">Add Packaging Slip - MMC - Preview</td>
</tr>
<tr height="15">
