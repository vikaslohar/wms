<?php
	...
	$sql_tbl_sub=mysqli_query($link,"select * from tbl_pnpslipsub where pnpslipsub_id='".$a."'") or die(mysqli_error($link));
...
$sql_tbl_subsub=mysqli_query($link,"select * from tbl_pnpslipsubsub where pnpslipsub_id='".$row['pnpslipsub_id']."' and pnpslipmain_id='".$tid."'  and pnpslipsubsub_wh='".$row_issuetbl['lotldg_whid']."' and pnpslipsubsub_bin='".$row_issuetbl['lotldg_binid']."' and pnpslipsubsub_subbin='".$row_issuetbl['lotldg_subbinid']."'") or die(mysqli_error($link));
...
<?php
$abrc="";
$s_sub3=mysqli_query($link,"select bar_barcodes from tbl_barcodestmp where where bar_lotno='".$row['pnpslipsub_plotno']."' and bar_logid='".$logid."' and bar_psrn='".$row_tbl['pnpslipmain_proslipno']."'") or die(mysqli_error($link));
...
while($row_sub3=mysqli_fetch_array($s_sub3))
{
	...
	if($abrc!="")
	{
	$sqlbtsls=mysqli_query($link,"select distinct(btsl_id) from tbl_btslsub where btslsub_barcode IN ($abrc) order by btslsub_id asc") or die(mysqli_error($link));
...
<?php
	$abc=""; $abcdef="";
	$sql_barcode2=mysqli_query($link,"select bar_barcodes from tbl_barcodestmp where bar_lotno='".$row['pnpslipsub_plotno']."' and bar_logid='".$logid."' and bar_psrn='".$row_tbl['pnpslipmain_proslipno']."'") or die(mysqli_error($link));
...
$sql_tbl_subsub3=mysqli_query($link,"select * from tbl_pnpslipsubsub3 where pnpslipsub_id='".$row['pnpslipsub_id']."' and pnpslipmain_id='".$tid."' order by pnpslipsubsub_id asc") or die(mysqli_error($link));
