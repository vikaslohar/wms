...
function sloccomment(rval)
{
	...
	var totpch=parseInt(document.getElementById(loosepouches).value);
	totpch=parseInt(totpch)+parseInt(parseInt(document.getElementById(totnomp).value)*parseInt(document.getElementById(wtnop).value));
	...
	else if((document.getElementById(trflg).value!="" && document.getElementById(tpflg).value!="" && document.getElementById(tflg).value!="" && document.getElementById(tpmflg).value!="") && (document.getElementById(trflg).value==0 && document.getElementById(tpflg).value==0 && document.getElementById(tflg).value==0 && document.getElementById(tpmflg).value==0))
	{
		...
		document.getElementById(p).value=parseInt(document.getElementById(loosepouches).value);
		...
		document.getElementById(lwb).value=parseInt(document.getElementById(loosewb).value);
	}
	else
	{
		...
		document.getElementById(lwb).value="";
...
{
	var totpouches=parseInt(document.frmaddDepartment.totnop.value)+parseInt(document.frmaddDepartment.loosepouches.value);
	
	var totccqty=(parseInt(totpouches)*parseFloat(ccval))/1000;
...
<td width="157" align="right"  valign="middle" class="smalltblheading">Packing Slip Ref./indent No.&nbsp;</td>
    <td width="165" align="left"  valign="middle" class="smalltbltext">&nbsp;<input name="txtpsrn" type="text" size="15" class="smalltbltext" tabindex="" value="<?php echo $row_tbl['pnpslipmain_proslipno'];?>" />&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
</tr></table>
<table align="center" border="1" width="970" cellspacing="0" cellpadding="0" bordercolor="#1dbe03" style="border-collapse:collapse" > 
<tr class="Light" height="30">
 <?php
...
<tr class="tblsubtitle" height="20">
	...
	<td width="6%" align="center" valign="middle" class="smalltblheading">Total NoWB</td>
...
$sql_wbm=mysqli_query($link,"select distinct wb_extqrcode from tbl_wbqrcode where wb_pnptrid='".$row_tbl['pnpslipmain_id']."' and wb_mpqlinkflg=0 and wb_mpblinkflg=0  ") or die(mysqli_error($link));
while($row_wbm=mysqli_fetch_array($sql_wbm))
{
	$loosewb=$loosewb+1;
}
...
$sql_wbs=mysqli_query($link,"select wb_nop, wb_qty, wb_mpgrosswt, wb_mpbarcode from tbl_wbqrcode where wb_pnptrid='".$row_tbl['pnpslipmain_id']."' ") or die(mysqli_error($link));
while($row_wbs=mysqli_fetch_array($sql_wbs))
{
	...
	if($totnomp>0)
	{
		...
		{
		$grwtflg++;
		//echo $row_wbs['wb_mpbarcode']."  =  ".$grwtflg;
		}
	}
	//if($row_wbs['wb_mpbarcode']!="" && $row_wbs['wb_mpgrosswt']==0)
	//{$grwtflg++;}
...
$totpckqty=round($totpckqty,3);
//echo $row_tbl_sub['pnpslipsub_pickpqty']."  =  ".$totpckqty."  =  ".$pckccqty;

$wbwt=$row_tbl_sub['pnpslipsub_wbwt'];
$pickpqty=$row_tbl_sub['pnpslipsub_pickpqty'];
$pcklossqty=$row_tbl_sub['pnpslipsub_pickpqty']-($totpckqty+$pckccqty);
if($pcklossqty<0){$pcklossqty=0;}
$pcklossper=($pcklossqty/$pickpqty)*100;
$pcklossper=round($pcklossper,2);

$wtmp=$row_tbl_sub['pnpslipsub_wtmp'];
if($row_tbl_sub['pnpslipsub_mptnop']>0)
{$wtnop=$row_tbl_sub['pnpslipsub_mptnop'];}
else
{$wtnop=($row_tbl_sub['pnpslipsub_wbnop']*$row_tbl_sub['pnpslipsub_wbinmp']);}
$wtnopkg=$ptp1;

$wbnop=$row_tbl_sub['pnpslipsub_wbnop'];
$remarks=$row_tbl_sub['pnpslipsub_remarks'];
