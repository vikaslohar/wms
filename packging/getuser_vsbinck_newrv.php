...
//echo $trid;
	...
	$subids="";	
/*$sql_tr_222=mysqli_query($link,"select * from tbl_salesrsub_sub where salesrss_subbin='".$a."' order by salesrss_id desc") or die(mysqli_error($link));
$tot_tr_222=mysqli_num_rows($sql_tr_222);
if($tot_tr_222 > 0)
{
$row_tr_222=mysqli_fetch_array($sql_tr_222);

$sqs=mysqli_query($link,"select * from tbl_salesr_sub where salesrs_id='".$row_tr_222['salesrs_id']."'") or die(mysqli_error($link));
...
$sql_tr=mysqli_query($link,"select * from tbl_salesr_sub where salesr_id='".$trid."' and salesrs_variety!='".$varid11."' and salesrs_id='".$subids."'") or die(mysqli_error($link));
