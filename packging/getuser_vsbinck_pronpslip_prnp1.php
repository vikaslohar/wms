...
if($tpmflg==0)
{
	if(($tp==$typ || $tp=="Empty"))
	{
		$s_good=mysqli_query($link,"select distinct lotldg_variety from tbl_lot_ldg where plantcode='$plantcode' and  lotldg_subbinid='".$a."' and lotldg_variety!='".$b."' and lotldg_balqty > 0") or die(mysqli_error($link));
		//echo $r_good=mysqli_num_rows($s_good);
		$cnt=0;
		while($row_issueg=mysqli_fetch_array($s_good))
 	{ 
	$sql_lot=mysqli_query($link,"select distinct lotldg_lotno from tbl_lot_ldg where plantcode='$plantcode' and  lotldg_subbinid='".$a."' and lotldg_variety='".$row_issueg['lotldg_variety']."' and lotldg_balqty > 0") or die(mysqli_error($link));
...
//echo $cnt;
$xcflg=0;
$s_good_new=mysqli_query($link,"select distinct lotldg_lotno from tbl_lot_ldg where plantcode='$plantcode' and  lotldg_subbinid='".$a."' and lotldg_balqty > 0") or die(mysqli_error($link));
...
if($tpmflg==0)
{
	if(($tp==$typ || $tp=="Empty"))
	{ $sa="";
		$s_good=mysqli_query($link,"select distinct lotldg_variety from tbl_lot_ldg_pack where plantcode='$plantcode' and  subbinid='".$a."' and lotldg_variety!='".$b."' and balqty > 0") or die(mysqli_error($link));
		//echo $r_good=mysqli_num_rows($s_good);
		$cnt=0;
	while($row_issueg=mysqli_fetch_array($s_good))
 	{ 
	
	$sql_lot=mysqli_query($link,"select distinct lotno from tbl_lot_ldg_pack where plantcode='$plantcode' and  subbinid='".$a."' and lotldg_variety='".$row_issueg['lotldg_variety']."' and balqty > 0") or die(mysqli_error($link));
	while($row_lot=mysqli_fetch_array($sql_lot))
 	{ 
...
$xcflg=0;
$s_good_new=mysqli_query($link,"select distinct lotno from tbl_lot_ldg_pack where plantcode='$plantcode' and  subbinid='".$a."' and balqty > 0") or die(mysqli_error($link));
...
<input type="hidden" name="trflg<?php echo $g?>" id="trflg<?php echo $g?>" value="<?php echo $trflg?>" /><input type="hidden" name="tpflg<?php echo $g?>" id="tpflg<?php echo $g?>" value="<?php echo $tpflg?>" /><input type="hidden" name="tflg<?php echo $g?>" id="tflg<?php echo $g?>" value="<?php echo $tflg?>" /><input type="hidden" name="tpmflg<?php echo $g?>" id="tpmflg<?php echo $g?>" value="<?php echo $tpmflg?>" />
