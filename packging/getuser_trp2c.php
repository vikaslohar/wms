...
<td align="left"  valign="middle" class="tblheading"   >&nbsp;<input type="radio" name="ptptyp" class="tbltext" value="entire" onclick="chklot(this.value);"<?php if($tflg>0) echo "disabled";?> />Entire&nbsp;&nbsp;<input type="radio" name="ptptyp" class="tbltext" value="partial" onclick="chklot(this.value);"  <?php if($tflg>0) echo "checked";?>  />Partial&nbsp;<font color="#FF0000">*</font>&nbsp;<input type="hidden" name="ptptype" value="<?php if($tflg>0) echo "partial"; else echo "Entire";?>" /></td>
...
<td align="left"  valign="middle" class="tblheading">&nbsp;<input name="txtnewlot" type="text" size="20" class="tbltext" tabindex=""   maxlength="20" value="<?php if($tflg>0) echo $abc24; else echo $abc23;?>"  style="background-color:#CCCCCC" readonly="true"/>&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
</tr>
...
<tr class="Light" height="20">
	...
	<td width="107" align="center" valign="middle" class="tblheading"><input type="text" name="nop<?php echo $sno;?>" id="nop_<?php echo $sno;?>" value="" size="6" maxlength="6" onchange="chknop(this.value,'<?php echo $sno;?>')" /></td>
	<td width="107" align="center" valign="middle" class="tblheading"><input type="text" name="qty<?php echo $sno;?>" id="qty_<?php echo $sno;?>" value="" size="6" maxlength="6" onchange="chkqty(this.value,'<?php echo $sno;?>')"  /></td>
	<td width="107" align="center" valign="middle" class="tblheading"><input type="text" name="bnop<?php echo $sno;?>" id="bnop_<?php echo $sno;?>" value="" size="6" maxlength="6" readonly="true" style="background-color:#CCCCCC" /></td>
	<td width="107" align="center" valign="middle" class="tblheading"><input type="text" name="bqty<?php echo $sno;?>" id="bqty_<?php echo $sno;?>" value="" size="6" maxlength="6" readonly="true" style="background-color:#CCCCCC" /></td>
</tr>
<?php
}
}
