<?php
	...
	if(isset($_POST['frm_action'])=='submit')
	{
		...
		if($sdate!="")
		{
			echo "<script>window.location='periodical_dtpack_report.php?sdate=$sdate&edate=$edate&txtcrop=$txtcrop&txtvariety=$txtvariety&txtupsdc=$txtupsdc'</script>";
		}
		else
		{?>
		 <script>
...
<title>Packaging-Report - Periodical Packed Seed Activity Report</title>
...
<table align="center" border="1" width="550" cellspacing="0" cellpadding="0" bordercolor="#1dbe03" style="border-collapse:collapse" >
                <tr class="tblsubtitle" height="25">
                  <td colspan="4" align="center" class="tblheading" >Periodical Packed Seed Activity Report</td>
                </tr>
                <tr height="15">
...
<?php
$quer3=mysqli_query($link,"SELECT cropid, cropname FROM tblcrop where cropname IN('Paddy Seed','Maize Seed','Bajra Seed') order by cropname Asc"); 
?>            
...
<tr >
	<td align="left" class="smalltbltext" style="color:#303918;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 2. This report will be generated for only 3 crops: Paddy Seed, Bajra Seed and Maize Seed</td>
</tr>
<tr >
