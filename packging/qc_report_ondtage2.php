...
<?php	
	...
	$qry="select distinct variety from tbl_qctest where plantcode='$plantcode' and testdate<='".$edate."' and crop='".$itemid."' ";
	...
	if($seedstage!="ALL")
	{
		$qry.=" and trstage='".$seedstage."' ";
		$reslt=" and trstage='".$seedstage."' ";
	}
	$qry.=" order by variety asc,testdate asc ";
	//echo $qry;
...
while($row_arr_home1=mysqli_fetch_array($sql_arr_home1))
{
	...
	$quer3=mysqli_query($link,"SELECT * FROM tblvariety where varietyid ='".$row_arr_home1['variety']."' "); 
	...
	$cont=0;
	$sql_arr_home244=mysqli_query($link,"select distinct lotno from tbl_qctest where plantcode='$plantcode' and testdate<='$edate' and crop='".$itemid."'  and variety='".$row_arr_home1['variety']."' $reslt order by variety asc, testdate asc ") or die(mysqli_error($link));
	$t=mysqli_num_rows($sql_arr_home244);
	while($row_arr_home244=mysqli_fetch_array($sql_arr_home244))
	{
		//if($seedstage!="Pack")
		{
			$sql_tbl_sub1=mysqli_query($link,"select distinct lotldg_subbinid from tbl_lot_ldg where plantcode='$plantcode' and lotldg_lotno='".$row_arr_home244['lotno']."' order by lotldg_subbinid") or die(mysqli_error($link));
			$t=mysqli_num_rows($sql_tbl_sub1);
			while($row_tbl=mysqli_fetch_array($sql_tbl_sub1))
			{$total_tbl=0;
				$sql_tbl1=mysqli_query($link,"select max(lotldg_id) from tbl_lot_ldg where plantcode='$plantcode' and lotldg_subbinid='".$row_tbl['lotldg_subbinid']."' and lotldg_lotno='".$row_arr_home244['lotno']."'") or die(mysqli_error($link));  
		...
		//else
		{
			$sql_tbl_sub1=mysqli_query($link,"select distinct subbinid from tbl_lot_ldg_pack where plantcode='$plantcode' and lotno='".$row_arr_home244['lotno']."' order by subbinid") or die(mysqli_error($link));
			$t=mysqli_num_rows($sql_tbl_sub1);
			while($row_tbl=mysqli_fetch_array($sql_tbl_sub1))
			{$total_tbl=0;
				$sql_tbl1=mysqli_query($link,"select max(lotdgp_id) from tbl_lot_ldg_pack where plantcode='$plantcode' and subbinid='".$row_tbl['subbinid']."' and lotno='".$row_arr_home244['lotno']."'") or die(mysqli_error($link));  
				$row_tbl1=mysqli_fetch_array($sql_tbl1);
...
<table align="center" border="0" cellspacing="0" cellpadding="0" width="850" style="border-collapse:collapse">
  ...
  <table  border="1" cellspacing="0" cellpadding="0" width="850" bordercolor="#1dbe03" style="border-collapse:collapse" align="center">
...
<?php
$sql_arr_home2=mysqli_query($link,"select distinct lotno from tbl_qctest where plantcode='$plantcode' and testdate<='$edate' and crop='".$itemid."'  and variety='".$row_arr_home1['variety']."' $reslt order by variety asc, testdate asc ") or die(mysqli_error($link));
$t=mysqli_num_rows($sql_arr_home2);
while($row_arr_home2=mysqli_fetch_array($sql_arr_home2))
{

$sql_arr_home3=mysqli_query($link,"select MAX(tid) from tbl_qctest where plantcode='$plantcode' and testdate<='$edate' and crop='".$itemid."'  and variety='".$row_arr_home1['variety']."' and lotno='".$row_arr_home2['lotno']."' $reslt order by variety asc, testdate asc ") or die(mysqli_error($link));
while($row_arr_home3=mysqli_fetch_array($sql_arr_home3))
{

$sql_arr_home=mysqli_query($link,"select * from tbl_qctest where plantcode='$plantcode' and testdate<='$edate' and crop='".$itemid."'  and variety='".$row_arr_home1['variety']."' and lotno='".$row_arr_home2['lotno']."' and tid='".$row_arr_home3[0]."' $reslt order by variety asc, testdate asc ") or die(mysqli_error($link));
...
$crop=""; $variety=""; $lotno=""; $bags=""; $qty=0; $stage=""; $got=""; $qc=""; $sstatus=""; $loc1=""; $per=""; $qcresult="";
	$sql_tbl_sub1=mysqli_query($link,"select distinct lotldg_subbinid from tbl_lot_ldg where plantcode='$plantcode' and lotldg_lotno='".$row_arr_home2['lotno']."'  order by lotldg_subbinid") or die(mysqli_error($link));
if(	 $t=mysqli_num_rows($sql_tbl_sub1) > 0)
{
	while($row_tbl=mysqli_fetch_array($sql_tbl_sub1))
	{	 
	
	$sql_tbl1=mysqli_query($link,"select max(lotldg_id) from tbl_lot_ldg where plantcode='$plantcode' and lotldg_subbinid='".$row_tbl['lotldg_subbinid']."' and lotldg_lotno='".$row_arr_home2['lotno']."'") or die(mysqli_error($link));  
$row_tbl1=mysqli_fetch_array($sql_tbl1);
//echo "  ".$row_tbl1[0]."  ";
$sql1=mysqli_query($link,"select * from tbl_lot_ldg where plantcode='$plantcode' and lotldg_id='".$row_tbl1[0]."' and lotldg_balqty > 0 ")or die(mysqli_error($link));
...
{
	$sql_tbl_sub1=mysqli_query($link,"select distinct subbinid from tbl_lot_ldg_pack where plantcode='$plantcode' and lotno='".$row_arr_home2['lotno']."'  order by subbinid") or die(mysqli_error($link));
	while($row_tbl=mysqli_fetch_array($sql_tbl_sub1))
	{	 
	
	$sql_tbl1=mysqli_query($link,"select max(lotdgp_id) from tbl_lot_ldg_pack where plantcode='$plantcode' and subbinid='".$row_tbl['subbinid']."' and lotno='".$row_arr_home2['lotno']."'") or die(mysqli_error($link));  
$row_tbl1=mysqli_fetch_array($sql_tbl1);
//echo "  ".$row_tbl1[0]."  ";
$sql1=mysqli_query($link,"select * from tbl_lot_ldg_pack where plantcode='$plantcode' and lotdgp_id='".$row_tbl1[0]."' and balqty > 0 ")or die(mysqli_error($link));
...
if($durtyp=="dfill")
{
	if($fillagetyp=="less")
	{
		...
		if($dt2!="")
		{
			if($row_arr_home['testdate']<$dt2)$flg++;
		}
	}
...
else
{
	...
	else if($dotage!="ALL" && $dotage=="45-90")
	{
		...
		if($dt2!="" && $dt24!="")
		{
			if($row_arr_home['testdate']>=$dt2 || $row_arr_home['testdate']<$dt24)$flg++;
		}
	}
...
//echo $dt2;
$diff = abs(strtotime($trdate240) - strtotime($row_arr_home['testdate']));
...
//printf("%d days\n", $days);
//echo $row_arr_home['testdate']."  -  ".$dt2."  -  ".$dt24."<br />";
$days=$days;
