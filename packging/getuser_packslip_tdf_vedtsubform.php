...
<?php
$sno=0; $srnonew=0;
$sqlcrop=mysqli_query($link,"select * from tblups_tdf where plantcode='$plantcode' order by uom Asc") or die(mysqli_error($link));
$totcrop=mysqli_num_rows($sqlcrop);
while($row12=mysqli_fetch_array($sqlcrop))
{
$p1_array=explode(";",$row12['crop']);
foreach($p1_array as $val1)
{
if($val1<>"")
{
//echo $val1." - ".$b."<br>";
if($val1==$row_tbl['pnpslipmain_crop'])
{
$sno++;	
?>

<tr class="Light" height="25">
<td width="49" align="center" valign="middle" class="tbltext"><input type="radio" name="fet" onClick="clk('<?php echo $sno?>',<?php echo $row12['tid'];?>);" id="fetchk_<?php echo $sno?>" value="<?php echo $row12['tid'];?>" <?php if($row12['tid']==$row['pnpslipsub_upsid']) echo "checked"; ?>/><?php if($row12['tid']==$row['pnpslipsub_upsid']) {?><input type="hidden" name="upssize" value="<?php echo $sno;?>" /><?php } ?></td>
...
<td width="81" align="center" valign="middle" class="tbltext"><input type="text" name="packqty_<?php echo $sno?>" id="packqty_<?php echo $sno?>" size="7" maxlength="7" class="tbltext" value="<?php if($row12['tid']==$row['pnpslipsub_upsid']) echo $row['pnpslipsub_packqty']; else echo ""; ?>" onkeypress="return isNumberKey(event)" onchange="chktotpouches(this.value, <?php echo $sno?>)" <?php if($row['pnpslipsub_packtype']=="E") echo "readonly='true' style='background-color:#CCCCCC'";?> />&nbsp;<font color="#FF0000" >* </font>&nbsp;</td>
<td width="96" align="center" valign="middle" class="tbltext"><input type="text" name="nopc_<?php echo $sno?>" id="nopc_<?php echo $sno?>" size="7" maxlength="7" class="tbltext" value="<?php if($row12['tid']==$row['pnpslipsub_upsid']) echo $row['pnpslipsub_nop']; else echo ""; ?>" readonly="true" style="background-color:#CCCCCC"/></td>
<td width="135" align="center" valign="middle" class="tbltext"><?php $quer3=mysqli_query($link,"SELECT dom_mcode FROM tbl_rm_dommac  order by dom_mcode Asc"); ?>
  <select class="smalltbltext" <?php if($row12['tid']!=$row['pnpslipsub_upsid']) echo "disabled";?> name="domcs_<?php echo $sno?>" id="domcs_<?php echo $sno?>" style="width:40px;" onchange="domcchk(this.value, <?php echo $sno?>)"> <option value="" >Select</option> <?php while($noticia = mysqli_fetch_array($quer3)) { ?> <option <?php if($row12['tid']==$row['pnpslipsub_upsid']) { if($noticia['dom_mcode']==$row['pnpslipsub_lblschar']) echo "selected";} else echo "disabled";?> value="<?php echo $noticia['dom_mcode'];?>" /><?php echo $noticia['dom_mcode'];?><?php } ?></select>&nbsp;<font color="#FF0000" >* </font>&nbsp;<input type="text" name="lbls_<?php echo $sno?>" id="lbls_<?php echo $sno?>" size="5" maxlength="7" class="tbltext" value="<?php if($row12['tid']==$row['pnpslipsub_upsid']) echo $row['pnpslipsub_lblsno']; else echo ""; ?>"  onkeypress="return isNumberKey1(event)" onchange="domchk(<?php echo $sno?>);"  />&nbsp;<font color="#FF0000" >* </font>&nbsp;</td>
<td width="114" align="center" valign="middle" class="tbltext"><input type="text" name="domce_<?php echo $sno?>" id="domce_<?php echo $sno?>" class="tbltext" size="1" maxlength="1" readonly="true" style="background-color:#CCCCCC" value="<?php if($row12['tid']==$row['pnpslipsub_upsid']) echo $row['pnpslipsub_lbechar']; else echo ""; ?>" />&nbsp;<input type="text" name="lble_<?php echo $sno?>" id="lble_<?php echo $sno?>" size="5"  maxlength="7" class="tbltext" value="<?php if($row12['tid']==$row['pnpslipsub_upsid']) echo $row['pnpslipsub_lbeno']; else echo ""; ?>"  onkeypress="return isNumberKey1(event)" onchange="domchk1(this.value, <?php echo $sno?>)" />&nbsp;<font color="#FF0000" >* </font>&nbsp;</td>
<td width="53" align="center" valign="middle" class="tbltext"><input type="checkbox" name="mpck_<?php echo $sno?>" id="mpck_<?php echo $sno?>" class="tbltext" value="Yes" onchange="mpchk(this.value, <?php echo $sno;?>)" disabled="disabled"   /></td>
<td width="78" align="center" valign="middle" class="tbltext"><input type="text" name="nomp_<?php echo $sno?>" id="nomp_<?php echo $sno?>" size="7" maxlength="7" class="tbltext" value="<?php if($row12['tid']==$row['pnpslipsub_upsid'] && $row['pnpslipsub_convtomp']=="Yes") echo $row['pnpslipsub_nomp']; else echo ""; ?>"  readonly="true" style="background-color:#CCCCCC" onchange="balnopcheck(this.value, <?php echo $sno?>)"/><input type="hidden" name="wtmp_<?php echo $sno?>" id="wtmp_<?php echo $sno?>" value="<?php echo $wtmp?>" /><input type="hidden" name="wtnop_<?php echo $sno?>" id="wtnop_<?php echo $sno?>" value="<?php echo $mptnop?>" /></td>
<td width="82" align="center" valign="middle" class="tbltext"><input type="text" name="noofpacks_<?php echo $sno?>" id="noofpacks_<?php echo $sno?>" size="7" maxlength="7" class="tbltext" value="<?php if($row12['tid']==$row['pnpslipsub_upsid'] && $row['pnpslipsub_convtomp']=="Yes") echo $row['pnpslipsub_balpouch']; else echo ""; ?>" readonly="true" style="background-color:#CCCCCC" /><input type="hidden" name="nowb_<?php echo $sno?>" id="nowb_<?php echo $sno?>" size="7" maxlength="7" class="tbltext" value="" readonly="true" style="background-color:#CCCCCC" /></td>
<td width="61" align="center" valign="middle" class="tbltext" id="dtail_<?php echo $sno;?>"><?php if($row12['tid']==$row['pnpslipsub_upsid'] && $row['pnpslipsub_convtomp']=="Yes") {?><a href="Javascript:void(0)" onclick="detailspop('edit')">Details</a><?php }else{ ?>Fill<?php } ?></td>
</tr>
<?php	
