...
<title>Packaging - Transaction - Online Processing and Packing Slip</title>
...
<tr class="tblsubtitle" height="20">
  <td colspan="8" align="center" class="tblheading">Online Processing and Packing Slip Preview</td>
</tr>
...
<tr class="Light" height="20">
	...
	<td width="30" align="center" valign="middle" class="smalltbltext"><?php echo $row_tbl_sub['pnpslipsub_tlper'];?></td>
	<td width="107" align="center" valign="middle" class="smalltbltext"><?php echo $sloc;?></td>
	<td width="54" align="center" valign="middle" class="smalltbltext"><?php echo $row_tbl_sub['pnpslipsub_nomp'];?><input type="hidden" name="totlotnomp<?php echo $srno;?>" value="<?php echo $row_tbl_sub['pnpslipsub_nomp'];?>" /></td>
	<td width="54" align="center" valign="middle" class="smalltbltext"><?php echo $tot_barcnomp;?><input type="hidden" name="totlotbar<?php echo $srno;?>" value="<?php echo $tot_barcnomp;?>" /></td>
	<td width="54" align="center" valign="middle" class="smalltbltext"><a href="Javascript:void(0)" onclick="openpackdetails(<?php echo $row_tbl_sub['pnpslipsub_id']?>,<?php echo $arrival_id;?>)">View</a></td>
	<td width="54" align="center" valign="middle" class="smalltbltext"><?php if($row_tbl_sub['pnpslipsub_remarks']!=""){ ?><a href="Javascript:void(0)" title="<?php echo $row_tbl_sub['pnpslipsub_remarks'];?>" onmouseover="<?php echo $row_tbl_sub['pnpslipsub_remarks'];?>">Details</a><?php } ?></td>
        </tr>
  <?php
