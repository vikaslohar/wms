...
if(tp=="barcform")
{ 
	var url="getuser_pronpslip_barcvupdateform.php";
	url=url+"?"+str; 
	url=url+"&sid="+Math.random();
	xmlHttp.onreadystatechange=stateChanged ;
	xmlHttp.open("GET",url,true);
...
if(tp=="barcemtyform")
{ 
	var url="getuser_pronpslip_blanckbarcvupdateform.php";
	url=url+"?"+str; 
	url=url+"&sid="+Math.random();
	xmlHttp.onreadystatechange=stateChanged ;
	xmlHttp.open("GET",url,true);
...
if(tp=="bin")
{ 
	var url="getuser_vnsbindrop.php";
	url=url+"?a="+str;
	url=url+"&b="+d; 
	url=url+"&c="+e;
	url=url+"&sid="+Math.random();
...
if(tp=="subbin")
{ 
	var url="getuser_vnsbinck_pronpslip.php";
	url=url+"?a="+str;
	url=url+"&b="+d; 
	url=url+"&c="+e;
	url=url+"&f="+i;
...
if(tp=="subformprvedt")
{ 
	var url="getuser_pronpslip_previewedtsubform.php";
	url=url+"?a="+str;
	url=url+"&b="+d; 
	url=url+"&sid="+Math.random();
	xmlHttp.onreadystatechange=stateChanged ;
...
{
		//alert(tp); 
	var url="getuser_pronpslip_showrec_fc.php";
	url=url+"?a="+str;
	url=url+"&b="+d;
	url=url+"&c="+e;
	url=url+"&h="+i;
...
if(tp=="mformupdate")
{ 
	var url="getuser_pronpslip_prvupdateform.php";
	url=url+"?"+str; 
	url=url+"&sid="+Math.random();
	xmlHttp.onreadystatechange=stateChanged ;
	xmlHttp.open("GET",url,true);
