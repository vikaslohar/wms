...
$qr="select distinct lotno from tbl_lot_ldg_pack where lotldg_crop='".$crop."' and lotldg_variety='".$variety."'  $sss  order by lotdgp_id desc";
...
{	
	if($row24['trtype']="NSTPNPSLIP"){$nsflg=0;break;}
}
