<?php
	...
	if(isset($_POST['frm_action'])=='submit')
	{
		...
		if($subflg==1)
		{
			$sql_main="update tbl_pnpslipmain set pnpslipmain_tflag=0  where pnpslipmain_id ='$pid'";
...
if($trtype=="NST Packing Slip"){$trtyp='NST';}
	...
	$tdate2=$row_tbl['pnpslipmain_date'];
...
<tr class="Dark" height="30">
<td align="right"  valign="middle" class="smalltblheading">Pack Line Type&nbsp;</td>
    <td align="left"  valign="middle" class="smalltbltext" colspan="5" >&nbsp;<input name="txtdrefno" type="text" size="20" class="smalltbltext" maxlength="20" readonly="true" style="background-color:#CCCCCC" value="<?php echo $row_tbl['pnpslipmain_packlinetype'];?>" /></td>
	</tr>
</table><br />
