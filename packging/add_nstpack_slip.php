<?php
	...
	$sql_code="SELECT MAX(pnpslipmain_code) FROM tbl_pnpslipmain where pnpslipmain_ttype='NST Packing Slip' and yearid='$yearid_id'  ORDER BY pnpslipmain_code DESC";
	...
	if(mysqli_num_rows($res_code) > 0)
	{
		...
		$t_code=$row_code['0'];
		$code=$t_code+1;
		$code1="TNP".$code."/".$yearid_id."/".$lgnid;
	}
	else
	{
		$code=1;
