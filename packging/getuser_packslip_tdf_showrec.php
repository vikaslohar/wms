...
<?php
$sno=0; $srnonew=0;
$sqlcrop=mysqli_query($link,"select * from tblups_tdf order by uom Asc") or die(mysqli_error($link));
...
<tr class="Light" height="25">
<td width="49" align="center" valign="middle" class="tbltext"><input type="radio" name="fet" onClick="clk('<?php echo $sno?>',<?php echo $row12['tid'];?>);" id="fetchk_<?php echo $sno?>" value="<?php echo $row12['tid'];?>"/></td>
