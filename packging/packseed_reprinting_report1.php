  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#a8a09e" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#a8a09e" style="border-bottom:solid; border-bottom-color:#a8a09e" >
	    <tr >
	      <td width="813" height="25" class="Mainheading">&nbsp;Report - Re-Printing Sales Return Report As on Date <?php echo date("d-m-Y");?></td>
	    </tr></table></td>
...
<tr class="light" height="20">
  <td align="center" class="tblheading">Re-Printing Sales Return Report As on Date <?php echo date("d-m-Y");?></td>
</tr>
</table>
<?php
...
<tr class="tblsubtitle" height="25">
	...
	<td width="65" align="Center" class="tblheading">PK Slip No.</td>
	<td width="129" align="Center" class="tblheading">PK Slip Date</td>
	<td width="55" align="Center" class="tblheading">Lot No.</td>
	<td width="55" align="Center" class="tblheading">Size</td>	
	<td width="65" align="Center" class="tblheading">Re-Printing Qty</td>
	<td width="68" align="Center" class="tblheading">Pack Qty</td>
	<td width="108" align="Center" class="tblheading">Pack Loss</td>
	<td width="106" align="Center" class="tblheading">Pack DoP</td>
	<td width="60" align="Center" class="tblheading">Pack DoT</td>
	<td width="46" align="Center" class="tblheading">DoV</td>
	<td width="46" align="Center" class="tblheading">No. Of MP</td>
	<td width="46" align="Center" class="tblheading">Bin No.</td>
	<td width="46" align="Center" class="tblheading">Barcodes Atta. Details</td>
</tr>
<?php
...
$sql_binn=mysqli_query($link,"select * from tbl_bin whereplantcode='$plantcode' and binid='".$row_issuetbl['lotldg_binid']."' and whid='".$row_issuetbl['lotldg_whid']."'") or die(mysqli_error($link));
...
<tr height="25">
	...
	<td width="65" align="Center" class="tbltext"><?php echo $pksn?></td>	
	<td width="55" align="Center" class="tbltext"><?php echo $pksd;?></td>
	<td width="129" align="Center" class="tbltext"><?php echo $row_arr_home['lotldg_lotno']?></td>
	<td width="55" align="Center" class="tbltext"><?php echo totups;?></td>
	<td width="65" align="Center" class="tbltext"><?php echo $repqty;?></td>
	<td width="68" align="Center" class="tbltext"><?php echo $packqty;?></td>
	<td width="108" align="Center" class="tbltext"><?php echo $packloss;?></td>
	<td width="106" align="Center" class="tbltext"><?php echo $packdop;?></td>
	<td width="60" align="Center" class="tbltext"><?php echo $packdot;?></td>
	<td width="60" align="Center" class="tbltext"><?php echo $dov;?></td>
	<td width="60" align="Center" class="tbltext"><?php echo $nomp;?></td>
	<td width="60" align="Center" class="tbltext"><?php echo $binno;?></td>
	<td width="60" align="Center" class="tbltext"><?php echo $bardet;?></td>
</tr>
<?php
}
else
...
<tr class="Dark">
			...
			<td align="center" valign="middle" class="tblheading"><?php echo $totpackqty;?></td>
			<td align="center" valign="middle" class="tblheading"><?php echo $totpackloss;?></td>
...
<tr >
<td valign="top" align="center"><a href="reprinting_sr_report.php"><img src="../images/back.gif" border="0"style="display:inline;cursor:pointer;"  /></a>&nbsp;&nbsp;<img src="../images/printpreview.gif" onclick="openprint()" style="cursor:pointer" border="0" /></td>
</tr>
</table>
</td><td width="30"></td>
</tr>
