...
if($t > 0)
{
 ...
 { 
	//echo $row_arr_home['lotno']."  =>  ".$row_issuetbl['lotdgp_id']."  ==>  ".$row_issuetbl['balqty']."<BR>";
...
?>
<table align="center" border="0" cellspacing="0" cellpadding="0" width="950" bordercolor="#1dbe03" style="border-collapse:collapse">
<tr height="25" >
