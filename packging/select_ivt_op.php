...
<title>Packaging - Transction - Lot Merger - Select output</title>
...
$tid=$pid;
$sql_tbl=mysqli_query($link,"select * from tbl_ivtmain where plantcode='$plantcode' and ivt_id=$tid") or die(mysqli_error($link));
