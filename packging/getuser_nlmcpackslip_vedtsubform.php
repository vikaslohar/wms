<?php
	...
	$sql_tbl_sub=mysqli_query($link,"select * from tbl_pnpslipsub where plantcode='$plantcode' pnpslipsub_id='".$a."'") or die(mysqli_error($link));
	$row=mysqli_fetch_array($sql_tbl_sub);
  	$tot_tbl_sub=mysqli_num_rows($sql_tbl_sub);
	$tid=$row['pnpslipmain_id'];
	$subtid=$a;

	$sql_tbl=mysqli_query($link,"select * from tbl_pnpslipmain where plantcode='$plantcode' pnpslipmain_id='".$tid."'") or die(mysqli_error($link));
...
<table align="center" border="1" width="970" cellspacing="0" cellpadding="0" bordercolor="#1dbe03" style="border-collapse:collapse" >	
  ...
  <tr class="Light" height="25">
	...
	<td width="113" align="center" valign="middle" class="smalltblheading"><?php echo $tdate31;?></td>
	<td width="113" align="center" valign="middle" class="smalltblheading"><?php echo $tdate32;?><input type="hidden" name="qctestdate" value="<?php echo $tdate3;?>" /><input type="hidden" name="dp1" value="<?php echo $dp1;?>" /><input type="hidden" name="dp2" value="<?php echo $dp2;?>" /><input type="hidden" name="dp3" value="<?php echo $dp3;?>" /><input type="hidden" name="qcdttype" value="<?php echo $row['pnpslipsub_qcdttype'];?>" /></td>
...
$sql_issue=mysqli_query($link,"select distinct lotldg_whid, lotldg_subbinid, lotldg_binid from tbl_lot_ldg where plantcode='$plantcode' lotldg_lotno='".$row['pnpslipsub_lotno']."'  and lotldg_balqty > 0") or die(mysqli_error($link));

 while($row_issue=mysqli_fetch_array($sql_issue))
 { 

$sql_issue1=mysqli_query($link,"select max(lotldg_id) from tbl_lot_ldg where plantcode='$plantcode' lotldg_subbinid='".$row_issue['lotldg_subbinid']."' and lotldg_binid='".$row_issue['lotldg_binid']."' and lotldg_whid='".$row_issue['lotldg_whid']."' and lotldg_lotno='".$row['pnpslipsub_lotno']."' ") or die(mysqli_error($link));
$row_issue1=mysqli_fetch_array($sql_issue1); 

$sql_issuetbl=mysqli_query($link,"select * from tbl_lot_ldg where plantcode='$plantcode' lotldg_id='".$row_issue1[0]."' and lotldg_balqty > 0") or die(mysqli_error($link)); 
...
$sql_whouse=mysqli_query($link,"select perticulars from tbl_warehouse where plantcode='$plantcode' whid='".$row_issuetbl['lotldg_whid']."' order by perticulars") or die(mysqli_error($link));
$row_whouse=mysqli_fetch_array($sql_whouse);
$wareh=$row_whouse['perticulars'];

$sql_binn=mysqli_query($link,"select binname from tbl_bin where plantcode='$plantcode' binid='".$row_issuetbl['lotldg_binid']."' and whid='".$row_issuetbl['lotldg_whid']."'") or die(mysqli_error($link));
$row_binn=mysqli_fetch_array($sql_binn);
$binn=$row_binn['binname'];

$sql_subbinn=mysqli_query($link,"select sname from tbl_subbin where plantcode='$plantcode' sid='".$row_issuetbl['lotldg_subbinid']."' and binid='".$row_issuetbl['lotldg_binid']."' and whid='".$row_issuetbl['lotldg_whid']."'") or die(mysqli_error($link));
...
$sql_tbl_subsub=mysqli_query($link,"select * from tbl_pnpslipsubsub where plantcode='$plantcode' pnpslipsub_id='".$row['pnpslipsub_id']."' and pnpslipmain_id='".$tid."'  and pnpslipsubsub_wh='".$row_issuetbl['lotldg_whid']."' and pnpslipsubsub_bin='".$row_issuetbl['lotldg_binid']."' and pnpslipsubsub_subbin='".$row_issuetbl['lotldg_subbinid']."'") or die(mysqli_error($link));
...
$sql_tbl_subsub2=mysqli_query($link,"select * from tbl_pnpslipsubsub2 where plantcode='$plantcode' pnpslipsub_id='".$row['pnpslipsub_id']."' and pnpslipmain_id='".$tid."' order by pnpslipsubsub_id asc") or die(mysqli_error($link));
...
<?php
$bind1_query=mysqli_query($link,"select binid, binname from tbl_bin where plantcode='$plantcode' whid='".$row_tbl_subsub2['pnpslipsubsub_wh']."' order by binname") or die(mysqli_error($link));
?>
...
<?php
$subbind1_query=mysqli_query($link,"select sid, sname from tbl_subbin where plantcode='$plantcode' binid='".$row_tbl_subsub2['pnpslipsubsub_bin']."' order by sname") or die(mysqli_error($link));
?>	
...
<?php
$sno3=0;
$sql_tbl_subsub3=mysqli_query($link,"select * from tbl_pnpslipsubsub3 where plantcode='$plantcode' pnpslipsub_id='".$row['pnpslipsub_id']."' and pnpslipmain_id='".$tid."' order by pnpslipsubsub_id asc") or die(mysqli_error($link));
...
<td align="center" valign="middle" class="tbltext"><input type="text" class="tbltext" name="nopmpcs_<?php echo $sno3;?>" id="nopmpcs_<?php echo $sno3;?>" value="<?php echo $row_tbl_subsub3['pnpslipsubsub_nomp'];?>" size="9"  onchange="pacsbinchk(this.value,<?php echo $sno3;?>)" <?php if($row['pnpslipsub_convtomp']!="Yes") echo "readonly='true' style='background-color:#CCCCCC'";?>  /></td>
