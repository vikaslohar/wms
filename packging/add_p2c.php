<?php
	...
	if(isset($_POST['frm_action'])=='submit')
	{
	   // exit;
		...
		$sql="Insert into tbl_psunpp2c (unp_date, unp_tcode, unp_p2ctype, unp_crop, unp_variety, unp_lotno, unp_orlot, unp_newlotno, unp_ups, unp_logid, unp_yearcode, plantcode) values('$dt', '$tcode', '$ptptype', '$crop', '$variety', '$lotno', '$orlot', '$txtnewlot', '$ups', '$logid', '$yearid_id', '$plantcode')";
...
<?php
	...
	$sql_code="SELECT MAX(unp_tcode) FROM tbl_psunpp2c where unp_yearcode='$yearid_id'  ORDER BY unp_tcode DESC";
