<?php
	...
	$so_array="";
	$arr=explode(",",$abarc);
	$main_array1=array($arr);
	$main_array1=array_unique($main_array1);
...
<td  align="right" class="tblheading" colspan="2">No of Barcodes to be entered - as per Master Packs&nbsp;</td><td colspan="2" align="left" class="tblheading">&nbsp;<input type="text" name="nobapmp" id="nobapmp" class="tbltext" value="<?php echo $totnomp;?>" style="background-color:#CCCCCC" readonly="true" size="5" /></td>
</tr>
<tr class="light" height="20">
  <td  align="right" class="tblheading" colspan="2">No of Barcodes entered&nbsp;</td><td colspan="2" align="left" class="tblheading">&nbsp;<input type="text" name="nobe" id="nobe" class="tbltext" style="background-color:#CCCCCC" readonly="true" size="5" value="<?php echo $nobe;?>" /></td>
</tr>
<!--<tr class="light" height="20">
...
<tr class="light" height="20">
  <td  align="right" class="tblheading" colspan="2">No. of Duplicate Barcodes - already present in system&nbsp;</td><td colspan="2" align="left" class="tblheading">&nbsp;<input type="text" name="nobdups" id="nobdups" class="tbltext" style="background-color:#CCCCCC" readonly="true" size="5" value="<?php echo $count;?>" /></td>
</tr>
<tr class="light" height="20">
  <td  align="right" class="tblheading" colspan="2">Net Number of Barcodes&nbsp;</td><td colspan="2" align="left" class="tblheading">&nbsp;<input type="text" name="nnob" id="nnob" class="tbltext" style="background-color:#CCCCCC" readonly="true" size="5" value="<?php echo $nnob-$count;?>" /></td>
</tr>
...
<tr >
<td align="center" colspan="3"><a href="getuser_pronpslip_barcode_sel.php?totnomp=<?php echo $totnomp?>&tid=<?php echo $tid?>&subtid=<?php echo $subtid?>&lotno=<?php echo $lotno?>&txtpsrn=<?php echo $txtpsrn?>&nobe=<?php echo $nobe?>&nobmos=<?php echo $nobmos?>&nnob=<?php echo $nnob?>&dval=<?php echo $dval?>&dobg=<?php echo $dobg?>&operatorcode=<?php echo $operatorcode?>&wtmaccode=<?php echo $wtmaccode?>" ><img src="../images/back.gif" border="0" style="cursor:pointer" /></a>&nbsp;<input type="image" src="../images/submit.gif" alt="Submit Value" border="0" style="display:inline;cursor:pointer;" onclick="return mySubmit();"/></td>
</tr>
</table>
</form>
</td></tr>
