<?php
	...
	$sql_tbl_sub=mysqli_query($link,"select * from tbl_packagingsub_sub where plantcode='$plantcode' and packagingsubsub_id='".$a."'") or die(mysqli_error($link));
