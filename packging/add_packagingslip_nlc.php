<?php
	...
	{
		//exit;
		//frm_action=submit&txtid=1&plantcodes=D%2CH&yearcodes=A%2CD%2CF%2CK%2CN%2CP%2CS&cdate=29-01-2015&date=29-01-2015&dopc=29-01-2015&txtpsrn=Test&txtcrop=51&txtvariety=528&txtups=125.000%20Gms&nlcweight=30&barcode=DP010000001&bardupchk=0&weight=30.01&txtstage=Pack&txtlot2=DF09190%2F00000%2F00P%0ADF09286%2F00000%2F00P&txtlot1=DF09190%2F00000%2F00P%2CDF09286%2F00000%2F00P&maintrid=0&subtrid=0&lotno_1=DF09190%2F00000%2F00P&softstatus=&upssize=125.000%20Gms&wtnopkg_1=&upsname_1=125.000%20Gms&txtextnob=96&txtextqty=12&txtonob=96&txtoqty=12&txtqty=12&nomp_1=96&wtmp_1=30&wtnop_1=240&noofpacks_1=0&nowb_1=&txtbqty=0&exwh1_1=1&exbin1_1=136&exsubbin1_1=2719&extnomphs1_1=0&extnophs1_1=96&extqtyhs1_1=12&qtyphs1_1=12&nophs1_1=96&balnophs1_1=0&sno33_1=1&lotno_2=DF09286%2F00000%2F00P&softstatus=&upssize=125.000%20Gms&wtnopkg_2=&upsname_2=125.000%20Gms&txtextnob=272&txtextqty=34&txtonob=176&txtoqty=22&txtqty=18&nomp_2=144&wtmp_2=30&wtnop_2=240&noofpacks_2=32&nowb_2=&txtbqty=4&exwh2_1=1&exbin2_1=136&exsubbin2_1=2719&extnomphs2_1=0&extnophs2_1=176&extqtyhs2_1=22&qtyphs2_1=18&nophs2_1=144&balnophs2_1=32&sno33_2=1&sno=2&detmpbno=1&upsidno=&nopks=&extwh=1%2C1&extbin=136%2C136&extsubbin=2719%2C2719&sno3=0&tsno=0&txtwhg1=1&txtbing1=136&txtsubbg1=2719&existview1=Bhindi%2C%20VNR-999%2C%20Pack%2C%20%3Ca%20href%3D'Javascript%3Avoid(0)'%20onclick%3D'openprintsubbin(2719%2C136%2C1%2C32852)'%3EDetails%3C%2Fa%3E&trflg1=0&tpflg1=0&tflg1=0&tpmflg1=0&nopmpcs_1=1&noppchs_1=&noptpchs_1=240&noptqtys_1=30
		...
		$sql_main="insert into tbl_packaging (packaging_type, packaging_tdate, packaging_code,  packaging_date, packaging_slipno, packaging_remarks, packaging_yearid, packaging_logid, packaging_barcode, packaging_mptype, plantcode) values ('$ttype', '$tdate1', '$txtid', '$tdate2', '$txtpsrn', '$txtremarks', '$yearid_id', '$logid', '$barcode', '$mptyp', '$plantcode')";
   		//$sql_main="insert into tbl_packaging (packaging_type, packaging_tdate, packaging_code,  packaging_date, packaging_slipno, packaging_remarks, packaging_yearid, packaging_logid) values ('$ttype', '$tdate1', '$txtid', '$tdate2', '$txtpsrn', '$txtremarks', '$yearid_id', '$logid')";
		...
		//exit;
		$p_id=$mainid;
		echo "<script>window.location='add_packagingslipnlc_preview.php?p_id=$p_id'</script>";	
		}
	}
...
function pacqtychk(pacpcval, snoval, sno33val)
{
	...
	//alert(document.getElementById(nophs).value);
	if(parseInt(document.getElementById(nophs).value)>parseInt(document.getElementById(nomp).value))
	{
		alert("NoP from SLOC cannot be more than NoP");
		document.getElementById(nophs).value="";
...
<td width="240"  align="left" valign="middle" class="smalltbltext" id="tnopinmp">&nbsp;<input type="text" name="nlcweight" id="nlcwt" class="tbltext" size="6" maxlength="6" onchange="chkups(this.value);" onkeypress="return isNumberKey1(event)" value=""  />&nbsp;Kgs.&nbsp;<font color="#FF0000">*</font>&nbsp;</td>

</tr>
<tr class="Light" height="30">
	<td width="240" align="right"  valign="middle" class="smalltblheading" >Barcode&nbsp;</td>
    <td width="240" align="left"  valign="middle" class="smalltblheading" id="barserch">&nbsp;<input type="text" name="barcode" class="smalltbltext" size="11" maxlength="11" value="<?php echo $row_month['code'];?><?php echo $yearid_id;?>" onchange="barcheck(this.value)" onblur="javascript:this.value=this.value.toUpperCase();" onkeyup="searchbarcode(this.value)" onkeypress="return isNumberKey24(event)" />&nbsp;<font color="#FF0000">*</font>&nbsp;<input type="hidden" name="bardupchk" value="0" /></td>
...
<tr class="Light" height="30">
  <td align="right" class="tblheading">MP Type&nbsp;</td>
   ...
   <option value="Carton" selected="selected">Carton</option>
...
<td align="left" width="241" valign="middle" class="smalltbltext">&nbsp;<textarea name="txtlot2" class="smalltbltext" cols="25" rows="3" readonly="readonly" style="background-color:#CCCCCC"></textarea><input name="txtlot1" type="hidden" value="" >&nbsp;<font color="#FF0000">*</font>&nbsp;&nbsp;<a href="Javascript:void(0);" onclick="openslocpop();">Select</a></td>
