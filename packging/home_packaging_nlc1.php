...
$sql_arr_home=mysqli_query($link,"select * from tbl_packaging where plantcode='$plantcode' and packaging_type='NLC' and packaging_tdate>='$tdate' and packaging_tdate<='$pdate' and packaging_tflg=1 order by packaging_tcode desc LIMIT $from, $max_results") or die(mysqli_error($link));
$tot_arr_home=mysqli_num_rows($sql_arr_home);
//$tot_arr_home=0;

$total_results3 =mysqli_query($link,"SELECT COUNT(*)  FROM tbl_packaging where plantcode='$plantcode' and packaging_type='NLC' and packaging_tdate>='$tdate' and packaging_tdate<='$pdate' and packaging_tflg=1");
...
<tr >
<td valign="top" align="right"><a href="home_packaging_nlc.php"><img src="../images/back.gif" border="0"style="display:inline;cursor:Pointer;" /></a></td>
</tr>
</table>
