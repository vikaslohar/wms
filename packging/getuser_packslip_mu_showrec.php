...
if($tot_row > 0)
{
	$nob=0; $qty=0; $softstatus=""; $qc=""; $qcdot=""; $qcdot1=""; $qcdot2=""; $qcdttype="";
 	...
 	{ 
		$sql_issue1=mysqli_query($link,"select max(lotldg_id) from tbl_lot_ldg where lotldg_subbinid='".$row_issue['lotldg_subbinid']."' and lotldg_binid='".$row_issue['lotldg_binid']."' and lotldg_whid='".$row_issue['lotldg_whid']."' and lotldg_lotno='".$a."' ") or die(mysqli_error($link));
...
<?php
$sqlvsriety=mysqli_query($link,"Select * from tblvariety where plantcode='$plantcode' and varietyid='".$c."' and actstatus='Active'") or die(mysqli_error($link));
