...
$barccount=count(str_split($barcode));
if($z1 > 0)
{
$sqlbarc6=mysqli_query($link,"SELECT pnpslipbar_barcode FROM tbl_pnpslipbarcode where plantcode='$plantcode' and pnpslipbar_barcode='$barcode'" ) or die("Error: " . mysqli_error($link));
$to60=mysqli_num_rows($sqlbarc6);
$sqlbarc61=mysqli_query($link,"SELECT mpmain_barcode FROM tbl_mpmain where plantcode='$plantcode' and mpmain_barcode='$barcode'" ) or die("Error: " . mysqli_error($link));
$to61=mysqli_num_rows($sqlbarc61);
if($to60==0 && $to61==0 && $barccount==11)
{
   $sql_sub="Update tbl_pnpslipsub SET pnpslipsub_lblschar='$domcs_1', pnpslipsub_lblsno='$lbls_1', pnpslipsub_lbechar='$domcs_1', pnpslipsub_lbeno='$lble_1', pnpslipsub_lblschar2='$domcs_2', pnpslipsub_lblsno2='$lbls_2', pnpslipsub_lbechar2='$domcs_2', pnpslipsub_lbeno2='$lble_2', pnpslipsub_pnop='$pouches', pnpslipsub_balpouch='$noofpcks' where pnpslipmain_id='$maintrid' and pnpslipsub_plotno='$txtplotno' and pnpslipsub_id='$sid'";
$xxzx=mysqli_query($link,$sql_sub) or die(mysqli_error($link));


   $sql_main="insert into tbl_pnpslipbarcode(pnpslipmain_id, pnpslipsub_id, pnpslipbar_lotno,  pnpslipbar_ups, pnpslipbar_barcode, pnpslipbar_wtmp, pnpslipbar_grosswt, pnpslipbar_wtdate, pnpslipbar_wtmcode, pnpslipbar_wtmopr, pnpslipbar_wtgrfr, pnpslipbar_wtgrto, pnpslipbar_bctype, pnpslipbar_logid, pnpslipbar_yearid,  pnpslipbar_whid, pnpslipbar_binid, pnpslipbar_subbinid, pnpslipbar_nop, plantcode) values ('$maintrid','$sid','$txtplotno','$upssize','$barcode','$pnpwtmp', '$weight', '$dobg', '$wtmaccode', '$operatorcode', '$wtrangefr', '$wtrangeto', 'SMC', '$logid', '$yearid_id', '$txtwhg1', '$vbin_1', '$vsubbin_1', '$slnop_1', '$plantcode')";
