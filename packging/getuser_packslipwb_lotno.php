...
$qr="select distinct lotldg_lotno from tbl_lot_ldg where lotldg_crop='".$crop."' and lotldg_variety='".$variety."' and lotldg_sstage='".$stage."' and lotldg_whid=5 and lotldg_mergerflg=0 $sss  order by lotldg_id desc";
...
$lotqry=mysqli_query($link,"select distinct lotldg_whid, lotldg_subbinid, lotldg_binid from tbl_lot_ldg where plantcode='$plantcode' and lotldg_lotno='".$row['lotldg_lotno']."' and lotldg_whid=5") or die(mysqli_error($link));
