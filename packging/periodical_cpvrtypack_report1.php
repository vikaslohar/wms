...
<title>Packaging - Report - Crop Variety Wise Packed Seed Report As on <?php echo date("d-m-Y");?></title>
...
winHandle=window.open('periodical_cpvrtypack_report2.php?txtcrop='+itemid+'&txtvariety='+vv+'&txtupsdc='+txtupsdc,'WelCome','top=20,left=80,width=950,height=600,scrollbars=yes');
if(winHandle==null){
