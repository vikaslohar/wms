...
<td width="55" align="center" valign="middle" class="tbltext"><input type="text" name="nopinwb_<?php echo $sno?>" id="nopinwb_<?php echo $sno?>" size="7" maxlength="7" class="tbltext" value=""  onchange="calnopinwb(this.value)"  /></td>
...
<tr class="tblsubtitle" height="25">
	...
	<td align="left" valign="middle" class="tblheading">&nbsp;MP Weight (Kgs) (Kgs)</td>
</tr>
