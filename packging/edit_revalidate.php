<?php
	...
	if(isset($_POST['frm_action'])=='submit')
	{
		...
		$sql_sub="update tbl_revalidatetemp set rv_date='$date', rv_crop='$crop', rv_variety='$variety', rv_lotno='$lotno', rv_newlot='$txtnewlot', rv_orlot='$orlot', rv_ups='$upssize', rv_enop='$enop', rv_eqty='$eqty', rv_qc='$qcsts', rv_dot='$dot', rv_got='$got', rv_got1='$got1', rv_dogt='$dogt', rv_rvpsrn='$txtpsrno', rv_dorvp='$dcdate', rv_qcnop='$txtnopqc', rv_bnop='$txtbnop', rv_bqty='$txtbqty', rv_valperiod='$validityperiod', rv_valupto='$validityupto', rv_valdays='$valdays', rv_slable='$slable', rv_elable='$elable', rv_tcode='$tcode', rv_logid='$logid', rv_yearcode='$yearid_id', rv_pid='$pid', rv_rvtyp='$ptptype', rv_mptyp='$pkgtype', rv_pl='$txtnoppl', rv_pnomp='$nomp_1', rv_bpch='$noofpacks_1' where rv_id='$sid'";
		if(mysqli_query($link,$sql_sub) or die(mysqli_error($link)))
		{
			$subid=$sid;
			$s_del="delete from tbl_revalidatetmp_sub where rv_id='$subid'";
			$xsw=mysqli_query($link,$s_del) or die(mysqli_error($link));
			$s_del2="delete from tbl_revalidatetmp_sub2 where rv_id='$subid'";
		...
		//exit;
		echo "<script>window.location='add_revalidate_preview.php?p_id=$pid&sid=$sid'</script>";	
	}
...
<td width="267"  align="left" valign="middle" class="tbltext">&nbsp;<?php echo "TRV".$row_tbl2['rv_tcode']."/".$row_tbl2['rv_yearcode']."/".$row_tbl2['rv_logid'];?></td>
...
<td align="left" width="267" valign="middle" class="tbltext">&nbsp;<?php echo $row_tbl2['rv_enop'];?><input type="hidden" name="enop" value="<?php echo $row_tbl['rv_enop'];?>" /></td>	
<td align="right" width="229" valign="middle" class="tblheading">Qty&nbsp;</td>
<td align="left" width="251" valign="middle" class="tbltext">&nbsp;<?php echo $row_tbl2['rv_eqty'];?><input type="hidden" name="eqty" value="<?php echo $row_tbl['rv_eqty'];?>" /></td>	
</tr>
<tr class="Light" height="30" >
<td align="right"   valign="middle" class="tblheading">QC Status&nbsp;</td>
<td align="left"  valign="middle" class="tbltext">&nbsp;<?php echo $row_tbl['rv_qc'];?><input type="hidden" name="qcsts" value="<?php echo $row_tbl['rv_qc'];?>" /></td>	
...
<td align="left"  valign="middle" class="tbltext"   >&nbsp;<?php echo $row_tbl['rv_got'];?><input type="hidden" name="got" value="<?php echo $row_tbl['rv_got'];?>" /></td>
...
<td align="left" width="191" valign="middle" class="tblheading"   >&nbsp;<input type="radio" name="ptptyp" class="tbltext" value="entire" onclick="chklot(this.value);" <?php if($row_tbl['rv_rvtyp']=="entire") echo "checked"; ?> />Entire&nbsp;&nbsp;<input type="radio" name="ptptyp" class="tbltext" value="partial" onclick="chklot(this.value);" <?php  if($row_tbl['rv_rvtyp']=="partial") echo "checked"; ?>   />Partial&nbsp;<font color="#FF0000">*</font>&nbsp;<input type="hidden" name="ptptype" value="<?php echo $row_tbl['rv_rvtyp'];?>" /></td>
<td align="left"  valign="middle" class="tblheading" colspan="2" id="batchchk">&nbsp;<?php if($tflg>0) echo "Batch No. Generated - <font color=red>YES</font>"; else if($row_tbl['rv_rvtyp']=="partial") echo "Batch No. Generated - <font color=red>YES</font>"; else if($row_tbl['rv_rvtyp']=="entire") echo "Batch No. Generated - <font color=red>YES</font>"; else echo ""; ?></td>
<td align="right" width="113"  valign="middle" class="tblheading">Lot number&nbsp;</td>
<td align="left" width="221"  valign="middle" class="tblheading">&nbsp;<input name="txtnewlot" type="text" size="20" class="tbltext" tabindex=""   maxlength="20" value="<?php echo $row_tbl['rv_newlot'];?>"  style="background-color:#CCCCCC" readonly="true"/>&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
</tr>
<tr class="Light" height="30" >
<td align="right" width="105"  valign="middle" class="tblheading">NoP&nbsp;</td>
<td align="left" width="191" valign="middle" class="tbltext">&nbsp;<input name="txtenop" type="text" size="9" class="tbltext" tabindex="0" maxlength="9" value="<?php echo $np;?>" <?php if($row_tbl['rv_rvtyp']=="entire") echo "style='background-color:#CCCCCC' readonly='true'"; ?>  onkeypress="return isNumberKey(event)" onchange="chknop(this.value);" /></td>	
...
<td align="left" width="221" valign="middle" class="tbltext">&nbsp;<input name="bnop" type="text" size="9" class="tbltext" tabindex="0" maxlength="9" value="<?php echo $bnp;?>" style="background-color:#CCCCCC" readonly="true" onkeypress="return isNumberKey(event)" /></td>	
</tr>
<tr class="Light" height="30" >
<td align="right" width="105"  valign="middle" class="tblheading">Qty&nbsp;</td>
<td align="left" width="191" valign="middle" class="tbltext">&nbsp;<input name="txteqty" type="text" size="9" class="tbltext" tabindex="0" maxlength="9" value="<?php echo $qt;?>"  <?php if($row_tbl['rv_rvtyp']=="entire") echo "style='background-color:#CCCCCC' readonly='true'"; ?> onkeypress="return isNumberKey1(event)" onchange="chkqty(this.value);" /></td>	
<td align="left"  valign="middle" class="tblheading" colspan="2">&nbsp;</td>
<td align="right" width="113" valign="middle" class="tblheading">Balance Qty&nbsp;</td>
<td align="left" width="221" valign="middle" class="tbltext">&nbsp;<input name="bqty" type="text" size="9" class="tbltext" tabindex="0" maxlength="9" value="<?php echo $bqt;?>" style="background-color:#CCCCCC" readonly="true" onkeypress="return isNumberKey1(event)" /></td>	
</tr>
<input type="hidden" name="orlot" value="<?php echo $orlot;?>" />
...
?>
 ...
 <td  align="center"  valign="middle" class="smalltbltext" ><input name="recnobp_<?php echo $srno2?>" id="recnobp<?php echo $srno2?>" type="text" size="7" class="smalltbltext" tabindex=""   maxlength="7" onkeypress="return isNumberKey(event)"   <?php if($row_tbl['rv_rvtyp']=="entire") echo "style='background-color:#CCCCCC' readonly='true'"; ?> onchange="qtychk1(this.value,<?php echo $srno2?>);" value="<?php echo $rnob;?>"  />&nbsp;<font color="#FF0000" >* </font>&nbsp;</td>

  
  <td  align="center"  valign="middle" class="smalltbltext"><input name="recqtyp_<?php echo $srno2?>" id="recqtyp<?php echo $srno2?>" type="text" size="8" class="smalltbltext" tabindex="" maxlength="10"   <?php if($row_tbl['rv_rvtyp']=="entire") echo "style='background-color:#CCCCCC' readonly='true'"; ?> onchange="Bagschk1(this.value,<?php echo $srno2?>);"  onkeypress="return isNumberKey1(event)" value="<?php echo $rqty;?>"  />&nbsp;<font color="#FF0000" >* </font>&nbsp;</td>
  
      <td align="center"  valign="middle" class="smalltbltext"><input name="txtbalnobp_<?php echo $srno2?>" id="txtbalnobp<?php echo $srno2?>" type="text" size="7" class="smalltbltext" tabindex="" maxlength="7" onkeypress="return isNumberKey(event)" style="background-color:#CCCCCC" readonly="true" value="<?php echo $blnob;?>"  /></td>
       
      <td align="center"  valign="middle" class="smalltbltext"><input name="txtbalqtyp_<?php echo $srno2?>" id="txtbalqtyp<?php echo $srno2?>" type="text" size="8" class="smalltbltext" tabindex=""   maxlength="10" onkeypress="return isNumberKey1(event)" style="background-color:#CCCCCC" readonly="true" value="<?php echo $blqty;?>" /></td>
  </tr>
 <?php
  }
}
...
<td align="left" valign="middle" class="tblheading" colspan="2">&nbsp;<input type="text" name="txtpsrno" id="txtpsrtno" class="smalltbltext" value="<?php echo $row_tbl['rv_rvpsrn'];?>" size="15" onchange="chktotnop();"  />&nbsp;<font color="#FF0000" >* </font>&nbsp;</td>
<td align="right" valign="middle" class="tblheading" colspan="2">Date of Re-Printing/Packing&nbsp;</td>
<td width="148" align="left" valign="middle" class="tblheading" id="pltno">&nbsp;<input name="dcdate" id="dcdate" type="text" size="10" class="tbltext" tabindex="0" readonly="true"  style="background-color:#CCCCCC" value="<?php echo $dorvp;?>" maxlength="10"/>&nbsp;<a href="javascript:void(0)" onClick="showCalendar('dcdate');" tabindex="6"><img src="../images/cal.gif" alt="Calender" border="0" align="absmiddle"></a>&nbsp;<font color="#FF0000" >* </font>&nbsp;<script type="text/javascript" language="javascript" src="../include/popcalender.js"></script> </td>
</tr>

<tr class="Light" height="25">
<td align="right" valign="middle" class="tblheading">NoP - QC Sample&nbsp;</td>
<td align="left" valign="middle" class="tblheading" colspan="2">&nbsp;<input type="text" name="txtnopqc" id="txtnopqc" class="smalltbltext" value="<?php echo $row_tbl['rv_qcnop'];?>" size="2" onchange="psrnchk(this.value);" onkeypress="return isNumberKey(event)"  />&nbsp;<font color="#FF0000" >* </font>&nbsp;</td>
<td align="right" valign="middle" class="tblheading" colspan="2">NoP - Re-Printing Packing Loss&nbsp;</td>
<td align="left" valign="middle" class="tblheading">&nbsp;<input type="text" name="txtnoppl" id="txtnoppl" class="smalltbltext" value="<?php echo $row_tbl['rv_pl'];?>" size="2" onchange="psrnchk1(this.value);" onkeypress="return isNumberKey(event)"  />&nbsp;<font color="#FF0000" >* </font>&nbsp;</td>
</tr>
<tr class="Light" height="25">
<td align="right" valign="middle" class="tblheading">Balance Pouches&nbsp;</td>
<td align="left" valign="middle" class="tblheading" colspan="2">&nbsp;<input type="text" name="txtbnop" id="txtbnop" class="smalltbltext" value="<?php echo $row_tbl['rv_bnop'];?>" size="9" readonly="true" style="background-color:#CCCCCC" /></td>
<td align="right" valign="middle" class="tblheading" colspan="2">Balance Quantity&nbsp;</td>
<td align="left" valign="middle" class="tblheading" id="pltno">&nbsp;<input type="text" name="txtbqty" id="txtbqty" class="smalltbltext" value="<?php echo $row_tbl['rv_bqty'];?>" size="9" readonly="true" style="background-color:#CCCCCC" /></td>
</tr>
<tr class="Light" height="25">
...
<option <?php if($row_tbl['rv_valperiod']==9) echo "Selected";?> value="9" >9</option>
<option <?php if($row_tbl['rv_valperiod']==6) echo "Selected";?> value="6" >6</option>
<option <?php if($row_tbl['rv_valperiod']==3) echo "Selected";?> value="3" >3</option>
</select>&nbsp;Months&nbsp;<font color="#FF0000" >* </font>&nbsp;</td>
<td width="87" align="right" valign="middle" class="tblheading">Valid upto&nbsp;</td>
<td width="112" align="left" valign="middle" class="tblheading">&nbsp;<input type="text" class="tbltext" name="validityupto" id="validityupto" value="<?php echo $dov;?>" size="12" readonly="true" style="background-color:#ECECEC"  /></td>
<td width="151" align="right" valign="middle" class="tblheading">Validity Days&nbsp;</td>
<td width="148" align="left" valign="middle" class="tblheading">&nbsp;<input type="text" name="valdays" id="valdays" size="4" class="tblheading" value="<?php echo $row_tbl['rv_valdays'];?>" readonly="true" style="background-color:#ECECEC; color:#FF0000" />&nbsp;Days From DoT</td>
</tr>
<tr class="Light" height="25">  
<?php 
$x=implode(",", str_split($row_tbl['rv_slable']));
$y=implode(",", str_split($row_tbl['rv_elable']));
$x=explode(",", $x);
$y=explode(",", $y);
...
<td width="144" align="left" valign="middle" class="tbltext"><input type="radio" name="pckgtyp" id="pckgtyp" value="Yes" onclick="pcksel(this.value);" <?php if($row_tbl['rv_mptyp']=="Yes") echo "checked";?> />&nbsp;Yes&nbsp;&nbsp;<input type="radio" name="pckgtyp" id="pckgtyp" value="No" onclick="pcksel(this.value);" <?php if($row_tbl['rv_mptyp']=="No") echo "checked";?> />&nbsp;No<input type="hidden" name="pkgtype" value="<?php echo $row_tbl['rv_mptyp'];?>" /></td>
<td width="76" align="center" valign="middle" class="tblheading">No. of MP</td>

<td width="83" align="center" valign="middle" class="tbltext"><input type="text" name="nomp_1" id="nomp_1" size="7" maxlength="7" class="tbltext" value="<?php if($row_tbl['rv_mptyp']=="Yes") echo $row_tbl['rv_pnomp']; else echo "";?>"   <?php if($row_tbl['rv_mptyp']=="No") echo "style='background-color:#CCCCCC' readonly='true'"; ?> onchange="balnopcheck(this.value, 1)"/><input type="hidden" name="wtmp_1" id="wtmp_1" value="<?php echo $wtmp?>" /><input type="hidden" name="wtnop_1" id="wtnop_1" value="<?php echo $mptnop?>" /><input type="hidden" name="wtnopkg_1" id="wtnopkg_1" value="<?php echo $wtnopkg;?>" /> <input type="hidden" name="upsname_1" id="upsname_1" value="<?php echo $row_tbl['rv_ups'];?>" /></td>
<td width="140" align="center" valign="middle" class="tblheading">Balance Pouches</td>

<td width="82" align="center" valign="middle" class="tbltext"><input type="text" name="noofpacks_1" id="noofpacks_1" size="7" maxlength="7" class="tbltext" value="<?php if($row_tbl['rv_mptyp']=="Yes") echo $row_tbl['rv_bpch']; else echo "";?>" readonly="true" style="background-color:#CCCCCC" /><input type="hidden" name="nowb_1" id="nowb_1" size="7" maxlength="7" class="tbltext" value="" readonly="true" style="background-color:#CCCCCC" /></td>
<td width="130" align="center" valign="middle" class="tblheading">Barcode Labels</td>
<td width="61" align="center" valign="middle" class="tbltext" id="dtail_1"><?php if($row_tbl['rv_mptyp']=="Yes") {?><a href="Javascript:void(0)" onclick="detailspop('edit')">Details</a><?php }else{ ?>Fill<?php } ?></td>
</tr>
</table>
<?php
$abrc="";
$s_sub3=mysqli_query($link,"select bar_barcodes from tbl_barcodestmp where plantcode='$plantcode' and bar_lotno='".$row_tbl['rv_newlot']."' and bar_logid='".$logid."' and bar_psrn='".$row_tbl['rv_rvpsrn']."'") or die(mysqli_error($link));
...
<input type="hidden" name="sno" value="<?php echo $sno;?>" /><input type="hidden" name="detmpbno" value="<?php echo $row_tbl['rv_pnomp'];?>" /><input type="hidden" name="nopks" value="<?php echo $row_tbl['rv_bpch'];?>" />
...
<option value="" selected>WH</option>
	<?php while($noticia_whg1 = mysqli_fetch_array($whg1_query)) { ?>
          <option <?php if($row_sub['rvs_whid']==$noticia_whg1['whid']) echo "selected";?> value="<?php echo $noticia_whg1['whid'];?>" />  
          <?php echo $noticia_whg1['perticulars'];?>
          <?php } ?>
	</select>&nbsp;<font color="#FF0000" >* </font>&nbsp;</td>
<?php
$bing1_query=mysqli_query($link,"select binid, binname from tbl_bin where plantcode='$plantcode' and whid='".$row_sub['rvs_whid']."' order by binname") or die(mysqli_error($link));
?>

<td align="center"  valign="middle" class="smalltbltext" id="bingn<?php echo $sno3;?>"><select class="smalltbltext" name="txtbing<?php echo $sno3;?>" id="txtbing<?php echo $sno3;?>" style="width:60px;" onchange="bin(this.value,<?php echo $sno3;?>);" >
<option value="" selected>Bin</option>
<?php while($noticia_bing1 = mysqli_fetch_array($bing1_query)) { ?>
          <option <?php if($row_sub['rvs_binid']==$noticia_bing1['binid']) echo "selected";?> value="<?php echo $noticia_bing1['binid'];?>" />  
          <?php echo $noticia_bing1['binname'];?>
          <?php } ?>
</select>&nbsp;<font color="#FF0000" >* </font>&nbsp;</td>

<?php
$subbing1_query=mysqli_query($link,"select sid, sname from tbl_subbin where plantcode='$plantcode' and whid='".$row_sub['rvs_whid']."' and binid='".$row_sub['rvs_binid']."' order by sname") or die(mysqli_error($link));
?>	

<td align="center"  valign="middle" class="smalltbltext" id="sbingn<?php echo $sno3;?>"><select class="smalltbltext" name="txtsubbg<?php echo $sno3;?>" id="txtsubbg<?php echo $sno3;?>" style="width:60px;" onchange="subbin(this.value,<?php echo $sno3;?>);"  >
<option value="" selected>Subbin</option>
<?php while($noticia_subbing1 = mysqli_fetch_array($subbing1_query)) { ?>
          <option <?php if($row_sub['rvs_sbinid']==$noticia_subbing1['sid']) echo "selected";?> value="<?php echo $noticia_subbing1['sid'];?>" />  
...
<table align="center" height="30" width="100%"  border="1" cellspacing="0" cellpadding="0" bordercolor="#1dbe03" style="border-collapse:collapse" >		
	<tr>
 		<td align="center"  valign="middle" class="smalltbltext" >&nbsp;<?php echo $existview;?><input type="hidden" name="existview<?php echo $sno3;?>" id="existview<?php echo $sno3;?>" class="tbltext" value="<?php echo $existview;?>" /><input type="hidden" name="trflg<?php echo $sno3?>" id="trflg<?php echo $sno3?>" value="<?php echo $trflg?>" /><input type="hidden" name="tpflg<?php echo $sno3?>" id="tpflg<?php echo $sno3?>" value="<?php echo $tpflg?>" /><input type="hidden" name="tflg<?php echo $sno3?>" id="tflg<?php echo $sno3?>" value="<?php echo $tflg?>" /><input type="hidden" name="tpmflg<?php echo $sno3?>" id="tpmflg<?php echo $sno3?>" value="<?php echo $tpmflg?>" /></td>
 	</tr>
</table>
</div> 
</td> 
...
$np=$pt*$wtmp;
$tnp=$np*$row_sub['rvs_nomp'];
$totnopch=$tnp+$row_sub['rvs_nop'];
?>
<td align="center" valign="middle" class="tbltext"><input type="text" class="tbltext" name="nopmpcs_<?php echo $sno3;?>" id="nopmpcs_<?php echo $sno3;?>" value="<?php echo $row_sub['rvs_nomp'];?>" size="9" <?php if($row_tbl['rv_mptyp']=="No") echo "readonly='true' style='background-color:#CCCCCC'";?> onchange="pacsbinchk(this.value,<?php echo $sno3;?>)"  /></td>
<td align="center" valign="middle" class="tbltext"><input type="text" class="tbltext" name="noppchs_<?php echo $sno3;?>" id="noppchs_<?php echo $sno3;?>" value="<?php echo $row_sub['rvs_nop'];?>" size="9" onchange="pacpchchk(this.value,<?php echo $sno3;?>)"  /></td>
<td align="center" valign="middle" class="tbltext"><input type="text" class="tbltext" name="noptpchs_<?php echo $sno3;?>" id="noptpchs_<?php echo $sno3;?>" value="<?php echo $totnopch;?>" size="9" readonly="true" style="background-color:#CCCCCC" /></td>
<td align="center" valign="middle" class="tbltext"><input type="text" class="tbltext" name="noptqtys_<?php echo $sno3;?>" id="noptqtys_<?php echo $sno3;?>" value="<?php echo $row_sub['rvs_qty'];?>" size="9" readonly="true" style="background-color:#CCCCCC" /></td>
</tr>
<?php
}
}
...
<tr class="Light" height="25">
<td align="center" valign="middle" class="tblheading"><input type="text" class="smalltblheading" size="7" name="extbpch" value="<?php if($row_tbl['rv_mptyp']=="Yes") echo $row_tbl['rv_bpch']; else echo $row_tbl['rv_bnop']?>" readonly="true" style="background-color:#CCCCCC" /></td>
<td align="center" valign="middle" class="tblheading"><input type="text" class="smalltblheading" size="7" name="linkpch" value="<?php if($row_tbl['rv_mptyp']=="Yes") echo $row_tbl['rv_bpch']; else echo $row_tbl['rv_bnop']?>" readonly="true" style="background-color:#CCCCCC" /></td>
<td align="center" valign="middle" class="tblheading"><input type="text" class="smalltblheading" size="7" name="bpch" value="0" readonly="true" style="background-color:#CCCCCC; color:#FF0000" /></td>
</tr>
</table>
</div>
