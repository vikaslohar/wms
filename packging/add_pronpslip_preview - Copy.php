<?php
	...
	while($row_arrsub=mysqli_fetch_array($sql_arrsub))
	{
		...
		$protyp=$row_arr['pnpslipsub_processtype'];
		...
		$prolotno=$row_arrsub['pnpslipsub_clotno'];
		...
		$zzz2=implode(",", str_split($row_arrsub['pnpslipsub_clotno']));
		$coldlot=$zzz2[0].$zzz2[2].$zzz2[4].$zzz2[6].$zzz2[8].$zzz2[10].$zzz2[12].$zzz2[14].$zzz2[16].$zzz2[18].$zzz2[20].$zzz2[22].$zzz2[24].$zzz2[26].$zzz2[28].$zzz2[30];
		...
		$a="";
		$sql_barcode2=mysqli_query($link,"Select * from tbl_pnpslipbarcode where plantcode='$plantcode' and pnpslipbar_lotno='".$packlotno."' and pnpslipmain_id='".$pid."'") or die(mysqli_error($link));
		...
		if($tot_barcode2 > 0)
		{
			while($row_barcode2=mysqli_fetch_array($sql_barcode2))
			{
				...
				$grosswt=$row_barcode2['pnpslipbar_grosswt'];
				$dt=$row_barcode2['pnpslipbar_wtdate'];
				$tim='';//$row_barcode2['bar_wttime'];
				$poprid=$row_barcode2['pnpslipbar_wtmopr'];
				$bar_crop=$row_arr['pnpslipmain_crop'];
				$bar_variety=$row_arr['pnpslipmain_variety'];
				$bar_ups=$row_barcode2['pnpslipbar_ups'];
				$bar_dop=$row_arr['pnpslipmain_dop'];
				$bar_vdate=$row_barcode2['pnpslipsub_valupto'];
				$bar_netweight=$row_barcode2['pnpslipbar_wtmp'];
				$bar_bctyp=$row_barcode2['pnpslipbar_bctype'];
		...
		$sql_barcode3=mysqli_query($link,"Select distinct pnpslipbar_subbinid from tbl_pnpslipbarcode where plantcode='$plantcode' and pnpslipbar_lotno='".$packlotno."' and pnpslipmain_id='".$pid."'") or die(mysqli_error($link));
		...
		if($tot_barcode3 > 0)
		{
			while($row_barcode3=mysqli_fetch_array($sql_barcode3))
			{
				...
				$sql_barcode23=mysqli_query($link,"Select * from tbl_pnpslipbarcode where plantcode='$plantcode' and pnpslipbar_lotno	='".$packlotno."' and pnpslipmain_id='".$pid."' and pnpslipbar_subbinid='".$row_barcode3['pnpslipbar_subbinid']."'") or die(mysqli_error($link));
				...
				if($tot_barcode23 > 0)
				{
					while($row_barcode23=mysqli_fetch_array($sql_barcode23))
					{
						...
						$txtwhg=$row_barcode23['pnpslipbar_whid'];
						$txtbing=$row_barcode23['pnpslipbar_binid'];
						$txtsubbg=$row_barcode23['pnpslipbar_subbinid'];
						$nopmpcs=$nopmpcs+1;
						$noppchs=$bar_nop; 
						$noptpchs=$noppchs; 
		...
		while($row_arrsubsub2=mysqli_fetch_array($sql_arrsubsub2))
		{
			...
			while($row_issuetbl22=mysqli_fetch_array($sql_issuetbl22))
			{
				...
				$srflg2=$row_issuetbl22['lotldg_srflg'];
				  ...
				  $sql_ins_main22="insert into tbl_lot_ldg (yearcode,lotldg_trtype, lotldg_trid, lotldg_trdate, lotldg_lotno, lotldg_crop, lotldg_variety, lotldg_whid, lotldg_binid, lotldg_subbinid, lotldg_opbags, lotldg_opqty, lotldg_trbags, lotldg_trqty, lotldg_balbags, lotldg_balqty, lotldg_sstage, lotldg_sstatus, lotldg_moisture, lotldg_gemp, lotldg_vchk, lotldg_got1, lotldg_qc, lotldg_got, lotldg_qctestdate, lotldg_gottestdate, orlot, lotldg_gs, lotldg_resverstatus, lotldg_revcomment, lotldg_genpurity, lotldg_srtyp, lotldg_srflg, plantcode) values('$yearcode2','PNPSLIPSUC', '$pid', '$arrival_date', '$prolotno', '$crop', '$variety', '$whid2', '$binid2', '$subbinid2', '$onob2', '$oqty2', '$nob12', '$qty12', '$balups2', '$balqty2', '$sstage2', '$sstatus2', '$moist2', '$gemp2', '$vchk2', '$got12', '$qc2', '$gotstatus2', '$qctestdate2', '$gottestdate2', '$coldlot', '$gs2', '$resverstatus2', '$revcomment2', '$geneticpurity2', '$srtype', '$srflg', '$plantcode')";
				//exit;
				...
				if($srflg>0)
				{
					if($protyp=="P")
					{
						...
						while($row_srsub=mysqli_fetch_array($sql_srsub))
						{
							...
							$sql_code2="SELECT MAX(softr_code) FROM tbl_softr  where plantcode='$plantcode' and yearcode='$yearid_id'  ORDER BY softr_code DESC";
						...
						if(mysqli_query($link,$sql_srmain) or die(mysqli_error($link)))
						{
							...
							$sql_srsub="Insert into tbl_softr_sub (softr_id, softrsub_lotno, softrsub_srtyp, softrsub_srflg, plantcode) values('$id', '$coldlot', '$type', '1', '$plantcode')";
				...
				$sqlisstbl=mysqli_query($link,"select * from tbl_lemain where plantcode='$plantcode' and le_lotno='".$lot."'") or die(mysqli_error($link)); 
				if($totisstbl=mysqli_num_rows($sqlisstbl)>0)
				{
					$rowisstbl=mysqli_fetch_array($sqlisstbl);
					//$sqlsubsub1="UPDATE tbl_lemain SET le_duration='$leduration', le_upto='$ledate'  where le_lotno='$lot' and le_stage='$sstage2'";
					//mysqli_query($link,$sqlsubsub1) or die(mysqli_error($link));
				}
				else
				{
					$sqlsubsub1="insert into tbl_lemain (le_lotno, le_stage, le_duration, le_upto, plantcode) values( '$lot' ,'$txtstage', '$leduration','$ledate', '$plantcode')";
					mysqli_query($link,$sqlsubsub1) or die(mysqli_error($link));
				
				
					$sqlsubsub13="insert into tbl_learchive (lea_lotno, lea_stage, lea_duration, lea_upto, lea_date, lea_module, lea_logid, plantcode) values( '$lot' ,'$sstage2', '$leduration','$ledate', '$dt', 'Packing Slip', '$logid', '$plantcode')";
		...
		while($row_arrsubsub3=mysqli_fetch_array($sql_arrsubsub3))
		{
			...
			foreach($b_arr as $bval1)
			{
				if($bval1<>"")
				{
					$sql_barcode24="update tbl_barcodes set bar_wtmp='$wtmp', bar_orlot='$poldlot' where bar_trid='$pid' and bar_subtrid='$subtranid' and bar_lotno='$packlotno' and bar_barcode='$bval1'";
					...
					if($balqty3>0)
					{
						$sql_ins_main24="insert into tbl_mpmain (mpmain_date, mpmain_trid, mpmain_trtype, mpmain_crop, mpmain_variety, mpmain_lotno, mpmain_upssize, mpmain_barcode, mpmain_wtmp, mpmain_mptnop, mpmain_opnop, mpmain_opqty, mpmain_nop, mpmain_qty, mpmain_balnop, mpmain_balqty, mpmain_wh, mpmain_bin, mpmain_subbin, mpmain_yearcode, mpmain_logid, mpmain_lotnop, bar_bctyp, plantcode) values('$arrival_date', '$pid', 'PACKSMC', '$crop', '$variety', '$packlotno', '$packtype', '$bval1', '$wtmp', '$nopinmp', '0', '0', '$balnop3', '$balqty3', '$balnop3', '$balqty3', '$whid3', '$binid3', '$subbinid3', '$yearcode', '$logid', '$nopinmp', '$bar_bctyp', '$plantcode')";
			...
			if($srflg>0)
			{
				//if($row_arrsub['pnpslipsub_packtype']=="P")
				{
					...
					{
						$id=mysqli_insert_id($link);
						$sql_srsub="Insert into tbl_softr_sub (softr_id, softrsub_lotno, softrsub_srtyp, softrsub_srflg, plantcode) values('$id', '$poldlot', '$type', '1', '$plantcode')";
						$ss=mysqli_query($link,$sql_srsub) or die(mysqli_error($link));
					}	
				}
			}
			...
			foreach($zxcd as $bstlval)
			{
				...
				else*/
				{
					...
					/*if($qc2=="UT" || $got1=="UT")
					{
						$sql_sub_sub123="insert into tbl_qctest(spdate, testdate, gotdate, dosdate, pp, moist, got, qc, variety, crop, gemp, srdate, qcstatus, gotstatus, sampleno, aflg, bflg, cflg, qcflg, gotflg, gsflg, gs, gotrefno, gotauth, doswdate, gotsmpdflg, stsno, qcrefno, genpurity, lotno, oldlot, yearid, logid, state, trstage) values('".$row_qc['spdate']."','".$row_qc['testdate']."','".$row_qc['gotdate']."','".$row_qc['dosdate']."','".$row_qc['pp']."','".$row_qc['moist']."','".$row_qc['got']."','".$row_qc['qc']."','".$row_qc['variety']."','".$row_qc['crop']."','".$row_qc['gemp']."','".$row_qc['srdate']."','".$row_qc['qcstatus']."','".$row_qc['gotstatus']."','".$row_qc['sampleno']."','".$row_qc['aflg']."','".$row_qc['bflg']."','".$row_qc['cflg']."','".$row_qc['qcflg']."','".$row_qc['gotflg']."','".$row_qc['gsflg']."','".$row_qc['gs']."','".$row_qc['gotrefno']."','".$row_qc['gotauth']."','".$row_qc['doswdate']."','".$row_qc['gotsmpdflg']."','".$row_qc['stsno']."','".$row_qc['qcrefno']."','".$row_qc['genpurity']."','".$packlotno."','".$poldlot."','$yrco','$logid', '".$row_qc['state']."', '$sstage2')";
						mysqli_query($link,$sql_sub_sub123) or die(mysqli_error($link));
					}*/
					
					if($qc2=="UT")
					{
						$sql_sub_sub123="insert into tbl_qctest(spdate, testdate, pp, moist, qc, variety, crop, gemp, srdate, qcstatus, sampleno, aflg, bflg, cflg, qcflg, gsflg, gs, stsno, qcrefno, lotno, oldlot, yearid, logid, state, trstage, sampno, plantcode) values('".$row_qc['spdate']."','".$row_qc['testdate']."','".$row_qc['pp']."','".$row_qc['moist']."','".$row_qc['qc']."','".$row_qc['variety']."','".$row_qc['crop']."','".$row_qc['gemp']."','".$row_qc['srdate']."','".$row_qc['qcstatus']."','".$row_qc['sampleno']."','".$row_qc['aflg']."','".$row_qc['bflg']."','".$row_qc['cflg']."','".$row_qc['qcflg']."','".$row_qc['gsflg']."','".$row_qc['gs']."','".$row_qc['stsno']."','".$row_qc['qcrefno']."','".$packlotno."','".$poldlot."','$yrco','$logid', '".$row_qc['state']."', '$sstage2','".$row_qc['sampno']."', '$plantcode')";
						mysqli_query($link,$sql_sub_sub123) or die(mysqli_error($link));
					}
							
					if($got1=="UT")
					{
						$sql_sub_sub123="insert into tbl_gottest (gottest_spdate, gottest_gotdate, gottest_dosdate, gottest_got, gottest_variety, gottest_crop, gottest_srdate, gottest_gotstatus, gottest_sampleno, gottest_aflg, gottest_bflg, gottest_cflg, gottest_gotflg, gottest_gotrefno, gottest_gotauth, gottest_gotsampdflg, genpurity, gottest_lotno, gottest_oldlot, yearid, logid, gottest_trstage, gottest_sampno, plantcode) values('".$row_got['gottest_spdate']."','".$row_got['gottest_gotdate']."','".$row_got['gottest_dosdate']."','".$row_got['gottest_got']."','".$row_got['gottest_variety']."','".$row_got['gottest_crop']."','".$row_got['gottest_srdate']."','".$row_got['gottest_gotstatus']."','".$row_got['gottest_sampleno']."','".$row_got['gottest_aflg']."','".$row_got['gottest_bflg']."','".$row_got['gottest_cflg']."','".$row_got['gottest_gotflg']."','".$row_got['gottest_gotrefno']."','".$row_got['gottest_gotauth']."','".$row_got['gottest_gotsampdflg']."','".$row_got['genpurity']."','".$packlotno."','".$poldlot."','$yrco','$logid', '$sstage2','".$row_got['gottest_sampno']."', '$plantcode')";
						mysqli_query($link,$sql_sub_sub123) or die(mysqli_error($link));
					}
					/*else if($qc2=="UT" && $got1!="UT")
					{
						$sql_sub_sub12="insert into tbl_qctest(pp, moist, got, lotno, srdate, crop,  variety, sampleno, trstage, qc, state, gs, oldlot, spdate, bflg,yearid,logid)values('$vchk2', '$moist2', '$got1', '$packlotno', '".$arrivaldate."', '$crop', '$variety', '$ncode1', '$sstage2', '$qc2', '$state',1,'$poldlot', '".$row_qc['spdate']."',1,'$yrco','$logid')";
						mysqli_query($link,$sql_sub_sub12) or die(mysqli_error($link));
					}
					else if($got1=="UT" && $qc2!="UT")
					{
						$sql_sub_sub13="insert into tbl_qctest(pp, moist, got, lotno, srdate, crop,  variety, sampleno, trstage, qc, state, gs, oldlot, spdate, dosdate, bflg, testdate, qcflg, qcstatus,gotsmpdflg,yearid,logid)values('$vchk2', '$moist2', '$got1', '$packlotno', '".$row_qc['srdate']."', '$crop', '$variety', '$ncode2', '$sstage2', '$qc2', '$state2',1,'$poldlot', '".$row_qc['spdate']."', '".$row_qc['dosdate']."',1,'".$row_qc['testdate']."',1, '$qc2',0,'$yrco','$logid')";
						mysqli_query($link,$sql_sub_sub13) or die(mysqli_error($link));
					}	
					else
					{
		...
		$sql_code1="SELECT MAX(pnpslipmain_tcode) FROM tbl_pnpslipmain where pnpslipmain_ttype='Online Processing and Packing Slip' ORDER BY pnpslipmain_tcode DESC";
	$res_code1=mysqli_query($link,$sql_code1)or die(mysqli_error($link));
...
{ 
	...
	else if(parseInt(document.frmaddDepartment.slcnt.value)>0)
	{
		alert("SLOC not updated. Please SLOC first");
		return false;
	}
	else
	{
...
function chkconqty()
{
	...
	else
	{
		...
		var tpl=parseFloat(document.frmaddDepartment.txtconrem.value)+parseFloat(document.frmaddDepartment.txtconim.value)+parseFloat(document.frmaddDepartment.txtconpl.value);
		...
		else
		{
			...
			//document.getElementById('avlnobpck').value=parseInt(document.frmaddDepartment.txtconnob.value);
			//document.getElementById('avlqtypck').value=parseFloat(document.frmaddDepartment.txtconqty.value);	
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#1dbe03" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#F1B01E" style="border-bottom:solid; border-bottom-color:#1dbe03" >
	    <tr >
	      <td width="813" height="25" class="Mainheading">&nbsp;Transaction - Online Processing and Packing slip - Preview </td>
	    </tr></table></td>
...
<tr class="tblsubtitle" height="20">
	...
	<td width="35"  rowspan="2" align="center" valign="middle" class="smalltblheading">RM</td>
	<td width="35" align="center" valign="middle" class="smalltblheading"  rowspan="2">IM </td>
	<td width="35"  rowspan="2" align="center" valign="middle" class="smalltblheading">PL</td>
	<td align="center" valign="middle" class="smalltblheading"  colspan="2">Total C. Loss</td>
	<td width="107" colspan="1" rowspan="2" align="center" valign="middle" class="smalltblheading">CSW SLOC</td>
	<td width="54" colspan="3" align="center" valign="middle" class="smalltblheading">Pack Details</td>
	<td width="54" rowspan="2" align="center" valign="middle" class="smalltblheading">Remarks</td>
	<td width="54" rowspan="2" align="center" valign="middle" class="smalltblheading">Loss / Qty Update</td>
</tr>
<tr class="tblsubtitle">
	...
	<td width="27" align="center" valign="middle" class="smalltblheading">NoMP</td>
	<td width="27" align="center" valign="middle" class="smalltblheading">Barcodes</td>
	<td width="54" align="center" valign="middle" class="smalltblheading">Details</td>
</tr>
  <?php
...
<tr class="Light" height="20">
	...
	<td align="center"  valign="middle" class="smalltbltext" ><?php echo $pnplotno;?></td>
	...
	<td width="45" align="center" valign="middle" class="smalltbltext"><?php echo $pnpconnob;?></td>
	<td align="center" valign="middle" class="smalltbltext"><?php echo $pnpconqty;?></td>
	<td width="35" align="center" valign="middle" class="smalltbltext"><?php echo $pnprm;?></td>
	<td width="35" align="center" valign="middle" class="smalltbltext"><?php echo $pnpim;?></td>
	<td width="35" align="center" valign="middle" class="smalltbltext"><?php echo $pnppl;?></td>
	<td width="50" align="center" valign="middle" class="smalltbltext"><?php echo $pnptlqty;?></td>
	<td width="30" align="center" valign="middle" class="smalltbltext"><?php echo $pnptlper;?></td>
	<td width="107" align="center" valign="middle" class="smalltbltext"><?php echo $sloc;?></td>
	<td width="35" align="center" valign="middle" class="smalltbltext"><?php echo $pnpnomp;?><input type="hidden" name="totlotnomp<?php echo $srno;?>" id="totlotnomp_<?php echo $srno;?>" value="<?php echo $pnpnomp;?>" /></td>
	<td width="35" align="center" valign="middle" class="smalltbltext"><a href="Javascript:void(0)" onclick="openbarcodedetails(<?php echo $row_tbl_sub['pnpslipsub_id']?>,<?php echo $arrival_id;?>)"><?php echo $tot_barcnomp;?></a><input type="hidden" name="totlotbar<?php echo $srno;?>" id="totlotbar_<?php echo $srno;?>" value="<?php echo $tot_barcnomp;?>" /></td>
	<td width="35" align="center" valign="middle" class="smalltbltext"><a href="Javascript:void(0)" onclick="openpackdetails(<?php echo $row_tbl_sub['pnpslipsub_id']?>,<?php echo $arrival_id;?>)">View</a></td>
	...
	<td width="54" align="center" valign="middle" class="smalltbltext"><?php if($pnptlqty=="0"){ ?><a href="Javascript:void(0)" onclick="updatelossnqty(<?php echo $row_tbl_sub['pnpslipsub_id']?>,<?php echo $arrival_id;?>)">Update</a><?php } ?></td>
</tr>
  <?php
}
else
