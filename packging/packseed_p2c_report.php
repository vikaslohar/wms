<?php
	...
	if(isset($_POST['frm_action'])=='submit')
	{
		...
		echo "<script>window.location='packseed_p2c_report1.php?sdate=$sdate&edate=$edate&txtcrop=$crop&txtvariety=$veriety'</script>";	
	}
...
<title>Packaging - Pack Seed P2C Report</title>
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#1dbe03" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#1dbe03" style="border-bottom:solid; border-bottom-color:#1dbe03" >
	    <tr >
	      <td width="813" height="25" class="Mainheading">&nbsp;Report - Pack Seed P2C Report</td>
	    </tr></table></td>
...
?>
    ...
    <td align="left"  valign="middle" class="tbltext" id="vitem" colspan="3" id="vitem" >&nbsp;<select class="tbltext" id="itm" name="txtvariety" style="width:170px;" >
          <option value="ALL" selected>--ALL--</option>
