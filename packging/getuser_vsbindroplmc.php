...
if($f!="")
$sql_month=mysqli_query($link,"select sid, sname from tbl_subbin where plantcode='$plantcode' and  binid='".$a."' and sid IN ($f) order by sname")or die("Error:".mysqli_error($link));
else
