...
$lotqry=mysqli_query($link,"select distinct subbinid, whid, binid from tbl_lot_ldg_pack where plantcode='$plantcode' and lotno='".$a."'") or die(mysqli_error($link));
...
$sql_mpns=mysqli_query($link,"Select * from tbl_mpmain where plantcode='$plantcode' and mpmain_trtype='PACKNMC' and mpmain_lotno='$a' and mpmain_dflg!=1 and mpmain_upflg!=1") or die(mysqli_error($link));
...
<td align="center" valign="middle" class="smalltbltext"><?php echo $qty;?><input type="hidden" name="extnomphs<?php echo $sno;?>_<?php echo $sno33;?>" id="extnomphs<?php echo $sno;?>_<?php echo $sno33;?>" value="<?php echo $qty;?>" /></td> 
<td align="center" valign="middle" class="smalltbltext"><?php echo $nob;?><input type="hidden" name="extnophs<?php echo $sno;?>_<?php echo $sno33;?>" id="extnophs<?php echo $sno;?>_<?php echo $sno33;?>" value="<?php echo $nob;?>" /></td>
<td align="center" valign="middle" class="smalltbltext"><?php echo $avlqty;?><input type="hidden" name="extqtyhs<?php echo $sno;?>_<?php echo $sno33;?>" id="extqtyhs<?php echo $sno;?>_<?php echo $sno33;?>" value="<?php echo $avlqty;?>" /></td>
<td align="center" valign="middle" class="smalltbltext"><input type="text" class="tbltext" name="qtyphs<?php echo $sno;?>_<?php echo $sno33;?>" id="qtyphs<?php echo $sno;?>_<?php echo $sno33;?>" value="" size="7"  onchange="pacqtychk(this.value,<?php echo $sno;?>,<?php echo $sno33;?>)" onkeypress="return isNumberKey1(event)"  /></td>
<td align="center" valign="middle" class="smalltbltext"><input type="text" class="tbltext" name="nophs<?php echo $sno;?>_<?php echo $sno33;?>" id="nophs<?php echo $sno;?>_<?php echo $sno33;?>" value="" size="7"  onchange="pacpchk(this.value,<?php echo $sno;?>,<?php echo $sno33;?>)" onkeypress="return isNumberKey(event)"  /></td>
<td align="center" valign="middle" class="smalltbltext"><input type="text" class="tbltext" name="balnophs<?php echo $sno;?>_<?php echo $sno33;?>" id="balnophs<?php echo $sno;?>_<?php echo $sno33;?>" value="" size="7" readonly="true" style="background-color:#CCCCCC"  /></td>
</tr>
<?php
}
}
