...
<tr class="tblsubtitle" height="20">
  <td colspan="6" align="center" class="tblheading">Re-Printing</td>
</tr>
...
{
$whg1_query=mysqli_query($link,"select whid, perticulars from tbl_warehouse plantcode='$plantcode' and where whid='".$row_sub['rvs_whid']."' order by perticulars") or die(mysqli_error($link));
$noticia_whg1 = mysqli_fetch_array($whg1_query);

$bing1_query=mysqli_query($link,"select binid, binname from tbl_bin plantcode='$plantcode' and where binid='".$row_sub['rvs_binid']."'") or die(mysqli_error($link));
$noticia_bing1 = mysqli_fetch_array($bing1_query);

$subbing1_query=mysqli_query($link,"select sid, sname from tbl_subbin plantcode='$plantcode' and where sid='".$row_sub['rvs_sbinid']."'") or die(mysqli_error($link));
