...
$targetpage = $_SERVER['PHP_SELF']; 
  ...
  $sql_arr_home=mysqli_query($link,"select * from tbl_packaging where plantcode='$plantcode' and packaging_type='SMC' and packaging_tdate>='$tdate' and packaging_tdate<='$pdate' and packaging_tflg=1 order by packaging_tcode desc LIMIT $start, $limit") or die(mysqli_error($link));
 $tot_arr_home=mysqli_num_rows($sql_arr_home);
...
$query = "select * from tbl_packaging where plantcode='$plantcode' and packaging_type='SMC' and packaging_tdate>='$tdate' and packaging_tdate<='$pdate' and packaging_tflg=1 order by packaging_tcode desc";
...
$sql_arr_home=mysqli_query($link,"select * from tbl_packaging where packaging_type='SMC' and packaging_tdate>='$tdate' and packaging_tdate<='$pdate' and packaging_tflg=1 order by packaging_tcode desc LIMIT $from, $max_results") or die(mysqli_error($link));
$tot_arr_home=mysqli_num_rows($sql_arr_home);
//$tot_arr_home=0;

$total_results3 =mysqli_query($link,"SELECT COUNT(*)  FROM tbl_packaging where packaging_type='SMC' and packaging_tdate>='$tdate' and packaging_tdate<='$pdate' and packaging_tflg=1");
$total_results2 = mysqli_fetch_array($total_results3);
$total_results = $total_results2[0]; */
...
<tr >
<td valign="top" align="right"><a href="home_packaging_smc.php"><img src="../images/back.gif" border="0"style="display:inline;cursor:Pointer;" /></a></td>
</tr>
</table>
