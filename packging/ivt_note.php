...
<title>Packaging - Transaction - Inter Variety Transfer - IVTN</title>
...
$sql_tblissue=mysqli_query($link,"select * from tbl_ivtsub_sub2 where plantcode='$plantcode' and ivt_id='".$trid."' and ivts_id='".$row_eindent_sub['ivts_id']."'") or die(mysqli_error($link));
