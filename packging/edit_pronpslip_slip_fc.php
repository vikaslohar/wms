...
{ 
	...
	if(dt2 > dt1)
	{
		alert("Date of Indent cannot be more than Transaction Date.");
		f=1;
		return false;
	}
	if(document.frmaddDepartment.txtpsrn.value=="")
	...
	else
	{
		...
		//	document.getElementById(det2).innerHTML="Attach";
			...
			//if(document.getElementById('pcktype').value=="E")
			{
				...
				document.frmaddDepartment.upswisepackqty.value=document.getElementById('balpck').value;
...
<tr class="tblsubtitle" height="20">
  <td colspan="8" align="center" class="tblheading">Add Processing and Packing Slip FC </td>
</tr>
...
<td width="319" align="left" valign="middle" class="smalltbltext">&nbsp;<input name="dopc" id="dopc" type="text" size="10" class="smalltbltext" tabindex="0" value="<?php echo $indentdate;?>" maxlength="10"/>&nbsp;<a href="javascript:void(0)" onClick="showCalendar('dopc')" tabindex="6"><img src="../images/cal.gif" border="0" align="absmiddle" /></a>&nbsp;<font color="#FF0000">*</font></td>
<td width="157" align="right"  valign="middle" class="smalltblheading">Indent No.&nbsp;</td>
    <td width="165" align="left"  valign="middle" class="smalltbltext">&nbsp;<input name="txtpsrn" type="text" size="15" class="smalltbltext" tabindex="" value="<?php echo $row_trdetails['pnpslipmain_indentsrn'];?>"   maxlength="15" />&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
</tr></table>
...
<td  align="left" valign="middle" class="smalltbltext"  >&nbsp;
  <select class="smalltbltext" name="txtpromech" style="width:120px;" >
    ...
    <option <?php if($row_trdetails['pnpslipmain_promachcode']==$noticia_item1['promac_id']) {echo "Selected";}?> value="<?php echo $noticia_item1['promac_id'];?>" />  
    <?php echo $num;?>
    <?php } ?>
  </select>  &nbsp;<font color="#FF0000">*</font>	</td>
<?php
...
<td width="209" align="left" valign="middle" class="smalltbltext">&nbsp;<select class="smalltbltext" name="txtoprname" style="width:150px;" >
    <option value="" >--Select--</option>
    <?php while($row_popr = mysqli_fetch_array($query_popr)) { $num2=$row_popr['proopr_fname']." ".$row_popr['proopr_lname'];?>
		<option <?php if($row_trdetails['pnpslipmain_proopr']==$row_popr['proopr_id']) {echo "Selected";}?> value="<?php echo $row_popr['proopr_id'];?>" />   
		<?php echo $num2; ?>
		<?php } ?>
  </select>&nbsp;<font color="#FF0000">*</font>	</td>
<?php
...
<table align="center" border="1" width="970" cellspacing="0" cellpadding="0" bordercolor="#1dbe03"  > 
	...
	<td align="left" width="645" valign="middle" class="smalltbltext" style="border-color:#1dbe03">&nbsp;<input name="txtlot1" type="text" size="20" class="smalltbltext" tabindex=""  maxlength="20"  value="<?php echo $row_trdetails_sub['pnpslipsub_lotno'];?>" readonly="true" style="background-color:#CCCCCC" />
	</tr>
</table>
...
$tdate44=$row_trdetails['pnpslipsetup_date'];
...
<td width="165" align="center" valign="middle" class="tblheading">&nbsp;
  <input type="text" class="tbltext" name="validityupto" id="validityupto" value="<?php echo $tdate4;?>" size="15" readonly="true" style="background-color:#ECECEC"  /></td>
<td width="220" align="center" valign="middle" class="tblheading">&nbsp;
  <input type="text" name="valdays" id="valdays" size="4" class="tblheading" value="<?php echo $datediffn;?>" readonly="true" style="background-color:#ECECEC; color:#FF0000" />&nbsp;From DoT/DoSF</td>
<td width="125" align="center" valign="middle" class="tblheading"><input type="radio" name="paceptyp" id="paceptyp0" value="E" onclick="pcksel(this.value);" <?php if($row_trdetails_sub['pnpslipsub_packtype']=="E") echo "checked"; ?>  /></td>
<td width="125" align="center" valign="middle" class="tblheading"><input type="radio" name="paceptyp" id="paceptyp1" value="P" onclick="pcksel(this.value);" <?php if($row_trdetails_sub['pnpslipsub_packtype']=="P") echo "checked"; ?>    /></td>
<td width="156" align="center" valign="middle" class="tblheading" id="pltno"><input type="text" name="txtplotno" id="txtplotno" class="smalltbltext" value="<?php echo $row_trdetails_sub['pnpslipsub_plotno'];?>" size="16" readonly="true" style="background-color:#CCCCCC" /></td>
</tr>
<!--<tr class="Light" height="25">
...
<input type="hidden" name="pcktype" id="pcktype" value="<?php echo $row_trdetails_sub['pnpslipsub_packtype']; ?>" />
</table>
<table align="center" border="1" width="970" cellspacing="0" cellpadding="0" bordercolor="#1dbe03" style="border-collapse:collapse" >	
  <tr class="tblsubtitle" height="20">
    <!--<td width="24" align="center" valign="middle" class="smalltblheading" rowspan="2">#</td>
  ...
  <td  align="center"  valign="middle" class="smalltbltext"><input name="picqtyp" id="picqtyp" type="text" size="8" class="smalltbltext" tabindex="" maxlength="10"  onkeypress="return isNumberKey(event)" onchange="pfpchk(this.value)" value="<?php echo $row_trdetails_sub['pnpslipsub_pickpqty']; ?>"  />&nbsp;<font color="#FF0000" >* </font>&nbsp;</td>
  ...
  <td  align="center"  valign="middle" class="smalltbltext"><input name="balcnob" id="balcnob" type="text" size="8" class="smalltbltext" tabindex="" maxlength="10" readonly="true"  style="background-color:#CCCCCC"  value="<?php echo $row_trdetails_sub['pnpslipsub_balcnob']; ?>" /></td>
   <td  align="center"  valign="middle" class="smalltbltext"><input name="balcqty" id="balcqty" type="text" size="8" class="smalltbltext" tabindex="" maxlength="10" readonly="true"  style="background-color:#CCCCCC" value="<?php echo $row_trdetails_sub['pnpslipsub_balcqty']; ?>"  />&nbsp;</td>
</tr>  
</table>
...
<tr class="Light" height="25">
<td width="49" align="center" valign="middle" class="tbltext"><input type="radio" name="fet" onClick="clk('<?php echo $sno?>',<?php echo $row12['uid'];?>);" id="fetchk_<?php echo $sno?>" value="<?php echo $row12['uid'];?>" <?php if($row12['uid']==$row_trdetails_sub['pnpslipsub_upsid']) echo "checked"; ?>/></td>
...
<td width="81" align="center" valign="middle" class="tbltext"><input type="text" name="packqty_<?php echo $sno?>" id="packqty_<?php echo $sno?>" size="7" maxlength="7" class="tbltext" value="<?php if($row12['uid']==$row_trdetails_sub['pnpslipsub_upsid']) echo $row_trdetails_sub['pnpslipsub_packqty']; else echo ""; ?>" onkeypress="return isNumberKey(event)" readonly="true" style="background-color:#CCCCCC"  />&nbsp;<font color="#FF0000" >* </font>&nbsp;</td>
<td width="96" align="center" valign="middle" class="tbltext"><input type="text" name="nopc_<?php echo $sno?>" id="nopc_<?php echo $sno?>" size="7" maxlength="7" class="tbltext" value="<?php if($row12['uid']==$row_trdetails_sub['pnpslipsub_upsid']) echo $row_trdetails_sub['pnpslipsub_nop']; else echo ""; ?>" disabled="disabled"  readonly="true" style="background-color:#CCCCCC"/></td>
<td width="53" align="center" valign="middle" class="tbltext"><input type="checkbox" disabled="disabled" name="mpck_<?php echo $sno?>" id="mpck_<?php echo $sno?>" class="tbltext" value="Yes" onchange="mpchk(this.value, <?php echo $sno;?>)" <?php if($row12['uid']==$row_trdetails_sub['pnpslipsub_upsid'] && $row_trdetails_sub['pnpslipsub_convtomp']=="Yes") echo "checked";  ?>   /></td>
<td width="78" align="center" valign="middle" class="tbltext"><input type="text" name="nomp_<?php echo $sno?>" id="nomp_<?php echo $sno?>" size="7" maxlength="7" class="tbltext" value="<?php if($row12['uid']==$row_trdetails_sub['pnpslipsub_upsid'] && $row_trdetails_sub['pnpslipsub_convtomp']=="Yes") echo $row_trdetails_sub['pnpslipsub_nomp']; else echo ""; ?>"  readonly="true" style="background-color:#CCCCCC" /><input type="hidden" name="wtmp_<?php echo $sno?>" id="wtmp_<?php echo $sno?>" value="<?php echo $wtmp?>" /><input type="hidden" name="wtnop_<?php echo $sno?>" id="wtnop_<?php echo $sno?>" value="<?php echo $mptnop?>" /></td>
<?php if($row12['uid']==$row_trdetails_sub['pnpslipsub_upsid']) {?>
<input type="hidden" name="upssize" value="<?php echo $sno;?>" />
<?php } ?>
...
?>
<input type="hidden" name="sno" value="<?php echo $sno;?>" /><input type="hidden" name="detmpbno" value="" />
<input type="hidden" name="upsidno" value="<?php echo $row_trdetails_sub['pnpslipsub_upsid'];?>" /><input type="hidden" name="nopks" value="<?php echo $row_trdetails_sub['pnpslipsub_balpouch'];?>" /><input type="hidden" name="upsize" value="<?php echo $row_trdetails_sub['pnpslipsub_ups'];?>" /> <input type="hidden" name="upswisepackqty" value="<?php echo $row_trdetails_sub['pnpslipsub_packqty'];?>" /> <input type="hidden" name="upswisemaxnomp" value="<?php echo $row_trdetails_sub['pnpslipsub_nomp'];?>" />
...
<tr class="Light" height="25">  
  <td  align="center"  valign="middle" class="smalltbltext"><input name="mrpups" id="mrpups" type="text" size="8" class="smalltbltext" tabindex="" maxlength="10"  onkeypress="return isNumberKey(event)" onchange="mrpconv(this.value)" value="<?php echo $row_trdetails_sub['pnpslipsub_upsmrp'];?>"  />&nbsp;<font color="#FF0000" >* </font>&nbsp;</td>
  <td  align="center"  valign="middle" class="smalltbltext" ><input name="mrpgms" id="mrpgms" type="text" size="7" class="smalltbltext" tabindex=""   maxlength="7" onkeypress="return isNumberKey(event)" readonly="true"  style="background-color:#CCCCCC" value="<?php echo $row_trdetails_sub['pnpslipsub_gmsmrp'];?>"   />&nbsp;<font color="#FF0000" >* </font>&nbsp;</td>
</tr> 
</table><br />
<div id="slsync">
...
<td width="656" align="left"  valign="middle" class="smalltbltext">&nbsp;<input type="text" name="txtremarks" class="smalltbltext" size="100" maxlength="100" value="<?php echo $row_trdetails_sub['pnpslipsub_packremarks'];?>" ></td>
</tr>
</table>
<br />
