<?php
	...
	$sql_code="SELECT MAX(pswrem_tcode) FROM tbl_pswrem  ORDER BY pswrem_tcode DESC";
...
<td width="234"  align="left" valign="middle" class="tbltext">&nbsp;TPD1/F/PK1</td>
...
<td align="left"  valign="middle" class="tbltext"  colspan="3" id="vitem1">&nbsp;<select class="tbltext"  id="itm1" name="txtstfp" style="width:220px;" onChange="showaddr(this.value);" >
...
<tr class="Dark" height="30">
<td width="206" align="right"  valign="middle" class="tblheading">Select Order&nbsp;</td>
<td align="left"  valign="middle" class="tbltext" colspan="3" id="ordernos">&nbsp;<select class="tbltext"  id="itm24" name="txtornos" style="width:120px;" onChange="showordr(this.value);" >
<option value="" selected="selected">--Select--</option>
	</select>&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
</tr>
</table>
</div>
<div id="orderdetails" ><input type="hidden" name="maintrid" value="0" /></div>	
<!--<br />

<table align="center" border="0" cellspacing="0" cellpadding="0" width="850" bordercolor="#378b8b" style="border-collapse:collapse">
<tr class="" height="20">
...
<table align="center" border="1" width="850" cellspacing="0" cellpadding="0" bordercolor="#378b8b" style="border-collapse:collapse" > 
<tr class="tblsubtitle" height="20">
  <td colspan="4" align="center" class="tblheading">Barcode</td>
</tr>

<tr class="Dark" height="25">
<td width="206"  align="right"  valign="middle" class="tblheading">Barcode&nbsp;</td>
<td align="left"  valign="middle" colspan="3" class="tbltext">&nbsp;<input type="text" name="barcode" id="txtbarcod" size="11" maxlength="11" class="smalltbltext"  onkeypress="return isNumberKey24(event)" onChange="chkbarcode1(this.value)" />&nbsp;<font color="#FF0000" >*</font>&nbsp;</td></tr>
</table>
	...
	<?php while($noticia_item = mysqli_fetch_array($sql_month)) { ?>
		...
		<?php } ?></select>&nbsp;<font color="#FF0000">*</font>&nbsp;</td>	
         ...
         <tr class="Light" height="30" id="vitem">
           ...
           <td align="left" width="238" valign="middle" class="tbltext" style="border-color:#378b8b" >&nbsp;<input name="txtlot1" type="text" size="20" class="tbltext" tabindex=""  maxlength="20"  value="" onchange="ltchk(this.value);"  onBlur="javascript:this.value=this.value.toUpperCase();" readonly="true" style="background-color:#CCCCCC" >&nbsp;<font color="#FF0000">*</font>&nbsp;<a href="Javascript:void(0);" onclick="openslocpop();">Select</a><input type="hidden" name="txtlotnoid" /></td>
...
<table align="center" width="850" cellpadding="5" cellspacing="5" border="0" >
<tr >
<td valign="top" align="right"><a href="add_dispatch.php" tabindex="20"><img src="../images/cancel.gif" border="0"style="display:inline;cursor:Pointer;" onClick="return confirm('Do You wish to Cancel this Transaction?');" /></a></td>
</tr>
</table>
</td><td width="30"></td>
</tr>
