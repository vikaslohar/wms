...
$sq="select * from tbl_revalidate where rv_tflg=1 and rv_rvflg!=1 and rv_crop='$txtcrop'  ";

if($txtvariety!="ALL")
$sq.=" and rv_variety='$txtvariety' ";


if($txtupsdc!="ALL")
$sq.=" and rv_ups='$txtupsdc' ";

if($txtqcsts!="ALL")
$sq.=" and rv_qc='$txtqcsts' ";
...
while($row_tbl_sub=mysqli_fetch_array($sql_arr_home))
{
	...
	while($row_tbl_sub=mysqli_fetch_array($sql_tbl_sub))*/
	{
		...
		$quer4=mysqli_query($link,"SELECT varietyid, popularname FROM tblvariety  where varietyid='".$row_tbl_sub['rv_variety']."' and actstatus='Active' order by popularname Asc"); 
		$noticia_item = mysqli_fetch_array($quer4);
...
$dgt=explode("-",$row_tbl_sub['salesrs_dogt']);
