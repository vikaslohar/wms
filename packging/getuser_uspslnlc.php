...
$sql_month=mysqli_query($link,"select distinct packtype from tbl_lot_ldg_pack where plantcode='$plantcode' and lotldg_crop='".$b."' and lotldg_variety='".$a."' and trtype='NSTPNPSLIP' order by packtype")or die(mysqli_error($link));
/*$row_month=mysqli_fetch_array($sql_month);
$toup=explode(",",$row_month['gm']);*/
//echo $t=mysqli_num_rows($sql_month);
