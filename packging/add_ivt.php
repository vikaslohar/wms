<?php
	...
	{	
		...
		//exit;
		echo "<script>window.location='add_ivt_preview.php?p_id=$mainid'</script>";
	}	
	
	
	$sql_code="SELECT MAX(ivt_tcode) FROM tbl_ivtmain  where ivt_yearid='$yearid_id'  ORDER BY ivt_tcode DESC";
		...
		if(mysqli_num_rows($res_code) > 0)
			{
				...
				$t_code=$row_code['0'];
				$code=$t_code+1;
				$code1="TVT".$code."/".$yearid_id."/".$lgnid;
			}
			else
			{
				$code=1;
...
<title>Packaging -Transaction - Add IVT</title>
...
{
var txtclass=document.frmaddDept.txtclass.value;
showUser(classval24,'frvitem','fritem',txtclass,'','','','');
document.getElementById('maindiv').innerHTML="";
}
...
var txtclass=document.frmaddDept.txtclass.value;
showUser(classval24,'tovitem','toitem',txtitem,txtclass,'','','');
}
...
function qtyf1(qtyval, sval)
{
	...
	//alert(nobb);
	//alert(document.getElementById(nobb).value);
	if(document.getElementById(nobb).value!="")
	{
		if(parseFloat(document.getElementById(nobb).value)==0 || document.getElementById(nobb).value=="")
		{
...
{	
	...
	for (var i=1; i<document.frmaddDept.srno2.value;i++)
	{
		//var nob=
		var qty="txttrqty"+i;
		...
		/*if(document.frmaddDept.srno2.value==2)
		{
			if(document.frmaddDept.txttrqty[i].value=="" && document.frmaddDept.txttrqty[i].value=="")
			{
				alert("Please enter Qty to Transfer");
				//document.frmaddDept.protype.focus();
				f=1;
	...
	{	
		...
		//alert(document.frmaddDept.srno2.value);
		//g=document.frmaddDept.txttrqty1.value;
		for (var i=1; i<=document.frmaddDept.srno2.value;i++)
		{
			var qty="txttrqty"+i;
			//alert(document.getElementById(qty).value);
			g=parseFloat(g)+parseFloat(document.getElementById(qty).value);
		}
		...
		//alert(parseFloat(g)); alert(parseFloat(qtyg));
...
<table width="1003" height="600" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#1dbe03" >
	  ...
	  <table width="950" border="0" cellpadding="0" cellspacing="0" bordercolor="#1dbe03" style="border-bottom:solid; border-bottom-color:#1dbe03" >
	    <tr >
	      <td width="813" height="25" class="Mainheading">&nbsp;Transaction - Inter Variety Transfer - ADD</td>
	    </tr></table></td>
...
<tr class="Dark" height="25">
           ...
           <td width="287" align="left"  valign="middle">&nbsp;<input name="txtdate" type="text" size="12" class="tbltext" tabindex="0" readonly="true" style="background-color:#CCCCCC"  value="<?php echo date("d-m-Y");?>" /></td>
</tr>
<?php 
...
<td align="left" valign="middle" class="tbltext"  id="frvitem">&nbsp;<select class="tbltext" name="txtfritem" id="fritm" style="width:170px;" onchange="modetchk6(this.value);" >
<option value="" selected>-Select PV/CV Variety-</option>
</select>&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
<td align="right" valign="middle" class="tblheading">Transfer To - Variety&nbsp;</td>
<td align="left" valign="middle" class="tbltext" id="tovitem">&nbsp;<select class="tbltext" name="txttoitem" id="toitm" style="width:170px;" >
<option value="" selected>-Select PV/CV Variety-</option>
</select>&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
</tr>		
</table><br />
