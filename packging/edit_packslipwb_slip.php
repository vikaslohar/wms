...
{
//alert(dval2);
	var sno=document.frmaddDepartment.sno.value1;
	var dval=0;
	for(var i=1; i<=sno; i++)
	{
		var fet="fetchk_"+i;
...
<td align="left" width="273" valign="middle" class="smalltbltext" style="border-color:#1dbe03">&nbsp;<?php echo $row_tbl_sub['pnpslipmain_ttype'];?><input type="hidden" name="txtpacktype" value="<?php echo $row_tbl_sub['pnpslipmain_ttype'];?>" /></td>
...
<td align="left" width="200" valign="middle" class="smalltbltext" style="border-color:#1dbe03">&nbsp;
  <input name="txtlot1" type="text" size="20" class="smalltbltext" tabindex=""  maxlength="20"  value="<?php echo $row_tbl_sub['pnpslipsub_lotno'];?>" readonly="true" style="background-color:#CCCCCC" >&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
<td align="left" width="272" valign="middle" class="smalltblheading" style="border-color:#1dbe03">&nbsp;</td>
</tr>
</table>
