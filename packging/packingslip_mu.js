...
if(tp=="subformedt")
{ 
var url="getuser_packslip_mu_vedtsubform.php";
url=url+"?a="+str;
url=url+"&sid="+Math.random();
xmlHttp.onreadystatechange=stateChanged ;
xmlHttp.open("GET",url,true);
...
if(tp=="mform")
{ 
var url="getuser_packslip_mu_vupdateform.php";
url=url+"?"+str; 
url=url+"&sid="+Math.random();
xmlHttp.onreadystatechange=stateChanged ;
xmlHttp.open("GET",url,true);
...
if(tp=="mformsubedt")
{ 
var url="getuser_packslip_mu_veditsubupdate.php";
url=url+"?"+str; 
url=url+"&sid="+Math.random();
xmlHttp.onreadystatechange=stateChanged ;
xmlHttp.open("GET",url,true);
...
if(tp=="delete")
{
var url="getuser_packslip_mu_vdelete.php";
url=url+"?a="+str;
url=url+"&b="+d;
url=url+"&c="+e;
url=url+"&sid="+Math.random();
...
{
	//alert(tp); 
var url="getuser_packslip_mu_showrec.php";
url=url+"?a="+str;
url=url+"&b="+d;
url=url+"&c="+e;
url=url+"&h="+i;
