<?php
	...
	//exit; 
		...
		$sql_main="update tbl_oflpnpslipmain set pnpslipmain_tflag=2 where pnpslipmain_id ='$pid'";
		$a123456=mysqli_query($link,$sql_main) or die(mysqli_error($link));
		 //exit;
		echo "<script>window.location='home_packslip_ofl.php'</script>";	
	}
?>
...
<title>Packaging -Transaction - OFL Packing Slip- Preview</title>
...
<table width="1003" height="600" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
 ...
 <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#1dbe03" >
  <tr><td>
   ...
   <?php
   $tid=$pid;
$sql_tbl=mysqli_query($link,"select * from tbl_oflpnpslipmain where plantcode='$plantcode' and pnpslipmain_id='".$tid."'") or die(mysqli_error($link));
...
<tr class="tblsubtitle" height="20">
  <td colspan="8" align="center" class="tblheading">OFL Packing Slip Preview</td>
</tr>
</table>
<table align="center" border="1" width="970" cellspacing="0" cellpadding="0" bordercolor="#1dbe03" style="border-collapse:collapse" > 
...
<td align="right"  valign="middle" class="smalltblheading">Proc. Mach. Code&nbsp;</td>
    <td align="left"  valign="middle" class="smalltbltext" >&nbsp;<input name="txtdrefno2" type="text" size="20" class="smalltbltext" maxlength="20" readonly="true" style="background-color:#CCCCCC" value="<?php echo $num?>" /></td>
