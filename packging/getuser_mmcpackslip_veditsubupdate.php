...
{
	$mainid=$z1;
	$sql_sub="update into tbl_packaging_sub set packagingsub_crop='$txtcrop', packagingsub_variety='$txtvariety', where packaging_id='$mainid' and packagingsub_id='$subtrid'";
	if(mysqli_query($link,$sql_sub) or die(mysqli_error($link)))
	{
		$suid=$subtrid;
		$sqlsubsub="delete from tbl_packagingsub_sub where packaging_id='$mainid' and packagingsub_id='$suid'";
		$ssub1=mysqli_query($link,$sqlsubsub) or die(mysqli_error($link));
		$sqlsubsub2="delete from tbl_packagingsub_sub2 where packaging_id='$mainid' and packagingsub_id='$suid'";
