...
$flag=0; 	
	if($c!="")
	{
		...
		if($c=="txtslsubbg2")
		{
			...
			$uid="txtconslnob2";
			$qid="txtconslqty2";
			$u="Bagsf1(this.value,2)";
			$q="qtyf1(this.value,2)";
			$typ=$f;
		}
	}
...
if($tpmflg==0)
{
	if(($tp==$typ || $tp=="Empty"))
	{
		$s_good=mysqli_query($link,"select distinct lotldg_variety from plantcode='$plantcode' and  tbl_lot_ldg where lotldg_subbinid='".$a."' and lotldg_variety!='".$b."'") or die(mysqli_error($link));
...
if($tpmflg==0)
{
	if(($tp==$typ || $tp=="Empty"))
	{ $sa="";
		$s_good=mysqli_query($link,"select distinct lotldg_variety from plantcode='$plantcode' and  tbl_lot_ldg_pack where subbinid='".$a."' and lotldg_variety!='".$b."'") or die(mysqli_error($link));
		//echo $r_good=mysqli_num_rows($s_good);
		$cnt=0;
	while($row_issueg=mysqli_fetch_array($s_good))
 	{ 
...
<tr>
<td  align="center" valign="middle" class="smalltblheading" colspan="3"><?php echo $existview?><input name="slnop_1" id="slnop_1" type="hidden"  size="4" maxlength="6" class="tbltext"  value=""   /><input name="slnomp_1" id="slnomp_1" type="hidden" size="4" maxlength="6" class="tbltext" readonly="" style="background-color:#CCCCCC" value="<?php echo $g;?>" /><input name="slqt_1" id="slqt_1" type="hidden" size="4" maxlength="6" class="tbltext" readonly="" style="background-color:#CCCCCC"  value="<?php echo $h;?>" /></td>
</tr></table>
<?php
}
else if($tpflg==1)
...
?><table align="center" height="30" width="100%"  border="1" cellspacing="0" cellpadding="0" bordercolor="#1dbe03" style="border-collapse:collapse" >
<tr>
<td  align="center" width="33%"  valign="middle" class="smalltbltext"><input name="slnop_1" id="slnop_1" type="text"  size="4" maxlength="6" class="tbltext"  value=""   />&nbsp;<font color="#FF0000">* </font>&nbsp;</td>	
<td width="33%" align="center"  valign="middle" class="smalltbltext"><input name="slnomp_1" id="slnomp_1" type="text" size="4" maxlength="6" class="tbltext" readonly="" style="background-color:#CCCCCC" value="<?php echo $g;?>" />&nbsp;<font color="#FF0000">* </font>&nbsp;</td>
<td width="33%" align="center"  valign="middle" class="smalltbltext"><input name="slqt_1" id="slqt_1" type="text" size="4" maxlength="6" class="tbltext" readonly="" style="background-color:#CCCCCC"  value="<?php echo $h;?>" />&nbsp;<font color="#FF0000">* </font>&nbsp;</td>
</tr></table><?php }?>