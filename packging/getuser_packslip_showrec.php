...
if($tot_row > 0)
{
	$nob=0; $qty=0; $softstatus=""; $qc=""; $qcdot=""; $qcdot1=""; $qcdot2=""; $qcdttype=""; $srflg=0;
...
else
{
	if($tdt1!="" && $tdt2!="")
	{
		if($qcdot2!="" && $qcdot1!="" && $srflg==0)
		{
			...
			$start_ts = strtotime($tdt2);// echo "<br />";
			$end_ts = strtotime($tdt1); //echo "<br />";
			$user_ts = strtotime($tdte2); //echo "<br />";
...
if($qcdot1!="")
{
	...
	if($dt!="")
	{
		if($m==5 && ($de==28 || $de==29 || $de==30 || $de==31)){$mon=2; $dt=8;} else {$mon=0; $dt=9;}
...
<td width="135" align="center" valign="middle" class="tbltext">
<?php $quer3=mysqli_query($link,"SELECT dom_mcode FROM tbl_rm_dommac  order by dom_mcode Asc"); ?>
