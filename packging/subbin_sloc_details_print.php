...
<title>Packaging - Transaction - Sloc details</title>
...
?>
<table align="center" border="0" width="800" cellspacing="0" cellpadding="0" bordercolor="#1dbe03" style="border-collapse:collapse" >
...
<table align="center" border="1" cellspacing="0" cellpadding="0" width="800" bordercolor="#1dbe03" style="border-collapse:collapse">
...
?>			  
 <tr class="Light" height="20">
             <td width="27" align="center" valign="middle" class="tblheading"><?php echo $srno;?></td>
			 <td width="92" align="center"  valign="middle" class="tblheading"><?php echo $row_crop['cropname'];?></td>
			 <td width="73" align="center"  valign="middle" class="tblheading"><?php echo $varty;?></td>
			 ...
			 <td width="69" align="center" valign="middle" class="tblheading"><?php echo $nop1;?></td>
