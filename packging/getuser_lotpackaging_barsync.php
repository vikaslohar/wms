<?php
	...
	$abc=""; $abcdef="";
	//echo "Select bar_barcodes from tbl_barcodestmp where bar_lotno='".$lotno."' and bar_logid='".$logid."' and bar_psrn='".$txtpsrn."'";
...
if($sbinval<>"")
{ 
$totnompbar=0; $nob=0; $qty=0; $qty12=0;
...
//echo "select * from tbl_subbin where sid='".$sbinval."'";
	$nobcd="";
	...
	if($nobcd=="")$nobcd=$abcdef;
	
if($qty12<=0)$qty12=$totnompbar;
