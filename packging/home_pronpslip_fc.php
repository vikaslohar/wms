...
$sql_tbl=mysqli_query($link,"select * from tbl_pnpslipmain where plantcode='$plantcode' and logid='".$logid."' and pnpslipmain_tflag=0 and pnpslipmain_trtype='fc' ") or die(mysqli_error($link));
...
function openoflsync(subid,tid)
{
	winHandle=window.open('ofl_pack_sync.php?subid='+subid+'&mainid='+tid,'WelCome','top=200,left=180,width=870,height=250,scrollbars=yes');
	if(winHandle==null){
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#1dbe03" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#1dbe03" style="border-bottom:solid; border-bottom-color:#1dbe03" >
	    <tr >
	      <td width="940" height="25">&nbsp;Transaction - Processing and Packing slip (FC) </td>
	    </tr></table></td>
...
<td width="10">	 </td><td>
  ...
  $targetpage = $_SERVER['PHP_SELF']; 
	...
	if($page) 
		...
		$start = 0;	
		//echo "select * from tbl_pnpslipmain where plantcode='$plantcode' and pnpslipmain_ttype='Processing and Packing Slip' and pnpslipmain_tflag=2 order by pnpslipmain_tcode desc LIMIT $start, $limit";
  $sql_arr_home=mysqli_query($link,"select * from tbl_pnpslipmain where plantcode='$plantcode' and pnpslipmain_ttype='Processing and Packing Slip' and pnpslipmain_tflag=2 and pnpslipmain_trtype='fc'  order by pnpslipmain_tcode desc LIMIT $start, $limit") or die(mysqli_error($link));
...
$query = "select * from tbl_pnpslipmain where plantcode='$plantcode' and pnpslipmain_ttype='Processing and Packing Slip' and pnpslipmain_tflag=2 order by pnpslipmain_tcode desc";
...
<tr class="Light" height="20">
  <td colspan="6" align="center" class="tblheading">Processing and Packing slip FC Pending List</td>
</tr>
</table>
<table align="center" border="1" cellspacing="0" cellpadding="0" width="970" bordercolor="#1dbe03" style="border-collapse:collapse">
            ...
            <tr class="tblsubtitle" height="20">
			 ...
			 <td width="73" rowspan="2" align="center" valign="middle" class="smalltblheading">Transaction Id</td>
              <td width="57" rowspan="2" align="center" valign="middle" class="smalltblheading">MTN No.</td>
			  <td width="61" rowspan="2" align="center" valign="middle" class="smalltblheading">Indent No.</td>
			  <td width="56" rowspan="2" align="center" valign="middle" class="smalltblheading">Date</td>
              <td width="73" rowspan="2" align="center" valign="middle" class="smalltblheading">Crop</td>
              <td width="97" rowspan="2" align="center" valign="middle" class="smalltblheading">Variety</td>
              <td width="146" rowspan="2" align="center" valign="middle" class="smalltblheading">Lot No.</td>
              <td colspan="2" align="center" valign="middle" class="smalltblheading">Existing</td>
              <td colspan="2" align="center" valign="middle" class="smalltblheading">Processing</td>
              <td width="72" rowspan="2" align="center" valign="middle" class="tblheading">Indent Setup</td>
            <td width="39" rowspan="2" align="center" valign="middle" class="tblheading">Pack Details</td>
			<td width="48" rowspan="2" align="center" valign="middle" class="smalltblheading">SLOC Updation</td>
              </tr>
            <tr class="tblsubtitle" height="20">
              <td width="49" align="center" valign="middle" class="smalltblheading">NoB</td>
              <td width="50" align="center" valign="middle" class="smalltblheading">Qty</td>
              <td width="53" align="center" valign="middle" class="smalltblheading">NoB</td>
              <td width="47" align="center" valign="middle" class="smalltblheading">Qty</td>
            </tr>
<?php
//$srno=1;
if($tot_arr_home > 0)
...
while($row_arr_home=mysqli_fetch_array($sql_arr_home))
{
	...
	$indentno=$row_arr_home['pnpslipmain_indentsrn'];
	...
	while($row_tbl_sub=mysqli_fetch_array($sql_tbl_sub))
	{
		...
		$oflpck=0; $oflwbactflg=0; $oflsubid=0;
		
		$oflsub=mysqli_query($link,"select * from tbl_oflpnpslipsub where plantcode='$plantcode' and pnpslipsub_plotno='".$row_tbl_sub['pnpslipsub_plotno']."' and pnpslipsub_ups='".$row_tbl_sub['pnpslipsub_ups']."' ") or die(mysqli_error($link));
		$tot_oflsub=mysqli_num_rows($oflsub);
		if($tot_oflsub=mysqli_num_rows($oflsub)>0)
		{
			$row_oflsub=mysqli_fetch_array($oflsub);
			
			if($row_oflsub['pnpslipsub_syncflg']==0)
			{ 
				$oflmain=mysqli_query($link,"select pnpslipmain_wbactflag from tbl_oflpnpslipmain where plantcode='$plantcode' and pnpslipmain_id='".$row_oflsub['pnpslipmain_id']."' ") or die(mysqli_error($link));
				if($tot_oflmain=mysqli_num_rows($oflmain)>0)
				{
					$row_oflmain=mysqli_fetch_array($oflmain);	
					$oflwbactflg=$row_oflmain['pnpslipmain_wbactflag'];
				}
				if($oflwbactflg==1){$oflpck=1; $oflsubid=$row_oflsub['pnpslipsub_id'];}
				if($oflwbactflg==0){$oflpck=2;}
			}
			else
			{
				$oflpck=3;
...
<tr class="Light">
	...
	<td align="center" valign="middle" class="smalltbltext"><?php echo "PS".$row_arr_home['pnpslipmain_code']."/".$yearid_id."/".$lrole;?></td>
	<td align="center" valign="middle" class="smalltbltext"><?php echo $mtnno;?></td>
	<td align="center" valign="middle" class="smalltbltext"><?php echo $indentno;?></td>
	...
	<td align="center" valign="middle" class="smalltbltext"><?php if($row_arr_home['pnpslipmain_setupflg']==1) { echo "Updated";?><?php } else { ?><a href="add_pronpslip_slip_fc.php?maintrid=<?php echo $arrival_id;?>" >Update</a><?php } ?></td>
	<td align="center" valign="middle" class="smalltbltext"><?php if($row_arr_home['pnpslipmain_wbactflag']==1){  ?><a href="Javascript:void(0)" onclick="openpackdetails(<?php echo $arrival_id;?>)">View</a><?php } else { if($oflpck==1){?><a href="Javascript:void(0)" onclick="openoflsync(<?php echo $oflsubid;?>,<?php echo $arrival_id;?>)">Sync Offline</a><?php }else if($oflpck==2){ ?>Offline Submit Pending<?php }else if($oflpck==3){ ?>Already Synced<?php } else { ?>Pending<?php }} ?></td>
	<td align="center" valign="middle" class="smalltbltext"><?php if($row_arr_home['pnpslipmain_wbactflag']==1 && $row_arr_home['pnpslipmain_prolossupdflg']==1) { ?><a href="add_pronpslip_slipsloc_fc.php?p_id=<?php echo $arrival_id;?>" >Update</a><?php } else { ?>Pending<?php } ?></td>
</tr>
<?php
}
else
...
<?php echo $pagination?>
  ...
  $sql_arr_home2=mysqli_query($link,"select * from tbl_pnpslipmain where plantcode='$plantcode' and pnpslipmain_ttype='Processing and Packing Slip'  and pnpslipmain_tflag=1 and pnpslipmain_trtype='fc' order by pnpslipmain_tcode desc LIMIT $start2, $limit2") or die(mysqli_error($link));
...
$query2 = "select * from tbl_pnpslipmain where plantcode='$plantcode' and pnpslipmain_ttype='Processing and Packing Slip' and pnpslipmain_tflag=1 order by pnpslipmain_tcode desc";
...
<table align="center" border="0" width="600" cellspacing="0" cellpadding="0" bordercolor="#4ea1e1" style="border-collapse:collapse" > 
<tr class="Light" height="20">
  <td colspan="6" align="center" class="tblheading">Processing and Packing slip FC Completed List</td>
</tr>
</table>
<table align="center" border="1" cellspacing="0" cellpadding="0" width="970" bordercolor="#1dbe03" style="border-collapse:collapse">
...
<tr class="Light">
         ...
         <td align="center" valign="middle" class="smalltbltext"><a href="add_pronpslip_view_fc.php?p_id=<?php echo $arrival_id;?>"><?php echo "PS".$row_arr_home2['pnpslipmain_tcode']."/".$yearid_id."/".$lrole;?></a></td>
         <td align="center" valign="middle" class="smalltbltext"><?php echo $trdate;?></td>
         <td align="center" valign="middle" class="smalltbltext"><?php echo $crop?></td>
         <td align="center" valign="middle" class="smalltbltext"><?php echo $variety?></td>
         <td align="center" valign="middle" class="smalltbltext"><?php echo $lotno?></td>
