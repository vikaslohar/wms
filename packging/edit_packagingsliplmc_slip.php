<?php
	...
	if(isset($_POST['frm_action'])=='submit')
	{
		...
		$tdate2=$tdate12[2]."-".$tdate12[1]."-".$tdate12[0];
   		...
   		$sql_main="update tbl_packaging set packaging_type='$ttype', packaging_tdate='$tdate1', packaging_code='$txtid',  packaging_date='$tdate2', packaging_slipno='$txtpsrn', packaging_remarks='$txtremarks', packaging_yearid='$yearid_id', packaging_logid='$logid', packaging_barcode='$barcode', packaging_mptype='$mptyp' where packaging_id='$pid'";
		...
		echo "<script>window.location='add_packagingsliplmc_preview.php?p_id=$pid'</script>";	
		}
	}
...
{ 
	...
	?>
		<option <?php if($upsize==$uups) {echo "Selected"; $nopmp=$parray1[$i]; $wtimp=$parray2[$i]; }?> value="<?php echo $uups;?>" />   
		<?php echo $uups;?>
	<?php } } ?>
</select>&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
...
$extnob=$extqty*$ptp;
$qty=$nob*$ptp1;
$c=$row_tblsub['packagingsub_variety'];
