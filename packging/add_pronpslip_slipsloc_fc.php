<?php
	...
	if(isset($_POST['frm_action'])=='submit')
	{
		...
		if(isset($_POST['pchccqty'])) { $pchccqty= $_POST['pchccqty']; }
		if(isset($_POST['pckloss'])) { $pckloss= $_POST['pckloss']; }
		if(isset($_POST['pcklossper'])) { $pcklossper= $_POST['pcklossper']; }
		...
		if($z1>0)
		{
		  	$sql_tbl="UPDATE tbl_pnpslipmain SET pnpslipmain_proslipno='".$txtpsrn."' where pnpslipmain_id='".$maintrid."'";
			$row_tbl=mysqli_query($link,$sql_tbl) or die(mysqli_error($link));
			$mainid=$maintrid;
			
			$sql_tblsub=mysqli_query($link,"select * from tbl_pnpslipsub where pnpslipmain_id='".$maintrid."'") or die(mysqli_error($link));
			$row_tblsub=mysqli_fetch_array($sql_tblsub);
			$suid=$row_tblsub['pnpslipsub_id'];
			
			 $sql_psub="update tbl_pnpslipsub set pnpslipsub_packcc='$ccloss', pnpslipsub_pouchccqty='$pchccqty',  pnpslipsub_packloss='$pckloss', pnpslipsub_packqty='$totpckqtyp', pnpslipsub_nop='$totnop'  where pnpslipsub_id ='$suid'";
			 $a123456=mysqli_query($link,$sql_psub) or die(mysqli_error($link));
			/*$sql_tblsubsub=mysqli_query($link,"select * from tbl_pnpslipsubsub where pnpslipmain_id='".$maintrid."'") or die(mysqli_error($link));
			$row_tblsubsub=mysqli_fetch_array($sql_tblsubsub);*/
			$sql_tblsubsub=mysqli_query($link,"DELETE from tbl_pnpslipsubsub3 where pnpslipmain_id='".$mainid."' and pnpslipsub_id='".$suid."'") or die(mysqli_error($link));
			for($j=1; $j<=$sno3; $j++)
			{
		...
		$p_id=$z1;
		echo "<script>window.location='add_pronpslipsloc_preview_fc.php?p_id=$p_id'</script>";	
	}
...
{ 
	...
	if(document.frmaddDepartment.txtpsrn.value=="") 
	{
		alert("Please enter Packing Slip Reference Number.");
		f=1;
		return false;
	}
	if(f==1)
	...
	{	
		...
		{
			if(parseFloat(zx)!=parseFloat(document.frmaddDepartment.totpckqtyp.value))
			{
				alert("Please check. Quantity in Pack Seed is not matching with Quantity distributed in Bins");
				f=1;
				return false;
...
function uploadgw()
{
	...
	winHandle=window.open('getuser_pronpslip_barcode_gwupd.php?tid='+tid+'&subtid='+subtid,'WelCome','top=170,left=180,width=450,height=450,scrollbars=yes');
				if(winHandle==null){
				alert("While Launching New Window...\nYour browser maybe blocking up Popup windows. \n\n  Please check your Popup Blocker Settings or ..\n Please hold Ctrl Key and Click on link to open new Browser"); }
...
{ 	//alert(wh1val);
	//alert(whno);
	var wh="txtwhg"+whno;
	if(document.frmaddDepartment.gwupdflg.value=="" || parseInt(document.frmaddDepartment.gwupdflg.value)==0) 
	{
	...
	if(document.frmaddDepartment.pchccqty.value=="") 
	{
		alert("Please enter Pouch CC qty in Gms..");
		document.getElementById(wh).SelectedIndex=0;
		document.getElementById(wh).value="";
		return false;
	}
...
function sloccomment(rval)
{
	...
	var wtnop="wtnop_1";
	var wtmp="wtmp_1";
	var mptnop="wtnopkg_1";
	var wbwt="wbwt"; 
	var wbnop="wbnop_1"; 
	var totnomp="totnomp"; 
	var loosepouches="loosepouches"; 
	var loosewb="loosewb";
	var totpckqty="totpckqty";
	var totnop="totnop";
	//alert(parseInt(document.getElementById(loosepouches).value)); 
	//alert(parseInt(parseInt(document.getElementById(totnomp).value)*parseInt(document.getElementById(wtnop).value))); 
	//alert(parseInt(parseInt(document.getElementById(wbnop).value)*parseInt(document.getElementById(loosewb).value)));

	var totpch=parseInt(document.getElementById(totnop).value);
	//alert(totpch);
	//alert(document.getElementById(totnomp).value);
	//totpch=parseInt(parseInt(document.getElementById(totnomp).value)*parseInt(document.getElementById(wtnop).value));
	//totpch=parseInt(totpch)+parseInt(parseInt(document.getElementById(wbnop).value)*parseInt(document.getElementById(loosewb).value));
	...
	else if((document.getElementById(trflg).value!="" && document.getElementById(tpflg).value!="" && document.getElementById(tflg).value!="" && document.getElementById(tpmflg).value!="") && (document.getElementById(trflg).value==0 && document.getElementById(tpflg).value==0 && document.getElementById(tflg).value==0 && document.getElementById(tpmflg).value==0))
	{
		if(document.frmaddDepartment.detmpbno.value!="" || document.frmaddDepartment.detmpbno.value > 0)
		{
			document.getElementById(mp).value=parseInt(document.getElementById(totnomp).value);
		...
		document.getElementById(tp).value=parseFloat(totpch);
		document.getElementById(tq).value=parseFloat(document.getElementById(totpckqty).value);
	}
	else
	{
...
function pacsbinchk(mpval, mpno)
{
	...
	{
		var loosewbval=''; var npwt=0; var wbqty=0;
		var d=0; var dd=0;
//alert(parseInt(loosewbval));
		...
		for(var i=1; i<=sno; i++)
		{;
			//alert(parseInt(document.getElementById('wbnop_'+[i]).value));	alert(parseInt(loosewbval));			
		...
		{
			document.getElementById('noptpchs_'+[mpno]).value=0;
...
function pouchcccalc(ccval)
{
	var totpouches=parseInt(document.frmaddDepartment.totnop.value);
	
	var totccqty=(parseInt(totpouches)*parseFloat(ccval));
	
	var totpckqtyp=(parseFloat(document.frmaddDepartment.totpckqty.value)+parseFloat(totccqty));
	 totpckqtyp=parseFloat( totpckqtyp).toFixed(3);
	var loss=parseFloat(document.frmaddDepartment.picqtyp.value)-parseFloat(totpckqtyp);
//alert(totpouches);alert(totccqty);alert(totpckqtyp);alert(loss);
	
	if(parseFloat(loss)>=0)
	{
		document.frmaddDepartment.ccloss.value=parseFloat(totccqty);
		document.frmaddDepartment.pckloss.value=parseFloat(document.frmaddDepartment.picqtyp.value)-parseFloat(totpckqtyp);
		document.frmaddDepartment.pckloss.value=parseFloat(document.frmaddDepartment.picqtyp.value)-parseFloat(totpckqtyp);
		document.frmaddDepartment.pcklossper.value=(parseFloat(document.frmaddDepartment.pckloss.value)/parseFloat(document.frmaddDepartment.picqtyp.value))*100;
		document.frmaddDepartment.pcklossper.value=parseFloat(document.frmaddDepartment.pcklossper.value).toFixed(2);
		document.frmaddDepartment.pckloss.value=parseFloat(document.frmaddDepartment.pckloss.value).toFixed(3);
	}
	else
	{
		alert("Please enter correct Captive Consumption Qty in Gms. per Pouch");
		document.frmaddDepartment.pchccqty.value="";
		document.frmaddDepartment.ccloss.value="";
		document.frmaddDepartment.pckloss.value="";
		document.frmaddDepartment.pckloss.value="";
		document.frmaddDepartment.pcklossper.value="";
		document.frmaddDepartment.pcklossper.value="";
	}
//alert(parseInt(document.frmaddDepartment.totnop.value)); alert(parseInt(document.frmaddDepartment.loosepouches.value)); alert(totccqty); alert(document.frmaddDepartment.ccloss.value); alert(document.frmaddDepartment.totpckqtyp.value); alert(document.frmaddDepartment.pckloss.value); alert(document.frmaddDepartment.pcklossper.value); alert(document.frmaddDepartment.pcklossper.value);
}
...
<tr class="tblsubtitle" height="20">
  <td colspan="8" align="center" class="tblheading">Processing and Packing slip FC - SLOC Updation </td>
</tr>
...
<td width="157" align="right"  valign="middle" class="smalltblheading">Packing Slip Ref. No.&nbsp;</td>
    <td width="165" align="left"  valign="middle" class="smalltbltext">&nbsp;<input name="txtpsrn" type="text" size="8" maxlength="8" class="smalltbltext" tabindex="" value="<?php echo $row_tbl['pnpslipmain_proslipno'];?>" onkeypress="return isNumberKey1(event)" />&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
</tr></table>
<table align="center" border="1" width="970" cellspacing="0" cellpadding="0" bordercolor="#1dbe03" style="border-collapse:collapse" > 
<tr class="Light" height="30">
 <?php
...
<table align="center" border="1" width="970" cellspacing="0" cellpadding="0" bordercolor="#1dbe03" style="border-collapse:collapse" >	
  <tr class="tblsubtitle" height="20">
	...
	<td width="124" align="center" valign="middle" class="smalltblheading">Pouch CC Qty (Kgs.)</td>
	<td width="153" align="center" valign="middle" class="smalltblheading">Captive Consumption Qty</td>
	<td width="124" align="center" valign="middle" class="smalltblheading">Packing Loss Qty</td>
	<td width="124" align="center" valign="middle" class="smalltblheading">Packing Loss %</td>
	<td width="128" align="center" valign="middle" class="smalltblheading">Balance Packing Qty</td>
	<!--<td width="72" align="center" valign="middle" class="smalltblheading">Gross Weight File</td>-->
</tr>
<tr class="Light" height="25">  
  <td  align="center"  valign="middle" class="smalltbltext"><input name="picqtyp" id="picqtyp" type="text" size="8" class="smalltbltext" tabindex="" maxlength="10"  onkeypress="return isNumberKey(event)" readonly="true"  style="background-color:#CCCCCC"  value="<?php echo $pickpqty;?>" />&nbsp;<font color="#FF0000" >* </font>&nbsp;</td>
  <td  align="center"  valign="middle" class="smalltbltext"><input name="totpckqtyp" id="totpckqtyp" type="text" size="8" class="smalltbltext" tabindex="" maxlength="10"  onkeypress="return isNumberKey(event)" readonly="true"  style="background-color:#CCCCCC"  value="<?php echo $totpckqty;?>" />&nbsp;<font color="#FF0000" >* </font>&nbsp;</td>  
  <td  align="center"  valign="middle" class="smalltbltext" ><input name="loosepouches" id="loosepouches" type="text" size="7" class="smalltbltext" tabindex=""   maxlength="7" onkeypress="return isNumberKey1(event)" readonly="true"   style="background-color:#CCCCCC"  value="<?php echo $loosepouches;?>" />&nbsp;</td>
  
  <td  align="center"  valign="middle" class="smalltbltext" ><input name="pchccqty" id="pchccqty" type="text" size="7" class="smalltbltext" tabindex=""   maxlength="7" onkeypress="return isNumberKey(event)" value="<?php echo $pchccqty;?>" onchange="pouchcccalc(this.value)"  />&nbsp;<font color="#FF0000" >* </font>&nbsp;</td>
  <td  align="center"  valign="middle" class="smalltbltext"><input name="ccloss" id="ccloss" type="text" size="8" class="smalltbltext" tabindex="" maxlength="10" onchange="plchk1(this.value);"  onkeypress="return isNumberKey(event)" value="<?php echo $pckccqty;?>" readonly="true"  style="background-color:#CCCCCC"  />&nbsp;<font color="#FF0000" >* </font>&nbsp;</td>
  <td  align="center"  valign="middle" class="smalltbltext" ><input name="pckloss" id="pckloss" type="text" size="7" class="smalltbltext" tabindex=""   maxlength="7" onkeypress="return isNumberKey(event)" onchange="pfpchk1(this.value);" value="<?php echo $pcklossqty;?>" readonly="true"  style="background-color:#CCCCCC"  />&nbsp;<font color="#FF0000" >* </font>&nbsp;</td>
  <td  align="center"  valign="middle" class="smalltbltext" ><input name="pcklossper" id="pcklossper" type="text" size="7" class="smalltbltext" tabindex=""   maxlength="7" onkeypress="return isNumberKey(event)" onchange="pfpchk1(this.value);" value="<?php echo $pcklossper;?>" readonly="true"  style="background-color:#CCCCCC"  />&nbsp;<font color="#FF0000" >* </font>&nbsp;</td>
 <td  align="center"  valign="middle" class="smalltbltext" ><input name="balpck" id="balpck" type="text" size="7" class="smalltbltext" tabindex=""   maxlength="7" onkeypress="return isNumberKey1(event)" readonly="true"   style="background-color:#CCCCCC" value="0"  />&nbsp;</td>
...
<br />
<input type="hidden" name="detmpbno" value="<?php echo $loosepouches;?>" /><input type="hidden" name="nopks" value="<?php echo $loosepouches;?>" />

<table align="center" border="1" width="970" cellspacing="0" cellpadding="0" bordercolor="#1dbe03" style="border-collapse:collapse" >
<tr class="tblsubtitle" height="25">
<td align="center" valign="middle" class="tblheading" colspan="8">SLOC</td>
</tr>
<tr class="tblsubtitle" height="25">
...
<td align="center" valign="middle" class="tbltext" title="<?php echo $nobcd;?>"><?php echo $totnomp;?><input type="text" class="tbltext" name="nopmpcs_<?php echo $sno3;?>" id="nopmpcs_<?php echo $sno3;?>" value="<?php echo $totnomp;?>" size="9"  onchange="pacsbinchk(this.value,<?php echo $sno3;?>)"  onkeypress="return isNumberKey1(event)"   /></td>

<td align="center" valign="middle" class="tbltext"><input type="text" class="tbltext" name="noppchs_<?php echo $sno3;?>" id="noppchs_<?php echo $sno3;?>" value="<?php echo $row_tbl_subsub3['pnpslipsubsub_pouches'];?>" size="9"  onchange="pacpchchk(this.value,<?php echo $sno3;?>)" readonly="true" style="background-color:#CCCCCC"  /></td>
...
<td align="center" valign="middle" class="tbltext"><input type="text" class="tbltext" name="nopmpcs_1" id="nopmpcs_1" value="" size="9"  readonly="true" style="background-color:#CCCCCC" onchange="pacsbinchk(this.value,1)" onkeypress="return isNumberKey1(event)"   /></td>
...
<td align="center" valign="middle" class="tbltext"><input type="text" class="tbltext" name="nopmpcs_2" id="nopmpcs_2" value="" size="9"  readonly="true" style="background-color:#CCCCCC" onchange="pacsbinchk(this.value,2)"  onkeypress="return isNumberKey1(event)"  /></td>
...
<td align="center" valign="middle" class="tbltext"><input type="text" class="tbltext" name="nopmpcs_3" id="nopmpcs_3" value="" size="9"  readonly="true" style="background-color:#CCCCCC" onchange="pacsbinchk(this.value,3)" onkeypress="return isNumberKey1(event)"   /></td>
...
<td align="center" valign="middle" class="tbltext"><input type="text" class="tbltext" name="nopmpcs_4" id="nopmpcs_4" value="" size="9"  readonly="true" style="background-color:#CCCCCC" onchange="pacsbinchk(this.value,4)" onkeypress="return isNumberKey1(event)"   /></td>
...
<td align="center" valign="middle" class="tbltext"><input type="text" class="tbltext" name="nopmpcs_5" id="nopmpcs_5" value="" size="9"  readonly="true" style="background-color:#CCCCCC" onchange="pacsbinchk(this.value,5)" onkeypress="return isNumberKey1(event)"   /></td>
...
<td align="center" valign="middle" class="tbltext"><input type="text" class="tbltext" name="nopmpcs_6" id="nopmpcs_6" value="" size="9"  readonly="true" style="background-color:#CCCCCC" onchange="pacsbinchk(this.value,6)" onkeypress="return isNumberKey1(event)"   /></td>
...
<td align="center" valign="middle" class="tbltext"><input type="text" class="tbltext" name="nopmpcs_7" id="nopmpcs_7" value="" size="9"  readonly="true" style="background-color:#CCCCCC"  onchange="pacsbinchk(this.value,7)" onkeypress="return isNumberKey1(event)"  /></td>
...
<td align="center" valign="middle" class="tbltext"><input type="text" class="tbltext" name="nopmpcs_8" id="nopmpcs_8" value="" size="9" readonly="true" style="background-color:#CCCCCC" onchange="pacsbinchk(this.value,8)" onkeypress="return isNumberKey1(event)" /></td>
