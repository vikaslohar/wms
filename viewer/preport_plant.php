<?php
	...
	$typ = $_POST['txtvisualck'];
		...
		if($sdate!="" && $edate!="")
		{
		echo "<script>window.location='preport_plant12.php?sdate=$sdate&edate=$edate&txtcrop=$cid&txtvariety=$itemid&txtvisualck=$typ'</script>";
		}
		else
		 {?>
		 <script>
...
<title>Viewer- Report -Consolidated Arrival Report Selection</title>
...
<tr>
<td width="30">	 </td><td>
<table align="center" border="1" width="574" cellspacing="0" cellpadding="0" bordercolor="#ef0388" style="border-collapse:collapse" >
...
<tr >
<td valign="top" align="center" style="color:#FF0000"><b>Note:</b>User advised to select shorter period.Long period selection will take more time to generate the report.</td>
</tr>
</table>
</td><td ></td>
</tr>
