...
function cleanData(&$str)
	...
	$datatitle3 = array("#","Date of Arrival","Crop","Variety","Lot No.","NoB","Qty","NoB","Qty","GOT Status","Production Personnel","Organiser","Farmer","Production Location","State","Blend Lot No.");
...
if($tot_arr_home > 0)			
{
$data1[$d]=array($d,$trdate,$crop,$variety,$lotno,$bags,$qty,$bags2,$qty2,$got,$pp12,$org,$farm,$moist,$stage,$blendlot); 
$d++;
}
}
}
