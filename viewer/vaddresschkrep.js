...
if(tp=="lotnoexsit")
{
var url="getuser_lotregular.php";
url=url+"?a="+str;
url=url+"&sid="+Math.random();
xmlHttp.onreadystatechange=stateChanged ;
xmlHttp.open("GET",url,true);
...
if(tp=="subformedt")
{ 
var url="getuser_edtvupdateform.php";
url=url+"?a="+str;
url=url+"&sid="+Math.random();
xmlHttp.onreadystatechange=stateChanged ;
xmlHttp.open("GET",url,true);
...
if(tp=="mformsubedthome")
{ 
var url="getuser_veditsubupdate1.php";
url=url+"?"+str; 
url=url+"&sid="+Math.random();
xmlHttp.onreadystatechange=stateChanged ;
xmlHttp.open("GET",url,true);
...
if(tp=="item")
{
var url="getuser_stitemdroprep.php";
url=url+"?a="+str;
url=url+"&sid="+Math.random();
xmlHttp.onreadystatechange=stateChanged ;
xmlHttp.open("GET",url,true);
...
if(tp=="itemufsr")
{
var url="getuser_stitemdrop_sfrl.php";
url=url+"?a="+str;
url=url+"&sid="+Math.random();
xmlHttp.onreadystatechange=stateChanged ;
xmlHttp.open("GET",url,true);
...
if(tp=="itemqc")
{
var url="getuser_stitemdropqc.php";
url=url+"?a="+str;
url=url+"&sid="+Math.random();
xmlHttp.onreadystatechange=stateChanged ;
xmlHttp.open("GET",url,true);
...
if(tp=="itemups2")
{
var url="getuser_uspslreplmc.php";
url=url+"?a="+str;
url=url+"&sid="+Math.random();
xmlHttp.onreadystatechange=stateChanged ;
xmlHttp.open("GET",url,true);
...
if(tp=="itemloc")
{
var url="getuser_locationrep.php";
url=url+"?a="+str;
url=url+"&b="+d;
url=url+"&c="+e;
url=url+"&f="+i;
...
if(tp=="selstloc")
{
var url="getuser_partylocationrep.php";
url=url+"?a="+str;
url=url+"&b="+d;
url=url+"&c="+e;
url=url+"&f="+i;
