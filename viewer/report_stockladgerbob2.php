...
$sql_istbl=mysqli_query($link,"select * from tmp_pmsldgrep2 where plantcode='$plantcode' AND logid='".$logid."' order by crop asc, variety asc") or die(mysqli_error($link)); 
