<?php
	...
	$sql_rep="Delete from tmp_pmsldgrep2 where logid='$logid'";
	...
	if(isset($_POST['frm_action'])=='submit')
	{
		...
		echo "<script>window.location='report_stockladgerbob1.php?slchk=$slchk&slchk2=$slchk2&txtcrop=$cid&txtvariety=$itemid&sdate=$sdate&edate=$edate'</script>";
	}
?>
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#ef0388" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#ef0388" style="border-bottom:solid; border-bottom-color:#ef0388" >
	    <tr >
	      <td width="813" height="30"class="Mainheading"  >Periodical Crop Variety wise Classified Stock Report</td>
	    </tr></table></td>
	  </tr>
	  </table></td></tr>
	...
	<input type="hidden" name="cdate" value="<?php echo date("d-m-Y", time());?>" />
	    <table  border="0" cellspacing="0" cellpadding="0" align="center" width="974"  style="border-collapse:collapse">
          ...
          <tr>
            <td width="30"></td>
            <td><table align="center" border="1" width="700" cellspacing="0" cellpadding="0" bordercolor="#ef0388" style="border-collapse:collapse" >
                <tr class="tblsubtitle" height="25">
                  <td colspan="4" align="center" class="tblheading">Periodical Crop Variety wise Classified Stock Report</td>
                </tr>
                <tr height="15">
               ...
               <tr class="Dark" height="25">
                  <td width="104" height="30" align="right" valign="middle" class="tblheading">&nbsp;Period&raquo;&nbsp;From&nbsp;</td>
                  <td width="242" align="left"  valign="middle" >&nbsp;<input name="sdate" id="sdate" type="text" size="10" class="tbltext" tabindex="0" readonly="true"  value="<?php echo date("d-m-Y", time());?>" style="background-color:#EFEFEF" />&nbsp;<a href="javascript:void(0)" onClick="showCalendar('sdate');" tabindex="6"><img src="../images/cal.gif" alt="Calender" border="0" align="absmiddle" /></a><script type="text/javascript" language="javascript" src="../../include/popcalender22.js"></script>&nbsp;<font color="#FF0000" >*</font></td>
                   <td width="73" align="right"  valign="middle" class="tblheading">&nbsp;To&nbsp;</td>
                  <td width="271" align="left"  valign="middle" >&nbsp;<input name="edate" id="edate" type="text" size="10" class="tbltext" tabindex="0" readonly="true"  value="<?php echo date("d-m-Y", time());?>" style="background-color:#EFEFEF" />&nbsp;<a href="javascript:void(0)" onClick="showCalendar('edate');" tabindex="6"><img src="../images/cal.gif" alt="Calender" border="0" align="absmiddle" /></a><script type="text/javascript" language="javascript" src="../../include/popcalender22.js"></script>&nbsp;<font color="#FF0000" >*</font></td>
</tr>
<?php
...
<!--   <tr class="Light" height="25">
    ...
    <td align="left"  valign="middle" class="tbltext" id="vitem" >&nbsp;<input tabindex="0" type="radio" name="wsloc" value="yes" onclick="slchk(this.value)" checked="checked" />Yes&nbsp;<input tabindex="0" type="radio" name="wsloc" value="no" onclick="slchk(this.value)" />No</td>
