<?php
	...
	$sql_istbl=mysqli_query($link,"select tid from tmp_vwasrrep where plantcode='$plantcode' AND logid='".$logid."' order by crop asc, variety asc") or die(mysqli_error($link)); 
	while($row_issuetbl=mysqli_fetch_array($sql_istbl))
	{ 
		$sql_repsub="Delete from tmp_vwasrrep2 where tid='".$row_issuetbl['tid']."'";
		$inssub=mysqli_query($link,$sql_repsub) or die(mysqli_error($link));
	}
	$sql_rep="Delete from tmp_vwasrrep where logid='$logid'";
	...
	if(isset($_POST['frm_action'])=='submit')
	{
		...
		echo "<script>window.location='report_rawcropq1.php?slchk=$slchk&slchk2=$slchk2&txtcrop=$cid&txtvariety=$itemid'</script>";
	}
?>
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#ef0388" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#ef0388" style="border-bottom:solid; border-bottom-color:#ef0388" >
	    <tr >
	      <td width="813" height="30"class="Mainheading"  >Quality based Stock Report </td>
	    </tr></table></td>
	  </tr>
	  </table></td></tr>
          ...
          <tr>
            ...
            <td><table align="center" border="1" width="600" cellspacing="0" cellpadding="0" bordercolor="#ef0388" style="border-collapse:collapse" >
                <tr class="tblsubtitle" height="25">
                  <td colspan="2" align="center" class="tblheading">Quality based Stock Report</td>
                </tr>
                <tr height="15">
