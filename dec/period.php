<?php
	...
	if(isset($_REQUEST['edate']))
	{
	 $edate = $_REQUEST['edate'];
		...
		if($sdate!="" && $edate!="")
		{
		/*echo "<script>window.location='period1.php?sdate=$sdate&edate=$edate'</script>";*/
		header('Location: period1.php?sdate='.$sdate.'&edate='.$edate);
		}
		else
		 {?>
		 <script>
...
<title>Decode-Report - Period wise  Report</title>
...
<table width="1003" height="600" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#7a9931" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#7a9931" style="border-bottom:solid; border-bottom-color:#7a9931" >
	    <tr >
	      <td width="813" height="30"class="Mainheading"  >&nbsp;Period wise Decode Report	</td>
	    </tr></table></td>
	  </tr>
	  </table></td></tr>
 ...
 style="border-collapse:collapse" >
                <tr class="tblsubtitle" height="25">
                  <td colspan="4" align="center" class="tblheading">Period wise Decode Report</td>
                </tr>
                <tr height="15">
...
?>
                ...
                <?php 
$qry=mysqli_query($link,"select did,dest from tbldestination  order by dest Asc") or die(mysqli_error($link));
?>
