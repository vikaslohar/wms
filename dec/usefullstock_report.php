<?php
	...
	if(isset($_POST['frm_action'])=='submit')
	{
		...
		echo "<script>window.location='usefullstock_report1.php?txtcrop=$txtcrop&txtvariety=$txtvariety&sdate=$sdate&edate=$edate'</script>";
	}
...
<title>Decode-Report - Ready Stock Report As on <?php echo date("d-m-Y");?></title>
...
{	
	showUser(classval,'vitem','itemufsr','','','','','');
}
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#7a9931" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#7a9931" style="border-bottom:solid; border-bottom-color:#7a9931" >
	    <tr >
	      <td width="813" height="30"class="Mainheading"  >&nbsp;Ready Stock Report As on <?php echo date("d-m-Y");?></td>
	    </tr></table></td>
	  </tr>
	  </table></td></tr>
...
<tr>
<td width="30">	 </td><td>
<table align="center" border="1" width="550" cellspacing="0" cellpadding="0" bordercolor="#7a9931" style="border-collapse:collapse" >
                <tr class="tblsubtitle" height="25">
                  <td colspan="4" align="center" class="tblheading" >Ready Stock Report As on <?php echo date("d-m-Y");?></td>
                </tr>
                <tr height="15">
...
?>                 </tr>
  <tr class="Dark" height="25">
                  ...
                  <td width="20%" align="left"  valign="middle" >&nbsp;<input name="sdate" id="sdate" type="text" size="10" class="tbltext" tabindex="0" readonly="true"  value="<?php echo date("d-m-Y", time());?>" style="background-color:#EFEFEF" />&nbsp;<font color="#FF0000" >*</font></td>
