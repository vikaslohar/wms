...
$sql = "select * from tblspcodes where altdate <= '$edate' and altdate >= '$sdate' ";
	...
	$dh="Period_Wise_Report_From_".$_REQUEST['sdate']."_To_".$_REQUEST['edate'];
	$datahead = array($dh);
	$datahead1 = array("Period Wise Report");
	$datahead2 = array("Period: ","  Date From: ",$_REQUEST['sdate'],"  To: ",$_REQUEST['edate']);
	$data1 = array();
