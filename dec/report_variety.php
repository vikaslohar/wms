<?php
	...
	if(isset($_POST['frm_action'])=='submit')
	{
		...
		header('Location: report_variety1.php?age='.$age);
	}
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#7a9931" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#7a9931" style="border-bottom:solid; border-bottom-color:#7a9931" >
	    <tr >
	      <td width="813" height="30"class="Mainheading"  >&nbsp;Coded Raw Seed Report - As on Date <?php echo date("d-m-Y");?></td>
	    </tr></table></td>
	  </tr>
	  </table></td></tr>
	  ...
	  <form name="frmaddDepartment" method="post" action="<?php $_SERVER['PHP_SELF']; ?>" > 
	    <table  border="0" cellspacing="0" cellpadding="0" align="center" width="974"  style="border-collapse:collapse">
          ...
          <tr>
            <td width="30"></td>
            <td><table align="center" border="1" width="574" cellspacing="0" cellpadding="0" bordercolor="#7a9931" style="border-collapse:collapse" >
...
<!----><tr class="Light" height="25">
	<td align="right"  valign="middle" class="tblheading" >Select - Duration based on Arrival&nbsp;</td>
