...
winHandle=window.open('report_crop.php?sdate='+sdate+'&edate='+edate+'&txtclss='+cls,'WelCome','top=20, left=80, width=800, height=500, scrollbars=yes');
if(winHandle==null){
...
<table width="1003" height="600" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  ...
  <tr><td>
   ...
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#7a9931" >
	  ...
	  <td width="940" class="Mainheading" height="25"><table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#7a9931" style="border-bottom:solid; border-bottom-color:#7a9931" >
        <tr >
          <td width="813" height="25">&nbsp;Crop Wise   Report</td>
        </tr>
	    </table></td>
	  </tr>
	  </table></td></tr>
...
?>
<table align="center" border="0" cellspacing="0" cellpadding="0" width="774" style="border-collapse:collapse">
   <tr height="25" >
    <td align="center" class="Mainheading" style="color:#303918; ">Crop wise Report</td>
  	</tr>
  	</table>
  <table align="center" border="0" cellspacing="0" cellpadding="0" width="774" style="border-collapse:collapse">
  <tr height="25" >
...
?>
<tr class="Light" height="20">
     <td align="center" valign="middle" class="tblheading" colspan="6">Record not found.</td>
</tr>
<?php
}
?>   
...
<tr >
<td height="49" align="center" valign="top"><a href="crop.php"><img src="../images/back.gif" border="0"  style="display:inline;cursor:pointer;"/></a>&nbsp;&nbsp;<img src="../images/printpreview.gif" onclick="openprint()" style="cursor:pointer" border="0" />
