...
<?php 
	...
	$tdate=$edate;
	 ...
	 $sql = "select * from tblspcodes where altdate <= '$edate' and altdate >= '$sdate' ";
...
<table align="center" border="0" cellspacing="0" cellpadding="0" width="750" style="border-collapse:collapse">
    ...
    <td align="center" class="subheading" style="color:#303918; ">Date From: <?php echo $_GET['sdate'];?> To <?php echo $_GET['edate'];?></td>
        ...
        <table  border="1" align="center" cellspacing="0" cellpadding="0" width="730" bordercolor="#7a9931"
