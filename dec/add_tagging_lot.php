<?php
	...
	require_once("../include/insertxlsdata.php");	
	...
	if(isset($_POST['frm_action'])=='submit')
	{
			...
			$file7=$file_array[6];
			$file8=$file_array[7];
			echo $filenamechk=$file1." ".$file2." ".$file3;
			$destchk=$file4;
			exit;*/
			insertdata($filepath);
			//exit;
			...
			window.location='add_tagging_lot_list.php';
			</script>
			<?php
}
...
<title>Decode -Transaction - Add File Import</title>
...
//alert(filechk);
	...
	if(flg==1)
	{
		/*if(filechk!="Lot Destination Report" && destchk!="Gomchi")
		{
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#7a9931" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#7a9931" style="border-bottom:solid; border-bottom-color:#7a9931" >
	    <tr >
	      <td width="813" height="25" class="Mainheading">&nbsp;Transaction - File Import - Add</td>
	    </tr></table></td>
	    	 </tr>
	  </table></td></tr>
...
<tr>
<td width="30">	 </td><td>
<table align="center" border="1" width="650" cellspacing="0" cellpadding="0" bordercolor="#7a9931"
 style="border-collapse:collapse" > 
<tr class="tblsubtitle" height="25">
  <td colspan="4" align="center" class="tblheading">Add File Import </td>
</tr>
<tr height="15">
    <td colspan="4" align="right" class="tblheading"><font color="#FF0000" >* </font>indicates required field&nbsp;</td>
  </tr>
<tr class="Dark" height="25">
<td width="206"  align="right"  valign="middle" class="tblheading">Import File&nbsp;</td>
...
<tr >
<td valign="top" align="center"><a href="home_tagging.php"><img src="../images/back.gif" border="0"  style="display:inline;cursor:pointer;"/></a>&nbsp;<a href="javascript:document.frmaddDept.reset()"></a>&nbsp;<input name="Submit" type="image" src="../images/next.gif" alt="Submit Value" onClick="return mySubmit();"  border="0" style="display:inline;cursor:pointer;"></td>
</tr>
</table>
</td><td width="30"></td>
</tr>
