...
?>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" style="border-bottom:solid; border-bottom-color:#d21704" >
	    <tr >
	      <td width="813" height="25">&nbsp; Bin Card</td>
	    </tr></table></td>
	  </tr>
	  </table></td></tr>
...
//echo $sql;
   ...
   <tr height="25" >
    <td align="center" class="subheading" style="color:#303918; ">Bin Card</td>
  </tr>
...
<tr class="tblsubtitle" height="25">
			<td width="48" rowspan="2" align="center" valign="middle" class="tblheading">Lot No </td>
			<td width="74" rowspan="2" align="center" valign="middle" class="tblheading">NO. Of Bags </td>
			<td width="50" colspan="1" align="center" valign="middle" class="tblheading">Qty</td>
			<td width="71" colspan="1" align="center" valign="middle" class="tblheading"> Moisture </td>
			<td width="121" colspan="1" align="center" valign="middle" class="tblheading">Qc Status </td>
			<td width="66" colspan="1" align="center" valign="middle" class="tblheading">D.&amp;T.</td>
			<td width="217" colspan="1" align="center" valign="middle" class="tblheading">SLoc</td>
