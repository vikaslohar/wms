...
if($z1 == 0)
{
 $sql_main="insert into tbl_gotqc (arrival_code,year_code,arr_code, arrival_date, party_id, pid,pname, party_name, address, address1, city, pin, state, contactno ,tmode, trans_name, trans_lorryrepno, trans_vehno, trans_paymode, courier_name, docket_no )values('$c','$yearid_id','$c','$ddate1','$f','$txt12','$pname','$party','$txtaddress','$txtaddress1', '$city', '$pin', '$state','$contact','$txt11','$txttname','$txtlrn', '$txtvn', '$txt13', '$txtcname', '$txtdc')";
...
{
  $sql_main="update tbl_gotqc set year_code='$yearid_id', arr_code='$c',arrival_date='$ddate1',party_id='$f', pname='$pname',party_name='$party',address='$txtaddress',address1='$txtaddress1',city='$city',pin='$pin',state='$state',contactno='$contact',tmode='$txt11',trans_name='$txttname',trans_lorryrepno='$txtlrn',trans_vehno='$txtvn',trans_paymode='$txt13',courier_name='$txtcname',docket_no='$txtdc',pid='$txt12' where arrival_id = '$z1'";

if(mysqli_query($link,$sql_main) or die(mysqli_error($link)))
{
   $mainid=$z1;
 $sql_sub="update tbl_gotqc1 set  lotno='$lot2', arr_role='$logid' ,arrival_id='$mainid' where arrsub_id = '$subtrid'";
mysqli_query($link,$sql_sub) or die(mysqli_error($link));
}
}
 $z1;	
