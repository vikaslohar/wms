...
<title>Quality-Report - GOT Biotech Test Initiative Summery Report</title>
  ...
  <tr><td>
   ...
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#d21704" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#d21704" style="border-bottom:solid; border-bottom-color:#d21704" >
	    <tr >
	      <td width="813" height="25">&nbsp;Report - GOT Biotech Test Initiative Summery Report</td>
	    </tr></table></td>
	  </tr>
	  </table></td></tr>
...
<table align="center" border="0" cellspacing="0" cellpadding="0" width="500" style="border-collapse:collapse">
   <!--	<tr height="25" >
    <td align="center" class="subheading" style="color:#303918; ">Lot Destination Report:</td>
  	...
  	<tr height="25">
    <td align="center" class="subheading" style="color:#303918;" colspan="2">GOT Biotech Test Initiative Report As on Date: <?php echo date("d-m-Y");?> </td>
  	</tr>
</table>
...
<?php
$srno=1;
$sql="SELECT distinct(gotm_crop) FROM tbl_qcgotmain WHERE gotm_ackflg=1 and gotm_retestflg=0 and gotm_resamplingflg=0 and gotm_sowingflg=1   ";
//echo $sql;
...
$sqlmax2="SELECT distinct(gotm_variety) FROM tbl_qcgotmain WHERE gotm_ackflg=1 and gotm_retestflg=0 and gotm_resamplingflg=0 and gotm_sowingflg=1  and gotm_crop='".$row_arr_home['gotm_crop']."'";
...
<tr class="Light" height="25">
	...
	<td width="123" align="center" valign="middle" class="tblheading"><a href="report_btspendet.php?txtcrop=<?php echo $row_arr_home['gotm_crop'];?>&txtvariety=<?php echo $row_arr_home3['gotm_variety']; ?>"><?php echo $lotno?></a></td>
</tr>
<?php
}
else
