...
//echo $row_arr_home['tid'];
	$gsdnid="";
	$sql_dtchk=mysqli_query($link,"select * from tbl_gotqc where arrival_date<='$edate' and arrival_date>='$sdate' and arrtrflag=1 order by arrival_id asc") or die(mysqli_error($link));
