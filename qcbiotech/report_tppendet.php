...
<tr class="tblsubtitle" height="25">
	...
	<td width="176"  align="center" valign="middle" class="smalltblheading">Nursery location</td>
	<td width="176"  align="center" valign="middle" class="smalltblheading">Bed no</td>
	<td width="176"  align="center" valign="middle" class="smalltblheading">Trey no.</td>
	<td width="176"  align="center" valign="middle" class="smalltblheading">No of trey</td>
</tr>

<?php
$srno=1;
$sql="SELECT distinct(gotm_crop) FROM tbl_qcgotmain WHERE gotm_ackflg=1 and gotm_retestflg=0 and gotm_resamplingflg=0 and gotm_sowingflg=1 and gotm_transplantflg=0 and gotm_crop='".$txtcrop."' ";
//echo $sql;
...
$sqlmax2="SELECT distinct(gotm_variety) FROM tbl_qcgotmain WHERE gotm_ackflg=1 and gotm_retestflg=0 and gotm_resamplingflg=0 and gotm_sowingflg=1 and gotm_transplantflg=0 and gotm_crop='".$row_arr_home['gotm_crop']."' and gotm_variety='".$txtvariety."' ";
...
$lotno=0;
$sql_max=mysqli_query($link,"SELECT distinct(gotm_lotno) FROM tbl_qcgotmain WHERE gotm_ackflg=1 and gotm_retestflg=0 and gotm_resamplingflg=0 and gotm_sowingflg=1 and gotm_transplantflg=0 and gotm_crop='".$row_arr_home['gotm_crop']."' AND gotm_variety='".$row_arr_home3['gotm_variety']."'  ") or die(mysqli_error($link));
$tot_max=mysqli_num_rows($sql_max);
while($row_arr_home2=mysqli_fetch_array($sql_max))
{
	$sql_max4=mysqli_query($link,"SELECT gotm_sampleno, gotm_id FROM tbl_qcgotmain WHERE gotm_ackflg=1 and gotm_retestflg=0 and gotm_resamplingflg=0 and gotm_sowingflg=1 and gotm_transplantflg=0 and gotm_crop='".$row_arr_home['gotm_crop']."' AND gotm_variety='".$row_arr_home3['gotm_variety']."' AND gotm_lotno='".$row_arr_home2['gotm_lotno']."'  ") or die(mysqli_error($link));
	...
	while($row_arr_home4=mysqli_fetch_array($sql_max4))
	{
		...
		$gotsow_state=$row_arrm['gotsow_state'];
		$gotsow_loc=$row_arrm['gotsow_loc'];
		$gotsow_nooftraylot=$row_arrm['gotsow_nooftraylot'];
		$gotsow_bedno=$row_arrm['gotsow_bedno'];
		$gotsow_treynumber=$row_arrm['gotsow_treynumber'];
...
<tr class="Light" height="25">
	...
	<td width="123" align="center" valign="middle" class="smalltbltext"><?php echo $locations?></td>
	<td width="123" align="center" valign="middle" class="smalltbltext"><?php echo $gotsow_bedno?></td>
	<td width="123" align="center" valign="middle" class="smalltbltext"><?php echo $gotsow_treynumber?></td>
	<td width="123" align="center" valign="middle" class="smalltbltext"><?php echo $gotsow_nooftraylot?></td>
</tr>
<?php
}
else
...
<tr >
<td height="49" align="center" valign="top"><a href="report_tppen.php"><img src="../images/back.gif" border="0"  style="display:inline;cursor:pointer;"/></a><!--&nbsp;&nbsp;<img src="../images/printpreview.gif" onclick="openprint()" style="cursor:pointer" border="0" />-->
