...
<title>Quality-Report - GOT Transplanting Pending Detailed Report</title>
  ...
  <tr><td>
   ...
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#d21704" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#d21704" style="border-bottom:solid; border-bottom-color:#d21704" >
	    <tr >
	      <td width="813" height="25">&nbsp;Report - GOT Transplanting Pending Detailed Report</td>
	    </tr></table></td>
	  </tr>
	  </table></td></tr>
...
<table align="center" border="0" cellspacing="0" cellpadding="0" width="940" style="border-collapse:collapse">
   <!--	<tr height="25" >
    <td align="center" class="subheading" style="color:#303918; ">Lot Destination Report:</td>
  	...
  	<tr height="25">
    <td align="center" class="subheading" style="color:#303918;" colspan="2">GOT Transplanting Pending Detailed Report As on Date: <?php echo date("d-m-Y");?> </td>
  	</tr>
</table>
...
<tr class="tblsubtitle" height="25">
	...
	<td width="176"  align="center" valign="middle" class="smalltblheading">Transplanting /Sowing location</td>
	<td width="176"  align="center" valign="middle" class="smalltblheading">Date of transplanting (DOT)</td>
	<td width="176"  align="center" valign="middle" class="smalltblheading">Bed no</td>
	<td width="176"  align="center" valign="middle" class="smalltblheading">Direction</td>
</tr>

<?php
$srno=1;
$sql="SELECT distinct(gotm_crop) FROM tbl_qcgotmain WHERE gotm_ackflg=1 and gotm_retestflg=0 and gotm_resamplingflg=0 and gotm_sowingflg=1 and gotm_transplantflg>0 AND gotm_fieldmflg=0 and gotm_crop='".$txtcrop."' ";
//echo $sql;
...
$sqlmax2="SELECT distinct(gotm_variety) FROM tbl_qcgotmain WHERE gotm_ackflg=1 and gotm_retestflg=0 and gotm_resamplingflg=0 and gotm_sowingflg=1 and gotm_transplantflg>0 AND gotm_fieldmflg=0 and gotm_crop='".$row_arr_home['gotm_crop']."' and gotm_variety='".$txtvariety."' ";
...
$lotno=0;
$sql_max=mysqli_query($link,"SELECT distinct(gotm_lotno) FROM tbl_qcgotmain WHERE gotm_ackflg=1 and gotm_retestflg=0 and gotm_resamplingflg=0 and gotm_sowingflg=1 and gotm_transplantflg>0 AND gotm_fieldmflg=0 and gotm_crop='".$row_arr_home['gotm_crop']."' AND gotm_variety='".$row_arr_home3['gotm_variety']."'  ") or die(mysqli_error($link));
$tot_max=mysqli_num_rows($sql_max);
while($row_arr_home2=mysqli_fetch_array($sql_max))
{
	$sql_max4=mysqli_query($link,"SELECT gotm_sampleno, gotm_id FROM tbl_qcgotmain WHERE gotm_ackflg=1 and gotm_retestflg=0 and gotm_resamplingflg=0 and gotm_sowingflg=1 and gotm_transplantflg>0 AND gotm_fieldmflg=0 and gotm_crop='".$row_arr_home['gotm_crop']."' AND gotm_variety='".$row_arr_home3['gotm_variety']."' AND gotm_lotno='".$row_arr_home2['gotm_lotno']."'  ") or die(mysqli_error($link));
	...
	while($row_arr_home4=mysqli_fetch_array($sql_max4))
	{
		...
		$dt=date("Y-m-d"); $tpdd="";
		$sql_arrmain2=mysqli_query($link,"SELECT gottransp_date, gottransp_state, gottransp_loc, gottransp_bedno, gottransp_direction FROM tbl_qcgottranspl WHERE gotm_id='".$gotm_id."' ") or die(mysqli_error($link));
		$row_arrmain2=mysqli_fetch_array($sql_arrmain2); 
		
		if($row_arrmain2['gottransp_date']!='' && $row_arrmain2['gottransp_date']!='0000-00-00' && $row_arrmain2['gottransp_date']!=NULL)
		{
			$arrival_date1=explode("-",$row_arrmain2['gottransp_date']);
			$tpsowingdate=$arrival_date1[2]."-".$arrival_date1[1]."-".$arrival_date1[0];
			
			if($row_arrmain2['gottransp_date']!='')
			{
				$m=$arrival_date1[1];
				$de=$arrival_date1[2];
				$y=$arrival_date1[0];
...
<tr class="Light" height="25">
	...
	<td width="123" align="center" valign="middle" class="smalltbltext"><?php echo $tplocations?></td>
	<td width="123" align="center" valign="middle" class="smalltbltext"><?php echo $tpsowingdate?></td>
	<td width="123" align="center" valign="middle" class="smalltbltext"><?php echo $gottransp_bedno?></td>
	<td width="123" align="center" valign="middle" class="smalltbltext"><?php echo $gottransp_direction?></td>
</tr>
<?php
}
else
...
<tr >
<td height="49" align="center" valign="top"><a href="report_fmvpen.php"><img src="../images/back.gif" border="0"  style="display:inline;cursor:pointer;"/></a><!--&nbsp;&nbsp;<img src="../images/printpreview.gif" onclick="openprint()" style="cursor:pointer" border="0" />-->
