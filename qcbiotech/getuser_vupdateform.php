...
if($z1 == 0)
{
  $sql_main="insert into tbl_qcgen (year_code,arr_code, arrival_date,arr_role,crop, variety,stage)values('$yearid_id','$c','$ddate','$logid','$o','$p','$stage')";
// exit;
...
{
  $sql_main="update tbl_qcgen set year_code='$yearid_id', arr_code='$c',crop='$o',variety='$p', stage='$stage',arrival_date='$ddate',arr_role='$logid' where arrival_id = '$z1'";
