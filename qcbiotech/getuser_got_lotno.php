...
{	
	...
	window.location='getuser_got_lotno.php?crop='+val3+'&variety='+val4+'&sqq='+txtlot1;
	return true;	
	}
}	
...
$sss="";
$qr="select distinct(oldlot)  from tbl_qctest where crop='".$crop."' and variety='".$variety."' $sss";
...
<td align="right"  valign="middle" class="tbltext"><input type="radio" name="loc" value="<?php echo $row['oldlot'];?>" onclick="clk(this.value);" />&nbsp;</td>
