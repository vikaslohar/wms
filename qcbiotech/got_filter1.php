...
while($row_tbl=mysqli_fetch_array($sql_tbl))
{
	...
	if(isset($_POST['frm_action'])=='submit')
	{
		...
		echo "<script>window.location='home_got_filter3.php?txtlot=$txtlot&txtcrop=$txtcrop&txtvariety=$txtvariety&pcode=$pcode&txt=$txt&txtlot2=$txtlot2&txtlot=$txtlot&reptyp=$reptyp&txtlot4=$txtlot4&ycodee=$ycode&txtlo=$txtlo&stcode=$stcode&stcode2=$stcode2'</script>";
...
<title>GOT- Transaction -GOT Result Update</title>
...
winHandle=window.open('getuser_trading_lotno333.php?crop='+crop+'&variety='+variety,'WelCome','top=150,left=160,width=420,height=350,scrollbars=yes');
if(winHandle==null){
...
//alert(document.frmaddDepartment.reptyp.value);
	...
	if(maintyp=="select")
		...
		if(maintyp=="sno")
		{
			val4=document.frmaddDepartment.txtlot4.value;
			val5=document.frmaddDepartment.txtlo.value;
			val3="";
			if(val4=="")
			{
				alert("Please Select Yearcode");
				return false;
			}
			if(val5=="")
			{
			...
			if(document.frmaddDepartment.txtlo.value.length<5)
				{
				alert("Sample  No. cannot be less than 5 digits alphanumaric.");
				document.frmaddDepartment.txtlo.focus();
				return false;
				}
		}
		if(maintyp=="lotno")
		{
		val1=document.frmaddDepartment.pcode.value;
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#d21704" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#d21704" style="border-bottom:solid; border-bottom-color:#d21704" >
	    <tr >
	      <td width="940" height="25">&nbsp;Transaction - GOT Result Update - Search Lots</td>
	    </tr></table></td>
...
<td width="58" align="right"  valign="middle" class="tblheading">Crop&nbsp;</td>
<td width="317" align="left"  valign="middle" class="tbltext" >&nbsp;<select class="tbltext" name="txtcrop" style="width:170px;" onchange="modetchk(this.value)">
...
?>
	<td width="114" align="right"  valign="middle" class="tblheading" >Variety&nbsp;</td>
    <td width="351" align="left"  valign="middle" class="tbltext" id="vitem">&nbsp;<select class="tbltext" id="itm" name="txtvariety" style="width:170px;"  onchange="modetchk1(this.value)">
<option value="" selected>--Select Variety-</option>
	<?php while($noticia_item = mysqli_fetch_array($sql_month)) { ?>
		...
		<td width="205" align="right" valign="middle" class="tblheading">Seed Stage&nbsp;</td>
<td width="275"  align="left" valign="middle" class="tbltext"  >&nbsp;<select class="tbltext" name="txtstage" style="width:170px;" >
    <option value="" selected>--Select--</option>
    <option value="Raw" >Raw </option>
    <option value="Condition" >Condition </option>
	 <option value="Pack" >Pack </option>
  </select>&nbsp;<font color="#FF0000">*</font>	</td>
           <td width="205" align="right"  valign="middle" class="tblheading">Lot Number &nbsp;</td>
           <td align="left" valign="middle" class="tbltext" style="border-color:#d21704" colspan="3"  >&nbsp;<input name="txtlot1" type="text" size="15" class="tbltext" tabindex=""  maxlength="14"  value="" onchange="ltchk(this.value);" readonly="true" style="background-color:#ECECEC"   >&nbsp;<font color="#FF0000">*</font>&nbsp;<a href="Javascript:void(0);" onclick="openslocpop();">Select</a></td>
           </tr>-->
	</table>		  
...
?>	
    ...
    <?php } ?></select><input name="txtlot2" type="text" size="6" class="tbltext"  maxlength="5" onkeypress="return 
  isNumberKey(event)"  />/<input name="stcode" type="text" size="6" class="tbltext" tabindex="0" maxlength="5" onkeypress="return isNumberKey(event)"  value="00000" />/<input name="stcode2" type="text" size="2" class="tbltext" tabindex="0" maxlength="2" onkeypress="return isNumberKey(event)"  value="00" /><!--<select class="tbltext" name="txtlot3" style="width:40px;">
...
<tr class="Light" height="25">
		  <td width="377"  align="right"  valign="middle" class="tblheading">&nbsp; Select Sample No.&nbsp; </td>    
           <td colspan="3" align="left"  valign="middle">&nbsp;<input name="txt" type="text" size="1" class="tbltext" tabindex="0" maxlength="2" value="<?php echo $a;?>"  readonly="true" style="background-color:#ECECEC"/><select class="tbltext" name="txtlot4" style="width:40px;">
    <option value="" selected="selected">--Select--</option>
    <?php while($noticia = mysqli_fetch_array($quer4)) { ?>
    <option value="<?php echo $noticia['ycode'];?>" />  
    <?php echo $noticia['ycode'];?>
    <?php } ?></select><input name="txtlo" type="text" size="6" class="tbltext" tabindex="0" maxlength="6" onkeypress="return isNumberKey(event)" />&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
		   </tr>
</table>		  
</div>
<table width="850" align="center" cellpadding="5" cellspacing="5" border="0" >
                  <tr >
                    <td valign="top" align="center"><a href="home_result.php" tabindex="20"><img src="../images/back.gif" border="0"style="display:inline;cursor:hand;" /></a>&nbsp;<input name="Submit" type="image" src="../images/next.gif" alt="next Value"  border="0" style="display:inline;cursor:pointer;" onClick="return mySubmit();" />
                        <input type="hidden" name="txtinv" />
                      <input name="txt11" value="" type="hidden"> 
                      <input type="hidden" name="flagcode1" value=""/>
					   <input type="hidden" name="qcrsl" value=""/>
					   <input type="hidden" name="gotrsl" value=""/>
					   <input type="hidden" name="txt14" value=""/>
					   <input type="hidden" name="txt16" value=""/>
                 </td> </tr>
              </table>
  </tr>       
