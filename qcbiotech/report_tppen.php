...
<?php
$srno=1;
$sql="SELECT distinct(gotm_crop) FROM tbl_qcgotmain WHERE gotm_ackflg=1 and gotm_retestflg=0 and gotm_resamplingflg=0 and gotm_sowingflg=1 and gotm_transplantflg=0  ";
//echo $sql;
...
$sqlmax2="SELECT distinct(gotm_variety) FROM tbl_qcgotmain WHERE gotm_ackflg=1 and gotm_retestflg=0 and gotm_resamplingflg=0 and gotm_sowingflg=1 and gotm_transplantflg=0 and gotm_crop='".$row_arr_home['gotm_crop']."'";
...
<tr class="Light" height="25">
	...
	<td width="123" align="center" valign="middle" class="tblheading"><a href="report_tppendet.php?txtcrop=<?php echo $row_arr_home['gotm_crop'];?>&txtvariety=<?php echo $row_arr_home3['gotm_variety']; ?>"><?php echo $lotno?></a></td>
</tr>
<?php
}
else
