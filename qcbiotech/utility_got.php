...
while($row_tbl=mysqli_fetch_array($sql_tbl))
{
	...
	if(isset($_POST['frm_action'])=='submit')
	{
		...
		echo "<script>window.location='home_got.php?txtlot=$txtlot&txtcrop=$txtcrop&txtvariety=$txtvariety&txtstage=$txtstage&txtlot1=$txtlot1&pcode=$pcode&txt=$txt&txtlot2=$txtlot2&txtlot=$txtlot&txtlot3=$txtlot3&reptyp=$reptyp&txtlot4=$txtlot4&ycodee=$ycode&txtlo=$txtlo&stcode=$stcode&stcode2=$stcode2'</script>";
...
winHandle=window.open('getuser_got_lotno.php?crop='+crop+'&variety='+variety,'WelCome','top=150,left=160,width=420,height=350,scrollbars=yes');
if(winHandle==null){
...
<table align="center" border="1" width="850" cellspacing="0" cellpadding="0" bordercolor="#d21704" style="border-collapse:collapse" >
				...
				<tr class="Light" height="25">
                    <td width="376" height="30" align="right" valign="middle" class="tblheading">Product wise&nbsp;</td>
           <td width="468" align="left"  valign="middle" ><input type="radio" name="reptyp" value="select" onClick="typchk(this.value);" /></td>
                </tr>
				<tr class="Dark" height="25">
                    <td align="right" height="30" valign="middle" class="tblheading">Lot No. wise&nbsp;</td>
           <td align="left"  valign="middle" ><input type="radio" name="reptyp" value="lotno" onClick="typchk(this.value);" /></td>
                </tr>
...
?>	
  ...
  isNumberKey(event)"  />/<input name="stcode" type="text" size="6" class="tbltext" tabindex="0" maxlength="5" onkeypress="return isNumberKey(event)"  value="00000" />/<input name="stcode2" type="text" size="2" class="tbltext" tabindex="0" maxlength="2" onkeypress="return isNumberKey(event)"  value="00" />
...
<tr class="Light" height="25">
		  <td width="188"  align="right"  valign="middle" class="tblheading">&nbsp; Select Sample No.&nbsp; </td>    
           <td colspan="3" align="left"  valign="middle">&nbsp;<input name="txt" type="text" size="1" class="tbltext" tabindex="0" maxlength="5" value="12"  readonly="true"/><select class="tbltext" name="txtlot4" style="width:40px;">
    <option value="" selected="selected">--Select--</option>
    <?php while($noticia = mysqli_fetch_array($quer4)) { ?>
    <option value="<?php echo $noticia['ycode'];?>" />  
    <?php echo $noticia['ycode'];?>
