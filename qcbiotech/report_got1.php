...
$sql="select distinct(sampleno) from tbl_qctest where gotflg=0 and (got='UT' or got='RT') and (state='P/M/G/T' or state='T')";
if($cid!="ALL")
{	
$sql.=" and crop='".$cid."'";
}
...
<tr class="tblsubtitle" height="25">
			...
			<td width="70"  align="center" valign="middle" class="tblheading">DOSC</td>
			...
			<td width="95" align="center" valign="middle" class="tblheading" >Location</td>
			<td width="62" align="center" valign="middle" class="tblheading" >Mode</td>
            </tr>
...
{
$sqlmax2="select MAX(tid) from tbl_qctest where sampleno='".$row_arr_home2['sampleno']."'";
if($cid!="ALL")
{
...
while($row_arr_home=mysqli_fetch_array($sql_max))
{
	...
	/*$sql_tbl_sub1=mysqli_query($link,"select distinct lotldg_subbinid, lotldg_variety, lotldg_crop, lotldg_whid, lotldg_binid from tbl_lot_ldg where orlot='".$row_arr_home['oldlot']."' group by lotldg_subbinid, lotldg_variety, lotldg_lotno order by lotldg_subbinid") or die(mysqli_error($link));
	$row_tbl=mysqli_fetch_array($sql_tbl_sub1);
	$T=mysqli_num_rows($sql_tbl_sub1);*/
	
	$sql_tbl1=mysqli_query($link,"select max(lotldg_id) from tbl_lot_ldg where orlot='".$row_arr_home['oldlot']."'") or die(mysqli_error($link));  
...
$crop=""; $variety=""; $lotno=""; $bags=""; $qty=""; $stage="";  $qc=""; $sstatus=""; $loc1=""; $per=""; $qcresult=""; $address=""; $tmode="";
$flg=0;
	$sql_dtchk=mysqli_query($link,"select lotno, pid, party_id, city, tmode from tbl_gotqc where arrtrflag=1 order by arrival_id asc") or die(mysqli_error($link));
	...
	//echo $lotno."  =  ".$row_arr_home['gotsmpdflg']."  -  ".$flg."<br />";
	$fg=0;
	if($row_arr_home['gotsmpdflg']==1)$fg++;
	//if($flg==0)$fg++;
	//$lrole=$row_arr_home['arr_role'];
...
<td align="center" valign="middle" class="tblheading"><?php echo $srno?></td>
         ...
         <td width="70" align="center" valign="middle" class="tblheading"><?php echo $trdate1?></td>
         <td width="70" align="center" valign="middle" class="tblheading"><?php echo $trdate2;?></td>
         <td width="95" align="center" valign="middle" class="tblheading"><?php echo $got?></td>
         <td width="95" align="center" valign="middle" class="tblheading"><?php echo $address?></td>
         <td width="62" align="center" valign="middle" class="tblheading"><?php echo $tmode;?></td>
         </tr
>
<?php
}
