...
<td align="left" valign="middle" class="tbltext">&nbsp;<input name="txtbedno" type="text" size="10" class="tbltext" tabindex=""  maxlength="20" value="<?php echo $row['dotransplant'];?>"  >&nbsp;&nbsp;<font color="#FF0000">*</font>&nbsp;&nbsp;</td>
...
<td align="left" valign="middle" class="tbltext">&nbsp;<input name="txtno" type="text" size="3" class="tbltext" tabindex=""  maxlength="20"  value="<?php echo $row['maleno'];?>" onchange="malepercal(this.value)">&nbsp;No.&nbsp;&nbsp;&nbsp;<input name="txtper" type="text" size="4" class="tbltext" tabindex=""  maxlength="20"  value="<?php echo $row['maleper'];?>" readonly="true" style="background-color:#CCCCCC" >%</td>

<td align="right" valign="middle" class="tblheading"><?php if($crop!="Cluster Bean"){?>Female&nbsp;<?php }else{?>Branching&nbsp;<?php }?></td>
<td align="left" valign="middle" class="tbltext">&nbsp;<input name="txtno1" type="text" size="3" class="tbltext" tabindex=""  maxlength="20"  value="<?php echo $row['femaleno'];?>" onchange="femalecal(this.value)">&nbsp;No.&nbsp;&nbsp;&nbsp;<input name="txtper1" type="text" size="4" class="tbltext" tabindex=""  maxlength="20"  value="<?php echo $row['femaleper'];?>" readonly="true" style="background-color:#CCCCCC" >%</td>
</tr>

<tr class="Dark" height="25">
<td align="right" valign="middle" class="tblheading">OOF&nbsp;</td>
<td align="left" valign="middle" class="tbltext">&nbsp;<input name="txtoofno" type="text" size="3" class="tbltext" tabindex=""  maxlength="20"  value="<?php echo $row['oofno'];?>" onchange="oofcal(this.value)" >&nbsp;No.&nbsp;&nbsp;&nbsp;<input name="txtoofper" type="text" size="4" class="tbltext" tabindex=""  maxlength="20"  value="<?php echo $row['oofper'];?>" readonly="true" style="background-color:#CCCCCC" >%</td>

<td align="right" valign="middle" class="tblheading">Total&nbsp;</td>
<td align="left" valign="middle" class="tbltext">&nbsp;<input name="txttotno" type="text" size="3" class="tbltext" tabindex=""  maxlength="20"  value="<?php echo $row['totalno'];?>" readonly="true" style="background-color:#CCCCCC">&nbsp;No.&nbsp;&nbsp;&nbsp;<input name="txttotper" type="text" size="4" class="tbltext" tabindex=""  maxlength="20"  value="<?php echo $row['totalper'];?>" readonly="true" style="background-color:#CCCCCC" >%</td>
</tr>

<tr class="Dark" height="25">
<td align="right"  valign="middle" class="tblheading">Genetic Purity&nbsp;</td>
<td align="left"  valign="middle" class="tbltext" >&nbsp;<input name="txtgenpurity" type="text" size="5" class="tbltext" tabindex=""   maxlength="6" onkeypress="return isNumberKey(event)" onchange="genchk(this.value)" value="<?php echo $row['genpurity'];?>" readonly="true" style="background-color:#CCCCCC"/>  &nbsp;%</td>

<td width="154" align="right" valign="middle" class="tblheading">Date of Observation&nbsp;</td>
<td width="354" colspan="3" align="left" valign="middle" class="tbltext">&nbsp;<input name="obdate" id="obdate1" type="text" size="10" class="tbltext" tabindex="0" readonly="true"  value="<?php echo $row['doobr'];?>" style="background-color:#EFEFEF" />&nbsp;<a href="javascript:void(0)" onClick="doobchk('obdate1')" tabindex="6"><img src="../images/cal.gif" alt="Calender" border="0" align="absmiddle"></a></a>&nbsp;&nbsp;<font color="#FF0000">*</font>&nbsp;&nbsp;</td>
</tr>

<tr class="Dark" height="25">
<td align="right"  valign="middle" class="tblheading" >GOT Result&nbsp;</td>
 <td align="left"  valign="middle" class="tbltext" id="gotresult">&nbsp;<select class="tbltext" name="result" style="width:100px;" >
...
<td align="right"  valign="middle" class="tblheading">GOT Doc Ref No.&nbsp;</td>
    <td align="left"  valign="middle" class="tbltext">&nbsp;<input name="txtloc" type="text" size="20" class="tbltext" tabindex="0"  value="" maxlength="20"/>&nbsp;<font color="#FF0000">*</font>&nbsp;&nbsp;</td>
</tr>	
