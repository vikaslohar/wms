...
<title>Quality-Report - GOT Sowing Pending Detailed Report</title>
  ...
  <tr><td>
   ...
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#d21704" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#d21704" style="border-bottom:solid; border-bottom-color:#d21704" >
	    <tr >
	      <td width="813" height="25">&nbsp;Report - GOT Sowing Pending Detailed Report</td>
	    </tr></table></td>
	  </tr>
	  </table></td></tr>
...
<table align="center" border="0" cellspacing="0" cellpadding="0" width="940" style="border-collapse:collapse">
   <!--	<tr height="25" >
    <td align="center" class="subheading" style="color:#303918; ">Lot Destination Report:</td>
  	...
  	<tr height="25">
    <td align="center" class="subheading" style="color:#303918;" colspan="2">GOT Sowing Pending Detailed Report As on Date: <?php echo date("d-m-Y");?> </td>
  	</tr>
</table>
...
<tr class="tblsubtitle" height="25">
	...
	<td width="176"  align="center" valign="middle" class="smalltblheading">NoB</td>
	<td width="176"  align="center" valign="middle" class="smalltblheading">Qty(Kg.)</td>
	<td width="176"  align="center" valign="middle" class="smalltblheading">GOT Status</td>
	<td width="176"  align="center" valign="middle" class="smalltblheading">Prod. Loc.</td>
	<td width="176"  align="center" valign="middle" class="smalltblheading">Organizer</td>
	<td width="176"  align="center" valign="middle" class="smalltblheading">Farmer</td>
	<td width="176"  align="center" valign="middle" class="smalltblheading">Prod. Per.</td>
	<td width="176"  align="center" valign="middle" class="smalltblheading">SLOC</td>
</tr>

<?php
$srno=1;
$sql="SELECT distinct(gotm_crop) FROM tbl_qcgotmain WHERE gotm_ackflg=1 and gotm_retestflg=0 and gotm_resamplingflg=0 and gotm_sowingflg=0 and gotm_crop='".$txtcrop."' ";
//echo $sql;
...
$sqlmax2="SELECT distinct(gotm_variety) FROM tbl_qcgotmain WHERE gotm_ackflg=1 and gotm_retestflg=0 and gotm_resamplingflg=0 and gotm_sowingflg=0 and gotm_crop='".$row_arr_home['gotm_crop']."' and gotm_variety='".$txtvariety."' ";
...
{
	$sql_max4=mysqli_query($link,"SELECT distinct(gotm_sampleno) FROM tbl_qcgotmain WHERE gotm_ackflg=1 and gotm_retestflg=0 and gotm_resamplingflg=0 and gotm_sowingflg=0 and gotm_crop='".$row_arr_home['gotm_crop']."' AND gotm_variety='".$row_arr_home3['gotm_variety']."' AND gotm_lotno='".$row_arr_home2['gotm_lotno']."'  ") or die(mysqli_error($link));
	...
	while($row_arr_home4=mysqli_fetch_array($sql_max4))
	{
		...
		$sql_issue=mysqli_query($link,"select distinct lotldg_subbinid, lotldg_whid, lotldg_binid from tbl_lot_ldg where orlot='".$row_arr_home2['orlot']."'   group by lotldg_subbinid order by lotldg_id asc") or die(mysqli_error($link));
		while($row_issue=mysqli_fetch_array($sql_issue))
		{ 
			$sql_issue1=mysqli_query($link,"select max(lotldg_id) from tbl_lot_ldg where lotldg_subbinid='".$row_issue['lotldg_subbinid']."' and lotldg_binid='".$row_issue['lotldg_binid']."' and lotldg_whid='".$row_issue['lotldg_whid']."' and orlot='".$row_arr_home2['orlot']."'  order by lotldg_id asc ") or die(mysqli_error($link));
			$row_issue1=mysqli_fetch_array($sql_issue1); 
		
			$sql_issuetbl=mysqli_query($link,"select * from tbl_lot_ldg where lotldg_id='".$row_issue1[0]."' and lotldg_balqty > 0 order by lotldg_id asc") or die(mysqli_error($link)); 
...
<tr class="Light" height="25">
	...
	<td width="123" align="center" valign="middle" class="smalltbltext"><?php echo $nob?></td>
	<td width="123" align="center" valign="middle" class="smalltbltext"><?php echo $qty?></td>
	<td width="123" align="center" valign="middle" class="smalltbltext"><?php echo $got?></td>
	<td width="123" align="center" valign="middle" class="smalltbltext"><?php echo $ploc?></td>
	<td width="123" align="center" valign="middle" class="smalltbltext"><?php echo $organiser?></td>
	<td width="123" align="center" valign="middle" class="smalltbltext"><?php echo $farmer?></td>
	<td width="123" align="center" valign="middle" class="tbltext"><?php echo $pper?></td>
	<td width="123" align="center" valign="middle" class="smalltbltext"><?php echo $slocs?></td>
</tr>
<?php
}
else
...
<tr class="Light" height="25">
	...
	<td width="123" align="center" valign="middle" class="smalltbltext"><?php echo $organiser?></td>
	<td width="123" align="center" valign="middle" class="smalltbltext"><?php echo $farmer?></td>
	<td width="123" align="center" valign="middle" class="smalltbltext"><?php echo $pper?></td>
	<td width="123" align="center" valign="middle" class="smalltbltext"><?php echo $slocs?></td>
</tr>
<?php
}
...
<tr >
<td height="49" align="center" valign="top"><a href="report_sowpen.php"><img src="../images/back.gif" border="0"  style="display:inline;cursor:pointer;"/></a><!--&nbsp;&nbsp;<img src="../images/printpreview.gif" onclick="openprint()" style="cursor:pointer" border="0" />-->
