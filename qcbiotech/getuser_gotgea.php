...
<?php
$male=""; $female=""; $hybrid=""; $male2=""; $female2=""; $hybrid2=""; $male3=""; $female3=""; $hybrid3=""; 
$quer1=mysqli_query($link,"select * from tbl_basepair where markername1='".$rowss2['gottestss2_mname']."'")or die(mysqli_error($link));
$tot1=mysqli_num_rows($quer1);
$rowmar1=mysqli_fetch_array($quer1);
$quer2=mysqli_query($link,"select * from tbl_basepair where markername2='".$rowss2['gottestss2_mname']."'")or die(mysqli_error($link));
$tot2=mysqli_num_rows($quer2);
$rowmar2=mysqli_fetch_array($quer2);
$quer3=mysqli_query($link,"select * from tbl_basepair where markername3='".$rowss2['gottestss2_mname']."'")or die(mysqli_error($link));
$tot3=mysqli_num_rows($quer3);
$rowmar3=mysqli_fetch_array($quer3);
$quer4=mysqli_query($link,"select * from tbl_basepair where markername4='".$rowss2['gottestss2_mname']."'")or die(mysqli_error($link));
$tot4=mysqli_num_rows($quer4);
$rowmar4=mysqli_fetch_array($quer4);
if($tot4>0)
{
	$male=$rowmar4['mark4set1_male1'].",".$rowmar4['mark4set1_male2']; 
	$female=$rowmar4['mark4set1_female1'].",".$rowmar4['mark4set1_female2']; 
	$hybrid=$rowmar4['mark4set1_hybrid1'].",".$rowmar4['mark4set1_hybrid2'].",".$rowmar4['mark4set1_hybrid3'].",".$rowmar4['mark4set1_hybrid4'];
	
	$male2=$rowmar4['mark4set2_male1'].",".$rowmar4['mark4set2_male2']; 
	$female2=$rowmar4['mark4set2_female1'].",".$rowmar4['mark4set2_female2']; 
	$hybrid2=$rowmar4['mark4set2_hybrid1'].",".$rowmar4['mark4set2_hybrid2'].",".$rowmar4['mark4set2_hybrid3'].",".$rowmar4['mark4set2_hybrid4'];
	
	$male3=$rowmar4['mark3set3_male1'].",".$rowmar4['mark3set3_male2']; 
	$female3=$rowmar4['mark3set3_female1'].",".$rowmar4['mark3set3_female2']; 
	$hybrid3=$rowmar4['mark3set3_hybrid1'].",".$rowmar4['mark3set3_hybrid2'].",".$rowmar4['mark3set3_hybrid3'].",".$rowmar4['mark4set3_hybrid4'];
}
else if($tot3>0)
{
	$male=$rowmar3['mark3set1_male1'].",".$rowmar3['mark3set1_male2']; 
	$female=$rowmar3['mark3set1_female1'].",".$rowmar3['mark3set1_female2']; 
	$hybrid=$rowmar3['mark3set1_hybrid1'].",".$rowmar3['mark3set1_hybrid2'].",".$rowmar3['mark3set1_hybrid3'].",".$rowmar3['mark3set1_hybrid4'];
	
	$male2=$rowmar3['mark3set2_male1'].",".$rowmar3['mark3set2_male2']; 
	$female2=$rowmar3['mark3set2_female1'].",".$rowmar3['mark3set2_female2']; 
	$hybrid2=$rowmar3['mark3set2_hybrid1'].",".$rowmar3['mark3set2_hybrid2'].",".$rowmar3['mark3set2_hybrid3'].",".$rowmar3['mark3set2_hybrid4'];
	
	$male3=$rowmar3['mark3set3_male1'].",".$rowmar3['mark3set3_male2']; 
	$female3=$rowmar3['mark3set3_female1'].",".$rowmar3['mark3set3_female2']; 
	$hybrid3=$rowmar3['mark3set3_hybrid1'].",".$rowmar3['mark3set3_hybrid2'].",".$rowmar3['mark3set3_hybrid3'].",".$rowmar3['mark3set3_hybrid4'];
}
else if($tot2>0)
{
	$male=$rowmar2['mark2set1_male1'].",".$rowmar2['mark2set1_male2']; 
	$female=$rowmar2['mark2set1_female1'].",".$rowmar2['mark2set1_female2']; 
	$hybrid=$rowmar2['mark2set1_hybrid1'].",".$rowmar2['mark2set1_hybrid2'].",".$rowmar2['mark2set1_hybrid3'].",".$rowmar2['mark2set1_hybrid4'];
	
	$male2=$rowmar2['mark2set2_male1'].",".$rowmar2['mark2set2_male2']; 
	$female2=$rowmar2['mark2set2_female1'].",".$rowmar2['mark2set2_female2']; 
	$hybrid2=$rowmar2['mark2set2_hybrid1'].",".$rowmar2['mark2set2_hybrid2'].",".$rowmar2['mark2set2_hybrid3'].",".$rowmar2['mark2set2_hybrid4'];
	
	$male3=$rowmar2['mark2set3_male1'].",".$rowmar2['mark2set3_male2']; 
	$female3=$rowmar2['mark2set3_female1'].",".$rowmar2['mark2set3_female2']; 
	$hybrid3=$rowmar2['mark2set3_hybrid1'].",".$rowmar2['mark2set3_hybrid2'].",".$rowmar2['mark2set3_hybrid3'].",".$rowmar2['mark2set3_hybrid4'];
}
else
{
	$male=$rowmar1['mark1set1_male1'].",".$rowmar1['mark1set1_male2']; 
	$female=$rowmar1['mark1set1_female1'].",".$rowmar1['mark1set1_female2']; 
	$hybrid=$rowmar1['mark1set1_hybrid1'].",".$rowmar1['mark1set1_hybrid2'].",".$rowmar1['mark1set1_hybrid3'].",".$rowmar1['mark1set1_hybrid4'];
	
	$male2=$rowmar1['mark1set2_male1'].",".$rowmar1['mark1set2_male2']; 
	$female2=$rowmar1['mark1set2_female1'].",".$rowmar1['mark1set2_female2']; 
	$hybrid2=$rowmar1['mark1set2_hybrid1'].",".$rowmar1['mark1set2_hybrid2'].",".$rowmar1['mark1set2_hybrid3'].",".$rowmar1['mark1set2_hybrid4'];
	
	$male3=$rowmar1['mark1set3_male1'].",".$rowmar1['mark1set3_male2']; 
	$female3=$rowmar1['mark1set3_female1'].",".$rowmar1['mark1set3_female2']; 
	$hybrid3=$rowmar1['mark1set3_hybrid1'].",".$rowmar1['mark1set3_hybrid2'].",".$rowmar1['mark1set3_hybrid3'].",".$rowmar1['mark1set3_hybrid4'];
}
?>
<tr class="Dark" height="25">
<td width="223" align="right" valign="middle" class="tblheading" rowspan="3">Base Pair Size&nbsp;</td>
<td align="left" valign="middle" class="tbltext">&nbsp;Male&nbsp;<input name="txtmale" type="text" size="20" class="tbltext" tabindex=""  maxlength="20" value="<?php echo $male?>" readonly="true" style="background-color:#CCCCCC"></td>
<td align="left" valign="middle" class="tbltext">&nbsp;Female&nbsp;<input name="txtfemale" type="text" size="20" class="tbltext" tabindex=""  maxlength="20" value="<?php echo $female?>" readonly="true" style="background-color:#CCCCCC"></td>
<td align="left" valign="middle" class="tbltext">&nbsp;Hybrid&nbsp;<input name="txthybrid" type="text" size="20" class="tbltext" tabindex=""  maxlength="20" value="<?php echo $hybrid?>" readonly="true" style="background-color:#CCCCCC"></td>
</tr>
<tr class="Dark" height="25">
<td align="left" valign="middle" class="tbltext">&nbsp;Male&nbsp;<input name="txtmale" type="text" size="20" class="tbltext" tabindex=""  maxlength="20" value="<?php echo $male2?>" readonly="true" style="background-color:#CCCCCC"></td>
<td align="left" valign="middle" class="tbltext">&nbsp;Female&nbsp;<input name="txtfemale" type="text" size="20" class="tbltext" tabindex=""  maxlength="20" value="<?php echo $female2?>" readonly="true" style="background-color:#CCCCCC"></td>
<td align="left" valign="middle" class="tbltext">&nbsp;Hybrid&nbsp;<input name="txthybrid" type="text" size="20" class="tbltext" tabindex=""  maxlength="20" value="<?php echo $hybrid2?>" readonly="true" style="background-color:#CCCCCC"></td>
</tr>
<tr class="Dark" height="25">
<td align="left" valign="middle" class="tbltext">&nbsp;Male&nbsp;<input name="txtmale" type="text" size="20" class="tbltext" tabindex=""  maxlength="20" value="<?php echo $male3?>" readonly="true" style="background-color:#CCCCCC"></td>
<td align="left" valign="middle" class="tbltext">&nbsp;Female&nbsp;<input name="txtfemale" type="text" size="20" class="tbltext" tabindex=""  maxlength="20" value="<?php echo $female3?>" readonly="true" style="background-color:#CCCCCC"></td>
<td align="left" valign="middle" class="tbltext">&nbsp;Hybrid&nbsp;<input name="txthybrid" type="text" size="20" class="tbltext" tabindex=""  maxlength="20" value="<?php echo $hybrid3?>" readonly="true" style="background-color:#CCCCCC"></td>
</tr>

<tr class="Dark" height="25">
<td width="223" align="right" valign="middle" class="tblheading">Gel Image 1&nbsp;</td>
...
<tr class="Dark" height="25">
<td width="223" align="right" valign="middle" class="tblheading">Gel Image 2&nbsp;</td>
<td align="left" valign="middle" class="tbltext" colspan="3">&nbsp;<input type="file" value="" name="image2" onclick="imageck2()"></td>
</tr>
<tr class="Dark" height="25">
<td width="223" align="right" valign="middle" class="tblheading">Gel Image 3&nbsp;</td>
<td align="left" valign="middle" class="tbltext" colspan="3">&nbsp;<input type="file" value="" name="image3" onclick="imageck3()"></td>
</tr>
<tr class="Dark" height="25">
<td width="223" align="right" valign="middle" class="tblheading">Gel Image 4&nbsp;</td>
