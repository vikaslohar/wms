...
if($printopt == "1" )
{
	echo "<script>window.location='add_new_request _tr.php?p_id=$pid'</script>";	
}
if($printopt == "2" )
{
	echo "<script>window.location='add_voluntary_isit.php?p_id=$pid'</script>";	
}
if($printopt=="3")
{
echo "<script>window.location='add_new_stagwise.php.php?p_id=$pid&tp=Internalreturn'</script>";}
...
<tr class="tblsubtitle" height="25">
  <td colspan="4" align="center" class="tblheading">Select ISIT </td>
</tr>
<tr class="Light" height="25">

<td width="85"  align="right"  valign="middle" class="tbltext">&nbsp;<input type="radio" name="fet" value="1" onClick="test1(this.value);" /></td>
    <td width="223" align="left"  valign="middle" class="tblheading"> &nbsp;Request </td>
</tr>
<tr class="Dark" height="25">
<td  align="right"  valign="middle" class="tbltext">&nbsp;<input type="radio" name="fet" value="2" onClick="test1(this.value);" /></td>
 <td width="223" align="left"  valign="middle" class="tblheading">&nbsp;Voluntary</td >
 </tr>
 <tr class="Light" height="25">

<td width="85"  align="right"  valign="middle" class="tbltext">&nbsp;<input type="radio" name="fet" value="1" onClick="test1(this.value);" /></td>
    <td width="223" align="left"  valign="middle" class="tblheading"> &nbsp;stagewise</td>
</tr>
