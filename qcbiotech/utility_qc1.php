...
<tr class="tblsubtitle" height="20">
  ...
  if($dval<>"")
  { 
  $sql_tbl=mysqli_query($link,"select *  from tbl_qctest where crop='".$crop."' and variety='".$variety."' and oldlot='".$lot."' and srdate='".$dval."' group by sampleno, testdate, state, tid order by testdate desc, tid desc") or die(mysqli_error($link));
