...
<title>CSW- Transaction - CSW  sampling</title>
...
<br/>
<div id="postingtable" style="display:block"><table align="center" border="1" cellspacing="0" cellpadding="0" width="850" bordercolor="#fa8283" style="border-collapse:collapse">
<tr class="tblsubtitle" height="20">
			  ...
			  <td width="87" align="center" valign="middle" class="tblheading">NoB</td>
...
$sql_issue1=mysqli_query($link,"select max(lotldg_id) from tbl_lot_ldg where lotldg_subbinid='".$row_issue['lotldg_subbinid']."' and lotldg_binid='".$row_issue['lotldg_binid']."' and plantcode='".$plantcode."' and lotldg_whid='".$row_issue['lotldg_whid']."' and lotldg_lotno='".$row_tbl_sub['lotno']."' ") or die(mysqli_error($link));
