...
<title>CSW - Utility - Lot Biography</title>
...
?>
<table align="center" border="1" bordercolor="#fa8283" cellspacing="0" cellpadding="0" width="550" style="border-collapse:collapse">
...
<td width="199" align="right"  valign="middle" class="tblheading">Stage:&nbsp;Condition&nbsp;&nbsp;</td>
</tr>
  </table>
<?php
$sql_issue=mysqli_query($link,"select distinct lotldg_whid, lotldg_subbinid, lotldg_binid from tbl_lot_ldg where plantcode='".$plantcode."' and  lotldg_lotno='".$txtlot1."' ") or die(mysqli_error($link));
...
$sql_issue1=mysqli_query($link,"select max(lotldg_id) from tbl_lot_ldg where plantcode='".$plantcode."' and  lotldg_subbinid='".$row_issue['lotldg_subbinid']."' and lotldg_binid='".$row_issue['lotldg_binid']."' and lotldg_whid='".$row_issue['lotldg_whid']."' and lotldg_lotno='".$txtlot1."'") or die(mysqli_error($link));
$row_issue1=mysqli_fetch_array($sql_issue1); 

$sql_arr_home=mysqli_query($link,"select * from tbl_lot_ldg where plantcode='".$plantcode."' and lotldg_id='".$row_issue1[0]."' ") or die(mysqli_error($link)); 
...
if($acn==0)$slocs="";
?>   
<table align="center" border="1" cellspacing="0" cellpadding="0" width="550" bordercolor="#fa8283" style="border-collapse:collapse">
