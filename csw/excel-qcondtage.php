 ...
 while($row_arr_home1=mysqli_fetch_array($sql_arr_home1))
{
	...
	$quer3=mysqli_query($link,"SELECT * FROM tblvariety where varietyid ='".$row_arr_home1['lotldg_variety']."' and actstatus='Active'"); 
...
//echo $slups;
	...
	$quer3=mysqli_query($link,"SELECT * FROM tblvariety where varietyid ='".$row_arr_home['lotldg_variety']."' and actstatus='Active'"); 
