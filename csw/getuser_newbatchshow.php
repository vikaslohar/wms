...
$a=$zzz[0].$zzz[2].$zzz[4].$zzz[6].$zzz[8].$zzz[10].$zzz[12].$zzz[14].$zzz[16].$zzz[18].$zzz[20].$zzz[22].$zzz[24].$zzz[26].$zzz[28].$zzz[30];
...
$lotqry=mysqli_query($link,"select distinct lotldg_whid, lotldg_subbinid, lotldg_binid from tbl_lot_ldg where orlot='".$a."' and plantcode='$plantcode'") or die(mysqli_error($link));
...
<tr class="tblsubtitle" height="20">
  <td colspan="6" align="center" class="tblheading">Lot-Batch Number Details<input type="hidden" name="lotnmo" value="<?php echo $a; ?>" /><input type="hidden" name="lotnmb" value="<?php echo $abc24; ?>" /></td>
</tr>
<tr class="Light" height="25">
	...
	<td width="100" align="left" class="smalltblheading">&nbsp;<?php echo $sstage;?><input type="hidden" name="seedstage" value="<?php echo $sstage;?>" /></td>
</tr>
<tr class="Light" height="25">
...
<tr class="Light" height="25">
	...
	<td width="145" align="left" class="smalltblheading">&nbsp;<?php echo $nob;?><input type="hidden" name="ornob" value="<?php echo $nob;?>" /></td>
	<td width="75" align="right" class="smalltblheading">Qty&nbsp;</td>
	<td align="left" class="smalltblheading" colspan="3">&nbsp;<?php echo $qty;?><input type="hidden" name="orqty" value="<?php echo $qty;?>" /></td>
</tr>
<tr class="Light" height="25">
	<td width="85" align="right" class="smalltblheading">Batch&nbsp;<br />
Conversion&nbsp;</td>
	<td align="left" class="smalltblheading" >&nbsp;<input type="radio" name="paceptyp" id="paceptyp" value="E" onclick="chkvalidity(this.value);" />&nbsp;Pick Entire&nbsp;&nbsp;<input type="radio" name="paceptyp" id="paceptyp" value="P" onclick="chkvalidity(this.value);"  />&nbsp;Pick Partial</td>
	<td width="75" align="right" class="smalltblheading">Batch NoB&nbsp;</td>
	<td width="166" align="left" class="smalltblheading">&nbsp;<input type="text" name="batchnob" class="tabltext" value="" maxlength="5" /></td>
	<td width="115" align="right" class="smalltblheading">Batch Qty&nbsp;</td>
	<td width="100" align="left" class="smalltblheading">&nbsp;<input type="text" name="batchqty" class="tabltext" value="" maxlength="9" /></td>
</tr>
</table>
<br />
<table align="center" border="1" width="950" cellspacing="0" cellpadding="0" bordercolor="#fa8283" style="border-collapse:collapse" > 
...
<table align="center" border="1" width="950" cellspacing="0" cellpadding="0" bordercolor="#fa8283" style="border-collapse:collapse" >
<tr class="tblsubtitle" height="20">
  <td colspan="10" align="center" valign="middle" class="tblheading">SLOC</td>
  </tr>
<tr class="tblsubtitle" height="20">
  <td colspan="5" align="center" valign="middle" class="tblheading">SLOC</td>
  <td colspan="2" rowspan="2" align="center" valign="middle" class="tblheading">&nbsp;</td>
...
<?php
$whd1_query=mysqli_query($link,"select whid, perticulars from tbl_warehouse where plantcode='".$plantcode."' and whtype='Regular' order by perticulars") or die(mysqli_error($link));
?>
...
$whd2_query=mysqli_query($link,"select whid, perticulars from tbl_warehouse where plantcode='".$plantcode."' and whtype='Regular' order by perticulars") or die(mysqli_error($link));
?>
...
<?php
$sno=1;
$sq=mysqli_query($link,"select distinct lotldg_lotno from tbl_lot_ldg WHERE SUBSTRING(orlot, 15, 2 ) = '00' and SUBSTRING( orlot, 1, 13 ) = '$baselot' and plantcode='$plantcode' order by lotldg_id asc")or die("Error:".mysqli_error($link));
$totrow=mysqli_num_rows($sq);
if($totrow > 1)
$sq=mysqli_query($link,"select distinct lotldg_lotno from tbl_lot_ldg WHERE SUBSTRING(orlot, 15, 2 ) = '00' and SUBSTRING( orlot, 1, 13 ) = '$baselot' and plantcode='$plantcode' order by lotldg_id asc limit 1,1")or die("Error:".mysqli_error($link));
while($rowissue=mysqli_fetch_array($sq))
{ 
$lotqry=mysqli_query($link,"select distinct lotldg_whid, lotldg_subbinid, lotldg_binid from tbl_lot_ldg WHERE SUBSTRING(orlot, 15, 2 ) = '00' and SUBSTRING( orlot, 1, 13 ) = '$baselot' and lotldg_lotno='".$rowissue['lotldg_lotno']."' and plantcode='$plantcode'")or die("Error:".mysqli_error($link));
$tot_row=mysqli_num_rows($lotqry);
$nob=0; $qty=0; $sstage=""; $lotts="";
while($row_issue=mysqli_fetch_array($lotqry))
{ 
	$sql_issue1=mysqli_query($link,"select max(lotldg_id) from tbl_lot_ldg where lotldg_subbinid='".$row_issue['lotldg_subbinid']."' and lotldg_binid='".$row_issue['lotldg_binid']."' and lotldg_whid='".$row_issue['lotldg_whid']."' and SUBSTRING(orlot, 15, 2 ) = '00' and SUBSTRING( orlot, 1, 13 ) = '$baselot' and lotldg_lotno='".$rowissue['lotldg_lotno']."' and plantcode='$plantcode'") or die(mysqli_error($link));
	$row_issue1=mysqli_fetch_array($sql_issue1); 
...
$sq2=mysqli_query($link,"select distinct lotno from tbl_lot_ldg_pack WHERE SUBSTRING(orlot, 15, 2 ) != '00' and SUBSTRING( orlot, 1, 13 ) = '$baselot' and plantcode='$plantcode' order by lotdgp_id asc")or die("Error:".mysqli_error($link));
$totrow2=mysqli_num_rows($sq2);
if($totrow2 > 1)
while($rowissue2=mysqli_fetch_array($sq2))
{ 
$lotqry=mysqli_query($link,"select distinct whid, subbinid, binid from tbl_lot_ldg_pack WHERE SUBSTRING(orlot, 15, 2 ) != '00' and SUBSTRING( orlot, 1, 13 ) = '$baselot' and lotno='".$rowissue2['lotno']."' and plantcode='$plantcode'")or die("Error:".mysqli_error($link));
$tot_row=mysqli_num_rows($lotqry);
$nob=0; $qty=0; $sstage=""; $lotts=""; $upsz="";
while($row_issue=mysqli_fetch_array($lotqry))
{ 
	$sql_issue1=mysqli_query($link,"select max(lotdgp_id) from tbl_lot_ldg_pack where subbinid='".$row_issue['subbinid']."' and binid='".$row_issue['binid']."' and whid='".$row_issue['whid']."' and SUBSTRING(orlot, 15, 2 ) != '00' and SUBSTRING( orlot, 1, 13 ) = '$baselot'  and lotno='".$rowissue2['lotno']."' and plantcode='$plantcode'") or die(mysqli_error($link));
	$row_issue1=mysqli_fetch_array($sql_issue1); 
		
	$sql_issuetbl=mysqli_query($link,"select * from tbl_lot_ldg_pack where lotdgp_id='".$row_issue1[0]."' and plantcode='$plantcode'") or die(mysqli_error($link)); 
