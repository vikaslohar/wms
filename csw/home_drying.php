...
$sql_tbl=mysqli_query($link,"select * from tbl_drying where plantcode='".$plantcode."' and  stage='Condition' and   arrflg=0") or die(mysqli_error($link));
while($row_tbl=mysqli_fetch_array($sql_tbl))
{
	 $arrival_id=$row_tbl['trid'];	
	
	$s_sub="delete from tbl_dryingsub where plantcode='".$plantcode."' and  trid='".$arrival_id."'";
	mysqli_query($link,$s_sub) or die(mysqli_error($link));
	
	/*$s_sub_sub="delete from tblarr_sloc where plantcode='".$plantcode."' and  arr_tr_id='".$arrival_id."'";
	mysqli_query($link,$s_sub_sub) or die(mysqli_error($link));
	*/
}

	$s_sub="delete from tbl_drying where plantcode='".$plantcode."' and  stage='Condition' and  arrflg=0";
	mysqli_query($link,$s_sub) or die(mysqli_error($link));	/**/
...
$sql_arr_home=mysqli_query($link,"select * from tbl_drying where plantcode='".$plantcode."' and  stage='Condition' and arrflg=1") or die(mysqli_error($link));
...
$sql_arr_home=mysqli_query($link,"select * from tbl_drying where plantcode='".$plantcode."' and  stage='Condition'and arrflg=1  order by arr_code desc LIMIT $from, $max_results") or die(mysqli_error($link));
$tot_arr_home=mysqli_num_rows($sql_arr_home);

 $total_results3 =mysqli_query($link,"SELECT COUNT(*)  FROM tbl_drying where plantcode='".$plantcode."' and  stage='Condition' and arrflg=1");
