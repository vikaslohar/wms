...
$sql_arr_home3=mysqli_query($link,"select * from tbl_qctest where tid='".$row_arr_home3[0]."' AND plantcode='".$plantcode."'  sampleno='".$row_arr_home2['sampleno']."' order by crop asc, variety asc, oldlot asc") or die(mysqli_error($link));
