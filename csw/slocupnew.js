...
function showUser(str,el,tp,d,e,i,j,k,p,q,r,s)
{ 
	...
	if(tp=="etdrecsl")
	{
		var url="getuser_slocnew_edtrec.php";
		url=url+"?a="+str;
		url=url+"&b="+d;
		url=url+"&c="+e;
		url=url+"&f="+1;
	...
	if(tp=="slocshowmrv")
	{ 
		var url="getuser_slocupnew_slocshow.php";
		url=url+"?a="+str;
		url=url+"&b="+d;
		url=url+"&c="+e;
		url=url+"&f="+i;
	...
	if(tp=="subbin")
	{ 
		var url="getuser_vsbinck_slocnew.php";
		url=url+"?a="+str;
		url=url+"&b="+d; 
		url=url+"&c="+e;
		url=url+"&f="+i;
	...
	{ 
		var url="getuser_slupdation_slocshownew.php";
		url=url+"?a="+str;
		url=url+"&b="+d; 
		url=url+"&c="+e;
		url=url+"&f="+i;
	...
	if(tp=="mformcc")
	{ 
		var url="getuser_slocnew_update.php";
		url=url+"?"+str; 
		url=url+"&sid="+Math.random();
		xmlHttp.onreadystatechange=stateChanged ;
		xmlHttp.open("GET",url,true);
	...
	if(tp=="mformccupdate")
	{ 
		var url="getuser_slocnew_edtupdate.php";
		url=url+"?"+str; 
		url=url+"&sid="+Math.random();
		xmlHttp.onreadystatechange=stateChanged ;
		xmlHttp.open("GET",url,true);
