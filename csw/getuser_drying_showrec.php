...
$srno=1;
$lotqry=mysqli_query($link,"select * from tbl_lot_ldg where plantcode='".$plantcode."' and lotldg_crop ='".$b."' and lotldg_variety='".$c."' and lotldg_sstage='Condition' and lotldg_lotno='$a'")or die (mysqli_error($link));
...
<table align="center" border="1" width="850" cellspacing="0" cellpadding="0" bordercolor="#fa8283" style="border-collapse:collapse" >
  ...
  <tr class="Light" height="30">
    ...
    <td align="left"  valign="middle" class="tbltext" >&nbsp;<input name="txtlotno" type="text" size="20" class="tbltext"  maxlength="20" style="background-color:#CCCCCC" value="<?php echo $a;?>"/></td>
