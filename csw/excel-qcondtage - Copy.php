 ...
 while($row_arr_home1=mysqli_fetch_array($sql_arr_home1))
{
	...
	$quer3=mysqli_query($link,"SELECT * FROM tblvariety where varietyid ='".$row_arr_home1['variety']."' and actstatus='Active'"); 
...
//echo $slups;
		...
		if($variety!="")
		{
		$variety=$variety.",".$row_arr_home['variety'];
		}
		else
		{
