...
<title>CSW-Report - Unidentified Condition Seed Report</title>
...
<table width="1003" height="600" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  ...
  <?php
	...
	$qry="select * from tbl_lot_ldg where plantcode='".$plantcode."' and  lotldg_sstage='Condition' and lotldg_trtype='Unidentified' and lotldg_trdate<='$edate'";	
