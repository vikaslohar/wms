...
if(isset($_REQUEST['pid']))
	...
	/*$sql_code="SELECT MAX(rswrem_code) FROM tbl_cswrem  ORDER BY rswrem_code DESC";
		...
		if(mysqli_num_rows($res_code) > 0)
			{
				...
				$t_code=$row_code['0'];
				$code=$t_code+1;
			$code1="TRM".$code."/".$yearid_id."/".$lgnid;
		}
		else
		{
			$code=1;
...
<title>CSW- Transaction - Condition Seed Release</title>
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#fa8283" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#fa8283" style="border-bottom:solid; border-bottom-color:#fa8283" >
	    <tr >
	      <td width="813" height="25" class="Mainheading">&nbsp;Transaction - Condition Seed Release</td>
	    </tr></table></td>
...
<form id="mainform" name="frmaddDepartment" method="post" action="<?php $_SERVER['PHP_SELF']; ?>" onsubmit="return mySubmit();"   > 
	 ...
	 <input name="txt11" value="" type="hidden"> 
		...
		<input type="hidden" name="txtid" value="<?php echo $row_tbl['rswrem_tcode'];?>" />
