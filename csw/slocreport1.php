...
?>	 
   <table align="center" border="1" bordercolor="#fa8283" cellspacing="0" cellpadding="0" width="750" style="border-collapse:collapse">
...
<td width="50%" align="right"  valign="middle" class="tblheading">Stage: Condition&nbsp;&nbsp;</td>
</tr>
...
if($sid=='ALL')
{ 
  $sql_tb="select distinct(lotldg_subbinid) from tbl_lot_ldg where plantcode='".$plantcode."' and  lotldg_whid='".$whid."' and lotldg_binid='".$bid."' and lotldg_sstage='Condition' order by lotldg_subbinid";  
}
 else
{
$sql_tb="select distinct(lotldg_subbinid) from tbl_lot_ldg where plantcode='".$plantcode."' and  lotldg_whid='".$whid."' and lotldg_binid='".$bid."' and lotldg_subbinid='".$sid."'  and lotldg_sstage='Condition' order by lotldg_subbinid";  
 }
...
{ 
$sql_tbl1=mysqli_query($link,"select max(lotldg_id) from tbl_lot_ldg where plantcode='".$plantcode."' and  lotldg_whid='".$whid."' and lotldg_binid='".$bid."' and lotldg_subbinid='".$row_tbl['lotldg_subbinid']."' and lotldg_sstage='Condition' group by lotldg_lotno order by lotldg_id desc") or die(mysqli_error($link));  
...
else if($sltyp=="cvwise")
{
		...
		$sql_variety=mysqli_query($link,"select * from tblvariety where varietyid='".$txtvariety."'") or die(mysqli_error($link));
		$row_variety=mysqli_fetch_array($sql_variety);
		$tot_variety=mysqli_num_rows($sql_variety);
		if($tot_variety>0)
		{
...
if($lotsltyp=='all')
{ 
  $sql_tb="select distinct(lotldg_lotno) from tbl_lot_ldg where plantcode='".$plantcode."' and  lotldg_crop='".$txtcrop."' and lotldg_variety='".$txtvariety."' and lotldg_sstage='Condition' order by lotldg_id desc";  
}
else
{
	$sql_tb="select distinct(lotldg_lotno) from tbl_lot_ldg where plantcode='".$plantcode."' and  lotldg_crop='".$txtcrop."' and lotldg_variety='".$txtvariety."' and lotldg_sstage='Condition' and lotldg_lotno='".$txtlot1."' order by lotldg_id desc";  
}
...
while($row_tbl=mysqli_fetch_array($sql_qry))
{
$sql_tbl1=mysqli_query($link,"select max(lotldg_id) from tbl_lot_ldg where plantcode='".$plantcode."' and  lotldg_crop='".$txtcrop."' and lotldg_variety='".$txtvariety."' and lotldg_lotno='".$row_tbl['lotldg_lotno']."' and lotldg_sstage='Condition' group by lotldg_lotno order by lotldg_id desc") or die(mysqli_error($link));  
$t1=mysqli_num_rows($sql_tbl1);
while($row_tbl1=mysqli_fetch_array($sql_tbl1))
{
...
$row_subbinn=mysqli_fetch_array($sql_subbinn);
	...
	$crop=""; $variety=""; $lotno=""; $bags=""; $qty=""; $stage=""; $got=""; $qc=""; $moist=""; $gemp=""; $sststus="";
	/*$sql_tbl_sub=mysqli_query($link,"select * from tbl_lot_ldg where plantcode='".$plantcode."' and  lotldg_trid='".$arrival_id."'") or die(mysqli_error($link));
...
$sql_issue=mysqli_query($link,"select distinct lotldg_whid, lotldg_subbinid, lotldg_binid from tbl_lot_ldg where plantcode='".$plantcode."' and  lotldg_lotno='".$lotno."' and lotldg_sstage='Condition' ") or die(mysqli_error($link));
 while($row_issue=mysqli_fetch_array($sql_issue))
 { 
 
$sql_issue1=mysqli_query($link,"select max(lotldg_id) from tbl_lot_ldg where plantcode='".$plantcode."' and  lotldg_subbinid='".$row_issue['lotldg_subbinid']."' and lotldg_binid='".$row_issue['lotldg_binid']."' and lotldg_whid='".$row_issue['lotldg_whid']."' and lotldg_sstage='Condition' and lotldg_lotno='".$lotno."'") or die(mysqli_error($link));
$row_issue1=mysqli_fetch_array($sql_issue1); 

$sql_arr_home=mysqli_query($link,"select * from tbl_lot_ldg where plantcode='".$plantcode."' and  lotldg_id='".$row_issue1[0]."' and lotldg_sstage='Condition' and lotldg_balqty > 0") or die(mysqli_error($link)); 
...
?>
<table align="center" border="1" cellspacing="0" cellpadding="0" width="400" bordercolor="#fa8283" style="border-collapse:collapse">
