...
$s_sub="delete from tbl_dryingsub where plantcode='".$plantcode."' and  subtrid='".$b."'";
...
{
$s_sub1="delete from tbl_drying where plantcode='".$plantcode."' and  trid='".$a."'";
mysqli_query($link,$s_sub1) or die(mysqli_error($link));
$tid=0;
}
?>
 
<table align="center" border="1" width="850" cellspacing="0" cellpadding="0" bordercolor="#fa8283" style="border-collapse:collapse" > <?php  
///echo $tid=$a;
...
<tr height="15"><td colspan="6" align="right" class="tblheading"><font color="#FF0000" >*</font>indicates required field&nbsp;</td></tr><?php
	$sql_code="SELECT MAX(arr_code) FROM tbl_drying  ORDER BY arr_code DESC";
