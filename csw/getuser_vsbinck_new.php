...
if($tpmflg==0)
{
	...
	{ 	
		...
		{	
			...
			$details="<a href='Javascript:void(0)' onclick='openprintsubbin($row_issuetblg_new2[lotldg_subbinid],$row_issuetblg_new2[lotldg_binid],$row_issuetblg_new2[lotldg_whid],$row_issuetblg_new2[lotldg_id])'>Details</a>";
...
if($tpmflg==0)
{
	...
	{ 
		...
		if($whval=='14')
		{
			$s_good=mysqli_query($link,"select distinct lotldg_variety from tbl_lot_ldg_pack where plantcode='".$plantcode."' and  subbinid='".$a."' and lotldg_variety!='".$b."' and lotldg_crop='".$crpval."'") or die(mysqli_error($link));
		}
		else
		{
