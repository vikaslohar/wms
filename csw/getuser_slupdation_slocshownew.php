...
{
$whd1_query=mysqli_query($link,"select whid, perticulars from tbl_warehouse where plantcode='".$plantcode."' and whtype='Cold' order by perticulars") or die(mysqli_error($link));
?>
<tr class="Light" height="30" >
...
<?php
$whd2_query=mysqli_query($link,"select whid, perticulars from tbl_warehouse where plantcode='".$plantcode."' and  whtype='Cold' order by perticulars") or die(mysqli_error($link));
?>
...
$whd3_query=mysqli_query($link,"select whid, perticulars from tbl_warehouse where plantcode='".$plantcode."' and  whtype='Cold' order by perticulars") or die(mysqli_error($link));
?>
...
$whd4_query=mysqli_query($link,"select whid, perticulars from tbl_warehouse where plantcode='".$plantcode."' and whtype='Cold' order by perticulars") or die(mysqli_error($link));
?>
...
$whd5_query=mysqli_query($link,"select whid, perticulars from tbl_warehouse where plantcode='".$plantcode."' and whtype='Cold' order by perticulars") or die(mysqli_error($link));
?>
...
$whd6_query=mysqli_query($link,"select whid, perticulars from tbl_warehouse where plantcode='".$plantcode."' and whtype='Cold' order by perticulars") or die(mysqli_error($link));
?>
...
$whd7_query=mysqli_query($link,"select whid, perticulars from tbl_warehouse where plantcode='".$plantcode."' and whtype='Cold' order by perticulars") or die(mysqli_error($link));
?>
...
$whd8_query=mysqli_query($link,"select whid, perticulars from tbl_warehouse where plantcode='".$plantcode."' and whtype='Cold' order by perticulars") or die(mysqli_error($link));
?>
...
$whd9_query=mysqli_query($link,"select whid, perticulars from tbl_warehouse where plantcode='".$plantcode."' and whtype='Cold' order by perticulars") or die(mysqli_error($link));
?>
...
$whd10_query=mysqli_query($link,"select whid, perticulars from tbl_warehouse where  plantcode = '".$plantcode."' and whtype='Cold' order by perticulars") or die(mysqli_error($link));
?>
