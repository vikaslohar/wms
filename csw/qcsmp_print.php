...
$sqltblsub2=mysqli_query($link,"select * from tbl_csw where plantcode='".$plantcode."' and arrival_id='".$arrival_id."'") or die(mysqli_error($link));
...
<tr class="tblsubtitle" height="20">
	...
	<td width="14%" align="center" valign="middle" class="tblheading">NoB</td>
...
$sql_whouse=mysqli_query($link,"select perticulars from tbl_warehouse plantcode='".$plantcode."' and  where whid='".$row_issuetbl['lotldg_whid']."' order by perticulars") or die(mysqli_error($link));
