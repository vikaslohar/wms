...
if($trid == 0)
{
 $sql_in1="insert into tbl_sloc_csw (code, sldate, crop, variety, lotno, yearcode, surole,plantcode) values ('$code', '$tdate', '$txtcrop', '$txtvariety', '$txtlot1', '$yearid_id', '$lgnid','$plantcode')";
...
{
$sql_in1="update tbl_sloc_csw set crop='$txtcrop', variety='$txtvariety', lotno='$txtlot1', yearcode='$yearid_id', surole='$lgnid' where plantcode='".$plantcode."' and  slid='".$trid."'";
 
if(mysqli_query($link,$sql_in1) or die(mysqli_error($link)))
{

$s_sub_sub="delete from tbl_sloc_csw_sub where plantcode='".$plantcode."' and  rowid='".$orwoid."' and slocid='".$trid."'";
