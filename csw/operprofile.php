	   ...
	   $sql_in="update tblopr set login='$login',
		...
		if(mysqli_query($link,$sql_in)or die(mysqli_error($link)))
          ...
          $sql_in1="Update tbluser set	loginid='$login',
										password='$pass',
										email='$email'
										where role='rsw' and scode='$scode'";	
...
<title>CSW In-charge Profile</title>
...
<!-- actual page start--->	
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#fa8283" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#fa8283" style="border-bottom:solid; border-bottom-color:#fa8283" >
	    <tr >
	      <td width="813" height="25" class="Mainheading">&nbsp;RSW In-charge Profile</td>
	    </tr></table></td>
 ...
 <?php
	$result=mysqli_query($link,"SELECT * FROM tblopr where plantcode='".$plantcode."' and id='".$loginid."'")or die(mysqli_error($link)); 
	...
	?>
	 ...
	 <input type="hidden" name="scode" value="<?php echo "RS".$row['code'];?>">
...
<table align="center" border="0" width="650" cellspacing="0" cellpadding="0" bordercolor="#fa8283"
 style="border-collapse:collapse" > <tr><td>
<table width="700" border="1" cellspacing="0" cellpadding="0" align="center"  bordercolor="#fa8283"
 style="border-collapse:collapse">
<tr class="tblsubtitle" height="25">
<td colspan="2" align="center" class="tblheading" valign="middle">RSW In-charge Profile </td>
</tr>
...
<?php 
$result1=mysqli_query($link,"SELECT * FROM tbldept where plantcode='".$plantcode."' and department_id='".$row['department_id']."'")or die(mysqli_error($link)); 
...
<td width="349" align="left" valign="middle" class="tbltext">&nbsp;<input name="txtId" type="text" class="tbltext" tabindex="0" value="<?php echo $row['login'];?>" size="25" maxlength="10"/>&nbsp;<font color="#FF0000" >* </font>&nbsp;Min 6 Max 10</td>
</tr>		
<tr class="Light" height="25">
<td align="right" valign="middle" class="tblheading">&nbsp;Password&nbsp;</td>
<td align="left" valign="middle" class="tbltext">&nbsp;<input name="txtpass" type="password" class="tbltext" tabindex="" value="<?php echo $row['pass'];?>" size="25" maxlength="10"/>&nbsp;<font color="#FF0000" >* </font>&nbsp;Min 6 Max 10</td>
</tr>
<tr class="Dark" height="25">
<td align="right" valign="middle" class="tblheading">&nbsp;Retype Password&nbsp;</td>
<td align="left" valign="middle" class="tbltext">&nbsp;<input name="txtrepass" type="password" class="tbltext" tabindex="" value="<?php echo $row['pass'];?>" size="25" maxlength="10"/>&nbsp;<font color="#FF0000" >* </font>&nbsp;Min 6 Max 10</td>
</tr>
<tr class="Light" height="25">
...
<?php
$quer24=mysqli_query($link,"SELECT * FROM tbldestination where plantcode='".$plantcode."' and did='".$row['did']."' order by dest"); 
