<?php
	...
	{	
		/*$sql_arr=mysqli_query($link,"select * from tbl_sloc_csw where slid='".$pid."'") or die(mysqli_error($link));
	...
	$row_issuetbl=mysqli_fetch_array($sql_issuetbl);
		...
		$sql_sloc_sub=mysqli_query($link,"select * from tbl_sloc_csw_sub where slocid='".$pid."'") or die(mysqli_error($link));
...
<tr class="Dark" height="25">
 ...
 <?php 
$quer3=mysqli_query($link,"select classification_id, classification from tbl_classification where classification_id='".$c."'AND plantcode='".$plantcode."'") or die(mysqli_error($link));
...
<?php 
$itemqry1=mysqli_query($link,"select * from tbl_stores where items_id='".$f."' AND plantcode='".$plantcode."'") or die(mysqli_error($link));
...
if($a=="good")
{
$sql_tbl=mysqli_query($link,"select * from tbl_stldg_good where stlg_trtype='SLOC' and stlg_trsubtype='SUO' and stlg_trid='".$pid."' AND plantcode='".$plantcode."'") or die(mysqli_error($link));
...
{ 
$sql_whouse=mysqli_query($link,"select perticulars from tbl_warehouse where whid='".$row_tbl_sub['stlg_whid']."' AND plantcode='".$plantcode."' order by perticulars") or die(mysqli_error($link));
$row_whouse=mysqli_fetch_array($sql_whouse);
$wareh=$row_whouse['perticulars'];

$sql_binn=mysqli_query($link,"select binname from tbl_bin where binid='".$row_tbl_sub['stlg_binid']."' and whid='".$row_tbl_sub['stlg_whid']."' AND plantcode='".$plantcode."'") or die(mysqli_error($link));
$row_binn=mysqli_fetch_array($sql_binn);
$binn=$row_binn['binname'];

$sql_subbinn=mysqli_query($link,"select sname from tbl_subbin where sid='".$row_tbl_sub['stlg_subbinid']."' and binid='".$row_tbl_sub['stlg_binid']."' AND plantcode='".$plantcode."' and whid='".$row_tbl_sub['stlg_whid']."'") or die(mysqli_error($link));
...
$sql_tbl=mysqli_query($link,"select * from tbl_stldg_damage where stld_trtype='SLOC' and stld_trsubtype='SUO' and stld_trid='".$pid."' AND plantcode='".$plantcode."'") or die(mysqli_error($link));
...
while($row_tbl_sub=mysqli_fetch_array($sql_tbl))
{ 
$sql_whouse=mysqli_query($link,"select perticulars from tbl_warehouse where whid='".$row_tbl_sub['stld_whid']."' AND plantcode='".$plantcode."' order by perticulars") or die(mysqli_error($link));
$row_whouse=mysqli_fetch_array($sql_whouse);
$wareh=$row_whouse['perticulars'];

$sql_binn=mysqli_query($link,"select binname from tbl_bin where binid='".$row_tbl_sub['stld_binid']."' and whid='".$row_tbl_sub['stld_whid']."' AND plantcode='".$plantcode."'") or die(mysqli_error($link));
$row_binn=mysqli_fetch_array($sql_binn);
$binn=$row_binn['binname'];

$sql_subbinn=mysqli_query($link,"select sname from tbl_subbin where sid='".$row_tbl_sub['stld_subbinid']."' and binid='".$row_tbl_sub['stld_binid']."' and whid='".$row_tbl_sub['stld_whid']."' AND plantcode='".$plantcode."'") or die(mysqli_error($link));
$row_subbinn=mysqli_fetch_array($sql_subbinn);
$subbinn=$row_subbinn['sname'];
...
<tr >
<td valign="top" align="right"><a href="home_slocnew.php"><img src="../images/back.gif" border="0"  style="display:inline;cursor:pointer;"/></a>&nbsp;&nbsp;</td>
</tr>
</table>
</td><td width="30"></td>
</tr>
