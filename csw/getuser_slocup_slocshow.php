...
$sql_issue=mysqli_query($link,"select distinct lotldg_whid, lotldg_subbinid, lotldg_binid from tbl_lot_ldg where lotldg_crop='".$c."' and lotldg_variety='".$f."' and lotldg_lotno='".$a."'") or die(mysqli_error($link));
