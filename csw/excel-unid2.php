...
$row31=mysqli_fetch_array($sql_crop);
 ...
 $quer4=mysqli_query($link,"SELECT varietyid, popularname FROM tblvariety where cropname='".$row_tbl_sub['lotldg_crop']."' and actstatus='Active' order by popularname Asc"); 
