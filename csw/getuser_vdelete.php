...
$s_sub="delete from tbl_csw where plantcode='".$plantcode."' and  arrsub_id='".$b."'";
mysqli_query($link,$s_sub) or die(mysqli_error($link));


$sql_t_sub=mysqli_query($link,"select * from tbl_csw where plantcode='".$plantcode."' and  arrival_id='".$a."'") or die(mysqli_error($link));
...
<tr class="tblsubtitle" height="20">
  <!--<td width="2%" rowspan="2" align="center" valign="middle" class="tblheading">#</td>
	...
	<td width="17" align="center" valign="middle" class="tblheading">#</td>
			  ...
			  <td width="91" align="center" valign="middle" class="tblheading">NoB</td>
