...
<?php	
	...
	$reslt="";
 	$sql_class=mysqli_query($link,"select * from tblcrop where plantcode='".$plantcode."' and cropid='".$itemid."'") or die(mysqli_error($link));
	$row_class=mysqli_fetch_array($sql_class);
	$crop=$row_class['cropname'];	 
	
	$qry="select distinct lotldg_variety from tbl_lot_ldg where plantcode='".$plantcode."' and  lotldg_qctestdate<='".$edate."' and lotldg_crop='".$itemid."' ";
...
while($row_arr_home1=mysqli_fetch_array($sql_arr_home1))
{
	...
	$cont=0;
	$sql_arr_home244=mysqli_query($link,"select distinct lotldg_lotno from tbl_lot_ldg where plantcode='".$plantcode."' and  lotldg_qctestdate<='$edate' and lotldg_crop='".$itemid."'  and lotldg_variety='".$row_arr_home1['lotldg_variety']."' $reslt order by lotldg_variety asc, lotldg_qctestdate asc ") or die(mysqli_error($link));
...
<?php
$sql_arr_home2=mysqli_query($link,"select distinct lotldg_lotno from tbl_lot_ldg where plantcode='".$plantcode."' and  lotldg_qctestdate<='".$edate."' and lotldg_crop='".$itemid."' and lotldg_variety='".$row_arr_home1['lotldg_variety']."' $reslt order by lotldg_variety asc, lotldg_qctestdate asc ") or die(mysqli_error($link));
$t=mysqli_num_rows($sql_arr_home2);
while($row_arr_home2=mysqli_fetch_array($sql_arr_home2))
{

$sql_arr_home3=mysqli_query($link,"select MAX(lotldg_id) from tbl_lot_ldg where plantcode='".$plantcode."' and  lotldg_qctestdate<='".$edate."' and lotldg_crop='".$itemid."' and lotldg_variety='".$row_arr_home1['lotldg_variety']."' and lotldg_lotno='".$row_arr_home2['lotldg_lotno']."' $reslt order by lotldg_variety asc, lotldg_qctestdate asc  ") or die(mysqli_error($link));
