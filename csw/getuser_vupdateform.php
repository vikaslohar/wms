...
if($z1 == 0)
{
   $sql_main="insert into tbl_csw_main (year_code,arr_code, arrival_date,arr_role,plantcode)values('$yearid_id','$c','$tdate1','$logid','$plantcode')";
if(mysqli_query($link,$sql_main) or die(mysqli_error($link)))
{
$mainid=mysqli_insert_id($link);

  $sql_sub="insert into tbl_csw (crop, variety, pp,moist,gemp,got,arr_role,lotno ,arrival_id,arrival_date,plantcode)values('$o','$p','$a','$b','$f','$d','$logid','$lot2','$mainid','$tdate1','$plantcode')";
...
{
 $sql_main="update tbl_csw_main set year_code='$yearid_id', arrival_date='$tdate1',arr_role='$logid' where arrival_id = '$z1'";

if(mysqli_query($link,$sql_main) or die(mysqli_error($link)))
{
$mainid=$z1;
 $sql_sub="insert into tbl_csw (crop, variety, pp,moist,gemp,got,arr_role,lotno ,arrival_id,arrival_date,plantcode)values('$o','$p','$a','$b','$f','$d','$logid','$lot2','$mainid','$tdate1','$plantcode')"; /*$sql_sub="insert into tbl_csw (crop, variety,yearcode,arr_code,pp,moist,gemp,got,arr_role,lotno ,arrival_id)values('$o','$p','$yearid_id','$c','$a','$b','$f','$d','$logid','$lot2','$mainid')";*/
mysqli_query($link,$sql_sub) or die(mysqli_error($link));
}
}
