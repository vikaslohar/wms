...
if($z1 == 0)
{
  $sql_main="insert into tbl_csw_main (crop, varietyyear_code,arr_code, arrival_date,arr_role,plantcode)values('$o','$p','$yearid_id','$c','$tdate1','$logid','$plantcode')";
if(mysqli_query($link,$sql_main) or die(mysqli_error($link)))
{
$mainid=mysqli_insert_id($link);

 $sql_sub="insert into tbl_csw (crop, variety,pp,moist,gemp,got,arr_role,lotno ,arrival_id,plantcode)values('$o','$p','$a','$b','$f','$d','$logid','$lot2','$mainid','$plantcode')";
...
{
 $sql_main="update tbl_csw_main set crop='$o',variety='$p',year_code='$yearid_id' , arrival_date='$tdate1',arr_role='$logid' where arrival_id = '$z1'";

if(mysqli_query($link,$sql_main) or die(mysqli_error($link)))
{
$mainid=$z1;
$sql_sub="update tbl_csw set crop='$o',variety='$p', pp='$a',moist='$b',gemp='$f',got='$d',arrival_date='$tdate1', arr_role='$logid' where arrsub_id = '$subtrid'";
mysqli_query($link,$sql_sub) or die(mysqli_error($link));
}
}
...
?>
  <?php
$sql_tbl=mysqli_query($link,"select * from tbl_csw_main where plantcode='".$plantcode."' and  arr_role='".$logid."'  and arrival_id='".$tid."'") or die(mysqli_error($link));
...
<tr class="tblsubtitle" height="20">
  <td width="17" align="center" valign="middle" class="tblheading">#</td>
   ...
   <td width="99" align="center" valign="middle" class="tblheading">Crop</td>
			  ...
			  <td width="48" align="center" valign="middle" class="tblheading">Lot No. </td>
			  <td width="99" align="center" valign="middle" class="tblheading">NoB</td>
              <td width="124" align="center" valign="middle" class="tblheading">Qty</td>
			   <td width="107" align="center" valign="middle" class="tblheading">SLOC</td>
              <td width="107" align="center" valign="middle" class="tblheading">QC Tests </td>
			   <td width="58" align="center" valign="middle" class="tblheading">Edit</td>
              <td width="70" align="center" valign="middle" class="tblheading">Delete</td>
...
$row31=mysqli_fetch_array($quer3);
 ...
 $totqty=0; $totnob=0; $totqc=""; $totdot=""; $totmost=""; $totgemp=""; $totgot=""; $reserve=""; $totsst=""; 	$sloc=""; 
	$sql_issue=mysqli_query($link,"select distinct lotldg_subbinid, lotldg_whid, lotldg_binid from tbl_lot_ldg where plantcode='".$plantcode."' and   lotldg_lotno='".$row_tbl_sub['lotno']."' ") or die(mysqli_error($link));

 while($row_issue=mysqli_fetch_array($sql_issue))
 { 

$sql_issue1=mysqli_query($link,"select max(lotldg_id) from tbl_lot_ldg where plantcode='".$plantcode."' and  lotldg_subbinid='".$row_issue['lotldg_subbinid']."' and lotldg_binid='".$row_issue['lotldg_binid']."' and lotldg_whid='".$row_issue['lotldg_whid']."' and lotldg_lotno='".$row_tbl_sub['lotno']."' ") or die(mysqli_error($link));
