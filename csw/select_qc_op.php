...
<title>CSW - QC Sampling - Select output</title>
...
?> 
<table align="center" border="0" width="750" cellspacing="0" cellpadding="0" bordercolor="#fa8283" style="border-collapse:collapse" > 
<tr height="25">
  ...
  <!--<td width="2%" rowspan="2" align="center" valign="middle" class="tblheading">#</td>
	...
	<td width="2%" align="center" valign="middle" class="tblheading">#</td>
              ...
              <td width="17%" align="center" valign="middle" class="tblheading">Qty</td>
			   <td width="17%" align="center" valign="middle" class="tblheading">GOT</td>
               <td width="14%" align="center" valign="middle" class="tblheading">Quality</td>
			   </tr>
  <?php
...
$sql_tbl=mysqli_query($link,"select * from tbl_lot_ldg where plantcode='".$plantcode."' and lotldg_lotno='".$lot."'") or die(mysqli_error($link));
$row_tbl=mysqli_fetch_array($sql_tbl);
$tot=mysqli_num_rows($sql_tbl);		
$lotldg_trid=$row_tbl['lotldg_trid'];

	
$sql_tbl=mysqli_query($link,"select * from tbl_lot_ldg where plantcode='".$plantcode."' and lotldg_trid='".$lotldg_trid."'") or die(mysqli_error($link));
$row_tbl=mysqli_fetch_array($sql_tbl);
 $tot=mysqli_num_rows($sql_tbl);		
