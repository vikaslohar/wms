<?php
	...
	$res_code1=mysqli_query($link,$sql_code1)or die(mysqli_error($link));
	  ...
	  $sql_main="update tbl_drying set dflg=1 , arrflg=1  where trid ='$pid' AND plantcode='".$plantcode."'";
	$a123456=mysqli_query($link,$sql_main) or die(mysqli_error($link));
	//exit;


		$sql_code="SELECT MAX(arr_code) FROM tbl_csw_main  AND plantcode='".$plantcode."' ORDER BY arr_code DESC";
...
<title>CSW -Transaction - Drying Slip- Preview</title>
...
<table width="1003" height="600" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
 ...
 <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#fa8283" >
  <tr><td>
   ...
   <?php
  $tid=$pid;
$sql_tbl=mysqli_query($link,"select * from tbl_drying where  stage='Condition' and trid='".$tid."' AND plantcode='".$plantcode."'") or die(mysqli_error($link));
