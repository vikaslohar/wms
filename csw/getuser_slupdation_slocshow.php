...
$sql_issuetbl=mysqli_query($link,"select * from tbl_lot_ldg where plantcode='".$plantcode."' and  lotldg_id='".$orid."' and lotldg_balqty > 0") or die(mysqli_error($link)); 

 while($row_issuetbl=mysqli_fetch_array($sql_issuetbl))
 { 
$whi=$row_issuetbl['lotldg_whid'];$bni=$row_issuetbl['lotldg_binid'];$sbni=$row_issuetbl['lotldg_subbinid'];   //$cnt++; 
$sql_whouse=mysqli_query($link,"select perticulars from tbl_warehouse where plantcode =  '".$plantcode."' plantcode='".$plantcode."' and  where whid='".$row_issuetbl['lotldg_whid']."' order by perticulars") or die(mysqli_error($link));
...
$sql_binn=mysqli_query($link,"select binname from tbl_bin where plantcode =  '".$plantcode."' where plantcode='".$plantcode."' and   binid='".$row_issuetbl['lotldg_binid']."' and whid='".$row_issuetbl['lotldg_whid']."'") or die(mysqli_error($link));
$row_binn=mysqli_fetch_array($sql_binn);
$binn=$row_binn['binname'];

$sql_subbinn=mysqli_query($link,"select sname from tbl_subbin where plantcode =  '".$plantcode."' where plantcode='".$plantcode."' and  sid='".$row_issuetbl['lotldg_subbinid']."' and binid='".$row_issuetbl['lotldg_binid']."' and whid='".$row_issuetbl['lotldg_whid']."'") or die(mysqli_error($link));
...
$sql_issue=mysqli_query($link,"select distinct lotldg_whid, lotldg_subbinid, lotldg_binid from tbl_lot_ldg where plantcode='".$plantcode."' and  lotldg_crop='".$c."' and lotldg_variety='".$b."' and lotldg_lotno='".$a."'") or die(mysqli_error($link));
...
$totBags=0; $totqty=0; $cnt=0; $whid="";$binid="";$subbinid=""; $whid1="";$binid1="";$subbinid1="";
 ...
 $sql_issue1=mysqli_query($link,"select max(lotldg_id) from tbl_lot_ldg where plantcode='".$plantcode."' and  lotldg_subbinid='".$row_issue['lotldg_subbinid']."' and lotldg_binid='".$row_issue['lotldg_binid']."' and lotldg_whid='".$row_issue['lotldg_whid']."' and lotldg_variety='".$b."' and lotldg_lotno='".$a."'") or die(mysqli_error($link));
//$row_subtb=0;
$row_issue1=mysqli_fetch_array($sql_issue1); 

if($trid > 0)
{
$sql_subtb=mysqli_query($link,"select * from tbl_sloc_csw_sub where plantcode='".$plantcode."' and  slocid='".$trid."' and subbinid='".$row_issue['lotldg_subbinid']."' and  binid='".$row_issue['lotldg_binid']."' and  whid='".$row_issue['lotldg_whid']."' and lotno='".$a."'") or die(mysqli_error($link));
...
$sql_whouse=mysqli_query($link,"select perticulars from tbl_warehouse where plantcode =  '".$plantcode."' where plantcode='".$plantcode."' and  whid='".$row_issuetbl['lotldg_whid']."' order by perticulars") or die(mysqli_error($link));
$row_whouse=mysqli_fetch_array($sql_whouse);
$wareh=$row_whouse['perticulars'];
...
if($whi==$row_issuetbl['lotldg_whid'] && $bni==$row_issuetbl['lotldg_binid'] && $sbni==$row_issuetbl['lotldg_subbinid'])
{
 ?>
 <?php
$whd1_query=mysqli_query($link,"select whid, perticulars from tbl_warehouse where plantcode =  '".$plantcode."' where plantcode='".$plantcode."'  order by perticulars") or die(mysqli_error($link));
?>
...
<?php
$bind1_query=mysqli_query($link,"select binid, binname from tbl_bin where plantcode =  '".$plantcode."' where plantcode='".$plantcode."' and  whid='".$whi."' order by binname") or die(mysqli_error($link));
?>
...
<?php
$subbind1_query=mysqli_query($link,"select sid, sname from tbl_subbin where plantcode =  '".$plantcode."' where whid='".$whi."' and binid='".$bni."' order by sname") or die(mysqli_error($link));
?>	
...
<?php
$subbind1_query=mysqli_query($link,"select sid, sname from tbl_subbin where plantcode =  '".$plantcode."' where plantcode='".$plantcode."' and  whid='".$whi."' and binid='".$bni."' order by sname") or die(mysqli_error($link));
?>	
...
$sql_iss=mysqli_query($link,"select max(slocsubid) from tbl_sloc_csw_sub where plantcode='".$plantcode."' and  slocid='".$trid."' and whid='".$t_gddist['whid']."' and binid='".$t_gddist['binid']."' and subbinid='".$t_gddist['subbinid']."'") or die(mysqli_error($link));
$t=mysqli_fetch_array($sql_iss);
//$srno=1;
$sql_issue=mysqli_query($link,"select * from tbl_sloc_csw_sub where plantcode='".$plantcode."' and  slocsubid='".$t[0]."'") or die(mysqli_error($link));
$totBags=0; $totqty=0; 
 while($row_issue=mysqli_fetch_array($sql_issue))
 { 
...
//echo $t=mysqli_num_rows($sql_issuetbl);
 ...
 { */$cnt++;$ct++;
 $wareh=""; $binn=""; $subbinn=""; $sBags="";$sqty=0; $slocs=""; $gd=""; $slBags=0; $slqty=0;
$sql_whouse=mysqli_query($link,"select perticulars from tbl_warehouse where plantcode =  '".$plantcode."' where plantcode='".$plantcode."' and  whid='".$row_issue['whid']."' order by perticulars") or die(mysqli_error($link));
$row_whouse=mysqli_fetch_array($sql_whouse);
$wareh=$row_whouse['perticulars'];

$sql_binn=mysqli_query($link,"select binname from tbl_bin where plantcode =  '".$plantcode."' where plantcode='".$plantcode."' and  binid='".$row_issue['binid']."' and whid='".$row_issue['whid']."'") or die(mysqli_error($link));
$row_binn=mysqli_fetch_array($sql_binn);
$binn=$row_binn['binname'];

$sql_subbinn=mysqli_query($link,"select sname from tbl_subbin where plantcode =  '".$plantcode."' where plantcode='".$plantcode."' and  sid='".$row_issue['subbinid']."' and binid='".$row_issue['binid']."' and whid='".$row_issue['whid']."'") or die(mysqli_error($link));
$row_subbinn=mysqli_fetch_array($sql_subbinn);
$subbinn=$row_subbinn['sname'];
...
<?php
/*if($rid=="CS-01")
$whd1_query=mysqli_query($link,"select whid, perticulars from tbl_warehouse where plantcode =  '".$plantcode."' where perticulars='CS-01' order by perticulars") or die(mysqli_error($link));
else*/
$whd1_query=mysqli_query($link,"select whid, perticulars from tbl_warehouse where plantcode =  '".$plantcode."' where plantcode='".$plantcode."' order by perticulars") or die(mysqli_error($link));
?>
<tr class="Light" height="30" >
...
<?php
$bind1_query=mysqli_query($link,"select binid, binname from tbl_bin where plantcode =  '".$plantcode."' where plantcode='".$plantcode."' order by binname") or die(mysqli_error($link));
?>
...
<?php
$subbind1_query=mysqli_query($link,"select sid, sname from tbl_subbin where plantcode =  '".$plantcode."' where plantcode='".$plantcode."' order by sname") or die(mysqli_error($link));
?>	
...
<?php
/*if($rid=="CS-01")
$whd2_query=mysqli_query($link,"select whid, perticulars from tbl_warehouse where plantcode =  '".$plantcode."' where perticulars='CS-01' order by perticulars") or die(mysqli_error($link));
else*/
$whd2_query=mysqli_query($link,"select whid, perticulars from tbl_warehouse where plantcode =  '".$plantcode."' where plantcode='".$plantcode."' order by perticulars") or die(mysqli_error($link));
?>
...
<?php
$bind2_query=mysqli_query($link,"select binid, binname from tbl_bin where plantcode =  '".$plantcode."' where plantcode='".$plantcode."' order by binname") or die(mysqli_error($link));
?>
...
<?php
$subbind2_query=mysqli_query($link,"select sid, sname from tbl_subbin where plantcode =  '".$plantcode."' where plantcode = '".$plantcode."'order by sname") or die(mysqli_error($link));
?>	
...
?>
<?php
//$whd3_query=mysqli_query($link,"select whid, perticulars from tbl_warehouse where plantcode =  '".$plantcode."' where perticulars='CS-01' order by perticulars") or die(mysqli_error($link));
$whd3_query=mysqli_query($link,"select whid, perticulars from tbl_warehouse where plantcode =  '".$plantcode."' where plantcode = '".$plantcode."'order by perticulars") or die(mysqli_error($link));
?>
...
<?php
$bind3_query=mysqli_query($link,"select binid, binname from tbl_bin where plantcode =  '".$plantcode."' where plantcode = '".$plantcode."'order by binname") or die(mysqli_error($link));
?>
...
<?php
//$whd4_query=mysqli_query($link,"select whid, perticulars from tbl_warehouse where plantcode =  '".$plantcode."' where perticulars='CS-01' order by perticulars") or die(mysqli_error($link));
$whd4_query=mysqli_query($link,"select whid, perticulars from tbl_warehouse where plantcode =  '".$plantcode."' where plantcode = '".$plantcode."'order by perticulars") or die(mysqli_error($link));
?>
...
<?php
$bind4_query=mysqli_query($link,"select binid, binname from tbl_bin where plantcode =  '".$plantcode."' where plantcode = '".$plantcode."'order by binname") or die(mysqli_error($link));
?>
...
<?php
$subbind4_query=mysqli_query($link,"select sid, sname from tbl_subbin where plantcode =  '".$plantcode."' where plantcode = '".$plantcode."'order by sname") or die(mysqli_error($link));
?>	
...
<?php
//$whd5_query=mysqli_query($link,"select whid, perticulars from tbl_warehouse where plantcode =  '".$plantcode."' where perticulars='CS-01' order by perticulars") or die(mysqli_error($link));
$whd5_query=mysqli_query($link,"select whid, perticulars from tbl_warehouse where plantcode =  '".$plantcode."' where plantcode = '".$plantcode."'order by perticulars") or die(mysqli_error($link));
?>
...
<?php
$bind5_query=mysqli_query($link,"select binid, binname from tbl_bin where plantcode =  '".$plantcode."' where plantcode = '".$plantcode."'order by binname") or die(mysqli_error($link));
?>
...
<?php
$subbind5_query=mysqli_query($link,"select sid, sname from tbl_subbin where plantcode =  '".$plantcode."' where plantcode = '".$plantcode."'order by sname") or die(mysqli_error($link));
?>	
...
<?php
//$whd6_query=mysqli_query($link,"select whid, perticulars from tbl_warehouse where plantcode =  '".$plantcode."' where perticulars='CS-01' order by perticulars") or die(mysqli_error($link));
$whd6_query=mysqli_query($link,"select whid, perticulars from tbl_warehouse where plantcode =  '".$plantcode."' where plantcode = '".$plantcode."'order by perticulars") or die(mysqli_error($link));
?>
...
<?php
$bind6_query=mysqli_query($link,"select binid, binname from tbl_bin where plantcode =  '".$plantcode."' where plantcode = '".$plantcode."'order by binname") or die(mysqli_error($link));
?>
...
<?php
$subbind6_query=mysqli_query($link,"select sid, sname from tbl_subbin where plantcode =  '".$plantcode."' where plantcode = '".$plantcode."'order by sname") or die(mysqli_error($link));
?>	
...
<?php
//$whd7_query=mysqli_query($link,"select whid, perticulars from tbl_warehouse where plantcode =  '".$plantcode."' where perticulars='CS-01' order by perticulars") or die(mysqli_error($link));
$whd7_query=mysqli_query($link,"select whid, perticulars from tbl_warehouse where plantcode =  '".$plantcode."' where plantcode = '".$plantcode."'order by perticulars") or die(mysqli_error($link));
?>
...
<?php
$bind7_query=mysqli_query($link,"select binid, binname from tbl_bin where plantcode =  '".$plantcode."' where plantcode = '".$plantcode."'order by binname") or die(mysqli_error($link));
?>
...
<?php
$subbind7_query=mysqli_query($link,"select sid, sname from tbl_subbin where plantcode =  '".$plantcode."' where plantcode = '".$plantcode."'order by sname") or die(mysqli_error($link));
?>	
...
<?php
//$whd8_query=mysqli_query($link,"select whid, perticulars from tbl_warehouse where plantcode =  '".$plantcode."' where perticulars='CS-01'  order by perticulars") or die(mysqli_error($link));
$whd8_query=mysqli_query($link,"select whid, perticulars from tbl_warehouse where plantcode =  '".$plantcode."' where plantcode = '".$plantcode."' order by perticulars") or die(mysqli_error($link));
?>
...
<?php
$bind8_query=mysqli_query($link,"select binid, binname from tbl_bin where plantcode =  '".$plantcode."' where plantcode = '".$plantcode."' order by binname") or die(mysqli_error($link));
?>
...
<?php
$subbind8_query=mysqli_query($link,"select sid, sname from tbl_subbin where plantcode =  '".$plantcode."' plantcode = '".$plantcode."' order by sname") or die(mysqli_error($link));
?>	
...
<?php
//$whd9_query=mysqli_query($link,"select whid, perticulars from tbl_warehouse where plantcode =  '".$plantcode."' where perticulars='CS-01' order by perticulars") or die(mysqli_error($link));
$whd9_query=mysqli_query($link,"select whid, perticulars from tbl_warehouse where plantcode =  '".$plantcode."' plantcode = '".$plantcode."' order by perticulars") or die(mysqli_error($link));
?>
...
<?php
$bind9_query=mysqli_query($link,"select binid, binname from tbl_bin where plantcode =  '".$plantcode."' plantcode = '".$plantcode."' order by binname") or die(mysqli_error($link));
?>
...
<?php
$subbind9_query=mysqli_query($link,"select sid, sname from tbl_subbin where plantcode =  '".$plantcode."' plantcode = '".$plantcode."' order by sname") or die(mysqli_error($link));
?>	
...
<?php
//if($rid=="CS-01")
//$whd10_query=mysqli_query($link,"select whid, perticulars from tbl_warehouse where plantcode =  '".$plantcode."' where perticulars='CS-01' order by perticulars") or die(mysqli_error($link));
$whd10_query=mysqli_query($link,"select whid, perticulars from tbl_warehouse where plantcode =  '".$plantcode."' plantcode = '".$plantcode."' order by perticulars") or die(mysqli_error($link));
?>
...
<?php
$bind10_query=mysqli_query($link,"select binid, binname from tbl_bin where plantcode =  '".$plantcode."' plantcode = '".$plantcode."' order by binname") or die(mysqli_error($link));
?>
...
<?php
$subbind10_query=mysqli_query($link,"select sid, sname from tbl_subbin where plantcode =  '".$plantcode."' plantcode = '".$plantcode."' order by sname") or die(mysqli_error($link));
?>	
...
$whd2_query=mysqli_query($link,"select whid, perticulars from tbl_warehouse where plantcode =  '".$plantcode."' plantcode = '".$plantcode."' order by perticulars") or die(mysqli_error($link));
?>
...
<?php
$bind2_query=mysqli_query($link,"select binid, binname from tbl_bin where plantcode =  '".$plantcode."' plantcode = '".$plantcode."' order by binname") or die(mysqli_error($link));
?>
...
<?php
$subbind2_query=mysqli_query($link,"select sid, sname from tbl_subbin where plantcode =  '".$plantcode."' plantcode = '".$plantcode."' order by sname") or die(mysqli_error($link));
?>	
...
<?php
//$whd3_query=mysqli_query($link,"select whid, perticulars from tbl_warehouse where plantcode =  '".$plantcode."' where perticulars='CS-01' order by perticulars") or die(mysqli_error($link));
$whd3_query=mysqli_query($link,"select whid, perticulars from tbl_warehouse where plantcode =  '".$plantcode."' plantcode = '".$plantcode."' order by perticulars") or die(mysqli_error($link));
?>
...
<?php
$bind3_query=mysqli_query($link,"select binid, binname from tbl_bin where plantcode =  '".$plantcode."' plantcode = '".$plantcode."' order by binname") or die(mysqli_error($link));
?>
...
<?php
//$whd4_query=mysqli_query($link,"select whid, perticulars from tbl_warehouse where plantcode =  '".$plantcode."' where perticulars='CS-01'  order by perticulars") or die(mysqli_error($link));
$whd4_query=mysqli_query($link,"select whid, perticulars from tbl_warehouse where plantcode =  '".$plantcode."' plantcode = '".$plantcode."' order by perticulars") or die(mysqli_error($link));
?>
...
<?php
$bind4_query=mysqli_query($link,"select binid, binname from tbl_bin where plantcode =  '".$plantcode."' plantcode = '".$plantcode."' order by binname") or die(mysqli_error($link));
?>
...
<?php
$subbind4_query=mysqli_query($link,"select sid, sname from tbl_subbin where plantcode =  '".$plantcode."' plantcode = '".$plantcode."' order by sname") or die(mysqli_error($link));
?>	
...
<?php
//$whd5_query=mysqli_query($link,"select whid, perticulars from tbl_warehouse where plantcode =  '".$plantcode."' where perticulars='CS-01'  order by perticulars") or die(mysqli_error($link));
$whd5_query=mysqli_query($link,"select whid, perticulars from tbl_warehouse where plantcode =  '".$plantcode."' plantcode = '".$plantcode."' order by perticulars") or die(mysqli_error($link));
?>
...
<?php
$bind5_query=mysqli_query($link,"select binid, binname from tbl_bin where plantcode =  '".$plantcode."' plantcode = '".$plantcode."' order by binname") or die(mysqli_error($link));
?>
...
<?php
$subbind5_query=mysqli_query($link,"select sid, sname from tbl_subbin where plantcode =  '".$plantcode."' plantcode = '".$plantcode."' order by sname") or die(mysqli_error($link));
?>	
...
<?php
//$whd6_query=mysqli_query($link,"select whid, perticulars from tbl_warehouse where plantcode =  '".$plantcode."' where perticulars='CS-01'  order by perticulars") or die(mysqli_error($link));
$whd6_query=mysqli_query($link,"select whid, perticulars from tbl_warehouse where plantcode =  '".$plantcode."' plantcode = '".$plantcode."' order by perticulars") or die(mysqli_error($link));
?>
...
<?php
$bind6_query=mysqli_query($link,"select binid, binname from tbl_bin where plantcode =  '".$plantcode."' plantcode = '".$plantcode."' order by binname") or die(mysqli_error($link));
?>
...
<?php
$subbind6_query=mysqli_query($link,"select sid, sname from tbl_subbin where plantcode =  '".$plantcode."' plantcode = '".$plantcode."' order by sname") or die(mysqli_error($link));
?>	
...
<?php
//$whd7_query=mysqli_query($link,"select whid, perticulars from tbl_warehouse where plantcode =  '".$plantcode."' where perticulars='CS-01'  order by perticulars") or die(mysqli_error($link));
$whd7_query=mysqli_query($link,"select whid, perticulars from tbl_warehouse where plantcode =  '".$plantcode."' plantcode = '".$plantcode."' order by perticulars") or die(mysqli_error($link));
?>
...
<?php
$bind7_query=mysqli_query($link,"select binid, binname from tbl_bin where plantcode =  '".$plantcode."' plantcode = '".$plantcode."' order by binname") or die(mysqli_error($link));
?>
...
<?php
$subbind7_query=mysqli_query($link,"select sid, sname from tbl_subbin where plantcode =  '".$plantcode."' plantcode = '".$plantcode."' order by sname") or die(mysqli_error($link));
?>	
...
<?php
//$whd10_query=mysqli_query($link,"select whid, perticulars from tbl_warehouse where plantcode =  '".$plantcode."' where perticulars='CS-01'  order by perticulars") or die(mysqli_error($link));
$whd10_query=mysqli_query($link,"select whid, perticulars from tbl_warehouse where plantcode =  '".$plantcode."' order by perticulars") or die(mysqli_error($link));
?>
