...
<table width="1003" height="600" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
 ...
 <?php
	$sql1=mysqli_query($link,"select * from tbl_sloc_csw where slid='".$pid."' WHERE plantcode = '".$plantcode."'")or die(mysqli_error($link));
	...
	$sql_sub=mysqli_query($link,"select * from tbl_sloc_csw_sub where slocid='".$pid."' WHERE plantcode = '".$plantcode."'")or die(mysqli_error($link));
