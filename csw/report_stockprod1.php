...
<table width="1003" height="600" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  ...
  <tr><td>
   ...
   $ccnntt=0;
	...
	$crp="ALL"; $ver="ALL";
	$qry="select distinct lotldg_lotno from tbl_lot_ldg where plantcode='".$plantcode."' and lotldg_sstage='Condition'";
	if($crop!="ALL")
	{	
...
$sql_is=mysqli_query($link,"select distinct lotldg_subbinid, lotldg_whid, lotldg_binid from tbl_lot_ldg where plantcode='".$plantcode."' and  lotldg_lotno='".$row_arr_home['lotldg_lotno']."' and lotldg_sstage='Condition' group by lotldg_subbinid order by lotldg_id asc") or die(mysqli_error($link));

while($row_is=mysqli_fetch_array($sql_is))
{ 
$sql_is1=mysqli_query($link,"select max(lotldg_id) from tbl_lot_ldg where plantcode='".$plantcode."' and  lotldg_subbinid='".$row_is['lotldg_subbinid']."' and lotldg_binid='".$row_is['lotldg_binid']."' and lotldg_whid='".$row_is['lotldg_whid']."' and lotldg_lotno='".$row_arr_home['lotldg_lotno']."' and lotldg_sstage='Condition'  order by lotldg_id asc ") or die(mysqli_error($link));
$row_is1=mysqli_fetch_array($sql_is1); 

$sql_istbl=mysqli_query($link,"select * from tbl_lot_ldg where plantcode='".$plantcode."' and  lotldg_id='".$row_is1[0]."' and lotldg_balqty > 0 and lotldg_sstage='Condition' order by lotldg_id asc") or die(mysqli_error($link)); 
...
if($sstate=="ALL")
$qry2="select * from tblarrival_sub where plantcode='".$plantcode."' and  lotcrop='".$crop."' and lotvariety='".$variety."' and orlot='".$orlot."'";
else
$qry2="select * from tblarrival_sub where plantcode='".$plantcode."' and  lotcrop='".$crop."' and lotvariety='".$variety."' and orlot='".$orlot."' and lotstate='".$sstate."'";
...
//echo "Select * from tblarrival where plantcode='".$plantcode."' and  arrival_id='".$row_rr['arrival_id']."' and arrival_date<='$edate' and arrival_date>='$sdate' and arrival_type='Fresh Seed with PDN'"."<br />";
$sql_arrmain=mysqli_query($link,"Select * from tblarrival where plantcode='".$plantcode."' and  arrival_id='".$row_rr['arrival_id']."' and arrival_date<='$edate' and arrival_date>='$sdate' and arrival_type='Fresh Seed with PDN'") or die(mysqli_error($link));
