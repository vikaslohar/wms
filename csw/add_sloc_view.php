...
$sql_subbinn=mysqli_query($link,"select sname from tbl_subbin where sid='".$row_tbl_sub['stlg_subbinid']."' and binid='".$row_tbl_sub['stlg_binid']."' and whid='".$row_tbl_sub['stlg_whid']."' AND plantcode='".$plantcode."'") or die(mysqli_error($link));
...
$sql_subbinn=mysqli_query($link,"select sname from tbl_subbin where sid='".$row_tbl_sub['stld_subbinid']."' and binid='".$row_tbl_sub['stld_binid']."' AND plantcode='".$plantcode."' and whid='".$row_tbl_sub['stld_whid']."'") or die(mysqli_error($link));
$row_subbinn=mysqli_fetch_array($sql_subbinn);
$subbinn=$row_subbinn['sname'];
...
$sql_subbinn=mysqli_query($link,"select sname from tbl_subbin where sid='".$row_sloc_sub['subbinid']."' and binid='".$row_sloc_sub['binid']."' AND plantcode='".$plantcode."' and whid='".$row_sloc_sub['whid']."'") or die(mysqli_error($link));
$row_subbinn=mysqli_fetch_array($sql_subbinn);
$subbinn=$row_subbinn['sname'];
