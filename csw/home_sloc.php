...
$sql_arr_home=mysqli_query($link,"select * from tbl_sloc_csw where supflg=1 and stage='Condition' order by scode desc LIMIT $from, $max_results") or die(mysqli_error($link));
$tot_arr_home=mysqli_num_rows($sql_arr_home);

$total_results3 =mysqli_query($link,"SELECT COUNT(*)  FROM tbl_sloc_csw where supflg=1");
