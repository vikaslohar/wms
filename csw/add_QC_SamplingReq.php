<?php
	...
	//exit;
		...
		$sql_main="insert into tbl_csw_main (year_code, arr_code, arrival_date, arr_role,plantcode)values('$yearid_id', '$txtid', '$tdate1', '$logid','$plantcode')";
		if(mysqli_query($link,$sql_main) or die(mysqli_error($link)))
		{
			...
			foreach($pl as $val)
			{
				if($val<>"")
				{
					$sql_sub="insert into tbl_csw (crop, variety, pp, moist, gemp, got, arr_role, lotno , arrival_id, arrival_date, arr_code,plantcode) values ('$txtcrop', '$txtvariety', '$chk1', '$chk2', '$chk3', '$chk4', '$logid', '$val', '$p_id', '$tdate1', '$dotage','$plantcode')";
...
<tr class="Dark" height="30">
 <?php
$quer3=mysqli_query($link,"SELECT cropid, cropname FROM tblcrop  where plantcode='".$plantcode."' order by cropname Asc");
