...
$age = $_REQUEST['age'];
	$qry="select * from tbl_lot_ldg where plantcode='".$plantcode."' and lotldg_sstage='Condition' ";
	if($age=="morethan60")
	{	
...
<title>CSW - Report - Coded Condition Seed Report </title>
...
<table align="center" border="0" cellspacing="0" cellpadding="0" width="750" style="border-collapse:collapse">
  	...
  	<tr height="25">
    <td align="center" class="subheading" style="color:#303918; ">Coded Condition Seed Report - As on Date: <?php echo date("d-m-Y");?></td>
  </tr>
</table>
