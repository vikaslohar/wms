<?php
	...
	/*$sql_code="SELECT MAX(gcode) FROM tbl_gtod  where plantcode='".$plantcode."' and  yearcode='$yearid_id' ORDER BY gcode DESC";
	...
	/*$sql_main="update tbl_gtod set gdflg=1, gcode=$code  where plantcode='".$plantcode."' and  gid = '$pid'";

	$a123456=mysqli_query($link,$sql_main) or die(mysqli_error($link));
*/
	/*$sql_main1="update tbl_ieindent set flg=1  where plantcode='".$plantcode."' and  tid = '$tid'";
...
<?php
$sql_tbl=mysqli_query($link,"select * from tbl_lot_ldg where plantcode='".$plantcode."' and  lotldg_trtype='CSWSUO' and lotldg_trid='".$pid."'") or die(mysqli_error($link));
...
<?php
$sql_tbl=mysqli_query($link,"select * from tbl_lot_ldg where plantcode='".$plantcode."' and  lotldg_trtype='CSWSUC' and lotldg_trid='".$pid."'") or die(mysqli_error($link));
...
<tr >
<td valign="top" align="center"><a href="home_sloc.php"><img src="../images/back.gif" border="0"style="display:inline;cursor:pointer;" /></a>&nbsp;&nbsp;&nbsp;
