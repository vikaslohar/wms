<?php
	...
	$datahead2= array("#","Lot No.","Raw Seed","","Condition Seed","","Pack Seed","","","","Sales Return","","Total","","Quality Status"); 
...
if($tqty > 0)
{
$data1[$d]=array($d,$lt2,$totrnob,$totrqty,$totcnob,$totcqty,$ups,$totpnob,$totpnomp,$totpqty,$totsrnob,$totsrqty,$tnob,$tqty,$gemp,$qcresult,$dot,$gotresult,$dogr); 
$d++;
}
}
}
