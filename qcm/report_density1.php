...
<title>QC Manager - Report - Periodical Density Report</title>
...
<table width="1003" height="600" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  ...
  <tr><td>
   <?php
	...
	$tot_arr_home=0;//mysqli_num_rows($sql_arr_home1);
?>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#d21704" >
...
<tr class="tblsubtitle" height="20">
            <!--<td width="70" align="center" valign="middle" class="smalltblheading" rowspan="2">#</td>-->
			<td width="107"  align="center" valign="middle" class="smalltblheading" rowspan="2">Crop</td>
			<td width="102" rowspan="2" align="center" valign="middle" class="smalltblheading">Variety</td>
			 <td width="98" rowspan="2" align="center" valign="middle" class="smalltblheading">Lot No.</td>
			 <td width="36" rowspan="2"  align="center" valign="middle" class="smalltblheading">NoB</td>
			 <td width="42" rowspan="2" align="center" valign="middle" class="smalltblheading">Qty</td>
			 <td align="center" valign="middle" class="smalltblheading" colspan="2">Sample weight</td>
			 <td width="53" rowspan="2" align="center" valign="middle" class="smalltblheading">Avg cond sample wt</td>
			 <td width="52" rowspan="2" align="center" valign="middle" class="smalltblheading">% of good seed</td>
			 <td width="56" rowspan="2" align="center" valign="middle" class="smalltblheading">Wt of Good seed in sample</td>
			 <td width="48" rowspan="2" align="center" valign="middle" class="smalltblheading">Good Seed %</td>
			 <td width="41" rowspan="2" align="center" valign="middle" class="smalltblheading">Rem %</td>
			 <td align="center" valign="middle" class="smalltblheading" colspan="4">Actual Processing</td>
</tr>	
<tr class="tblsubtitle" height="20">		 
			 <td width="56" align="center" valign="middle" class="smalltblheading">500 ml Sample Wt.(g) - Raw</td>
			 <td width="64" align="center" valign="middle" class="smalltblheading">500 ml Sample Wt.(g) - Condition</td>
			 <td width="39" align="center" valign="middle" class="smalltblheading">Qty</td>
