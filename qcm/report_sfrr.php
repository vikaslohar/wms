<?php
	...
	if(isset($_POST['frm_action'])=='submit')
	{
		...
		$status = $_REQUEST['txtqcstatus'];
		$sftyp = $_REQUEST['sftyp'];
		$sdate=trim($_POST['sdate']);
		$edate=trim($_POST['edate']);
		$ddate=trim($_POST['ddate']);
		
		echo "<script>window.location='report_sfr1.php?sdate=$sdate&edate=$edate&ddate=$ddate&txtcrop=$cid&txtvariety=$itemid&qcstatus=$status&sftyp=$sftyp'</script>";
...
<title>Report - Soft Release Status Report</title>
<link href="../include/main_quality.css" rel="stylesheet" type="text/css" />
<link href="../include/vnrtrac_quality.css" rel="stylesheet" type="text/css" />
</head>
<script src="../qc/vaddresschk22.js"></script>
...
{ 
	...
	if(document.frmaddDepartment.sftyp.value=="")
	{
		alert("Select Report Type");
		//document.frmaddDepartment.sftyp.focus();
		return false;
	}
	if(document.frmaddDepartment.sftyp.value=="periodical")
	{
...
function srtchk(sfrval)
{
	if(sfrval!="")
	{
		if(sfrval=="ason")
		{
			document.getElementById('asond').style.display="block";
			document.getElementById('peri').style.display="none";
			document.frmaddDepartment.sftyp.value=sfrval;
		}
		else
		{
			document.getElementById('peri').style.display="block";
			document.getElementById('asond').style.display="none";
			document.frmaddDepartment.sftyp.value=sfrval;
		}
	}
	else
	{
		document.getElementById('peri').style.display="none";
		document.getElementById('asond').style.display="none";
		document.frmaddDepartment.sftyp.value="";
	}
}
</script>
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#d21704" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#d21704" style="border-bottom:solid; border-bottom-color:#d21704" >
	    <tr >
	      <td width="813" height="30"class="Mainheading"> Soft Release Status Report</td>
	    </tr></table></td>
	  </tr>
	  </table></td></tr>
	  ...
	  <form name="frmaddDepartment" method="post" action="<?php $_SERVER['../qc/PHP_SELF']; ?>" > 
...
<table align="center" border="1" width="574" cellspacing="0" cellpadding="0" bordercolor="#d21704" style="border-collapse:collapse" >
                <tr class="tblsubtitle" height="25">
                  <td colspan="4" align="center" class="tblheading">Soft Release Status Report</td>
                </tr>
<tr height="15">
...
<td align="right" width="50%" valign="middle" class="tblheading">Crop&nbsp;</td>
<td align="left" valign="middle" class="tbltext" colspan="3" >&nbsp;<select class="tbltext" name="txtcrop" style="width:170px;" onChange="modetchk(this.value)">
...
?>
    ...
    <td align="left"  valign="middle" class="tbltext" id="vitem" colspan="3">&nbsp;<select class="tbltext" id="itm" name="txtvariety" style="width:170px;" >
        <option value="ALL" selected>--ALL-</option>
...
<tr class="Light" height="25">
    ...
    <td align="left"  valign="middle" class="tbltext" colspan="3">&nbsp;<select class="tbltext" id="itm" name="txtqcstatus" style="width:170px;" onchange="chk()">
        <option value="ALL" selected>--ALL--</option>
        <option value="fail" >Fail</option>
		<option value="RT/UT" >RT/UT</option>
		<option value="ok" >OK</option></select></td>
</tr>				
				
<tr height="15">
     <td align="right" class="tblheading"><input type="radio" name="srtype" value="ason" onclick="srtchk(this.value);" /></td>
	 <td align="left" class="tblheading">&nbsp;As on Date</td>
</tr>
<tr height="15">
     <td align="right" class="tblheading"><input type="radio" name="srtype" value="periodical" onclick="srtchk(this.value);" /></td>
	 <td align="left" class="tblheading">&nbsp;Periodical</td>
</tr>
</table>
...
<tr class="Dark" height="25">
                  ...
                  <td width="91" align="right"  valign="middle" class="tblheading">&nbsp;To&nbsp;</td>
...
<div id="asond" style="display:none"> 
 <table align="center" border="1" width="574" cellspacing="0" cellpadding="0" bordercolor="#2e81c1" style="border-collapse:collapse" >
<tr class="Dark" height="25">
                  <td width="50%" height="30" align="right" valign="middle" class="tblheading">&nbsp;As on Date&nbsp;</td>
                  <td align="left"  valign="middle" >&nbsp;
                    <input name="ddate" id="ddate" type="text" size="10" class="tbltext" tabindex="0" readonly="true"  value="<?php echo date("d-m-Y", time());?>" style="background-color:#EFEFEF" />&nbsp;</td>
 </tr>
</table>
</div>
                <table width="574" align="center" cellpadding="5" cellspacing="5" border="0" >
                  <tr >
                    <td valign="top" align="center"><input name="Submit" type="image" src="../images/submit_1.gif" alt="Submit Value"  border="0" style="display:inline;cursor:pointer;" onClick="return mySubmit();" />
						...
						<input type="hidden" name="sftyp" value="" />
