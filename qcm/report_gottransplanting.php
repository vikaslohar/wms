<?php
	...
	if(isset($_POST['frm_action'])=='submit')
	{
		...
		echo "<script>window.location='report_gottransplanting1.php?sdate=$sdate&edate=$edate&txtcrop=$cid&txtvariety=$itemid'</script>";
	}
?>
...
<title>Quality-Report - Pending GOT Report - Lot Transplantation Pending</title>
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#d21704" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#d21704" style="border-bottom:solid; border-bottom-color:#d21704" >
	    <tr >
	      <td width="813" height="30"class="Mainheading"  >&nbsp;Report - Pending GOT Report - Lot Transplantation Pending</td>
	    </tr></table></td>
	  </tr>
	  </table></td></tr>
...
<table align="center" border="1" width="550" cellspacing="0" cellpadding="0" bordercolor="#d21704" style="border-collapse:collapse" >
                <tr class="tblsubtitle" height="25">
                  <td colspan="4" align="center" class="tblheading">Pending GOT Report - Lot Transplantation Pending</td>
                </tr>
                <tr height="15">
