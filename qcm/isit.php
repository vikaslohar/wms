  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" style="border-bottom:solid; border-bottom-color:#d21704" >
	    <tr >
	      <td width="813" height="25" class="Mainheading">&nbsp;Internal Sample,Internal Test -ISIT </td>
	    </tr></table></td>
...
<tr class="tblsubtitle" height="20">
  <td colspan="6" align="center" class="tblheading">ISIT- Volmtary </td>
</tr>
...
<td width="154" align="right" valign="middle" class="tblheading">&nbsp; Transaction Date  &nbsp;</td>
<td width="206" align="left" valign="middle" class="tbltext">&nbsp;<input name="sdate" id="sdate" type="text" size="10" class="tbltext" tabindex="0" readonly="true"  value="<?php echo date("d-m-Y", time());?>" style="background-color:#EFEFEF" />&nbsp;<a href="javascript:void(0)" onClick="imgOnClick(document.frmaddDepartment.sdate,-100,-100)" tabindex="6"><img src="../images/cal.gif" alt="Calender" border="0" align="absmiddle"></a><script type="text/javascript" language="javascript" src="../include/popcalender.js"></script> &nbsp;<font color="#FF0000" >*</font>&nbsp;</td>
</tr>
 <tr class="Dark" height="30">
<td width="205" align="right" valign="middle" class="tblheading">DEB   &nbsp;</td>
<td width="275"  align="left" valign="middle" class="tbltext">&nbsp;<input name="sdate" id="sdate" type="text" size="10" class="tbltext" tabindex="0" readonly="true"  value=""  />&nbsp;<a href="javascript:void(0)" onClick="imgOnClick(document.frmaddDepartment.sdate,-100,-100)" tabindex="6"></a>
  <script type="text/javascript" language="javascript" src="../include/popcalender.js"></script> &nbsp;<font color="#FF0000" >*</font></td>

<td width="154" align="right" valign="middle" class="tblheading">&nbsp;Crop&nbsp;</td>
<td width="206" align="left" valign="middle" class="tbltext">&nbsp;<select name="txtuom" class="tbltext"  style="width:170px;" tabindex="" onChange="f2(this.value);">
...
?>
<tr class="Dark" height="30">
<td width="205" align="right" valign="middle" class="tblheading">Variety   &nbsp;</td>
<td width="275"  align="left" valign="middle" class="tbltext">&nbsp;<select name="txtuom" class="tbltext"  style="width:120px;" tabindex="" onChange="f2(this.value);">
		<option value="">---Select Variety--</option>
		<option value="NOT tested">Not tested</option>
		<option value="accept">Acceptabel</option>
		<option value="naccept">Not acceptaable</option>
		</select>&nbsp;&nbsp;<font color="#FF0000" >*</font><a href="Javascript:void();" onclick="openslocpop();">LOt No.</a></td>

<td width="154" align="right" valign="middle" class="tblheading">Stage&nbsp;</td>
<td width="206" align="left" valign="middle" class="tbltext">&nbsp;<select name="txtuom" class="tbltext"  style="width:170px;" tabindex="" onChange="f2(this.value);">
		...
		<option value="naccept">Not acceptaable</option>
		   ...
		   <tr class="tblsubtitle" height="20">
  <td colspan="4" align="center" class="tblheading">Select Test </td>
</tr>
...
<td align="right"  valign="middle" class="tblheading"><input name="txtlot"  type="checkbox"size="10" class="tbltext" tabindex="" maxlength="5" onkeypress="return isNumberKey(event)" onchange="itemcheck();"  />  &nbsp;</td>
<td align="left"  valign="middle" class="tbltext" >&nbsp;Genetic Family &nbsp;&nbsp;</td>
<td align="right"  valign="middle" class="tblheading"><input name="txtlot"  type="checkbox"size="10" class="tbltext" tabindex="" maxlength="5" onkeypress="return isNumberKey(event)" onchange="itemcheck();"  />  &nbsp;</td>
    <td align="left"  valign="middle" class="tbltext">&nbsp;GP- DNA </td>
           </tr>
		   <tr class="Light" height="30">
 <?php
//$quer3=mysqli_query($link,"SELECT p_id, business_name FROM tbl_partymaser  where classification='Stock Transfer'"); 
...
<td align="right"  valign="middle" class="tblheading"><input name="txtlot"  type="checkbox"size="10" class="tbltext" tabindex="" maxlength="5" onkeypress="return isNumberKey(event)" onchange="itemcheck();"  />  &nbsp;</td>
<td align="left"  valign="middle" class="tbltext" >&nbsp;Germination</td>
<td align="right"  valign="middle" class="tblheading">&nbsp;<input name="txtlot"  type="checkbox"size="10" class="tbltext" tabindex="" maxlength="5" onkeypress="return isNumberKey(event)" onchange="itemcheck();"  /></td>
    <td align="left"  valign="middle" class="tbltext">&nbsp;Moisture</td>
           </tr>
		   <tr class="Light" height="30">
 <?php
//$quer3=mysqli_query($link,"SELECT p_id, business_name FROM tbl_partymaser  where classification='Stock Transfer'"); 
...
<td align="right"  valign="middle" class="tblheading"><input name="txtlot"  type="checkbox"size="10" class="tbltext" tabindex="" maxlength="5" onkeypress="return isNumberKey(event)" onchange="itemcheck();"  />  &nbsp;</td>
<td align="left"  valign="middle" class="tbltext" >&nbsp;Physical Purity </td>
	<td align="right"  valign="middle" class="tblheading">&nbsp;<input name="txtlot"  type="checkbox"size="10" class="tbltext" tabindex="" maxlength="5" onkeypress="return isNumberKey(event)" onchange="itemcheck();"  /></td>
    <td align="left"  valign="middle" class="tbltext">&nbsp;Vigour Test</td>
           </tr>
		   <tr class="Light" height="30">
 <?php
//$quer3=mysqli_query($link,"SELECT p_id, business_name FROM tbl_partymaser  where classification='Stock Transfer'"); 
...
<td align="right"  valign="middle" class="tblheading"><input name="txtlot"  type="checkbox"size="10" class="tbltext" tabindex="" maxlength="5" onkeypress="return isNumberKey(event)" onchange="itemcheck();"  />  &nbsp;</td>
<td align="left"  valign="middle" class="tbltext" >&nbsp;Guard Sample Reqd </td>
	<td align="right"  valign="middle" class="tblheading">&nbsp;&nbsp;<input name="txtlot"  type="checkbox"size="10" class="tbltext" tabindex="" maxlength="5" onkeypress="return isNumberKey(event)" onchange="itemcheck();"  /></td>
    <td align="left"  valign="middle" class="tbltext">&nbsp;Conti Germi Sample Req </td>
           </tr>
		   <tr class="Light" height="30">
 <?php
//$quer3=mysqli_query($link,"SELECT p_id, business_name FROM tbl_partymaser  where classification='Stock Transfer'"); 
...
<td align="right"  valign="middle" class="tblheading"> No. Of Sample &nbsp;</td>
<td align="left"  valign="middle" class="tbltext" >&nbsp;<input name="sdate" id="sdate" type="text" size="10" class="tbltext" tabindex="0" readonly="true"  value="" style="background-color:#EFEFEF" />&nbsp;</td>
...
<tr >
<td valign="top" align="Center"><a href="add_arrival_stocktransfer2.php" tabindex="20"></a>&nbsp;&nbsp;
  <input name="Submit" type="image" src="../images/Next.gif" alt="Submit Value"  border="0" style="display:inline;cursor:hand;" tabindex="" onClick="return mySubmit();">&nbsp;&nbsp;</td>
</tr>
</table>-->
		 <table align="center" border="1" width="850" cellspacing="0" cellpadding="0" bordercolor="#d21704" style="border-collapse:collapse" > 
...
<td align="right"  valign="middle" class="tblheading">Actual Sample Qty &nbsp;</td>
<td align="left"  valign="middle" class="tbltext" >&nbsp;<select name="txtuom" class="tbltext"  style="width:170px;" tabindex="" onChange="f2(this.value);">
		...
		<option value="NOT tested">Present</option>
		<option value="accept">Absent</option>
		<option value="naccept">insignificant</option>
		</select>&nbsp;</td>
    ...
    <td align="left"  valign="middle" class="tbltext">&nbsp;<input name="sdate" id="sdate" type="text" size="10" class="tbltext" tabindex="0" readonly="true"  value="<?php echo date("d-m-Y", time());?>" style="background-color:#EFEFEF" />&nbsp;<a href="javascript:void(0)" onClick="imgOnClick(document.frmaddDepartment.sdate,-100,-100)" tabindex="6"><img src="../images/cal.gif" alt="Calender" border="0" align="absmiddle"></a><script type="text/javascript" language="javascript" src="../include/popcalender.js"></script> &nbsp;<font color="#FF0000" >*</font>&nbsp;</td>
         ...
         <table align="center" width="850" cellpadding="5" cellspacing="5" border="0" >
<tr >
<td valign="top" align="Center"><a href="add_arrival_stocktransfer2.php" tabindex="20"><img src="../images/submit.gif" border="0"style="display:inline;cursor:hand;" onclick="return confirm('Do You wish to Cancel this Transaction?');" /></a>&nbsp;&nbsp;<input name="Submit" type="image" src="../images/Next.gif" alt="Submit Value"  border="0" style="display:inline;cursor:hand;" tabindex="" onClick="return mySubmit();">&nbsp;&nbsp;</td>
</tr>
</table>
</td><td width="30"></td>
</tr>
