	...
	{	
		...
		while($row_sub=mysqli_fetch_array($sql_sub))
		{
			if($lottype=="Regular")
			{
				...
				$sql_sub_upd="Insert into tbl_lotmgen (lotmgen_lot, lotmgen_lotno, lotmgen_orlot, lotmgen_yearcode, lotmgen_yearid, lotmgen_logid, lotmgen_wyearcode) values ('$lot_code', '$lotnonew', '$lotnoornew', '$yer', '$yer2', '$logid', '$yearid_id')";
