<?php
	...
	{ 
		$ids=trim($_POST['foccode']);
		$typ=trim($_POST['typ']);
		//exit;	
		echo "<script>window.location='home_aging1.php?ids=$ids&typ=$typ'</script>";
...
function typchk(typ)
{
document.frmaddDept.typ.value=typ;
}
function postval()
{
	document.frmaddDept.foccode.value="";
	if(document.frmaddDept.srno.value > 1)
	{
...
{	
	if(document.frmaddDept.foccode.value=="")
	{
	alert("Please select Lot(s) for Dispose OR Extension.");
	return false;
	}
	if(document.frmaddDept.typ.value=="")
	{
	alert("Please select Dispose OR Extend.");
	return false;
	}
return true;
}
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#d21704" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#d21704" style="border-bottom:solid; border-bottom-color:#d21704" >
	    <tr >
	      <td width="940" height="25" class="Mainheading">&nbsp;Transaction - Guard Sample Ageing </td>
	    </tr></table></td>
...
<?php
 $sql_arr_home=mysqli_query($link,"select * from tbl_gsample where gsdisflg=0 order by arrivaldate asc") or die(mysqli_error($link));
 $tot_arr_home=mysqli_num_rows($sql_arr_home);
 if($tot_arr_home >0) { 
?>
<table align="center" border="0" cellspacing="0" cellpadding="0" width="850" style="border-collapse:collapse">
	<tr height="15"><td colspan="6" align="right" class="tblheading"> <a href="javascript:void(0)" onclick="selectall()">Check  All</a>&nbsp;&nbsp;<a href="javascript:void(0)" onclick="unselectall()">Clear  All</a></td>
  	</tr>
</table>
<table align="center" border="1" cellspacing="0" cellpadding="0" width="850" bordercolor="#d21704" style="border-collapse:collapse">
            ...
            <tr class="tblsubtitle" height="20">
              ...
              <td width="74" align="center" valign="middle" class="tblheading">Select<br />Disp/Ext.</td>
              </tr>
<?php
$srno=1;
...
<tr class="Light">
		 ...
		 <td width="74" align="center" valign="middle" class="tblheading"><input type="checkbox" name="foc" value="<?php echo $row_arr_home['gsid'];?>" <?php if($ids!="") { $zzz=explode(",",$ids);
foreach($zzz as $val)
{
if($val<>"")
{ 
if($row_arr_home['gsid']==$val) echo "checked";
}
}
}?>/></td>
</tr>
...
<table align="center" border="1" cellspacing="0" cellpadding="0" width="850" bordercolor="#d21704" style="border-collapse:collapse">
            ...
            <tr class="light" height="20">
              <td width="50%"align="right" valign="middle" class="tblheading">Select&nbsp;&nbsp;</td>
			   <td align="left" valign="middle" class="tblheading"><input type="radio" name="txttyp" value="dispose" onclick="typchk(this.value);" <?php if($typ=="dispose") echo "checked";?> />Dispose&nbsp;&nbsp;<input type="radio" name="txttyp" value="extend" onclick="typchk(this.value);" <?php if($typ=="extend") echo "checked";?> />Extend<font color="#FF0000">*</font>&nbsp;</td>
              </tr>
</table>			  
<table align="center" width="850" cellpadding="5" cellspacing="5" border="0" >
<tr >
<td valign="top" align="right"><input name="Submit" type="image" src="../images/next.gif" alt="Submit Value"  border="0" style="display:inline;cursor:pointer;" onClick="postval();"><input type="hidden" name="foccode" value="" />
...
<table align="center" border="1" cellspacing="0" cellpadding="0" width="850" bordercolor="#d21704" style="border-collapse:collapse">
            ...
            <tr class="light" height="20">
              <td align="center" valign="middle" class="tblheading" colspan="2">Record(s) not found</td>
              </tr>
</table>
<?php
}
