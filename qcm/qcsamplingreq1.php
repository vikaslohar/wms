<?php
	...
	//exit;
	 $p_id=trim($_POST['maintrid']);
		...
		echo "<script>window.location='add_qc_preview.php?cropid=$p_id&txtvariety=$txtvariety&txtcrop=$txtcrop&date=$date'</script>";	
...
<table align="center" border="1" cellspacing="0" cellpadding="0" width="850" bordercolor="#d21704" style="border-collapse:collapse">
    ...
    <td width="9%" align="center" valign="middle" class="tblheading">Variety</td>
			  <td width="12%" align="center" valign="middle" class="tblheading">Lot No. </td>
			  <td width="11%" align="center" valign="middle" class="tblheading">NoB</td>
              <td width="11%" align="center" valign="middle" class="tblheading">Qty</td>
			  <td width="12%" align="center" valign="middle" class="tblheading">Stage</td> 
