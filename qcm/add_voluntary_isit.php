...
<title>Qty- Transaction - Fresh Arrival With PDN</title>
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#d21704" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#d21704" style="border-bottom:solid; border-bottom-color:#d21704" >
	    <tr >
	      <td width="813" height="25" class="Mainheading">&nbsp; ISIT Voluntary Transaction</td>
	    </tr></table></td>
...
<tr class="tblsubtitle" height="20">
  <td colspan="6" align="center" class="tblheading">Add New ISIT </td>
</tr>
...
<td align="right"  valign="middle" class="tblheading">Stage&nbsp;</td>
    <td align="left"  valign="middle" class="tbltext">&nbsp;<select class="tbltext" id="itm" name="txtvariety" style="width:170px;" >
<option value="" selected>--Select Variety-</option>
	<?php while($noticia_item = mysqli_fetch_array($sql_month)) { ?>
		<option value="<?php echo $noticia_item['varietyid'];?>" />   
		<?php echo $noticia_item['popularname'];?>
      ...
      &nbsp;<font color="#FF0000">*</font>&nbsp;</td>
		   		   ...
		   		   <tr class="tblsubtitle" height="20">
  <td colspan="4" align="center" class="tblheading"> Select Tests </td>
</tr>
		   <tr class="Light" height="30">
 <?php
//$quer3=mysqli_query($link,"SELECT p_id, business_name FROM tbl_partymaser  where classification='Stock Transfer'"); 
...
<td align="right"  valign="middle" class="tblheading">Guard Sample Requires &nbsp;</td>
<td align="left"  valign="middle" class="tbltext" >&nbsp;<input name="txtstfp" type="text" size="10" class="tbltext" tabindex=""   maxlength="5" onkeypress="return isNumberKey(event)" onchange="upschk(this.value);"/>&nbsp;</td>
	<td align="right"  valign="middle" class="tblheading">Conti Germi Sample Req  &nbsp;</td>
<td align="left"  valign="middle" class="tbltext" >&nbsp;<input name="txtstfp" type="text" size="10" class="tbltext" tabindex=""   maxlength="5" onkeypress="return isNumberKey(event)" onchange="upschk(this.value);"/>&nbsp;</td>
           </tr>
		   <tr class="Light" height="30">
 <?php
...
<td align="right"  valign="middle" class="tblheading"> No. Of Samples &nbsp;</td>
...
<td align="left"  valign="middle" class="tbltext" colspan="3">&nbsp;1<input name="txtstfp" type="text" size="10" class="tbltext" tabindex=""   maxlength="5" onkeypress="return isNumberKey(event)" onchange="upschk(this.value);"/>&nbsp;2<input name="txtstfp" type="text" size="10" class="tbltext" tabindex=""   maxlength="5" onkeypress="return isNumberKey(event)" onchange="upschk(this.value);"/>&nbsp;3<input name="txtstfp" type="text" size="10" class="tbltext" tabindex=""   maxlength="5" onkeypress="return isNumberKey(event)" onchange="upschk(this.value);"/>
&nbsp;gm</td>
           </tr>
		   <tr class="Light" height="30">
 <?php
