<?php
	...
	if(isset($_POST['frm_action'])=='submit')
	{
		...
		if($sdate!="" && $edate!="")
		{
			echo "<script>window.location='report_blending1.php?sdate=$sdate&edate=$edate&txtcrop=$cid&txtvariety=$itemid&txtvertype=$txtvertype'</script>";
		}
		else
		{?>
		 <script>
...
<script src="blendingrep.js"></script>
<!--- Calender code --->
...
{ 
	...
	if(document.frmaddDepartment.txtvertype.value == "")
	{
...
{	
	var vertyp=document.frmaddDepartment.txtvertype.value;
	showUser(classval,'vitem','item',vertyp,'','','','');
}
...
{	
	...
	else
	{
		...
		showUser(cropval,'vitem','item',classval,'','','','');
	}
}
</script>
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#d21704" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#d21704" style="border-bottom:solid; border-bottom-color:#d21704" >
	    <tr >
	      <td width="813" height="30"class="Mainheading"  >Periodical Blending Report</td>
	    </tr></table></td>
	  </tr>
	  </table></td></tr>
          ...
          <tr>
            ...
            <td><table align="center" border="1" width="600" cellspacing="0" cellpadding="0" bordercolor="#d21704" style="border-collapse:collapse" >
                <tr class="tblsubtitle" height="25">
                  <td colspan="4" align="center" class="tblheading">Periodical Blending Report</td>
                </tr>
                <tr height="15">
                ...
                <!--<tr class="Dark" height="25">
                  <td width="26%" height="30" align="right" valign="middle" class="tblheading">&nbsp;Period&nbsp;&raquo;&nbsp;&nbsp;&nbsp;From&nbsp;</td>
                  <td width="20%" align="left"  valign="middle" >&nbsp;<input name="sdate" id="sdate" type="text" size="10" class="tbltext" tabindex="0" readonly="true"  value="<?php echo date("d-m-Y", time());?>" style="background-color:#EFEFEF" />&nbsp;<a href="javascript:void(0)" onClick="showCalendar(sdate);" tabindex="6"><img src="../images/cal.gif" border="0" align="absmiddle" /></a>&nbsp;<font color="#FF0000" >*</font></td>
                  <td width="16%" align="right"  valign="middle" class="tblheading">&nbsp;To&nbsp;</td>
                  <td width="38%" align="left"  valign="middle" >&nbsp;<input name="edate" id="edate" type="text" size="10" class="tbltext" tabindex="0" readonly="true"  value="<?php echo date("d-m-Y", time());?>" style="background-color:#EFEFEF" />&nbsp;<a href="javascript:void(0)" onClick="showCalendar(edate);" tabindex="6"><img src="../images/cal.gif" border="0" align="absmiddle" /></a>&nbsp;<font color="#FF0000" >*</font></td>
</tr>-->
<?php
...
<tr class="Light" height="25">
<td align="right"  valign="middle" class="tblheading" colspan="2">Variety Type&nbsp;</td>
<td align="left"  valign="middle" class="tbltext" colspan="2" >&nbsp;<select class="tbltext" name="txtvertype" style="width:170px;" onChange="modetchk5(this.value)">
