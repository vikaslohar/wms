  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" style="border-bottom:solid; border-bottom-color:#d21704" >
	    <tr >
	      <td width="813" height="25" class="Mainheading">&nbsp; QC Test</td>
	    </tr></table></td>
...
<tr class="tblsubtitle" height="20">
  <td colspan="6" align="center" class="tblheading">Physical Purity Test </td>
</tr>
<tr height="15"><td colspan="6" align="right" class="tblheading"><font color="#FF0000" >* </font>indicates required field&nbsp;</td></tr>

 <tr class="Dark" height="30">
<td width="205" align="right" valign="middle" class="tblheading">Date Of Sampling   &nbsp;</td>
<td width="275"  align="left" valign="middle" class="tbltext">&nbsp;<input name="sdate" id="sdate" type="text" size="10" class="tbltext" tabindex="0" readonly="true"  value="<?php echo date("d-m-Y", time());?>" style="background-color:#EFEFEF" />&nbsp;<a href="javascript:void(0)" onClick="imgOnClick(document.frmaddDepartment.sdate,-100,-100)" tabindex="6"><img src="../images/cal.gif" alt="Calender" border="0" align="absmiddle"></a><script type="text/javascript" language="javascript" src="../include/popcalender.js"></script> &nbsp;<font color="#FF0000" >*</font></td>

<td width="154" align="right" valign="middle" class="tblheading">&nbsp;Date  OF Test&nbsp;</td>
...
<td align="right"  valign="middle" class="tblheading">Qty Of Sample &nbsp;</td>
 <td align="left"  valign="middle" class="tbltext" colspan="3" >&nbsp;<input name="lotno" type="text" size="10" class="tbltext" tabindex="0" readonly="true"   value="" maxlength="10"/>&nbsp;gms</td>
</tr>
		   <tr class="tblsubtitle" height="20">
  <td colspan="4" align="center" class="tblheading">Quantative</td>
</tr>
...
<td align="right"  valign="middle" class="tblheading">Infection&nbsp;</td>
<td align="left"  valign="middle" class="tbltext" >&nbsp;<input name="txtcrop" type="text" size="20" class="tbltext" tabindex=""    maxlength="20" onchange="vendorchk();"/>&nbsp;gms<font color="#FF0000">*</font>&nbsp;</td>
	<td align="right"  valign="middle" class="tblheading">Broker&nbsp;</td>
    <td align="left"  valign="middle" class="tbltext">&nbsp;<input name="txtvariety" type="text" size="20" class="tbltext" tabindex=""    maxlength="20" onchange="vendorchk();"/>&nbsp;gms<font color="#FF0000">*</font>&nbsp;</td>
           </tr>
		   <tr class="Light" height="30">
 <?php
//$quer3=mysqli_query($link,"SELECT p_id, business_name FROM tbl_partymaser  where classification='Stock Transfer'"); 
...
<td align="right"  valign="middle" class="tblheading">Infesiation&nbsp;</td>
<td align="left"  valign="middle" class="tbltext" >&nbsp;<input name="txtcrop" type="text" size="20" class="tbltext" tabindex=""    maxlength="20" onchange="vendorchk();"/>&nbsp;gms<font color="#FF0000">*</font>&nbsp;</td>
	<td align="right"  valign="middle" class="tblheading">Insert Matter &nbsp;</td>
    <td align="left"  valign="middle" class="tbltext">&nbsp;<input name="txtvariety" type="text" size="20" class="tbltext" tabindex=""    maxlength="20" onchange="vendorchk();"/>&nbsp;gms<font color="#FF0000">*</font>&nbsp;</td>
           </tr>
		  
		   <tr class="tblsubtitle" height="20">
  <td colspan="4" align="center" class="tblheading">Qualtative</td>
</tr>
		   <tr class="Light" height="30">
 <?php
//$quer3=mysqli_query($link,"SELECT p_id, business_name FROM tbl_partymaser  where classification='Stock Transfer'"); 
...
<td align="right"  valign="middle" class="tblheading">Color&nbsp;</td>
<td align="left"  valign="middle" class="tbltext" >&nbsp;<select name="txtuom" class="tbltext"  style="width:170px;" tabindex="" onChange="f2(this.value);">
	...
	<td align="right"  valign="middle" class="tblheading"> Shape&nbsp; </td>
    <td align="left"  valign="middle" class="tbltext">&nbsp;<select name="txtuom" class="tbltext"  style="width:170px;" tabindex="" onChange="f2(this.value);">
		<option value="">---Select Color--</option>
		<option value="NOT tested">Not tested</option>
		<option value="accept">Acceptabel</option>
...
<td align="right"  valign="middle" class="tblheading">Size &nbsp;</td>
<td align="left"  valign="middle" class="tbltext" >&nbsp;<select name="txtuom" class="tbltext"  style="width:170px;" tabindex="" onChange="f2(this.value);">
		<option value="">---Select Color--</option>
		<option value="NOT tested">Not tested</option>
		<option value="accept">Acceptabel</option>
	...
	<td align="right"  valign="middle" class="tblheading">Roubustness</td>
    <td align="left"  valign="middle" class="tbltext">&nbsp;<select name="txtuom" class="tbltext"  style="width:170px;" tabindex="" onChange="f2(this.value);">
		<option value="">---Select Robustness--</option>
		<option value="NOT tested">Noramal</option>
		<option value="accept">Shriveled</option>
		<option value="naccept">Wrinkled</option>
		</select></td>
           </tr>
		   <tr class="Light" height="30">
 <?php
...
<td align="right"  valign="middle" class="tblheading">Crack&nbsp;</td>
<td align="left"  valign="middle" class="tbltext" >&nbsp;<select name="txtuom" class="tbltext"  style="width:170px;" tabindex="" onChange="f2(this.value);">
	...
	<td align="right"  valign="middle" class="tblheading">Not Visible seeds&nbsp;</td>
    <td align="left"  valign="middle" class="tbltext">&nbsp;<select name="txtuom" class="tbltext"  style="width:170px;" tabindex="" onChange="f2(this.value);">
		<option value="">---Select Crack-</option>
		<option value="NOT tested">Present</option>
		<option value="accept">Absent</option>
...
<td align="right"  valign="middle" class="tblheading">Deformity&nbsp;</td>
<td align="left"  valign="middle" class="tbltext" >&nbsp;<select name="txtuom" class="tbltext"  style="width:170px;" tabindex="" onChange="f2(this.value);">
		<option value="">---Select Crack-</option>
		<option value="NOT tested">Present</option>
		<option value="accept">Absent</option>
				</select></td>
	<td align="right"  valign="middle" class="tblheading">Others&nbsp;</td>
...
<td align="left"  valign="middle" class="tbltext"  colspan="3">&nbsp;<input name="txtlot"   type="radio" size="10" class="tbltext" tabindex="" maxlength="5" onkeypress="return isNumberKey(event)" onchange="itemcheck();"  />&nbsp;Acceptable&nbsp;<input name="txtlot"   type="radio" size="10" class="tbltext" tabindex="" maxlength="5" onkeypress="return isNumberKey(event)" onchange="itemcheck();"  />&nbsp; Not Acceptable</td>
           </tr>
		   <tr class="Light" height="30">
 <?php
//$quer3=mysqli_query($link,"SELECT p_id, business_name FROM tbl_partymaser  where classification='Stock Transfer'"); 
...
<td align="right"  valign="middle" class="tblheading"> Photo File Name &nbsp;</td>
<td align="left"  valign="middle" class="tbltext"  colspan="3">&nbsp;<input name="txtstfp" type="text" size="10" class="tbltext" tabindex=""   maxlength="5" onkeypress="return isNumberKey(event)" onchange="upschk(this.value);"/>&nbsp;</td>
           </tr>
...
<td align="right"  valign="middle" class="tblheading"> Test By &nbsp;</td>
<td align="left"  valign="middle" class="tbltext"  colspan="3">&nbsp;<input name="txtstfp" type="text" size="10" class="tbltext" tabindex=""   maxlength="5" onkeypress="return isNumberKey(event)" onchange="upschk(this.value);"/>&nbsp;</td>
           </tr>
</table>
<table align="center" border="1" width="850" cellspacing="0" cellpadding="0" bordercolor="#d21704" style="border-collapse:collapse" >
