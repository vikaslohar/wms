...
<td width="825" align="left"  valign="middle" class="smalltbltext">&nbsp;<input type="text" name="txtremarks" class="tbltext" size="132" maxlength="90" value="<?php echo $row['blendm_qcremarks'];?>" ></td>
</tr></table>
