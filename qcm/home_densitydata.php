...
<title>QC Manager - Transaction -Home - Density Data Edit</title>
...
{
	searchUser(searchval,"searchresult","lotserch2");
}
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#d21704" >
	  ...
	  <table width="810" border="0" cellpadding="0" cellspacing="0" bordercolor="#d21704" style="border-bottom:solid; border-bottom-color:#d21704" >
        <tr >
          <td width="810" height="25">&nbsp;Transaction - Density Data Edit</td>
        </tr></table></td>
...
<tr class="Light" height="20">
  <td  align="right" class="tblheading">Density Data Updated List&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
<td width="234" align="right" class="tblheading" >&nbsp;Lot No. wise Search:&nbsp;<input type="text" class="smalltbltext" size="5" maxlength="5" name="lsearch" id="lsearch" onkeyup="searchlotname(this.value)" onkeypress="return isNumberKey1(event)" style="background-color:#FFFFFF; border-color:#378b8b" placeholder="12345" />&nbsp;&nbsp;</td>
</table> 
<div id="searchresult">
  <?php
