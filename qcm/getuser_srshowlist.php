...
$sql2="SELECT distinct orlot FROM tbl_lot_ldg_pack WHERE lotldg_crop='".$crop."' and lotldg_variety='".$variety."' and lotldg_srflg='0' and lotldg_qc!='Fail' and lotldg_got!='Fail' and lotldg_qc!='NUT' and lotldg_rvflg=0 and (lotldg_qc='UT' OR lotldg_qc='RT')";
}
else
{
...
$sql2="SELECT distinct orlot FROM tbl_lot_ldg_pack WHERE lotldg_crop='".$crop."' and lotldg_variety='".$variety."' and whid='".$wh."' and binid='".$bin."' and subbinid='".$subbin."' and lotldg_srflg='0' and lotldg_qc!='NUT' and lotldg_qc!='Fail' and lotldg_got!='Fail' and lotldg_rvflg=0 and (lotldg_qc='UT' OR lotldg_qc='RT')";
}
...
$sql_issuetbl=mysqli_query($link,"select * from tbl_lot_ldg_pack where lotdgp_id='".$row_issue1[0]."' and balqty > 0 and lotldg_rvflg=0") or die(mysqli_error($link)); 
