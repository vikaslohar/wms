<?php
	...
	if(isset($_POST['frm_action'])=='submit')
	{
		...
		$cropage = $_POST['cropage'];
		echo "<script>window.location='report_gotdatapending1.php?sdate=$sdate&edate=$edate&txtcrop=$cid&txtvariety=$itemid&cropage=$cropage'</script>";
	}
?>
...
<title>Quality-Report - Pending GOT Report - GOT Data Pending</title>
...
{ 
	...
	if(document.frmaddDepartment.cropage.value == "")
	{
		alert("Please Enter Age of Crop");
		return false;
	}
	if(parseInt(document.frmaddDepartment.cropage.value)==0)
	{
		alert("Please Enter proper Age of Crop");
		return false;
	}
	return true;	 
}
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#d21704" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#d21704" style="border-bottom:solid; border-bottom-color:#d21704" >
	    <tr >
	      <td width="813" height="30"class="Mainheading"  >&nbsp;Report - Pending GOT Report - GOT Data Pending</td>
	    </tr></table></td>
	  </tr>
	  </table></td></tr>
...
<table align="center" border="1" width="550" cellspacing="0" cellpadding="0" bordercolor="#d21704" style="border-collapse:collapse" >
                <tr class="tblsubtitle" height="25">
                  <td colspan="4" align="center" class="tblheading">Pending GOT Report - GOT Data Pending</td>
                </tr>
                <tr height="15">
                  <td colspan="6" align="right" class="tblheading"><font color="#FF0000" >* </font>indicates required field&nbsp;</td>
                </tr>
<tr class="Dark" height="25">
                  <td width="26%" height="30" align="right" valign="middle" class="tblheading">&nbsp;Arrival&nbsp;Period&nbsp;&raquo;&nbsp;&nbsp;&nbsp;From&nbsp;</td>
...
<td width="264" align="right"  valign="middle" class="tblheading" colspan="2">Crop&nbsp;</td>
<td width="304" colspan="2" align="left"  valign="middle" class="tbltext" >&nbsp;<select class="tbltext" name="txtcrop" style="width:170px;" onChange="modetchk(this.value)">
...
<tr class="Light" height="25">
	<td align="right"  valign="middle" class="tblheading" colspan="2" >Age of Crop&nbsp;</td>
    <td align="left"  valign="middle" class="tbltext" id="vitem" colspan="2">&nbsp;<input type="text" name="cropage" id="crpage" class="tbltext" value="" size="2" maxlength="3" />&nbsp;Days&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
                </tr>				
              </table>
