  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#d21704" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#d21704" style="border-bottom:solid; border-bottom-color:#d21704" >
	    <tr >
	      <td width="940" height="25">&nbsp;Transaction - GOT Result Pending List</td>
	    </tr></table></td>
...
$targetpage = $PHP_SELF; 
  ...
  $sql_arr_home=mysqli_query($link,"select * from tbl_qctest where gotflg=0 and gotsmpdflg=1 and got='UT' and (dosdate!='NULL' and dosdate!='--' and dosdate!='0000-00-00')  group by lotno,spdate order by tid asc, spdate ASC LIMIT $start, $limit") or die(mysqli_error($link));
 $tot_arr_home=mysqli_num_rows($sql_arr_home);

//echo $total_results = mysql_result(mysqli_query($link,"SELECT COUNT(*) as Num FROM tbl_qctest where gotflg=0 and gotsmpdflg=1 and got='UT' and (dosdate!='NULL' and dosdate!='--' and dosdate!='0000-00-00')"),0); 

$query = "SELECT COUNT(*) as num FROM tbl_qctest where gotflg=0 and gotsmpdflg=1 and got='UT' and (dosdate!='NULL' and dosdate!='--' and dosdate!='0000-00-00') ";
...
$pagination = "";
 ...
 /*$sql_arr_home=mysqli_query($link,"select * from tbl_qctest where  aflg=0  and cflg=0 and gotflg=0 and got='UT'  order by spdate ASC") or die(mysqli_error($link));
 $tot_arr_home=mysqli_num_rows($sql_arr_home);
...
<tr class="Light" height="20">
  <td colspan="6" align="center" class="tblheading">GOT Result Pending List</td>
  <td width="58" colspan="6" align="right" class="tblheading"><a href="got_filter1.php">Search</a>&nbsp;&nbsp;</td>
</tr>
</table>
...
$sampno=$tp1.$row_arr_home['yearid'].sprintf("%000006d",$qc1);
if($srno%2!=0)
{
?>			  
<tr class="Light">
	...
	<td width="70" align="center" valign="middle" class="tblheading"><?php echo $tdate1;?></td>
         <td align="center" valign="middle" class="tblheading"><?php echo $tdatee;?></td>
		  ...
		  <td width="75" align="center" valign="middle" class="tblheading"><?php echo $sampno;?></a></td>
...
$adjacents1 = 2;
	...
	$sql_dtchk=mysqli_query($link,"select * from tbl_qctest where gotflg=1 order by gotdate desc LIMIT 0,1") or die(mysqli_error($link));
	$tot_dtchk=mysqli_num_rows($sql_dtchk);
	$row_dtchk=mysqli_fetch_array($sql_dtchk);
	$lasttdate=$row_dtchk['gotdate'];
	$trdate=$row_dtchk['gotdate'];
	$tryear=substr($trdate,0,4);
	$trmonth=substr($trdate,5,2);
	$trday=substr($trdate,8,2);
	$trdate=$trday."-".$trmonth."-".$tryear;
		...
		//echo $dt1;
  $sql_arr_home=mysqli_query($link,"select * from tbl_qctest where gotflg=1 and gotdate>='$dt1' and gotstatus!='UT' and gotstatus!='RT' order by gotdate desc LIMIT $start1, $limit1") or die(mysqli_error($link));
  $tot_arr_home=mysqli_num_rows($sql_arr_home);

//$total_results = mysql_result(mysqli_query($link,"SELECT COUNT(*) as Num FROM tbl_qctest where bflg=1   and qcflg=0"),0); 

$query = "SELECT COUNT(*) as num1 FROM tbl_qctest where gotflg=1 and gotdate>='$dt1' and gotstatus!='UT' and gotstatus!='RT'";
...
?>			  
<tr class="Light">
         <td width="26" align="center" valign="middle" class="tblheading"><?php echo $srno1;?></td>
		  <td width="141" align="center" valign="middle" class="tblheading"><?php echo $row31['cropname'];?></td>
    <td align="center" valign="middle" class="tblheading"><?php echo $vv;?></td>
         <td width="109" align="center" valign="middle" class="tblheading"><?php echo $lotno?></td>
		 <td align="center" valign="middle" class="tblheading"><?php echo $stage?></td>
	  <td align="center" valign="middle" class="tblheading"><?php echo $pp;?></td>  
		   <td width="76" align="center" valign="middle" class="tblheading"><?php echo $trdate?></td>
       
	<td width="72" align="center" valign="middle" class="tblheading"><?php echo $tdate1;?></td>
         <td align="center" valign="middle" class="tblheading"><?php echo $tdatee;?></td>
		  <td width="73" align="center" valign="middle" class="tblheading"><?php echo $trdate2?></a></td>
         <td align="center" valign="middle" class="tblheading"><?php echo $row_arr_home['gotstatus'];?></td>
</tr>
<?php
}
else
