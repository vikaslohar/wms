...
$s_sub="delete from tbl_qcgen1 where arrsub_id='".$b."'";
mysqli_query($link,$s_sub) or die(mysqli_error($link));

$sql_t_sub=mysqli_query($link,"select * from tbl_qcgen1 where arrival_id='".$a."'") or die(mysqli_error($link));
...
<table align="center" border="1" cellspacing="0" cellpadding="0" width="850" bordercolor="#d21704" style="border-collapse:collapse">
 ...
 $sql_tbl=mysqli_query($link,"select * from tbl_qcgen where arrival_id='".$a."'") or die(mysqli_error($link));
...
<td width="186" align="right" valign="middle" class="tblheading">Seed Stage&nbsp;</td>
...
<option value="" selected>--Select Variety-</option>
         ...
         <tr class="Light" height="30" id="vitem">
           ...
           <td align="left" width="271" valign="middle" class="tbltext" style="border-color:#d21704" >&nbsp;<input name="txtlot1" type="text" size="20" class="tbltext" tabindex=""  maxlength="20"  value="" onchange="ltchk(this.value);"  readonly="true" style="background-color:#ECECEC"  >&nbsp;<font color="#FF0000">*</font>&nbsp;<a href="Javascript:void(0);" onclick="openslocpop();">Select</a><input type="hidden" name="qcrsl" value="" /><input type="hidden" name="gotrsl" value="" /></td>
