...
var status=document.frmaddDepartment.qcstatus.value;
var sftyp=document.frmaddDepartment.sftyp.value;
var ddate=document.frmaddDepartment.ddate.value;
winHandle=window.open('report_sfr2.php?sdate='+sdate+'&edate='+edate+'&ddate='+ddate+'&txtcrop='+itemid+'&txtvariety='+vv+'&qcstatus='+status+'&sftyp='+sftyp,'WelCome','top=20,left=80,width=780,height=400,scrollbars=yes');
if(winHandle==null){
...
{	 
	...
	{
	//echo "select * from tbl_softr where softr_date <= '$edate' and softr_date >= '$sdate' and softr_tflg=1 order by softr_crop, softr_variety asc ";
...
?>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#d21704" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#d21704" style="border-bottom:solid; border-bottom-color:#d21704" >
	    <tr >
	      <td width="813" height="25">&nbsp;Soft Release Status Report</td>
	    </tr></table></td>
	  </tr>
	  </table></td></tr>
	 ...
	 <input name="frm_action" value="submit" type="hidden"> 
	   ...
	   <input name="txtvariety" value="<?php echo $_REQUEST['txtvariety']?>" type="hidden"> 
	    <input name="qcstatus" value="<?php echo $_REQUEST['qcstatus'];?>" type="hidden">
...
if($sftyp=="periodical")
{	//echo "select * from tbl_softr_sub where softr_id='".$arrival_id."' and softrsub_srtyp='pack' ";
...
<tr >
<td height="49" align="center" valign="top"><a href="report_sfrr.php"><img src="../images/back.gif" border="0"  style="display:inline;cursor:pointer;"/></a>&nbsp;&nbsp;<img src="../images/printpreview.gif" onclick="openprint()" style="cursor:pointer" border="0" /><input type="hidden" name="txtinv" /></td>
</tr>
</table>
</td><td ></td>
</tr>
