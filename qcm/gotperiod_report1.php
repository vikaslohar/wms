...
<tr class="tblsubtitle" height="25">
	...
	<td width="64"  align="center" valign="middle" class="tblheading">SP Code</td>
    ...
    <td width="46" align="center" valign="middle" class="tblheading">DoGT</td>
</tr>
<?php
$srno=1;
while($row_arr_home2=mysqli_fetch_array($sql_arr_home))
{
	...
	while($row_arr_home=mysqli_fetch_array($sql_max))
	{
		...
		$crop=""; $variety=""; $lotno=""; $spcodes=""; $qty=""; $stage=""; $got=""; $qc=""; $sstatus=""; $loc1=""; $per=""; $qcresult="";
...
<tr class="Light" height="25">
	...
	<td width="36" align="center" valign="middle" class="tblheading"><?php echo $spcodes?></td>
