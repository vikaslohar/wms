...
if($sftyp=="periodical")
{	
	$sql_tbl_sub=mysqli_query($link,"select * from tbl_softr_sub where softr_id='".$arrival_id."' and softrsub_srtyp='pack' ") or die(mysqli_error($link));
}
else
{
	$sql_tbl_sub=mysqli_query($link,"select * from tbl_softr_sub where softr_id='".$arrival_id."' and softrsub_srflg='1' and softrsub_srtyp='pack' ") or die(mysqli_error($link));
}	
