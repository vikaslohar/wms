  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" style="border-bottom:solid; border-bottom-color:#d21704" >
	    <tr >
	      <td width="813" height="25" class="Mainheading">&nbsp;Germination</td>
	    </tr></table></td>
...
<tr class="tblsubtitle" height="20">
  <td colspan="6" align="center" class="tblheading">Germination</td>
</tr>
<tr height="15"><td colspan="6" align="right" class="tblheading"><font color="#FF0000" >* </font>indicates required field&nbsp;</td></tr>

 <tr class="Dark" height="30">
<td width="205" align="right" valign="middle" class="tblheading">Test Date &nbsp;</td>
<td width="275"  align="left" valign="middle" class="tbltext">&nbsp;<input name="sdate" id="sdate" type="text" size="10" class="tbltext" tabindex="0" readonly="true"  value="<?php echo date("d-m-Y", time());?>" style="background-color:#EFEFEF" />&nbsp;</td>

<td width="154" align="right" valign="middle" class="tblheading">Cropt&nbsp;</td>
...
<td width="206" align="left" valign="middle" class="tbltext">&nbsp;<input name="sdate" id="sdate" type="text" size="20" class="tbltext" tabindex="0" readonly="true"  value="" style="background-color:#EFEFEF" /></td>
</tr>
 <?php
$quer4=mysqli_query($link,"SELECT DISTINCT address,p_id FROM tbl_partymaser order by classification Asc"); 
?>
<tr class="Dark" height="25">
<td width="205" align="right" valign="middle" class="tblheading">Lot Stage &nbsp;</td>
<td width="275"  align="left" valign="middle" class="tbltext" colspan="3">&nbsp;<input name="sdate" id="sdate" type="text" size="10" class="tbltext" tabindex="0" readonly="true"  value="" style="background-color:#EFEFEF" /></td>
</tr>
</table>
<table align="center" border="1" width="850" cellspacing="0" cellpadding="0" bordercolor="#d21704" style="border-collapse:collapse" > 

<tr class="tblsubtitle" height="25">
			<td align="center" valign="middle" class="tblheading" rowspan="2">Method</td>
			<td align="center" valign="middle" class="tblheading" rowspan="2">Germination Keeping Date </td>
			<td height="28" colspan="1" align="center" valign="middle" class="tblheading">Test End Date </td>
			<td align="center" valign="middle" class="tblheading" colspan="1"> No. Of seed Used </td>
			<td align="center" valign="middle" class="tblheading" colspan="1">Normal</td>
			<td align="center" valign="middle" class="tblheading" colspan="1">Abnormal</td>
			<td align="center" valign="middle" class="tblheading" colspan="1">Hard</td>
			<td align="center" valign="middle" class="tblheading" colspan="1">%Germination</td>
			<td align="center" valign="middle" class="tblheading" colspan="1">Test By </td>
</tr>
<tr class="tblsubtitle" height="25">
...
<tr class="Light" height="25">
			<td align="center" valign="middle" class="tblheading"  rowspan="1">Soil</td>
...
?>
<tr class="Dark" height="25">
			<td align="center" valign="middle" class="tblheading">Petridish</td>
			<td align="center" valign="middle" class="tblheading"><?php echo $p_name;?></td>
			<td align="center" valign="middle" class="tblheading"><?php echo $stlg_trups;?></td>
			<td align="center" valign="middle" class="tblheading">&nbsp;</td>
			<td align="center" valign="middle" class="tblheading">&nbsp;</td>
...
?>
<tr class="Dark" height="25">
			<td align="center" valign="middle" class="tblheading" rowspan="1">paper</td>
			<td align="center" valign="middle" class="tblheading"><?php echo $p_name;?></td>
			<td align="center" valign="middle" class="tblheading"><?php echo $stlg_trups;?></td>
			<td align="center" valign="middle" class="tblheading">&nbsp;</td>
			<td align="center" valign="middle" class="tblheading">&nbsp;</td>
...
<table align="center" border="1" width="850" cellspacing="0" cellpadding="0" bordercolor="#d21704" style="border-collapse:collapse" >
<tr class="Light" height="30">
<td width="88" align="right"  valign="middle" class="tblheading">&nbsp;Find Result&nbsp;</td>
<td width="656" align="left"  valign="middle" class="tbltext">&nbsp;<input type="text" name="txtremarks" class="tbltext" size="20" maxlength="20" ></td>
</tr>
<tr class="Light" height="30">
