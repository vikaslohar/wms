...
$sql_sub=mysqli_query($link,"select * from tbl_softr_sub2 where softrsub_id='".$pid."' and softr_id='".$trid."'") or die(mysqli_error($link));
...
$sql_t_sub=mysqli_query($link,"select * from tbl_softr_sub2 where softr_id='".$trid."'") or die(mysqli_error($link));
