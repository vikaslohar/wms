...
while($row_tbl=mysqli_fetch_array($sql_tbl))
{
	...
	if(isset($_POST['frm_action'])=='submit')
	{
		...
		$f="Fail";$u="UT";$r="RT";
		$sql_tbl_sub=mysqli_query($link,"select distinct(orlot) from tbl_lot_ldg where orlot='".$ln1."' and lotldg_balqty>0 and lotldg_qc!='".$f."' and lotldg_qc!='".$u."' and lotldg_qc!='".$r."' and lotldg_got!='".$f."'")or die(mysqli_error($link));
		$ct1=mysqli_num_rows($sql_tbl_sub);	
	//exit;
		if($ct1 > 0)
		{
		echo "<script>window.location='pm_update.php?txtlot=$txtlot&txtcrop=$txtcrop&txtvariety=$txtvariety&txtlot1=$txtlot1&pcode=$pcode&txt=$txt&txtlot2=$txtlot2&txtlot=$txtlot&reptyp=$reptyp&txtlot4=$txtlot4&ycodee=$ycode&txtlo=$txtlo&stcode=$stcode'</script>";
		}
		else
		{
		?>
		<script type="text/javascript">
		alert("Can not proceed. \nReason:\n\n1. Invalid Lot number selected.\n\n2. Lot Number is Under Test for QC.\n\n3. Lot Number not Arrived.");
		</script>
		<?php
		}
...
<title>QC- Transaction -PP Moisture % Update</title>
<link href="../include/main_quality.css" rel="stylesheet" type="text/css" />
<link href="../include/vnrtrac_quality.css" rel="stylesheet" type="text/css" />
</head>
<script src="trading222.js"></script>
<script type="text/javascript">
...
winHandle=window.open('getuser_trading_lotno222.php?crop='+crop+'&variety='+variety,'WelCome','top=150,left=160,width=420,height=350,scrollbars=yes');
if(winHandle==null){
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#d21704" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#d21704" style="border-bottom:solid; border-bottom-color:#d21704" >
	    <tr >
	      <td width="940" height="25" class="Mainheading">&nbsp;Transaction - PP Moisture Update</td>
	    </tr></table></td>
...
<table align="center" border="1" width="850" cellspacing="0" cellpadding="0" bordercolor="#d21704" style="border-collapse:collapse" >
                <tr class="tblsubtitle" height="25">
                  <td colspan="4" align="center" class="tblheading">Search to select Lot</td>
                </tr>
