...
<td align="left" width="272" valign="middle" class="tbltext" style="border-color:#adad11">&nbsp;<input name="txtlot1" type="text" size="6" class="tblheading" tabindex=""  maxlength="6"  value="<?php echo $mode;?>" onchange="ltchk(this.value);"  readonly="true" style="background-color:#CCCCCC" />
