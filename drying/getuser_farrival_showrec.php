...
$tot_arrsub=0;
$fg=0;
$sql_tbl_sub=mysqli_query($link,"select * from tbl_dryarrival_sub where plantcode='".$plantcode."' and   old='".$a."'") or die(mysqli_error($link));
...
--><tr class="Dark" height="25">
 ...
 <td align="left"  valign="middle" class="tbltext">&nbsp;<input name="qc2"  type="checkbox" class="tbltext" tabindex="0" readonly="true" value="1" onclick="qcsamp(this.value)" /></td>
 <td align="right"  valign="middle" class="tblheading">QC Status&nbsp;</td>
 <td align="left"  valign="middle" class="tbltext">&nbsp;<input name="txtqc" type="text" size="15" class="tbltext" tabindex="0" readonly="true" style="background-color:#CCCCCC" value="" maxlength="20"/></td>
</tr>
<tr class="Dark" height="25">
...
<td width="148" align="right" valign="middle" class="tblheading">Seed Status-Drying&nbsp;</td>
<td width="256" align="left" valign="middle" class="tbltext">&nbsp;<input name="sstatus" type="text" size="6" class="tbltext" tabindex=""  maxlength="6"  value="D" style="background-color:#CCCCCC" readonly="true"></td>
</tr>
