...
<?php 
$arrlots="";
$sql_arrival=mysqli_query($link,"select arrival_id from tblarrival where plantcode='".$plantcode."' and   arrival_type='$tp' and arrtrflag=0") or die(mysqli_error($link));
$tot_arrival=mysqli_num_rows($sql_arrival);
if($tot_arrival)
{
	while($row_arrival=mysqli_fetch_array($sql_arrival))
	{
		$sql_tbl_sub=mysqli_query($link,"select * from tblarrival_sub where plantcode='".$plantcode."' and   arrival_id='".$row_arrival['arrival_id']."'") or die(mysqli_error($link));
...
$sql="select * from tbllotimp where    lottrtype='$tp' and unarrtyp='$crop' and lotimpflg=0 $sss order by lotnumber";
...
<td width="350"  align="left" valign="middle" class="tblheading" style="vertical-align:middle">&nbsp;Lot&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="../images/back.gif" border="0" onClick="window.close()" align="middle" style="vertical-align:middle" />&nbsp;<input type="image" src="../images/update.gif" alt="Submit Value" border="0" style="display:inline;cursor:pointer; vertical-align:middle" onclick="post_value();" align="middle"/>&nbsp;&nbsp;</td>
</tr>
<?php
$srno=1;
//echo $arrlots;
