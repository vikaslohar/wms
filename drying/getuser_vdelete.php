...
$sql_t_sub=mysqli_query($link,"select * from tblarrival_sub where plantcode='".$plantcode."' and   arrival_id='".$a."'") or die(mysqli_error($link));
$tot_sub=mysqli_num_rows($sql_t_sub);
?><?php
$sql_tbl=mysqli_query($link,"select * from tblarrival where plantcode='".$plantcode."' and   arrival_id='".$a."'") or die(mysqli_error($link));
...
<tr class="Light" height="30">
<td align="right" width="204" valign="middle" class="tblheading" style="border-color:#adad11">&nbsp;Lot <span class="tblheading" style="border-color:#adad11">Number</span>&nbsp;</td>
