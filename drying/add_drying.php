<?php
	...
	$sql_code="SELECT MAX(arr_code) FROM tbl_cobdrying  ORDER BY arr_code DESC";
	...
	if(mysqli_num_rows($res_code) > 0)
	{
		...
		$t_code=$row_code['0'];
		$code=$t_code+1;
		$code1="TPD".$code."/".$yearid_id."/".$lgnid;
	}
	else
	{
		$code=1;
...
var balper1="txtdbagp1";
	...
	document.getElementById(balper).value=Math.round(parseFloat(document.getElementById(balqty).value)/parseFloat(document.getElementById(acqty).value)*100);
		...
		//alert(document.frmaddDepartment.txtqtytot.value);
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#adad11" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#adad11" style="border-bottom:solid; border-bottom-color:#adad11" >
	    <tr >
	      <td width="813" height="25" class="Mainheading">&nbsp;Transaction - Cob Drying Slip </td>
	    </tr></table></td>
...
<tr class="tblsubtitle" height="20">
  <td colspan="6" align="center" class="tblheading">Cob Drying Slip</td>
</tr>
<tr height="15"><td colspan="6" align="right" class="tblheading"><font color="#FF0000" >*</font>indicates required field&nbsp;</td></tr>

 <tr class="Dark" height="30">
<td width="236" align="right" valign="middle" class="tblheading">&nbsp;Transaction Id&nbsp;</td>
<td width="265"  align="left" valign="middle" class="tbltext">&nbsp;<?php echo $code1?></td>

<td width="196" align="right" valign="middle" class="tblheading">Date&nbsp;</td>
<td width="263" align="left" valign="middle" class="tbltext">&nbsp;<input name="date" type="text" size="10" class="tbltext" bndex="0" readonly="true"  style="background-color:#CCCCCC" value="<?php echo date("d-m-Y");?>" maxlength="10"/>&nbsp;</td>
</tr>
  <?php
$quer3=mysqli_query($link,"SELECT cropid, cropname FROM tblcrop where cropname IN ('Maize Seed','Sweet Corn Seed') order by cropname Asc");
...
<table align="center" border="1" cellspacing="0" cellpadding="0" width="970" bordercolor="#adad11" style="border-collapse:collapse">
            ...
            <tr class="tblsubtitle" height="20">
              <td width="2%" align="center" valign="middle" class="smalltblheading" rowspan="2">#</td>
			   <td width="8%" align="center" valign="middle" class="smalltblheading" rowspan="2">Lot No. </td>
			   <td width="10%" align="center" valign="middle" class="smalltblheading" rowspan="2">Existing SLOC</td>
			   <td align="center" valign="middle" class="smalltblheading"  colspan="2">Before Drying </td>
			    <td width="11%" align="center" valign="middle" class="smalltblheading"rowspan="2" >Updated SLOC</td>
			   ...
			   <td colspan="2" align="center" valign="middle" class="smalltblheading" >Drying Start</td>
			    <td colspan="2" align="center" valign="middle" class="smalltblheading" >Drying End</td>
				<td width="4%" align="center" valign="middle" class="smalltblheading" rowspan="2">Total D.Time</td>
				 <td width="7%" align="center" valign="middle" class="smalltblheading" rowspan="2">Drying Details</td>
              <td width="3%" align="center" valign="middle" class="smalltblheading" rowspan="2">Edit</td>
              <td width="5%" align="center" valign="middle" class="smalltblheading"rowspan="2" >Delete</td>
  </tr>
  <tr class="tblsubtitle">
                    ...
                    <td width="4%" align="center" valign="middle" class="smalltblheading">%</td>
					 <td width="5%" align="center" valign="middle" class="smalltblheading" >Date</td>
                    <td width="5%" align="center" valign="middle" class="smalltblheading" >Time</td>
                    <td width="5%" align="center" valign="middle" class="smalltblheading" >Date</td>
                    <td width="5%" align="center" valign="middle" class="smalltblheading" >Time</td>
                            </tr>
			  <?php $subtbltot=0;?>
...
<tr class="light" height="30">
  ...
  <td width="903" align="left" class="smalltbltext">&nbsp;<input type="text" name="txtremarks" size="140" value="" class="smalltbltext" />&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
</tr>
</table>
<table align="center" width="970" cellpadding="5" cellspacing="5" border="0" >
<tr >
