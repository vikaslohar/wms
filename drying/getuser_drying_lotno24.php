...
$arrlots="";
		$sql_tbl_sub=mysqli_query($link,"select * from tbl_opspa_sub where plantcode='".$plantcode."' and opspa_id='".$tid."'") or die(mysqli_error($link));
...
$aaaass="select distinct(orlot)  from tbl_lot_ldg where plantcode='".$plantcode."' and lotldg_crop='".$noticia['cropid']."' and lotldg_variety='".$noticia_item['varietyid']."' $sss";			
...
//echo $ct;
 ...
 // $row['lotldg_lotno'];
 $sql_chk=mysqli_query($link,"select * from tbl_lot_ldg where plantcode='".$plantcode."' and   orlot='".$row['orlot']."' and lotldg_sstage='Condition'") or die(mysqli_error($link));
