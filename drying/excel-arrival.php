...
$tot_arr_home=mysqli_num_rows($sql_arr_home);
	/* $s = "select stores_item,uom from tbl_stores where items_id = $itemid";
	 ...
	 $rs = mysqli_query($link,$sql) or die(mysqli_error($link));  */
	 	if($typ=="Fresh Seed with PDN")	{$tlp="Fresh Seed Arrival with PDN";}
...
function cleanData(&$str)
    ...
    $datatitle2 = array("","","","","","","","","PP","Moist %","","","","");
	 $datatitle3 = array("#","Crop","Variety","Lot No.","NoB","Qty"," Stage","Production Location","Preliminary QC","","QC Status","GOT Status","Seed Status","SLOC");
$d=1;
...
if($tot_arr_home > 0)			
{
$data1[$d]=array($d,$crop,$variety,$lotno,$bags,$qty,$stage,$loc1,$per,$per1,$qc,$got,$sstatus,$slocs); 
$d++;
}
}
}
