...
<?php
 $targetpage = $_SERVER['PHP_SELF']; 
  ...
  $sql_arr_home=mysqli_query($link,"select * from tbl_dryarrival where plantcode='".$plantcode."' and arrival_date >='$tdate' and arrival_date <='$pdate' and arrival_type='Fresh Seed with PDN' and arrtrflag=1 order by arrival_date desc LIMIT $start, $limit") or die(mysqli_error($link));
 $tot_arr_home=mysqli_num_rows($sql_arr_home);
...
$query = "select * from tbl_dryarrival where plantcode='".$plantcode."' and arrival_date >='$tdate' and arrival_date <='$pdate' and arrival_type='Fresh Seed with PDN' and arrtrflag=1 order by arrival_date desc";
...
// if($tot_arr_home >0) { $total_results3 =mysqli_query($link,"SELECT COUNT(*)  FROM tbl_dryarrival where  plantcode='".$plantcode."' and   arrtrflag=1"),0);
 $srno=($page-1)*$limit+1;
/*if(!isset($_GET['page'])) { 
		$page = 1; 
		$srno=1;
...
$sql_arr_home=mysqli_query($link,"select * from tbl_dryarrival where plantcode='".$plantcode."' and arrival_date >='$tdate' and arrival_date <='$pdate' and arrival_type='Fresh Seed with PDN' and arrtrflag=1 order by arrival_date desc LIMIT $from, $max_results") or die(mysqli_error($link));
$tot_arr_home=mysqli_num_rows($sql_arr_home);

$total_results3 =mysqli_query($link,"SELECT COUNT(*)  FROM tbl_dryarrival where  plantcode='".$plantcode."' and   arrival_date >='$tdate' and arrival_date <='$pdate' and arrival_type='Fresh Seed with PDN' and arrtrflag=1");
$total_results2 = mysqli_fetch_array($total_results3);
$total_results = $total_results2[0]; */
