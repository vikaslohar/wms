...
$flag=0; 
//echo $a;
$sql_month=mysqli_query($link,"select items_id, stores_item from tbl_stores where plantcode='".$plantcode."' and   classification_id='".$a."' order by stores_item")or die(mysqli_error($link));
