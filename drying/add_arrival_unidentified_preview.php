...
$sql_main="update tblarrival set type='$txtarr', nolot='$txtlot2', sstage='$sstage',  tmode='$txt11', trans_name='$txttname', trans_lorryrepno='$txtlrn', trans_vehno='$txtvn', trans_paymode='$txt14', courier_name='$txtcname', docket_no='$txtdc', pname_byhand='$txtpname', remarks='$remarks', party_id='$txtstfp' where arrival_id = '$pid'";
$a123456=mysqli_query($link,$sql_main) or die(mysqli_error($link));
	...
	$sql_crop=mysqli_query($link,"select * from tblcrop where cropname='$crop'") or die(mysqli_error($link));
		...
		echo $itemid=$row_variety['varietyid'];				
		*/
	...
	$res_code1=mysqli_query($link,$sql_code1)or die(mysqli_error($link));
		...
		if($row_arrsub['qc']=="UT")
		{
			$sql_sub_sub1244="insert into tbl_qctest(pp, moist, lotno, srdate, crop, variety, sampleno, trstage, qc, state, gs, oldlot, yearid,logid,plantcode) values ('$vchk', '$moist', '$lotno', '$trdate1', '$classid', '$itemid', '$ncode1', '$stage', '$qc', '$state',1 ,'$gln', '$yearid_id','$logid','$plantcode')";
			mysqli_query($link,$sql_sub_sub1244) or die(mysqli_error($link));
		}
		if($got1=="UT")
		{
			$sql_sub_sub1244="insert into tbl_gottest(gottest_got, gottest_lotno, gottest_srdate, gottest_crop, gottest_variety, gottest_sampleno, gottest_trstage, gottest_oldlot, yearid, logid,plantcode) values ('$got1', '$lotno', '$trdate1', '$classid', '$itemid', '$ncode1', '$stage', '$gln', '$yearid_id','$logid','$plantcode')";
			mysqli_query($link,$sql_sub_sub1244) or die(mysqli_error($link));
		}
		/*$state="P/M/G"."/".$got;
		if($row_arrsub['qc']=="UT" || $row_arrsub['got']=="UT" )
				{
		$sql_sub_sub12="insert into tbl_qctest(pp,moist, got,lotno,srdate, crop, variety,gemp,sampleno,trstage,qc,gs,oldlot,state,yearid,logid)values('$vchk','$moist','$got1','$lotno','$trdate1','$classid','$itemid','$gemp','$ncode1','$stage','$qc',1,'$gln','$state','$yearid_id','$logid')";
	...
	$sql_code="SELECT MAX(arr_code) FROM tblarrival where plantcode='".$plantcode."' and   yearcode='$yearid_id' and arrival_type='Unidentified' ORDER BY arr_code DESC";
	$res_code=mysqli_query($link,$sql_code)or die(mysqli_error($link));
		...
		$sql_code1="SELECT MAX(ncode) FROM tblarrival where plantcode='".$plantcode."' and   yearcode='$yearid_id' and arrival_type='Unidentified' ORDER BY ncode DESC";
	$res_code1=mysqli_query($link,$sql_code1)or die(mysqli_error($link));
	...
	$a123456=mysqli_query($link,$sql_main) or die(mysqli_error($link));
		...
		echo "<script>window.location='select_arrival_unidop.php?p_id=$pid'</script>";	
	}
	}
...
<title>Drying -Transaction -Unidentified Arrival - Preview</title>
...
winHandle=window.open('unid_print_view.php?itmid='+itm+'&remarks='+remarks,'WelCome','top=170,left=180,width=820,height=350,scrollbars=yes');
if(winHandle==null){
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#adad11" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#adad11" style="border-bottom:solid; border-bottom-color:#adad11" >
	    <tr >
	      <td width="813" height="25" class="Mainheading">&nbsp;Transaction - Unidentified Arrival- Preview</td>
	    </tr></table></td>
...
<tr class="tblsubtitle" height="20">
  <td colspan="6" align="center" class="tblheading">Unidentified Arrival Preview </td>
</tr>

 <tr class="Dark" height="30">
<td width="160" align="right" valign="middle" class="tblheading">&nbsp;Transaction Id&nbsp;</td>
<td width="349"  align="left" valign="middle" class="tbltext">&nbsp;<?php echo "TAU".$row_tbl['arrival_code']."/".$yearid_id."/".$lgnid;?></td>
...
<td align="right" width="145" valign="middle" class="tblheading">No. of Bag&nbsp;</td>
...
<tr class="tblsubtitle" height="20">
  <td width="2%" rowspan="2" align="center" valign="middle" class="tblheading">#</td>
    ...
    <td width="9%" rowspan="2" align="center" valign="middle" class="tblheading">Crop</td>
	   <td width="9%" rowspan="2" align="center" valign="middle" class="tblheading">Variety</td>
 ...
 <td width="10%" align="center" valign="middle" class="tblheading" colspan="2">Difference</td>*/-->
		  ...
		  <td width="9%" rowspan="2" align="center" valign="middle" class="tblheading">QC Status</td>
		   <!--<td width="12%" rowspan="2" align="center" valign="middle" class="tblheading">GOT Type</td>-->	 
		   <td width="12%" rowspan="2" align="center" valign="middle" class="tblheading">GOT Status</td>
		 	
		 <td width="8%" rowspan="2" align="center" valign="middle" class="tblheading">Seed Status </td>
...
?>
  <tr class="Light" height="20">
    ...
    <td width="5%" align="center" valign="middle" class="tblheading"><?php echo $row_tbl_sub['lotcrop'];?></td>
