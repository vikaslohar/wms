...
$sql_tbl_sub=mysqli_query($link,"select * from tblarrival_sub where plantcode='".$plantcode."' and   arrsub_id='".$a."'") or die(mysqli_error($link));
...
$arrival_id=$row_tbl['arrival_id'];
	...
	$lotqry1=mysqli_query($link,"select * from tblvariety where popularname='".$row_tbl_sub['lotvariety']."' and actstatus='Active' and vertype='PV'")or die (mysqli_error($link));
	$t=mysqli_num_rows($lotqry1);
	$row11=mysqli_fetch_array($lotqry1);
	$qctyp=$row11['opt'];
	
$sql_tbl2=mysqli_query($link,"select * from tblarrival_sub where plantcode='".$plantcode."' and   arrival_id='".$tid."'") or die(mysqli_error($link));
$srno=1; $itmdchk="";
 $total_tbl2=mysqli_num_rows($sql_tbl2);
if($total_tbl2 > 0)
{
	...
	if($itmdchk!="")
	{
	$itmdchk=$itmdchk.$row_tbl2['nolot'].",";
	}
	else
	{
	$itmdchk=$row_tbl2['nolot'].",";
	}
...
<td width="197" align="right"  valign="middle" class="tblheading"> Lot No.&nbsp;</td>
<td width="327" align="left"  valign="middle" class="tblheading" >&nbsp;<input name="txtold" type="text" size="20" class="tblheading" tabindex="" maxlength="20" onkeypress="return isNumberKey(event)" onchange="qtychk(this.value);"   style="background-color:#CCCCCC" readonly="true" value="<?php echo $row_tbl_sub['lotno'];?>"  >&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
...
<td width="219" align="left" valign="middle" class="tbltext">&nbsp;
  <input name="txtold1" type="text" size="20" class="tbltext" tabindex="0" readonly="true"  style="background-color:#CCCCCC" value="<?php echo $row_tbl_sub['lotoldlot'];?>" maxlength="20"/>&nbsp;<font color="#FF0000">*</font></td>
</tr>
...
<td align="left"  valign="middle" class="tbltext">&nbsp;<input name="txtdcnob" type="text" size="10" class="tbltext" tabindex=""    maxlength="9" onchange="bagschk1();" onkeypress="return isNumberKey(event)"  value="<?php echo $row_tbl_sub['qty1'];?>" //>&nbsp;<font color="#FF0000">*</font> </td>

<td align="left"  valign="middle" class="tblheading">&nbsp;<input name="txtactnob" type="text" size="10" class="tbltext" tabindex=""    maxlength="9" onchange="bagschk2(this.value);" onkeypress="return isNumberKey(event)" value="<?php echo $row_tbl_sub['act1'];?>" />  &nbsp;<font color="#FF0000">*</font></td>
<td align="left"  valign="middle" class="tbltext">&nbsp;<input name="txtdiffnob" type="text" size="10" class="tbltext" tabindex=""    maxlength="9" style="background-color:#CCCCCC" readonly="true"  onkeypress="return isNumberKey(event)" value="<?php echo $row_tbl_sub['diff1'];?>" />&nbsp;<font color="#FF0000">*</font>	</td>
</tr>
...
<td align="left"  valign="middle" class="tblheading">&nbsp;<input name="txtactqty" type="text" size="10" class="tbltext" tabindex=""    maxlength="9" onchange="qtychk2(this.value);" onkeypress="return isNumberKey(event)" value="<?php echo $row_tbl_sub['act'];?>" />&nbsp;<font color="#FF0000">*</font>	</td>
<td align="left"  valign="middle" class="tbltext">&nbsp;<input name="txtdiffqty" type="text" size="10" class="tbltext" tabindex=""    maxlength="9" style="background-color:#CCCCCC" readonly="true" onkeypress="return isNumberKey(event)" value="<?php echo $row_tbl_sub['diff'];?>"  />&nbsp;<font color="#FF0000">*</font></td>
</tr>
...
<td align="left"  valign="middle" class="tbltext">&nbsp;<input name="txtmoist" type="text" size="1" class="tbltext" tabindex=""    maxlength="4" onchange="moischk(this.value);" onkeypress="return isNumberKey(event)" value="<?php echo $row_tbl_sub['moisture'];?>"/>%&nbsp;<font color="#FF0000">*</font>	</td>
...
<table align="center" border="1" width="950" cellspacing="0" cellpadding="0" bordercolor="#adad11" style="border-collapse:collapse" >
<tr class="Light" height="30">
<td width="198" align="right" valign="middle" class="tblheading">&nbsp;Reason&nbsp;</td>
<td width="746" colspan="3" align="left"  valign="middle" class="tbltext">&nbsp;<input type="text" name="txtremarks1" class="tbltext" size="100" maxlength="90" value="<?php echo $row_tbl_sub['remarks'];?>" >&nbsp;<font color="#FF0000">*</font></td>
</tr>
</table>
</div>
<table align="center" border="1" width="950" cellspacing="0" cellpadding="0" bordercolor="#adad11" style="border-collapse:collapse" > 
<tr class="tblsubtitle" height="20">
  <td colspan="4" align="center" class="tblheading">Grow Out Test (GOT) </td>
		   ...
		   <tr class="Light" height="30">
<td width="197" align="right"  valign="middle" class="tblheading">GOT Type&nbsp;</td>
<td width="332" align="left"  valign="middle" class="tbltext">&nbsp;<select class="tbltext" name="txtgstat" style="width:80px;" onchange="gotchk(this.value)">
...
<td width="196" align="right"  valign="middle" class="tblheading">Generate GOT Sample&nbsp;</td>
 <td width="215" align="left"  valign="middle" class="tbltext" >&nbsp;<?php if($qctyp == "Mandatory"){?>
   <input name="gotsample"  type="checkbox" class="tbltext" tabindex="0" readonly="true" disabled="disabled" checked="checked" style="background-color:#CCCCCC" value="1" /><?php } else { ?><input name="gotsample"  type="checkbox" <?php if($row_tbl_sub['sample']=="1"){ echo "checked";}  ?> class="tbltext" tabindex="0" value="0" onclick="gensmpchk()" /><?php } ?><input type="hidden" name="gscheckbox" value="<?php echo $row_tbl_sub['sample'];?>"  /></td>
</tr>
<tr class="Dark" height="25">
  <td align="right"  valign="middle" class="tblheading">GOT Status&nbsp;</td>
 <td align="left"  valign="middle" class="tbltext" >&nbsp;<input name="gotstatus" type="text" size="15" class="tbltext" tabindex="0" readonly="true" style="background-color:#CCCCCC" value="<?php echo $row_tbl_sub['got1'];?>" maxlength="20"/></td>
<td width="196" align="right" valign="middle" class="tblheading">Seed Status&nbsp;</td>
<td width="215" align="left" valign="middle" class="tblheading">&nbsp;<input name="sstatus" type="text" size="6" class="tblheading" tabindex=""  maxlength="6"  value="<?php echo $row_tbl_sub['sstatus'];?>" style="background-color:#CCCCCC" readonly="true"><a href="Javascript:void(0);" onclick="openslocpop1();">Select</a></td>
</tr>
</table>
...
<table align="center" border="1" width="950" cellspacing="0" cellpadding="0" bordercolor="#adad11" style="border-collapse:collapse" >
  ...
  <tr class="tblsubtitle" height="20">
    ...
    <td width="337" rowspan="2" align="center" valign="middle" class="tblheading">View</td>
    <td width="295" rowspan="2" align="center" valign="middle" class="tblheading">Arrival</td>
  </tr>
  <tr class="tblsubtitle" height="20">
...
?>
  <tr class="Light" height="30" >
    ...
    <?php
$bing1_query=mysqli_query($link,"select binid, binname from tbl_bin where plantcode='".$plantcode."' and   whid='".$row_sub_sloc['whid']."'") or die(mysqli_error($link));
?>
    ...
    <?php
$subbing1_query=mysqli_query($link,"select sid, sname from tbl_subbin where plantcode='".$plantcode."' and   whid='".$row_sub_sloc['whid']."' and binid='".$row_sub_sloc['binid']."'") or die(mysqli_error($link));
?>
