...
//$a="c";
	//$a="c";
	$sql_code="SELECT MAX(arrival_code) FROM tblarrival where plantcode='".$plantcode."' and   arrival_type='Unidentified arrival' ORDER BY arrival_code DESC";
		...
		if(mysqli_num_rows($res_code) > 0)
			{
				...
				$t_code=$row_code['0'];
				$code=$t_code+1;
			$code1="TAU".$code."/".$yearid_id."/".$lgnid;
		}
		else
		{
			$code=1;
...
<title>Drying- Transaction - Unidentified Arrival</title>
...
if(document.frmaddDepartment.txtlot2.value!="" && (parseInt(document.frmaddDepartment.itmdchk.value)>=parseInt(document.frmaddDepartment.txtlot2.value)))
 ...
 if(document.frmaddDepartment.txtlot1.value=="")
	...
	{	//alert("hi");
		...
		{
		alert("Please check.NoB received is not matching with Quantity distributed in Bins");
		return false;
		f=1;
		}
...
<tr class="tblsubtitle" height="20">
  <td colspan="6" align="center" class="tblheading">Add Unidentified Arrival </td>
</tr>
...
<td width="146" align="right" valign="middle" class="tblheading">&nbsp;Date&nbsp;</td>
<td width="258" align="left" valign="middle" class="tbltext">&nbsp;
  <input name="date" type="text" size="10" class="tbltext" tabindex="0" readonly="true"  style="background-color:#CCCCCC" value="<?php echo date("d-m-Y");?>" maxlength="10"/>&nbsp;</td>
</tr>
...
<td align="left"  valign="middle" class="tbltext">&nbsp;<input name="arrivaltype" type="text" size="15" class="tbltext" tabindex="0"  value="UniIdentifiedArrival" maxlength="15"/>&nbsp;</td>
	 <?php
...
<tr class="Light" height="30">
<td align="right"  valign="middle" class="tblheading">Type of Arrival&nbsp;</td>
<td align="left"  valign="middle" class="tbltext" colspan="3">&nbsp;<input name="arrivaltype" type="text" size="20" class="tbltext" tabindex="0"  value="Unidentified Arrival" maxlength="20" readonly="true" style="background-color:#CCCCCC"/>&nbsp;</td>
...
<td align="left"  valign="middle" class="tbltext" >&nbsp;<select class="tbltext" name="txtarr" style="width:190px;">
    ...
    <option value="Fresh Seed Arrival with PDN" >Fresh Seed Arrival with PDN</option>
    <option value="Stock Transfer-Plant" >Stock Transfer-Plant</option>
	 <option value="Trading Arrival" >Trading Arrival</option>
...
<td width="147" align="right"  valign="middle" class="tblheading">Lorry Receipt No.&nbsp;</td>
<td align="left" width="255" valign="middle" class="tbltext" colspan="3">&nbsp;<input name="txtlrn" type="text" size="15" class="tbltext" tabindex=""  maxlength="15"/>&nbsp;</td>
</tr>

<tr class="Dark" height="25">
<td align="right" width="229" valign="middle" class="tblheading">&nbsp;Vehicle No.&nbsp;</td>
<td align="left" width="309" valign="middle" class="tbltext">&nbsp;<input name="txtvn" type="text" size="12" class="tbltext" tabindex="" maxlength="12"  />&nbsp;<font color="#FF0000">*</font>&nbsp; </td>
...
<td align="left" width="310" valign="middle" class="tbltext">&nbsp;<input name="txtcname" type="text" size="20" class="tbltext" tabindex=""  maxlength="20" />&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
<td align="right" width="147" valign="middle" class="tblheading">&nbsp;Docket No.&nbsp;</td>
<td align="left" width="254" valign="middle" class="tbltext" colspan="3">&nbsp;<input name="txtdc" type="text" size="15" class="tbltext" tabindex="" maxlength="15"   />&nbsp;<font color="#FF0000">*</font></td>
</tr>
</table></div>
...
<td width="715" colspan="8" align="left" valign="middle" class="tbltext">&nbsp;<input name="txtpname" type="text" size="31" class="tbltext" tabindex=""  maxlength="30" />&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
</tr>
</table>
</div>
<br />
...
<table align="center" border="1" cellspacing="0" cellpadding="0" width="950" bordercolor="#adad11" style="border-collapse:collapse">
	...
	<td width="10%" align="center" rowspan="3" valign="middle" class="tblheading">Crop</td>
	<td width="10%" align="center" rowspan="3" valign="middle" class="tblheading">Variety</td>
	...
	<!--/* <td width="10%" align="center" valign="middle" class="tblheading" colspan="2">Actual</td>
*/-->
 <td width="8%" rowspan="3" align="center" valign="middle" class="tblheading">Stage</td>
	 	 <td width="10%" align="center" valign="middle" class="tblheading" colspan="2">Preliminary QC</td>
		  <td width="9%" rowspan="3" align="center" valign="middle" class="tblheading">QC Sample </td> 
		  <!--<td width="10%" align="center" valign="middle" class="tblheading"   rowspan="3">GOT Type</td>	 -->
		   <td width="9%" rowspan="3" align="center" valign="middle" class="tblheading">GOT Status</td>
...
<td align="left" width="366" valign="middle" class="tblheading" style="border-color:#adad11">&nbsp;<a href="javascript:void(0);" onclick="getdetails(this.value);" >Get Details</a>&nbsp;(After selection of lot no. click on 'Get Details')</td>
</tr>
...
<table align="center" border="1" width="950" cellspacing="0" cellpadding="0" bordercolor="#adad11" style="border-collapse:collapse" >
<tr class="Light" height="30">
<td align="right" width="152" valign="middle" class="tblheading">&nbsp;Remarks&nbsp;</td>
<td width="692" align="left"  valign="middle" class="tbltext">&nbsp;<input type="text" name="txtremarks" class="tbltext" size="100" maxlength="90" ></td>
</tr>
