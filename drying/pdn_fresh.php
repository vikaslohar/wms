...
//$a="c";
	//$a="c";
	$sql_code="SELECT MAX(arrival_code) FROM tbl_dryarrival where  plantcode='".$plantcode."' and   yearcode='$yearid_id' and arrival_type='Stocktransfer' ORDER BY arrival_code DESC";
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" style="border-bottom:solid; border-bottom-color:#4ea1e1" >
	    <tr >
	      <td width="813" height="25" class="Mainheading">&nbsp;Transaction - Fresh Arrival PDN </td>
	    </tr></table></td>
...
<tr class="tblsubtitle" height="20">
  <td colspan="6" align="center" class="tblheading">Fresh arrival With PDN </td>
</tr>
<tr height="15"><td colspan="6" align="right" class="tblheading"><font color="#FF0000" >* </font>indicates required field&nbsp;</td></tr>

 <tr class="Light" height="25">
<td align="right"  valign="middle" class="tblheading">SP Code Male &nbsp;</td>
 <td align="left"  valign="middle" class="tbltext" colspan="3" >&nbsp;<input name="txtdcno22" type="text" size="10" class="tbltext" tabindex=""    maxlength="2" onchange="vendorchk();"/>  <font color="#FF0000">*</font></td>
</tr>
...
</table><table id="trans" align="center" border="1" width="850" cellspacing="0" cellpadding="0" bordercolor="#4ea1e1" style="display:none; border-color:#4ea1e1" > 
...
<div id="postingtable" style="display:block"><br />
		  <div id="postingsubtable" style="display:block">
		    <div id="subsubdivgood" style="display:block">
		      <table align="center" border="1" width="850" cellspacing="0" cellpadding="0" bordercolor="#4ea1e1" style="border-collapse:collapse" >
                <tr class="tblsubtitle" height="20">
                  <td colspan="8" align="center" valign="middle" class="tblheading">Existing SLOC Good</td>
                </tr>
                <tr class="tblsubtitle" height="20">
