...
<?php 
	...
	$sql_arr_home=mysqli_query($link,"select * from tblarrival where plantcode='".$plantcode."' and   arrival_type='$typ' and arrival_date >='$sdate' and arrival_date <='$edate' and arrtrflag=1 order by arrival_date asc ") or die(mysqli_error($link));
