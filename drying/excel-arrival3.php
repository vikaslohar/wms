...
$tot_arr_home=mysqli_num_rows($sql_arr_home);
	...
	if($typ=="Unidentified")	{$tlp="Unidentified_Arrival";}
...
function cleanData(&$str)
 ...
 $datatitle2 = array("","","","","","","","","","PP","Moist %","","","");
	 $datatitle3 = array("#","Arrived In","Arrived From","Crop","Variety","Lot No.","NoB","Qty","Stage"," Prel.QC","","QC Status"," Got Status", "SLOC");
...
if($tot_arr_home > 0)			
{
$data1[$d]=array($d,$loc1,$location,$crop,$variety,$lotno,$bags,$qty,$stage,$vk,$moist,$qc,$got1,$slocs); 
$d++;
}
}
}
