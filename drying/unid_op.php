...
<title>Drying - Transction Issue - Stock Transfer  - Output Selection</title>
...
winHandle=window.open('mrtv_issue_note_print.php?itmid='+itm,'WelCome','top=170,left=180,width=770,height=450,scrollbars=yes');
if(winHandle==null){
...
{
var itm=document.frmaddDepartment.txtitem.value;
winHandle=window.open('gatepass_str.php?itmid='+itm,'WelCome','top=170,left=180,width=820,height=450,scrollbars=yes');
if(winHandle==null){
alert("While Launching New Window...\nYour browser maybe blocking up Popup windows. \n\n  Please check your Popup Blocker Settings or ..\n Please hold Ctrl Key and Click on link to open new Browser"); }
}
else
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" style="border-bottom:solid; border-bottom-color:#adad11" >
	    <tr >
	      <td width="813" height="25" class="Mainheading">&nbsp;Transction  - Unidentified Bag- Output Selection </td>
	    </tr></table></td>
	  </tr>
	  </table></td></tr>
...
$sql_tbl=mysqli_query($link,"select * from tbl_stldg_good where plantcode='".$plantcode."' and   stlg_trtype='Issue' and stlg_trsubtype='$tp' and stlg_trid='".$pid."'") or die(mysqli_error($link));
/*$row_tbl=mysqli_fetch_array($sql_tbl);			
...
//$sql_tbl_sub=mysqli_query($link,"select * from tblissue_sub where plantcode='".$plantcode."' and   issue_id='".$issue_id."'") or die(mysqli_error($link));
...
?>
  <tr class="tblsubtitle" height="25">
    <td width="39" align="center" class="tblheading" valign="middle">#</td>
      ...
      <td width="67" align="center" class="tblheading" valign="middle" colspan="4">Quality</td>
...
{ 
$sql_class=mysqli_query($link,"select * from tbl_classification where plantcode='".$plantcode."' and   classification_id='".$row_tbl_sub['stlg_trclassid']."'") or die(mysqli_error($link));
$row_class=mysqli_fetch_array($sql_class);

$sql_item=mysqli_query($link,"select * from tbl_stores where plantcode='".$plantcode."' and   items_id='".$row_tbl_sub['stlg_tritemid']."'") or die(mysqli_error($link));
