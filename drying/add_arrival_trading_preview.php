<?php
   ...
   // $yearid_id="09-10";	
	...
	while($row_arrsub_sub=mysqli_fetch_array($sql_arrsub_sub))
	{
		...
		$sql_code="SELECT MAX(arr_code) FROM tblarrival where plantcode='".$plantcode."' and   yearcode='$yearid_id' and arrival_type='Trading' ORDER BY arr_code DESC";
		...
		$sql_code1="SELECT MAX(ncode) FROM tblarrival where plantcode='".$plantcode."' and   yearcode='$yearid_id' and arrival_type='Trading' ORDER BY ncode DESC";
		$res_code1=mysqli_query($link,$sql_code1)or die(mysqli_error($link));
...
<title>Drying -Transaction -Trading Arrival - Preview</title>
