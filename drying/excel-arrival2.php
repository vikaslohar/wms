...
$tot_arr_home=mysqli_num_rows($sql_arr_home);
	...
	/* $s = "select stores_item,uom from tbl_stores where items_id = $itemid";
		...
		$sql_loc=mysqli_query($link,"select did, dest from tbldestination where plantcode='".$plantcode."' and did='$cid'"); 
...
if($typ=="Trading")	{$tlp="Trading Arrival";}
 		

	$dh="Daily_Arrival_Report:".$tlp."_From_".$_REQUEST['sdate']."_To_".$_REQUEST['edate'];
	$datahead = array($dh);
	//$datahead1 = array("Arrival Report");
	$datahead2 = array("Daily Arrival Report: ",$tlp,"  Period From  ",$_REQUEST['sdate'],"  To  ",$_REQUEST['edate']);
	$data1 = array();
...
function cleanData(&$str)
	 ...
	 $datatitle3 = array("#","Crop","Variety"," V. Lot No."," Vendor Name"," Lot No.","NoB","Qty"," Stage","SLOC","QC","","QC Status","GOT Status","Seed Status","SLOC");
	 $d=1;
if($typ=="Trading")
{ 
while($row_arr_home=mysqli_fetch_array($sql_arr_home))
{
	...
	{
$crop=""; $variety=""; $lotno=""; $bags=""; $qty=""; $stage=""; $got=""; $qc=""; $sstatus=""; $loc1=""; $vchk=""; $lotoldlot="";
...
$slocs=$wareh.$binn.$subbinn." | ".$slups." | ".$slqty.",";
				...
				*/
				...
				$sql_usr=mysqli_query($link,"select * from tbluser where plantcode='".$plantcode."' and scode='".$row_arr['logid']."'") or die(mysqli_error($link));
...
if($tot_arr_home > 0)			
{
$data1[$d]=array($d,$crop,$variety,$lotoldlot,$loc1,$lotno,$bags,$qty,$stage,$slocs,$vchk,$per1,$qc,$got,$sstatus,$slocs); 
$d++;
}
}
}
