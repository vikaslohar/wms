...
if($t=mysqli_num_rows($quer3)>0)
$txtcrop=$noticia['cropname'];
...
if($t2=mysqli_num_rows($quer4)>0)
$txtvariety=$noticia_item['popularname'];		
		
if($z1 == 0)
{
$sql_main="insert into tbl_cobdrying(arr_code, dryingdate, crop,  variety, drefno, logid,plantcode) values ('$txtid','$tdate1','$txtcrop','$txtvariety','$txtdrefno', '$logid','$plantcode')";
if(mysqli_query($link,$sql_main) or die(mysqli_error($link)))
{
$mainid=mysqli_insert_id($link);

  $sql_sub="insert into tbl_cobdryingsub (lotno, trid, onob, oqty, nob1, qty1, adnob , adqty, sstage, dsdate, dedate, dtime, ddtype, ddid,plantcode) values ('$txtlotno', '$mainid', '$txtdisptot', '$txtqtytot', '$recqtyptot', '$txtrecbagptot', '$txtdqtyptot', '$txtdbagptot', '$txtstage', '$datestart', '$dateend', '$txttottime', '$txtdmtyp', '$txtdid','$plantcode')";
if(mysqli_query($link,$sql_sub) or die(mysqli_error($link)))
{
	$suid=mysqli_insert_id($link);
	$sql_sub="insert into tbl_cobdryingsubsub (subtrid, trid, owh, obin, osubbin, onob, oqty, nwh, nbin, nsubbin, nnob, nqty, dryingloss, dlossper, samebin,plantcode) values ('$suid', '$mainid', '$extslwhg1', '$extslbing1', '$extslsubbg1', '$txtdisp1', '$txtqty1', '$txtslwhg1', '$txtslbing1', '$txtslsubbg1', '$recqtyp1', '$txtrecbagp1', '$txtdqtyp1', '$txtdbagp1', '$samebin1','$plantcode')";
	mysqli_query($link,$sql_sub) or die(mysqli_error($link));
	if($srno2==2)
	{
		$sql_sub="insert into tbl_cobdryingsubsub (subtrid, trid, owh, obin, osubbin, onob, oqty, nwh, nbin, nsubbin, nnob, nqty, dryingloss, dlossper, samebin,plantcode) values ('$suid', '$mainid', '$extslwhg2', '$extslbing2', '$extslsubbg2', '$txtdisp2', '$txtqty2', '$txtslwhg2', '$txtslbing2', '$txtslsubbg2', '$recqtyp2', '$txtrecbagp2', '$txtdqtyp2', '$txtdbagp2', '$samebin2','$plantcode')";
		mysqli_query($link,$sql_sub) or die(mysqli_error($link));
	}
...
{
$mainid=$z1;
   $sql_sub="update tbl_cobdryingsub set lotno='$txtlotno', trid='$mainid', onob='$txtdisptot', oqty='$txtqtytot', nob1='$recqtyptot', qty1='$txtrecbagptot', adnob='$txtdqtyptot', adqty='$txtdbagptot', sstage='$txtstage', dsdate='$datestart', dedate='$dateend', dtime='$txttottime', ddtype='$txtdmtyp', ddid='$txtdid' where  subtrid='".$subtrid."' ";
if(mysqli_query($link,$sql_sub) or die(mysqli_error($link)))
{
	$s_sub="delete from tbl_cobdryingsubsub where subtrid='".$subtrid."' and trid='".$mainid."'";
	mysqli_query($link,$s_sub) or die(mysqli_error($link));
	//$suid=mysqli_insert_id($link);
	$sql_sub="insert into tbl_cobdryingsubsub (subtrid, trid, owh, obin, osubbin, onob, oqty, nwh, nbin, nsubbin, nnob, nqty, dryingloss, dlossper, samebin,plantcode) values ('$subtrid', '$mainid', '$extslwhg1', '$extslbing1', '$extslsubbg1', '$txtdisp1', '$txtqty1', '$txtslwhg1', '$txtslbing1', '$txtslsubbg1', '$recqtyp1', '$txtrecbagp1', '$txtdqtyp1', '$txtdbagp1', '$samebin1','$plantcode')";
	mysqli_query($link,$sql_sub) or die(mysqli_error($link));
	if($srno2==2)
	{
		$sql_sub="insert into tbl_cobdryingsubsub (subtrid, trid, owh, obin, osubbin, onob, oqty, nwh, nbin, nsubbin, nnob, nqty, dryingloss, dlossper, samebin,plantcode) values ('$subtrid', '$mainid', '$extslwhg2', '$extslbing2', '$extslsubbg2', '$txtdisp2', '$txtqty2', '$txtslwhg2', '$txtslbing2', '$txtslsubbg2', '$recqtyp2', '$txtrecbagp2', '$txtdqtyp2', '$txtdbagp2', '$samebin2','$plantcode')";
		mysqli_query($link,$sql_sub) or die(mysqli_error($link));
	}
