<?php
	...
	$sql_tbl=mysqli_query($link,"select * from tblarrival where plantcode='".$plantcode."' and   arr_role='".$logid."' and  arrival_type='Unidentified' and arrtrflag=0") or die(mysqli_error($link));
while($row_tbl=mysqli_fetch_array($sql_tbl))
{
	...
	$s_sub="delete from tblarrival where arr_role='".$logid."' and arrival_type='Unidentified' and arrtrflag=0";
	mysqli_query($link,$s_sub) or die(mysqli_error($link));	
	...
	if(isset($_POST['frm_action'])=='submit')
	{
		...
		if($sdate1!="" && $edate1!="")
		{
		echo "<script>window.location='home_bag1.php?sdate=$sdate1&edate=$edate1'</script>";
		}
		else
		{
		echo "<script>window.location='home_bag.php'</script>";
		}
	}
...
<title>Drying- Transaction - Unidentified Bag</title>
...
{
winHandle=window.open('uan.php?itmid='+tid,'WelCome','top=170,left=180,width=820,height=450,scrollbars=yes');
if(winHandle==null){
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" >
	  ...
	  <table width="820" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" style="border-bottom:solid; border-bottom-color:#adad11" >
	    <tr >
	      <td width="820" height="25">&nbsp;Transaction - Unidentified Arrival </td>
	    </tr></table></td>
...
<td align="center" width="100" valign="middle" class="tblbutn" style="cursor:Pointer;"><?php if($flg==0 && $flg1==0 && $flg2==0) { ?><a href="unid_bag.php" style="text-decoration:none; color:#000000">Add </a><?php } else { ?><a href="Javascript:void(0);" onclick="alert('Can not perform Transaction.\nReason:\n1. Todays date is not in Active Current Financial Year.\n2. Transaction after todays date has been made.\n3. Cycle Inventory transaction is under process.');" style="text-decoration:none; color:#000000">Add </a><?php } ?></td>
</tr>
</table></td>
...
$sql_arr_home=mysqli_query($link,"select * from tblarrival where plantcode='".$plantcode."' and   arrival_type='Unidentified' and arrtrflag=1") or die(mysqli_error($link));
...
$targetpage = $_SERVER['PHP_SELF']; 
  ...
  $sql_arr_home=mysqli_query($link,"select * from tblarrival where plantcode='".$plantcode."' and   arrival_type='Unidentified' and arrtrflag=1 order by arrival_date desc, arr_code desc LIMIT $start, $limit") or die(mysqli_error($link));
 $tot_arr_home=mysqli_num_rows($sql_arr_home);
...
$query = "select * from tblarrival where plantcode='".$plantcode."' and   arrival_type='Unidentified' and arrtrflag=1 order by arrival_date desc, arr_code desc";
...
$pagination = "";
	...
	{	
		...
		//previous button
		if ($page > 1) 
			$pagination.= " <a href=\"$targetpage?page=$prev\">� previous&laquo; Previous </a> ";
		else
...
$sql_arr_home=mysqli_query($link,"select * from tblarrival where plantcode='".$plantcode."' and   arrival_type='Unidentified' and arrtrflag=1 order by arrival_date desc, arr_code desc LIMIT $from, $max_results") or die(mysqli_error($link));
$tot_arr_home=mysqli_num_rows($sql_arr_home);

$total_results3 =mysqli_query($link,"SELECT COUNT(*)  FROM tblarrival where  plantcode='".$plantcode."' and   arrival_type='Unidentified' and arrtrflag=1"),0);*/ 

    if($tot_arr_home >0) { 
?>
<table align="center" border="0" width="600" cellspacing="0" cellpadding="0" bordercolor="#4ea1e1" style="border-collapse:collapse" > 
<tr class="Light" height="20">
  <td colspan="6" align="center" class="tblheading"> Unidentified Arrival </td>
</tr>
</table>
<table align="center" border="1" cellspacing="0" cellpadding="0" width="950" bordercolor="#adad11" style="border-collapse:collapse">
            ...
            <tr class="tblsubtitle" height="20">
			 ...
			 <!-- <td width="7%" align="center" valign="middle" class="tblheading">GOT Type </td>-->
...
while($row_arr_home=mysqli_fetch_array($sql_arr_home))
{
	...
	{
	$crop=""; $variety="";  $stage=""; $got=""; $qc=""; $sstatus="";
...
<tr class="Light">
         <td width="3%" align="center" valign="middle" class="tblheading"><?php echo $srno;?></td>
          <td width="11%" align="center" valign="middle" class="tblheading"><a href="add_arrival_unidentified_viewpage.php?p_id=<?php echo $row_arr_home['arrival_id'];?>"><?php echo "AU".$row_arr_home['arr_code']."/".$yearid_id."/".$lrole;?></a></td>
         <td width="8%" align="center" valign="middle" class="tblheading"><?php echo $trdate;?></td>
        <td width="14%" align="center" valign="middle" class="tblheading"><?php echo $crop;?></td>
		   <td width="14%" align="center" valign="middle" class="tblheading"><?php echo $variety;?></td>
        ...
        <!-- <td width="7%" align="center" valign="middle" class="tblheading"><?php echo $got?></td>-->
		 <td width="7%" align="center" valign="middle" class="tblheading"><?php echo $got1?></td>
		 <td width="7%" align="center" valign="middle" class="tblheading"><?php echo $sstatus?></td>
		   <td width="7%" align="center" valign="middle" class="tblheading"><a href="Javascript:void(0)" onClick="openslocpopprint('<?php echo $row_arr_home['arrival_id'];?>');">UAN</a></td>
         </tr>
<?php
}
else
