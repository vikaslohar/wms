...
$sql="select * from tblproductionpersonnel where plantcode = $plantcode order by productionpersonnelid";
	   ...
	   { 
		...
		{ 
				 if($val1<>"")
			 {
				if($val1==$q)
				{ 
					$sql_r="select productionpersonnelid, productionpersonnel from tblproductionpersonnel where plantcode = $plantcode and productionpersonnelid =".$row['productionpersonnelid']; 
