...
if(tp=="subbin")
{ 
var url="getuser_vsbinck_drying.php";
url=url+"?a="+str;
url=url+"&b="+d; 
url=url+"&c="+e;
url=url+"&f="+i;
...
if(tp=="samesloc")
{ 
var url="getuser_samebin_drying.php";
url=url+"?a="+str;
url=url+"&b="+d; 
url=url+"&c="+e;
url=url+"&f="+i;
...
if(tp=="subformedt")
{ 
var url="getuser_vedtsubform1.php";
url=url+"?a="+str;
url=url+"&sid="+Math.random();
xmlHttp.onreadystatechange=stateChanged ;
xmlHttp.open("GET",url,true);
...
if(tp=="mform")
{ 
var url="getuser_vupdateform1.php";
url=url+"?"+str; 
url=url+"&sid="+Math.random();
xmlHttp.onreadystatechange=stateChanged ;
xmlHttp.open("GET",url,true);
...
{
	//alert(tp); 
var url="getuser_drying_showrec.php";
url=url+"?a="+str;
url=url+"&b="+d;
url=url+"&c="+e;
url=url+"&h="+i;
