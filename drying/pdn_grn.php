...
<table width="750" height="282" border="0" align="center" cellpadding="0" cellspacing="0" >
 ...
 <?php 
$tid=$itmid;
$sql_tbl=mysqli_query($link,"select * from tbl_dryarrival where plantcode='".$plantcode."' and arr_role='".$logid."' and arrival_type='Vendor' and arrival_id='".$tid."'") or die(mysqli_error($link));
...
<tr  height="20">
  <td colspan="6" align="center" class="Mainheading"><font color="#000000">PDN (GRN)</font></td>
</tr>
</table><br />
...
<td align="right"  valign="middle" class="tblheading"> Date &nbsp;</td>
 ...
 <tr class="Dark" height="20">
<td width="187" align="right" valign="middle" class="tblheading">DC No. &nbsp;</td>
<td width="263"  align="left" valign="middle" class="tbltext">&nbsp;<?php echo $tdate;?></td>

<td width="121" align="right" valign="middle" class="tblheading">&nbsp;DC Date &nbsp;</td>
