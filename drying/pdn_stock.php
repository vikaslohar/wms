  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#adad11" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#adad11" style="border-bottom:solid; border-bottom-color:#adad11" >
	    <tr >
	      <td width="813" height="25" class="Mainheading">&nbsp;Transaction - PDN Stock T ransfer From Plant </td>
	    </tr></table></td>
...
<tr class="tblsubtitle" height="20">
  <td colspan="6" align="center" class="tblheading"> PDN Stock Transfer From Plant </td>
</tr>
<tr height="15"><td colspan="6" align="right" class="tblheading"><font color="#FF0000" >* </font>indicates required field&nbsp;</td></tr>

 <tr class="Light" height="25">
<td width="350" align="right"  valign="middle" class="tblheading">Crop &nbsp;</td>
 <td width="494" colspan="3" align="left"  valign="middle" class="tbltext" >&nbsp;<select class="tbltext" name="select2" style="width:180px;" onchange="modetchk(this.value)">
    <option value="" selected>--Select GOT--</option>
    <option value="accept" >Fresh With PDN</option>
    <option value="nona" >Stock Tranasfer From Plant</option>
	 <option value="nona" >Trading Arrival</option>
...
<tr >
<td valign="top" align="center"><img src="../images/submit.gif" border="0"style="display:inline;cursor:Pointer;" onclick="pform();" />&nbsp;&nbsp;<img src="../images/reset.gif" border="0"style="display:inline;cursor:Pointer;" onclick="pform();" /></td>
</tr>
</table><table id="trans" align="center" border="1" width="850" cellspacing="0" cellpadding="0" bordercolor="#adad11" style="display:none; border-color:#adad11" > 
...
<div id="postingtable" style="display:block"><br />
		  <div id="postingsubtable" style="display:block">
		    <div id="subsubdivgood" style="display:block">
		      <table align="center" border="1" width="850" cellspacing="0" cellpadding="0" bordercolor="#adad11" style="border-collapse:collapse" >
                <tr class="tblsubtitle" height="20">
                  <td colspan="8" align="center" valign="middle" class="tblheading">Locations</td>
                </tr>
                <tr class="tblsubtitle" height="20">
                  ...
                  <td width="65" align="center" valign="middle" class="tblheading">GOT Status </td>
                  <td width="58" align="center" valign="middle" class="tblheading">Crop</td>
                  <td width="57" align="center" valign="middle" class="tblheading">Variety</td>
