...
if(tp=="get")
{
var url="getuser_unarrival_showrec.php";
url=url+"?a="+str;
url=url+"&f="+i;
url=url+"&b="+d;
url=url+"&sid="+Math.random();
...
if(tp=="subformedt")
{ 
var url="getuser_uniedtsubform.php";
url=url+"?a="+str;
url=url+"&f="+i;
url=url+"&b="+d;
url=url+"&sid="+Math.random();
...
if(tp=="mform")
{ 
var url="getuser_unidateform.php";
url=url+"?"+str; 
url=url+"&sid="+Math.random();
xmlHttp.onreadystatechange=stateChanged ;
xmlHttp.open("GET",url,true);
...
if(tp=="mformsubedt")
{ 
var url="getuser_unieditsubupdate.php";
url=url+"?"+str; 
url=url+"&sid="+Math.random();
xmlHttp.onreadystatechange=stateChanged ;
xmlHttp.open("GET",url,true);
...
{ 
var url="getuser_arrv_slocsuniden.php";
url=url+"?a="+str;
url=url+"&b="+d;
url=url+"&c="+e;
url=url+"&f="+i;
