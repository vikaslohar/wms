...
<title>Drying - Transaction - Sloc details</title>
...
<body topmargin="0" >
<?php  
//$sql_main=mysqli_query($link,"select * from tblarr_sloc where plantcode='".$plantcode."' and   subbin='".$slid."' and whid='".$wid."' and binid='".$bid."' group by item_id")or die(mysqli_error($link));
