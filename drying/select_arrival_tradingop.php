...
<title>Drying - Transction Trading Arrival-Select output</title>
...
?>
<?php
 $sql_tbl=mysqli_query($link,"select * from tbl_lot_ldg where plantcode='".$plantcode."' and   lotldg_trtype='Trading' and lotldg_trid='".$pid."'") or die(mysqli_error($link));
?>
