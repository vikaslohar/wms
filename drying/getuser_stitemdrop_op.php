...
/*if(isset($_GET['b']))
	...
	//}
//$flag=0; 
$sql_month=mysqli_query($link,"select varietyid, popularname from tblvariety where cropid='".$a."' and actstatus='Active' and vertype='PV' order by popularname")or die(mysqli_error($link));
