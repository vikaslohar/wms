...
$a123456=mysqli_query($link,$sql_main) or die(mysqli_error($link));
	...
	while($row_arrsub=mysqli_fetch_array($sql_arrsub))
	{
		...
		mysqli_query($link,$sql_sub_sub12) or die(mysqli_error($link));
			 ...
			 $sql_sub_upd="update tbl_stlotimp set stlotimp_trflg=1, stlotimp_trid='$pid' where stlotimp_id='".$lotnoid."'";
	...
	$sql_code="SELECT MAX(arr_code) FROM tblarrival where plantcode='".$plantcode."' and   yearcode='$yearid_id' and arrival_type='StockTransfer Arrival' ORDER BY arr_code DESC";
	$res_code=mysqli_query($link,$sql_code)or die(mysqli_error($link));
		...
		$sql_code1="SELECT MAX(ncode) FROM tblarrival where plantcode='".$plantcode."' and   yearcode='$yearid_id' and arrival_type='StockTransfer Arrival' ORDER BY ncode DESC";
	$res_code1=mysqli_query($link,$sql_code1)or die(mysqli_error($link));
