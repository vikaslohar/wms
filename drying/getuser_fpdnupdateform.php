...
$sql_sub="insert into tbl_dryarrival_sub (arrival_id, organiser, pdnno, pdndate, spcodef, spcodem, lotcrop, lotvariety, ploc, pper, farmer, plotno, gi, harvestdate, got, qty, act, diff, qty1, act1, diff1, moisture, vchk, qc, remarks, sstage, sstatus, lotno, old, got1, sample,qcsample,orlot,gssample,prodtype, lotstate,plantcode) values('$mainid', '$organi', '$txtpdno', '$pdate', '$spcodef', '$spcodem', '$txtcrop', '$txtvariety', '$txtloc', '$txtprod', '$txtfar', '$txtplot', '$gcode', '$hdate1', '$txtgstat', '$txtdcqty', '$txtactqty', '$txtdiffqty', '$txtdcnob', '$txtactnob', '$txtdiffnob', '$txtmoist', '$txtvisualck', '$qc', '$txtremarks', '$sstage', '$sstatus', '$glotno', '$txtlot1', '$gotstatus', '$gscheckbox','$qc2','$gln','$gs1','$productiontype','$statename','$plantcode')";
...
$sqlarrsub=mysqli_query($link,"select * from tbl_dryarrival_sub where plantcode='".$plantcode."' and   arrival_id='".$arrival_id."' order by arrsub_id") or die(mysqli_error($link));
