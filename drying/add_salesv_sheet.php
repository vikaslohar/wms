...
$a123456=mysqli_query($link,$sql_main) or die(mysqli_error($link));
	...
	$sql_code="SELECT MAX(arr_code) FROM tblarrival where plantcode='".$plantcode."' and   yearcode='$yearid_id' and arrival_type='StockTransfer Arrival' ORDER BY arrival_code DESC";
...
<title>Drying- Transaction - Stock Transfer Arrival - Preview</title>
