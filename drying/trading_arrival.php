...
<title>Drying- Transaction - Trading Arrival</title>
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#adad11" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#adad11" style="border-bottom:solid; border-bottom-color:#adad11" >
	      <td width="813" height="25" class="Mainheading">&nbsp;Transaction - Trading Arrival 
...
<tr class="tblsubtitle" height="20">
  <td colspan="6" align="center" class="tblheading">Add Trading Arrival </td>
</tr>
<tr height="15"><td colspan="6" align="right" class="tblheading"><font color="#FF0000" >* </font>indicates required field&nbsp;</td></tr>

 <tr class="Dark" height="30">
<td width="229" align="right" valign="middle" class="tblheading">&nbsp;Transaction Id&nbsp;</td>
<td width="307"  align="left" valign="middle" class="tbltext">&nbsp;<?php echo $code1?></td>

<td width="152" align="right" valign="middle" class="tblheading">&nbsp;Date&nbsp;</td>
<td width="252" align="left" valign="middle" class="tbltext">&nbsp;<input name="date" type="text" size="10" class="tbltext" tabindex="0" readonly="true"  style="background-color:#CCCCCC" value="<?php echo date("d-m-Y");?>" maxlength="10"/>&nbsp;</td>
</tr>
...
<td align="left"  valign="middle" class="tbltext"  colspan="3">&nbsp;<input name="arrivaltype" type="text" size="15" class="tbltext" tabindex="0"  value="Trading Arrival" maxlength="15" style="background-color:#CCCCCC" readonly="true"/>&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
	<!--<td align="right"  valign="middle" class="tblheading">GRN No.&nbsp;</td>
    <td align="middle"  valign="middle" class="tbltext">&nbsp;<input name="txtgrn" type="text" size="5" class="tbltext" tabindex=""    maxlength="5" value="00000"   readonly="true"  style="background-color:#CCCCCC"/>&nbsp;</td>-->
           </tr>
 
<tr class="Dark" height="30">
<td width="229" align="right"  valign="middle" class="tblheading">DC Date&nbsp;</td>
<td width="307" align="left"  valign="middle" class="tbltext" >&nbsp;<input name="dcdate" id="sdate" type="text" size="10" class="tbltext" tabindex="0" readonly="true"  value="" style="background-color:#EFEFEF" /><a href="javascript:void(0)" onClick="showCalendar('sdate')" tabindex="6"><img src="../images/cal.gif" alt="Calender" border="0" align="absmiddle"></a></td>
...
<table align="center" border="1" width="950" cellspacing="0" cellpadding="0" bordercolor="#adad11"  style="border-collapse:collapse" > 
<tr class="Light" height="30">
<td align="right" width="230" valign="middle" class="tblheading" style="border-color:#adad11">&nbsp;Transport Name&nbsp;</td>
<td align="left"  valign="middle" class="tbltext" style="border-color:#adad11">&nbsp;<input name="txttname" type="text" size="25" class="tbltext" tabindex="" maxlength="25" />  &nbsp;<font color="#FF0000">*</font>&nbsp;</td>
<td width="155" align="right"  valign="middle" class="tblheading" style="border-color:#adad11">Lorry Receipt No.&nbsp;</td>
<td align="left" width="248" valign="middle" class="tbltext" colspan="3" style="border-color:#adad11">&nbsp;<input name="txtlrn" type="text" size="15" class="tbltext" tabindex=""  maxlength="15"/>&nbsp;</td>
</tr>

<tr class="Dark" height="25">
<td align="right" width="230" valign="middle" class="tblheading" style="border-color:#adad11">&nbsp;Vehicle No.&nbsp;</td>
<td align="left" width="307" valign="middle" class="tbltext"  style="border-color:#adad11">&nbsp;<input name="txtvn" type="text" size="12" class="tbltext" tabindex="" maxlength="12"  />&nbsp;<font color="#FF0000">*</font>&nbsp; </td>
<td align="right"  valign="middle" class="tblheading" style="border-color:#adad11">&nbsp;Payment Mode&nbsp;</td>
 <td align="left"  valign="middle" class="tbltext"colspan="3" style="border-color:#adad11">&nbsp;<select class="tbltext" name="txt13" style="width:70px;" onchange="clk1(this.value);" >
<option value="" selected="selected">Select</option>
...
<table  align="center" border="1" width="950" cellspacing="0" cellpadding="0" bordercolor="#adad11" style="border-collapse:collapse" > 
<tr class="Dark" height="30">
<td align="right" width="230" valign="middle" class="tblheading" style="border-color:#adad11">&nbsp;Courier Name&nbsp;</td>
<td align="left" width="308" valign="middle" class="tbltext" style="border-color:#adad11">&nbsp;<input name="txtcname" type="text" size="20" class="tbltext" tabindex=""  maxlength="20" />&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
<td align="right" width="153" valign="middle" class="tblheading" style="border-color:#adad11">&nbsp;Docket No.&nbsp;</td>
<td align="left" width="249" valign="middle" class="tbltext" colspan="3" style="border-color:#adad11">&nbsp;<input name="txtdc" type="text" size="15" class="tbltext" tabindex="" maxlength="15"   />&nbsp;<font color="#FF0000">*</font></td>
</tr>
</table></div>
<div id="byhand" style="display:none; width:850">
<table align="center" border="1" width="950" cellspacing="0" cellpadding="0" bordercolor="#adad11" style="border-collapse:collapse" > 
<tr class="Dark" height="30">
<td align="right" width="229" valign="middle" class="tblheading" style="border-color:#adad11">&nbsp;Name of Person&nbsp;</td>
<td width="715" colspan="8" align="left" valign="middle" class="tbltext" style="border-color:#adad11">&nbsp;<input name="txtpname" type="text" size="31" class="tbltext" tabindex=""  maxlength="30" />&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
</tr>
</table>
</div>
...
<td width="305" align="left"  valign="middle" class="tbltext" >&nbsp;<select class="tbltext" name="txtcrop" style="width:170px;" onchange="modetchk(this.value)">
...
<table align="center" border="1" cellspacing="0" cellpadding="0" width="950" bordercolor="#adad11" style="border-collapse:collapse">
	...
	<td width="10%" align="center" rowspan="3" valign="middle" class="tblheading"> Lot No.</td>
	 <td width="10%" align="center" valign="middle" class="tblheading" colspan="2">As Per DC </td>
 ...
 <td width="10%" align="center" valign="middle" class="tblheading" colspan="2">Difference</td>
	 	 ...
	 	 <td width="10%" align="center" valign="middle" class="tblheading" colspan="2">Preliminary QC</td>

		  <td width="9%" rowspan="3" align="center" valign="middle" class="tblheading">QC Status </td>	 
		   <td width="12%" rowspan="3" align="center" valign="middle" class="tblheading">GOT Status </td>
...
<td align="left" width="272" valign="middle" class="tbltext" style="border-color:#adad11">&nbsp;<input name="txtlot1" type="text" size="6" class="tbltext" tabindex=""  maxlength="6"  value="" onchange="ltchk(this.value);" readonly="true" style="background-color:#CCCCCC" onBlur="javascript:this.value=this.value.toUpperCase();">&nbsp;<font color="#FF0000">*</font>&nbsp;<a href="Javascript:void(0);" onclick="openslocpop();">Select</a></td>
