<?php
	...
	//exit;
	 $pid=trim($_POST['txtitem']);
		...
		$sql_arr=mysqli_query($link,"select * from tblarrival where plantcode='".$plantcode."' and   arrival_id='".$pid."'") or die(mysqli_error($link));
	...
	$sql_arrsub=mysqli_query($link,"select * from tblarrival_sub where plantcode='".$plantcode."' and   arrival_id='".$pid."'") or die(mysqli_error($link));
	while($row_arrsub=mysqli_fetch_array($sql_arrsub))
	{
		...
		$dot=$row_arrsub['testd'];
		$dogt=$row_arrsub['gotdate'];
		$gotrusl="";
		if($got!="")
		{
		$gotr=explode(" ",$got);
		...
		$sql_arrsub_sub=mysqli_query($link,"select * from tblarr_sloc where plantcode='".$plantcode."' and   arr_tr_id='".$pid."' and arr_id='".$row_arrsub['arrsub_id']."'") or die(mysqli_error($link));
		...
		$state="P/M/G"."/".$got;	*/
				$sql_issue1=mysqli_query($link,"select max(lotldg_id) from tbl_lot_ldg where plantcode='".$plantcode."' and   lotldg_subbinid='".$subbinid."' and lotldg_binid='".$binid."' and lotldg_whid='".$whid."' and lotldg_variety='".$itemid."' and lotldg_crop='".$classid."'") or die(mysqli_error($link));
				...
				/*if($row_arrsub['qc']=="UT" && ($row_arrsub['got1']!="GOT-NR UT" || $row_arrsub['got1']!="GOT-R UT"))
				{
				$sql_sub_sub="insert into tbl_lot_ldg (yearcode, lotldg_lotno, lotldg_trtype, lotldg_trid, lotldg_trdate, lotldg_crop, lotldg_variety, lotldg_whid, lotldg_binid, lotldg_subbinid, lotldg_opbags, lotldg_opqty, lotldg_trbags, lotldg_trqty,  lotldg_balbags,  lotldg_balqty, lotldg_sstage, lotldg_moisture, lotldg_gemp, lotldg_vchk, lotldg_qc, lotldg_got1, lotldg_sstatus, orlot, lotldg_gs, lotldg_got,lotldg_gottestdate) values('$yearid_id', '$lotno', 'Opening Stock', '$pid', '$trdate', '$classid', '$itemid', '$whid', '$binid', '$subbinid', '$opups', '$opqty', '$ups', '$qty', '$balups', '$balqty' ,'$stage', '$moist', '$gemp', '$vchk', '$qc', '$got','$sstatus','$gln',1,'$gotrusl','$dogt')";
				 }
				 else if($row_arrsub['qc']!="UT" && ($row_arrsub['got1']=="GOT-NR UT" || $row_arrsub['got1']=="GOT-R UT"))
				{
				$sql_sub_sub="insert into tbl_lot_ldg (yearcode, lotldg_lotno, lotldg_trtype, lotldg_trid, lotldg_trdate, lotldg_crop, lotldg_variety, lotldg_whid, lotldg_binid, lotldg_subbinid, lotldg_opbags, lotldg_opqty, lotldg_trbags, lotldg_trqty,  lotldg_balbags,  lotldg_balqty, lotldg_sstage, lotldg_moisture, lotldg_gemp, lotldg_vchk, lotldg_qc, lotldg_got1, lotldg_sstatus, orlot, lotldg_gs, lotldg_got, lotldg_qctestdate) values('$yearid_id', '$lotno', 'Opening Stock', '$pid', '$trdate', '$classid', '$itemid', '$whid', '$binid', '$subbinid', '$opups', '$opqty', '$ups', '$qty', '$balups', '$balqty' ,'$stage', '$moist', '$gemp', '$vchk', '$qc', '$got','$sstatus','$gln',1,'$gotrusl','$dot')";
				 }
				 else
				 {*/
				 $sql_sub_sub="insert into tbl_lot_ldg (yearcode, lotldg_lotno, lotldg_trtype, lotldg_trid, lotldg_trdate, lotldg_crop, lotldg_variety, lotldg_whid, lotldg_binid, lotldg_subbinid, lotldg_opbags, lotldg_opqty, lotldg_trbags, lotldg_trqty,  lotldg_balbags,  lotldg_balqty, lotldg_sstage, lotldg_moisture, lotldg_gemp, lotldg_vchk, lotldg_qc, lotldg_got1, lotldg_sstatus, orlot, lotldg_gs, lotldg_got, lotldg_qctestdate, lotldg_gottestdate) values('$yearid_id', '$lotno', 'Opening Stock', '$pid', '$trdate', '$classid', '$itemid', '$whid', '$binid', '$subbinid', '$opups', '$opqty', '$ups', '$qty', '$balups', '$balqty' ,'$stage', '$moist', '$gemp', '$vchk', '$qc', '$got','$sstatus','$gln',1,'$gotrusl','$dot','$dogt')";
				// }
	...
	$res_code1=mysqli_query($link,$sql_code1)or die(mysqli_error($link));
		...
		else
		{
		 ...
		 $qc="";$got1="";
		if($row_arrsub['got1']=="GOT-R UT" || $row_arrsub['got1']=="GOT-R RT")
		{
		$got1="UT";	
		}
		else if($row_arrsub['got1']=="GOT-NR UT" || $row_arrsub['got1']=="GOT-NR RT")
		{
		$got1="UT";
		}
		else
		{
		$g1=explode(" ", $row_arrsub['got1']); 
		$got1=$g1[1];
		}
		
		if($row_arrsub['qc']=="UT" || $row_arrsub['qc']=="RT")
		{
		$qc="UT";
		}
		else
	...
	$state="";
		...
		if($got1=="UT")
		{
			$sql_sub_sub1244="insert into tbl_gottest(gottest_got, gottest_lotno, gottest_srdate, gottest_crop, gottest_variety, gottest_sampleno, gottest_trstage, gottest_oldlot, yearid, logid,plantcode) values ('$got1', '$lotno', '$trdate', '$classid', '$itemid', '$ncode1', '$stage', '$gln', '$yearid_id','$logid','$plantcode')";
			mysqli_query($link,$sql_sub_sub1244) or die(mysqli_error($link));
		}
		
		/*if($qc=="UT" && $got1!="UT")
		{
		$sql_sub_sub12="insert into tbl_qctest(pp, moist, got, lotno, srdate, crop,  variety, sampleno, trstage, qc, state, gs, oldlot, spdate, dosdate, bflg, gotdate, gotflg, gotstatus,yearid,logid)values('$vchk', '$moist', '$got1', '$lotno', '$trdate', '$classid', '$itemid', '$ncode1', '$stage', '$qc', '$state',1,'$gln', '$trdate', '$trdate',1,'$dogt',1, '$got1','$yearid_id','$logid')";
		}
		else if($qc!="UT" && $got1=="UT")
		{
		$sql_sub_sub12="insert into tbl_qctest(pp, moist, got, lotno, srdate, crop,  variety, sampleno, trstage, qc, state, gs, oldlot, spdate, dosdate, bflg, testdate, qcflg, qcstatus,gotsmpdflg,yearid,logid)values('$vchk', '$moist', '$got1', '$lotno', '$trdate', '$classid', '$itemid', '$ncode1', '$stage', '$qc', '$state',1,'$gln', '$trdate', '$trdate',1,'$dot',1, '$qc',1,'$yearid_id','$logid')";
		}	
		else if($qc=="UT" || $got1=="UT")
		{
		$sql_sub_sub12="insert into tbl_qctest(pp, moist, got, lotno, srdate, crop,  variety, sampleno, trstage, qc, state, gs, oldlot, spdate, dosdate, bflg,gotsmpdflg,yearid,logid)values('$vchk', '$moist', '$got1', '$lotno', '$trdate', '$classid', '$itemid', '$ncode1', '$stage', '$qc', '$state',1,'$gln', '$trdate', '$trdate',1,1,'$yearid_id','$logid')";
		}	
		else
		{
		$sql_sub_sub12="insert into tbl_qctest(pp, moist, got, lotno, srdate, crop,  variety, sampleno, trstage, qc, state, gs, oldlot, spdate, dosdate, bflg, testdate, qcflg, gotdate, gotflg, qcstatus,gotsmpdflg, gotstatus,yearid,logid)values('$vchk', '$moist', '$got1', '$lotno', '$trdate', '$classid', '$itemid', '$ncode1', '$stage', '$qc', '$state',1,'$gln', '$trdate', '$trdate',1,'$dot',1,'$dogt',1, '$qc',1, '$got1','$yearid_id','$logid')";
		}	
	...
	$sql_code="SELECT MAX(arr_code) FROM tblarrival where plantcode='".$plantcode."' and   yearcode='$yearid_id' and arrival_type='Opening Stock' ORDER BY arr_code DESC";
...
/*$sql_tbl_arsub=mysqli_query($link,"select distinct organiser from tblarrival_sub where arrival_id='".$pid."' and organiser!=''") or die(mysqli_error($link));
$arsubtbltot=mysqli_num_rows($sql_tbl_arsub);

while($row_tbl_arsub=mysqli_fetch_array($sql_tbl_arsub))
{
$ncode=$ncode+1;
$sqltblarsub=mysqli_query($link,"update tblarrival_sub set ncode='$ncode' where arrival_id='".$pid."' and organiser='".$row_tbl_arsub['organiser']."'") or die(mysqli_error($link));
}

$sql_tbl_arsub1=mysqli_query($link,"select distinct farmer from tblarrival_sub where arrival_id='".$pid."' and organiser=''") or die(mysqli_error($link));
$arsubtbltot1=mysqli_num_rows($sql_tbl_arsub1);
while($row_tbl_arsub1=mysqli_fetch_array($sql_tbl_arsub1))
{
$ncode=$ncode+1;
$sqltblarsub1=mysqli_query($link,"update tblarrival_sub set ncode='$ncode' where arrival_id='".$pid."' and farmer='".$row_tbl_arsub1['farmer']."'") or die(mysqli_error($link));
}*/		
...
<title>Drying -Transaction - Opening Stock - Preview</title>
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#adad11" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#adad11" style="border-bottom:solid; border-bottom-color:#adad11" >
	    <tr >
	      <td width="813" height="25" class="Mainheading">&nbsp;Transaction - Opening Stock - Preview</td>
	    </tr></table></td>
...
<tr class="tblsubtitle" height="20">
  <td colspan="6" align="center" class="tblheading">Opening Stock</td>
</tr>

 <tr class="Dark" height="30">
<td width="205" align="right" valign="middle" class="tblheading">&nbsp;Transaction Id&nbsp;</td>
<td width="275"  align="left" valign="middle" class="tbltext">&nbsp;<?php echo "TOP".$row_tbl['arrival_code']."/".$yearid_id."/".$lgnid;?></td>
