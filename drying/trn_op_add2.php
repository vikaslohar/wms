<?php
	...
	$sql_code="SELECT MAX(opspa_tcode) FROM tbl_opspa ORDER BY opspa_tcode DESC";
...
<tr class="tblsubtitle" height="20">
                ...
                <td width="57" rowspan="2" align="center" valign="middle" class="tblheading">Difference in Seed Stock</td>
