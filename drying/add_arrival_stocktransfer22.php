...
<title>Drying- Transaction - Arrival Stock Transfer-Plant</title>
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#adad11" >
	  ...
	  <table width="820" border="0" cellpadding="0" cellspacing="0" bordercolor="#adad11" style="border-bottom:solid; border-bottom-color:#adad11" >
	    <tr >
	      <td width="820" height="25" class="Mainheading">&nbsp;Transaction - Arrival Stock Transfer - Plant</td>
	    </tr></table></td>
...
<td align="center" width="100" valign="middle" class="tblbutn" style="cursor:Pointer;"><?php if($flg==0 && $flg1==0 && $flg2==0) { ?><a href="add_arrival_stocktransfer.php" style="text-decoration:none; color:#000000">Add </a><?php } else { ?><a href="Javascript:void(0);" onClick="alert('Can not perform Transaction.\nReason:\n1. Todays date is not in Active Current Financial Year.\n2. Transaction after todays date has been made.\n3. Cycle Inventory transaction is under process.');" style="text-decoration:none; color:#000000">Add </a><?php } ?></td>
</tr>
</table></td>
...
$sql_arr_home=mysqli_query($link,"select * from tblarrival where plantcode='".$plantcode."' and   arrival_type='StockTransfer Arrival' and arrtrflag=1") or die(mysqli_error($link));
...
$targetpage = $_SERVER['PHP_SELF']; 
  ...
  $sql_arr_home=mysqli_query($link,"select * from tblarrival where plantcode='".$plantcode."' and   arrival_date >='$tdate' and arrival_date <='$pdate' and arrival_type='StockTransfer Arrival' and arrtrflag=1 order by arrival_date desc, arr_code desc LIMIT $start, $limit") or die(mysqli_error($link));
 $tot_arr_home=mysqli_num_rows($sql_arr_home);
...
$query = "select * from tblarrival where plantcode='".$plantcode."' and   arrival_date >='$tdate' and arrival_date <='$pdate' and arrival_type='StockTransfer Arrival' and arrtrflag=1 order by arrival_date desc, arr_code desc";
...
// if($tot_arr_home >0) { $total_results3 =mysqli_query($link,"SELECT COUNT(*)  FROM tblarrival where  plantcode='".$plantcode."' and   arrtrflag=1"),0);
 $srno=($page-1)*$limit+1;
/*if(!isset($_GET['page'])) { 
		$page = 1; 
		$srno=1;
...
$sql_arr_home=mysqli_query($link,"select * from tblarrival where plantcode='".$plantcode."' and   arrival_date >='$tdate' and arrival_date <='$pdate' and arrival_type='StockTransfer Arrival' and arrtrflag=1 order by arrival_date desc, arr_code desc LIMIT $from, $max_results") or die(mysqli_error($link));
$tot_arr_home=mysqli_num_rows($sql_arr_home);

$total_results3 =mysqli_query($link,"SELECT COUNT(*)  FROM tblarrival where  plantcode='".$plantcode."' and   arrival_date >='$tdate' and arrival_date <='$pdate'  and arrival_type='StockTransfer Arrival' and arrtrflag=1");
$total_results2 = mysqli_fetch_array($total_results3);
$total_results = $total_results2[0]; 
*/
    if($tot_arr_home >0) { 
...
<tr class="Light" height="20">
  <td colspan="6" align="center" class="tblheading">Arrival from Stock Transfer-Plant </td>
</tr>
</table>
<table align="center" border="1" cellspacing="0" cellpadding="0" width="970" bordercolor="#adad11" style="border-collapse:collapse">
            ...
            <tr class="tblsubtitle" height="20">
			 ...
			 <td width="9%" align="center" valign="middle" class="tblheading">Transaction Id</td>
              <td width="12%" align="center" valign="middle" class="tblheading">Stock Transfer from Plant</td>
...
while($row_arr_home=mysqli_fetch_array($sql_arr_home))
{
	...
	$crop=""; $variety=""; $lotno=""; $bags=""; $qty=""; $stage=""; $got=""; $qc=""; $got1="";
...
$quer3=mysqli_query($link,"SELECT * FROM tblcrop  where cropid='".$row_tbl_sub['lotcrop']."'"); 
	...
	//$crop=$row31['cropname'];
		...
		if($got!="")
		{
		$got=$got."<br>".$row_tbl_sub['got']." ".$row_tbl_sub['got1'];
		}
		else
		{
		$got=$row_tbl_sub['got']." ".$row_tbl_sub['got1'];
		}
		/*if($got1!="")
		{
...
?>			  
<tr class="Light">
         <td width="4%" align="center" valign="middle" class="smalltblheading"><?php echo $srno;?></td>
		   <td width="6%" align="center" valign="middle" class="smalltblheading"><?php echo $trdate;?></td>
         <td width="9%" align="center" valign="middle" class="smalltblheading"><a href="add_arrival_stock_viewpage.php?cropid=<?php echo $row_arr_home['arrival_id'];?>"><?php echo "AS".$row_arr_home['arr_code']."/".$yearid_id."/".$lrole;?></a></td>
		  <td width="12%" align="center" valign="middle" class="smalltblheading"><?php echo $row3['business_name'];?></td>
         <td width="11%" align="center" valign="middle" class="smalltblheading"><?php echo $crop;?></td>
         <td width="13%" align="center" valign="middle" class="smalltblheading"><?php echo $variety;?></td>
         ...
         <td width="5%" align="center" valign="middle" class="smalltblheading"><?php echo $qty?></td>
         <td width="6%" align="center" valign="middle" class="smalltblheading"><?php echo $stage?></td>
              <td width="6%" align="center" valign="middle" class="smalltblheading"><?php echo $qc?></td>
			   <td width="8%" align="center" valign="middle" class="smalltblheading"><?php echo $got?></td>
         <td width="4%" align="center" valign="middle" class="smalltblheading"><a href="Javascript:void(0)" onClick="openslocpopprint('<?php echo $row_arr_home['arrival_id'];?>');">STRN</a></td>
</tr>
<?php
}
else
