...
$sql_tbl_sub=mysqli_query($link,"select * from tbl_dryarrival_sub where plantcode='".$plantcode."' and   arrsub_id='".$a."'") or die(mysqli_error($link));
...
$sql_spc=mysqli_query($link,"select * from tblspcodes where plantcode='".$plantcode."' and spcodem='".$row_tbl_sub['spcodem']."' and spcodef='".$row_tbl_sub['spcodef']."'") or die(mysqli_error($link));
...
<tr class="Dark" height="25">
 ...
 <td align="left"  valign="middle" class="tbltext">&nbsp;<input name="qc2"  type="checkbox" class="tbltext" tabindex="0" <?php if($row_tbl_sub['qcsample']!=""){ echo "checked";} ?>style="background-color:#CCCCCC" value="1"/></td>
 <td align="right"  valign="middle" class="tblheading">QC Status&nbsp;</td>
...
<td width="173" align="right" valign="middle" class="tblheading">Seed Status-Drying&nbsp;</td>
<td width="258" align="left" valign="middle" class="tblheading">&nbsp;<input name="sstatus" type="text" size="6" class="tblheading" tabindex=""  maxlength="6"  value="D" style="background-color:#CCCCCC" readonly="true"></td>
</tr>
...
<td align="right"  valign="middle" class="tblheading">Lot No.&nbsp;</td>
 <td align="left"  valign="middle" class="tblheading" colspan="3" >&nbsp;<input name="glotno" type="text" size="20" class="tbltext" tabindex="0"  readonly="true"  style="background-color:#CCCCCC" value="<?php echo $row_tbl_sub['lotno'];?>" maxlength="20"/><input type="hidden" name="gln" value="<?php echo $tp1?>/<?php echo $row_tbl_sub['old'];?>/00000/00" /></td>
</tr>
</table>
<table align="center" border="1" width="950" cellspacing="0" cellpadding="0" bordercolor="#adad11" style="border-collapse:collapse" >
  <tr class="tblsubtitle" height="20">
...
//$ba=0;
//$up=0;
$sql_sub_sloc=mysqli_query($link,"select * from tbl_dryarr_sloc where plantcode='".$plantcode."' and   arr_id='".$a."' order by arrsloc_id") or die(mysqli_error($link));
$tot_sub_sloc=mysqli_num_rows($sql_sub_sloc);
/*$sql_sub_sloc1=mysqli_query($link,"select whid,binid,subbin from tbl_dryarr_sloc where arr_id='".$rid."' and qty_good=0 and ups_good=0") or die(mysqli_error($link));
...
$sql_whouse=mysqli_query($link,"select perticulars from tbldrywarehouse where plantcode='".$plantcode."' and   whid='".$row_sub_sloc['whid']."' order by perticulars") or die(mysqli_error($link));
$row_whouse=mysqli_fetch_array($sql_whouse);
$wareh=$row_whouse['perticulars'];

$sql_binn=mysqli_query($link,"select binname from tbldrybin where plantcode='".$plantcode."' and   binid='".$row_sub_sloc['binid']."' and whid='".$row_sub_sloc['whid']."'") or die(mysqli_error($link));
$row_binn=mysqli_fetch_array($sql_binn);
$binn=$row_binn['binname'];

$sql_subbinn=mysqli_query($link,"select sname from tbldrysubbin where plantcode='".$plantcode."' and   sid='".$row_sub_sloc['subbin']."' and binid='".$row_sub_sloc['binid']."' and whid='".$row_sub_sloc['whid']."'") or die(mysqli_error($link));
...
?>
  <tr class="Light" height="30" >
    ...
    <?php
$bing1_query=mysqli_query($link,"select binid, binname from tbldrybin where plantcode='".$plantcode."' and   whid='".$row_sub_sloc['whid']."' order by binname") or die(mysqli_error($link));
?>
    ...
    <?php
$subbing1_query=mysqli_query($link,"select sid, sname from tbldrysubbin where plantcode='".$plantcode."' and   whid='".$row_sub_sloc['whid']."' and binid='".$row_sub_sloc['binid']."' order by sname") or die(mysqli_error($link));
?>
...
?>
  <tr class="Light" height="30" >
    ...
    <?php
$bing1_query=mysqli_query($link,"select binid, binname from tbldrybin where plantcode='".$plantcode."'  order by binname") or die(mysqli_error($link));
?>
    ...
    <?php
$subbing1_query=mysqli_query($link,"select sid, sname from tbldrysubbin where plantcode='".$plantcode."'  order by sname") or die(mysqli_error($link));
?>
...
?>
  <tr class="Light" height="30"  >
    ...
    <?php
$bing2_query=mysqli_query($link,"select binid, binname from tbldrybin where plantcode='".$plantcode."'  order by binname") or die(mysqli_error($link));
?>
    ...
    <?php
$subbing2_query=mysqli_query($link,"select sid, sname from tbldrysubbin where plantcode='".$plantcode."'  order by sname") or die(mysqli_error($link));
?>
