...
*/
$s_good_new=mysqli_query($link,"select distinct lotldg_whid, lotldg_subbinid, lotldg_binid from tbl_lot_ldg where plantcode='".$plantcode."' and   lotldg_subbinid='".$row_sub_sloc['subbin']."' and lotldg_lotno='".$row_tbl_sub['lotno']."'") or die(mysqli_error($link));
//$r_good_new=mysqli_fetch_array($s_good_new);
$row_issueg_new=mysqli_fetch_array($s_good_new);

	$sql_issueg1_new=mysqli_query($link,"select max(lotldg_id) from tbl_lot_ldg where plantcode='".$plantcode."' and   lotldg_subbinid='".$row_issueg_new['lotldg_subbinid']."' and lotldg_binid='".$row_issueg_new['lotldg_binid']."' and lotldg_whid='".$row_issueg_new['lotldg_whid']."' and lotldg_lotno='".$row_tbl_sub['lotno']."'") or die(mysqli_error($link));
...
while($row_issueg_new11=mysqli_fetch_array($s_good_new11))
{
	...
	$sql_sub_sloc11=mysqli_query($link,"select * from tblarr_sloc where plantcode='".$plantcode."' and   whid='".$row_issuetblg_new11['lotldg_whid']."' and binid='".$row_issuetblg_new11['lotldg_binid']."' and subbin='".$row_issuetblg_new11['lotldg_subbinid']."' and arr_id='".$a."' order by arrsloc_id") or die(mysqli_error($link));
...
$s_good_new=mysqli_query($link,"select distinct lotldg_whid, lotldg_subbinid, lotldg_binid from tbl_lot_ldg where plantcode='".$plantcode."' and   lotldg_subbinid='".$row_issuetblg_new11['lotldg_subbinid']."'") or die(mysqli_error($link));
//$r_good_new=mysqli_fetch_array($s_good_new);
$row_issueg_new=mysqli_fetch_array($s_good_new);
