...
?>
&nbsp;<select class="tbltext" id="<?php echo $nid;?>" name="<?php echo $id;?>" style="width:80px;" <?php if($b=="bing1"){?>onchange="bin1(this.value);"<?php }if($b=="bing2"){?>onchange="bin2(this.value);"<?php }if($b=="bing3"){?>onchange="bin3(this.value);"<?php }if($b=="bind1"){?>onchange="bin4(this.value);"<?php }if($b=="bind2"){?>onchange="bin5(this.value);"<?php } ?>   >
