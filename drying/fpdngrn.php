...
if($typ=="organiser")
{
$sql_tbl_sub11=mysqli_query($link,"select * from tbl_dryarrival_sub where plantcode='".$plantcode."' and   arrival_id='".$tid."' and organiser='".$typval."'") or die(mysqli_error($link));
}
else if($typ=="farmer")
{
$sql_tbl_sub11=mysqli_query($link,"select * from tbl_dryarrival_sub where plantcode='".$plantcode."' and   arrival_id='".$tid."' and farmer='".$typval."'") or die(mysqli_error($link));
}
else 
{
$sql_tbl_sub11=mysqli_query($link,"select * from tbl_dryarrival_sub where plantcode='".$plantcode."' and   arrival_id='".$tid."'") or die(mysqli_error($link));
}
...
if($typ=="organiser")
{
$sql_tbl_sub=mysqli_query($link,"select * from tbl_dryarrival_sub where plantcode='".$plantcode."' and   arrival_id='".$arrival_id."' and organiser='".$typval."'") or die(mysqli_error($link));
}
else if($typ=="farmer")
{
$sql_tbl_sub=mysqli_query($link,"select * from tbl_dryarrival_sub where plantcode='".$plantcode."' and   arrival_id='".$arrival_id."' and farmer='".$typval."'") or die(mysqli_error($link));
}
else 
{
...
?>
<tr class="Light" height="20">
    <td width="3%" align="right" valign="middle" class="tblheading" colspan="7">Total&nbsp;&nbsp;</td>
    ...
    <td width="6%" align="center" valign="middle" class="tblheading"><?php echo $tanob;?></td>
    <td width="6%" align="center" valign="middle" class="tblheading"><?php echo $taqty;?></td>
