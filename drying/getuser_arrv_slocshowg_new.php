...
$sql_item=mysqli_query($link,"select * from tbl_stores where plantcode='".$plantcode."' and   items_id='".$f."'") or die(mysqli_error($link));
...
$sql_whouse=mysqli_query($link,"select perticulars from tbldrywarehouse where plantcode='".$plantcode."' and   whid='".$row_issuetbl['lotldg_whid']."'") or die(mysqli_error($link));
$row_whouse=mysqli_fetch_array($sql_whouse);
$wareh=$row_whouse['perticulars'];

$sql_binn=mysqli_query($link,"select binname from tbldrybin where plantcode='".$plantcode."' and   binid='".$row_issuetbl['lotldg_binid']."' and whid='".$row_issuetbl['lotldg_whid']."'") or die(mysqli_error($link));
$row_binn=mysqli_fetch_array($sql_binn);
$binn=$row_binn['binname'];

$sql_subbinn=mysqli_query($link,"select sname from tbldrysubbin where plantcode='".$plantcode."' and   sid='".$row_issuetbl['lotldg_subbinid']."' and binid='".$row_issuetbl['lotldg_binid']."' and whid='".$row_issuetbl['lotldg_whid']."'") or die(mysqli_error($link));
...
?>
  <tr class="Light" height="30" >
    ...
    <?php
$bing1_query=mysqli_query($link,"select binid, binname from tbldrybin where plantcode='".$plantcode."' ") or die(mysqli_error($link));
?>
    ...
    <?php
$subbing1_query=mysqli_query($link,"select sid, sname from tbldrysubbin where plantcode='".$plantcode."' ") or die(mysqli_error($link));
?>
...
?>
  <tr class="Light" height="30"  >
    ...
    <?php
$bing2_query=mysqli_query($link,"select binid, binname from tbldrybin where plantcode='".$plantcode."' ") or die(mysqli_error($link));
?>
    ...
    <?php
$subbing2_query=mysqli_query($link,"select sid, sname from tbldrysubbin where plantcode='".$plantcode."' ") or die(mysqli_error($link));
?>
