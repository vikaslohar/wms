...
<title>Drying-Report -Period Wise Unidentified Report</title>
...
winHandle=window.open('report_unidentified2.php?sdate='+sdate+'&edate='+edate,'WelCome','top=20,left=80,width=1000,height=900,scrollbars=yes');
if(winHandle==null){
...
$sdate = $_REQUEST['sdate'];
	...
	$sql_arr_home=mysqli_query($link,"select * from tblarrival where plantcode='".$plantcode."' and   arrival_type='Unidentified' and  arrival_date <= '$edate' and arrival_date >= '$sdate' and arrtrflag=1 order by arrival_date asc ") or die(mysqli_error($link));
$tot_arr_home=mysqli_num_rows($sql_arr_home);
	
	/*$total_results3 =mysqli_query($link,"SELECT COUNT(*)  FROM tblarrival where  plantcode='".$plantcode."' and   arrival_date <= '$edate' and ardate >= '$arrival_date' and arrtrflag=1");
...
<table align="center" border="0" cellspacing="0" cellpadding="0" width="974" style="border-collapse:collapse">
  ...
  <table  border="1" cellspacing="0" cellpadding="0" width="750" bordercolor="#adad11" style="border-collapse:collapse" align="center">
<tr class="tblsubtitle" height="25">
			<td width="19" align="center" valign="middle" class="tblheading">#</td>
			<td width="64" align="center" valign="middle" class="tblheading">Date </td>
			<td width="103"  align="center" valign="middle" class="tblheading">Crop</td>
			<td width="38"  align="center" valign="middle" class="tblheading">Lot No.</td>
			...
			<td width="84" align="center" valign="middle" class="tblheading" >Stage</td>
			<td width="80" align="center" valign="middle" class="tblheading" > QC status</td>
			...
			<td width="103" align="center" valign="middle" class="tblheading">SLOC</td>
</tr>
