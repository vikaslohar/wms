<?php
	...
	if(isset($_POST['frm_action'])=='submit')
	{
		...
		echo "<script>window.location='verified_sr_report1.php?sdate=$sdate&edate=$edate&txtcrop=$crop&txtvariety=$veriety&txtptype=$txtptype&txtpp=$txtpp&txtstatesl=$txtstatesl&txtppname=$txtppname&txtcity=$txtcity'</script>";	
	}
...
<tr class="tblsubtitle" height="20">
  <td colspan="6" align="center" class="tblheading">Periodical Periodical Verified Sales Return Report</td>
</tr>
