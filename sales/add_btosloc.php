...
<?php
	...
	*/
	$sql_code="SELECT MAX(btsl_tcode) FROM tbl_srbtslmain where plantcode='$plantcode' AND btsl_yearcode='$yearid_id'  ORDER BY btsl_tcode DESC";
	$res_code=mysqli_query($link,$sql_code)or die(mysqli_error($link));
	...
	$sql_code2="SELECT MAX(btsl_trefno) FROM tbl_srbtslmain where plantcode='$plantcode' AND btsl_yearcode='$yearid_id' ORDER BY btsl_trefno DESC";
	...
	if(mysqli_num_rows($res_code2) > 0)
	{
		...
		$t_code2=$row_code2['0'];
		$code2=$t_code2+1;
		$code12=$pltcode.$yearid_id.sprintf("%00005d",$code);
	}
	else
	{
		$code2=1;
...
<tr class="tblsubtitle" height="20">
    <td align="center" valign="middle" class="tblheading" colspan="6" >Barcode to SLOC Linking</td>
</tr>
<tr class="Light" height="20">
	...
	<td width="114" align="left" valign="middle" class="smalltbltext">&nbsp;<?php echo date("d-m-Y");?> </td>
