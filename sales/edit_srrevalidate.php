<?php
	...
	if(isset($_POST['frm_action'])=='submit')
	{
		...
		$sql_sub="update tbl_srrevalidate set srrv_date='$date', srrv_crop='$crop', srrv_variety='$variety', srrv_lotno='$lotno', srrv_ups='$upssize', srrv_enop='$enop', srrv_eqty='$eqty', srrv_qc='$qcsts', srrv_dot='$dot', srrv_got='$got', srrv_got1='$got1', srrv_dogt='$dogt', srrv_rvpsrn='$txtpsrno', srrv_dorvp='$dcdate', srrv_qcnop='$txtnopqc', srrv_bnop='$txtbnop', srrv_bqty='$txtbqty', srrv_valperiod='$validityperiod', srrv_valupto='$validityupto', srrv_valdays='$valdays', srrv_slable='$slable', srrv_elable='$elable', srrv_tcode='$tcode', srrv_logid='$logid', srrv_yearcode='$yearid_id', srrv_pid='$sid' where srrv_id='$pid'";
		if(mysqli_query($link,$sql_sub) or die(mysqli_error($link)))
		{
			$subid=$pid;
			$s_del="delete from tbl_srrevalidate_sub where srrv_id='$subid'";
		...
		//exit;
		echo "<script>window.location='add_srrevalidate_preview.php?p_id=$subid&sid=$sid'</script>";	
	}
...
<form name="frmaddDepartment" method="post" action="<?php $_SERVER['PHP_SELF']; ?>"   > 
	...
	<input type="hidden" name="tcode" value="<?php echo $row_tbl['srrv_tcode'];?>" />
...
<td width="267"  align="left" valign="middle" class="tbltext">&nbsp;<?php echo "TRV".$row_tbl['srrv_tcode']."/".$row_tbl['srrv_yearcode']."/".$row_tbl['srrv_logid'];?></td>
...
<td align="left" valign="middle" class="tbltext">&nbsp;<?php echo $noticia['cropname'];?><input type="hidden" name="crop" value="<?php echo $row_tbl['srrv_crop'];?>" /></td>
<td align="right"  valign="middle" class="tblheading">Variety&nbsp;</td>
<td align="left"  valign="middle" class="tbltext">&nbsp;<?php echo $noticia_item['popularname'];?><input type="hidden" name="variety" value="<?php echo $row_tbl['srrv_variety'];?>" /></td>
</tr>
<tr class="Light" height="30">
<td align="right"  valign="middle" class="tblheading">Lot Number&nbsp;</td>
<td align="left"  valign="middle" class="tbltext">&nbsp;<?php echo $row_tbl['srrv_lotno'];?><input type="hidden" name="lotno" value="<?php echo $row_tbl['srrv_lotno'];?>" /></td>
<td width="229" align="right"  valign="middle" class="tblheading">UPS&nbsp;</td>
<td width="251" align="left"  valign="middle" class="tbltext">&nbsp;<?php echo $row_tbl['srrv_ups'];?><input type="hidden" name="upssize" value="<?php echo $row_tbl['srrv_ups'];?>" /></td>
</tr>
<?php
...
<td align="left" width="267" valign="middle" class="tbltext">&nbsp;<?php echo $row_tbl['srrv_enop'];?><input type="hidden" name="enop" value="<?php echo $row_tbl['srrv_enop'];?>" /></td>	
<td align="right" width="229" valign="middle" class="tblheading">Qty&nbsp;</td>
<td align="left" width="251" valign="middle" class="tbltext">&nbsp;<?php echo $row_tbl['srrv_eqty'];?><input type="hidden" name="eqty" value="<?php echo $row_tbl['srrv_eqty'];?>" /></td>	
</tr>
<tr class="Light" height="30" >
<td align="right"   valign="middle" class="tblheading">QC Status&nbsp;</td>
<td align="left"  valign="middle" class="tbltext">&nbsp;<?php echo $row_tbl['srrv_qc'];?><input type="hidden" name="qcsts" value="<?php echo $row_tbl['srrv_qc'];?>" /></td>	
...
<td align="left"  valign="middle" class="tbltext"   >&nbsp;<?php echo $row_tbl['srrv_got'];?><input type="hidden" name="got" value="<?php echo $row_tbl['srrv_got'];?>" /></td>
...
<td width="170" align="left" valign="middle" class="tblheading">&nbsp;<input type="text" name="txtpsrno" id="txtpsrtno" class="smalltbltext" value="<?php echo $row_tbl['srrv_rvpsrn'];?>" size="15"  />&nbsp;<font color="#FF0000" >* </font>&nbsp;</td>
...
<td width="170" align="left" valign="middle" class="tblheading">&nbsp;<input type="text" name="txtnopqc" id="txtnopqc" class="smalltbltext" value="<?php echo $row_tbl['srrv_qcnop'];?>" size="2" onchange="psrnchk(this.value);" onkeypress="return isNumberKey(event)"  />&nbsp;<font color="#FF0000" >* </font>&nbsp;</td>
<td width="107" align="right" valign="middle" class="tblheading">Balance Pouches&nbsp;</td>
<td width="108" align="left" valign="middle" class="tblheading">&nbsp;<input type="text" name="txtbnop" id="txtbnop" class="smalltbltext" value="<?php echo $row_tbl['srrv_bnop'];?>" size="9" readonly="true" style="background-color:#CCCCCC" /></td>
<td align="right" valign="middle" class="tblheading">Balance Quantity&nbsp;</td>
<td width="148" align="left" valign="middle" class="tblheading" id="pltno">&nbsp;<input type="text" name="txtbqty" id="txtbqty" class="smalltbltext" value="<?php echo $row_tbl['srrv_bqty'];?>" size="9" readonly="true" style="background-color:#CCCCCC" /></td>
</tr>
<tr class="Light" height="25">
...
<option <?php if($row_tbl['srrv_valperiod']==9) echo "Selected";?> value="9" >9</option>
<option <?php if($row_tbl['srrv_valperiod']==6) echo "Selected";?> value="6" >6</option>
<option <?php if($row_tbl['srrv_valperiod']==3) echo "Selected";?> value="3" >3</option>
</select>&nbsp;Months&nbsp;<font color="#FF0000" >* </font>&nbsp;</td>
<td width="107" align="right" valign="middle" class="tblheading">Valid upto&nbsp;</td>
<td width="108" align="left" valign="middle" class="tblheading">&nbsp;<input type="text" class="tbltext" name="validityupto" id="validityupto" value="<?php echo $dov;?>" size="12" readonly="true" style="background-color:#ECECEC"  /></td>
<td width="112" align="right" valign="middle" class="tblheading">Validity Days&nbsp;</td>
<td width="148" align="left" valign="middle" class="tblheading">&nbsp;<input type="text" name="valdays" id="valdays" size="4" class="tblheading" value="<?php echo $row_tbl['srrv_valdays'];?>" readonly="true" style="background-color:#ECECEC; color:#FF0000" />&nbsp;From DoT</td>
</tr>
<tr class="Light" height="25">  
<?php 
$x=implode(",", str_split($row_tbl['srrv_slable']));
$y=implode(",", str_split($row_tbl['srrv_elable']));
$x=explode(",", $x);
$y=explode(",", $y);
...
?>
  <tr class="Light" height="30" >
    <td width="100" align="center"  valign="middle" class="smalltbltext">&nbsp;<select class="smalltbltext" name="txtslwhg<?php echo $srno?>" style="width:70px;" onchange="wh(this.value,<?php echo $srno?>);"  >
          ...
          <option <?php if($row_sub['srrvs_whid']==$noticia_whg1['whid']) echo "selected";?> value="<?php echo $noticia_whg1['whid'];?>" />  
          <?php echo $noticia_whg1['perticulars'];?>
          <?php } ?>
        </select>&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
    <?php
$bing1_query=mysqli_query($link,"select binid, binname from tbl_bin where plantcode='$plantcode' AND whid='".$row_sub['srrvs_whid']."' order by binname") or die(mysqli_error($link));
?>
    <td width="93" align="center"  valign="middle" class="smalltbltext" id="bing<?php echo $srno?>">&nbsp;<select class="smalltbltext" name="txtslbing<?php echo $srno?>" style="width:60px;" onchange="bin(this.value,<?php echo $srno?>);" >
          ...
          <option <?php if($row_sub['srrvs_binid']==$noticia_bing1['binid']) echo "selected";?> value="<?php echo $noticia_bing1['binid'];?>" />  
          <?php echo $noticia_bing1['binname'];?>
          <?php } ?>
        </select>&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
    <?php
$subbing1_query=mysqli_query($link,"select sid, sname from tbl_subbin where plantcode='$plantcode' AND whid='".$row_sub['srrvs_whid']."' and binid='".$row_sub['srrvs_binid']."' order by sname") or die(mysqli_error($link));
?>
    <td width="113" align="center"  valign="middle" class="smalltbltext" id="sbing<?php echo $srno?>">&nbsp;<select class="smalltbltext" name="txtslsubbg<?php echo $srno?>" style="width:80px;" onchange="subbin(this.value,<?php echo $srno?>);"  >
          ...
          <option <?php if($row_sub['srrvs_sbinid']==$noticia_subbing1['sid']) echo "selected";?> value="<?php echo $noticia_subbing1['sid'];?>" />  
      ...
      <table align="center" height="30" width="100%"  border="1" cellspacing="0" cellpadding="0" bordercolor="#a8a09e" style="border-collapse:collapse" >
        <tr>
          ...
          <td  align="left" width="94"  valign="middle" class="smalltbltext">&nbsp;<input name="txtslBagsg<?php echo $srno?>" id="ups<?php echo $srno?>" type="text" size="4" class="smalltbltext" tabindex="" maxlength="4" onkeypress="return isNumberKey1(event)" onchange="Bagsf<?php echo $srno?>(this.value);" value="<?php echo $row_sub['srrvs_nop'];?>"  />
            &nbsp;<font color="#FF0000">*</font>&nbsp;</td>
          <td  align="right" width="44"  valign="middle" class="tblheading">&nbsp;Qty &nbsp;</td>
          <td width="106" align="left"  valign="middle" class="smalltbltext">&nbsp;<input name="txtslqtyg<?php echo $srno?>" id="qty<?php echo $srno?>" type="text" size="9" class="smalltbltext" tabindex="" maxlength="9" onkeypress="return isNumberKey(event)" onchange="qtyf<?php echo $srno?>(this.value);" value="<?php echo $row_sub['srrvs_qty'];?>"  />
            &nbsp;<font color="#FF0000">*</font>&nbsp;</td>
        </tr>
      </table>
    </div></td>
