<?php
	...
	if(isset($_POST['frm_action'])=='submit')
	{
		...
		echo "<script>window.location='packseed_bal_sr_report1.php?txtcrop=$crop&txtvariety=$veriety'</script>";	
	}
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#a8a09e" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#a8a09e" style="border-bottom:solid; border-bottom-color:#a8a09e" >
	    <tr >
	      <td width="813" height="25" class="Mainheading">&nbsp;Report - Pack seeds Balance Sales Return Repor</td>
	    </tr></table></td>
...
<tr class="tblsubtitle" height="20">
  <td colspan="6" align="center" class="tblheading">Pack seeds Balance Sales Return Report</td>
</tr>
...
?>
 <tr class="Light" height="25">
    <td width="171" align="right"  valign="middle" class="tblheading">Crop&nbsp;</td>
    <td width="273" align="left"  valign="middle" class="tbltext" >&nbsp;<select class="tbltext" name="txtcrop" style="width:170px;" onchange="modetchk(this.value)">
...
?>
  ...
  <tr class="Dark" height="25">
 <?php
$quer5=mysqli_query($link,"SELECT * FROM `tbl_qctest` where plantcode='$plantcode'"); 
?>
    <td align="right"  valign="middle" class="tblheading" >QC Status&nbsp;</td>
    <td align="left"  valign="middle" class="tbltext" id="vitem" >&nbsp;<select class="tbltext" id="itm" name="txtvariety" style="width:170px;" >
          <option value="ALL" selected>--ALL--</option>
          <?php while($noticia_item = mysqli_fetch_array($sql_month)) { ?>
          <option value="<?php echo $noticia_item['qcstatus'];?>" />  
          <?php echo $noticia_item['qcstatus'];?>
          <?php } ?>
        </select>
      <font color="#FF0000">*</font>&nbsp;</td>
  </tr>
