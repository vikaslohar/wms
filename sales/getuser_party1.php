...
if($a!="Export Buyer")
{
	if($a=="C" || $a=="C&F" || $a=="CandF")
	{
		if($b!="ALL")
		{
			//echo "select * from tbl_partymaser where location_id='".$b."' and classification='".$z."' order by business_name";
		...
		{
			//echo "select * from tbl_partymaser where classification='".$z."' order by business_name";
			$sql_month=mysqli_query($link,"select * from tbl_partymaser where classification='".$z."' order by business_name")or die(mysqli_error($link));
		}
	}
	else
	{
		...
		{
			//echo "select * from tbl_partymaser where classification='".$a."' order by business_name";
...
?>&nbsp;<select class="tbltext" id="txtppname" name="txtppname" style="width:220px;"  >
