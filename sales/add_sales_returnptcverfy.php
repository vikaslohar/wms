<?php
	...
	if(isset($_POST['frm_action'])=='submit')
	{
		...
		echo "<script>window.location='add_sales_returnptcverfy_preview.php?pid=$pid'</script>";	
	}
...
<title>Sales Return - Transaction - Sales Return - Verification</title>
...
{	
	...
	{
		if(document.frmaddDepartment.sritmrecsts.value=="")
		{
			alert("Please Select SR Item Received Yes/No");
			f=1;
			document.getElementById('postbutn').disabled=false;
			return false;
		}
		if(document.frmaddDepartment.sritmrecsts.value=="No")
		{
			if(confirm("You have selected Sales Return Item Received Status as NO\n\nDo you want to Post the Record?")==true)
			{
				f=1;
	...
	if(f==0)
	{
		dt3=getDateObject(document.frmaddDepartment.dogt.value,"-");
		...
		document.frmaddDepartment.sritmrecsts.value="Yes"
		...
		if(document.frmaddDepartment.lotchecko.value == 0)
		{
			...
			document.frmaddDepartment.stcode2o.value="";
			document.frmaddDepartment.stcode.value="";
			document.frmaddDepartment.stcode2.value="";
			document.frmaddDepartment.stcodeo.focus();
			return false;
		}
		if(document.frmaddDepartment.txtsrtyp.value=="")
		{
		...
		if(document.frmaddDepartment.txtnopd.value=="")
		{
			alert("Please enter NoP");
			document.frmaddDepartment.txtnopd.focus();
			fl=1;
			document.getElementById('postbutn').disabled=false;
			return false;
		}
		...
		if(document.frmaddDepartment.txtqtydc2.value=="")
		{
		...
		if(document.frmaddDepartment.txtgstat.value=="")
		{
			...
			document.frmaddDepartment.qcrequest.focus();
			fl=1;
			document.getElementById('postbutn').disabled=false;
			return false;
		}
		if(document.frmaddDepartment.qcsreq.value=="")
		{
			alert("Please Select GOT Status");
			document.frmaddDepartment.qcsreq.focus();
			fl=1;
			document.getElementById('postbutn').disabled=false;
			return false;
		}
		if(document.frmaddDepartment.qcrequest.value=="OK" && document.frmaddDepartment.dogt.value=="")
		{
		...
		if(document.frmaddDepartment.dogt.value!="")
		{
			if(dt3 > dt4)
			{
		...
		var q7="";
		var q8="";
		g=document.frmaddDepartment.txtqtydc.value;
		
		if(parseFloat(g) > 0)
		{
			if(document.frmaddDepartment.txtsrtyp.value=="P2P")
			{
		...
		d=document.frmaddDepartment.txtqtydc2.value;
		if(parseFloat(d) > 0)
		{
		...
		if(d=="")d=0;
		var qtyd=parseFloat(d1)+parseFloat(d2);
		
		if(parseFloat(g)!=parseFloat(qtyg))
		{
			alert("Please check. Quantity in Good is not matching with Quantity distributed in Bins");
			document.getElementById('postbutn').disabled=false;
			f=1;
			return false;
		}
		...
		{
			alert("Please check. Quantity in Damage is not matching with Quantity distributed in Bins");
			document.getElementById('postbutn').disabled=false;
			f=1;
			return false;
		}
...
function showslocbins()
{
	...
	var tpys=document.frmaddDepartment.tpys.value;
	showUser(stage,'subsubdivgood','slocshowsubgood',clasid,itmid,lotno,subid,dmgqty,goodqty,tpys);
}
...
{ 
	...
	if(whno>1)
	{
		...
		{
			var bing="bing"+whno;
			if(document.frmaddDepartment.txtsrtyp.value=="P2C")
				showUser(wh1val,bing,'wh1',bing,'','','','');
			else
...
function bin(bin1val, binno)
{
	...
	if(document.getElementsByName(whi)[0].value!="")
	{
		...
		if(document.frmaddDepartment.txtsrtyp.value=="P2C")
			showUser(bin1val,sbing,'bin1',txtslsubbg,'','','','');
		else
...
{	
	...
	{	
		...
		else if(document.frmaddDepartment.txtsrtyp.value=="P2P")
		...
		if(document.frmaddDepartment.txtsrtyp.value=="P2C")
			showUser(subbin1val,slocrow,'subbin1',itemv,txtslsubbg,slocnogood,Bagsv1,qtyv1,trid);
		else
...
{
	document.frmaddDepartment.rettype.value="Sales Return - ";
	if(document.frmaddDepartment.lotchecko.value == 0)
	{
		alert("Lot Number not present in System");
...
function lot2chko(lotchval)
{
	...
	else if(document.frmaddDepartment.txtlot2o.value=="00000")
	{
		alert("Invalid Lot Number");
		document.frmaddDepartment.txtlot2o.value="";
		document.frmaddDepartment.txtlot2o.focus();
		document.frmaddDepartment.stcodeo.value="";
		document.frmaddDepartment.stcode2o.value="";
		document.frmaddDepartment.txtlot2.value="";
		document.frmaddDepartment.stcode.value="";
...
function stchko()
{
	document.frmaddDepartment.lotchecko.value='';
	...
	{
		document.frmaddDepartment.stcode.value=document.frmaddDepartment.ltnn.value;
		document.frmaddDepartment.ltnflg.value=0;
		var val1=document.frmaddDepartment.pcodeo.value;
		var val2=document.frmaddDepartment.ycodeeo.value;
		var val3=document.frmaddDepartment.txtlot2o.value;
		var val4=document.frmaddDepartment.stcodeo.value;
		...
		if(document.frmaddDepartment.stcode2o.value!="")
		{
			if(document.frmaddDepartment.itmdchk2.value!="")
			{	
				var val12=document.frmaddDepartment.pcode.value;
				var val22=document.frmaddDepartment.ycodee.value;
				var val32=document.frmaddDepartment.txtlot2.value;
				var val42=document.frmaddDepartment.stcode.value;
				var val62=document.frmaddDepartment.stcode2.value;
				var lot2=val12+val22+val32+"/"+val42+"/"+val62;
				
				var arry=document.frmaddDepartment.itmdchk2.value.split(",");
				if (arry.indexOf(lot2) > -1) {
					document.frmaddDepartment.stcode.value=document.frmaddDepartment.ltnn2.value;
					document.frmaddDepartment.ltnflg.value=1;
					document.getElementById('lotnewsr').innerHTML="Temporary Lot Number";
				} else {
					document.frmaddDepartment.stcode.value=document.frmaddDepartment.ltnn.value;
					document.frmaddDepartment.ltnflg.value=0;
					document.getElementById('lotnewsr').innerHTML="";
				}
			}
			var clasid=document.frmaddDepartment.txtcrop.value;
			var itmid=document.frmaddDepartment.txtvariety.value;
...
function stchko2()
{
	//alert(document.frmaddDepartment.lotchecko.value);
	if(document.frmaddDepartment.lotchecko.value!="" && document.frmaddDepartment.lotchecko.value == 0)
	{
		alert("Lot Number not present in System");
		document.frmaddDepartment.stcodeo.value="";
		document.frmaddDepartment.stcode2o.value="";
	...
	else
	{
		...
		var itmid=document.frmaddDepartment.txtvariety.value;
		showUser(lot,'lotchko','lotchko',val1,val2,val3,val4,val6,clasid,itmid);
		setTimeout(function(){if(document.frmaddDepartment.lotchecko.value == 0)
		{
			alert("Lot Number not present in System");
			document.frmaddDepartment.stcodeo.value="";
			document.frmaddDepartment.stcode2o.value="";
...
function qtchk(qcsrval)
{
	...
	{
		alert("Please select GOT Type");
		document.frmaddDepartment.qcrequest.value;
		document.frmaddDepartment.txtgstat.focus();
		return false;
	}
	else
	{
		document.frmaddDepartment.qcrequest.value=qcsrval;
		var lotno=document.frmaddDepartment.pcode.value+document.frmaddDepartment.ycodee.value+document.frmaddDepartment.txtlot2.value+"/"+document.frmaddDepartment.stcode.value;
...
function upchk(npval,ttyp)
{
	...
	if(document.frmaddDepartment.txtupsdc.value!="")
	{
		...
		{
			/*if(document.frmaddDepartment.lotupschko.value=="" && parseInt(npval) > 0)
			{
				alert("Invalid UPS selected. Lot No. not packed in this UPS Size.");
				document.frmaddDepartment.txtnopdc.value="";
				document.frmaddDepartment.txtupsdc.focus();
				f=1;
				return false;
			...
			{
				var x=document.frmaddDepartment.lotupschko.value.split(",");
				var z=0;
				for(var i=0; i<x.length; i++)
				{
					if(document.frmaddDepartment.txtupsdc.value!=x[i])z++;
				}
				if(z==x.length && parseInt(npval) > 0)
				{
					alert("Invalid UPS selected. Lot No. not packed in this UPS Size.");
					document.frmaddDepartment.txtnopdc.value="";
					document.frmaddDepartment.txtupsdc.focus();
	...
	{
		document.frmaddDepartment.txtnopdc2.value=parseInt(document.frmaddDepartment.txtnopd.value)-(parseInt(document.frmaddDepartment.txtnopdc.value));
		...
		if(document.frmaddDepartment.txtupstyp.value=="Standard")
		{
			...
			document.frmaddDepartment.txtqtydc2.value=parseFloat(document.frmaddDepartment.txtqtyd.value)-(parseFloat(document.frmaddDepartment.txtqtydc.value));
			document.frmaddDepartment.txtqtydc2.value=parseFloat(document.frmaddDepartment.txtqtydc2.value).toFixed(3);
			...
			document.frmaddDepartment.txtqtydc3.value=parseFloat(document.frmaddDepartment.txtqtydc3.value).toFixed(3);
		}
		else
		{
			document.frmaddDepartment.txtqtydc2.value=parseFloat(document.frmaddDepartment.txtqtyd.value)-(parseFloat(document.frmaddDepartment.txtqtydc.value));
...
function upchk2(npval,ttyp)
{
	...
	else
	{
		...
		if(document.frmaddDepartment.txtupstyp.value=="Standard")
		{
			...
			document.frmaddDepartment.txtqtydc2.value=Math.round((parseFloat(npval)*parseFloat(pt))*1000)/1000;
			document.frmaddDepartment.txtqtydc2.value=parseFloat(document.frmaddDepartment.txtqtydc2.value).toFixed(3);
			document.frmaddDepartment.txtqtydc3.value=parseFloat(document.frmaddDepartment.txtqtyd.value)-(parseFloat(document.frmaddDepartment.txtqtydc.value)+parseFloat(document.frmaddDepartment.txtqtydc2.value));
			document.frmaddDepartment.txtqtydc3.value=parseFloat(document.frmaddDepartment.txtqtydc3.value).toFixed(3);
		}
...
function nopschk(qtval,ttyp)
{
	...
	if(document.frmaddDepartment.txtupsdc.value!="")
	{
		if(document.frmaddDepartment.txtupstyp.value=="Standard")
		{
			/*if(document.frmaddDepartment.lotupschko.value=="" && parseInt(qtval) > 0)
			{
				alert("Invalid UPS selected. Lot No. not packed in this UPS Size.");
				document.frmaddDepartment.txtqtydc.value="";
				document.frmaddDepartment.txtqtydc.focus();
			...
			else
			{
				...
				if(z==x.length && parseInt(qtval) > 0)
				{
					alert("Invalid UPS selected. Lot No. not packed in this UPS Size.");
					document.frmaddDepartment.txtqtydc.value="";
					document.frmaddDepartment.txtqtydc.focus();
...
function nopschk2(qtval,ttyp)
{
	...
	else
	{
		...
		if(document.frmaddDepartment.txtupstyp.value=="Standard")
		{
			...
			{
				pt=(1000/parseFloat(ups[0]));
				document.frmaddDepartment.txtnopdc2.value=parseFloat(qtval)*parseInt(pt);
			}
			else
			{
				pt=ups[0];
			...
			var x=document.frmaddDepartment.txtnopdc2.value.split(".");
			if(parseInt(x[1]) > 0)
			{
				alert("Invalid NoP.\n\nNoP cannot be in decimal value");
				document.frmaddDepartment.txtnopdc2.value="";
...
function upschks(npval)
{
	var f=0;
	if(document.frmaddDepartment.stcodeo.value=="")
	{
		alert("Please enter Lot Number");
		document.frmaddDepartment.txtnopd.value="";
		document.frmaddDepartment.stcodeo.focus();
		f=1;
		return false;
	}
	...
	else
	{
		if(document.frmaddDepartment.txtupstyp.value=="Standard")
		{
			...
			document.frmaddDepartment.txtqtyd.value=Math.round((parseFloat(npval)*parseFloat(pt))*1000)/1000;
		}
		else
		{
...
function tnopchks(qtval)
{
	...
	else
	{
		if(document.frmaddDepartment.txtupstyp.value=="Standard")
		{
			...
			{
				pt=(1000/parseFloat(ups[0]));
				document.frmaddDepartment.txtnopd.value=parseFloat(qtval)*parseInt(pt);
			}
			else
			{
				pt=ups[0];
			...
			var x=document.frmaddDepartment.txtnopd.value.split(".");
			if(parseInt(x[1]) > 0)
			{
				alert("Invalid NoP.\n\nNoP cannot be in decimal value");
				document.frmaddDepartment.txtnopd.value="";
...
function sritrecchk(srirval)
{
	document.frmaddDepartment.sritmrecsts.value=srirval;
	if(srirval=="Yes")
	{
		document.getElementById('postverrec').style.display="block";
		document.getElementById('subsubdivgood').innerHTML="";
	}
	else
	{
		document.getElementById('postverrec').style.display="none";
		document.getElementById('subsubdivgood').innerHTML="<table align='center' width='950' cellpadding='5' cellspacing='5' border='0' ><tr><td valign='top' align='right'><img src='../images/post.gif' border='0' style='display:inline;cursor:pointer;'  onclick='pform();' id='postbutn' />&nbsp;&nbsp;</td></tr></table>";
	}
}
</script>
<body>
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#a8a09e" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#a8a09e" style="border-bottom:solid; border-bottom-color:#a8a09e" >
	    <tr >
	      <td width="813" height="25" class="Mainheading">&nbsp;Transaction - Sales Return - Verification</td>
	    </tr></table></td>
...
<tr >
<td valign="top" align="right"><a href="home_returnptc.php" tabindex="20"><img src="../images/back.gif" border="0"style="display:inline;cursor:pointer;"  /></a>&nbsp;&nbsp;<input name="Submit" type="image" src="../images/preview.gif" alt="Submit Value"  border="0" style="display:inline;cursor:pointer;" tabindex="" onClick="return mySubmit();">&nbsp;&nbsp;</td>
</tr>
</table>
</td><td width="30"></td>
</tr>
