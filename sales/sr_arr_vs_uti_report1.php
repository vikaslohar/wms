  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#a8a09e" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#a8a09e" style="border-bottom:solid; border-bottom-color:#a8a09e" >
	    <tr >
	      <td width="813" height="25" class="Mainheading">&nbsp;Report - Sales Return Arrival Vs Utilisation Report</td>
	    </tr></table></td>
...
<tr class="light" height="20">
  <td align="center" class="tblheading">Sales Return Arrival Vs Utilisation Report</td>
</tr>
</table>
<table align="center" border="0" width="850" cellspacing="0" cellpadding="0" bordercolor="#a8a09e" style="border-collapse:collapse" > 
<tr class="light" height="20">
...
<tr class="tblsubtitle" height="25">
	<td width="70" height="31" align="Center" class="tblheading">Crop</td>
	<td width="70" align="Center" class="tblheading">Variety</td>
	<td width="79" align="Center" class="tblheading">Qty Arrived</td>
	<td width="81" align="Center" class="tblheading">Qty Packed</td>
	<td width="92" align="Center" class="tblheading">Qty Discarded</td>
	<td width="141" align="Center" class="tblheading">Balance Available Qty</td>
	<td width="76" align="Center" class="tblheading">Ok</td>
	<td width="94" align="Center" class="tblheading">RT/UT</td>
	<td width="127" align="Center" class="tblheading">Fail</td>

	</tr>
<tr height="25">
	<td width="70" align="Center" class="tblheading">&nbsp;</td>
	<td width="70" align="Center" class="tblheading">&nbsp;</td>
	<td width="79" align="Center" class="tblheading">&nbsp;</td>
	<td width="81" align="Center" class="tblheading">&nbsp;</td>
	<td width="92" align="Center" class="tblheading">&nbsp;</td>
	<td width="141" align="Center" class="tblheading">&nbsp;</td>
	<td width="76" align="Center" class="tblheading">&nbsp;</td>
	<td width="94" align="Center" class="tblheading">&nbsp;</td>
	<td width="127" align="Center" class="tblheading">&nbsp;</td>
</tr>
<tr height="25">
	<td width="70" align="Center" class="tblheading">&nbsp;</td>
	<td width="70" align="Center" class="tblheading">&nbsp;</td>
