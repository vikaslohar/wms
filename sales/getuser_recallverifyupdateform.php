...
//frm_action=submit&txt11=&txt14=&txtid=&logid=SR1&slrgln1=&txtconchk=&txtptype=&txtcountrysl=&txtcountryl=&sstage=&date=06-08-2014&plantcodes=D%2CH&yearcodes=A%2CD%2CF%2CK%2CN%2CS&rbcrefno=DF00001&pcodeo=--Select--&ycodeeo=--Select--&txtlot2o=&stcodeo=&stcode2o=00&barcode=DF010000021&txtbarcode=DF010000021&txtpacktype=SMC&txtedop=11-07-2014&txtcrop1=24&txtvariety1=445&txtelotn1=DF04078%2F00000%2F00P&txteups1=1.000%20Kgs&txtenop1=60&txteqty1=60&txteqc1=OK&smplno1=&txtedot1=14-06-2014&txtegerm1=87&txtemoist1=11.40&txtepp1=Acceptable&txtegottyp1=GOT-NR%20UT&txtedgot1=00-00-0000&txtedov1=13-03-2015&srrno=1&maintrid=1&subtrid=0&subsubtrid=0&ptp=&ptp1=60&wtmp=&wtnop=&otnop=&otqty=&ocrp=&overty=barc&oups=1&sreciptyp=vernew&maintrid=1&subtrid=&subsubtrid=0&ptp=&ptp1=&wtmp=&wtnop=&ocrp=undefined&overty=undefined&vtyp=vernew&oups=undefined
...
$sql_salesvr_subsub=mysqli_query($link,"select * from tbl_salesrvsub_sub2 where plantcode='$plantcode' AND salesrs_id ='".$row_tbl_sub['salesrs_id']."'") or die(mysqli_error($link));
while($row_salesvr_subsub=mysqli_fetch_array($sql_salesvr_subsub))
{
$dnop=$dnop+$row_salesvr_subsub['salesrss_nob'];
$dqty=$dqty+$row_salesvr_subsub['salesrss_qty'];
}
...
<tr class="Light" height="20">
	...
	<td align="center" valign="middle" class="smalltbltext"><?php echo ($acnop+$dnop)-$nob;?></td>
	<td align="center" valign="middle" class="smalltbltext"><?php echo ($acqty+$dqty)-$qty;?></td>
