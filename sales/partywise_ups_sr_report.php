<?php
	...
	if(isset($_POST['frm_action'])=='submit')
	{
		...
		echo "<script>window.location='sr_party_ws_ups_st_report1.php?sdate=$sdate&edate=$edate&txtcrop=$crop&txtvariety=$veriety&txtups=$ups&txtptype=$txtptype&txtcountryl=$txtcountryl&txtpp=$txtpp&txtstatesl=$txtstatesl&locationname=$locationname&txtstfp=$txtstfp'</script>";	
	}
...
<tr class="tblsubtitle" height="20">
  <td colspan="6" align="center" class="tblheading">Periodical Party And UPS wise Sales Return Report</td>
</tr>
...
?>
  ...
  <tr class="Dark" height="25">
    <?php
$quer5=mysqli_query($link,"SELECT * FROM `tblups`"); 
?>
    <td align="right"  valign="middle" class="tblheading" >UPS&nbsp;</td>
    <td align="left"  valign="middle" class="tbltext" id="ups" >&nbsp;<select class="tbltext" id="itm" name="txtups" style="width:170px;" >
          <option value="ALL" selected>--ALL--</option>
          <?php while($noticia_item = mysqli_fetch_array($sql_month)) { ?>
          <option value="<?php echo $noticia_item['varietyid'];?>" />  
          <?php echo $noticia_item['popularname'];?>
