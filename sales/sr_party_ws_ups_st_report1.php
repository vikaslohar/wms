...
<title>Sales Return - Periodical Party And UPS wise Sales Return Report</title>
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#a8a09e" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#a8a09e" style="border-bottom:solid; border-bottom-color:#a8a09e" >
	    <tr >
	      <td width="813" height="25" class="Mainheading">&nbsp;Report - Periodical Party And UPS wise Sales Return Report</td>
	    </tr></table></td>
...
<tr class="light" height="20">
  <td align="center" class="tblheading">Periodical Party And UPS wise Sales Return Report</td>
</tr>
</table>
<table align="center" border="0" width="750" cellspacing="0" cellpadding="0" bordercolor="#a8a09e" style="border-collapse:collapse" > 
<tr class="light" height="20">
...
?>
<tr class="light" height="20">
  <td width="25%" align="left" class="tblheading">&nbsp;&nbsp;Crop:&nbsp;<?php echo $crp;?></td>
  <td width="25%" align="right" class="tblheading">Variety:&nbsp;<?php echo $variet;?>&nbsp;&nbsp;</td>
  <td width="50%" align="right" class="tblheading">UPS:&nbsp;<?php echo $variet;?>&nbsp;&nbsp;</td>
</tr>
</table>
...
<tr class="tblsubtitle" height="25">
	...
	<td width="160" align="Center" class="tblheading">Lot No.</td>
	<td width="210" align="Center" class="tblheading">Actual Good</td>
	<td width="80" align="Center" class="tblheading">Party DC No.</td>
	<td width="80" align="Center" class="tblheading">Party Date</td>
	<td width="80" align="Center" class="tblheading">Pass In No.</td>
	<td width="80" align="Center" class="tblheading">Transport Name</td>
	<td width="80" align="Center" class="tblheading">Lr / Vehicle no.</td>
	<td width="80" align="Center" class="tblheading">DoV</td>
	<td width="80" align="Center" class="tblheading"> Verification Date</td>
	</tr>
<?php
$srno=1; $mid=""; $cnt=0;
...
{
$cropn=""; $varietyn=""; $totqty=0; $okqty=0; $failqty=0; $utqty=0; $lotnc=""; $lotnp=""; $lttn="";
$sql_srretsub2=mysqli_query($link,"select distinct salesrs_newlot, salesrs_rettype from tbl_salesrv_sub where plantcode='$plantcode' AND salesrs_variety='".$row_srrets['salesrs_variety']."' and salesrs_vflg=1 and salesr_id IN ($mid)") or die(mysqli_error($link));
...
$sql_srretsub=mysqli_query($link,"select * from tbl_salesrv_sub where plantcode='$plantcode' AND salesrs_variety='".$row_srrets['salesrs_variety']."' and salesrs_newlot IN($lttn) and salesrs_vflg=1") or die(mysqli_error($link));
...
<tr >
<td valign="top" align="center"><a href="partywise_ups_sr_report.php"><img src="../images/back.gif" border="0"style="display:inline;cursor:pointer;"  /></a>&nbsp;&nbsp;<img src="../images/printpreview.gif" onclick="openprint()" style="cursor:pointer" border="0" /></td>
</tr>
</table>
</td><td width="30"></td>
</tr>
