...
?>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#adad11" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#adad11" style="border-bottom:solid; border-bottom-color:#adad11" >
	    <tr >
	      <td width="813" height="25">&nbsp;Daily Seed Conditioning Report</td>
	    </tr></table></td>
	  </tr>
	  </table></td></tr>
...
<tr class="tblsubtitle" height="20">
			...
			<td width="97"  align="center" valign="middle" class="tblheading">Raw Seed  Qty </td>
			 <td width="10%" align="center" valign="middle" class="tblheading" colspan="2">Conditioned Seed </td>
			 <td width="97"  align="center" valign="middle" class="tblheading" colspan="2">Remnat</td>
			 <td width="97" align="center" valign="middle" class="tblheading" colspan="2">Inter Matter </td>
			 <td width="97" align="center" valign="middle" class="tblheading" colspan="2">Condititon Loss </td>
			 <td width="97" align="center" valign="middle" class="tblheading" colspan="2">Total Loss </td>
