<?php
	...
	//exit;
		...
		$rettype=trim($_POST['txtrecallreason']);
		...
		$txtrecrefno=trim($_POST['txtrecrefno']);
		
		$edate1=explode("-",$dcdate);
		$dot=$edate1[2]."-".$edate1[1]."-".$edate1[0];
		
		$sql_main="update tbl_salesrv set salesr_dcno='$txtdcno', salesr_dcdate='$dot', salesr_partytype='$txtpp', salesr_state='$txtstatesl', salesr_loc='$locationname', salesr_party='$txtstfp', salesr_tmode='$txt1', salesr_tname='$txttname', salesr_lrno='$txtlrn', salesr_vehno='$txtvn', salesr_pmode='$txt13', salesr_cname='$txtcname', salesr_docket='$txtdc', salesr_pname='$txtpname', salesr_retryp='$rettype', salesr_dnop='$txtdcnopbox', salesr_dnop1='$txtacnopbox', salesr_nob='$txtdcnobag', salesr_nob1='$txtacnopbag', salesr_tnop='$txtdcnopto', salesr_tnop1='$txtacnopto', salesr_recallrefno='$txtrecrefno' where salesr_id = '$p_id'";
		mysqli_query($link,$sql_main) or die(mysqli_error($link));
		
		echo "<script>window.location='add_sales_recall_preview.php?pid=$p_id'</script>";	
	}
...
{	
	...
	if(document.frmaddDepartment.txtrecallreason.value=="")
	{
		alert("Please enter Cartons / Bags");
		document.frmaddDepartment.txtrecallreason.focus();
		fl=1;
		return false;
	}
	...
	if(document.frmaddDepartment.txtslBagsd1.value=="" || parseInt(document.frmaddDepartment.txtslBagsd2.value)<=0)
	{
...
function clk(opt)
{
	...
	{
		alert("Please Select Party Type");
		for(var i=0; i<document.frmaddDepartment.txt1.length; i++)
		{
	...
	if(document.frmaddDepartment.txtrecallreason.value=="")
	{
		alert("Please Select Reason for Recall");
		for(var i=0; i<document.frmaddDepartment.txt1.length; i++)
		{
			document.frmaddDepartment.txt1[i].checked=false;
		}
...
{	
	if(document.frmaddDepartment.txtacnopto.value==0)
	{
		alert("Please enter Cartons / Bags");
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#a8a09e" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#a8a09e" style="border-bottom:solid; border-bottom-color:#a8a09e" >
	    <tr >
	      <td width="813" height="25" class="Mainheading">&nbsp;Transaction - Sales Recall - Edit</td>
	    </tr></table></td>
...
<form id="mainform" name="frmaddDepartment" method="post" action="<?php $_SERVER['PHP_SELF']; ?>" onsubmit="return mySubmit();"   > 
	 ...
	 <input name="txt11" value="<?php echo $row_tbl['salesr_tmode'];?>" type="hidden"> 
	    <input name="txt14" value="<?php echo $row_tbl['salesr_pmode'];?>" type="hidden"> 
		<input type="hidden" name="txtid" value="<?php echo $row_tbl['salesr_tcode']?>" />
		<input type="hidden" name="logid" value="<?php echo $logid?>" />
		<input type="hidden" name="slrgln1" value="<?php echo $row_tbl['salesr_tslrno']?>" />
		<input type="hidden" name="txtconchk" value="" />
		<input type="hidden" name="txtptype" value="<?php echo $row_tbl['salesr_partytype'];?>" />
		<input type="hidden" name="txtcountrysl" value="<?php if($row_tbl['salesr_partytype']=="Export Buyer") echo salesr_loc; else echo "";?>" />
		<input type="hidden" name="txtcountryl" value="<?php if($row_tbl['salesr_partytype']=="Export Buyer") echo salesr_loc; else echo "";?>" />
...
<tr class="tblsubtitle" height="20">
  <td colspan="6" align="center" class="tblheading">Sales Recall - Edit</td>
</tr>
...
<td width="239" align="left" valign="middle" class="tbltext">&nbsp;<input name="date" type="text" size="10" class="tbltext" tabindex="0" readonly="true"  style="background-color:#CCCCCC" value="<?php echo $tdate;?>" maxlength="10"/>&nbsp;</td>
</tr>
<tr class="Dark" height="30">
<td width="205" align="right" valign="middle" class="tblheading">&nbsp;Recall BC Linking Ref. No.&nbsp;</td>
<td align="left" valign="middle" class="tbltext" colspan="3">&nbsp;<input name="txtrecrefno" type="text" size="10" class="tbltext" tabindex="0" value="<?php echo $row_tbl['salesr_recallrefno'];?>" maxlength="10"/>&nbsp;</td>
</tr>
<tr class="Light" height="30">
<td width="205" align="right" valign="middle" class="tblheading">Party DC Date&nbsp;</td>
<td align="left" valign="middle" class="tbltext">&nbsp;<input name="dcdate" id="dcdate" type="text" size="10" class="tbltext" tabindex="0" readonly="true"  style="background-color:#CCCCCC" value="<?php echo $tdate1;?>" maxlength="10"/>&nbsp;<a href="javascript:void(0)" onClick="showCalendar('dcdate');" tabindex="6"><img src="../images/cal.gif" alt="Calender" border="0" align="absmiddle"></a><script type="text/javascript" language="javascript" src="../include/popcalender.js"></script> </td>

	<td align="right"  valign="middle" class="tblheading">Party DC No.&nbsp;</td>
    <td align="left"  valign="middle" class="tbltext">&nbsp;<input name="txtdcno" type="text" size="20" class="tbltext" tabindex="" maxlength="20" onchange="dcdchk();" value="<?php echo $row_tbl['salesr_dcno'];?>" />&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
</tr>
<?php
...
<option value="" selected>--Select--</option>
	<?php while($noticia = mysqli_fetch_array($quer3)) { ?>
		<option <?php if($row_tbl['salesr_partytype']==$noticia['classification']) echo "selected";?> value="<?php echo $noticia['classification'];?>" />   
		<?php echo $noticia['classification'];?>
		<?php } ?>
	</select>&nbsp;&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
<td align="right"  valign="middle" class="tblheading">Reasons for Recall&nbsp;</td>
    <td align="left"  valign="middle" class="tbltext">&nbsp;<select class="tbltext" name="txtrecallreason" style="width:120px;" >
<option value="" >--Select--</option>
<option <?php if($row_tbl['salesr_retryp']=="Quality Issues") echo "Selected";?> value="Quality Issues" >Quality Issues</option>
<option <?php if($row_tbl['salesr_retryp']=="Stock Shifting") echo "Selected";?> value="Stock Shifting" >Stock Shifting</option>
<option <?php if($row_tbl['salesr_retryp']=="In-Transit Cancellation") echo "Selected";?> value="In-Transit Cancellation">In-Transit Cancellation</option>
</select>&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
           </tr>
</table>
...
<?php while($ro_states=mysqli_fetch_array($sq_states)) {?>
	<option value="<?php echo $ro_states['state_name'];?>" <?php if($row_tbl['salesr_state']==$ro_states['state_name']){ echo "Selected";} ?>  ><?php echo $ro_states['state_name'];?></option>
<?php } ?>  
          
	</select>&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
<?php
$sql_month=mysqli_query($link,"select * from tblproductionlocation where state='".$row_tbl['salesr_state']."' order by productionlocation")or die(mysqli_error($link));
?>	
...
<?php while($noticia = mysqli_fetch_array($sql_month)) { ?>
		<option <?php if($row_tbl['salesr_loc']==$noticia['productionlocationid']) echo "selected";?> value="<?php echo $noticia['productionlocationid'];?>" />   
		<?php echo $noticia['productionlocation'];?>
		<?php } ?>
</select>&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
  </tr><input type="hidden" name="locationname" value="<?php echo $row_tbl['salesr_loc'];?>" />
</table>
<?php
}
else
...
<option value="" >--Select--</option>
<?php while($noticia = mysqli_fetch_array($sql_month)) { ?>
		<option <?php if($row_tbl['salesr_loc']==$noticia['country']) echo "selected";?> value="<?php echo $noticia['country'];?>" />   
...
if($row_tbl['salesr_partytype']!="Export Buyer")
{
$sql_month=mysqli_query($link,"select * from tbl_partymaser where location_id='".$row_tbl['salesr_loc']."' and classification='".$row_tbl['salesr_partytype']."' order by business_name")or die(mysqli_error($link));
}
else
{
...
$c=$noticia123['c_id'];
$sql_month=mysqli_query($link,"select * from tbl_partymaser where country='".$c."' and classification='".$row_tbl['salesr_partytype']."' order by business_name")or die(mysqli_error($link));
}
$addr="";
?>		   
<table align="center" border="1" width="850" cellspacing="0" cellpadding="0" bordercolor="#a8a09e" style="border-collapse:collapse" >   
...
<?php while($noticia = mysqli_fetch_array($sql_month)) { ?>
		<option <?php if($row_tbl['salesr_party']==$noticia['p_id']) { echo "selected"; $addr=$noticia['address']; if($noticia['city']!="") { $addr=$addr.", ".$noticia['city']; } $addr=$addr.", ".$noticia['state']; }?> value="<?php echo $noticia['p_id'];?>" />   
...
<td align="left"  valign="middle" class="tbltext" colspan="3" id="vaddress"><div align="justify" class="tbltext" style="padding:2px 5px 5px 5px"><?php echo $addr;?></div><input type="hidden" name="adddchk" value="" /></td>
</tr>
</table>
</div>	
...
<td width="275" align="left"  valign="middle" class="tbltext">&nbsp;<input name="txtdcnopac" type="text" size="10" class="tbltext" tabindex=""   maxlength="5" onkeypress="return isNumberKey(event)" onchange="ptchk(this.value);" value="<?php echo $row_tbl['salesr_dcnop'];?>" />&nbsp;<font color="#FF0000">*</font>&nbsp;</td>

<td width="121" align="right"  valign="middle" class="tblheading">Type of Packages&nbsp;</td>
<td width="239" align="left"  valign="middle" class="tbltext">&nbsp;<select class="tbltext" name="txtpackagetyp" style="width:70px;" onchange="dcnpchk(this.value);" >
<option value="" selected="selected">Select</option>
<option <?php if($row_tbl['salesr_packtyp']=="Bags") echo "selected";?> value="Bags">Bags</option>
<option <?php if($row_tbl['salesr_packtyp']=="Cartons") echo "selected";?> value="Cartons" >Cartons</option>
<option <?php if($row_tbl['salesr_packtyp']=="Both") echo "selected";?> value="Both">Both</option>
</select>&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
</tr>-->
<tr class="Light" height="25">
<td width="205" align="right"  valign="middle" class="tblheading">&nbsp;Recall Mode&nbsp;</td>
 <td width="639" colspan="3" align="left"  valign="middle" class="tbltext" ><input name="txt1" type="radio" class="tbltext" value="Transport" onClick="clk(this.value);" <?php if($row_tbl['salesr_tmode']=="Transport") echo "checked";?> />Transport&nbsp;<input name="txt1" type="radio" class="tbltext" value="Courier" onClick="clk(this.value);" <?php if($row_tbl['salesr_tmode']=="Courier") echo "checked";?> />Courier&nbsp;<input name="txt1" type="radio" class="tbltext" value="By Hand" onClick="clk(this.value);" <?php if($row_tbl['salesr_tmode']=="By Hand") echo "checked";?> />Hand Delivery&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
</tr>
</table>
...
<td align="left"  valign="middle" class="tbltext" style="border-color:#a8a09e">&nbsp;<input name="txttname" type="text" size="20" class="tbltext" tabindex="" maxlength="20" value="<?php echo $row_tbl['salesr_tname'];?>" />  &nbsp;<font color="#FF0000">*</font>&nbsp;</td>
<td width="121" align="right"  valign="middle" class="tblheading" style="border-color:#a8a09e">Lorry Receipt No&nbsp;</td>
<td align="left" width="239" valign="middle" class="tbltext" colspan="3" style="border-color:#a8a09e">&nbsp;<input name="txtlrn" type="text" size="15" class="tbltext" tabindex=""  maxlength="15" value="<?php echo $row_tbl['salesr_lrno'];?>" />&nbsp;</td>
</tr>

<tr class="Light" height="25">
<td align="right" width="205" valign="middle" class="tblheading" style="border-color:#a8a09e">&nbsp;Vehicle No&nbsp;</td>
<td align="left" width="275" valign="middle" class="tbltext"  style="border-color:#a8a09e">&nbsp;<input name="txtvn" type="text" size="12" class="tbltext" tabindex="" maxlength="12" value="<?php echo $row_tbl['salesr_vehno'];?>"  />&nbsp;<font color="#FF0000">*</font>&nbsp; </td>
...
<option value="" selected="selected">Select</option>
<option <?php if($row_tbl['salesr_pmode']=="TBB") echo "selected";?> value="TBB">TBB</option>
<option <?php if($row_tbl['salesr_pmode']=="ToPay") echo "selected";?> value="ToPay" >To Pay</option>
<option <?php if($row_tbl['salesr_pmode']=="Paid") echo "selected";?> value="Paid">Paid</option>
...
<td align="left" width="275" valign="middle" class="tbltext" style="border-color:#a8a09e">&nbsp;<input name="txtcname" type="text" size="20" class="tbltext" tabindex=""  maxlength="20" value="<?php echo $row_tbl['salesr_cname'];?>" />&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
<td align="right" width="121" valign="middle" class="tblheading" style="border-color:#a8a09e">&nbsp;Docket No.&nbsp;</td>
<td align="left" width="239" valign="middle" class="tbltext" colspan="3" style="border-color:#a8a09e">&nbsp;<input name="txtdc" type="text" size="15" class="tbltext" tabindex="" maxlength="15" value="<?php echo $row_tbl['salesr_docket'];?>"   />&nbsp;<font color="#FF0000">*</font></td>
</tr>
...
<td width="639" colspan="8" align="left" valign="middle" class="tbltext" style="border-color:#a8a09e">&nbsp;<input name="txtpname" type="text" size="30" class="tbltext" tabindex=""  maxlength="30" value="<?php echo $row_tbl['salesr_pname'];?>" />&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
</tr>
...
<td width="275" align="center"  valign="middle" class="tbltext"><input name="txtdcnopbox" type="text" size="10" class="tbltext" tabindex=""   maxlength="5" onkeypress="return isNumberKey(event)" onchange="ptchk(this.value);" value="<?php echo $row_tbl['salesr_dnop'];?>"/>&nbsp;<font color="#FF0000">*</font></td>
<td width="121" align="center"  valign="middle" class="tblheading"><input name="txtacnopbox" type="text" size="10" class="tbltext" tabindex=""   maxlength="5" onkeypress="return isNumberKey(event)" onchange="dcnpchk(this.value);" value="<?php echo $row_tbl['salesr_dnop1'];?>"/>&nbsp;<font color="#FF0000">*</font></td>
<td width="239" align="center"  valign="middle" class="tblheading"><input name="txtesnobox" type="text" size="10" class="tbltext" tabindex=""   maxlength="5" readonly="true" style="background-color:#CCCCCC" value="<?php echo $row_tbl['salesr_dnop1']-$row_tbl['salesr_dnop'];?>" /></td>
</tr>
<tr class="Light" height="30">
<td align="right"  valign="middle" class="tblheading">No. of Bags&nbsp;</td>
<td width="275" align="center"  valign="middle" class="tbltext"><input name="txtdcnobag" type="text" size="10" class="tbltext" tabindex=""   maxlength="5" onkeypress="return isNumberKey(event)" onchange="ptchk2(this.value);" value="<?php echo $row_tbl['salesr_nob'];?>"/>&nbsp;<font color="#FF0000">*</font></td>
<td width="121" align="center"  valign="middle" class="tblheading"><input name="txtacnopbag" type="text" size="10" class="tbltext" tabindex=""   maxlength="5" onkeypress="return isNumberKey(event)" onchange="dcnpchk2(this.value);" value="<?php echo $row_tbl['salesr_nob1'];?>"/>&nbsp;<font color="#FF0000">*</font></td>
<td width="239" align="center"  valign="middle" class="tblheading"><input name="txtesnopbag" type="text" size="10" class="tbltext" tabindex=""   maxlength="5" readonly="true" style="background-color:#CCCCCC" value="<?php echo $row_tbl['salesr_nob1']-$row_tbl['salesr_nob'];?>" /></td>
</tr>
<tr class="Light" height="30">
<td align="right"  valign="middle" class="tblheading">Total Packages&nbsp;</td>
<td width="275" align="center"  valign="middle" class="tbltext"><input name="txtdcnopto" type="text" size="10" class="tbltext" tabindex=""   maxlength="5" readonly="true" style="background-color:#CCCCCC" value="<?php echo $row_tbl['salesr_tnop'];?>"  />&nbsp;&nbsp;&nbsp;</td>
<td width="121" align="center"  valign="middle" class="tblheading"><input name="txtacnopto" type="text" size="10" class="tbltext" tabindex=""   maxlength="5" readonly="true" style="background-color:#CCCCCC" value="<?php echo $row_tbl['salesr_tnop1'];?>" />&nbsp;&nbsp;&nbsp;</td>
<td width="239" align="center"  valign="middle" class="tblheading"><input name="txtesnopto" type="text" size="10" class="tbltext" tabindex=""   maxlength="5" readonly="true" style="background-color:#CCCCCC" value="<?php echo $row_tbl['salesr_tnop1']-$row_tbl['salesr_tnop'];?>" /></td>
</tr>
</table>
<br />
...
<table align="center" width="850" cellpadding="5" cellspacing="5" border="0" >
<tr >
<td valign="top" align="right"><a href="home_recall.php" tabindex="20"><img src="../images/cancel.gif" border="0"style="display:inline;cursor:hand;" onclick="return confirm('Do You wish to Cancel this Transaction?');" /></a>&nbsp;&nbsp;<input name="Submit" type="image" src="../images/preview.gif" alt="Submit Value"  border="0" style="display:inline;cursor:hand;" tabindex="" onClick="return mySubmit();">&nbsp;&nbsp;</td>
</tr>
</table>
</td><td width="30"></td>
</tr>
