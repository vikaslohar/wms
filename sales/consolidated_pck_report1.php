  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#a8a09e" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#a8a09e" style="border-bottom:solid; border-bottom-color:#a8a09e" >
	    <tr >
	      <td width="813" height="25" class="Mainheading">&nbsp;Report - Consolidated Packaging Report</td>
	    </tr></table></td>
...
<tr class="light" height="20">
  <td align="center" class="tblheading">Consolidated Packaging Report</td>
</tr>
</table>
<table align="center" border="0" width="850" cellspacing="0" cellpadding="0" bordercolor="#a8a09e" style="border-collapse:collapse" > 
<tr class="light" height="20">
...
<tr class="tblsubtitle" height="25">
	<td width="123" height="31" align="Center" class="tblheading">Machine Code</td>
	<td width="121" align="Center" class="tblheading">Crop</td>
	<td width="138" align="Center" class="tblheading">Variety</td>
	<td width="148" align="Center" class="tblheading"></td>
	<td width="128" align="Center" class="tblheading">UPS</td>
	<td width="178" align="Center" class="tblheading">Qty</td>

	</tr>
<tr height="25">
	<td width="123" align="Center" class="tblheading">&nbsp;</td>
	<td width="121" align="Center" class="tblheading">&nbsp;</td>
	<td width="138" align="Center" class="tblheading">&nbsp;</td>
	<td width="148" align="Center" class="tblheading">&nbsp;</td>
	<td width="128" align="Center" class="tblheading">&nbsp;</td>
	<td width="178" align="Center" class="tblheading">&nbsp;</td>
