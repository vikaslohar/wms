  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#a8a09e" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#a8a09e" style="border-bottom:solid; border-bottom-color:#a8a09e" >
	    <tr >
	      <td width="813" height="25" class="Mainheading">&nbsp;Report - Pack Seed P2C Report As on Date <?php echo date("d-m-Y");?></td>
	    </tr></table></td>
...
<tr class="light" height="20">
  <td align="center" class="tblheading">Pack Seed P2C Report As on Date <?php echo date("d-m-Y");?></td>
</tr>
</table>
<?php
...
<tr class="tblsubtitle" height="25">
	...
	<td width="65" align="Center" class="tblheading">Date</td>
	<td width="129" align="Center" class="tblheading">Lot No.</td>
	<td width="129" align="Center" class="tblheading">Bulk Qty Size</td>
	<td width="55" align="Center" class="tblheading">Qty</td>	
	<td width="65" align="Center" class="tblheading">NoB</td>
	<td width="71" align="Center" class="tblheading">Bin Details</td>
	<td width="105" align="Center" class="tblheading">Remarks</td>
</tr>
<?php
...
<tr height="25">
	...
	<td width="129" align="Center" class="tbltext"><?php echo $pksd;?></td>
	...
	<td width="71" align="Center" class="tbltext"><?php echo $packqty;?></td>
	<td width="105" align="Center" class="tbltext"><?php echo $packloss;?></td>
</tr>
<?php
}
else
...
<!--<tr class="Dark">
			...
			<td width="286" colspan="8" align="center" valign="middle" class="tblheading">&nbsp;</td>
</tr>-->
</table>			
<br />
<?php
