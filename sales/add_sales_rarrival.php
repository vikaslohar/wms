  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#a8a09e" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#a8a09e" style="border-bottom:solid; border-bottom-color:#a8a09e" >
	    <tr >
	      <td width="813" height="25" class="Mainheading">&nbsp;Transaction - Sales Return Arrival </td>
	    </tr></table></td>
...
<tr class="tblsubtitle" height="20">
  <td colspan="6" align="center" class="tblheading">Add Sales Return Arrival </td>
</tr>
...
<td width="117" align="right" valign="middle" class="tblheading">&nbsp;Date&nbsp;</td>
<td width="243" align="left" valign="middle" class="tbltext">&nbsp;
  <input name="date" type="text" size="10" class="tbltext" tabindex="0" readonly="true"  style="background-color:#CCCCCC" value="<?php echo date("d-m-Y");?>" maxlength="10"/>&nbsp;<img src="../images/cal.gif" alt="Calender" border="0" align="absmiddle"></a><script type="text/javascript" language="javascript" src="../include/popcalender.js"></script> </td>
</tr>
...
<td align="right"  valign="middle" class="tblheading">Sales Return Party Name&nbsp;</td>
...
<option value="" selected="selected">--Select--</option>
	...
	<td align="right"  valign="middle" class="tblheading">GRN&nbsp;</td>
            ...
            <tr class="tblsubtitle" height="20">
			 ...
			 <td width="17%" align="center" rowspan="3" valign="middle" class="tblheading">Crop</td>
			  ...
			  <td width="9%" rowspan="3" align="center" valign="middle" class="tblheading">UPS</td>
                <td colspan="8"  align="center" valign="middle" class="tblheading">NOP</td>
				  <!--<td width="1%" rowspan="3" align="center" valign="middle" class="tblheading">New Lot No.</td>
			 <td width="17%" align="center" rowspan="3" valign="middle" class="tblheading">Quantity</td>
...
<td align="right"  valign="middle" class="tblheading">No. Of Unit Packs&nbsp;</td>
