<?php
	...
	if(isset($_POST['frm_action'])=='submit')
	{
		...
		echo "<script>window.location='report_srutilisation1.php?sdate=$sdate&edate=$edate&txtcrop=$crop&txtvariety=$veriety'</script>";	
	}
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#a8a09e" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#a8a09e" style="border-bottom:solid; border-bottom-color:#a8a09e" >
	    <tr >
	      <td width="813" height="25" class="Mainheading">&nbsp;Report - Periodical Arrival vs Utilisation Report</td>
	    </tr></table></td>
...
<tr class="tblsubtitle" height="20">
  <td colspan="6" align="center" class="tblheading">Periodical Arrival vs Utilisation Report</td>
</tr>
<tr height="15"><td colspan="6" align="right" class="tblheading"><font color="#FF0000" >* </font>indicates required field&nbsp;</td></tr>
<tr class="Dark" height="25">
<td width="140" height="30" align="right" valign="middle" class="tblheading">&nbsp;Arrival Period&nbsp;&raquo;&nbsp;&nbsp;&nbsp;From&nbsp;</td>
