...
winHandle=window.open('unverify_sr_report2.php?&txtcrop='+itemid+'&txtvariety='+vv+'&sdate='+sdate+'&edate='+edate+'&txtptype='+txtptype+'&txtpp='+txtpp+'&txtstatesl='+txtstatesl+'&txtcity='+txtcity+'&txtppname='+txtppname,'WelCome','top=20,left=80,width=850,height=600,scrollbars=yes');
if(winHandle==null){
...
<tr class="light" height="20">
  <td align="center" class="tblheading">Periodical Non-Verified Sales Return Report</td>
</tr>
</table>
<table align="center" border="0" width="750" cellspacing="0" cellpadding="0" bordercolor="#a8a09e" style="border-collapse:collapse" > 
<tr class="light" height="20">
...
<tr class="tblsubtitle" height="25">
	...
	<td width="210" align="Center" class="tblheading">UPS</td>
...
$sq="select salesr_id from tbl_salesrv where plantcode='$plantcode'and salesr_date<='".$edt."' and salesr_date>='".$sdt."'  ";
if($txtstatesl!="ALL")
{
...
$sql_srretsub2=mysqli_query($link,"select salesr_tslrno, salesr_id, salesr_yearcode, salesr_logid from tbl_salesrv where salesr_id IN ($mid) ") or die(mysqli_error($link));
...
$lotnp=""; $srnno=''; $cropn=""; $varietyn=""; $totqty=0; $okqty=0; $failqty=0; $utqty=0; $lotnc=""; $ups='';
	$srnno="SR".$row_srretsub2['salesr_tslrno']."/".$row_srretsub2['salesr_yearcode']."/".$row_srretsub2['salesr_logid'];
...
<tr >
<td valign="top" align="center"><a href="unverify_sr_report.php"><img src="../images/back.gif" border="0"style="display:inline;cursor:pointer;"  /></a>&nbsp;&nbsp;<img src="../images/printpreview.gif" onclick="openprint()" style="cursor:pointer" border="0" /></td>
</tr>
</table>
</td><td width="30"></td>
</tr>
