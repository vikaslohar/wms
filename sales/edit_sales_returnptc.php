  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#a8a09e" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#a8a09e" style="border-bottom:solid; border-bottom-color:#a8a09e" >
	    <tr >
	      <td width="813" height="25" class="Mainheading">&nbsp;Transaction - Sales Return - Edit</td>
	    </tr></table></td>
...
<tr class="tblsubtitle" height="20">
  <td colspan="6" align="center" class="tblheading">Sales Return - Edit</td>
</tr>
...
<td align="right"  valign="middle" class="tblheading">SRI No.&nbsp;</td>
    <td align="left"  valign="middle" class="tbltext">&nbsp;<input name="txtsrlno" type="text" size="20" class="tbltext" tabindex="" maxlength="20" onchange="dcdchk();" value="<?php echo sprintf("%00005d",$row_tbl['salesr_tslrno']);?>" />&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
           </tr>
</table>
...
<table align="center" border="1" width="850" cellspacing="0" cellpadding="0" bordercolor="#a8a09e" style="border-collapse:collapse" >
  <tr class="tblsubtitle" height="20">
    <td colspan="3" align="center" valign="middle" class="tblheading">SLOC - PV</td>
  </tr>
  <tr class="tblsubtitle" height="20">
...
?>		
    <td width="201" align="center"  valign="middle" class="tbltext" id="bind1">&nbsp;<select class="tbltext" name="txtslbind1" style="width:60px;" onchange="bind1(this.value);" >
          ...
          <option <?php if($row_tbl['salesr_bin']==$noticia_bind1['binid']) echo "selected"; ?> value="<?php echo $noticia_bind1['binid'];?>" />  
          <?php echo $noticia_bind1['binname'];?>
          <?php } ?>
        </select>&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
    
          <td  align="center" width="201"  valign="middle" class="tbltext"><input name="txtslBagsd1" id="Bagsd1" type="text" size="4" class="tbltext" tabindex="" maxlength="4" value="<?php echo $row_tbl['salesr_nop'];?>" onchange="bagsd1(this.value)" onkeypress="return isNumberKey(event)"   /></td>
  </tr>
<?php
...
?>		
    <td width="201" align="center"  valign="middle" class="tbltext" id="bind2">&nbsp;<select class="tbltext" name="txtslbind2" style="width:60px;" onchange="bind2(this.value);" >
          ...
          <option <?php if($row_tbl['salesr_bin1']==$noticia_bind2['binid']) echo "selected"; ?> value="<?php echo $noticia_bind2['binid'];?>" />  
          <?php echo $noticia_bind2['binname'];?>
          <?php } ?>
        </select>&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
    
          <td  align="center" width="201"  valign="middle" class="tbltext"><input name="txtslBagsd2" id="Bagsd2" type="text" size="4" class="tbltext" tabindex="" maxlength="4" value="<?php echo $row_tbl['salesr_nop1'];?>" readonly="true" style="background-color:#CCCCCC" onkeypress="return isNumberKey(event)"  /></td>
  </tr>  
  </table>
<br />
...
<td width="656" align="left"  valign="middle" class="tbltext">&nbsp;<input type="text" name="txtremarks" class="tbltext" size="140" value="<?php echo $row_tbl['salesr_remarks'];?>" ></td>
</tr>
</table>
<table align="center" width="850" cellpadding="5" cellspacing="5" border="0" >
<tr >
