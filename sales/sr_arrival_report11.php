...
winHandle=window.open('sr_arrival_report2.php?&txtcrop='+itemid+'&txtvariety='+vv+'&sdate='+sdate+'&edate='+edate+'&txtptype='+txtptype+'&txtcountryl='+txtcountryl+'&txtpp='+txtpp+'&txtstatesl='+txtstatesl+'&locationname='+locationname+'&txtstfp='+txtstfp,'WelCome','top=20,left=80,width=850,height=600,scrollbars=yes');
if(winHandle==null){
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#a8a09e" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#a8a09e" style="border-bottom:solid; border-bottom-color:#a8a09e" >
	    <tr >
	      <td width="813" height="25" class="Mainheading">&nbsp;Report - Periodical Party wise Sales Return Arrival Report</td>
	    </tr></table></td>
...
<tr class="light" height="20">
  <td align="center" class="subheading">Periodical Party wise Sales Return Arrival Report</td>
</tr>
</table>
<table align="center" border="0" width="850" cellspacing="0" cellpadding="0" bordercolor="#a8a09e" style="border-collapse:collapse" > 
<tr class="light" height="20">
...
<tr class="tblsubtitle" height="25">
	...
	<td width="85" align="Center" class="tblheading" rowspan="2">Date</td>
	<td width="125" align="Center" class="tblheading" rowspan="2">Crop</td>
	<td width="125" align="Center" class="tblheading" rowspan="2">Variety</td>
	<td width="125" align="Center" class="tblheading" rowspan="2">Lotno</td>
	<td width="125" align="Center" class="tblheading" rowspan="2">Party</td>
	<td width="125" align="Center" class="tblheading" rowspan="2">State</td>
...
<?php
$srno=1; $mid=""; $cnt=0;
$sql_srretm=mysqli_query($link,"select * from tbl_salesrv where plantcode='$plantcode' AND salesr_date<='".$edt."' and salesr_date>='".$sdt."' and salesr_trtype='Sales Return' ") or die(mysqli_error($link));
...
$totqty=0; $cropn=""; $varietyn="";$slups=""; $slnob=""; $slqty=""; $lotn=""; $party=""; $states="";
...
$lotn=$row_tbl_sub['salesrs_orlot'];

$sql_month2=mysqli_query($link,"select * from tbl_partymaser where p_id='".$row_srretm['salesr_party']."' order by business_name")or die(mysqli_error($link));
$noticia2 = mysqli_fetch_array($sql_month2);

$party=$noticia2['business_name']; 
$states=$row_srretm['salesr_state'];
...
<tr height="25">
	...
	<td width="85" align="Center" class="smalltblheading"><?php echo $dov;?></td>
	<td width="85" align="Center" class="smalltblheading"><?php echo $cropn;?></td>
	<td width="85" align="Center" class="smalltblheading"><?php echo $varietyn;?></td>
	<td width="85" align="Center" class="smalltblheading"><?php echo $lotn;?></td>
	<td width="85" align="Center" class="smalltblheading"><?php echo $party;?></td>
	<td width="85" align="Center" class="smalltblheading"><?php echo $states;?></td>
...
<tr >
<td valign="top" align="center"><a href="sr_arrival_report.php"><img src="../images/back.gif" border="0"style="display:inline;cursor:pointer;"  /></a>&nbsp;&nbsp;<img src="../images/printpreview.gif" onclick="openprint()" style="cursor:pointer" border="0" /></td>
</tr>
</table>
</td><td width="30"></td>
</tr>
