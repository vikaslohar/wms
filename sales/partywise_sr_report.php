<?php
	...
	if(isset($_POST['frm_action'])=='submit')
	{
		...
		echo "<script>window.location='sr_party_ws_arr_st_report1.php?sdate=$sdate&edate=$edate&txtcrop=$crop&txtvariety=$veriety&txtptype=$txtptype&txtcountryl=$txtcountryl&txtpp=$txtpp&txtstatesl=$txtstatesl&locationname=$locationname&txtstfp=$txtstfp'</script>";	
	}
...
<td align="left"  valign="middle" class="tbltext" colspan="3" >&nbsp;
  <select class="tbltext" name="txtpp" style="width:120px;" onchange="modetchk1(this.value)">
...
?>
 <tr class="Light" height="25">
    ...
    <td width="404" align="left"  valign="middle" class="tbltext" >&nbsp;
