...
//frm_action=submit&txt11=Transport&txt14=Paid&txtid=1&logid=SR1&slrgln1=1&txtconchk=&txtptype=Dealer&txtcountrysl=&txtcountryl=&rettype=&date=22-04-2014&dcdate=22-04-2014&txtdcno=test&txtpp=Dealer&txtrecallreason=Quality%20Issues&txtstatesl=Chhattisgarh&txtlocationsl=34&locationname=34&txtstfp=52&txt1=Transport&txttname=testsetsetset&txtlrn=dfggfddgffd&txtvn=zdrfs45435&txt13=Paid&txtcname=&txtdc=&txtpname=&txtdcnopbox=1&txtacnopbox=1&txtesnobox=0&txtdcnobag=1&txtacnopbag=1&txtesnopbag=0&txtdcnopto=2&txtacnopto=2&txtesnopto=0&txtcrop=28&txtvariety=8&upstype=Standard&txtupstyp=Standard&itmdchk=&txtupsdc=25.000%20Gms&txtnopdc=10&txtqtydc=70&maintrid=0&subtrid=0
...
$sql_sub="insert into tbl_salesrv_sub (salesr_id, salesrs_crop, salesrs_variety, salesrs_ups, salesrs_nob, salesrs_qty, salesrs_yearcode, salesrs_upstype, plantcode) values('$mainid', '$txtcrop', '$txtvariety', '$txtupsdc', '$txtnopdc', '$txtqtydc', '$yearid_id', '$txtupstyp', '$plantcode')";
