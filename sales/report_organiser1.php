...
<table width="1003" height="600" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  ...
  <tr><td>
   <?php
	...
	$crp="ALL"; $ver="ALL";
	$qry="select Distinct(lotldg_crop), lotldg_variety from tbl_lot_ldg where plantcode='$plantcode' AND lotldg_sstage='Raw Seed'";
	if($crop!="ALL")
	{	
...
?>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#adad11" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#adad11" style="border-bottom:solid; border-bottom-color:#adad11" >
	    <tr >
	      <td width="813" height="25">&nbsp;Organiser Wise Seed Analysis  Report</td>
	    </tr></table></td>
	  </tr>
	  </table></td></tr>
...
<tr class="tblsubtitle" height="20">
			...
			<td width="47" align="center" valign="middle" class="tblheading" rowspan="2">Date of Arrival</td>
			<td width="162"  align="center" valign="middle" class="tblheading" rowspan="2">PDN </td>
			<td width="254"  align="center" valign="middle" class="tblheading" rowspan="2">Process M/c Code </td>
			<td width="97"  align="center" valign="middle" class="tblheading" rowspan="2">Farmer </td>
			 <td width="10%" align="center" valign="middle" class="tblheading"rowspan="2">M%</td>
			 <td width="97"  align="center" valign="middle" class="tblheading" colspan="2">Arrival</td>
			 <td width="97" align="center" valign="middle" class="tblheading" colspan="2">Conditioned Qty </td>
			 <td width="97" align="center" valign="middle" class="tblheading" colspan="2">Condititon Loss </td>
			 <td width="97" align="center" valign="middle" class="tblheading" rowspan="2">Select  Print</td>
    ...
    <td width="8%" align="center" valign="middle" class="tblheading">Qty</td>*/-->
	  ...
	  <td width="7%" align="center" valign="middle" class="tblheading">%</td>
	   ...
	   <td width="7%" align="center" valign="middle" class="tblheading">Qty</td>
	    <td width="8%" align="center" valign="middle" class="tblheading">%</td>
		 <!--<td width="7%" align="center" valign="middle" class="tblheading">Qty</td>
	   <td width="8%" align="center" valign="middle" class="tblheading">%</td>
		<td width="7%" align="center" valign="middle" class="tblheading">Qty</td>
	    <td width="8%" align="center" valign="middle" class="tblheading">%</td>-->
