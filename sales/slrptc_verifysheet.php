...
<title>Sales Return - Transaction - Verification Sheet</title>
...
<table width="850" height="282" border="0" align="center" cellpadding="0" cellspacing="0" >
 ...
 <?php 
$tid=$pid;
//echo "select * from tbl_salesrv where plantcode='$plantcode' AND salesr_trtype='Sales Return' and salesr_id='".$tid."'";
...
<tr class="Light" height="25">
<td align="right" width="155" valign="middle" class="tblheading" >&nbsp;Vehicle No&nbsp;</td>
<td align="left" width="322" valign="middle" class="tbltext"  >&nbsp;<?php echo $row_tbl['salesr_vehno'];?></td>
...
<td align="left" width="322" valign="middle" class="tbltext" >&nbsp;<?php echo $row_tbl['salesr_cname'];?></td>
...
<td width="689" colspan="3" align="left" valign="middle" class="tbltext" >&nbsp;<?php echo $row_tbl['salesr_pname'];?></td>
</tr>
...
<tr class="Light" height="40">
	...
	<td align="center" valign="middle" class="smallesttbltext"><div align="justify" class="smallesttbltext" style="padding:2px 2px 2px 2px"><?php echo $noticia['cropname'];?></div></td>
	<td align="center" valign="middle" class="smallesttbltext"><div align="justify" class="smallesttbltext" style="padding:2px 2px 2px 2px"><?php echo $noticia_item['popularname'];?></div></td>
	<td align="center" valign="middle" class="smallesttbltext">&nbsp;</td>
	<td align="center" valign="middle" class="smallesttbltext">&nbsp;</td>
	<td align="center" valign="middle" class="smallesttbltext"><?php echo $slups;?></td>
	<td align="center" valign="middle" class="smallesttbltext"><?php echo $difn;?></td>
    <td align="center" valign="middle" class="smallesttbltext"><?php echo $difq;?></td>
	<td align="center" valign="middle" class="smallesttbltext">&nbsp;</td>
	<td align="center" valign="middle" class="smallesttbltext">&nbsp;</td>
	<td align="center" valign="middle" class="smallesttbltext">&nbsp;</td>
	<td align="center" valign="middle" class="smallesttbltext">&nbsp;</td>
