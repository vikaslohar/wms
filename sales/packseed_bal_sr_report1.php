  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#a8a09e" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#a8a09e" style="border-bottom:solid; border-bottom-color:#a8a09e" >
	    <tr >
	      <td width="813" height="25" class="Mainheading">&nbsp;Report - Pack seeds Balance Sales Return Report As on Date <?php echo date("d-m-Y");?></td>
	    </tr></table></td>
...
<tr class="light" height="20">
  <td align="center" class="tblheading">Pack seeds Balance Sales Return Report As on Date <?php echo date("d-m-Y");?></td>
</tr>
</table>
<?php
...
<tr class="tblsubtitle" height="25">
	...
	<td width="65" align="Center" class="tblheading">DoSRV</td>
	<td width="120" align="Center" class="tblheading">Lot No</td>
	<td width="55" align="Center" class="tblheading">UPS</td>
	<td width="55" align="Center" class="tblheading">NoP</td>	
	<td width="65" align="Center" class="tblheading">Qty</td>
	<td width="160" align="Center" class="tblheading">QC Status</td>
	<td width="65" align="Center" class="tblheading">DOT</td>
	<td width="65" align="Center" class="tblheading">SLOC</td>
	<td width="40" align="Center" class="tblheading">Re-Validate</td>
</tr>
<?php
...
<tr height="25">
	...
	<td width="65" align="Center" class="tbltext"><?php echo $dosrv?></td>
	...
	<td width="55" align="Center" class="tbltext"><?php echo $totnob;?></td>
	<td width="65" align="Center" class="tbltext"><?php echo $totqty;?></td>
	<td width="65" align="Center" class="tbltext"><?php echo $totqc;?></td>
	<td width="160" align="Center" class="tbltext"><?php echo $txtdot;?></td>
	<td width="55" align="Center" class="tbltext"><?php echo $sloc;?></td>
	<td width="65" align="Center" class="tbltext"><?php echo $reval;?></td>
</tr>
<?php
}
else
...
<tr >
<td valign="top" align="center"><a href="packseed_bal_sr_report.php"><img src="../images/back.gif" border="0"style="display:inline;cursor:pointer;"  /></a>&nbsp;&nbsp;<img src="../images/printpreview.gif" onclick="openprint()" style="cursor:pointer" border="0" /></td>
</tr>
</table>
</td><td width="30"></td>
</tr>
