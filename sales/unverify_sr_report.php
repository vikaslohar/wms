<?php
	...
	if(isset($_POST['frm_action'])=='submit')
	{
		...
		$txtppname=trim($_POST['txtppname']);
		$txtstatesl=trim($_POST['txtstatesl']);
		$txtcity=trim($_POST['txtcity']);
		
		echo "<script>window.location='unverify_sr_report1.php?sdate=$sdate&edate=$edate&txtcrop=$crop&txtvariety=$veriety&txtptype=$txtptype&txtpp=$txtpp&txtstatesl=$txtstatesl&txtppname=$txtppname&txtcity=$txtcity'</script>";	
	}
...
<title>Sales Return - Periodical Non-Verified Sales Return Report</title>
...
function selloc(classval)
{	
	showUser(classval,'loclist','loclist','','','','','');
}

function selparty(classval)
{	
	var txtcity=document.frmaddDepartment.txtcity.value;
	showUser(classval,'partylist','partylist',txtcity,'','','','');
}
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#a8a09e" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#a8a09e" style="border-bottom:solid; border-bottom-color:#a8a09e" >
	    <tr >
	      <td width="813" height="25" class="Mainheading">&nbsp;Report - Periodical Non-Verified Sales Return Report</td>
	    </tr></table></td>
...
<tr class="tblsubtitle" height="20">
  <td colspan="6" align="center" class="tblheading">Periodical Periodical Non-Verified Sales Return Report</td>
</tr>
<tr height="15"><td colspan="6" align="right" class="tblheading"><font color="#FF0000" >* </font>indicates required field&nbsp;</td></tr>
<tr class="Dark" height="25">
<td width="105" height="30" align="right" valign="middle" class="tblheading">&nbsp;Period&nbsp;&raquo;&nbsp;&nbsp;&nbsp;From&nbsp;</td>
<td width="266" align="left"  valign="middle" >&nbsp;<input name="sdate" id="sdate" type="text" size="10" class="tbltext" tabindex="0" readonly="true"  value="<?php echo date("d-m-Y", time());?>" style="background-color:#EFEFEF" />&nbsp;<a href="javascript:void(0)" onClick="showCalendar('sdate');" tabindex="6"><img src="../images/cal.gif" alt="Calender" border="0" align="absmiddle" /></a><script type="text/javascript" language="javascript" src="../include/popcalender.js"></script>&nbsp;<font color="#FF0000" >*</font></td>
<td width="99" align="right"  valign="middle" class="tblheading">&nbsp;To&nbsp;</td>
<td width="270" align="left"  valign="middle" >&nbsp;<input name="edate" id="edate" type="text" size="10" class="tbltext" tabindex="0" readonly="true"  value="<?php echo date("d-m-Y", time());?>" style="background-color:#EFEFEF" />&nbsp;<a href="javascript:void(0)" onClick="showCalendar('edate');" tabindex="6"><img src="../images/cal.gif" alt="Calender" border="0" align="absmiddle" /></a><script type="text/javascript" language="javascript" src="../include/popcalender.js"></script>&nbsp;<font color="#FF0000" >*</font></td>
</tr>
<?php
...
<td width="105"  align="right"  valign="middle" class="tblheading">State&nbsp;</td>
<td  align="left"  valign="middle" class="tbltext" >&nbsp;<select class="tbltext" name="txtstatesl" style="width:120px;" onchange="selloc(this.value);"  >
...
<td align="left"  valign="middle" class="tbltext" id="loclist" >&nbsp;<select class="tbltext" name="txtcity" style="width:120px;">
<option value="ALL" selected="selected">ALL</option>
	</select>&nbsp;<font color="#FF0000">*</font>&nbsp;</td>	
</tr>
<tr class="Light" height="30">
...
?>	
<td width="105" align="right"  valign="middle" class="tblheading">Party Type&nbsp;</td>
<td align="left"  valign="middle" class="tbltext" >&nbsp;<select class="tbltext" name="txtpp" style="width:120px;" onchange="selparty(this.value);" >
<option value="ALL" selected>ALL</option>
	...
	<td width="99" align="right"  valign="middle" class="tblheading">Party Name&nbsp;</td>
<td align="left"  valign="middle" class="tbltext" id="partylist" >&nbsp;<select class="tbltext" name="txtppname" style="width:120px;">
<option value="ALL" selected>ALL</option>
	</select>&nbsp;&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
</tr>
...
?>
 <tr class="Light" height="25">
    <td width="105" align="right"  valign="middle" class="tblheading">Crop&nbsp;</td>
    <td width="266" align="left"  valign="middle" class="tbltext"  >&nbsp;
