...
{	
	//return false;
	var f=0;
	if(document.frmaddDepartment.sreciptyp.value=="verrec")
	{
	...
	else if(document.frmaddDepartment.sreciptyp.value=="vernew")
	{
		...
		if(document.frmaddDepartment.txtlot2o.value=="")lotno="";
		
		if(document.frmaddDepartment.barcode.value=="" && lotno=="")
		{
			alert("Please enter Lot No OR Barcode.");
			return false;
			f=1;
		}
		if(lotno!="")
		{
			...
			{
				alert("Crop cannot be Blank.");
				return false;
				f=1;
			}
			if(document.frmaddDepartment.txtvariety.value=="")
			{
				alert("Variety cannot be Blank.");
				return false;
				f=1;
			}
			...
			if(document.frmaddDepartment.txtqtydc.value=="" || document.frmaddDepartment.txtqtydc.value=="0")
			{
				alert("Qty cannot be Blank OR ZERO.");
				return false;
				f=1;
			}
			if(document.frmaddDepartment.txtqcstatus.value=="")
			{
				alert("QC cannot be Blank.");
				return false;
				f=1;
			}
			if((document.frmaddDepartment.txtqcstatus.value=="OK" || document.frmaddDepartment.txtqcstatus.value=="Fail") && document.frmaddDepartment.dot.value=="")
			{
				alert("DoT cannot be Blank.");
				return false;
				f=1;
			}
			if(document.frmaddDepartment.txtgerm.value=="")
			{
			...
			if(document.frmaddDepartment.txtgotstatus.value=="")
			{
				alert("GOT cannot be Blank.");
				return false;
				f=1;
			}
			if((document.frmaddDepartment.txtgotstatus.value=="OK" || document.frmaddDepartment.txtgotstatus.value=="Fail") && document.frmaddDepartment.dogt.value=="")
			{
				alert("DoGT cannot be Blank.");
				return false;
				f=1;
			}
			if(document.frmaddDepartment.dop.value=="")
			{
				alert("DoP cannot be Blank.");
				return false;
				f=1;
			}
			if(document.frmaddDepartment.dov.value=="")
			{
		...
		{
			var srrno=document.frmaddDepartment.srrno.value;
			if(document.frmaddDepartment.srrno.value=="0")
			{
				alert("Cannot Post record. Reason: Barcode not found.");
				return false;
				f=1;
			}
		}
...
function editrec(edtrecid, typ)
{
	showUser(edtrecid,'postingsubsubtable','subformedt',typ,'','','','');
}
...
function showverifyscnew(subval,cropval,varietyval,upsval)
{
	...
	var typ="vernew";
	//var subval="";
	showUser(subval,'postingsubsubtable','showverscn',trid,cropval,varietyval,upsval,typ);	
...
function chkbarcode1(mltval)
{
	...
	if(flg==0)
	{
		...
		var trid=document.frmaddDepartment.maintrid.value;
		var oups='';
		showUser(mltval,'crpvershow','lotchko',clasid,itmid,vtyp,trid,oups,a);
	}
}
...
<tr class="Light" height="20">
    ...
    <td width="26" align="center" valign="middle" class="smalltbltext"><img src="../images/edit.png" border="0" style="display:inline;cursor:pointer;" onclick="editrec(<?php echo $row_tbl_sub['salesrs_id'];?>,'<?php echo $row_tbl_sub['salesrs_typ']?>');" /></td>
