...
session_start();
	...
	$dh="Sales_Return_Crop_Variety_wise_Substandard_Pack_Seed_Report ".$dat;
	$datahead = array("Sales Return Crop Variety wise Substandard Pack Seed Report  ".$dat);
	$filename=$dh.".xls";  
...
$totalbags=0; $totalqty=0;
	...
	$datahead2[$cnt] = array("#","Lot No.","NoP","Qty","SLOC","Qc Status","DOT","GOT Status","DOGR"); 
...
$data1[$cnt][$d]=array($d,$lotn,$totnob,$totqty,$sloc,$totqc,$txtdot,$totgot,$dogr);
$d++;
}
