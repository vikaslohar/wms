...
?><input type="text" name="stdptval_<?php echo $newa;?>" id="stdptval_<?php echo $newa;?>" value="<?php if($c=="WBox"){ echo $wtnopkg[$a];} else if($c=="MPack"){ echo $wtmp[$a]; } else { echo $upst; }?>" size="9" readonly="true" style="background-color:#F0F0F0" />
