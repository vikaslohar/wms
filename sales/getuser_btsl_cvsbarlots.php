...
<!--<table align="center" border="1" width="950" cellspacing="0" cellpadding="0" bordercolor="#a8a09e" style="border-collapse:collapse">	
<tr class="tblsubtitle" height="20">
    <td align="center" valign="middle" class="tblheading" colspan="4" >Lot Number SLOC</td>
</tr>
</table>
<table align="center" border="1" width="950" cellspacing="0" cellpadding="0" bordercolor="#a8a09e" style="border-collapse:collapse">	
<?php 
$sbin=explode(",",$slocs);
foreach($sbin as $subbin)
{
if($subbin<>"")
{
$sql_issuetbl=mysqli_query($link,"select * from tbl_subbin where plantcode='$plantcode' AND sid='".$subbin."'") or die(mysqli_error($link)); 
while($row_issuetbl=mysqli_fetch_array($sql_issuetbl))
{
...
$sql_subbinn=mysqli_query($link,"select sname from tbl_subbin where plantcode='$plantcode' AND sid='".$row_issuetbl['sid']."' and binid='".$row_issuetbl['binid']."' and whid='".$row_issuetbl['whid']."'") or die(mysqli_error($link));
$row_subbinn=mysqli_fetch_array($sql_subbinn);
$subbinn=$row_subbinn['sname'];
?>
<tr class="Light" height="20">
<td width="92" align="right" valign="middle" class="smalltblheading">WH&nbsp;</td>
<td width="94" align="Left"  valign="middle" class="smalltbltext">&nbsp;<?php echo $wareh;?></td>
<td width="104" align="Right" valign="middle" class="smalltblheading">Bin&nbsp;</td>
   
<td width="75" align="Left"  valign="middle" class="smalltbltext">&nbsp;<?php echo $binn;?></td>
 <td width="132" align="Right" valign="middle" class="smalltblheading" >Subbin&nbsp;</td>
<td width="139" align="Left"  valign="middle" class="smalltbltext">&nbsp;<?php echo $subbinn;?></td>
</tr>
<?php
}
}
...
<table align="center" border="1" width="950" cellspacing="0" cellpadding="0" bordercolor="#a8a09e" style="border-collapse:collapse">	
<tr class="tblsubtitle" height="20">
    <td align="center" valign="middle" class="tblheading" colspan="4" >Barcode Linking SLOC</td>
</tr>
<input type="hidden" name="sloclnktyp" value="<?php if($cont>0) echo "same"; else echo "new";?>" />
</table>
<table align="center" border="1" width="950" cellspacing="0" cellpadding="0" bordercolor="#a8a09e" style="border-collapse:collapse">
<?php
$sbin=explode(",",$slocs);
...
?>
<tr class="Light" height="20">
<td width="61" align="right" valign="middle" class="smalltblheading">WH&nbsp;</td>
<td width="79" align="Left"  valign="middle" class="smalltbltext">&nbsp;<?php echo $wareh;?><input type="hidden" id="txtewh" name="txtewhg" value="<?php echo $row_issuetbl['whid'];?>" /></td>
<td width="58" align="Right" valign="middle" class="smalltblheading">Bin&nbsp;</td>
   
<td width="73" align="Left"  valign="middle" class="smalltbltext">&nbsp;<?php echo $binn;?><input type="hidden" id="txtbing" name="txtebin" value="<?php echo $row_issuetbl['binid'];?>" /></td>
 <td width="76" align="Right" valign="middle" class="smalltblheading" >Subbin&nbsp;</td>
<td width="64" align="Left"  valign="middle" class="smalltbltext">&nbsp;<?php echo $subbinn;?><input type="hidden" id="txtsubbg" name="txtesubb" value="<?php echo $row_issuetbl['sid'];?>" /></td>
<td width="223" align="Left"  valign="middle" class="smalltbltext">&nbsp;Link to:&nbsp;&nbsp;<input type="radio" name="txtsloclnk" value="same" <?php if($cont>0) echo "checked"; ?> onclick="slclnkch(this.value)" />Same&nbsp;&nbsp;<input type="radio" name="txtsloclnk" value="new" <?php if($cont==0) echo "checked"; ?> onclick="slclnkch(this.value)" />New SLOC</td>
</tr>
<?php
}
}
...
<div id="sllnknew" style="display: <?php if($cont>0) echo "none"; else echo "block";?>">
<table align="center" border="1" width="950" cellspacing="0" cellpadding="0" bordercolor="#a8a09e" style="border-collapse:collapse">	
<tr class="tblsubtitle" height="20">
...
</tr><div id="slocr"><input type="hidden" name="sbinflg" value="0" /></div>
</table>
</div>
<?php
}
