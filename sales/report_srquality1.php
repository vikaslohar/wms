...
<title>Sales Return-Quality Report</title>
...
winHandle=window.open('report_srquality2.php?&txtcrop='+itemid+'&txtvariety='+vv+'&dotage='+dotage,'WelCome','top=20,left=80,width=850,height=600,scrollbars=yes');
if(winHandle==null){
  ...
  <tr><td>
   ...
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#a8a09e" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#a8a09e" style="border-bottom:solid; border-bottom-color:#a8a09e" >
	    <tr >
	      <td width="813" height="25">&nbsp;Sales Return - Quality Report as on Date - <?php echo date("d-m-Y");?></td>
	    </tr></table></td>
	  </tr>
	  </table></td></tr>
...
<table align="center" border="0" cellspacing="0" cellpadding="0" width="970" style="border-collapse:collapse">
   <tr height="25" >
    <td align="center" class="subheading" style="color:#303918; ">Sales Return Quality Report as on Date - <?php echo date("d-m-Y");?></td>
  	</tr>
</table>	
<table align="center" border="0" cellspacing="0" cellpadding="0" width="970" style="border-collapse:collapse">
	<tr height="25" >
...
<tr class="tblsubtitle" height="20">
	<td width="28" align="center" valign="middle" class="tblheading">#</td>
	<td width="148"  align="center" valign="middle" class="tblheading">Lot No.</td>
	<td width="90"  align="center" valign="middle" class="tblheading">Stage</td>
	<td width="90" align="center" valign="middle" class="tblheading">UPS</td>
	<td width="70"  align="center" valign="middle" class="tblheading">NoP/NoB</td>
	<td width="70" align="center" valign="middle" class="tblheading">Qty</td>
	<td width="170" align="center" valign="middle" class="tblheading">SLOC</td>
	<td width="70" align="center" valign="middle" class="tblheading">QC Status</td>
	<td width="70" align="center" valign="middle" class="tblheading">DoT</td>
	<td width="74" align="center" valign="middle" class="tblheading">Duration from DoT</td>
...
<tr >
<td height="49" align="center" valign="top"><a href="report_srquality.php"><img src="../images/back.gif" border="0"  style="display:inline;cursor:pointer;"/></a>&nbsp;&nbsp;<img src="../images/printpreview.gif" onclick="openprint()" style="cursor:pointer" border="0" />
