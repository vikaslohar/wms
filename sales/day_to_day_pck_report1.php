  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#a8a09e" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#a8a09e" style="border-bottom:solid; border-bottom-color:#a8a09e" >
	    <tr >
	      <td width="813" height="25" class="Mainheading">&nbsp;Report - Day To Day Packaging Report</td>
	    </tr></table></td>
...
<tr class="light" height="20">
  <td align="center" class="tblheading">Day To Day Packaging Report</td>
</tr>
</table>
<table align="center" border="0" width="850" cellspacing="0" cellpadding="0" bordercolor="#a8a09e" style="border-collapse:collapse" > 
<tr class="light" height="20">
...
<tr class="tblsubtitle" height="25">
	...
	<td width="79" align="Center" class="tblheading">Lot No.</td>
	<td width="81" align="Center" class="tblheading">UPS</td>
	<td width="92" align="Center" class="tblheading">Qty</td>
	<td width="100" align="Center" class="tblheading">DOT</td>
	<td width="117" align="Center" class="tblheading">Packing Slip No.</td>
	<td width="94" align="Center" class="tblheading">Machine Code</td>
	<td width="127" align="Center" class="tblheading">Operator Code</td>
...
<tr height="25">
	...
	<td width="100" align="Center" class="tblheading">&nbsp;</td>
	<td width="117" align="Center" class="tblheading">&nbsp;</td>
