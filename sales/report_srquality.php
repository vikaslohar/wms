<?php
	...
	if(isset($_POST['frm_action'])=='submit')
	{
		...
		echo "<script>window.location='report_srquality1.php?txtcrop=$cid&txtvariety=$itemid&dotage=$dotage'</script>";
	}
...
{ 
	...
	{
		alert("Please select QC Test Duration");
		return false;
	}
	return true;	 
}
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#a8a09e" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#a8a09e" style="border-bottom:solid; border-bottom-color:#a8a09e" >
	    <tr >
	      <td width="813" height="30"class="Mainheading"  >&nbsp;Sales Return - Quality Report as on Date - <?php echo date("d-m-Y");?></td>
	    </tr></table></td>
	  </tr>
	  </table></td></tr>
          ...
          <tr>
            ...
            <td><table align="center" border="1" width="600" cellspacing="0" cellpadding="0" bordercolor="#a8a09e" style="border-collapse:collapse" >
                <tr class="tblsubtitle" height="25">
                  <td colspan="4" align="center" class="tblheading">Sales Return - Quality Report as on Date - <?php echo date("d-m-Y");?></td>
                </tr>
                <tr height="15">
...
<tr class="Light" height="30">
	<td align="right"  valign="middle" class="tblheading" >QC Test Duration&nbsp;</td>
 <td align="left"  valign="middle" class="tbltext">&nbsp;<select class="tbltext" name="dotage" id="dotage" style="width:170px;" >
    <option value="" selected>--Select--</option>
  	<option value="less45" >Less than 45 days</option>
	<option value="more45" >More than 45 days</option>
