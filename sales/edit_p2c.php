<?php
	...
	if(isset($_POST['frm_action'])=='submit')
	{
	   // exit;
		...
		$sql="update tbl_unpsp2c set unp_date='$dt', unp_crop='$crop', unp_variety='$variety', unp_lotno='$lotno', unp_orlot='$orlot', unp_ups='$ups', unp_pwh='$ewh', unp_pbin='$ebin', unp_psbin='$esbin', unp_pnop='$enop', unp_pqty='$eqty', unp_cwh1='$wh1', unp_cbin1='$bin1', unp_csbin1='$sbin1', unp_cnob1='$nob1', unp_cqty1='$qty1', unp_cwh2='$wh2', unp_cbin2='$bin2', unp_csbin2='$sbin2', unp_cnob2='$nob2', unp_cqty2='$qty2', unp_logid='$logid', unp_yearcode='$yearid_id' where unp_id='$p_id'";
...
<?php
$sql_month=mysqli_query($link,"select distinct salesrs_ups from tbl_salesrv_sub where plantcode='$plantcode' AND salesrs_crop='".$row_tbl['unp_crop']."' and salesrs_variety='".$row_tbl['unp_variety']."' and salesrs_rettype='P2P' and salesrs_rvflg=0 order by salesrs_ups")or die(mysqli_error($link));
?>
...
<?php  while($row_var=mysqli_fetch_array($sql_month)) {	?>
		<option <?php if($row_tbl['unp_ups']==$row_var['salesrs_ups']) echo "selected"; ?> value="<?php echo $row_var['salesrs_ups'];?>" />   
...
?>
  <tr class="Light" height="30" >
    <td width="94" align="center"  valign="middle" class="tbltext">&nbsp;<select class="tbltext" name="txtslwhg1" style="width:70px;" onchange="wh(this.value,'1');"  >
          ...
          <option <?php if($row_tbl['unp_cwh1']==$noticia_whg1['whid']) echo "selected"; ?> value="<?php echo $noticia_whg1['whid'];?>" />  
          <?php echo $noticia_whg1['perticulars'];?>
          <?php } ?>
    </select>&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
<?php
$bing1_query=mysqli_query($link,"select binid, binname from tbl_bin where plantcode='$plantcode' AND whid='".$row_tbl['unp_cwh1']."' order by binname") or die(mysqli_error($link));
?>
	...
	<?php while($noticia_bing1 = mysqli_fetch_array($bing1_query)) { ?>
		<option <?php if($row_tbl['unp_cbin1']==$noticia_bing1['binid']) echo "selected"; ?> value="<?php echo $noticia_bing1['binid'];?>" />   
		<?php echo $noticia_bing1['binname'];?>
		<?php } ?>
    </select>&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
<?php
$subbing1_query=mysqli_query($link,"select sid, sname from tbl_subbin where plantcode='$plantcode' AND binid='".$row_tbl['unp_cbin1']."' order by sid") or die(mysqli_error($link));
?>
	...
	<?php while($noticia_subbing1 = mysqli_fetch_array($subbing1_query)) { ?>
		<option <?php if($row_tbl['unp_csbin1']==$noticia_subbing1['sid']) echo "selected"; ?> value="<?php echo $noticia_subbing1['sid'];?>" />   
    ...
    <td colspan="2"  valign="middle"><div id="slocrow1">
      <table align="center" height="30" width="100%"  border="1" cellspacing="0" cellpadding="0" bordercolor="#a8a09e" style="border-collapse:collapse" >
		...
		<td width="275"  valign="middle">&nbsp;</td>
          ...
          <td  align="left" width="83"  valign="middle" class="tbltext">&nbsp;<input name="txtslBagsg1" id="Bags1" type="text" size="4" class="tbltext" tabindex="" maxlength="4" onkeypress="return isNumberKey1(event)" onchange="Bagsf(this.value,'1');" value="<?php echo $row_tbl['unp_cnob1'];?>"  />&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
          <td  align="right" width="40"  valign="middle" class="tblheading">&nbsp;Qty&nbsp;</td>
          <td width="98" align="left"  valign="middle" class="tbltext">&nbsp;<input name="txtslqtyg1" id="qty1" type="text" size="9" class="tbltext" tabindex="" maxlength="9" onkeypress="return isNumberKey(event)" onchange="qtyf(this.value,'1');" value="<?php echo $row_tbl['unp_cqty1'];?>"  />&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
        </tr>
      </table>
    </div></td>
  </tr>
...
?>
  <tr class="Light" height="30"  >
    <td width="94" align="center"  valign="middle" class="tbltext">&nbsp;<select class="tbltext" name="txtslwhg2" style="width:70px;" onchange="wh(this.value,'2');" >
          ...
          <option <?php if($row_tbl['unp_cwh2']==$noticia_whg2['whid']) echo "selected"; ?> value="<?php echo $noticia_whg2['whid'];?>" />  
          <?php echo $noticia_whg2['perticulars'];?>
          <?php } ?>
    </select>&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
<?php
$bing2_query=mysqli_query($link,"select binid, binname from tbl_bin where plantcode='$plantcode' AND whid='".$row_tbl['unp_cwh2']."' order by binname") or die(mysqli_error($link));
?>
    ...
    <option value="" selected>--Bin--</option>
	<?php while($noticia_bing2 = mysqli_fetch_array($bing2_query)) { ?>
		<option <?php if($row_tbl['unp_cbin2']==$noticia_bing2['binid']) echo "selected"; ?> value="<?php echo $noticia_bing2['binid'];?>" />   
		<?php echo $noticia_bing2['binname'];?>
		<?php } ?>
    </select>&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
<?php
$subbing2_query=mysqli_query($link,"select sid, sname from tbl_subbin where plantcode='$plantcode' AND binid='".$row_tbl['unp_cbin2']."' order by sid") or die(mysqli_error($link));
?>
    ...
    <option value="" selected>--Sub Bin--</option>
	<?php while($noticia_subbing2 = mysqli_fetch_array($subbing2_query)) { ?>
		<option <?php if($row_tbl['unp_csbin2']==$noticia_subbing2['sid']) echo "selected"; ?> value="<?php echo $noticia_subbing2['sid'];?>" />   
    ...
    <td colspan="2"  valign="middle"><div id="slocrow2">
      <table align="center" height="30" width="100%"  border="1" cellspacing="0" cellpadding="0" bordercolor="#a8a09e" style="border-collapse:collapse" >
		...
		<td width="275"  valign="middle">&nbsp;</td>
          ...
          <td width="83" align="left"  valign="middle" class="tbltext">&nbsp;<input name="txtslBagsg2" id="Bags2" type="text" size="4" class="tbltext" tabindex="" maxlength="4" onkeypress="return isNumberKey1(event)" onchange="Bagsf(this.value,'2');" value="<?php if($row_tbl['unp_cnob2'] > 0 ) echo $row_tbl['unp_cnob2'];?>"  />&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
          <td width="40" align="right"  valign="middle" class="tblheading">&nbsp;Qty&nbsp;</td>
          <td width="98"  align="left"  valign="middle" class="tbltext">&nbsp;<input name="txtslqtyg2" id="qty2" type="text" size="9" class="tbltext" tabindex="" maxlength="9" onkeypress="return isNumberKey(event)" onchange="qtyf(this.value,'2');" value="<?php if($row_tbl['unp_cqty2'] > 0 ) echo $row_tbl['unp_cqty2'];?>"   />&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
        </tr>
      </table>
    </div></td>
