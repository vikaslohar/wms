<?php
	...
	if(isset($_POST['frm_action'])=='submit')
	{
		...
		echo "<script>window.location='state_wise_sr_report1.php?sdate=$sdate&edate=$edate&txtcrop=$crop&txtvariety=$veriety&txtptype=$txtptype&txtpp=$txtpp&txtstatesl=$txtstatesl'</script>";	
	}
