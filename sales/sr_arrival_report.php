<?php
	...
	if(isset($_POST['frm_action'])=='submit')
	{
		...
		echo "<script>window.location='sr_arrival_report1.php?sdate=$sdate&edate=$edate&txtcrop=$crop&txtvariety=$veriety&txtptype=$txtptype&txtcountryl=$txtcountryl&txtpp=$txtpp&txtstatesl=$txtstatesl&locationname=$locationname&txtstfp=$txtstfp'</script>";	
	}
...
<title>Sales Return - Transaction - Sales Return Arrival  Report</title>
...
<tr class="tblsubtitle" height="20">
  <td colspan="6" align="center" class="tblheading">Periodical Party wise Sales Return Arrival Report</td>
</tr>
