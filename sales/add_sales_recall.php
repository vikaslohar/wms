<?php
	...
	$sql_code="SELECT MAX(salesr_tcode) FROM tbl_salesrv where plantcode='$plantcode' AND salesr_trtype='Sales Recall' and salesr_yearcode='$yearid_id'  ORDER BY salesr_tcode DESC";
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#a8a09e" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#a8a09e" style="border-bottom:solid; border-bottom-color:#a8a09e" >
	    <tr >
	      <td width="813" height="25" class="Mainheading">&nbsp;Transaction - Sales Recall</td>
	    </tr></table></td>
...
<td align="left" valign="middle" class="tbltext" colspan="3">&nbsp;<input name="txtrecrefno" type="text" size="10" class="tbltext" tabindex="0" value="" maxlength="10"/>&nbsp;</td>
</tr>
...
<option value="In-Transit Cancellation">In-Transit Cancellation</option>
</select>&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
           </tr>
</table>
...
<td width="206" align="right"  valign="middle" class="tblheading">&nbsp;Recall Mode&nbsp;</td>
...
<!--<table align="center" border="1" width="850" cellspacing="0" cellpadding="0" bordercolor="#a8a09e" style="border-collapse:collapse" >
  ...
  <tr class="tblsubtitle" height="20">
	...
	<td width="201" align="center" valign="middle" class="tblheading">NoP</td>
  </tr>
<?php
