...
$sql_tbl=mysqli_query($link,"select * from tbl_salesrv where plantcode='$plantcode' AND salesr_logid='".$logid."' and  salesr_trtype='Sales Recall' and salesr_flg=0") or die(mysqli_error($link));
while($row_tbl=mysqli_fetch_array($sql_tbl))
{
	...
	$s_sub="delete from tbl_salesrv where salesr_logid='".$logid."' and  salesr_trtype='Sales Recall' and salesr_flg=0";
	mysqli_query($link,$s_sub) or die(mysqli_error($link));	
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#a8a09e" >
	  ...
	  <table width="820" border="0" cellpadding="0" cellspacing="0" bordercolor="#a8a09e" style="border-bottom:solid; border-bottom-color:#a8a09e" >
	    <tr >
	      <td width="820" height="25">&nbsp;Transaction - Sales Recall</td>
	    </tr></table></td>
...
<td align="center" width="100" valign="middle" class="tblbutn" style="cursor:Pointer;"><?php if($flg==0 && $flg1==0 && $flg2==0) { ?><a href="add_sales_recall.php" style="text-decoration:none; color:#000000">Add </a><?php } else { ?><a href="Javascript:void(0);" onclick="alert('Can not perform Transaction.\nReason:\n1. Todays date is not in Active Current Financial Year.\n2. Transaction after todays date has been made.\n3. Cycle Inventory transaction is under process.');" style="text-decoration:none; color:#000000">Add </a><?php } ?></td>
</tr>
</table></td>
...
$sql_arr_home=mysqli_query($link,"select * from tbl_salesrv where plantcode='$plantcode' AND salesr_trtype='Sales Recall' and salesr_flg=1 and salesr_logid='$logid' order by salesr_date desc, salesr_code desc LIMIT $from, $max_results") or die(mysqli_error($link));
$tot_arr_home=mysqli_num_rows($sql_arr_home);

$total_results3 =mysqli_query($link,"SELECT COUNT(*)  FROM tbl_salesrv where plantcode='$plantcode' AND salesr_trtype='Sales Recall' and salesr_flg=1 and salesr_logid='$logid'");
...
<tr class="tblsubtitle" height="20">
	...
	<td width="10%" align="center" valign="middle" class="tblheading">Trans. Id</td>
	<td width="9%" align="center" valign="middle" class="tblheading">Date</td>
	<td width="9%" align="center" valign="middle" class="tblheading">DC No.</td>
	...
	<td width="12%" align="center" valign="middle" class="tblheading">BC Linking Ref. No. </td>
	<td width="12%" align="center" valign="middle" class="tblheading">Status</td>
    <!--<td width="7%" align="center" valign="middle" class="tblheading">Outputs</td>-->
</tr>
<?php
//$srno=1;
if($tot_arr_home > 0)
...
?>			  
<tr class="Light">
	<td width="3%" align="center" valign="middle" class="smalltblheading"><?php echo $srno;?></td>
	<td width="10%" align="center" valign="middle" class="smalltblheading"><?php echo "SR".$row_arr_home['salesr_code']."/".$row_arr_home['salesr_yearcode']."/".$row_arr_home['salesr_logid'];?></td>
	...
	<td width="12%" align="center" valign="middle" class="smalltblheading"><?php echo $row_arr_home['salesr_recallrefno']?></td>
	<td width="12%" align="center" valign="middle" class="smalltblheading"><?php if($row_arr_home['salesr_vflg']!=1) { ?><a href="add_sales_recallverfy.php?pid=<?php echo $arrival_id?>">Verify</a><?php }else{ ?>Verified<?php } ?></td>
    <!--<td width="7%" align="center" valign="middle" class="smalltblheading"><?php if($row_arr_home['salesr_vflg']!=1) { ?><a href="Javascript:void(0)" onclick="openslocpopprint2('<?php echo $arrival_id;?>');">SRV</a><br /><a href="Javascript:void(0)" onclick="openslocpopprint3('<?php echo $arrival_id;?>');">Annexure</a><?php } else{?><?php if($row_arr_home['salesr_partytype']=="Dealer" || $row_arr_home['salesr_partytype']=="Bulk" || $row_arr_home['salesr_partytype']=="Export Buyer") {?><a href="Javascript:void(0)" onclick="openslocpopprint('<?php echo $arrival_id;?>');">SRN</a><?php } else { ?><a href="Javascript:void(0)" onclick="openslocpopprint('<?php echo $arrival_id;?>');">STIN</a><?php } }?></td>-->
</tr>
<?php
}
else
