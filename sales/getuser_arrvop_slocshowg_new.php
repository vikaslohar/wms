...
$sql_i="select * from tblarrival_sub where plantcode='$plantcode' AND orlot='".$f."' and arrsub_id!='".$rid."'";
...
{
?>
<table align="center" border="1" width="950" cellspacing="0" cellpadding="0" bordercolor="#a8a09e" style="border-collapse:collapse" ><tr>
<td valign="middle" class="tblheading" align="left"><font color="#FF0000">&nbsp;&nbsp;Can not enter the Lot.&nbsp;&nbsp;Reasons : </font><br /><br />
<font color="#0000FF">&nbsp;&nbsp;1. The Lot has been already Present in System.<br />
&nbsp;&nbsp;2. The Lot is in the same transaction for Salse Return Opening Stock.</font></td>
</tr>
</table>
<?php
}
