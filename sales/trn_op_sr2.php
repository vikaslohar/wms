<?php
	...
	$sql_code="SELECT MAX(salesr_tcode) FROM tbl_salesr where plantcode='$plantcode' AND salesr_trtype='Opening Stock Condition'  ORDER BY salesr_tcode DESC";
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#a8a09e" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#a8a09e" style="border-bottom:solid; border-bottom-color:#a8a09e" >
	    <tr >
	      <td width="813" height="25" class="Mainheading">&nbsp;Transaction - Sales Return Opening Stock</td>
	    </tr></table></td>
...
<tr class="tblsubtitle" height="20">
  <td colspan="6" align="center" class="tblheading">Sales Return Opening Stock</td>
</tr>
...
<td align="left" width="270" valign="middle" class="smalltbltext">&nbsp;
  <select class="smalltbltext" name="pcodeo" style="width:40px;" onchange="pcdchk(this.value);">
   <option value="" >--Select--</option>
    ...
    <?php } ?></select><input name="txtlot2o" type="text" size="4" class="smalltbltext" maxlength="5" onkeypress="return isNumberKey(event)" onchange="lot2chko();"  /> <font size="+1"><b>/</b></font> <input name="stcodeo" type="text" size="4" class="smalltbltext" tabindex="0" maxlength="5" onkeypress="return isNumberKey24(event)" onblur="Javascript:this.value=this.value.toUpperCase()"  value="" onchange="stchko();" /> <font size="+1"><b>/</b></font> <input name="stcode2o" type="text" size="3" class="smalltbltext" tabindex="0" maxlength="3"  onkeypress="return isNumberKey24(event)" value="000" onchange="stchko2();" onblur="Javascript:this.value=this.value.toUpperCase()" />
