	 ...
	 $sql_in="update tblopr set login='$login',
		...
		if(mysqli_query($link,$sql_in)or die(mysqli_error($link)))
         ...
         $sql_in1="Update tbluser set	loginid='$login',
										password='$pass',
										email='$email'
										where role='csw' and scode='$scode'";	
...
<title>Settlement- Transaction-operator Profile</title>
...
<table align="center" border="0" width="650" cellspacing="0" cellpadding="0" bordercolor="#ef0388"
 style="border-collapse:collapse" > <tr><td>
<table width="700" border="1" cellspacing="0" cellpadding="0" align="center"  bordercolor="#ef0388"
