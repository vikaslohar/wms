<?php
	...
	$datatitle1 = array("#","Date of Drying Slip","Drying Slip Ref. No.","Crop","Variety","Lot No.","Before Drying","","After Drying","","Drying Loss","","Farmer Name","Farmer ID","Production Location");
...
while($row_arr_home1=mysqli_fetch_array($sql_arr_home1))
{
	...
	{ 
		...
		if($tot_arr_home > 0)			
		{
			$data1[$d]=array($d,$trdate,$drefno,$cropn,$varietyn,$lotno,$onob,$oqty,$nob1,$qty1,$adnob,$adqty,$farmer,$farmerid,$prodloc); 
			$d++;
		}
	}
}
