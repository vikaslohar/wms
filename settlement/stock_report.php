<?php
	...
	if(isset($_POST['frm_action'])=='submit')
	{
		...
		echo "<script>window.location='stock_report1.php?slchk=$slchk&slchk2=$slchk2&txtcrop=$cid&txtvariety=$itemid&sdate=$sdate'</script>";
	}
?>
...
<title>Settlement- Report - Stock Report as on<?php echo date("d-m-Y H:i:s"); ?></title>
          ...
          <tr>
            ...
            <td><table align="center" border="1" width="600" cellspacing="0" cellpadding="0" bordercolor="#ef0388" style="border-collapse:collapse" >
                <tr class="tblsubtitle" height="25">
                  <td colspan="2" align="center" class="tblheading">Stock Report As on - <?php echo date("d-m-Y H:i:s"); ?></td>
                </tr>
                <tr height="15">
