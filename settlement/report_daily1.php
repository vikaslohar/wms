...
<table width="1003" height="600" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  ...
  <tr><td>
   <?php
	...
	$qry.=" and proslipmain_tflag=1 and proslipmain_stage='Raw' group by proslipmain_crop, proslipmain_variety";
...
if($txtpmcode!="ALL")
{	
	$sql_rr=mysqli_query($link,"select distinct proslipmain_variety from tbl_proslipmain where proslipmain_crop='".$row_arr_home1['proslipmain_crop']."' and proslipmain_variety='".$row_arr_home1['proslipmain_variety']."' and proslipmain_promachcode='$txtpmcode'  and proslipmain_date<='$edate' and proslipmain_date>='$sdate' and proslipmain_tflag=1 and plantcode='$plantcode' and proslipmain_stage='Raw' order by proslipmain_id asc") or die(mysqli_error($link));
}
else
{
	$sql_rr=mysqli_query($link,"select distinct proslipmain_variety from tbl_proslipmain where proslipmain_crop='".$row_arr_home1['proslipmain_crop']."' and proslipmain_variety='".$row_arr_home1['proslipmain_variety']."' and proslipmain_date<='$edate' and proslipmain_date>='$sdate' and proslipmain_tflag=1 and plantcode='$plantcode' and proslipmain_stage='Raw' order by proslipmain_id asc") or die(mysqli_error($link));
}
...
if($txtpmcode!="ALL")
{	
	$sql_rr22=mysqli_query($link,"select * from tbl_proslipmain where proslipmain_variety='".$row_rr['proslipmain_variety']."' and proslipmain_date<='$edate' and proslipmain_date>='$sdate' and proslipmain_tflag=1 and proslipmain_promachcode='$txtpmcode' and plantcode='$plantcode' and proslipmain_stage='Raw' order by proslipmain_id asc") or die(mysqli_error($link));
}
else
{
	$sql_rr22=mysqli_query($link,"select * from tbl_proslipmain where proslipmain_variety='".$row_rr['proslipmain_variety']."' and proslipmain_date<='$edate' and proslipmain_date>='$sdate' and proslipmain_tflag=1 and plantcode='$plantcode' and proslipmain_stage='Raw' order by proslipmain_id asc") or die(mysqli_error($link));
}
...
else
{
	...
	{ $flg++;
		...
		{ 
			...
			$rmper=$row_densitytbl['density_remperlot'];
			
			$cqty1=$row_densitytbl['density_rawqty']-$rmqty1;
			
			$tplqty=$rmqty1+$imqty1+$plqty1;
			$tplper=$rmper1+$imper1+$plper1; 
