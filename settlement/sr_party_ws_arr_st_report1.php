...
<title>Settlement - Periodical Party wise Sales Return Report</title>
...
$sql_srretsub=mysqli_query($link,"select * from tbl_salesrv_sub where plantcode='$plantcode' AND salesrs_variety='".$row_srrets['salesrs_variety']."' and salesrs_vflg=1") or die(mysqli_error($link));
