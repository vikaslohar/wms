...
<tr class="Light">
	...
	<td align="center" valign="middle" class="smallesttbltext"><input type="checkbox" name="pschk<?php echo $cnt?>" id="pschk_<?php echo $cnt?>" value="<?php echo $lotno;?>" /></td>
</tr>
<?php
}
else
...
<tr >
<td  align="center" valign="middle"><a href="add_lotps.php"><img src="../images/cancel.gif" border="0" onclick="return confirm('Do You wish to Cancel this Transaction?');"  style="display:inline;cursor:pointer;"/></a>&nbsp;&nbsp;<input name="Submit" type="image" src="../images/preview.gif" alt="Submit Value" onclick="return mySubmit();"   border="0" style="display:inline;cursor:pointer;"  />&nbsp;&nbsp; <input type="hidden" name="sid" value="" /></td>
</tr>
</table>
</td><td ></td>
</tr>
