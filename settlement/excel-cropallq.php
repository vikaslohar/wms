<?php
	...
	$datahead3= array('','','','OK Qty','UT Qty','Total Qty','OK Qty','UT Qty','Total Qty');
...
array_push($datahead3,'OK Qty','UT Qty','Total Qty','OK Qty','UT Qty','Total Qty','OK Qty','UT Qty','Total Qty'); 
...
$data1[$d]=array($d,$crop1,$verty,$totrqok,$totrqut,$totrqty,$totcqok,$totcqut,$totcqty);
foreach($ui as $uidd)
{
array_push($data1[$d],$uidd);
}
array_push($data1[$d],$totpqok,$totpqut,$totpqty,$totsrqok,$totsrqut,$totsrqty,$totqok,$totqut,$tqty); 
