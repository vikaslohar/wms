...
function dateDiff($start, $end) 
{
  ...
  return round($diff / 86400);
	...
	$dh="Periodical_Arrival_Report_As_on_Date_".$dat;
	$datahead = array("Periodical Arrival Report - As on Date ".$dat);
	$filename=$dh.".xls";  
...
$cnt=1;
$qry="select arrival_id, arrival_date, yearcode, tmode, trans_name, trans_lorryrepno, trans_vehno, trans_paymode, courier_name, docket_no, pname_byhand  from tblarrival where plantcode='$plantcode' AND arrival_date <='".$edate."' and arrival_date >='".$sdate."' and arrival_type='Fresh Seed with PDN' and arrtrflag=1";
$sql_arr_home1=mysqli_query($link,$qry) or die(mysqli_error($link));
$tot_arr_home=mysqli_num_rows($sql_arr_home1);
	
$datahead3= array("Date of Arrival","FRN No.","Lot No.","Prod. Location","Prod. Personel","Organiser","Farmer","Farmer ID","Crop","Variety","Type","PDN Qty","Arrival Qty","Raw Seed Qty","Condition Seed Qty","Cond. Loss (RM + IM)","Date of Processing","GOT Result","DOGR","QC Result","DoT","Germination %","Genetic Purity %","ForTool","ForYear","Agreement ID","lotno","Mode of Transport","Transport Name","Lorry Receipt No.","Vehicle No.","Payment Mode","Courier Name","Docket No.","By Hand Person Name"); 
...
if($tot_rr > 0)
{
$data1[$d]=array($trdate1,$frn,$lotno1,$ploc,$pper,$orgniser,$farmer,$farmerid,$crpnm,$vername,$vernm,$pqty,$arrqty,$rswqty,$cswqty,$tplqty,$prsldate,$gotr,$dogr,$qcstatus,$dot,$gemp,$genpurity,$fortool,$foryear,$agreementid,$lotimp, $tmode, $trans_name, $trans_lorryrepno, $trans_vehno, $trans_paymode, $courier_name, $docket_no, $pname_byhand); 
$d++;$cntt++;
}
}
}
