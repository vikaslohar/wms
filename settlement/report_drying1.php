...
<title>Settlement - Report - Periodical Drying Report</title>
...
winHandle=window.open('report_drying2.php?sdate='+sdate+'&txtcrop='+itemid+'&txtvariety='+vv+'&edate='+edate,'WelCome','top=20,left=80,width=850,height=600,scrollbars=yes');
if(winHandle==null){
...
?>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#ef0388" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#ef0388" style="border-bottom:solid; border-bottom-color:#ef0388" >
	    <tr >
	      <td width="813" height="25">&nbsp;Periodical Drying Report</td>
	    </tr></table></td>
	  </tr>
	  </table></td></tr>
...
<tr class="tblsubtitle" height="20">
	...
	<td width="50"  align="center" valign="middle" class="tblheading"rowspan="2" >Drying Slip Ref. No.</td>
	...
	<td align="center" valign="middle" class="tblheading" colspan="2">Drying Loss </td>
	<td width="69" align="center" valign="middle" class="tblheading"rowspan="2" >Farmer Name</td>
	<td width="69" align="center" valign="middle" class="tblheading"rowspan="2" >Farmer ID</td>
	<td width="69" align="center" valign="middle" class="tblheading"rowspan="2" >Prod. Location</td>
</tr>
...
while($row_arr_home1=mysqli_fetch_array($sql_arr_home1))
{
	...
	$lot1=$zz[1].$zz[2].$zz[3].$zz[4].$zz[5].$zz[6];
	
	$sql_lotimp=mysqli_query($link,"select * from tbllotimp where lotnumber='".$lot1."' ") or die(mysqli_error($link));
...
<tr class="Light">
	...
	<td align="center" valign="middle" class="tblheading"><?php echo $row_arr_home1['drefno'];?></td>
	<td align="center" valign="middle" class="tblheading"><?php echo $cropn?></td>
	<td align="center" valign="middle" class="tblheading"><?php echo $varietyn?></td>
	<td align="center"  valign="middle" class="tblheading" ><?php echo $row_issuetbl['lotno'];?></td>
	<td align="center"  valign="middle" class="tblheading" ><?php echo $row_issuetbl['onob'];?></td>
	<td width="94" align="center" valign="middle" class="tblheading"><?php echo $row_issuetbl['oqty'];?></td>
	<td align="center" valign="middle" class="tblheading"><?php echo $row_issuetbl['nob1'];?></td>
	<td align="center" valign="middle" class="tblheading"><?php echo $row_issuetbl['qty1'];?></td>
	<td width="86" align="center" valign="middle" class="tblheading"><?php echo $row_issuetbl['adnob'];?></td>
	<td width="67" align="center" valign="middle" class="tblheading"><?php echo $row_issuetbl['adqty'];?></td>
	<td align="center"  valign="middle" class="tblheading" ><?php echo $farmer;?></td>
	<td align="center"  valign="middle" class="tblheading" ><?php echo $farmerid;?></td>
	<td align="center"  valign="middle" class="tblheading" ><?php echo $prodloc;?></td>
</tr>
<?php
}
else
...
<tr >
<td height="49" align="center" valign="top"><a href="report_drying.php"><img src="../images/back.gif" border="0"  style="display:inline;cursor:pointer;"/></a>&nbsp;&nbsp;<img src="../images/printpreview.gif" onclick="openprint()" style="cursor:pointer" border="0" />
