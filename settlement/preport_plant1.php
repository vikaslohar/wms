...
<title>Settlement- Report -Consolidated Report</title>
...
if($loc=="ALL")
{
$sql_tbl_sub=mysqli_query($link,"select * from tblarrival_sub where plantcode='$plantcode' AND lotcrop='".$crop."' and lotvariety='".$row_tbl_s[1]."' and sstage='".$row_tbl_s[0]."'") or die(mysqli_error($link));
}
else
{
$sql_tbl_sub=mysqli_query($link,"select * from tblarrival_sub where plantcode='$plantcode' AND lotcrop='".$crop."' and lotvariety='".$row_tbl_s[1]."' and sstage='".$row_tbl_s[0]."'") or die(mysqli_error($link));
