<?php
	...
	if(isset($_POST['frm_action'])=='submit')
	{
		...
		echo "<script>window.location='add_lotps_preview.php?sdate=$sdate&edate=$edate&txtcrop=$crop&txtvariety=$variety&txtpmcode=$txtpmcode&sid=$sid'</script>";
	}
...
<title>Settlement - Transaction - Settlement</title>
...
<tr class="Light">
	...
	<td align="center" valign="middle" class="smallesttbltext"><input type="checkbox" name="pschk<?php echo $cnt?>" id="pschk_<?php echo $cnt?>" value="<?php echo $lotno;?>" <?php if(in_array($lotno,$sid3)) {echo "checked=checked";}?> /></td>
</tr>
<?php
}
else
