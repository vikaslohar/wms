...
winHandle=window.open('report_dryarr2.php?sdate='+sdate+'&edate='+edate+'&txtcrop='+txtcrop+'&txtvariety='+txtvariety,'WelCome','top=20,left=80,width=1000,height=900,scrollbars=yes');
if(winHandle==null){
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#ef0388" style="border-bottom:solid; border-bottom-color:#ef0388" >
	    <tr >
	      <td width="813" height="25">&nbsp; Cob Arrival Report </td>
	    </tr></table></td>
	  </tr>
	  </table></td></tr>
...
<table align="center" border="0" cellspacing="0" cellpadding="0" width="954" style="border-collapse:collapse">
    	<tr height="25" >
...
<tr class="tblsubtitle" height="25">
	...
	<td width="67" align="center" valign="middle" class="tblheading"rowspan="2" >Farmer ID</td>
	<td width="67" align="center" valign="middle" class="tblheading"rowspan="2" >FRN No.</td>
...
while($row_arr_home=mysqli_fetch_array($sql_arr_home))
{
	...
	$farm="";$crop=""; $variety=""; $lotno=""; $bags=""; $qty=""; $bags2=""; $qty2=""; $stage=""; $got=""; $qc="";$moist=""; $org=""; $pp=""; $pp1=""; $pp12="";$trdate1=""; $p=""; $stnno1=""; $farmerid='';
...
<tr class="Light" height="25">
	...
	<td align="center" valign="middle" class="smalltbltext"> <?php echo $farmerid;?> </td>
...
<tr >
<td height="49" align="center" valign="top"><a href="report_dryarr.php"><img src="../images/back.gif" border="0"  style="display:inline;cursor:pointer;"/></a>&nbsp;&nbsp;<img src="../images/printpreview.gif" onclick="openprint()" style="cursor:pointer" border="0" />
