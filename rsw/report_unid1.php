...
<title>RSW-Report -Unidentified Raw Seed Report</title>
...
<table width="1003" height="600" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  ...
  <?php
	...
	$qry="select * from tbl_lot_ldg where lotldg_sstage='Raw' and lotldg_trtype='Unidentified' and lotldg_trdate<='$edate' and plantcode='$plantcode'";	
...
?>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#e48324" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#e48324" style="border-bottom:solid; border-bottom-color:#e48324" >
	    <tr >
	      <td width="813" height="25">&nbsp;Unidentified Raw Seed Report - As on Date: <?php echo date("d-m-Y");?></td>
	    </tr></table></td>
	  </tr>
	  </table></td></tr>
...
$row31=mysqli_fetch_array($sql_crop);
 ...
 $quer4=mysqli_query($link,"SELECT varietyid, popularname FROM tblvariety where cropname='".$row_tbl_sub['lotldg_crop']."'  and vertype='PV' order by popularname Asc"); 
...
<tr >
<td height="49" align="center" valign="top"><?php if($tot_arr_home > 0){?><img src="../images/printpreview.gif" onclick="openprint()" style="cursor:pointer" border="0" /><input type="hidden" name="txtinv" value="" /><?php } ?></td>
</tr>
</table>
</td><td ></td>
</tr>
