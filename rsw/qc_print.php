...
<title>QC - Transaction- Qc Sampling</title>
...
?>
  <?php
$sql_tbl=mysqli_query($link,"select * from tbl_rsw_main where arr_role='".$logid."' and plantcode='$plantcode' and arrival_id='".$tid."'") or die(mysqli_error($link));
...
$quer3=mysqli_query($link,"SELECT * FROM tblvariety where varietyid ='".$row_tbl_sub['variety']."' and actstatus='Active' and vertype='PV' and plantcode='$plantcode'"); 
