...
$s_sub="delete from tbl_rsw where arrsub_id='".$b."'";
mysqli_query($link,$s_sub) or die(mysqli_error($link));


$sql_t_sub=mysqli_query($link,"select * from tbl_rsw where arrival_id='".$a."' and plantcode='$plantcode'") or die(mysqli_error($link));
