<?php
	...
	if(isset($_POST['frm_action'])=='submit')
	{
		...
		$age = $_REQUEST['txtage'];		
		echo "<script>window.location='report_idle1.php?txtcrop=$cid&age=$age'</script>";
	}
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#e48324" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#e48324" style="border-bottom:solid; border-bottom-color:#e48324" >
	    <tr >
	      <td width="813" height="30"class="Mainheading"  >&nbsp;Raw Seed Idle Report   </td>
	    </tr></table></td>
	  </tr>
	  </table></td></tr>
          ...
          <tr>
            ...
            <td><table align="center" border="1" width="574" cellspacing="0" cellpadding="0" bordercolor="#e48324" style="border-collapse:collapse" >
                <tr class="tblsubtitle" height="25">
                  <td colspan="4" align="center" class="tblheading">Raw Seed Idle Report </td>
                </tr>
                <tr height="15">
...
<td width="256" align="right"  valign="middle" class="tblheading">Crop&nbsp;</td>
<td width="312" colspan="3" align="left"  valign="middle" class="tbltext" >&nbsp;<select class="tbltext" name="txtcrop" style="width:170px;">
...
<tr class="Light" height="25">
	<td align="right"  valign="middle" class="tblheading" >Age&nbsp;</td>
