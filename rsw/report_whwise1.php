...
{
$sql_tbl1=mysqli_query($link,"select max(lotldg_id) from tbl_lot_ldg where lotldg_whid='".$txtslwhg."' and lotldg_binid='".$row_arr_home1['lotldg_binid']."' and lotldg_subbinid='".$row_tbl['lotldg_subbinid']."' and plantcode='$plantcode' and lotldg_sstage='Raw' group by lotldg_lotno order by lotldg_id desc") or die(mysqli_error($link));  
