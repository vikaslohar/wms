...
<tr>
<td width="30"></td> <td>
 <table align="center" border="0" cellspacing="0" cellpadding="0" width="950" bordercolor="#e48324" style="border-collapse:collapse">
<tr height="25" >
...
$row31=mysqli_fetch_array($sql_crop);
 ...
 $quer4=mysqli_query($link,"SELECT varietyid, popularname FROM tblvariety where varietyid='".$row_tbl_sub['lotldg_variety']."'  and vertype='PV' order by popularname Asc"); 
