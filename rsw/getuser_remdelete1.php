...
$s_sub="delete from tbl_rswrem_sub where rswremsub_id='".$b."' and plantcode='$plantcode'";
mysqli_query($link,$s_sub) or die(mysqli_error($link));

$s_sub_sub="delete from tbl_rswremsub_sub where rswremsub_id='".$b."' and plantcode='$plantcode'";
mysqli_query($link,$s_sub_sub) or die(mysqli_error($link));

$sql_t_sub=mysqli_query($link,"select * from tbl_rswrem_sub where rswrem_id='".$a."' and plantcode='$plantcode'") or die(mysqli_error($link));
...
{
$s_sub1="delete from tbl_rswrem where rswrem_id='".$a."' and plantcode='$plantcode'";
...
$sql_subbinn=mysqli_query($link,"select sname from tbl_subbin where sid='".$row_subsub['subbinid']."' and binid='".$row_subsub['binid']."' and whid='".$row_subsub['whid']."' and plantcode='$plantcode'") or die(mysqli_error($link));
