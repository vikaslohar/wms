...
$sql_tbl=mysqli_query($link,"select * from tbl_sloc where surole='".$logid."' and supflg=0 and plantcode='$plantcode'") or die(mysqli_error($link));
...
<title>RSW- Transaction - Sloc Update -  Home</title>
...
<table width="1003" height="600" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#e48324" >
	  ...
	  <table width="809" border="0" cellpadding="0" cellspacing="0" bordercolor="#e48324" style="border-bottom:solid; border-bottom-color:#e48324" >
	    <tr >
	      <td width="810" height="25">&nbsp;Transaction - SLOC Updation</td>
	    </tr></table></td>
	  <td width="139" height="25" align="right" class="submenufont" >
	  <table border="3" align="right" bordercolor="#e48324" cellspacing="0" cellpadding="0" width="130" style="border-collapse:collapse;">

<tr height="15" class="tbltitle" >
<td align="center" width="100" valign="middle" class="tblbutn" style="cursor:hand;"><?php if($flg==0 && $flg1==0 && $flg2==0) { ?><a href="add_sloc.php" style="text-decoration:none; color:#FFFFFF">Add </a><?php } else { ?><a href="Javascript:void(0);" onclick="alert('Can not perform Transaction.\nReason:\n1. Todays date is not in Active Current Financial Year.\n2. Transaction after todays date has been made.\n3. Cycle Inventory transaction is under process.');" style="text-decoration:none; color:#FFFFFF">Add </a><?php } ?></td>
</tr>
...
$adjacents = 3;
 	...
 	$query = "SELECT COUNT(*) as num FROM tbl_sloc where supflg=1 and stage='Raw Seed' and plantcode='$plantcode'";
	...
	/* Get data. */
	$sql = "select * from tbl_sloc where supflg=1 and stage='Raw Seed' and plantcode='$plantcode' order by slid desc LIMIT $start, $limit";
...
$sql_arr_home=mysqli_query($link,"select * from tbl_sloc where supflg=1 and stage='Raw Seed' order by scode desc LIMIT $from, $max_results") or die(mysqli_error($link));
$tot_arr_home=mysqli_num_rows($sql_arr_home);

$total_results3 =mysqli_query($link,"SELECT COUNT(*)  FROM tbl_sloc where supflg=1");
$total_results2 = mysqli_fetch_array($total_results3);
$total_results = $total_results2[0]; 
*/
?>

<table align="center" border="0" width="700" cellspacing="0" cellpadding="0" bordercolor="#e48324" style="border-collapse:collapse" > 
