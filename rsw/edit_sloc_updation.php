...
<title>RSW-Transction-Sloc Updation</title>
...
$sql_qc=mysqli_query($link,"SELECT distinct(variety) FROM tbl_qctest WHERE crop='".$row['crop']."' and variety NOT RLIKE '^[-+0-9.E]+$' and plantcode='$plantcode'");
...
$sql_issue1=mysqli_query($link,"select max(lotldg_id) from tbl_lot_ldg where lotldg_subbinid='".$row_issue['lotldg_subbinid']."' and lotldg_binid='".$row_issue['lotldg_binid']."' and lotldg_whid='".$row_issue['lotldg_whid']."' and lotldg_variety='".$f."' and lotldg_lotno='".$a."' and plantcode='$plantcode'") or die(mysqli_error($link));
