...
$sql_m=mysqli_query($link,"select distinct lotldg_lotno from tbl_lot_ldg where lotldg_crop='".$a."' and lotldg_variety='".$b."' and lotldg_sstage='".$c."' and plantcode='$plantcode'") or die(mysqli_error($link));
