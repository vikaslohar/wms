...
if(isset($_REQUEST['pid']))
	...
	$sql_code="SELECT MAX(rswrem_code) FROM tbl_rswrem WHERE plantcode='$plantcode' ORDER BY rswrem_code DESC";
...
$sql_tbl_subsub=mysqli_query($link,"select * from tbl_rswremsub_sub where rswremsub_id='".$row_tbl_sub['rswremsub_id']."' and rswrem_id='".$row_tbl_sub['rswrem_id']."' and plantcode='$plantcode'") or die(mysqli_error($link));
