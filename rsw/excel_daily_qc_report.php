...
session_start();
	...
	$sql_arr_home=mysqli_query($link,"select distinct(sampleno) from tbl_qctest where testdate='$sdate' and trstage='Raw' and plantcode='$plantcode' and plantcode='$plantcode' order by crop asc, variety asc, oldlot asc") or die(mysqli_error($link));
