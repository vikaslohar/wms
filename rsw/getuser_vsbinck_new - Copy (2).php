...
if($tpmflg==0)
{
	...
	{ 
		...
		if($whval=='14')
		{
			$s_good=mysqli_query($link,"select distinct lotldg_variety from tbl_lot_ldg_pack where subbinid='".$a."' and lotldg_variety!='".$b."' and lotldg_crop='".$crpval."' and plantcode='$plantcode'") or die(mysqli_error($link));
		}
		else
		{
