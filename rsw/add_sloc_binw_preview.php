...
{	
	$sql_arr=mysqli_query($link,"select * from tbl_sloc_binw where slid='".$pid."' ") or die(mysqli_error($link));
	...
	$sql_sloc_sub22=mysqli_query($link,"select * from tbl_sloc_binw_sub where slocid='".$pid."' ") or die(mysqli_error($link));
...
//echo "select * from tbl_sloc_binw_sub where slocid='".$pid."' ";
	$sql_sub=mysqli_query($link,"select * from tbl_sloc_binw_sub where slocid='".$pid."' ")or die(mysqli_error($link));
...
//echo "select * from tbl_sloc_binw_sub where slocid='".$pid."' and lotno='".$lot."' and whid='".$row_sub['whid']."' and binid='".$row_sub['binid']."' and subbinid='".$row_sub['subbinid']."'";
$tot_sub2=0;
$sql_sub2=mysqli_query($link,"select * from tbl_sloc_binw_sub where slocid='".$pid."' and lotno='".$lot."' and whid='".$row_sub['whid']."' and binid='".$row_sub['binid']."' and subbinid='".$row_sub['subbinid']."'")or die(mysqli_error($link));
