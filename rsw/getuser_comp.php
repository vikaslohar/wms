...
?>
<table align="center" border="1" width="750" cellspacing="0" cellpadding="0" bordercolor="#e48324" style="border-collapse:collapse"  cols="2">
<tr class="tblsubtitle">
	<td width="70" align="center" valign="middle" class="tblheading" ><a href="Javascript:void(0);" onclick="chkall()">CA</a>  |  <a href="Javascript:void(0);" onclick="clall()">CL</a></td>
...
<?php
$srno=1; $cnt=0; $cropt="";$vert=""; $crpflg=0; $verflg=0; $stage=""; $stageflg=0; $stg="Raw";
$sql_iss=mysqli_query($link,"select distinct (lotldg_lotno)  from tbl_lot_ldg where lotldg_whid='".$b."' and lotldg_binid='".$c."' and lotldg_subbinid='".$a."' and plantcode='$plantcode'") or die(mysqli_error($link));
$tot=mysqli_num_rows($sql_iss);
while($row_iss=mysqli_fetch_array($sql_iss))
{ 

$sql_issue1=mysqli_query($link,"select max(lotldg_id) from tbl_lot_ldg where lotldg_subbinid='".$a."' and lotldg_binid='".$c."' and lotldg_whid='".$b."' and lotldg_lotno='".$row_iss['lotldg_lotno']."' and plantcode='$plantcode'") or die(mysqli_error($link));
...
$sql_veriety=mysqli_query($link,"Select * from tblvariety where varietyid='".$row_issuetbl['lotldg_variety']."' and actstatus='Active' and vertype='PV'") or die(mysqli_error($link));
...
<tr class="Light" height="30">
	<td width="70" align="center" valign="middle" class="tblheading"><input type="checkbox" name="lotsn" id="lotsn<?php echo $srno;?>" value="<?php echo $lot;?>" checked="checked" /></td>
...
{
?><br />
<table align="center" border="1" width="750" cellspacing="0" cellpadding="0" bordercolor="#e48324" style="border-collapse:collapse"> <tr class="tblsubtitle">
...
<tr class="Dark" height="25">
  ...
  <?php
$whg24_query=mysqli_query($link,"select whid, perticulars from tbl_warehouse where plantcode='$plantcode' order by perticulars")or die(mysqli_error($link));
?>                 
