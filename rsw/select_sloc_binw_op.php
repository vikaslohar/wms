...
<?php
$sql_tbl=mysqli_query($link,"select * from tbl_lot_ldg where lotldg_trtype='SBWSUO' and lotldg_trid='".$pid."' and plantcode='$plantcode'") or die(mysqli_error($link));
...
<?php
$sql_tbl=mysqli_query($link,"select * from tbl_lot_ldg where lotldg_trtype='SBWSUC' and lotldg_trid='".$pid."' and plantcode='$plantcode'") or die(mysqli_error($link));
