<?
	...
	if(isset($_POST['frm_action'])=='submit')
	{
		...
		echo "<script>window.location='report_rawcrop1.php?slchk=$slchk&slchk2=$slchk2&txtcrop=$cid&txtvariety=$itemid'</script>";
	}
...
<table width="1003" height="600" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  <tr>
    <td valign="top"><table width="1003" height="72" border="0" cellspacing="0" cellpadding="0" align="center">
        <tr>
          <td valign="top"><? require_once("../include/arr_rsw.php");?></td>
        </tr>
      </table>
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#e48324" >
	  ...
	  <form name="frmaddDepartment" method="post" action="<? $_SERVER['PHP_SELF']; ?>" > 
	  ...
	  <input type="hidden" name="slck2" value="no" />
	    <table  border="0" cellspacing="0" cellpadding="0" align="center" width="974"  style="border-collapse:collapse">
          ...
          <tr>
            <td width="30"></td>
            <td><table align="center" border="1" width="600" cellspacing="0" cellpadding="0" bordercolor="#e48324" style="border-collapse:collapse" >
...
<option value="ALL" selected>--ALL--</option>
	<? while($noticia = mysqli_fetch_array($quer3)) { ?>
		<option value="<?=$noticia['cropid'];?>" />   
		<?=$noticia['cropname'];?>
		<? } ?>
	</select>
              <font color="#FF0000">*</font>&nbsp;</td>
                ...
                <tr class="Dark" height="25">
                   <?
$quer4=mysqli_query($link,"SELECT varietyid, popularname FROM tblvariety  and vertype='PV' order by popularname Asc"); 
?>
...
<option value="ALL" selected>--ALL--</option>
	<? while($noticia_item = mysqli_fetch_array($sql_month)) { ?>
		<option value="<?=$noticia_item['varietyid'];?>" />   
		<?=$noticia_item['popularname'];?>
 ...
 <tr class="Light" height="25">
    ...
    <td align="left"  valign="middle" class="tbltext" id="vitem" colspan="2">&nbsp;<input tabindex="0" type="radio" name="whadte" value="yes" onclick="slchk2(this.value)" />Yes&nbsp;<input tabindex="0" type="radio" name="whadte" value="no" onclick="slchk2(this.value)" checked="checked" />No</td>
	  ...
	  <input type="hidden" name="cdate" value="<?=date("d-m-Y");?>" />
	  </form>	  </td>
	  </tr>
	  </table>
<!-- actual page end--->			  
