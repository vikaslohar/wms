...
$sqlistbl=mysqli_query($link,"select * from tbl_lot_ldg where lotldg_lotno='".$row_arr_home['lotldg_lotno']."' and lotldg_sstage='Raw' and lotldg_variety='".$variety."' and plantcode='$plantcode' order by lotldg_id asc") or die(mysqli_error($link)); 
