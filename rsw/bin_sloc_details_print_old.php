...
<title>RSW-Transaction -Bin card</title>
...
//$sql_main=mysqli_query($link,"select lotldg_subbinid, lotldg_variety from tbl_lot_ldg where lotldg_whid='".$wid."' and lotldg_binid='".$bid."' group by lotldg_subbinid, lotldg_variety order by lotldg_subbinid") or die(mysqli_error($link));  
...
<td width="601" align="left"  valign="middle" class="tblheading">&nbsp;Bin Status Card</td>
...
<table align="center" border="1" cellspacing="0" cellpadding="0" width="800" bordercolor="#e48324" style="border-collapse:collapse">
			...
			<tr class="tblsubtitle">
			  ...
			  <td width="15%" align="center" valign="middle" class="tblheading">Lot Number</td>
			  <td width="20%" align="center" valign="middle" class="tblheading">Crop</td>
			  <td width="33%" align="center" valign="middle" class="tblheading">Variety</td>
...
<?php
$srno=1;
$sql_tbl=mysqli_query($link,"select lotldg_subbinid, lotldg_variety from tbl_lot_ldg where lotldg_whid='".$wid."' and lotldg_binid='".$bid."' and plantcode='$plantcode' group by lotldg_subbinid, lotldg_variety order by lotldg_subbinid") or die(mysqli_error($link));   
//echo $t=mysqli_num_rows($sql_tbl);
while($row_tbl=mysqli_fetch_array($sql_tbl))
{

$sql_tbl1=mysqli_query($link,"select max(lotldg_id) from tbl_lot_ldg where lotldg_whid='".$wid."' and lotldg_binid='".$bid."' and lotldg_subbinid='".$row_tbl['lotldg_subbinid']."' and lotldg_variety='".$row_tbl['lotldg_variety']."' and lotldg_crop='".$row_tbl['lotldg_crop']."' and plantcode='$plantcode'") or die(mysqli_error($link));  
...
{
/*$sql_class=mysqli_query($link,"select * from tbl_classification where classification_id='".$row_tbl_sub['lotldg_trclassid']."'") or die(mysqli_error($link));
$row_class=mysqli_fetch_array($sql_class);

$sql_item=mysqli_query($link,"select * from tbl_stores where items_id='".$row_tbl_sub['lotldg_variety']."'") or die(mysqli_error($link));
...
?>			  
 <tr class="Light" height="20">
			 ...
			 <td width="9%" align="center" valign="middle" class="tblheading"><?php echo $row_subbinn['sname'];?></td>
			 <td width="15%" align="center" valign="middle" class="tblheading"><?php echo $row_tbl_sub['lotldg_lotno'];?></td>
             <td width="20%" align="center" valign="middle" class="tblheading"><?php echo $row_tbl_sub['lotldg_crop'];?></td>
			 <td align="center" valign="middle" class="tblheading"><?php echo $row_tbl_sub['lotldg_variety'];?></td>
<?php
$slups=0; $slqty=0;
...
?>			 
		     <td width="9%" align="center" valign="middle" class="tblheading"><?php echo $slups;?></td>
 		     <td width="9%" align="center" valign="middle" class="tblheading"><?php echo $slqty;?></td>
 </tr>
<?php
}
else
