...
$sql_main=mysqli_query($link,"select lotldg_subbinid, lotldg_variety from tbl_lot_ldg where lotldg_whid='".$wid."' and lotldg_binid='".$bid."' and lotldg_subbinid='".$slid."' and plantcode='$plantcode' group by lotldg_subbinid, lotldg_variety order by lotldg_subbinid") or die(mysqli_error($link));  
...
$sql_tbl1=mysqli_query($link,"select max(lotldg_id) from tbl_lot_ldg where lotldg_whid='".$wid."' and plantcode='$plantcode' and lotldg_binid='".$bid."' and lotldg_subbinid='".$slid."'  and lotldg_variety='".$vid."' and lotldg_crop='".$crop."'") or die(mysqli_error($link));  
