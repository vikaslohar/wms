...
if($z1 == 0)
{
  $sql_main="insert into tbl_rsw_main (crop, varietyyear_code,arr_code, arrival_date,arr_role,plantcode)values('$o','$p','$yearid_id','$c','$tdate1','$logid','$plantcode')";
if(mysqli_query($link,$sql_main) or die(mysqli_error($link)))
{
$mainid=mysqli_insert_id($link);

 $sql_sub="insert into tbl_rsw (crop, variety,pp,moist,gemp,got,arr_role,lotno ,arrival_id,plantcode)values('$o','$p','$a','$b','$f','$d','$logid','$lot2','$mainid','$plantcode')";
...
{
 $sql_main="update tbl_rsw_main set crop='$o',variety='$p',year_code='$yearid_id' , arrival_date='$tdate1',arr_role='$logid' where arrival_id = '$z1'";

if(mysqli_query($link,$sql_main) or die(mysqli_error($link)))
{
$mainid=$z1;
$sql_sub="update tbl_rsw set crop='$o',variety='$p', pp='$a',moist='$b',gemp='$f',got='$d',arrival_date='$tdate1', arr_role='$logid' where arrsub_id = '$subtrid'";
mysqli_query($link,$sql_sub) or die(mysqli_error($link));
}
}
