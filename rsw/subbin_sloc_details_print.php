...
<title>RSW - Transaction - Sloc details</title>
...
$sql_main123=mysqli_query($link,"select lotldg_crop, lotldg_variety from tbl_lot_ldg where lotldg_id='".$lid."' and plantcode='$plantcode'") or die(mysqli_error($link));  
...
$sql_main=mysqli_query($link,"select lotldg_subbinid, lotldg_variety, lotldg_lotno from tbl_lot_ldg where lotldg_whid='".$wid."' and plantcode='$plantcode' and lotldg_binid='".$bid."' and lotldg_subbinid='".$slid."' group by lotldg_subbinid, lotldg_variety, lotldg_lotno order by lotldg_subbinid") or die(mysqli_error($link));  
...
$sql_subbinn=mysqli_query($link,"select sname from tbl_subbin where sid='".$slid."' and binid='".$bid."' and plantcode='$plantcode' and whid='".$wid."'") or die(mysqli_error($link));
$row_subbinn=mysqli_fetch_array($sql_subbinn);
?>
<table align="center" border="0" width="800" cellspacing="0" cellpadding="0" bordercolor="#e48324" style="border-collapse:collapse" >
...
$sql_tbl1=mysqli_query($link,"select max(lotldg_id) from tbl_lot_ldg where lotldg_whid='".$wid."' and plantcode='$plantcode' and lotldg_binid='".$bid."' and lotldg_subbinid='".$row_tbl['lotldg_subbinid']."' and lotldg_variety='".$vid."' and lotldg_crop='".$crop."'  and lotldg_lotno='".$row_tbl['lotldg_lotno']."'") or die(mysqli_error($link));  
...
$sql_item=mysqli_query($link,"select * from tblarrival_sub where arrival_id='".$row_tbl_sub['lotldg_trid']."' and plantcode='$plantcode' and lotno='".$row_tbl_sub['lotldg_lotno']."'") or die(mysqli_error($link));
$row_item=mysqli_fetch_array($sql_item);


$sql_subbinn=mysqli_query($link,"select sname from tbl_subbin where sid='".$row_tbl_sub['lotldg_subbinid']."' and plantcode='$plantcode' and binid='".$bid."' and whid='".$wid."'") or die(mysqli_error($link));
$row_subbinn=mysqli_fetch_array($sql_subbinn);
...
$sql_main=mysqli_query($link,"select subbinid, lotldg_variety, lotno, lotldg_crop from tbl_lot_ldg_pack where whid='".$wid."' and plantcode='$plantcode' and binid='".$bid."' and subbinid='".$slid."' group by subbinid, lotldg_variety, lotno order by subbinid") or die(mysqli_error($link));  
...
//echo $row_tbl['lotno'];
//echo $vid;
$sql_tbl1=mysqli_query($link,"select max(lotdgp_id) from tbl_lot_ldg_pack where whid='".$wid."' and binid='".$bid."' and plantcode='$plantcode' and subbinid='".$row_tbl['subbinid']."' and lotldg_variety='".$row_tbl['lotldg_variety']."' and lotldg_crop='".$row_tbl['lotldg_crop']."'  and lotno='".$row_tbl['lotno']."'") or die(mysqli_error($link));  
$row_tbl1=mysqli_fetch_array($sql_tbl1);
$t1=mysqli_num_rows($sql_tbl1);
//echo $row_tbl1[0];
...
$sql_item=mysqli_query($link,"select * from tblarrival_sub where arrival_id='".$row_tbl_sub['lotldg_id']."' and lotno='".$row_tbl_sub['lotno']."' and plantcode='$plantcode'") or die(mysqli_error($link));
$row_item=mysqli_fetch_array($sql_item);
...
$sql_crop=mysqli_query($link,"select * from tblcrop where cropid='".$row_tbl_sub['lotldg_crop']."' and plantcode='$plantcode'") or die(mysqli_error($link));
$row_crop=mysqli_fetch_array($sql_crop);
...
if($row_tbl_sub['lotldg_variety']!=$varchk && $row_tbl_sub['lotldg_variety']!=$varchk2)
{		
	$sql_veriety=mysqli_query($link,"select * from tblvariety where varietyid='".$row_tbl_sub['lotldg_variety']."' and actstatus='Active' and vertype='PV' and plantcode='$plantcode'") or die(mysqli_error($link));
	$row_variety=mysqli_fetch_array($sql_veriety);
	$varty=$row_variety['popularname'];
}
else
