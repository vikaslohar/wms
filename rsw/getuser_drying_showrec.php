...
$srno=1;
$lotqry=mysqli_query($link,"select * from tbl_lot_ldg where lotldg_crop ='".$b."' and lotldg_variety='".$c."' and lotldg_sstage='Raw' and lotldg_lotno='$a' and plantcode='$plantcode'")or die (mysqli_error($link));
