...
<title>RSW - Transaction - QC Sampling Request- Preview</title>
...
$sqltblsub2=mysqli_query($link,"select * from tbl_rsw where arrival_id='".$arrival_id."' and plantcode='$plantcode'") or die(mysqli_error($link));
...
<td width="234"  align="left" valign="middle" class="tbltext">&nbsp;Raw Seed</td>
