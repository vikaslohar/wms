...
if(isset($_POST['frm_action'])=='submit')
	{
	   ...
	   $sql_in="update tblopr set login='$login',
									pass='$pass',
									email='$email'
									where id='$loginid' and plantcode='$plantcode'";
											//exit;
		if(mysqli_query($link,$sql_in)or die(mysqli_error($link)))
          ...
          $sql_in1="Update tbluser set	loginid='$login',
										password='$pass',
										email='$email'
										where role='rsw' and scode='$scode' and plantcode='$plantcode'";	
...
<title>RSW In-charge Profile</title>
...
<!-- actual page start--->	
 ...
 <?php
	$result=mysqli_query($link,"SELECT * FROM tblopr where id='".$loginid."' AND plantcode='$plantcode'")or die(mysqli_error($link)); 
...
<table align="center" border="0" width="650" cellspacing="0" cellpadding="0" bordercolor="#e48324"
 style="border-collapse:collapse" > <tr><td>
<table width="700" border="1" cellspacing="0" cellpadding="0" align="center"  bordercolor="#e48324"
...
<?php 
$result1=mysqli_query($link,"SELECT * FROM tbldept where department_id='".$row['department_id']."' and plantcode='$plantcode'")or die(mysqli_error($link)); 
