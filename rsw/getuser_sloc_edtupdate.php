...
if($trid == 0)
{
 $sql_in1="insert into tbl_sloc (code, sldate, crop, variety, lotno, yearcode, surole, plantcode) values ('$code', '$tdate', '$txtcrop', '$txtvariety', '$txtlot1', '$yearid_id', '$lgnid', '$plantcode')";
...
if(mysqli_query($link,$sql_in1) or die(mysqli_error($link)))
{
 $mainid=mysqli_insert_id($link);
	...
	for($j=1; $j<=$ocnt; $j++)
	{
		...
		{
			$sql_in="insert into tbl_sloc_sub(slocid, crop, variety, lotno, whid, binid, subbinid, opbags, opqty, balbags, balqty, bags, qty, rowid, $plantcode) values('$mainid', '$txtcrop', '$txtvariety', '$txtlot1', '$txtwhg', '$txtbing', '$txtsubbg', '$exBagsg', '$exqtyg', '$balBagsg', '$balqtyg', '$txtslBagsg', '$txtslqtyg', '$orwoid', '$plantcode')";
...
{
$sql_in1="update tbl_sloc set crop='$txtcrop', variety='$txtvariety', lotno='$txtlot1', yearcode='$yearid_id', surole='$lgnid' where slid='".$trid."'";
 
if(mysqli_query($link,$sql_in1) or die(mysqli_error($link)))
{

$s_sub_sub="delete from tbl_sloc_sub where rowid='".$orwoid."' and slocid='".$trid."'";
...
$sql_sloc=mysqli_query($link,"select * from tbl_sloc_sub where slocid='".$trid."' and rowid='".$row_issue1[0]."' and plantcode='$plantcode'") or die(mysqli_error($link));
