...
?>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#e48324" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#e48324" style="border-bottom:solid; border-bottom-color:#e48324" >
	    <tr >
	      <td width="813" height="25">Crop Variety wise Raw Seed Report </td>
	    </tr></table></td>
	  </tr>
	  </table></td></tr>
...
$sql_rr=mysqli_query($link,"select distinct lotldg_variety from tbl_lot_ldg where lotldg_crop='".$row_arr_home1['lotldg_crop']."' and lotldg_variety='".$row_arr_home1['lotldg_variety']."' and lotldg_sstage='Raw' and plantcode='$plantcode' order by lotldg_id desc") or die(mysqli_error($link));
...
while($row_rr=mysqli_fetch_array($sql_rr))
{
	...
	$sql_crop=mysqli_query($link,"select * from tblcrop where cropid='".$row_arr_home1['lotldg_crop']."'") or die(mysqli_error($link));
		...
		$ccnt=0;
$sql_arhome=mysqli_query($link,"select distinct lotldg_lotno from tbl_lot_ldg where  lotldg_crop='".$row_arr_home1['lotldg_crop']."' and lotldg_variety='".$row_rr['lotldg_variety']."'  and lotldg_sstage='Raw' and plantcode='$plantcode' group by lotldg_lotno order by lotldg_id asc") or die(mysqli_error($link));
	while($row_arhome=mysqli_fetch_array($sql_arhome))
{  
	$sql_is=mysqli_query($link,"select distinct lotldg_subbinid, lotldg_whid, lotldg_binid from tbl_lot_ldg where  lotldg_lotno='".$row_arhome['lotldg_lotno']."'  and lotldg_sstage='Raw' and plantcode='$plantcode' group by lotldg_subbinid order by lotldg_id asc") or die(mysqli_error($link));
...
?>
  ...
  <table align="center" border="1" cellspacing="0" cellpadding="0" width="970" bordercolor="#e48324" style="border-collapse:collapse">
<tr height="25" >
...
<tr class="tblsubtitle" height="20">
		...
		<td width="120"  align="center" valign="middle" class="tblheading">Lot No.</td>
			...
			<td width="45" align="center" valign="middle" class="tblheading">Moist %</td>
			...
			<td width="86"  align="center" valign="middle" class="tblheading">Production Location</td>
			<td width="70"  align="center" valign="middle" class="tblheading">State</td>
			<td width="50"  align="center" valign="middle" class="tblheading">Seed Status</td>
...
$srno=0; $totalbags=0; $totalqty=0;
	$sql_arr_home=mysqli_query($link,"select distinct lotldg_lotno from tbl_lot_ldg where  lotldg_crop='".$row_arr_home1['lotldg_crop']."' and lotldg_variety='".$row_rr['lotldg_variety']."' and lotldg_sstage='Raw' and plantcode='$plantcode' group by lotldg_lotno order by lotldg_id asc") or die(mysqli_error($link));
	while($row_arr_home=mysqli_fetch_array($sql_arr_home))
{  $srno++;
$wareh=""; $binn=""; $subbinn=""; $slups=0; $slqty=0;	 $cnt=0; $ploc=""; $pstate="";
$totqty=0; $totnob=0; $totqc=""; $totdot=""; $totmost=""; $totgemp=""; $totgot=""; $reserve=""; $totsst=""; $sloc="";$txtdot=""; 
	$sql_issue=mysqli_query($link,"select distinct lotldg_subbinid, lotldg_whid, lotldg_binid from tbl_lot_ldg where  lotldg_lotno='".$row_arr_home['lotldg_lotno']."'  and lotldg_sstage='Raw' and plantcode='$plantcode' group by lotldg_subbinid order by lotldg_id asc") or die(mysqli_error($link));
...
$sql_issuetbl=mysqli_query($link,"select * from tbl_lot_ldg where lotldg_id='".$row_issue1[0]."' and lotldg_balqty > 0 and lotldg_sstage='Raw' and plantcode='$plantcode' order by lotldg_id asc") or die(mysqli_error($link)); 
...
<tr class="Light">
			<td align="center" valign="middle" class="tbltext"><?php echo $srno;?></td>
		  	<td align="center" valign="middle" class="tbltext"><?php echo $row_arr_home['lotldg_lotno']?></td>
			...
			<td align="center" valign="middle" class="tbltext"><?php echo $totgot;?></td>
           	<td align="center" valign="middle" class="tbltext"><?php echo $ploc;?></td>
           	<td align="center" valign="middle" class="tbltext"><?php echo $pstate;?></td>
			<td align="center" valign="middle" class="tbltext"><?php echo $totsst;?></td>
			<td align="center" valign="middle" class="tbltext"><?php echo $prodgrade;?></td>
			<td align="center" valign="middle" class="tbltext"><?php echo $gotgrade;?></td>
			<?php if($slchk2=="yes") { ?>
           	<td align="center" valign="middle" class="tbltext"><?php echo $ardt;?></td>
			<td align="center" valign="middle" class="tbltext"><?php echo $harvesdt;?></td>
			<?php } ?>
</tr>
<?php
}
...
<tr class="Dark">
			...
			<td align="center" valign="middle" class="tblheading" colspan="12">&nbsp;</td>
</tr>
</table>			
<br />
<?php
