<?php
	...
	{ 
		...
		//exit;
	 	$sql_in1="update tbl_sloc_binw set sldate='$tdate', wh='$who', bin='$bino', subbin='$subbino', yearcode='$yearid_id', surole='$lgnid', stage='$stageo', plantcode='$plantcode' where slid ='$pid'";
...
<title>RSW -Transaction  - Sloc Update SubBin wise</title>
...
{ 
	...
	{
		if(document.frmaddDepartment.lotsn1.checked==true)
		{
			if(document.frmaddDepartment.olots.value=="")
			{
				document.frmaddDepartment.olots.value=document.frmaddDepartment.lotsn1.value;
			}
			else
			{
				document.frmaddDepartment.olots.value=document.frmaddDepartment.olots.value+','+document.frmaddDepartment.lotsn1.value;
			}
		}
	}
