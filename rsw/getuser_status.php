...
<tr class="tblsubtitle" height="20">
  <td colspan="2" align="center" class="tblheading">QC Test</td>
</tr>
<?php
...
<td align="right"  valign="middle" class="tbltext">&nbsp;<input type="checkbox" readonly="true" name="sstatus" <?php $p1_array=explode("/",$tp);
			...
			foreach($p1_array as $val1)
				...
				if($i !=0) { echo "checked";}?> value="M"/>&nbsp;</td>
<td align="left"  valign="middle" class="tbltext" >&nbsp;Moisture(M)&nbsp;</td>
</tr>
...
<td align="right"  valign="middle" class="tbltext">&nbsp;<input type="checkbox" readonly="true" name="sstatus" <?php $p1_array=explode("/",$tp);
			...
			foreach($p1_array as $val1)
				...
				if($i !=0) { echo "checked";}?> value="P"/>&nbsp;</td>
<td align="left"  valign="middle" class="tbltext" >&nbsp;Physical Purity (P)</td>
</tr> 
...
<td align="right"  valign="middle" class="tbltext"><input type="checkbox" readonly="true" name="sstatus" <?php $p1_array=explode("/",$tp);
			...
			foreach($p1_array as $val1)
				...
				if($i !=0) { echo "checked";}?> value="G"/>&nbsp;</td>
<td align="left"  valign="middle" class="tbltext" >&nbsp;Germination(G)</td> 
</tr>  
<tr class="Dark" height="30">
<td align="right"  valign="middle" class="tbltext"><input type="checkbox" readonly="true" name="sstatus" <?php $p1_array=explode("/",$tp);
			$i=0;
			...
			foreach($p1_array as $val1)
				...
				if($i !=0) { echo "checked";}?> value="T"/>&nbsp;</td>
<td align="left"  valign="middle" class="tbltext" >&nbsp;GOT(T)</td> 
</tr> 
