...
$sql_t_sub=mysqli_query($link,"select * from tbl_dryingsub where trid='".$a."' and plantcode='$plantcode'") or die(mysqli_error($link));
...
<table align="center" border="1" width="850" cellspacing="0" cellpadding="0" bordercolor="#e48324" style="border-collapse:collapse" > <?php  
///echo $tid=$a;
