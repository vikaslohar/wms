...
//	private $conn_vnr;
	...
	public function getScannedBarcodeList($trid) {
		...
		$stmt1 = $this->conn_ps->prepare("SELECT pnpslipbar_barcode, pnpslipbar_grosswt FROM tbl_pnpslipbarcode WHERE pnpslipmain_id=?");
...
public function GetUPSListUpkg($scode, $mobile1, $cropname, $varietyname) 
{
	...
	public function GetLblNoUpdate($scode, $trid, $lbltype, $lblno, $macoprname, $dopdate, $mingrwt, $maxgrwt) {
		$plantcode = $this->getPlantcode($scode);
		$flg=0;
		if($macoprname!=''){
...
// return "Update tbl_pnpslipsub SET pnpslipsub_slabelno='$slblno', pnpslipsub_mingrwt='$mingrwt', pnpslipsub_maxgrwt='$maxgrwt' pnpslipsub_lblflg=1 where pnpslipmain_id = $trid ";
			$stmt6 = $this->conn_ps->prepare("Update tbl_pnpslipsub SET pnpslipsub_slabelno=?, pnpslipsub_mingrwt=?, pnpslipsub_maxgrwt=?, pnpslipsub_lblflg=1 where pnpslipmain_id = ? ");
			$stmt6->bind_param("sssi", $slblno, $mingrwt, $maxgrwt, $trid);
		}
		else
		{
	...
	public function GetTranDetails($scode,$trid, $mobile1) {
        ...
        if ($stmt->num_rows > 0) {
			...
			if ($stmt_2->num_rows == 0) {
				...
				$userSR["mingrwt"] = $pnpslipsub_mingrwt;
				$userSR["maxgrwt"] = $pnpslipsub_maxgrwt;
				$stmt_2->close();
