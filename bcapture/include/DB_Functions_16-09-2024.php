...
public function GetTranSetupLotyrcodelist() {
	...
	public function GetLblNoUpdate($scode, $trid, $lbltype, $lblno, $macoprname, $dopdate) {
		$plantcode = $this->getPlantcode($scode);
		$flg=0;
		if($macoprname!=''){
