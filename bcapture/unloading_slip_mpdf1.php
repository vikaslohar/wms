...
$sql_tbl=mysqli_query($link,"select * from tblarrival_unld where arrival_id='".$trid."'") or die(mysqli_error($link));
...
$logo="<img src='../help/vnrlogo1.jpg' height='50' width='50'/>";

$html=$html.'<table align="center" border="0" width="780" cellspacing="0" cellpadding="0" style="border-collapse:collapse" > 
<tr ><td align="left" width="50" class="Mainheading" style="font-size:10pt;"><font color="#000000" style="font-size:20pt;">';$html=$html.$logo;$html=$html.'</font></td><td align="center" class="Mainheading" style="font-size:10pt;"><font color="#000000" style="font-size:20pt;"><b>';$html=$html.$row_param['company_name'];$html=$html.'</b></font></td>
</tr></table><table align="center" border="0" width="1000" cellspacing="0" cellpadding="0" style="border-collapse:collapse" >
<tr ><td align="center" class="Mainheading"><font color="#000000" style="font-size:10pt;">';$html=$html.$address;$html=$html.'</td></tr>
<tr ><td align="center" class="Mainheading"><font color="#000000" style="font-size:10pt;">';$html=$html.$address1;$html=$html.'</td></tr>
...
<td align="center" class="Mainheading" ><font color="#000000" style="font-size:14pt;" colspan="2"><b>Raw Seed Unloading Sheet</b></font></td>
</tr>
</table><br />
...
</tr><tr class="Light" height="20">
<td align="right" width="187" valign="middle" class="tblheading">Total DC no. of lots&nbsp;</td>
<td align="left" width="263" valign="middle" class="tbltext" >';$html=$html.$row_tbl['passinno'];$html=$html.'</td>
 <td width="121" align="right" valign="middle" class="tblheading">Total Bags&nbsp;</td>
<td width="219" align="left" valign="middle" class="tbltext">';$html=$html.$row_class12[0];$html=$html.'</td>
</tr>
...
<tr height="20">
<td align="center" valign="middle" class="smalltblheading" width="10%" rowspan="2">Crop</td>
<td align="center" valign="middle" class="smalltblheading" width="8%" colspan="2">SP Code</td>
 ...
 <td align="center" valign="middle" class="smalltblheading" colspan="10" width="60%" rowspan="2">
 <table border="1" align="center" cellspacing="0" cellpadding="0" style="border-collapse:collapse" width="100%" height="100%">
<tr height="100%">
 <td align="center" valign="middle" class="smalltblheading" width="10%">Bag Qty.1</td>
 <td align="center" valign="middle" class="smalltblheading" width="10%">Bag Qty.2</td>
 <td align="center" valign="middle" class="smalltblheading" width="10%">Bag Qty.3</td>
 <td align="center" valign="middle" class="smalltblheading" width="10%">Bag Qty.4</td>
 <td align="center" valign="middle" class="smalltblheading" width="10%">Bag Qty.5</td>
 <td align="center" valign="middle" class="smalltblheading" width="10%">Bag Qty.6</td>
 <td align="center" valign="middle" class="smalltblheading" width="10%">Bag Qty.7</td>
 <td align="center" valign="middle" class="smalltblheading" width="10%">Bag Qty.8</td>
 <td align="center" valign="middle" class="smalltblheading" width="10%">Bag Qty.9</td>
 <td align="center" valign="middle" class="smalltblheading" width="10%">Bag Qty.10</td>
 </tr></table></td>
...
<tr class="Light" height="20">
	 <td align="center" valign="middle" class="smalltbltext" >';$html=$html.$crop;$html=$html.'</td>
	 <td align="center" valign="middle" class="smalltbltext" >';$html=$html.$spcodef;$html=$html.'</td>
	 <td align="center" valign="middle" class="smalltbltext" >';$html=$html.$spcodem;$html=$html.'</td>
	 <td align="center" valign="middle" class="smalltbltext" >';$html=$html.$lotno[0];$html=$html.'</td>
	 <td align="center" valign="middle" class="smalltbltext" >';$html=$html.$dcbag;$html=$html.'</td>
	 <td align="center" valign="middle" class="smalltbltext" >';$html=$html.$tot_ss;$html=$html.'</td>
	 <td align="center" valign="middle" class="smalltbltext" >';$html=$html.$bagdiff;$html=$html.'</td>
	 <td align="center" valign="middle" class="smalltbltext" >';$html=$html.$moist;$html=$html.'</td>
	 <td align="left" valign="middle" class="smalltblheading" colspan="10">
	 <table border="1" align="left" cellspacing="0" cellpadding="0" style="border-collapse:collapse" width="100%" height="100%" >';
	...
	{
	$html=$html.'<td align="center" valign="middle" class="smalltbltext" width="10%" height="100%" >';$html=$html.$row_class2['grosswt'];$html=$html.'</td>';
	
	}
	for($i=0;$i<$forcnt;$i++)
	 {
	 $html=$html.'<td align="center" valign="middle" class="smalltbltext" width="10%" height="100%" ></td>';
...
$html=$html.'</table></td>
	 <td align="center" valign="middle" class="smalltbltext" >';$html=$html.$totalqty;$html=$html.'</td>
	 <td align="center" valign="middle" class="smalltbltext" >';$html=$html.$tareqty;$html=$html.'</td>
	 <td align="center" valign="middle" class="smalltbltext" >';$html=$html.$netqty;$html=$html.'</td>
	 <td align="center" valign="middle" class="smalltbltext" >';$html=$html.$remarks;$html=$html.'</td>
</tr>';
...
$html=$html.'<tr class="Light" height="20">
	 ...
	 <td align="center" valign="middle" class="smalltbltext" >';$html=$html.$bagdiff;$html=$html.'</td>
	 <td align="center" valign="middle" class="smalltbltext" >';$html=$html.$moist;$html=$html.'</td>
	 <td align="center" valign="middle" class="smalltbltext" colspan="10" ></td>
	<td align="center" valign="middle" class="smalltbltext" >';$html=$html.$totalqty;$html=$html.'</td>
	<td align="center" valign="middle" class="smalltbltext" >';$html=$html.$tareqty;$html=$html.'</td>
	<td align="center" valign="middle" class="smalltbltext" >';$html=$html.$netqty;$html=$html.'</td>
	<td align="center" valign="middle" class="smalltbltext" >';$html=$html.$remarks;$html=$html.'</td>
...
$html=$html.'<tr class="Light" height="20">
	 <td align="right" valign="middle" class="tblheading" width="5%" colspan="4">Total&nbsp;</td>
	 <td align="center" valign="middle" class="tbltext" width="3%">';$html=$html.$totaldcbag;$html=$html.'</td>
	 <td align="center" valign="middle" class="tbltext" width="3%">';$html=$html.$totactbag;$html=$html.'</td>
	 <td align="center" valign="middle" class="tbltext" width="3%">';$html=$html.$totdiffbag;$html=$html.'</td>
...
$pathtosave=$_SERVER['DOCUMENT_ROOT']."/wms/pdffiles/";
