...
<title>Plant - Transaction - Lot Merger - LMN</title>
...
<tr  height="20">
  <td colspan="6" align="center" class="Mainheading"><font color="#000000">Lot Merger Note (LMN)</font></td>
</tr>
</table><br />	  
...
<td width="194" align="left" valign="middle" class="tbltext">&nbsp;<?php echo "LM".$row['mergerm_code']."/".$row['mergerm_yearid']."/".$row['mergerm_code'];?></td>
</tr>
<?php
