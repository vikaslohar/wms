<?php
	...
	$datahead2= array("#","Crop","Veriety","Packing Machine Code","Picked for Packing Qty","Packing Loss","Packing Loss %","Pack Seed Qty"); 
...
if($ccnt > 0)
{
$data1[$d]=array($d,$crop1,$verty,$pmc,$totcqty,$totpqty,$lossper,$totsrqty); 
$d++;
}
}
}
