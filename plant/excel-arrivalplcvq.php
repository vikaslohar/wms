<?php
	...
	$dh="Periodical_Arrival_Report_From_".$_REQUEST['sdate']."_To_".$_REQUEST['edate'];
	$datahead = array($dh);
	//$datahead1 = array("Arrival Report");
	$datahead1=array("Periodical Arrival Report: Date From: ",$_REQUEST['sdate'],"  To: ",$_REQUEST['edate']);
	$data1 = array();
	...
	function cleanData(&$str)
	{
	 ...
	 $datatitle3 = array("#","Date of Arrival","Crop","SP-F","SP-M","Stage","FRN No.","Lot No.","NoB","Qty","Production Personnel","Organiser","Farmer","State","Production Location","Harvest Date","Raw Qty (Picked)","Condition Qty","Total Condition Loss Qty","TCL %","Raw Qty (Balance)","QC Status","Germination %","DOT","GOT Status","Genetic Purity %","DOGR");
...
if($tot_arr_home > 0)			
{
$data1[$d]=array($d,$trdate,$crop,$spf,$spm,$stage,$stnno,$lotno,$bags,$qty,$org,$pp12,$farm,$state2,$pp1,$harvestdate,$pqty,$conqty,$tcl,$tclper,$bqty,$qcsts,$germper,$dot,$gotsts,$genpper,$dogr); 
$d++;
}
}
}
