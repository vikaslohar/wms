			...
			while (($data = fgetcsv($handle, 1000, ",")) !== FALSE) 
			{
				...
				if($row>3)
				{
					...
					if(strlen($data[4])<=6)
					{
						...
						$lot=$zzz[2].$zzz[4].$zzz[6].$zzz[8].$zzz[10].$zzz[12];
						if($data[4]==$lot)$ccnt++;
						}*/
						//echo $ccnt;
						//echo $numofrecords." - ".$tot_crop." - ".$ccnt."<br />";
						//exit;	
						if($numofrecords == 0 && $tot_crop > 0 && $ccnt==0)
						{	
							$str="insert into tbllotimp (lotimpdate, lotgendate, lottrtype, lotcrop, lotnumber, lotspcodef, lotspcodem, lotploc, lotstate, lotpper, lotorganiser, lotfarmer, lotplotno, lotoldlot, lotvariety, pdnno, pdndate, prodtype, unarrtyp, agreement_id, farmer_id, farmer_code, plantcode, fortool, foryear) values('$dt','$final_date','".$data[1]."', '".$data[2]."', '".$data[4]."', '".$data[5]."', '".$data[6]."', '".$data[7]."', '".$data[8]."', '".$data[11]."', '".$data[9]."', '".$data[10]."', '".$data[12]."', '".$data[13]."', '".$data[3]."', '".$data[14]."', '".$final_date2."', '".$data[16]."', '".$data[17]."', '".$data[18]."', '".$data[19]."', '".$data[20]."', '$plantcode', '".$data[21]."', '".$data[22]."')";
