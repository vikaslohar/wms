...
$sql_eindent_sub=mysqli_query($link,"select * from tbl_ivtsub where ivts_id=$subtid and plantcode='$plantcode'") or die(mysqli_error($link));
...
$sql_issue24=mysqli_query($link,"select distinct lotldg_subbinid, lotldg_whid, lotldg_binid from tbl_lot_ldg where lotldg_crop='".$row['ivt_crop']."' and lotldg_variety='".$row['ivt_pvariety']."' and lotldg_sstage='Condition' and lotldg_lotno='".$row_eindent_sub['ivts_olotno']."' and lotldg_qc!='Fail' and lotldg_got!='Fail' and plantcode='$plantcode'") or die(mysqli_error($link));
...
$sql_issue1=mysqli_query($link,"select * from tbl_lot_ldg where lotldg_id='".$row_issue[0]."' and lotldg_variety='".$row['ivt_pvariety']."' and lotldg_lotno='".$row_eindent_sub['ivts_olotno']."' and plantcode='$plantcode'") or die(mysqli_error($link));
...
$sql_issue=mysqli_query($link,"select distinct lotldg_subbinid, lotldg_whid, lotldg_binid from tbl_lot_ldg where lotldg_lotno='".$row_eindent_sub['ivts_olotno']."'  and lotldg_balqty > 0 and plantcode='$plantcode'") or die(mysqli_error($link));

 while($row_issue=mysqli_fetch_array($sql_issue))
 { 

$sql_issue1=mysqli_query($link,"select max(lotldg_id) from tbl_lot_ldg where lotldg_subbinid='".$row_issue['lotldg_subbinid']."' and lotldg_binid='".$row_issue['lotldg_binid']."' and lotldg_whid='".$row_issue['lotldg_whid']."' and lotldg_lotno='".$row_eindent_sub['ivts_olotno']."' and plantcode='$plantcode'") or die(mysqli_error($link));
$row_issue1=mysqli_fetch_array($sql_issue1); 
...
$sql_tblissue=mysqli_query($link,"select * from tbl_ivtsub_sub where ivt_id='".$tid."' and ivts_id='".$row_eindent_sub['ivts_id']."' and ivtss_subbin='".$row_issuetbl['lotldg_subbinid']."' and plantcode='$plantcode'") or die(mysqli_error($link));
...
<?php
$bind1_query=mysqli_query($link,"select binid, binname from tbl_bin where whid='".$row_tblissue['ivtss2_wh']."' and plantcode='$plantcode' order by binname") or die(mysqli_error($link));
?>
...
<?php
$subbind1_query=mysqli_query($link,"select sid, sname from tbl_subbin where whid='".$row_tblissue['ivtss2_wh']."' and binid='".$row_tblissue['ivtss2_bin']."' and plantcode='$plantcode' order by sname") or die(mysqli_error($link));
?>	
