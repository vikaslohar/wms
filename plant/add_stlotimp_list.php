...
<title>Plant- Transaction -  Lot Transfer</title>
...
<table align="center" border="1" cellspacing="0" cellpadding="0" width="970" bordercolor="#2e81c1" style="border-collapse:collapse">
  <tr class="tblsubtitle" height="25">
    ...
    <td width="50" align="center" class="smalltblheading" valign="middle">Stage</td>
    <td width="30" align="center" class="smalltblheading" valign="middle">NoB</td>
...
$sql_cls=mysqli_query($link,"SELECT * FROM tbl_stlotimp where stlotimp_date >='$sdate'  and stlotimp_date <='$edate' AND plantcode='$plantcode' order by stlotimp_date desc") or die(mysqli_error($link));
while($row_cls=mysqli_fetch_array($sql_cls))
{
 	$tdate=$row_cls['stlotimp_date'];
	$tyear=substr($tdate,0,4);
	$tmonth=substr($tdate,5,2);
	$tday=substr($tdate,8,2);
	$tdate=$tday."-".$tmonth."-".$tyear;

	$tdate1=$row_cls['stlotimp_ltdate'];
	$tyear1=substr($tdate1,0,4);
	$tmonth1=substr($tdate1,5,2);
	$tday1=substr($tdate1,8,2);
	$tdate1=$tday1."-".$tmonth1."-".$tyear1;

	$tdate2=$row_cls['stlotimp_gtdate'];
...
?>
  <tr class="Light" height="25">
    ...
    <td valign="middle" class="smalltbltext" align="center"><?php echo $row_cls['stlotimp_lotno'];?></td>
    <td valign="middle" class="smalltbltext" align="center"><?php echo $row_cls['stlotimp_crop'];?></td>
    <td valign="middle" class="smalltbltext" align="center"><?php echo $row_cls['stlotimp_variety'];?></td>
	<td valign="middle" class="smalltbltext" align="center"><?php echo $row_cls['stlotimp_stage'];?></td>
	<td valign="middle" class="smalltbltext" align="center"><?php echo $row_cls['stlotimp_nob'];?></td>
	<td valign="middle" class="smalltbltext" align="center"><?php echo $row_cls['stlotimp_qty'];?></td>
	<td valign="middle" class="smalltbltext" align="center"><?php echo $row_cls['stlotimp_qcstatus'];?></td>
	<td valign="middle" class="smalltbltext" align="center"><?php echo $row_cls['stlotimp_pp'];?></td>
	<td valign="middle" class="smalltbltext" align="center"><?php echo $row_cls['stlotimp_moisture'];?></td>
	<td valign="middle" class="smalltbltext" align="center"><?php echo $row_cls['stlotimp_germination'];?></td>
	<td valign="middle" class="smalltbltext" align="center"><?php echo $tdate1;?></td>
	<td valign="middle" class="smalltbltext" align="center"><?php echo $row_cls['stlotimp_gottype'];?></td>
	<td valign="middle" class="smalltbltext" align="center"><?php echo $row_cls['stlotimp_gotstatus'];?></td>
...
<tr >
<td valign="top" align="right"><a href="home_stlotimp.php" tabindex="20"><img src="../images/back.gif" border="0"style="display:inline;cursor:pointer;" /></a></td>
</tr>
</table>
</td><td width="30"></td>
</tr>
