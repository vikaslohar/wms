  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#2e81c1" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#2e81c1" style="border-bottom:solid; border-bottom-color:#2e81c1" >
	    <tr >
	      <td width="813" height="25" class="Mainheading">&nbsp;Transaction - SP Cycle Inventory - Edit</td>
	    </tr></table></td>
...
?> 
	...
	<input name="code" value="<?php echo $row['ci_tcode'];?>" type="hidden">
...
<input type="hidden" name="maintrid" value="<?php echo $pid;?>" /> <input type="hidden" name="subtrid" value="<?php echo $subtrid;?>" />
</div>
</div>
