...
<tr class="tblsubtitle" height="25">
			...
			<td width="150"  align="center" valign="middle" class="tblheading">Variety</td>
			...
			<td width="39" align="center" valign="middle" class="tblheading">PP</td>
			<td width="52" align="center" valign="middle" class="tblheading" >Moist %</td>
			<td width="54" align="center" valign="middle" class="tblheading" >Germ %</td>
			<td width="72" align="center" valign="middle" class="tblheading">DOT</td>
            <td width="49" align="center" valign="middle" class="tblheading">QC Status</td>
            <td width="76" align="center" valign="middle" class="tblheading">DoGR</td>
...
<td align="center" valign="middle" class="tblheading"><?php echo $srno?></td>
		 <td width="81" align="center" valign="middle" class="tblheading"><?php echo $row31['cropname']?></td>
         <td width="150" align="center" valign="middle" class="tblheading"><?php echo $vv1?></td>
		 <td width="110" align="center" valign="middle" class="tblheading"><?php echo $lotno?></td>
         <!--<td width="54" align="center" valign="middle" class="tblheading"><?php echo $sstage;?></td>-->
         <td width="41" align="center" valign="middle" class="tblheading"><?php echo $bags?></td>
         <td width="43" align="center" valign="middle" class="tblheading"><?php echo $qty?></td>
         <td width="39" align="center" valign="middle" class="tblheading"><?php echo $qc;?></td>
         <td width="52" align="center" valign="middle" class="tblheading"><?php echo $got?></td>
