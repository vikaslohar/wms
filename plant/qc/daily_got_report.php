<?php
	...
	if(isset($_POST['frm_action'])=='submit')
	{
		...
		if($sdate!="")
		{
			echo "<script>window.location='daily_got_report1.php?sdate=$sdate&txtstage=$txtstage'</script>";
		}
		else
		{?>
		 <script>
		  alert("Please Select Date for search");
		  </script>
		<?php }
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#2e81c1" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#2e81c1" style="border-bottom:solid; border-bottom-color:#2e81c1" >
	    <tr >
	      <td width="813" height="30"class="Mainheading"  >&nbsp;Daily GOT Result Report </td>
	    </tr></table></td>
	  </tr>
	  </table></td></tr>
...
<table align="center" border="1" width="574" cellspacing="0" cellpadding="0" bordercolor="#2e81c1" style="border-collapse:collapse" >
                <tr class="tblsubtitle" height="25">
                  <td colspan="4" align="center" class="tblheading">Daily GOT Result Report</td>
                </tr>
                <tr height="15">
...
<td width="50%" height="30" align="right" valign="middle" class="tblheading">&nbsp;Result Updated on&nbsp;</td>
<td width="50%" align="left"  valign="middle" >&nbsp;<input name="sdate" id="sdate" type="text" size="10" class="tbltext" tabindex="0" readonly="true"  value="<?php echo date("d-m-Y", time());?>" style="background-color:#EFEFEF" />&nbsp;<a href="javascript:void(0)" onClick="showCalendar('sdate')" tabindex="6"><img src="../../images/cal.gif" alt="Calender" border="0" align="absmiddle" /></a>&nbsp;<font color="#FF0000" >*</font></td>
                </tr>
<tr class="Light" height="30">
<td align="right"  valign="middle" class="tblheading" >Stage&nbsp;</td>
 <td align="left"  valign="middle" class="tbltext">&nbsp;<select class="tbltext" name="txtstage" style="width:100px;" >
