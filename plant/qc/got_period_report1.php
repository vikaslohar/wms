...
$sql="select distinct sampleno from tbl_qctest where gotdate<='$edate' and gotdate>='$sdate' and crop='".$itemid."' and plantcode='$plantcode'";
...
$sql2="select MAX(tid) from tbl_qctest where sampleno='".$row_arr_home2['sampleno']."' and gotdate<='$edate' and gotdate>='$sdate' and crop='".$itemid."' and plantcode='$plantcode'";
