...
<table width="1003" height="600" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#2e81c1" >
	 ...
	 <table border="3" align="right" bordercolor="#2e81c1" bordercolordark="#2e81c1" cellspacing="0" cellpadding="0" width="116" style="border-collapse:collapse;">
...
/*				echo $txt11=$_REQUEST['txt11'];
				echo $txtcrop=$_REQUEST['txtcrop'];
				echo $txtvariety=$_REQUEST['txtvariety'];
				echo $cvslchb=$_REQUEST['cvslchb'];
				$wh=$_REQUEST['wh'];
...
$sql_home=mysqli_query($link,"select * from tbl_lot_ldg where lotldg_crop='".$txtcrop."' and lotldg_variety='".$txtvariety."' and plantcode='$plantcode' group by lotldg_lotno order by lotldg_whid, lotldg_binid, lotldg_subbinid asc ") or die(mysqli_error($link));
...
?>
<table align="center" border="0" width="943" cellspacing="0" cellpadding="0" bordercolor="#2e81c1" style="border-collapse:collapse" > 
...
$sql_arr_home=mysqli_query($link,"select * from tbl_qctest where crop='".$txtcrop."' and variety='".$txtvariety."' and oldlot='".$row_home['orlot']."' and aflg=0 and bflg=0 and cflg=0 and plantcode='$plantcode' order by sampleno desc") or die(mysqli_error($link));
...
while($row_arr_home=mysqli_fetch_array($sql_arr_home))
{
	...
	$sql_tbl_sub=mysqli_query($link,"select * from tbl_qctest where tid='".$arrival_id."' and plantcode='$plantcode'") or die(mysqli_error($link));
...
$sql_tblsub1=mysqli_query($link,"select distinct lotldg_sstage from tbl_lot_ldg where orlot='".$lotno."' and plantcode='$plantcode' order by orlot") or die(mysqli_error($link));
...
$details=$ddss; */
$bags=0; $qty=0; $slocs="";
$sql_tbl_sub1=mysqli_query($link,"select distinct lotldg_subbinid, lotldg_variety, lotldg_crop, lotldg_whid, lotldg_binid from tbl_lot_ldg where orlot='".$lotno."' and lotldg_sstage='".$rowtbl22['lotldg_sstage']."' and plantcode='$plantcode' group by lotldg_subbinid, lotldg_variety, orlot order by lotldg_subbinid") or die(mysqli_error($link));
	$t=mysqli_num_rows($sql_tbl_sub1);
while($row_tbl22=mysqli_fetch_array($sql_tbl_sub1))
{ $ac=0; $acn=0; $gd=""; $slups=0;$slqty=0;
$sql_tbl1=mysqli_query($link,"select max(lotldg_id) from tbl_lot_ldg where lotldg_subbinid='".$row_tbl22['lotldg_subbinid']."' and orlot='".$lotno."' and lotldg_sstage='".$rowtbl22['lotldg_sstage']."' and plantcode='$plantcode'") or die(mysqli_error($link));  
...
$sql_whouse=mysqli_query($link,"select perticulars from tbl_warehouse where whid='".$row_tbl['lotldg_whid']."' and plantcode='$plantcode'") or die(mysqli_error($link));
$row_whouse=mysqli_fetch_array($sql_whouse);
$wareh=$row_whouse['perticulars']."/";

$sql_binn=mysqli_query($link,"select binname from tbl_bin where binid='".$row_tbl['lotldg_binid']."' and whid='".$row_tbl['lotldg_whid']."' and plantcode='$plantcode'") or die(mysqli_error($link));
$row_binn=mysqli_fetch_array($sql_binn);
$binn=$row_binn['binname']."/";


$sql_subbinn=mysqli_query($link,"select sname from tbl_subbin where sid='".$row_tbl['lotldg_subbinid']."' and binid='".$row_tbl['lotldg_binid']."' and whid='".$row_tbl['lotldg_whid']."' and plantcode='$plantcode'") or die(mysqli_error($link));
...
$sql_home=mysqli_query($link,"select * from tbl_lot_ldg where lotldg_whid='".$wh."' and plantcode='$plantcode' group by lotldg_lotno order by lotldg_whid, lotldg_binid, lotldg_subbinid asc ") or die(mysqli_error($link));
$t=mysqli_num_rows($sql_home);
//echo $tot_arr_home=mysqli_num_rows($sql_arr_home);

$sql_arr=mysqli_query($link,"select * from tbl_warehouse where whid='".$wh."' and plantcode='$plantcode'") or die(mysqli_error($link));
...
$sql_arr_home=mysqli_query($link,"select * from tbl_qctest where oldlot='".$row_home['orlot']."' and aflg=0 and bflg=0 and cflg=0 and plantcode='$plantcode' order by sampleno desc") or die(mysqli_error($link));
 $tot_arr_home=mysqli_num_rows($sql_arr_home);
if($tot_arr_home > 0)
{
while($row_arr_home=mysqli_fetch_array($sql_arr_home))
