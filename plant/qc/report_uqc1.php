...
<table align="center" border="0" cellspacing="0" cellpadding="0" width="800" style="border-collapse:collapse">
  ...
  <!--	<tr height="25" >
    ...
    <table  border="1" cellspacing="0" cellpadding="0" width="800" bordercolor="#2e81c1" style="border-collapse:collapse" align="center">
<tr class="tblsubtitle" height="25">
			...
			<td width="128"  align="center" valign="middle" class="tblheading">Variety</td>
			...
			<td width="76" align="center" valign="middle" class="tblheading">Sample No.</td>
</tr>
...
<td align="center" valign="middle" class="tblheading"><?php echo $srno?></td>
         ...
         <td width="128" align="center" valign="middle" class="tblheading"><?php echo $vv?></td>
		 <td width="106" align="center" valign="middle" class="tblheading"><?php echo $lotno?></td>
         <td width="46" align="center" valign="middle" class="tblheading"><?php echo $slups?></td>
         <td width="48" align="center" valign="middle" class="tblheading"><?php echo $slqty?></td>
         ...
         <td width="76" align="center" valign="middle" class="tblheading"><?php echo $tp1?><?php echo $yearid_id?><?php echo sprintf("%000006d",$qc1);?></td>
</tr
>
<?php
}
