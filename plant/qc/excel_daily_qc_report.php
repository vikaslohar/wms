...
session_start();
	...
	function cleanData(&$str)
	 ...
	 $datatitle2 = array("#","Crop","Variety","Lot No. ","NoB","Qty","Stage","PP","Moist%","Germination %","DOT","QC Status","DOGR","GOT Status","QC Doc. Ref. No.");
$d=1;
...
if($qcresult!="UT")
{
$data1[$d]=array($d,$cropp,$vv1,$lotno,$bags,$qty,$sstage,$qc,$got,$stage,$trdate,$qcresult,$trdate1,$gotresult,$qcrefno); 
$d++;
}
}
}
...
# coading ends here............/../**/echo implode($datahead1) ;
echo "\n";
