...
<option value="ALL" selected>--ALL--</option>
	...
	$sql_qc=mysqli_query($link,"SELECT distinct(gsvariety) FROM tbl_gsample WHERE gscrop='".$row_crp['cropname']."' and gsvariety !='".$noticia_item12['popularname']."' and plantcode='$plantcode'") or die(mysqli_error($link)); 
