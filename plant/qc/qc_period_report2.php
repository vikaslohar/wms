...
<?php	
	...
	if($result=="ALL")	
	{
	$sql_arr_home=mysqli_query($link,"select distinct(sampleno) from tbl_qctest where testdate<='$edate' and testdate>='$sdate' and crop='".$itemid."' and  qcflg=1 and qcstatus!='RT' and plantcode='$plantcode' order by spdate asc ") or die(mysqli_error($link));
	}
	else
	{
	$sql_arr_home=mysqli_query($link,"select distinct(sampleno) from tbl_qctest where testdate<='$edate' and testdate>='$sdate' and crop='".$itemid."' and qcflg=1 and qcstatus='$result' and plantcode='$plantcode' order by spdate asc ") or die(mysqli_error($link));
	}
	}
	else
	{
	if($result=="ALL")	
	{
	$sql_arr_home=mysqli_query($link,"select distinct(sampleno) from tbl_qctest where testdate<='$edate' and testdate>='$sdate' and crop='".$itemid."' and variety='$vv' and  qcflg=1 and qcstatus!='RT' and plantcode='$plantcode' order by spdate asc ") or die(mysqli_error($link));
	}
	else
	{
	$sql_arr_home=mysqli_query($link,"select distinct(sampleno) from tbl_qctest where testdate<='$edate' and testdate>='$sdate' and crop='".$itemid."' and variety='$vv' and qcflg=1 and qcstatus='$result' and plantcode='$plantcode' order by spdate asc ") or die(mysqli_error($link));
	}
	}
...
<table align="center" border="0" cellspacing="0" cellpadding="0" width="800" style="border-collapse:collapse">
   <!--	<tr height="25" >
    <td align="center" class="subheading" style="color:#303918; ">Lot Destination Report:</td>
  	...
  	<tr height="25">
    <td align="center" class="subheading" style="color:#303918; " colspan="3">Periodical QC Report - Date From: <?php echo $_GET['sdate'];?> To <?php echo $_GET['edate'];?></td>
  	</tr>
  	<tr height="25" >
...
<tr class="tblsubtitle" height="25">
			...
			<td width="131"  align="center" valign="middle" class="tblheading">Lot No.</td>
			<!--<td width="76"  align="center" valign="middle" class="tblheading">Stage</td>-->
			<td width="47"  align="center" valign="middle" class="tblheading">NoB</td>
			<td width="58"  align="center" valign="middle" class="tblheading">Qty</td>
			<td width="87" align="center" valign="middle" class="tblheading">PP</td>
			<td width="50" align="center" valign="middle" class="tblheading" >Moist %</td>
			<td width="47" align="center" valign="middle" class="tblheading" >Germ %</td>
			<td width="79" align="center" valign="middle" class="tblheading">DOT</td>
            <td width="59" align="center" valign="middle" class="tblheading">QC Status</td>
            <td width="59" align="center" valign="middle" class="tblheading">DoGR</td>
            <td width="59" align="center" valign="middle" class="tblheading">GOT Status</td>
...
if($vv=="ALL")
{
	if($result=="ALL")	
	{
	$sql_arr_home2=mysqli_query($link,"select MAX(tid) from tbl_qctest where sampleno='".$row_arr_home2['sampleno']."' and testdate<='$edate' and testdate>='$sdate' and crop='".$itemid."' and  qcflg=1 and qcstatus!='RT' and plantcode='$plantcode' order by spdate asc ") or die(mysqli_error($link));
	}
	else
	{
	$sql_arr_home2=mysqli_query($link,"select MAX(tid) from tbl_qctest where sampleno='".$row_arr_home2['sampleno']."' and testdate<='$edate' and testdate>='$sdate' and crop='".$itemid."' and qcflg=1 and qcstatus='$result' and plantcode='$plantcode' order by spdate asc ") or die(mysqli_error($link));
	}
}
else
{
	if($result=="ALL")	
	{
	$sql_arr_home2=mysqli_query($link,"select MAX(tid) from tbl_qctest where sampleno='".$row_arr_home2['sampleno']."' and testdate<='$edate' and testdate>='$sdate' and crop='".$itemid."' and variety='$vv' and  qcflg=1 and qcstatus!='RT' and plantcode='$plantcode' order by spdate asc ") or die(mysqli_error($link));
	}
	else
	{
	$sql_arr_home2=mysqli_query($link,"select MAX(tid) from tbl_qctest where sampleno='".$row_arr_home2['sampleno']."' and testdate<='$edate' and testdate>='$sdate' and crop='".$itemid."' and variety='$vv' and qcflg=1 and qcstatus='$result' and plantcode='$plantcode' order by spdate asc ") or die(mysqli_error($link));
	}
}

$row_arr_home3=mysqli_fetch_array($sql_arr_home2);

$sql_arr_home3=mysqli_query($link,"select * from tbl_qctest where tid='".$row_arr_home3[0]."' and sampleno='".$row_arr_home2['sampleno']."' and qcflg=1 and plantcode='$plantcode' order by spdate asc") or die(mysqli_error($link));
...
$slups=0; $slqty=0; $sstage=""; $qcresult="";
...
<td align="center" valign="middle" class="tblheading"><?php echo $srno?></td>
         ...
         <td width="176" align="center" valign="middle" class="tblheading"><?php echo $vv1?></td>
		 <td width="131" align="center" valign="middle" class="tblheading"><?php echo $lotno?></td>
        <!-- <td width="76" align="center" valign="middle" class="tblheading"><?php echo $sstage;?></td>-->
         <td width="47" align="center" valign="middle" class="tblheading"><?php echo $bags?></td>
         <td width="58" align="center" valign="middle" class="tblheading"><?php echo $qty?></td>
         <td width="87" align="center" valign="middle" class="tblheading"><?php echo $qc;?></td>
         <td width="50" align="center" valign="middle" class="tblheading"><?php echo $got?></td>
         <td width="47" align="center" valign="middle" class="tblheading"><?php echo $stage?></td>
...
<tr >
<td width="924" align="right">&nbsp;&nbsp;&nbsp;<img src="../../images/Vista-printer.png" border="0" class="butn" height="29" width="35" alt="Print" style="display:inline;cursor:pointer;" onclick="javascript:window.print();" />&nbsp;&nbsp;<a href="excel-pqc.php?txtcrop=<?php echo $itemid;?>&txtvariety=<?php echo $vv;?>&sdate=<?php echo $_REQUEST['sdate'];?>&edate=<?php echo $_REQUEST['edate'];?>&result=<?php echo $_REQUEST['result'];?>" target="_blank"><img src="../../images/excelicon1.jpg" border="0" height="30" width="30" class="butn" alt="Export to Excel" style="display:inline;cursor:pointer;" /></a>&nbsp;<img src="../../images/close_icon2.jpg" border="0" class="butn" height="30"  alt="Close" style="display:inline;cursor:pointer;" onClick="window.close()" /></td>
</tr>
</table>
