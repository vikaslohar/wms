...
//}}
//}
$sql_code="SELECT MAX(tcode) FROM tbl_discard  where yearcode='$yearid_id' and plantcode='$plantcode' ORDER BY tcode DESC";
...
<title>Plant -Transaction - Material Discard</title>
...
<td width="564" align="left"  valign="middle" class="tbltext" style=" border-color:#2e81c1" colspan="3">&nbsp;<input type="text" class="tbltext" name="txtaddress" size="70" maxlength="70" >&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
</tr>
<tr class="Light" height="30">
<td width="180" align="right"  valign="middle" class="tblheading" style=" border-color:#2e81c1">&nbsp;Address 2&nbsp;</td>
<td width="564" align="left"  valign="middle" class="tbltext" style=" border-color:#2e81c1" colspan="3">&nbsp;<input type="text" class="tbltext" name="txtaddress1" size="70" maxlength="70" >&nbsp;</td>
</tr>
<tr class="Dark" height="30">
<td width="180" align="right"  valign="middle" class="tblheading" style=" border-color:#2e81c1">&nbsp;City/Town/Village&nbsp;</td>
<td width="564" align="left"  valign="middle" class="tbltext" style=" border-color:#2e81c1" colspan="3">&nbsp;<input type="text" class="tbltext" name="txtcity" size="50" maxlength="50" >&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
</tr>
<tr class="Light" height="30">
<td width="180" align="right"  valign="middle" class="tblheading" style=" border-color:#2e81c1">&nbsp;Pin&nbsp;</td>
<td width="564" align="left"  valign="middle" class="tbltext" style=" border-color:#2e81c1" colspan="3">&nbsp;<input type="text" class="tbltext" name="txtpin" size="6" maxlength="6" onkeypress="return isNumberKey(event)" >&nbsp;</td>
</tr>
<?php
...
<td width="564" align="left"  valign="middle" class="tbltext" style=" border-color:#2e81c1" colspan="3">&nbsp;<input type="text" class="tbltext" name="txtphone" size="15" maxlength="15" onkeypress="return isNumberKey(event)" >&nbsp;</td>
</tr>
<tr class="Light" height="25">
...
<table id="transmode" align="center" border="1" width="750" cellspacing="0" cellpadding="0" bordercolor="#2e81c1" style="display:none; border-color:#2e81c1" > 
<tr class="Light" height="25">
<td width="189" align="right"  valign="middle" class="tblheading" style="border-color:#2e81c1">&nbsp;Select Mode of Transit&nbsp;</td>
 <td width="555" colspan="5" align="left"  valign="middle" class="tbltext" style="border-color:#2e81c1"><input name="txt1" type="radio" class="tbltext" value="Transport" onClick="clk(this.value);" />Transport&nbsp;<input name="txt1" type="radio" class="tbltext" value="Courier" onClick="clk(this.value);" />Courier&nbsp;<input name="txt1" type="radio" class="tbltext" value="By Hand" onClick="clk(this.value);" />Hand Delivery&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
 </tr>
 </table>
<table id="trans" align="center" border="1" width="750" cellspacing="0" cellpadding="0" bordercolor="#2e81c1" style="display:none;border-color:#2e81c1" > 
<tr class="Light" height="30">
<td align="right" width="189" valign="middle" class="tblheading" style="border-color:#2e81c1">&nbsp;Transport Name&nbsp;</td>
<td align="left"  valign="middle" class="tbltext" style="border-color:#2e81c1">&nbsp;<input name="txttname" type="text" size="20" class="tbltext" tabindex="" maxlength="20" />  &nbsp;<font color="#FF0000">*</font>&nbsp;</td>
<td width="124" align="right"  valign="middle" class="tblheading" style="border-color:#2e81c1">Lorry Receipt No.&nbsp;</td>
<td align="left" width="191" valign="middle" class="tbltext" colspan="3" style="border-color:#2e81c1">&nbsp;<input name="txtlrn" type="text" size="15" class="tbltext" tabindex=""  maxlength="15"/>&nbsp;</td>
</tr>

<tr class="Light" height="25">
<td align="right" width="189" valign="middle" class="tblheading" style="border-color:#2e81c1">&nbsp;Vehicle No.&nbsp;</td>
<td align="left" width="236" valign="middle" class="tbltext" style="border-color:#2e81c1" >&nbsp;<input name="txtvn" type="text" size="12" class="tbltext" tabindex="" maxlength="12"  />&nbsp;<font color="#FF0000">*</font>&nbsp; </td>
<td align="right"  valign="middle" class="tblheading" style="border-color:#2e81c1">&nbsp;Payment Mode&nbsp;</td>
 <td align="left"  valign="middle" class="tbltext"colspan="3" style="border-color:#2e81c1">&nbsp;<select class="tbltext" name="txt13" style="width:70px;" onchange="clk1(this.value);" >
...
<table id="courier" align="center" border="1" width="750" cellspacing="0" cellpadding="0" bordercolor="#2e81c1" style="display:none; border-color:#2e81c1" > 
<tr class="Dark" height="30">
<td align="right" width="189" valign="middle" class="tblheading" style="border-color:#2e81c1">&nbsp;Courier Name&nbsp;</td>
<td align="left" width="236" valign="middle" class="tbltext" style="border-color:#2e81c1">&nbsp;<input name="txtcname" type="text" size="20" class="tbltext" tabindex=""  maxlength="20" />&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
<td align="right" width="124" valign="middle" class="tblheading" style="border-color:#2e81c1">&nbsp;Docket No.&nbsp;</td>
<td align="left" width="191" valign="middle" class="tbltext" colspan="3" style="border-color:#2e81c1">&nbsp;<input name="txtdc" type="text" size="15" class="tbltext" tabindex="" maxlength="15"   />&nbsp;<font color="#FF0000">*</font></td>
</tr>
 
</table>
<table id="byhand" align="center" border="1" width="750" cellspacing="0" cellpadding="0" bordercolor="#2e81c1" style="display:none; border-color:#2e81c1" > 
<tr class="Dark" height="30">
<td align="right" width="189" valign="middle" class="tblheading" style="border-color:#2e81c1">&nbsp;Name of Person&nbsp;</td>
<td width="555" colspan="8" align="left" valign="middle" class="tbltext" style="border-color:#2e81c1">&nbsp;<input name="txtpname" type="text" size="30" class="tbltext" tabindex=""  maxlength="30" />&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
</tr>
</table><br />
