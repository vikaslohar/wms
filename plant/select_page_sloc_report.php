<?php
	...
	if(isset($_POST['frm_action'])=='submit')
	{
		...
		echo "<script>window.location='sloc_report_main.php?txtcrop=$cid&txtvariety=$itemid&sdate=$sdate&edate=$edate'</script>";
		// echo "<script>window.location='sloc_report_main.php?slchk=$slchk&slchk2=$slchk2&txtcrop=$cid&txtvariety=$itemid&sdate=$sdate</script>";
	}
...
<title>CSW - Report - SLOC Report</title>
...
{ 
	...
	console.log(document.frmaddDepartment.txtvariety.value);
	console.log(document.frmaddDepartment.txtcrop.value);
	console.log(document.frmaddDepartment.sdate.value);
	console.log(document.frmaddDepartment.edate.value);
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#2e81c1" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#2e81c1" style="border-bottom:solid; border-bottom-color:#2e81c1" >
	    <tr >
	      <td width="813" height="30"class="Mainheading"  >SLOC Report </td>
	    </tr></table></td>
	  </tr>
	  </table></td></tr>
          ...
          <tr>
            <td width="30"></td>
                ...
                <tr class="tblsubtitle" height="25">
                  <td colspan="4" align="center" class="tblheading">SLOC Report </td>
                </tr>
                <tr height="15">
				...
				?>
                 <tr class="Dark" height="25">
                  <td width="26%" height="30" align="right" valign="middle" class="tblheading">&nbsp;Period From&nbsp;</td>
...
<td width="297" align="right"  valign="middle" class="tblheading" colspan="2">Crop&nbsp;</td>
<td width="297" align="left"  valign="middle" class="tbltext" colspan="2" >&nbsp;<select class="tbltext" name="txtcrop" style="width:170px;" onChange="modetchk(this.value)">
