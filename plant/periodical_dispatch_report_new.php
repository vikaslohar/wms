<?php
	...
	if(isset($_POST['frm_action'])=='submit')
	{
		...
		if($sdate!="")
		{
			echo "<script>window.location='periodical_dispatch_report_new1.php?sdate=$sdate&edate=$edate&txtstate=$txtstate&txtloc=$txtloc&txtparty=$txtparty&txtcrop=$txtcrop&txtvariety=$txtvariety&txtlotno=$txtlotno&txtupsdc=$txtupsdc&txtdisptype=$txtdisptype'</script>";
		}
		else
		{?>
		 <script>
...
<table align="center" border="1" width="750" cellspacing="0" cellpadding="0" bordercolor="#2e81c1" style="border-collapse:collapse" >
                <tr class="tblsubtitle" height="25">
                  <td colspan="4" align="center" class="tblheading" >Periodical Dispatch Report</td>
                </tr>
                <tr height="15">
