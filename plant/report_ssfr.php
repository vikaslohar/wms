<?php
	...
	if(isset($_POST['frm_action'])=='submit')
	{
		...
		echo "<script>window.location='report_ssfr1.php?sdate=$sdate&edate=$edate&ddate=$ddate&txtcrop=$cid&txtvariety=$itemid&sftyp=$sftyp'</script>";
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#2e81c1" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#2e81c1" style="border-bottom:solid; border-bottom-color:#2e81c1" >
	    <tr >
	      <td width="813" height="30"class="Mainheading">Super Soft Release Report</td>
	    </tr></table></td>
	  </tr>
	  </table></td></tr>
