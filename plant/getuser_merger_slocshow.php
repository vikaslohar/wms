...
if($val<>"")
{
$rtotalups=0; $rtotalqty=0; $qc=""; $got=""; $srstatus="";
...
<td align="center" valign="middle" class="tblheading"><input type="hidden" id="srst_<?php echo $srno;?>" name="srst_<?php echo $srno;?>" readonly="true" style="background-color:#CCCCCC" value="<?php echo $srstatus;?>" size="10" /><?php echo $srstatus;?></td>
<td align="center" valign="middle" class="tblheading"><input type="text" id="upsavl_<?php echo $srno;?>" name="upsavl_<?php echo $srno;?>" readonly="true" style="background-color:#CCCCCC" value="<?php echo $rtotalups;?>" size="9" /></td>
<td align="center" valign="middle" class="tblheading"><input type="text" id="qtyavl_<?php echo $srno;?>" name="qtyavl_<?php echo $srno;?>" readonly="true" style="background-color:#CCCCCC" value="<?php echo $rtotalqty;?>" size="9" /></td>
 </tr>
 <?php
 }
 else
...
<td align="center" valign="middle" class="tblheading"><input name="totalmnob" id="totalmnob" class="tbltext" value="<?php echo $totalups;?>" readonly="true" style="background-color:#CCCCCC" size="9" /></td>
<td align="center" valign="middle" class="tblheading"><input name="totalmqty" id="totalmqty" class="tbltext" value="<?php echo $totalqty;?>" readonly="true" style="background-color:#CCCCCC" size="9" /></td>
 </tr>
</table>
