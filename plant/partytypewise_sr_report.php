<?php
	...
	if(isset($_POST['frm_action'])=='submit')
	{
		...
		$txtupstype=trim($_POST['txtupstype']);
		if($txtupstype=="Yes")
		{
		echo "<script>window.location='partytype_wise_sr_report11.php?sdate=$sdate&edate=$edate&txtcrop=$crop&txtvariety=$veriety&txtptype=$txtptype&txtpp=$txtpp&txtstatesl=$txtstatesl'</script>";	
		}
		else
		{
		echo "<script>window.location='partytype_wise_sr_report1.php?sdate=$sdate&edate=$edate&txtcrop=$crop&txtvariety=$veriety&txtptype=$txtptype&txtpp=$txtpp&txtstatesl=$txtstatesl'</script>";	
		}
	}
...
?>
 ...
 <tr class="Light" height="30">
<td width="140" align="right"  valign="middle" class="tblheading">UPS wise&nbsp;</td>
<td align="left"  valign="middle" class="tbltext" colspan="3" >&nbsp;<select class="tbltext" name="txtupstype" style="width:120px;">
