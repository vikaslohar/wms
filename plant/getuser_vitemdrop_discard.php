...
$sql_qc=mysqli_query($link,"SELECT distinct(lotldg_variety) FROM tbl_lot_ldg WHERE lotldg_crop='".$a."' and lotldg_variety NOT RLIKE '^[-+0-9.E]+$' and plantcode='$plantcode'");
...
?>&nbsp;<select class="tbltext" name="txtitem" id="itm" style="width:170px;" onchange="modetchk24(this.value)">
<option value="" selected>-Select Variety-</option>
	...
	<?php while($noticia_item1 = mysqli_fetch_array($sql_qc)) { ?>
		<option value="<?php echo $noticia_item1['lotldg_variety'];?>" />   
		<?php echo $noticia_item1['lotldg_variety'];?>
		<?php } ?>
