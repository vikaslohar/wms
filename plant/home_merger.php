...
$targetpage = $_SERVER['PHP_SELF']; 
  ...
  $sql_arr_home=mysqli_query($link,"select * from tbl_mergermain where mergerm_tflg=1 and plantcode='$plantcode' order by mergerm_date desc,mergerm_code desc LIMIT $start, $limit") or die(mysqli_error($link));
...
$query = "select * from tbl_mergermain where mergerm_tflg=1 and plantcode='$plantcode' order by mergerm_date desc,mergerm_code desc";
