...
$s_sub="delete from tbl_cisub where cisub_id='".$b."'";
mysqli_query($link,$s_sub) or die(mysqli_error($link));
$s_sub_sub="delete from tbl_cisub_sub where cisub_id='".$b."'";
mysqli_query($link,$s_sub_sub) or die(mysqli_error($link));

$sql_t_sub=mysqli_query($link,"select * from tbl_cisub where ci_id='".$a."' and plantcode='$plantcode'") or die(mysqli_error($link));
