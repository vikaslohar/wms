...
$sql_tbl=mysqli_query($link,"select * from tbl_softr2 where softr_tflg=0 and plantcode='$plantcode'") or die(mysqli_error($link));
...
<title>Plant- Transaction -Home - Super Soft Release</title>
...
$sql_arr_home=mysqli_query($link,"select * from tbl_softr2 where softr_tflg=1 and plantcode='$plantcode' order by softr_id desc,softr_code desc LIMIT $from, $max_results") or die(mysqli_error($link));
$tot_arr_home=mysqli_num_rows($sql_arr_home);

$total_results3 =mysqli_query($link,"SELECT COUNT(*)  FROM tbl_softr2 where softr_tflg=1 and plantcode='$plantcode'");
...
$total_results3 =mysqli_query($link,"SELECT COUNT(*)  FROM tbl_softr2 where softr_tflg=1");
$total_results2 = mysqli_fetch_array($total_results3);
$total_results = $total_results2[0]; 
