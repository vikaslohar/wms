...
function cleanData(&$str)
	 ...
	 $datatitle3 = array("#","Date of Arrival","Crop","SP Code-F","SP Code-M","Lot No. ","NoB","Qty","QC Status","GOT Status","GOT Grade","Production Grade","Production Location","State","Farmer","Organiser","Duration");
...
if($trdate!="")
{$ccnntt++;
$data1[$d]=array($d,$trdate,$crop,$spcf,$spcm,$lotno,$nob,$qty,$qc,$got,$gotgrade,$prodgrade,$ploc,$statenm,$farmer,$organiser,$diff); 
$d++;
}
}
}
