...
<table width="1003" height="600" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  ...
  <tr><td>
   <?php
	...
	$crp="ALL"; $ver="ALL";
	$qry="select Distinct lotldg_crop, lotldg_variety from tbl_lot_ldg where lotldg_sstage='Condition' and (lotldg_qc='Fail' OR lotldg_got='Fail') and lotldg_balqty > 0 and plantcode='$plantcode'";
...
?>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#2e81c1" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#2e81c1" style="border-bottom:solid; border-bottom-color:#2e81c1" >
	    <tr >
	      <td width="813" height="25">Crop Variety wise Substandard Condition Seed Report</td>
	    </tr></table></td>
	  </tr>
	  </table></td></tr>
...
$sql_istbl=mysqli_query($link,"select * from tbl_lot_ldg where lotldg_id='".$row_is1[0]."' and lotldg_balqty > 0 and lotldg_sstage='Condition' and (lotldg_qc='Fail' OR lotldg_got='Fail') and plantcode='$plantcode' order by lotldg_id asc") or die(mysqli_error($link)); 
...
$sql_issuetbl=mysqli_query($link,"select * from tbl_lot_ldg where lotldg_id='".$row_issue1[0]."' and lotldg_balqty > 0 and lotldg_sstage='Condition' and (lotldg_qc='Fail' OR lotldg_got='Fail') and plantcode='$plantcode' order by lotldg_id asc") or die(mysqli_error($link)); 
