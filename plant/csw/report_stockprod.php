<?php
	...
	if(isset($_POST['frm_action'])=='submit')
	{
		...
		echo "<script>window.location='report_stockprod1.php?sdate=$sdate&edate=$edate&txtcrop=$crop&txtvariety=$variety&txtstate=$state'</script>";
	}
...
<title>CSW - Report - Condition Seed Stock Report with Production Data</title>
...
<script src="stockprod.js"></script>
...
function chkvariety(val1)
{
	if(document.frmaddDepartment.txtvariety.value == "")
	{
		alert("Please select Variety");
		document.frmaddDepartment.txtstate.value="";
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#2e81c1" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#2e81c1" style="border-bottom:solid; border-bottom-color:#2e81c1" >
	    <tr >
	      <td width="813" height="30"class="Mainheading"  >&nbsp;Condition Seed Stock Report with Production Data</td>
	    </tr></table></td>
	  </tr>
	  </table></td></tr>
          ...
          <tr>
            ...
            <td><table align="center" border="1" width="574" cellspacing="0" cellpadding="0" bordercolor="#2e81c1" style="border-collapse:collapse" >
                <tr class="tblsubtitle" height="25">
                  <td colspan="4" align="center" class="tblheading">Condition Seed Stock Report with Production Data</td>
                </tr>
                <tr height="15">
...
<tr class="Dark" height="25">
<?
$quer6=mysqli_query($link,"SELECT state_id, state_name FROM tbl_state order by state_name Asc"); 
?>
	<td align="right"  valign="middle" class="tblheading" colspan="2" >State&nbsp;</td>
    <td align="left"  valign="middle" class="tbltext" colspan="2">&nbsp;<select class="tbltext" id="sstate" name="txtstate" style="width:170px;" onchange="chkvariety(this.value);" >
<option value="ALL" selected>--ALL--</option>
	<? while($noticiaitem = mysqli_fetch_array($quer6)) { ?>
		<option value="<?=$noticiaitem['state_name'];?>" />   
		<?=$noticiaitem['state_name'];?>
		<? } ?></select>&nbsp;</td>
