<?php
  ...
  $qry="select * from tbl_lot_ldg where lotldg_sstage='Pack' and lotldg_balqty > 0 and lotldg_resverstatus=1 and plantcode='$plantcode'";
...
<title>Pack-Report-Unidentified Pack Seed Report</title>
