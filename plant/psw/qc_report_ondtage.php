...
<tr class="Light" height="30">
 ...
 <td align="left"  valign="middle" class="tbltext">&nbsp;<input type="text" name="sstage" size="10" maxlength="10" class="tbltext" value="Pack" readonly="true" style="background-color:#CCCCCC" />
...
<tr >
<td valign="top" align="center"><a href="psw_mod_ reports.php"><img src="../../images/back.gif" border="0"  style="display:inline;cursor:pointer;"/></a>&nbsp;&nbsp;<input name="Submit" type="image" src="../../images/submit_1.gif" alt="Submit Value"  border="0" style="display:inline;cursor:pointer;" onClick="return mySubmit();"><input type="hidden" name="txtinv" /><input type="hidden" name="flagcode" value=""/><input type="hidden" name="fet1" value="" /></td>
</tr>
</table>
</td><td ></td>
</tr>
