<?php
	...
	if(isset($_POST['frm_action'])=='submit')
	{
		...
		echo "<script>window.location='report_rawcrop1.php?slchk=$slchk&txtcrop=$cid&txtvariety=$itemid'</script>";
	}
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#2e81c1" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#2e81c1" style="border-bottom:solid; border-bottom-color:#2e81c1" >
	    <tr >
	      <td width="813" height="30"class="Mainheading"  >Crop Variety wise Pack Seed Report </td>
	    </tr></table></td>
	  </tr>
	  </table></td></tr>
          ...
          <tr>
            ...
            <td><table align="center" border="1" width="600" cellspacing="0" cellpadding="0" bordercolor="#2e81c1" style="border-collapse:collapse" >
                <tr class="tblsubtitle" height="25">
                  <td colspan="4" align="center" class="tblheading">Crop Variety wise Pack Seed Report</td>
                </tr>
                <tr height="15">
   ...
   <tr class="Light" height="25">
    ...
    <td align="left"  valign="middle" class="tbltext" id="vitem" colspan="2">&nbsp;<input tabindex="0" type="radio" name="wsloc" value="yes" onclick="slchk(this.value)" checked="checked" />Yes&nbsp;<input tabindex="0" type="radio" name="wsloc" value="no" onclick="slchk(this.value)" />No</td>
                ...
                <table width="600" align="center" cellpadding="5" cellspacing="5" border="0" >
                  <tr >
                    <td valign="top" align="center"><a href="psw_mod_ reports.php"><img src="../../images/back.gif" border="0"  style="display:inline;cursor:pointer;"/></a>&nbsp;&nbsp;<input name="Submit" type="image" src="../../images/submit_1.gif" alt="Submit Value"  border="0" style="display:inline;cursor:pointer;" onClick="return mySubmit();" />
