...
<link href="../../include/vnrtrac_plantm.css" rel="stylesheet" type="text/css" />
  <?php
	...
	$qry="select * from tbl_lot_ldg where lotldg_sstage='Pack' and lotldg_trtype='Unidentified' and lotldg_trdate<='$edate' and plantcode='$plantcode'";	
  
	$sql_arr_home=mysqli_query($link,$qry) or die(mysqli_error($link));
	$tot_arr_home=mysqli_num_rows($sql_arr_home);
?>
<title>RSW-Report-Unidentified Pack Seed Report</title><table width="750" border="0" cellpadding="0" cellspacing="0" bordercolor="#ffffff" style="border-collapse:collapse" align="center">
<tr >
