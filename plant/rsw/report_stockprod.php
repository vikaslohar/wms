  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#2e81c1" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#2e81c1" style="border-bottom:solid; border-bottom-color:#2e81c1" >
	    <tr >
	      <td width="813" height="30"class="Mainheading"  >&nbsp;Raw Seed Stock Report with Production Data</td>
	    </tr></table></td>
	  </tr>
	  </table></td></tr>
          ...
          <tr>
            ...
            <td><table align="center" border="1" width="574" cellspacing="0" cellpadding="0" bordercolor="#2e81c1" style="border-collapse:collapse" >
                <tr class="tblsubtitle" height="25">
                  <td colspan="4" align="center" class="tblheading">Raw Seed Stock Report with Production Data</td>
                </tr>
                <tr height="15">
...
<option value="ALL" selected>--ALL--</option>
	<?php while($noticiaitem = mysqli_fetch_array($quer6)) { ?>
		<option value="<?=$noticiaitem['state_name'];?>" />   
		<?php echo $noticiaitem['state_name'];?>
		<?php } ?></select>&nbsp;</td>
