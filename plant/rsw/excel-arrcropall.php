...
session_start();
	...
	$dh="Crop_Variety_wise_Raw_Seed_Report ".$dat;
...
$datahead2[$cnt] = array("#","Lot No.","NoB","Qty","SLOC","Qc Status","Moisture %","Germination %","DOT","GOT Status","Production Location","State","Seed Status","Production Grade","GOT Grade"); 
if($slchk2=="yes") 
	{	
	array_push($datahead2[$cnt],"Arrival Date","Harvest Date"); 
	}
...
array_push($data1[$cnt][$d],$totqc,$totmost,$totgemp,$txtdot,$totgot,$ploc,$pstate,$totsst,$prodgrade,$gotgrade,$transactionid);
if($slchk2=="yes") 
{
