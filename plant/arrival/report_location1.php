...
<title>Plant-Report -Location Wise Report</title>
...
winHandle=window.open('report_location2.php?sdate='+sdate+'&edate='+edate+'&txtclass='+loc+'&state='+state+'&txtorganiser='+txtorganiser+'&txtcrop='+txtcrop+'&txtvariety='+txtvariety,'WelCome','top=20,left=80,width=1000,height=900,scrollbars=yes');
if(winHandle==null){
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#2e81c1" style="border-bottom:solid; border-bottom-color:#2e81c1" >
	    <tr >
	      <td width="813" height="25">&nbsp; Production Location wise Arrivals Report </td>
	    </tr></table></td>
	  </tr>
	  </table></td></tr>
...
<tr >
<td height="49" align="center" valign="top"><a href="report_location.php"><img src="../../images/back.gif" border="0"  style="display:inline;cursor:pointer;"/></a>&nbsp;&nbsp;<img src="../../images/printpreview.gif" onclick="openprint()" style="cursor:pointer" border="0" />
