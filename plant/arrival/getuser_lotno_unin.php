...
?>
  <select class="tbltext" name="pcode" style="width:40px;">
	...
	<option value="<?php echo $a;?>" selected="selected" ><?php echo $a;?></option></select>&nbsp;&nbsp;<select class="tbltext" name="ycodee" id="ycodee" style="width:40px;" onchange="ycodchk();">
...
$variety=$noticia['cropname']."-"."Unidentified";

$qr="select distinct(lotldg_lotno) from tbl_lot_ldg where lotldg_crop='".$crop."' and lotldg_variety='".$variety."' and lotldg_sstage='".$tp."' and lotldg_balqty > 0 $sss and plantcode='$plantcode'";
