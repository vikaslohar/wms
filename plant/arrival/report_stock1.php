...
<title>Plant-ReportStock Wise  Report</title>
...
winHandle=window.open('report_stock2.php?sdate='+sdate+'&edate='+edate+'&txtparty='+txtparty,'WelCome','top=20,left=80,width=1000,height=900,scrollbars=yes');
if(winHandle==null){
...
?>
   ...
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#2e81c1" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#2e81c1" style="border-bottom:solid; border-bottom-color:#2e81c1" >
	    <tr >
	      <td width="813" height="25">&nbsp; Stock Transfer Plant Wise Report</td>
	    </tr></table></td>
	  </tr>
	  </table></td></tr>
...
<tr class="Light">
         ...
         <td width="21%" align="center" valign="middle" class="tblheading"><?php echo $variety;?></td>
        <!-- <td width="17%" align="center" valign="middle" class="tblheading"><?php echo $party;?></td>-->
         ...
         <td width="8%" align="center" valign="middle" class="tblheading"><?php echo $bags?></td>
         ...
         <td width="10%" align="center" valign="middle" class="tblheading"><?php echo $qc?></td>
</tr>
<?php
}
else
...
<tr class="Dark">
         <td width="6%" align="center" valign="middle" class="tblheading"><?php echo $srno;?></td>
		 <td width="9%" align="center" valign="middle" class="tblheading"><?php echo $trdate;?></td>
		  <td width="14%" align="center" valign="middle" class="tblheading"><?php echo $row_crop['cropname']?></td>
         <td width="21%" align="center" valign="middle" class="tblheading"><?php echo $row_variety['popularname']?></td>
      <!--   <td width="17%" align="center" valign="middle" class="tblheading"><?php echo $party;?></td>-->
         <td width="15%" align="center" valign="middle" class="tblheading"><?php echo $lotno?></td>
         <td width="8%" align="center" valign="middle" class="tblheading"><?php echo $bags?></td>
         <td width="8%" align="center" valign="middle" class="tblheading"><?php echo $qty?></td>
