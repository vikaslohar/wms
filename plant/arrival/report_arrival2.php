...
$sdate = $_REQUEST['sdate'];
	...
	$tdate=$edate;
		...
		$sql_arr_home=mysqli_query($link,"select * from tblarrival where arrival_type='Trading' and  arrival_date <= '$edate' and arrival_date >= '$sdate' and party_id='".$txtparty."' and arrtrflag=1 and plantcode='$plantcode' order by arrival_date asc ") or die(mysqli_error($link));
...
<title>Arrival-Report-Trading Wise</title><table width="850" border="0" cellpadding="0" cellspacing="0" bordercolor="#ffffff" style="border-collapse:collapse" align="center">
<tr >
...
<table align="center" border="0" cellspacing="0" cellpadding="0" width="974" style="border-collapse:collapse">
   <!--	<tr height="25" >
    <td align="center" class="subheading" style="color:#303918; ">Lot Destination Report:</td>
  	...
  	<tr height="25">
    <td align="center" class="subheading" style="color:#303918; ">Date From: <?php echo $_REQUEST['sdate'];?> To <?php echo $_REQUEST['edate'];?></td>
  	</tr>
 <tr height="25" >
    <td align="center" class="subheading" style="color:#303918; ">Vendor: <?php echo $row_party['business_name'];?></td>
  </tr>
</table>
...
<tr class="Light">
         ...
         <td width="13%" align="center" valign="middle" class="tblheading"><?php echo $variety;?></td>
...
?>
<tr class="Dark">
         <td width="2%" align="center" valign="middle" class="tblheading" colspan="9">Record not found.</td>
</tr>
<?php
}
?>
