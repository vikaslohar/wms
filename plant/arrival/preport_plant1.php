...
$sql_armain12=mysqli_query($link,"select * from tblarrival where arrival_date <= '$edate' and arrival_date >= '$sdate' and arrival_type='".$typ."' and arrtrflag=1 $aaaa and plantcode='$plantcode' order by arrival_date desc") or die(mysqli_error($link));
