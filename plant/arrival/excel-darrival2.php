...
function cleanData(&$str)
	 ...
	 $datatitle3 = array("#","Crop","Variety"," V. Lot No."," Vendor Name"," Lot No.","NoB","Qty"," Stage","SLOC","QC","","QC Status","GOT Status","Status");
	 $d=1;
if($typ=="Trading")
{ 
...
if($tot_arr_home > 0)			
{
$data1[$d]=array($d,$crop,$variety,$lotoldlot,$loc1,$lotno,$bags,$qty,$stage,$slocs,$vchk,$per1,$qc,$got,$sstatus); 
$d++;
}
}
}
