<?php
	...
	if(isset($_REQUEST['edate']))
	{
	 $edate = $_REQUEST['edate'];
		...
		if($sdate!="" && $edate!="")
		{
		echo "<script>window.location='report_organiser1.php?sdate=$sdate&edate=$edate&txtclass=$cid'</script>";
		}
		else
		 {?>
		 <script>
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#2e81c1" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#2e81c1" style="border-bottom:solid; border-bottom-color:#2e81c1" >
	    <tr >
	      <td width="813" height="30"class="Mainheading"  >&nbsp;Organiser Wise  Arrival Report	</td>
	    </tr></table></td>
	  </tr>
	  </table></td></tr>
          ...
          <tr>
            ...
            <td><table align="center" border="1" width="574" cellspacing="0" cellpadding="0" bordercolor="#2e81c1" style="border-collapse:collapse" >
                <tr class="tblsubtitle" height="25">
                  <td colspan="4" align="center" class="tblheading">Organiser Wise  Arrival Report</td>
                </tr>
                <tr height="15">
...
?>
                ...
                <?php 
				$a="";
 $qry=mysqli_query($link,"select DISTINCT organiser from tblarrival_sub  where organiser!='$a' and plantcode='$plantcode' order by organiser Asc") or die(mysqli_error($link));
 
?>
                <tr class="Light" height="25">
                  <td width="318"  align="right"  valign="middle" class="tblheading">&nbsp;Organiser&nbsp; </td>
                  <td align="left"  valign="middle" colspan="3">&nbsp;<select class="tbltext" name="txtclass" style="width:170px;"   >                        <option value="" >---Select Organiser---</option>
                        <?php while($noticia_class = mysqli_fetch_array($qry)) { ?>
                        <option  value="<?php echo $noticia_class['organiser'];?>" />          
                        <?php echo $noticia_class['organiser'];?>
                        <?php } ?>
