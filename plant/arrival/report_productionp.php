<?php
	...
	if(isset($_REQUEST['edate']))
	{
	 $edate = $_REQUEST['edate'];
		...
		if($sdate!="" && $edate!="")
		{
		echo "<script>window.location='report_productionp1.php?sdate=$sdate&edate=$edate&txtclass=$cid'</script>";
		}
		else
		 {?>
		 <script>
...
<title>Quality-Report - Production Personnel Report</title>
...
{ 
	...
	{
		alert("Please Select Production Personnel");
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#2e81c1" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#2e81c1" style="border-bottom:solid; border-bottom-color:#2e81c1" >
	    <tr >
	      <td width="813" height="30"class="Mainheading"  > Production Personnel wise Seed Arrival Report  </td>
	    </tr></table></td>
	  </tr>
	  </table></td></tr>
          ...
          <tr>
            ...
            <td><table align="center" border="1" width="574" cellspacing="0" cellpadding="0" bordercolor="#2e81c1" style="border-collapse:collapse" >
                <tr class="tblsubtitle" height="25">
                  <td colspan="4" align="center" class="tblheading"> Production Personnel  Arrivals Report </td>
                </tr>
                <tr height="15">
...
?>
                ...
                <?php 
				$a="";
$qry=mysqli_query($link,"select Distinct pper from tblarrival_sub where pper!='$a' and plantcode='$plantcode' order by pper Asc") or die(mysqli_error($link));
?>
                <tr class="Light" height="25">
                  <td width="318"  align="right"  valign="middle" class="tblheading">&nbsp;Production&nbsp;Personnel</td>
                  <td align="left"  valign="middle" colspan="3">&nbsp;<select class="tbltext" name="txtclass" style="width:170px;"   >                       <option value="" >---Select personnel---</option>
                        <?php while($noticia_class = mysqli_fetch_array($qry)) { ?>
                        <option  value="<?php echo $noticia_class['pper'];?>" />          
                        <?php echo $noticia_class['pper'];?>
                        <?php } ?>
...
?>
                <!--<tr class="Light" height="25">
                  ...
                  <td align="left"  valign="middle" colspan="3"  class="tblbutn">&nbsp;<select class="tbltext" name="txtclass" style="width:170px;"   >
                        <option value="" >---Select Variety---</option>
                        <?php while($noticia_class = mysqli_fetch_array($qry)) { ?>
                        <option  value="<?php echo $noticia_class['did'];?>" />          
                        <?php echo $noticia_class['dest'];?>
                        <?php } ?>
                      </select>&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
                </tr>-->
                <?php
