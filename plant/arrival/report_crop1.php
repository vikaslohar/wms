...
<table width="1003" height="600" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  ...
  <tr><td>
   <?php
	...
	if($vv=="ALL")
	{	
	$sql_arr_home=mysqli_query($link,"select * from tblarrival where arrival_type='StockTransfer Arrival' and  arrival_date <= '$edate' and arrival_date >= '$sdate' and lotcrop='".$itemid."' and arrtrflag=1 and plantcode='$plantcode' order by arrival_date asc ") or die(mysqli_error($link));
	}
	else
	{
	$sql_arr_home=mysqli_query($link,"select * from tblarrival where arrival_type='StockTransfer Arrival' and  arrival_date <= '$edate' and arrival_date >= '$sdate' and lotcrop='".$itemid."' and lotvariety='".$vv."' and arrtrflag=1 and plantcode='$plantcode' order by arrival_date asc ") or die(mysqli_error($link));
	}
...
?>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#2e81c1" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#2e81c1" style="border-bottom:solid; border-bottom-color:#2e81c1" >
	    <tr >
	      <td width="813" height="25">&nbsp;Crop Wise Variety StockTransfer Report</td>
	    </tr></table></td>
	  </tr>
	  </table></td></tr>
...
<tr class="tblsubtitle" height="20">
			  ...
			  <td width="32%" align="center" valign="middle" class="tblheading">Stock Transfer from Plant</td>
			  <td width="16%" align="center" valign="middle" class="tblheading">Lot No.</td>
...
<tr class="Light">
		 ...
		 <td width="11%" align="center" valign="middle" class="tblheading"><?php echo $trdate;?></td>
         <td width="32%" align="center" valign="middle" class="tblheading"><?php echo $party;?></td>
         <td width="16%" align="center" valign="middle" class="tblheading"><?php echo $lotno?></td>
         <td width="9%" align="center" valign="middle" class="tblheading"><?php echo $bags?></td>
