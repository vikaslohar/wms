...
$sql_sub=mysqli_query($link,"select * from tbl_softr_sub where softrsub_id='".$pid."' and softr_id='".$trid."' and plantcode='$plantcode'") or die(mysqli_error($link));
...
$sql_t_sub=mysqli_query($link,"select * from tbl_softr_sub where softr_id='".$trid."' and plantcode='$plantcode'") or die(mysqli_error($link));
