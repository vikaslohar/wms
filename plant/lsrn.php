...
<title>Plant-Transaction Soft Release - LSRN</title>
...
<table width="750" height="282" border="0" align="center" cellpadding="0" cellspacing="0" >
 ...
 <?php 
$tid=$pid;
$sql_tbl=mysqli_query($link,"select * from tbl_softr where softr_id='".$tid."' and plantcode='$plantcode'") or die(mysqli_error($link));
...
$sql_srsub=mysqli_query($link,"SELECT * FROM tbl_softr_sub WHERE softr_id='".$tid."' and plantcode='$plantcode'") or die(mysqli_error($link));
