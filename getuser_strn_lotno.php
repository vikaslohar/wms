...
$sql_is1=mysqli_query($link,"select max(lotldg_id) from tbl_lot_ldg where plantcode='".$plantcode."' and  lotldg_lotno='".$row['lotldg_lotno']."' and lotldg_mergerflg=0 order by lotldg_id desc ") or die(mysqli_error($link));
