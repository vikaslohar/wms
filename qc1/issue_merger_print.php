...
$sql_is=mysqli_query($link,"select distinct lotldg_subbinid, lotldg_whid, lotldg_binid from tbl_lot_ldg where lotldg_crop='".$row['blendm_crop']."' and lotldg_lotno='".$ltno."' and lotldg_variety='".$row['blendm_variety']."' and lotldg_sstage='".$row['blendm_stage']."' group by lotldg_subbinid order by lotldg_id asc") or die(mysqli_error($link));
		
while($row_is=mysqli_fetch_array($sql_is))
{ 
	$slups=0; $slqty=0; $wareh=""; $binn=""; $subbinn="";
	$sql_is1=mysqli_query($link,"select max(lotldg_id) from tbl_lot_ldg where lotldg_subbinid='".$row_is['lotldg_subbinid']."' and lotldg_binid='".$row_is['lotldg_binid']."' and lotldg_crop='".$row['blendm_crop']."' and lotldg_lotno='".$ltno."' and lotldg_variety='".$row['blendm_variety']."' and lotldg_sstage='".$row['blendm_stage']."' order by lotldg_id desc ") or die(mysqli_error($link));
...
<td width="88" align="right"  valign="middle" class="tblheading">&nbsp;Requester Remarks&nbsp;</td>
<td width="656" align="left"  valign="middle" class="tbltext">&nbsp<?php echo $row['blendm_remarks'];?> </td>
</tr></table><br />
<table align="center" border="1" width="750" cellspacing="0" cellpadding="0" bordercolor="#d21704" style="border-collapse:collapse" >
<tr class="Light" height="30">
<td width="88" align="right"  valign="middle" class="tblheading">&nbsp;QCM Remarks&nbsp;</td>
<td width="656" align="left"  valign="middle" class="tbltext">&nbsp<?php echo $row['blendm_qcremarks'];?> </td>
</tr></table>
