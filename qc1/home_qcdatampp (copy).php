...
{	
	...
	{
		alert("Select Sample(s) No./Result To Update");
		return false;
	}
...
<tr class="tblsubtitle" height="20">
	...
	<td align="center" valign="middle" class="smalltblheading" colspan="4">Physical Purity Test Data</td>
	<td width="52" rowspan="2" align="center" valign="middle" class="smalltblheading">OCS<br />
	  No. of Seeds/Kg</td>
	<td width="52" rowspan="2" align="center" valign="middle" class="smalltblheading">ODV<br />
	  No. of Seeds/Kg</td>
	<td width="55" rowspan="2" align="center" valign="middle" class="smalltblheading">Discolour Seed %</td>
	<td width="52" rowspan="2" align="center" valign="middle" class="smalltblheading">Pin hole Seed<br />
	  No. of Seeds/Kg</td>
...
<tr class="tblsubtitle" height="20">
<td width="44" align="center" valign="middle" class="smalltblheading">Sample Weight (gms)</td>
<td width="32" align="center" valign="middle" class="smalltblheading">Pure Seed %</td>
<td width="39" align="center" valign="middle" class="smalltblheading">Inert Matter %</td>
<td width="33" align="center" valign="middle" class="smalltblheading">Light Seed %</td>
</tr>
<?php
$srno=1; $sel=1;
...
while($row_arr_home24=mysqli_fetch_array($sql_arr_home))
{
	...
	$qcp_samplewt=0; $qcp_pureseedper=0; $qcp_lightseedper=0; $qcp_ocseedinkg=0; $qcp_dcseedper=0; $qcp_phseedinkg=0; $qcp_ppdatadt=''; $qcp_imseedper=0; $qcp_odvseedinkg=0;
