<?php
	...
	$datatitle2 = array("","","","","","","","","","","(%) By Meter","(%) By oven","Date of Test","Pure Seed %","Inert Matter %","Light Seed %","OCS Nos./ Kg","ODV Nos./ Kg","Discoloured Seed %","Pin hole Nos./ Kg","Date of test","","","","No of replication","Normal Seedlings (%)","Abormal Seedlings (%)","Dead Seeds (%)","Hard/FUG Seeds (%)","Vigor","Date of test","No of replication","Normal Seedlings (%)","Abormal Seedlings (%)","Dead Seeds (%)","Vigor","Date of Test","","","","","Working","Guard","","","Arrival Date","SP Code Female","SP Code Male","Harvest Date");
