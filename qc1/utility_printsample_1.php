...
<title>Utility - Print Sample</title>
...
function openslocpopprint()
{
	...
	var tid=document.frmaddDepartment.tid.value;
	if(txtpp==0 || tid==""){
		cnt++;
	}
	//alert(tid);alert(txtpp);
	if(cnt == 0)
	{
		var itm=tid;
		winHandle=window.open('utility_printsample_2.php?tid='+itm+'&txtpp='+txtpp,'WelCome','top=170,left=180,width=820,height=450,scrollbars=yes');
		if(winHandle==null)
		{
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#d21704" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#d21704" style="border-bottom:solid; border-bottom-color:#d21704" >
	    <tr >
	      <td width="813" height="30"class="Mainheading"  >Utility - Print Sample</td>
	    </tr></table></td>
	  </tr>
	  </table></td></tr>
...
<?php
$tid="";
//echo "select * from tbl_qctest where oldlot='".$txtlot."' and aflg=0 and bflg=0 and cflg=0 group by sampleno order by sampleno asc";
$sql_qctest=mysql_query("select * from tbl_qctest where oldlot='".$txtlot."' group by sampleno order by sampleno asc");
while($row_qctest=mysql_fetch_array($sql_qctest))
{
	if($tid=="")
	{
		$tid=$row_qctest['tid'];
...
<tr >
<td align="center" colspan="3"><a href="utility_printsample.php"><img src="../images/back.gif" border="0"/></a>&nbsp;<a href="Javascript:void(0);" onclick="openslocpopprint();"><input type="image" src="../images/next.gif" alt="Submit Value" border="0" style="display:inline;cursor:pointer;" /></a></td>
</tr>
</table>
