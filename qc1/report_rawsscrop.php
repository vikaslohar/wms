<?php
	...
	if(isset($_POST['frm_action'])=='submit')
	{
		...
		echo "<script>window.location='report_rawsscrop1.php?sdate=$sdate&edate=$edate&txtcrop=$cid&txtvariety=$itemid&txtstage=$txtstage'</script>";
	}
...
{ 
	...
	if(dt1 > dt2)
	{
	alert("Please select Valid Date Range1.");
	return false;
	}
	
	if(dt2 > dt3)
	{
	alert("Please select Valid Date Range2.");
	return false;
	}
	
	if(dt1 > dt3)
	{
	alert("Please select Valid Date Range3.");
	return false;
	}
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#d21704" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#d21704" style="border-bottom:solid; border-bottom-color:#d21704" >
	    <tr >
	      <td width="813" height="30"class="Mainheading"  >Crop Variety wise Substandard Seed Report </td>
	    </tr></table></td>
	  </tr>
	  </table></td></tr>
          ...
          <tr>
            ...
            <td><table align="center" border="1" width="600" cellspacing="0" cellpadding="0" bordercolor="#d21704" style="border-collapse:collapse" >
                <tr class="tblsubtitle" height="25">
                  <td colspan="4" align="center" class="tblheading">Crop Variety wise Substandard Seed Report</td>
                </tr>
                <tr height="15">
...
<tr class="Light" height="25">
	<td align="right"  valign="middle" class="tblheading" colspan="2">Stage&nbsp;</td>
    <td align="left"  valign="middle" class="tbltext" colspan="2">&nbsp;<select class="tbltext" id="stage" name="txtstage" style="width:170px;" >
<option value="ALL" selected>--ALL--</option>
