<?php
	...
	//exit;
		...
		$txtdensity=trim($_POST['txtdensity']);
		...
		$sql_arr_home=mysqli_query($link,"select * from tbl_densitydata where density_lotno='".$clotno."'") or die(mysqli_error($link));
		if($tot_arr_home=mysqli_num_rows($sql_arr_home)==0)
		{
			$sql_main="insert into tbl_densitydata (density_date, density_crop, density_variety, density_orlot, density_lotno, density_sampleno, density_rawwtdate, density_rawsampwt, density_rawwtflg)values('$dt', '$txtcrop', '$txtvariety', '$txtlot1', '$clotno', '$samplenum', '$dt', '$txtdensity', '1')";
			// exit;
			if(mysqli_query($link,$sql_main) or die(mysqli_error($link)))
			{
				echo "<script>window.location='home_rawdensitydata.php'</script>";	
			}	
		}
	}
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#e48324" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#d21704" style="border-bottom:solid; border-bottom-color:#d21704" >
	    <tr >
	      <td width="813" height="25" class="Mainheading">&nbsp;Transaction - Condition Density Data Update</td>
	    </tr></table></td>
...
<tr class="tblsubtitle" height="20">
  <td colspan="6" align="center" class="tblheading">Condition Density Data Update</td>
</tr>
...
<option value="" selected>--Select Variety--</option>
        ...
        <td align="left"  valign="middle" class="smalltblheading"  >&nbsp;<input name="txtdensity" type="text" size="20" class="tbltext" tabindex="0" maxlength="20" onkeypress="return isNumberKey(event)" />&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
</tr>
</table>

<table align="center" width="850" cellpadding="5" cellspacing="5" border="0" >
<tr >
<td valign="top" align="right"><a href="home_rawdensitydata.php" tabindex="20"><img src="../images/cancel.gif" border="0"style="display:inline;cursor:Pointer;" onclick="return confirm('Do You wish to Cancel this Transaction?');" /></a>&nbsp;&nbsp;<input name="Submit" type="image" src="../images/submit.gif" alt="Submit Value"  border="0" style="display:inline;cursor:Pointer;" tabindex="" onClick="return mySubmit();">&nbsp;&nbsp;</td>
</tr>
</table>
</td><td width="30"></td>
</tr>
