...
<table align="center" border="1" cellspacing="0" cellpadding="0" width="750" bordercolor="#d21704" style="border-collapse:collapse">
  	<tr height="25">
    <td align="center" class="subheading" style="color:#303918; " colspan="6">Stock Report As on - <?php echo date("d-m-Y H:i:s"); ?></td>
  </tr>
<tr height="25" >
...
if($crval<>"")
{
	...
	if($verval<>"")
	{
		...
		$gemp=''; $qcresult=''; $dot=''; $gotresult=''; $dogr=''; $gpurity=''; $harvestdt=''; $arryear='';
