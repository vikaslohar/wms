...
<title>Quality-Report - Pending GOT - GOT Data Pending</title>
...
function openprint(srno)
{
	if(srno>1)
	{
		...
		var cropage=document.frmaddDepartment.cropage.value;
		winHandle=window.open('report_gotdatapending2.php?sdate='+sdate+'&edate='+edate+'&txtcrop='+txtcrop+'&txtvariety='+txtvariety+'&cropage='+cropage,'WelCome','top=20,left=80,width=1000,height=950,scrollbars=yes');
		if(winHandle==null){
  ...
  <tr><td>
   ...
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#d21704" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#d21704" style="border-bottom:solid; border-bottom-color:#d21704" >
	    <tr >
	      <td width="813" height="25">&nbsp;Pending GOT Report - GOT Data Pending</td>
	    </tr></table></td>
	  </tr>
	  </table></td></tr>
	 ...
	 <input name="cropage" value="<?php echo $cropage;?>" type="hidden">
...
<tr >
<td height="49" align="center" valign="top"><a href="report_gotdatapending.php"><img src="../images/back.gif" border="0"  style="display:inline;cursor:pointer;"/></a>&nbsp;&nbsp;<img src="../images/printpreview.gif" onclick="openprint('<?php echo $srno;?>')" style="cursor:pointer" border="0" />
