	...
	if(isset($_POST['frm_action'])=='submit')
	{
		...
		for($k=0; $k<count($fctrid); $k++)
		{
			...
			if($samplenumber!='')
			{
				...
				$tdate=date("Y-m-d");
				$sql_in1="update tbl_qcpdata set qcp_ppresult='$germinationper', qcp_ppdate='$dt', qcp_qcslogid='$logid', qcp_ppflg='$one', qcp_ppdataflg='$one' where qcp_sampleno='$samplenumber'";	
					...
					while($rowck=mysqli_fetch_array($sqlck))
					{
						...
						while($rowck2=mysqli_fetch_array($sqlck2))
						{
							...
							while($row_ck=mysqli_fetch_array($sql_ck))
							{
								...
								$sql_sub_sub12="update tbl_qctest set pp='$germinationper' where tid='".$rowck2['tid']."' and sampleno='$osamp22' and yearid='$yearid22'";
								$qq=mysqli_query($link,$sql_sub_sub12) or die(mysqli_error($link));

								$sql_sub="update tbl_lot_ldg set lotldg_vchk='$germinationper' where orlot='$oldlotn'";
								$sql_sub2="update tbl_lot_ldg_pack set lotldg_vchk='$germinationper' where orlot='$oldlotn'";
		...
		{
			echo "<script>window.location='home_qcdatampp.php'</script>";
		}
	}
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#d21704" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#d21704" style="border-bottom:solid; border-bottom-color:#d21704" >
	    <tr >
	      <td width="940" height="25">&nbsp;Transaction - QC Data Verification and Physical Purity Result Update</td>
	    </tr></table></td>
...
<tr class="Light" height="20">
  <td align="center" class="tblheading">QC Physical Purity Data Verification and Result Pending List</td>
...
while($row_arr_home24=mysqli_fetch_array($sql_arr_home))
{
	...
	{
		//echo "select * from tbl_qcpdata where qcp_sampleno='".$sampno."' ";
	...
	//echo $row_arr_home['state']."  -  ".$moistflg."  -  ".$ppflg."  -  ".$germflg."<br/>";
	$setupdt='';
...
<table cellpadding="5" cellspacing="5" border="0" width="950">
    <tr >
      <td align="right" colspan="3"><a href="home_qcdatampp.php" tabindex="20"><img src="../images/back.gif" border="0"style="display:inline;cursor:hand;" /></a>&nbsp;<input name="image" type="image" style="display:inline;cursor:pointer;" onclick="return mySubmit();" src="../images/submit.gif" alt="Submit Value" border="0"/>
	  </td>
    </tr>
  </table>
</div>
