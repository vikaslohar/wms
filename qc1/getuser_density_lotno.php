...
//echo "select distinct(orlot) from tbl_lot_ldg where lotldg_crop='".$crop."' and lotldg_variety='".$variety."' and lotldg_balqty > 0 and lotldg_sstage ='Condition' $sss"."<br />";

$sql_tbl_sub=mysqli_query($link,"select distinct(orlot) from tbl_lot_ldg where lotldg_crop='".$crop."' and lotldg_variety='".$variety."' and lotldg_balqty > 0 and lotldg_sstage ='Condition' $sss")or die(mysqli_error($link));
