<?php
	...
	$crp="ALL"; $ver="ALL";
	$qry="select * from tbl_drying where arrflg='1' and dflg='1' ";
	if($crop!="ALL")
	{	
		$qry.="and crop='$crop' ";
	...
	$datatitle1 = array("#","Date of Drying Slip","Drying Slip Ref. No.","Crop","Variety","Lot No.","Before Drying","","After Drying","","Damage Loss","");
	$datatitle2 = array("","","","","","","NoB","Qty","NoB","Qty","Qty","%");
 
$d=1;
while($row_arr_home1=mysqli_fetch_array($sql_arr_home1))
{
	$sql_issuetbl=mysqli_query($link,"select * from tbl_dryingsub where trid='".$row_arr_home1['trid']."'") or die(mysqli_error($link)); 
