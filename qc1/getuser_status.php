...
{	
	$sql_tblsub1=mysqli_query($link,"select distinct lotldg_sstage from tbl_lot_ldg where orlot='".$orlot."' order by orlot") or die(mysqli_error($link));
	...
	while($rowtbl22=mysqli_fetch_array($sql_tblsub1))
	{
		...
		{ 
			...
			{ 
				...
				{ 
					$bags=0; $qty=0; 
					$sql_tbl_sub1=mysqli_query($link,"select distinct lotldg_subbinid, lotldg_variety, lotldg_crop, lotldg_whid, lotldg_binid from tbl_lot_ldg where orlot='".$orlot."' and lotldg_sstage='".$rowtbl22['lotldg_sstage']."' group by lotldg_subbinid, lotldg_variety, orlot order by lotldg_subbinid") or die(mysqli_error($link));
					$t=mysqli_num_rows($sql_tbl_sub1);
					while($row_tbl22=mysqli_fetch_array($sql_tbl_sub1))
					{
						$sql_tbl1=mysqli_query($link,"select max(lotldg_id) from tbl_lot_ldg where lotldg_subbinid='".$row_tbl22['lotldg_subbinid']."' and orlot='".$orlot."' and lotldg_sstage='".$rowtbl22['lotldg_sstage']."'") or die(mysqli_error($link));  
...
{	
	$sql_tblsub1=mysqli_query($link,"select distinct lotldg_sstage from tbl_lot_ldg_pack where orlot='".$orlot."' order by orlot") or die(mysqli_error($link));
	$t_tblsub1=mysqli_num_rows($sql_tblsub1);
	while($rowtbl22=mysqli_fetch_array($sql_tblsub1))
	{
		$p_array=explode(",", $row_arr_home['trstage']); 
		...
		{ 
			...
			{ 
				...
				{ 
					$bags=0; $qty=0; 
					$sql_tbl_sub1=mysqli_query($link,"select distinct subbinid, lotldg_variety, lotldg_crop, whid, binid from tbl_lot_ldg_pack where orlot='".$orlot."' and lotldg_sstage='".$rowtbl22['lotldg_sstage']."' group by subbinid, lotldg_variety, orlot order by subbinid") or die(mysqli_error($link));
					$t=mysqli_num_rows($sql_tbl_sub1);
					while($row_tbl22=mysqli_fetch_array($sql_tbl_sub1))
					{
						$sql_tbl1=mysqli_query($link,"select max(lotdgp_id) from tbl_lot_ldg_pack where subbinid='".$row_tbl22['subbinid']."' and orlot='".$orlot."' and lotldg_sstage='".$rowtbl22['lotldg_sstage']."'") or die(mysqli_error($link));  
						$row_tbl1=mysqli_fetch_array($sql_tbl1);
