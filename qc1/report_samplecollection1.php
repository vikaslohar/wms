...
function opensrfrint(tid)
{
winHandle=window.open('srfno_print.php?itmid='+tid,'WelCome','top=170,left=180,width=820,height=450,scrollbars=yes');
if(winHandle==null){
alert("While Launching New Window...\nYour browser maybe blocking up Popup windows. \n\n  Please check your Popup Blocker Settings or ..\n Please hold Ctrl Key and Click on link to open new Browser"); }

}

function openslocpopprint(sdate,edate,txtcrop,txtvariety)
{
//var itm=document.frmaddDepartment.tid.value;
winHandle=window.open('report_samplecollection_print.php?sdate='+sdate+'&edate='+edate+'&txtcrop='+txtcrop+'&txtvariety='+txtvariety,'WelCome','top=170,left=180,width=820,height=450,scrollbars=yes');
if(winHandle==null)
{
alert("While Launching New Window...\nYour browser maybe blocking up Popup windows. \n\n  Please check your Popup Blocker Settings or ..\n Please hold Ctrl Key and Click on link to open new Browser"); 
}
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#d21704" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#d21704" style="border-bottom:solid; border-bottom-color:#d21704" >
	    <tr >
	      <td width="940" height="25">&nbsp;Report - Sample Collection List</td>
	    </tr></table></td>
...
<tr class="Light">
	...
	<td align="center" valign="middle" class="smalltbltext"><?php if($qcrefno!=''){?><a href="Javascript:void(0)" onclick="opensrfrint('<?php echo $qcrefno;?>');"><?php echo $qcrefno;?></a><?php }else echo "";?></td>  
...
<tr >
<td valign="top" align="center"><a href="report_qcsamp.php"><img src="../images/back.gif" border="0"style="display:inline;cursor:Pointer;" /></a>&nbsp;<a href="Javascript:void(0)" onClick="openslocpopprint('<?php echo $_REQUEST['sdate'];?>','<?php echo $_REQUEST['edate'];?>','<?php echo $_REQUEST['txtcrop'];?>','<?php echo $_REQUEST['txtvariety'];?>');"><img src="../images/printpreview.gif" border="0"style="display:inline;cursor:pointer;" /></a></td>
</tr>
</table>
