...
$datahead3 = array("Crop","Variety","Blending Date","Blended Lot No.","Qty","SLOC","Constituent Lot No.","Qty","SLOC","QC Status","DoT","Germ%","GoT Status","DoGR"); 
...
//{
	while($row_rr=mysqli_fetch_array($sql_rr))
	{
		...
		while($rowmonth2=mysqli_fetch_array($sqlmonth2))
		{
			...
			{
				$ctlotno=""; $rmqty1=""; $qcresult=''; $gotresult=''; $dogr=''; $dot=''; $slocs=""; $gemp=""; $dogr2=''; $dot2=''; $slocs2="";
				...
				if($tot_rr > 0)
				{
					$data1[$d]=array($cropname,$variety,$blendingdate,$lotno,$cqty1,$mainsloc,$ctlotno,$rmqty1,$slocs2,$qcresult,$dot2,$gemp2,$gotresult,$dogr2); 
					$d++;
				}
			}
		}
