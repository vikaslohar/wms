...
<table width="1003" height="600" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#d21704" >
	  ...
	  <table width="810" border="0" cellpadding="0" cellspacing="0" bordercolor="#d21704" style="border-bottom:solid; border-bottom-color:#d21704" >
        <tr >
          <td width="810" height="25">&nbsp;Transaction - Condition Density Data Update</td>
        </tr></table></td>
...
<tr height="25" class="tbltitle" >
<td align="center" width="130" valign="middle" class="tblbutn" style="cursor:hand; background-color:#FAA199;"><a href="add_cdensity.php" style="text-decoration:none; color:#FFFFFF">Add </a></td>
</tr>
...
$targetpage = $PHP_SELF; 
	...
	$sql_arr_home=mysqli_query($link,"select * from tbl_densitydata where density_conwtflg=1 order by density_crop, density_variety, density_lotno asc LIMIT $start, $limit") or die(mysqli_error($link));
	$tot_arr_home=mysqli_num_rows($sql_arr_home);
	
	//$total_results = mysql_result(mysqli_query($link,"SELECT COUNT(*) as Num FROM tbl_qctest where bflg=1   and qcflg=0"),0); 
	
	$query = "select * from tbl_densitydata where density_conwtflg=1";
...
<tr class="Light" height="20">
  <td colspan="6" align="center" class="tblheading">Condition Density Data Update Completed List </td>
</tr>
</table>
<table align="center" border="1" cellspacing="0" cellpadding="0" width="800" bordercolor="#d21704" style="border-collapse:collapse">
...
while($row_arr_home=mysqli_fetch_array($sql_arr_home))
{
	...
	$rawsampwt=$row_arr_home['density_consampwt'];
