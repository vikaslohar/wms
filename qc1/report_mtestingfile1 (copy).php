...
<tr class="tblsubtitle" height="20">
	...
	<td align="center" valign="middle" class="smalltblheading" colspan="19" >Hot Air Oven Method</td>
    <td align="center" valign="middle" class="smalltblheading" colspan="10" >Moisture Meter</td>
</tr>
	...
	<td width="4%" align="center" valign="middle" class="smalltblheading" >m1rep1</td>
	<td width="4%" align="center" valign="middle" class="smalltblheading" >m1rep2</td>
	<td width="4%" align="center" valign="middle" class="smalltblheading" >m1rep3</td>
	<td width="4%" align="center" valign="middle" class="smalltblheading" >m1rep4</td>
	<td width="4%" align="center" valign="middle" class="smalltblheading" >m1repdt</td>
	<td width="4%" align="center" valign="middle" class="smalltblheading" >rep1moist</td>
    <td width="4%" align="center" valign="middle" class="smalltblheading" >m2rep1</td>
    <td width="4%" align="center" valign="middle" class="smalltblheading" >m2rep2</td>
    <td width="4%" align="center" valign="middle" class="smalltblheading" >m2rep3</td>
    <td width="4%" align="center" valign="middle" class="smalltblheading" >m2rep4</td>
    <td width="4%" align="center" valign="middle" class="smalltblheading" >m2repdt</td>
    <td width="4%" align="center" valign="middle" class="smalltblheading" >rep2moist</td>
    <td width="4%" align="center" valign="middle" class="smalltblheading" >m3rep1</td>
    <td width="4%" align="center" valign="middle" class="smalltblheading" >m3rep2</td>
    <td width="4%" align="center" valign="middle" class="smalltblheading" >m3rep3</td>
    <td width="4%" align="center" valign="middle" class="smalltblheading" >m3rep4</td>
    <td width="4%" align="center" valign="middle" class="smalltblheading" >m2repdt</td>
    <td width="4%" align="center" valign="middle" class="smalltblheading" >rep3moist</td>
    <td width="4%" align="center" valign="middle" class="smalltblheading" >haommoistper</td>
    <td width="4%" align="center" valign="middle" class="smalltblheading" >mmrep1</td>
    <td width="4%" align="center" valign="middle" class="smalltblheading" >mmrep2</td>
    <td width="4%" align="center" valign="middle" class="smalltblheading" >mmrep3</td>
    <td width="4%" align="center" valign="middle" class="smalltblheading" >mmrepdt</td>
    <td width="4%" align="center" valign="middle" class="smalltblheading" >mmoistper</td>
    <td width="4%" align="center" valign="middle" class="smalltblheading" >mmsrep1</td>
    <td width="4%" align="center" valign="middle" class="smalltblheading" >mmsrep2</td>
    <td width="4%" align="center" valign="middle" class="smalltblheading" >mmsrep3</td>
    <td width="4%" align="center" valign="middle" class="smalltblheading" >mmsrepdt</td>
    <td width="4%" align="center" valign="middle" class="smalltblheading" >mmsmoistper</td>
</tr>	
 </thead>
 <tbody>
<?php
...
<td align='center' valign='middle' class='smalltbltext'><?php echo $t5;?></td>
...
<td align='center' valign='middle' class='smalltbltext'><?php echo $t11;?></td>
