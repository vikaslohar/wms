<?php
	...
	if(isset($_POST['frm_action'])=='submit')
	{
		...
		?>
		<script>
		mywindow='excel-owpsr6.php?sdate=';
...
alert("While Launching New Window...\nYour browser maybe blocking up Popup windows. \n\n  Please check your Popup Blocker Settings or ..\n Please hold Ctrl Key and Click on link to open new Browser"); }
		...
		{
		echo "<script>window.location='report_orgw_prostatus4.php?sdate=$sdate&edate=$edate&txtcrop=$cid&txtvariety=$itemid&txtpmcode=$txtpmcode'</script>";
		}
		}
		else
		 {?>
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#d21704" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#d21704" style="border-bottom:solid; border-bottom-color:#d21704" >
	    <tr >
	      <td width="813" height="30"class="Mainheading"  >Organiser wise Processing Status Report - Pricessing Period</td>
	    </tr></table></td>
	  </tr>
	  </table></td></tr>
