<?php
	...
	if(isset($_POST['frm_action'])=='submit')
	{
		...
		$sql_in="insert into tbl_gotloc(gotloc_name,gotloc_state) values(
											  '$location','$state'
												)";
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="5398ee" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="4ea1e1" style="border-bottom:solid; border-bottom-color:#d21704" >
	    <tr >
	      <td width="813" height="25" class="Mainheading">&nbsp;GOT Location Master - Add New Location </td>
	    </tr></table></td>
...
<td width="309" align="right" height="30" valign="middle" class="tblheading">&nbsp;GOT Location (City/Town/Village)&nbsp;</td>
