...
$sql_month=mysqli_query($link,"select distinct packtype from tbl_lot_ldg_pack where lotldg_crop='".$b."' and lotldg_variety='".$a."'  order by packtype")or die(mysqli_error($link));
