...
var txtprodper=document.frmaddDepartment.txtprodper.value;
winHandle=window.open('report_prodperw_prostatus2.php?sdate='+sdate+'&txtcrop='+itemid+'&txtvariety='+vv+'&edate='+edate+'&txtpmcode='+pmc+'&txtprodper='+txtprodper,'WelCome','top=20,left=80,width=850,height=600,scrollbars=yes');
if(winHandle==null){
...
<?php
	...
	$qry="select arrival_id, arrival_date, yearcode from tblarrival where arrival_date <='".$edate."' and arrival_date >='".$sdate."' and arrival_type='Fresh Seed with PDN' and arrtrflag=1 and arrival_id IN($arid)";
