<?php
	...
	if(isset($_POST['frm_action'])=='submit')
	{
		...
		echo "<script>window.location='add_rtsrfgen_preview.php?lotno=$txtlot&lotarr=$txtlot1'</script>";	
	}
  ...
  <td colspan="6" align="center" class="tblheading">SRF for RT Lots Update</td>
         ...
         <tr class="Light" height="30" id="vitem">
          <td width="180" align="right"  valign="middle" class="tblheading">SRF Number &nbsp;</td>
           <td align="left" width="241" valign="middle" class="tbltext" style="border-color:#d21704" >&nbsp;<input name="txtlot" type="text" size="20" class="tbltext" tabindex=""  maxlength="20"  value="<?php echo $srfno;?>" readonly="true" style="background-color:#CCCCCC"  >&nbsp;<font color="#FF0000">*</font>&nbsp;<!--<a href="Javascript:void(0);" onclick="openslocpop();">New SRF</a>--></td>
		   
		  <td width="160" align="right"  valign="middle" class="smalltblheading">Total Lots Selected&nbsp;</td>
        <td width="259" align="left"  valign="middle" class="smalltblheading"  >&nbsp;<input name="totlotssel" type="text" size="5" class="tbltext"  readonly="true" style="background-color:#CCCCCC"  />&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
</tr>
</table>
<table align="center" border="1" width="850" cellspacing="0" cellpadding="0" bordercolor="#d21704" style="border-collapse:collapse" > 
...
<td width="100" align="center" valign="middle" class="tblheading">Select</td>
</tr>

<?php
$srn=1; $totalups=0; $totalqty=0; $cnt=0;

$sql_m=mysqli_query($link,"select qcg_lotno, qcg_sampleno, qcg_crop, qcg_variety, qcg_germp from tbl_qcgdata where qcg_retult='RT' and qcg_srfflg=0 ") or die(mysqli_error($link));
...
<td align="center" valign="middle" class="tblheading"><input type="hidden" id="sampleno_<?php echo $srn;?>" name="sampleno_<?php echo $srn;?>" value="<?php echo $sampleno;?>" /><?php echo $sampleno;?></td>
...
<td align="center" valign="middle" class="tblheading"><input type="hidden" id="dsdot_<?php echo $srn;?>" name="dsdot_<?php echo $srn;?>" readonly="true" style="background-color:#CCCCCC" value="<?php echo $lastgermp;?>" size="10" /><?php echo $lastgermp;?></td>
...
<td align="center" valign="middle" class="tblheading"><input type="checkbox" name="fet" id="foc_"<?php echo $srn;?> value="<?php echo $val;?>" onclick="return clall(this.value,<?php echo $srn;?>)" /></td>
  </tr>
<?php
}
else
...
<table align="center" width="850" cellpadding="5" cellspacing="5" border="0" >
<tr >
<td valign="top" align="right"><a href="home_rtsrf.php" tabindex="20"><img src="../images/cancel.gif" border="0"style="display:inline;cursor:Pointer;" onclick="return confirm('Do You wish to Cancel this Transaction?');" /></a>&nbsp;&nbsp;</td>
</tr>
</table>
</td><td width="30"></td>
</tr>
