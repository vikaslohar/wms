...
<tr class="tblsubtitle" height="20">
	<td width="2%"  align="center" valign="middle" class="smalltblheading" rowspan="2" >#</td>
	<td width="5%"  align="center" valign="middle" class="smalltblheading" rowspan="2" >DOSR</td>
	<td width="7%"  align="center" valign="middle" class="smalltblheading" rowspan="2" >Crop</td>
	<td width="8%"   align="center" valign="middle" class="smalltblheading" rowspan="2" >Variety</td>
	<td align="center" valign="middle" class="smalltblheading" rowspan="2" >Lot No.</td>
	<td width="3%"  align="center" valign="middle" class="smalltblheading" rowspan="2" >Total Qty (kg)</td>
	<td width="3%"   align="center" valign="middle" class="smalltblheading" rowspan="2" >QC Tests</td>
	<td width="5%"  align="center" valign="middle" class="smalltblheading" rowspan="2" >Sample no.</td>
	<td width="4%"  align="center" valign="middle" class="smalltblheading" rowspan="2" >DOSC</td>
	<td width="4%"  align="center" valign="middle" class="smalltblheading" rowspan="2" >Doc. Ref. No.</td>
	<td align="center" valign="middle" class="smalltblheading" rowspan="2" >Sample Weight</td>
	<td align="center" valign="middle" class="smalltblheading" colspan="2" >Pure Seed</td>
	<td align="center" valign="middle" class="smalltblheading" colspan="2" >Inert Matter</td>
	<td align="center" valign="middle" class="smalltblheading" colspan="2" >Light Seeds</td>
	<td align="center" valign="middle" class="smalltblheading" colspan="3" >Other Crop Seeds</td>
	<td align="center" valign="middle" class="smalltblheading" colspan="8" >Other Distinguishable Variety</td>
	<td align="center" valign="middle" class="smalltblheading" colspan="2" >Discoloured Seeds</td>
	<td align="center" valign="middle" class="smalltblheading" colspan="3" >Pin Holes</td>
	<td align="center" valign="middle" class="smalltblheading" colspan="3" >Germinated Seeds</td>
	<td width="5%"  align="center" valign="middle" class="smalltblheading" rowspan="2" >PP Result</td>
	<td width="5%"  align="center" valign="middle" class="smalltblheading" rowspan="2" >PP Result Date</td>
	</tr>
	<tr class="tblsubtitle" height="20">
	<td align="center" valign="middle" class="smalltblheading" >Weight (g)</td>
	<td align="center" valign="middle" class="smalltblheading" >%</td>
	<td align="center" valign="middle" class="smalltblheading" >Weight (g)</td>
	<td align="center" valign="middle" class="smalltblheading" >%</td>
	<td align="center" valign="middle" class="smalltblheading" >Weight (g)</td>
	<td align="center" valign="middle" class="smalltblheading" >%</td>
	<td width="4%"  align="center" valign="middle" class="smalltblheading" >Weight (g)</td>
	<td width="5%"  align="center" valign="middle" class="smalltblheading" >No of Seeds</td>
	<td width="5%"  align="center" valign="middle" class="smalltblheading" >Nos/Kg</td>
	<td width="5%"  align="center" valign="middle" class="smalltblheading" >Weight (g)</td>
	<td width="4%"  align="center" valign="middle" class="smalltblheading" >1010</td>
	<td width="5%"  align="center" valign="middle" class="smalltblheading" >Fine Grain</td>
	<td width="5%"  align="center" valign="middle" class="smalltblheading" >Bold Grain</td>
	<td width="5%"  align="center" valign="middle" class="smalltblheading" >Long Grain</td>
	<td width="4%"  align="center" valign="middle" class="smalltblheading" >Other Type</td>
	<td width="5%"  align="center" valign="middle" class="smalltblheading" >No of Seeds</td>
	<td width="5%"  align="center" valign="middle" class="smalltblheading" >Nos/Kg</td>
	<td width="5%"  align="center" valign="middle" class="smalltblheading" >Weight (g)</td>
	...
	<td width="5%"  align="center" valign="middle" class="smalltblheading" >Nos/Kg</td>
	<td width="5%"  align="center" valign="middle" class="smalltblheading" >Weight (g)</td>
	<td width="4%"  align="center" valign="middle" class="smalltblheading" >No of Seeds</td>
	<td width="5%"  align="center" valign="middle" class="smalltblheading" >Nos/Kg</td>
