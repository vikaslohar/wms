...
while($row_gotmain=mysqli_fetch_array($sql_arr_home))
{
	...
	$sql_gotmain=mysqli_query($link,"select * from tbl_gottest where  gottest_sampleno='".$sampno."'  and yearid='".$yrcode."' and gottest_lotno='".$row_gotmain['gotm_lotno']."' order by gottest_tid DESC") or die(mysqli_error($link));
...
<tr class="Light">
	...
	<td align="center" valign="middle" class="smalltbltext"><a href="add_got_data1.php?tid=<?php echo $row_arr_home['gottest_tid'];?>" >Review</a></td>
