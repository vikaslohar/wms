...
<td align="center" width="130" valign="middle" class="tblbutn" style="cursor:hand; background-color:#FAA199;"><a href="add_rawdensity.php" style="text-decoration:none; color:#FFFFFF">Add </a></td>
</tr>
...
$targetpage = $PHP_SELF; 
	...
	$sql_arr_home=mysqli_query($link,"select * from tbl_densitydata where density_rawwtflg=1 order by density_crop, density_variety, density_lotno asc LIMIT $start, $limit") or die(mysqli_error($link));
