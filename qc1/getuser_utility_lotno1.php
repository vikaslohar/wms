...
<?php 
$qr="select * from tbl_qctest where crop='".$crop."' and variety='".$variety."'   group by sampleno, yearid order by oldlot, sampleno ASC";
...
<tr class="tblsubtitle" height="20">
  <td colspan="6" align="center" class="tblheading">Select Lot </td>
</tr>
...
<td width="350"  align="left" valign="middle" class="tblheading">&nbsp;DoSR</td>
<td width="350"  align="left" valign="middle" class="tblheading">&nbsp;QC Status</td>
...
<td align="right"  valign="middle" class="tbltext"><input type="checkbox" name="loc" value="<?php echo $row['tid'];?>" onclick="clk(this.value);" />&nbsp;</td>
<td align="left"  valign="middle" class="tbltext" >&nbsp;<?php echo $row['oldlot'];?></td>
<td align="left"  valign="middle" class="tbltext" >&nbsp;<?php echo $sampno;?><input type="hidden" name="smpno" value="<?php echo $row['oldlot'];?>" /></td>
<td align="left"  valign="middle" class="tbltext" >&nbsp;<?php echo $row['trstage'];?></td>
<td align="left"  valign="middle" class="tbltext" >&nbsp;<?php echo $dosr;?></td>
<td align="left"  valign="middle" class="tbltext" >&nbsp;<?php echo $row['qcstatus'];?></td>
</tr>
<?php
}
else
