...
<title>QC Manager-Transaction Super Soft Release - LSRN</title>
...
<table width="750" height="282" border="0" align="center" cellpadding="0" cellspacing="0" >
 ...
 <?php 
$tid=$pid;
$sql_tbl=mysqli_query($link,"select * from tbl_softr2 where softr_id='".$tid."'") or die(mysqli_error($link));
