<?php
	...
	//exit;
		...
		{
			$sql_main="insert into tbl_densitydata (density_date, density_crop, density_variety, density_orlot, density_clotno, density_consampleno, density_conwtdate, density_consampwt, density_conwtflg)values('$dt', '$txtcrop', '$txtvariety', '$txtlot1', '$clotno', '$samplenum', '$dt', '$txtdensity', '1')";
			// exit;
