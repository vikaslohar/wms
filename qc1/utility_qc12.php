...
if($reptyp=="lotno")
{ 
 $sql_arr_home=mysqli_query($link,"select * from tbl_qctest where  oldlot='$lotno' order by lotno,tid desc limit 0,1") or die(mysqli_error($link));
 $tot_arr_home=mysqli_num_rows($sql_arr_home);
}
else 
{
$sql_arr_home=mysqli_query($link,"select * from tbl_qctest where oldlot='$txtlot1' and crop='$txtcrop' and variety='$txtvariety'  order by lotno,tid desc limit 0,1") or die(mysqli_error($link));
$tot_arr_home=mysqli_num_rows($sql_arr_home);
}
