...
<?php
$sql_arr_home=mysqli_query($link,"select * from tbl_qctest where aflg=0 and bflg=0 and cflg=0 and qcflg=0 group by sampleno, yearid, trstage, plantcode order by srdate, sampleno, yearid asc") or die(mysqli_error($link));
// $sql_arr_home=mysqli_query($link,"select * from tbl_qctest where aflg=0 and bflg=0 and cflg=0 group by sampleno,trstage order by srdate, sampleno asc") or die(mysqli_error($link));
...
$details=$ddss; 
	...
	$details=$ddss.", ".$bags." | ".$qty.", ".$slocs."<br/>";
//}
}
