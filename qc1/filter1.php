...
while($row_tbl=mysqli_fetch_array($sql_tbl))
{
	...
	if(isset($_POST['frm_action'])=='submit')
	{
		...
		echo "<script>window.location='home_filter3.php?txtlot=$txtlot&txtcrop=$txtcrop&txtvariety=$txtvariety&pcode=$pcode&txt=$txt&txtlot2=$txtlot2&txtlot=$txtlot&reptyp=$reptyp&txtlot4=$txtlot4&ycodee=$ycode&txtlo=$txtlo&stcode=$stcode&stcode2=$stcode2'</script>";
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#d21704" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#d21704" style="border-bottom:solid; border-bottom-color:#d21704" >
	    <tr >
	      <td width="940" height="25">&nbsp;Transaction - QC Result Update - Search Lots</td>
	    </tr></table></td>
...
<table width="850" align="center" cellpadding="5" cellspacing="5" border="0" >
                  <tr >
                    <td valign="top" align="center"><a href="home_qc_update.php" tabindex="20"><img src="../images/back.gif" border="0"style="display:inline;cursor:hand;" /></a>&nbsp;<input name="Submit" type="image" src="../images/next.gif" alt="next Value"  border="0" style="display:inline;cursor:pointer;" onClick="return mySubmit();" />
