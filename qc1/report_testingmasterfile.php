<?php
	...
	if(isset($_POST['frm_action'])=='submit')
	{
		...
		if($sdate!="" && $edate!="")
		{
		echo "<script>window.location='report_testingmasterfile1.php?sdate=$sdate&edate=$edate&txtcrop=$cid&txtvariety=$itemid'</script>";
		}
		else
		 {?>
		 <script>
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#d21704" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#d21704" style="border-bottom:solid; border-bottom-color:#d21704" >
	    <tr >
	      <td width="813" height="30"class="Mainheading"  >Periodical Testing Data Report</td>
	    </tr></table></td>
	  </tr>
	  </table></td></tr>
          ...
          <tr>
            ...
            <td><table align="center" border="1" width="600" cellspacing="0" cellpadding="0" bordercolor="#d21704" style="border-collapse:collapse" >
                <tr class="tblsubtitle" height="25">
                  <td colspan="4" align="center" class="tblheading">Periodical Testing Data Report</td>
                </tr>
                <tr height="15">
...
?>
                <tr class="Dark" height="25">
                  <td width="32%" height="30" align="right" valign="middle" class="tblheading">&nbsp;Sample Request Period&nbsp;&raquo;&nbsp;&nbsp;&nbsp;From&nbsp;</td>
