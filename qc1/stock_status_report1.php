...
<title>QC Manager-Report - Stock Status Report as on <?php echo date("d-m-Y H:i:s"); ?></title>
...
winHandle=window.open('stock_status_report2.php?slchk='+slchk+'&slchk2='+slchk2+'&txtcrop='+itemid+'&txtvariety='+vv+'&sdate='+sdate,'WelCome','top=20,left=80,width=850,height=600,scrollbars=yes');
if(winHandle==null){
...
?>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#d21704" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#d21704" style="border-bottom:solid; border-bottom-color:#d21704" >
	    <tr >
	      <td width="813" height="25">Stock Status Report as on <?php echo $sdate; ?></td>
	    </tr></table></td>
	  </tr>
	  </table></td></tr>
