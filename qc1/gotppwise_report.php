<?php
	...
	if(isset($_POST['frm_action'])=='submit')
	{
		...
		$txtprodp=trim($_POST['txtprodp']);
		if($sdate!="" && $edate!="")
		{
			echo "<script>window.location='gotppwise_report1.php?sdate=$sdate&edate=$edate&txtprodp=$txtprodp'</script>";
		}
		else
		{
		?>
...
<title>Quality-Report - Production Person Wise GOT Status Report</title>
  ...
  <tr><td>
   <table width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#d21704" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#d21704" style="border-bottom:solid; border-bottom-color:#d21704" >
	    <tr>
	      <td width="813" height="30" class="Mainheading">&nbsp;Production Person Wise GOT Status Report</td>
	    </tr></table></td>
	  </tr>
	  </table></td></tr>
...
<table align="center" border="1" width="574" cellspacing="0" cellpadding="0" bordercolor="#d21704" style="border-collapse:collapse" >
                <tr class="tblsubtitle" height="25">
                  <td colspan="4" align="center" class="tblheading">Production Person Wise GOT Status Report</td>
                </tr>
                <tr height="15">
                  <td colspan="6" align="right" class="tblheading"><font color="#FF0000" >* </font>indicates required field&nbsp;</td>
                </tr>
                <tr class="Dark" height="25">
                  <td width="131" height="30" align="right" valign="middle" class="tblheading">&nbsp;Arrival&nbsp;Period&nbsp;&raquo;&nbsp;&nbsp;&nbsp;From&nbsp;</td>
...
<?php
$quer3=mysqli_query($link,"SELECT distinct pper FROM tblarrival_sub where pper IS NOT NULL order by pper Asc"); 
?>				
				 <tr class="Light" height="25">
<td width="264" align="right"  valign="middle" class="tblheading" colspan="2">Production Person&nbsp;</td>
<td width="304" colspan="2" align="left"  valign="middle" class="tbltext" >&nbsp;<select class="tbltext" name="txtprodp" style="width:170px;">
<option value="ALL" selected>--ALL--</option>
	<?php while($noticia = mysqli_fetch_array($quer3)) { ?>
		<option value="<?php echo $noticia['pper'];?>" />   
		<?php echo $noticia['pper'];?>
		<?php } ?>
	</select>
