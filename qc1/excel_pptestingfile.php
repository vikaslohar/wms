<?php
	...
	$dh="Periodical_Physical_Purity_Testing_Data_Report:".$tlp."_From_".$_REQUEST['sdate'];
	$datahead = array($dh);
	$datahead1 = array("Periodical_Physical_Purity_Testing_Data_Report-Period From ",$_REQUEST['sdate'],"  To ",$_REQUEST['edate']);
