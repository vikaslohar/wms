...
?>
<title>QC Manager-Report - Super Soft Release Report</title><table width="650" border="0" cellpadding="0" cellspacing="0" bordercolor="#ffffff" style="border-collapse:collapse" align="center">
<tr >
<td width="650" align="right">&nbsp;&nbsp;&nbsp;<img src="../images/Vista-printer.png" border="0" class="butn" height="29" width="35" alt="Print" style="display:inline;cursor:pointer;" onclick="javascript:window.print();" />&nbsp;&nbsp;<!--&nbsp;<a href="word_class.php?classification_id=<?php echo $classification_id?>"><img src="../images/mswordicon.jpg" border="0" class="butn" height="30" width="30" alt="Export to MS-Word" /></a>&nbsp;&nbsp;&-->&nbsp;<img src="../images/close_icon2.jpg" border="0" class="butn" height="30"  alt="Close" style="display:inline;cursor:pointer;" onClick="window.close()" /></td>
  ...
  <table align="center" border="0" cellspacing="0" cellpadding="0" width="650" style="border-collapse:collapse">
   <tr height="25" >
    <td align="center" class="subheading" style="color:#303918; " colspan="2">Super Soft Release Report</td>
  	</tr>
	<?php
	if($sftyp=="periodical")
	{
...
<?php
$sql2="select distinct softr_crop from tbl_softr2 where softr_tflg=1 ";	
...
{
	$sql3="select distinct softr_variety from tbl_softr2 where softr_tflg=1 and softr_crop='".$row_arrhome['softr_crop']."' ";	
...
$sql="select * from tbl_softr2 where softr_tflg=1 and softr_crop='".$row_arrhome['softr_crop']."' and softr_variety='".$rowarr_home['softr_variety']."' ";	
...
{
	$sql_tbl_sub=mysqli_query($link,"select * from tbl_softr_sub2 where softr_id='".$arrival_id."' and softrsub_srflg='1'") or die(mysqli_error($link));
}	
