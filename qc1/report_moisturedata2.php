<?php
	...
	$crp="ALL"; $ver="ALL"; 
	$qry="select Distinct (proslipmain_crop), proslipmain_variety from tbl_proslipmain where proslipmain_date <='".$edate."' and proslipmain_date >='".$sdate."' ";
...
if($txtpmcode!="ALL")
{	
$sql_rr=mysqli_query($link,"select distinct proslipmain_variety from tbl_proslipmain where proslipmain_crop='".$row_arr_home1['proslipmain_crop']."' and proslipmain_variety='".$row_arr_home1['proslipmain_variety']."' and proslipmain_promachcode='$txtpmcode'  and proslipmain_date<='$edate' and proslipmain_date>='$sdate' and proslipmain_tflag=1 order by proslipmain_id asc") or die(mysqli_error($link));
}
else
{
$sql_rr=mysqli_query($link,"select distinct proslipmain_variety from tbl_proslipmain where proslipmain_crop='".$row_arr_home1['proslipmain_crop']."' and proslipmain_variety='".$row_arr_home1['proslipmain_variety']."' and proslipmain_date<='$edate' and proslipmain_date>='$sdate' and proslipmain_tflag=1 order by proslipmain_id asc") or die(mysqli_error($link));
}
$tot_rr=mysqli_num_rows($sql_rr);

if($txtpmcode!="ALL")
{	
$sqlrr=mysqli_query($link,"select distinct pnpslipmain_variety from tbl_pnpslipmain where pnpslipmain_crop='".$row_arr_home1['proslipmain_crop']."' and pnpslipmain_variety='".$row_arr_home1['proslipmain_variety']."' and pnpslipmain_promachcode='$txtpmcode' and pnpslipmain_date<='$edate' and pnpslipmain_date>='$sdate' and pnpslipmain_tflag=1 order by pnpslipmain_id asc") or die(mysqli_error($link));
}
else
{
$sqlrr=mysqli_query($link,"select distinct pnpslipmain_variety from tbl_pnpslipmain where pnpslipmain_crop='".$row_arr_home1['proslipmain_crop']."' and pnpslipmain_variety='".$row_arr_home1['proslipmain_variety']."' and pnpslipmain_date<='$edate' and pnpslipmain_date>='$sdate' and pnpslipmain_tflag=1 order by pnpslipmain_id asc") or die(mysqli_error($link));
}
...
if($txtpmcode!="ALL")
{	
$sql_rr22=mysqli_query($link,"select * from tbl_proslipmain where proslipmain_variety='".$row_rr['proslipmain_variety']."' and proslipmain_date<='$edate' and proslipmain_date>='$sdate' and proslipmain_tflag=1 and proslipmain_promachcode='$txtpmcode'  order by proslipmain_id asc") or die(mysqli_error($link));
}
else
{
$sql_rr22=mysqli_query($link,"select * from tbl_proslipmain where proslipmain_variety='".$row_rr['proslipmain_variety']."' and proslipmain_date<='$edate' and proslipmain_date>='$sdate' and proslipmain_tflag=1 order by proslipmain_id asc") or die(mysqli_error($link));
}
...
while($row_rr22=mysqli_fetch_array($sql_rr22))
{
	...
	$sql_sel1="select * from tbl_rm_promac where promac_id='".$row_rr22['proslipmain_promachcode']."' order by promac_type";
	...
	$query_popr=mysqli_query($link,"SELECT * FROM tbl_rm_proopr where proopr_id='".$row_rr22['proslipmain_proopr']."'") or die("Error: " . mysqli_error($link));
...
$sql_issuetbl=mysqli_query($link,"select * from tbl_proslipsub where proslipmain_id='".$row_rr22['proslipmain_id']."' order by proslipsub_lotno asc") or die(mysqli_error($link)); 
...
<table width="850" border="0" cellpadding="0" cellspacing="0" bordercolor="#ffffff" style="border-collapse:collapse" align="center">
<tr >
<td width="924" align="right">&nbsp;&nbsp;<img src="../images/Vista-printer.png" border="0" class="butn" height="29" width="35" alt="Print" style="display:inline;cursor:pointer;" onclick="javascript:window.print();" />&nbsp;<!--<a href="excel_moisturedata.php?txtcrop=<?php echo $crop;?>&sdate=<?php echo $_REQUEST['sdate'];?>&edate=<?php echo $_REQUEST['edate'];?>&txtvariety=<?php echo $variety;?>" target="_blank"><img src="../images/excelicon1.jpg" border="0" height="30" width="30" class="butn" alt="Export to Excel" style="display:inline;cursor:pointer;" /></a>-->&nbsp;<img src="../images/close_icon2.jpg" border="0" class="butn" height="30"  alt="Close" style="display:inline;cursor:pointer;" onClick="window.close()" />&nbsp;</td>
</tr>
</table>