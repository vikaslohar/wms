...
<tr >
<td width="850" align="right">&nbsp;&nbsp;<img src="../images/Vista-printer.png" border="0" class="butn" height="29" width="35" alt="Print" style="display:inline;cursor:pointer;" onclick="javascript:window.print();" />&nbsp;&nbsp;<a href="excel-prodperwpsr.php?txtcrop=<?php echo $crop;?>&sdate=<?php echo $_REQUEST['sdate'];?>&edate=<?php echo $_REQUEST['edate'];?>&txtvariety=<?php echo $_REQUEST['txtvariety'];?>&txtpmcode=<?php echo $_REQUEST['txtpmcode'];?>&txtprodper=<?php echo $_REQUEST['txtprodper'];?>" target="_blank"><img src="../images/excelicon1.jpg" border="0" height="30" width="30" class="butn" alt="Export to Excel" style="display:inline;cursor:pointer;" /></a>&nbsp;&nbsp;<img src="../images/close_icon2.jpg" border="0" class="butn" height="30"  alt="Close" style="display:inline;cursor:pointer;" onclick="window.close()" /></a>&nbsp;</td>
</tr>
</table>
  <table align="center" border="1" cellspacing="0" cellpadding="0" width="850" style="border-collapse:collapse">
   <tr class="Dark" height="25" >
    <td align="center" class="subheading" style="color:#303918; " colspan="3">Production Personnel wise Processing Status Report - As on Date: <?php echo date("d-m-Y");?></td>
  	</tr>
	<tr class="Dark" height="25">
...
$sql="select * from tbl_proslipmain where proslipmain_date <='".$edate."' and proslipmain_date >='".$sdate."' ";
	if($crop!="ALL")
	{	
		$sql.=" and proslipmain_crop='".$crop."'";
	}
	if($variety!="ALL")
	{	
		$sql.=" and proslipmain_variety='".$variety."' ";
	}		
		 $sql.=" order by proslipmain_date asc";
...
<?php
$qry="select arrival_id, arrival_date from tblarrival where arrival_date <='".$edate."' and arrival_date >='".$sdate."' and arrival_type='Fresh Seed with PDN' and arrtrflag=1 and arrival_id IN($arid)";
...
<tr class="tblsubtitle" height="20">
  ...
  <td width="50" align="center" valign="middle" class="smalltblheading" >Days</td>
			...
			<td width="105" align="center" valign="middle" class="smalltblheading">Organizer</td>
...
{	
	$sql_rr=mysqli_query($link,"select * from tblarrival_sub where arrival_id='".$row_arr_home1['arrival_id']."' and lotcrop='".$crp."' and lotvariety='".$ver."' and organiser='".$txtpmcode."' and sstage='Raw' order by orlot asc") or die(mysqli_error($link));
}
if($crop!="ALL" && $variety=="ALL")
{	
	$sql_rr=mysqli_query($link,"select * from tblarrival_sub where arrival_id='".$row_arr_home1['arrival_id']."' and lotcrop='".$crp."' and organiser='".$txtpmcode."' and sstage='Raw' order by orlot asc") or die(mysqli_error($link));
}

if($crop=="ALL" && $variety=="ALL")
{	
	$sql_rr=mysqli_query($link,"select * from tblarrival_sub where arrival_id='".$row_arr_home1['arrival_id']."' and organiser='".$txtpmcode."' and sstage='Raw' order by orlot asc") or die(mysqli_error($link));
}
else
{
	$sql_rr=mysqli_query($link,"select * from tblarrival_sub where arrival_id='".$row_arr_home1['arrival_id']."' and organiser='".$txtpmcode."' and sstage='Raw' order by orlot asc") or die(mysqli_error($link));
...
<table width="850" border="0" cellpadding="0" cellspacing="0" bordercolor="#ffffff" style="border-collapse:collapse" align="center">
<tr >
<td width="924" align="right">&nbsp;&nbsp;<img src="../images/Vista-printer.png" border="0" class="butn" height="29" width="35" alt="Print" style="display:inline;cursor:pointer;" onclick="javascript:window.print();" />&nbsp;&nbsp;<a href="excel-prodperwpsr.php?txtcrop=<?php echo $crop;?>&sdate=<?php echo $_REQUEST['sdate'];?>&edate=<?php echo $_REQUEST['edate'];?>&txtvariety=<?php echo $_REQUEST['txtvariety'];?>&txtpmcode=<?php echo $_REQUEST['txtpmcode'];?>&txtprodper=<?php echo $_REQUEST['txtprodper'];?>" target="_blank"><img src="../images/excelicon1.jpg" border="0" height="30" width="30" class="butn" alt="Export to Excel" style="display:inline;cursor:pointer;" /></a>&nbsp;&nbsp;<img src="../images/close_icon2.jpg" border="0" class="butn" height="30"  alt="Close" style="display:inline;cursor:pointer;" onClick="window.close()" />&nbsp;</td>
</tr>
</table>