...
$sql_tbl_sub=mysqli_query($link,"select distinct(orlot) from tbl_lot_ldg where lotldg_crop='".$crop."' and lotldg_variety='".$variety."' and lotldg_balqty > 0 and lotldg_sstage ='Raw' $sss")or die(mysqli_error($link));
...
$totarrhome=0;
$sqlarrhome=mysqli_query($link,"select * from tbl_densitydata where density_orlot='".$row['orlot']."' ") or die(mysqli_error($link));
