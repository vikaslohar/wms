...
<tr class="tblsubtitle" height="20">
	...
	<td align="center" valign="middle" class="smalltblheading" colspan="3" >Moisture Test Report</td>
	<td align="center" valign="middle" class="smalltblheading" colspan="8" >Physical Purity Test Report</td>
...
<tr class="tblsubtitle" height="20">
	<td width="4%" align="center" valign="middle" class="smalltblheading" >(%) By Meter</td>
	<td width="2%" align="center" valign="middle" class="smalltblheading" >(%) By oven</td>
	<td width="5%" align="center" valign="middle" class="smalltblheading" >Date of Test </td>
	<td width="3%" align="center" valign="middle" class="smalltblheading" >Pure Seed %</td>
	<td width="3%" align="center" valign="middle" class="smalltblheading" >Inert Matter %</td>
	<td width="3%" align="center" valign="middle" class="smalltblheading" >Light Seed %</td>
	<td width="3%" align="center" valign="middle" class="smalltblheading" >OCS Nos./ Kg</td>
	<td width="4%" align="center" valign="middle" class="smalltblheading" >ODV Nos./ Kg</td>
	<td width="4%" align="center" valign="middle" class="smalltblheading" >Discoloured Seed %</td>
	<td width="4%" align="center" valign="middle" class="smalltblheading" >Pin hole Nos./ Kg</td>
...
//exit;	
	...
	$qry.=" order by tid desc ";
	//echo $qry; echo "<br />";
	$sql_arr_home1=mysqli_query($link,$qry) or die(mysqli_error($link));
	$tot_arr_home=mysqli_num_rows($sql_arr_home1);


$row_arr_home1=mysqli_fetch_array($sql_arr_home1);
{
...
<tr class="Light">
	...
	<td align="center" valign="middle" class="smalltbltext"><?php echo $pppureseed;?></td>
	<td align="center" valign="middle" class="smalltbltext"><?php echo $ppim;?></td>
	<td align="center" valign="middle" class="smalltbltext"><?php echo $ppls?></td>
	<td align="center" valign="middle" class="smalltbltext"><?php echo $ppocs?></td>
	<td align="center" valign="middle" class="smalltbltext"><?php echo $ppodv;?></td>
	<td align="center" valign="middle" class="smalltbltext"><?php echo $ppdisc;?></td>
	<td align="center" valign="middle" class="smalltbltext"><?php echo $ppph;?></td>
