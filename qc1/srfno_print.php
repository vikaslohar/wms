...
$sql1=mysqli_query($link,"select * from tbl_qcsrf where srf_srfno='$pid'")or die(mysqli_error($link));
$srftotno=mysqli_num_rows($sql1);
...
<tr  height="20">
  <td colspan="6" align="center" class="Mainheading"><font color="#000000">SEED  ANALYSIS REQUEST FORM (SRF)</font></td>
</tr>
...
$sql_sub=mysqli_query($link,"select * from tbl_qcsrf where srf_srfno='$trid' order by srf_id asc") or die(mysqli_error($link));
...
$zzz=str_split($row_sub['srf_lotno']);
...
<td width="50%" align="left"  valign="middle" class="smalltbltext">&nbsp;No. of Samples&nbsp;<b><?php echo $srftotno;?></b></td>
<td width="50%" align="right"  valign="middle" class="smalltblheading">&nbsp;Accompanying Lots No. of Samples Tallied: YES/NO&nbsp;</td>
</tr></table><br />

<table align="center" border="0" width="750" cellspacing="0" cellpadding="0" bordercolor="#d21704" style="border-collapse:collapse" >
<tr class="Light" height="30">
<td width="60%" align="left"  valign="middle" class="smalltblheading">&nbsp;Sample Drawn By&nbsp;_________________________________________________________</td>
<td width="40%" align="center"  valign="middle" class="smalltbltext">&nbsp;Name & Signature&nbsp;</td>
</tr></table>

<table align="center" border="0" width="750" cellspacing="0" cellpadding="0" bordercolor="#d21704" style="border-collapse:collapse" >
<tr class="Light" height="30">
<td width="100%" align="left"  valign="middle" class="smalltblheading">&nbsp;Sample Collected By&nbsp;_______________________________________________________</td>
</tr></table>
<br />

<table align="left" border="1" width="300" cellspacing="0" cellpadding="0" bordercolor="#d21704" style="border-collapse:collapse" >
<tr class="Light" height="20">
<td width="5%" align="left"  valign="middle" class="smalltblheading">&nbsp;M&nbsp;</td>
<td width="53%" align="left"  valign="middle" class="smalltbltext">&nbsp;Moisture</td>
<td width="4%" align="left"  valign="middle" class="smalltblheading">&nbsp;R&nbsp;</td>
<td width="38%" align="left"  valign="middle" class="smalltbltext">&nbsp;Raw Seed</td>
</tr>
<tr class="Light" height="20">
<td width="5%" align="left"  valign="middle" class="smalltblheading">&nbsp;GOT&nbsp;</td>
<td width="53%" align="left"  valign="middle" class="smalltbltext">&nbsp;Grow Out Test</td>
<td width="4%" align="left"  valign="middle" class="smalltblheading">&nbsp;C&nbsp;</td>
<td width="38%" align="left"  valign="middle" class="smalltbltext">&nbsp;Clean Seed</td>
</tr>
<tr class="Light" height="20">
<td width="5%" align="left"  valign="middle" class="smalltblheading">&nbsp;G&nbsp;</td>
<td width="23%" align="left"  valign="middle" class="smalltbltext">&nbsp;Germination</td>
<td width="4%" align="left"  valign="middle" class="smalltblheading">&nbsp;P&nbsp;</td>
<td width="38%" align="left"  valign="middle" class="smalltbltext">&nbsp;Pack Seed</td>
</tr>
<tr class="Light" height="20">
<td width="5%" align="left"  valign="middle" class="smalltblheading">&nbsp;P&nbsp;</td>
<td width="23%" align="left"  valign="middle" class="smalltbltext">&nbsp;Purity</td>
<td width="4%" align="left"  valign="middle" class="smalltblheading">&nbsp;SR&nbsp;</td>
<td width="38%" align="left"  valign="middle" class="smalltbltext">&nbsp;Sales Return</td>
</tr>
</table>
