...
<title>Quality-Report - Comprehensive GOT Data Report (In Terra)</title>
...
function openprint(srno)
{
	if(srno>1)
	{
		...
		winHandle=window.open('report_gotdatainterra2.php?sdate='+sdate+'&edate='+edate,'WelCome','top=20,left=80,width=1000,height=950,scrollbars=yes');
		if(winHandle==null){
...
function opendata(trid)
{
	if(srno>1)
	{
		var sdate=document.frmaddDepartment.sdate.value;
		var edate=document.frmaddDepartment.edate.value;
		winHandle=window.open('getuser_gotdatarep.php?sdate='+sdate+'&edate='+edate+'trid='+trid,'WelCome','top=20,left=80,width=1000,height=950,scrollbars=yes');
		if(winHandle==null){
		alert("While Launching New Window...\nYour browser maybe blocking up Popup windows. \n\n  Please check your Popup Blocker Settings or ..\n Please hold Ctrl Key and Click on link to open new Browser"); } 
	}
	else
  ...
  <tr><td>
   ...
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#d21704" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#d21704" style="border-bottom:solid; border-bottom-color:#d21704" >
	    <tr >
	      <td width="813" height="25">&nbsp;Comprehensive GOT Data Report (In Terra)</td>
	    </tr></table></td>
	  </tr>
	  </table></td></tr>
...
<tr >
<td height="49" align="center" valign="top"><a href="report_gotdatainterra.php"><img src="../images/back.gif" border="0"  style="display:inline;cursor:pointer;"/></a>&nbsp;&nbsp;<img src="../images/printpreview.gif" onclick="openprint('<?php echo $srno;?>')" style="cursor:pointer" border="0" />
