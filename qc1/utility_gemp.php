...
<title>Quality- Utility - Lot Biography</title>
...
$sql_lotldg=mysqli_query($link,"Select * from tbl_lot_ldg where orlot='".$lotno."'") or die(mysqli_error($link));
$tot_lotldg=mysqli_num_rows($sql_lotldg);
$row_lotldg=mysqli_fetch_array($sql_lotldg);

$sql_lotldgpack=mysqli_query($link,"Select * from tbl_lot_ldg_pack where orlot='".$lotno."'") or die(mysqli_error($link));
$tot_lotldgpack=mysqli_num_rows($sql_lotldgpack);
$row_lotldgpack=mysqli_fetch_array($sql_lotldgpack);

$sql_whouse=mysqli_query($link,"select * from tblarrival_sub where orlot='".$lotno."'") or die(mysqli_error($link));
...
$got=$row_whouse['got1'];
?>	  
<table align="center" border="1" bordercolor="#d21704" cellspacing="0" cellpadding="0" width="800" style="border-collapse:collapse">
...
<tr class="tblsubtitle" height="20">
  ...
  <?php
 $sql_arr_home=mysqli_query($link,"select * from tbl_qctest where oldlot='$lotno' order by oldlot,tid desc limit 0,1") or die(mysqli_error($link));
...
$sqltbl=mysqli_query($link,"select * from tbl_lot_ldg_pack where orlot='".$lotno."' and lotdgp_id='".$rowtbl12[0]."'") or die(mysqli_error($link));
...
<?php
$sql_lotldg=mysqli_query($link,"Select * from tbl_lot_ldg where orlot='".$lotno."' order by lotldg_id desc") or die(mysqli_error($link));
$row_lotldg=mysqli_fetch_array($sql_lotldg);
...
$got=$row_whouse['got1'];
?>
<table align="center" border="0" bordercolor="#d21704" cellspacing="0" cellpadding="0" width="800" style="border-collapse:collapse">
...
$dt="";
$sql_tbl333=mysqli_query($link,"select * from tbl_qctest where oldlot='".$lotno."' group by testdate order by testdate desc, tid desc") or die(mysqli_error($link));
...
$sql_pp333=mysqli_query($link,"select * from tbl_pmupdate where lotno='".$lotno."'  order by pmup_id desc") or die(mysqli_error($link));
...
?>
<table align="center" border="0" cellspacing="0" cellpadding="0" width="800" bordercolor="#d21704" style="border-collapse:collapse">
...
$srno=1;
  ...
  if($dval<>"")
  {
  $sql_tbl=mysqli_query($link,"select * from tbl_qctest where oldlot='".$lotno."' and srdate='".$dval."'group by testdate order by srdate desc, tid desc") or die(mysqli_error($link));
...
<tr class="tblsubtitle" height="20">
	...
	<td width="97" align="center" valign="middle" class="tblheading">Mean GP %</td>
...
<tr class="Dark" height="25">
	<td width="72" align="center" valign="middle" class="tblheading">Repl No</td>
	<td width="191" align="center" valign="middle" class="tblheading">Sample Reciept Date</td>
	<td width="199" align="center" valign="middle" class="tblheading">DNA Extraction Date</td>
	<td width="180" align="center" valign="middle" class="tblheading">DNA Extracted From</td>
	<td align="center" valign="middle" class="tblheading" colspan="2">DNA Extraction Method</td>
	<td width="90" align="center" valign="middle" class="tblheading">Sample Age</td>
</tr>
<?php
$replsitu=1;
...
<?php $step2="PCR";?>
<tr class="Dark" height="25">
	<td width="36" align="center" valign="middle" class="tblheading" rowspan="2">#</td>
...
<tr class="Dark" height="25">
	...
	<td align="center" valign="middle" class="tblheading">Hybrid</td>
</tr>
<?php
$sql_s1=mysqli_query($link,"select * from tbl_gottestsub where gottest_tid='".$gotmid."' and gottests_type='IN-SITU'") or die(mysqli_error($link));
$rows1=mysqli_fetch_array($sql_s1);
...
<tr class="Dark" height="25">
	<td width="116" align="center" valign="middle" class="tblheading">#</td>
...
<?php 
if($crop=="Maize" || $crop=="Pearl Millet")
{
?>
<table align="center" border="1" width="800" cellspacing="0" cellpadding="0" bordercolor="#d21704" style="border-collapse:collapse" >
<tr class="tblsubtitle" height="20">
...
<td width="17" align="center" valign="middle" class="tblheading">Repl No</td>
...
<td width="17" align="center" valign="middle" class="tblheading" rowspan="2">Repl No</td>
...
<tr height="25" class="tblsubtitle" >
    <td align="center" class="subheading" style="color:#303918; " rowspan="2">GOT Result Data</td>
	 <td align="center" class="subheading" style="color:#303918; " colspan="2">Repl. #1</td>
	 <td align="center" class="subheading" style="color:#303918; " colspan="2">Repl. #2</td>
	 <td align="center" class="subheading" style="color:#303918; " colspan="2">Repl. #3</td>
	 <td align="center" class="subheading" style="color:#303918; " colspan="2">Repl. #4</td>
</tr>
<tr height="20" class="tblsubtitle" >
	<td width="97" align="center" valign="middle" class="tblheading">GP %</td>
	<td width="99" align="center" valign="middle" class="tblheading">CMC</td>
	<td width="97" align="center" valign="middle" class="tblheading">GP %</td>
	<td width="99" align="center" valign="middle" class="tblheading">CMC</td>
	<td width="97" align="center" valign="middle" class="tblheading">GP %</td>
	<td width="99" align="center" valign="middle" class="tblheading">CMC</td>
...
<?php
$srno=1;
$sql_tbl_sub=mysqli_query($link,"select distinct(lotldg_sstage) from tbl_lot_ldg where orlot='".$lotno."'")or die(mysqli_error($link));
$ct1=mysqli_num_rows($sql_tbl_sub);
while($row_tbl_sub=mysqli_fetch_array($sql_tbl_sub))
{
$nob=0; $qty=0; $wareh=""; $binn=""; $subbinn=""; $sups="";$sqty=0; $slocs=""; $slocs2=""; $srn=1;
$sql_qc_sub=mysqli_query($link,"SELECT distinct(lotldg_subbinid), lotldg_binid, lotldg_whid FROM tbl_lot_ldg WHERE orlot='".$lotno."' and lotldg_sstage='".$row_tbl_sub['lotldg_sstage']."'");
$tt_sub=mysqli_num_rows($sql_qc_sub);
while($row_qc_sub=mysqli_fetch_array($sql_qc_sub))
{

$sql_qc=mysqli_query($link,"SELECT max(lotldg_id) FROM tbl_lot_ldg WHERE orlot='".$lotno."' and lotldg_sstage='".$row_tbl_sub['lotldg_sstage']."' and lotldg_subbinid='".$row_qc_sub['lotldg_subbinid']."'  and lotldg_binid='".$row_qc_sub['lotldg_binid']."'  and lotldg_whid='".$row_qc_sub['lotldg_whid']."'");
...
$sql_whouse=mysqli_query($link,"select perticulars from tbl_warehouse where whid='".$row_qc_sub['lotldg_whid']."'") or die(mysqli_error($link));
$row_whouse=mysqli_fetch_array($sql_whouse);
$wareh=$row_whouse['perticulars']."/";

$sql_binn=mysqli_query($link,"select binname from tbl_bin where binid='".$row_qc_sub['lotldg_binid']."' and whid='".$row_qc_sub['lotldg_whid']."'") or die(mysqli_error($link));
$row_binn=mysqli_fetch_array($sql_binn);
$binn=$row_binn['binname']."/";


$sql_subbinn=mysqli_query($link,"select sname from tbl_subbin where sid='".$row_qc_sub['lotldg_subbinid']."' and binid='".$row_qc_sub['lotldg_binid']."' and whid='".$row_qc_sub['lotldg_whid']."'") or die(mysqli_error($link));
...
$nob=0; $qty=0; $wareh=""; $binn=""; $subbinn=""; $sups="";$sqty=0; $slocs=""; $slocs2=""; $srn=1;
$sql_qc_sub=mysqli_query($link,"SELECT distinct(subbinid), binid, whid FROM tbl_lot_ldg_pack WHERE orlot='".$lotno."'");
$tt_sub=mysqli_num_rows($sql_qc_sub);
while($row_qc_sub=mysqli_fetch_array($sql_qc_sub))
{

$sql_qc=mysqli_query($link,"SELECT max(lotdgp_id) FROM tbl_lot_ldg_pack WHERE orlot='".$lotno."' and subbinid='".$row_qc_sub['subbinid']."'  and binid='".$row_qc_sub['binid']."'  and whid='".$row_qc_sub['whid']."'");
$tt=mysqli_num_rows($sql_qc);
while($row_qc=mysqli_fetch_array($sql_qc))
{
...
$lotnop=$lotno."P";
$opstk=""; 
$sql_lot=mysqli_query($link,"select * from tbl_lot_ldg where orlot='".$lotno."' order by lotldg_id limit 0,1") or die(mysqli_error($link));
...
//echo "select * from tbl_lot_ldg_pack where orlot='".$lotno."' order by lotldg_id asc";
	$sql_lot=mysqli_query($link,"select * from tbl_lot_ldg_pack where orlot='".$lotno."' order by lotdgp_id asc limit 0,1") or die(mysqli_error($link));
	$tot_lot=mysqli_num_rows($sql_lot);
	$row_lot=mysqli_fetch_array($sql_lot);
	$opstk=$row_lot['balqty'];
}
$discardqty=0; $totloss=0; $totbatch=0;
$sql_discard=mysqli_query($link,"select * from tbl_discard_sub where lotnumber='".$lotno."' order by did asc") or die(mysqli_error($link));
...
$dryloss=0;
$sql_dryloss=mysqli_query($link,"select * from tbl_dryingsub where lotno='".$lotnor."' order by subtrid asc") or die(mysqli_error($link));
$tot_dryloss=mysqli_num_rows($sql_dryloss);
if($tot_dryloss==0)
{
	$sql_dryloss=mysqli_query($link,"select * from tbl_dryingsub where lotno='".$lotnoc."' order by subtrid asc") or die(mysqli_error($link));
}
while($row_dryloss=mysqli_fetch_array($sql_dryloss))
{
	$sql_dryloss1=mysqli_query($link,"select * from tbl_dryingsubsub where subtrid='".$row_dryloss['subtrid']."' order by subsubid asc") or die(mysqli_error($link));
...
$sql_pakloss=mysqli_query($link,"select * from tbl_pnpslipsub where pnpslipsub_orlot='".$lotno."' order by pnpslipsub_id asc") or die(mysqli_error($link));
//$tot_dryloss=mysqli_num_rows($sql_dryloss);
...
$sql_proloss=mysqli_query($link,"select * from tbl_proslipsub where proslipsub_orlot='".$lotno."' order by proslipsub_id asc") or die(mysqli_error($link));
//$tot_dryloss=mysqli_num_rows($sql_dryloss);
...
$rvloss=0; $rvobatch=0;
$sql_rvloss=mysqli_query($link,"select * from tbl_revalidate where rv_lotno='".$lotnop."' order by rv_id asc") or die(mysqli_error($link));
//$tot_dryloss=mysqli_num_rows($sql_dryloss);
...
$sql_p2closs=mysqli_query($link,"select * from tbl_psunpp2c where unp_orlot='".$lotno."' order by unp_id asc") or die(mysqli_error($link));
$tot_p2closs=mysqli_num_rows($sql_p2closs);
while($row_p2closs=mysqli_fetch_array($sql_p2closs))
{
	$sql_p2closs1=mysqli_query($link,"select * from tbl_psunpp2c_sub where unp_id='".$row_p2closs['unp_id']."' order by unps_id asc") or die(mysqli_error($link));
...
$sql_lotldg=mysqli_query($link,"select * from tbl_lot_ldg where orlot='".$lotno."' order by lotldg_id asc") or die(mysqli_error($link));
$tot_lotldg=mysqli_num_rows($sql_lotldg);
//$row_lotldg=mysqli_fetch_array($sql_lotldg);
...
$sql_lotldgpak=mysqli_query($link,"select * from tbl_lot_ldg_pack where orlot='".$lotno."' order by lotdgp_id asc") or die(mysqli_error($link));
...
$sql_allocss=mysqli_query($link,"select * from tbl_dallocsub_sub where dallocss_lotno='".$lotnop."' order by dallocss_id asc") or die(mysqli_error($link));
$alloups="";
while($row_allocss=mysqli_fetch_array($sql_allocss))
{
	if($row_allocss['dallocs_id']!=$allocssid)
	{
		$sql_allocs=mysqli_query($link,"select * from tbl_dalloc_sub where dallocs_id='".$row_allocss['dallocs_id']."' and dallocs_ups='".$row_allocss['dallocss_ups']."' and dallocs_dflg=0 order by dallocs_id asc") or die(mysqli_error($link));
		$tot_allocs=mysqli_num_rows($sql_allocs);
		$row_allocs=mysqli_fetch_array($sql_allocs);
		
		if($tot_allocs>0)
		{
			$sql_allocss2=mysqli_query($link,"select * from tbl_dallocsub_sub where dallocs_id='".$row_allocs['dallocs_id']."' and dallocss_ups='".$row_allocs['dallocs_ups']."' and dallocss_lotno='".$lotnop."' order by dallocss_id asc") or die(mysqli_error($link));
...
$sql_stock=mysqli_query($link,"select distinct subbinid from tbl_lot_ldg_pack where lotno='".$lotnop."'") or die(mysqli_error($link));
...
//echo "select MAX(lotdgp_id) from tbl_lot_ldg_pack where lotno='".$lotnop."' and subbinid='".$row_stock['subbinid']."'";
	$sql_stock1=mysqli_query($link,"select MAX(lotdgp_id) from tbl_lot_ldg_pack where lotno='".$lotnop."' and subbinid='".$row_stock['subbinid']."'") or die(mysqli_error($link));
	$row_stock1=mysqli_fetch_array($sql_stock1);
	//echo "select * from tbl_lot_ldg_pack where lotno='".$lotnop."' and lotdgp_id='".$row_stock1[0]."'";
	$sql_stock12=mysqli_query($link,"select * from tbl_lot_ldg_pack where lotno='".$lotnop."' and lotdgp_id='".$row_stock1[0]."'") or die(mysqli_error($link));
...
{
	$sql_stock=mysqli_query($link,"select distinct lotldg_subbinid from tbl_lot_ldg where orlot='".$lotno."' order by lotldg_id asc") or die(mysqli_error($link));
	while($row_stock=mysqli_fetch_array($sql_stock))
	{
	$sql_stock1=mysqli_query($link,"select MAX(lotldg_id) from tbl_lot_ldg where orlot='".$lotno."' and lotldg_subbinid='".$row_stock['lotldg_subbinid']."'") or die(mysqli_error($link));
	$row_stock1=mysqli_fetch_array($sql_stock1);
	
	$sql_stock12=mysqli_query($link,"select * from tbl_lot_ldg where orlot='".$lotno."' and lotldg_id='".$row_stock1[0]."'") or die(mysqli_error($link));
	$row_stock12=mysqli_fetch_array($sql_stock12);
...
$sql_tb1=mysqli_query($link,"select * from tblarrival where arrival_id='".$row_whouse['arrival_id']."'")or die(mysqli_error($link));
...
$pp=$vchk;
	...
	$nob=0; $qty=0;
	$sql_tbl=mysqli_query($link,"select * from tblarr_sloc where arr_id='".$row_whouse['arrsub_id']."' and arr_tr_id='".$row_whouse['arrival_id']."'")or die(mysqli_error($link));
...
$sql_whouse1=mysqli_query($link,"select * from tblarrival_sub where orlot='".$plotno1."'") or die(mysqli_error($link));
while($row_whouse1=mysqli_fetch_array($sql_whouse1))
{
$sql_tb2=mysqli_query($link,"select * from tblarrival where arrival_id='".$row_whouse1['arrival_id']."'")or die(mysqli_error($link));
$row_tb2=mysqli_fetch_array($sql_tb2);
	...
	$sql_tb3=mysqli_query($link,"select * from tblarr_sloc where arr_id='".$row_whouse1['arrsub_id']."'")or die(mysqli_error($link));
...
<?php 
	...
	$sql_ssrv=mysqli_query($link,"select * from tbl_salesrv_sub where salesrs_orlot='".$lotno1."'") or die(mysqli_error($link));
	$tot_ssrv=mysqli_num_rows($sql_ssrv);
	$row_ssrv=mysqli_fetch_array($sql_ssrv);
	$sql_ssr=mysqli_query($link,"select * from tbl_salesr_sub where salesrs_orlot='".$lotno1."'") or die(mysqli_error($link));
	$tot_ssr=mysqli_num_rows($sql_ssr);
	$row_ssr=mysqli_fetch_array($sql_ssr);
	
	if($tot_ssrv>0)
	{
		$sql_ssrv_main=mysqli_query($link,"select * from tbl_salesrv where salesr_id='".$row_ssrv['salesr_id']."'")or die(mysqli_error($link));
	...
	else if($tot_ssr>0)
	{
		...
		$sql_ssr_main=mysqli_query($link,"select * from tbl_salesr where salesr_id='".$row_ssr['salesr_id']."'")or die(mysqli_error($link));
...
<?php 
	...
	$sql_blend=mysqli_query($link,"select * from tbl_blends where blends_lotno='".$lotnoc."' and blends_sstatus=1 and blends_delflg=0") or die(mysqli_error($link));
	...
	else
	{
		...
		$sql_merg=mysqli_query($link,"select * from tbl_mergersub where mergers_lotno='".$lotno1."'") or die(mysqli_error($link));
		$tot_merg=mysqli_num_rows($sql_merg);
		$row_merg=mysqli_fetch_array($sql_merg);
		
		$sql_mergr=mysqli_query($link,"select * from tbl_mergersub where mergers_lotno='".$lotnor."'") or die(mysqli_error($link));
		$tot_mergr=mysqli_num_rows($sql_mergr);
		$row_mergr=mysqli_fetch_array($sql_mergr);
		
		$sql_mergc=mysqli_query($link,"select * from tbl_mergersub where mergers_lotno='".$lotnoc."'") or die(mysqli_error($link));
		$tot_mergc=mysqli_num_rows($sql_mergc);
		$row_mergc=mysqli_fetch_array($sql_mergc);
		
		if($tot_merg>0)
		{
			$sql_mergm=mysqli_query($link,"select * from tbl_mergermain where mergerm_id='".$row_merg['mergerm_id']."'") or die(mysqli_error($link));
		...
		{
			$sql_mergm=mysqli_query($link,"select * from tbl_mergermain where mergerm_id='".$row_mergr['mergerm_id']."'") or die(mysqli_error($link));
			$row_mergm=mysqli_fetch_array($sql_mergm);
			$sta="YES";
			$newblendedlot=$row_mergm['mergerm_newlot'];
		}
		else if($tot_mergc>0)
		{
			...
			$sql_mergm=mysqli_query($link,"select * from tbl_mergermain where mergerm_id='".$row_mergc['mergerm_id']."'") or die(mysqli_error($link));
			$row_mergm=mysqli_fetch_array($sql_mergm);
			$sta="YES";
			$newblendedlot=$row_mergm['mergerm_newlot'];
		}
...
<?php 
	...
	$sql_blend1=mysqli_query($link,"select * from tbl_blends where blends_orlot='".$orlot1."' and blends_sstatus=1 and blends_delflg=0") or die(mysqli_error($link));
	$tot_blend1=mysqli_num_rows($sql_blend1);
	$sql_mergm2=mysqli_query($link,"select * from tbl_mergermain where mergerm_orlot='".$orlot1."'") or die(mysqli_error($link));
...
{
	$sql_mergs2=mysqli_query($link,"select distinct mergers_lotno from tbl_mergersub where mergerm_id='".$row_mergm2['mergerm_id']."'") or die(mysqli_error($link));
...
<?php 
	//echo "select * from tbl_blends where blends_newlot='".$orlot1."'";
	$sql_blend1=mysqli_query($link,"select * from tbl_blends where blends_orlot='".$lotno1."' and blends_sstatus=1 and blends_delflg=0") or die(mysqli_error($link));
	$tot_blend1=mysqli_num_rows($sql_blend1);
	$sql_mergm2=mysqli_query($link,"select * from tbl_mergermain where mergerm_orlot='".$lotno1."'") or die(mysqli_error($link));
	$tot_mergm2=mysqli_num_rows($sql_mergm2);
	$row_mergm2=mysqli_fetch_array($sql_mergm2);
	if($tot_blend1>0)
	{
...
<?php 
	...
	$sql_dry=mysqli_query($link,"SELECT distinct lotldg_lotno FROM `tbl_lot_ldg` WHERE `orlot`='".$lotno1."' and `lotldg_trtype`='DRYSUC'") or die(mysqli_error($link));
...
<?php
	...
	$sql_drys=mysqli_query($link,"select * from tbl_dryingsub where lotno='".$row_dry['lotldg_lotno']."'")or die(mysqli_error($link));
	$tot_drys=mysqli_num_rows($sql_drys);
	while($row_drys=mysqli_fetch_array($sql_drys))
	{
		$sql_drym=mysqli_query($link,"SELECT * FROM tbl_drying WHERE trid='".$row_drys['trid']."'")or die(mysqli_error($link));
		$row_drym=mysqli_fetch_array($sql_drym);
		
		$sql_dryss=mysqli_query($link,"SELECT * FROM tbl_dryingsubsub WHERE subtrid='".$row_drys['subtrid']."'")or die(mysqli_error($link));
...
<?php 
	...
	$sql_pro=mysqli_query($link,"select * from tbl_proslipsub where proslipsub_orlot='".$lotno1."' order by proslipsub_id asc") or die(mysqli_error($link));
	$tot_pro=mysqli_num_rows($sql_pro);
	$row_pro=mysqli_fetch_array($sql_pro);
	
	$sql_pro_main=mysqli_query($link,"select * from tbl_proslipmain where proslipmain_id='".$row_pro['proslipmain_id']."'")or die(mysqli_error($link));
	$row_pro_main=mysqli_fetch_array($sql_pro_main);
	
	$sql_promac=mysqli_query($link,"select * from tbl_rm_promac where promac_id='".$row_pro_main['proslipmain_promachcode']."'")or die(mysqli_error($link));
	$row_promac=mysqli_fetch_array($sql_promac);
	
	$sql_proopr=mysqli_query($link,"select * from tbl_rm_proopr where proopr_id='".$row_pro_main['proslipmain_proopr']."'")or die(mysqli_error($link));
	$row_proopr=mysqli_fetch_array($sql_proopr);
	
	$sql_treat=mysqli_query($link,"select * from tbl_rm_treattype where treatt_type='".$row_pro_main['proslipmain_treattype']."'")or die(mysqli_error($link));
...
<?php 
	$sql_repro=mysqli_query($link,"select * from tbl_proslipsub where proslipsub_orlot='".$lotno1."' and proslipsub_id!='".$row_pro['proslipsub_id']."'") or die(mysqli_error($link));
...
<?php 
	...
	$sql_pnp=mysqli_query($link,"select * from tbl_pnpslipsub where pnpslipsub_plotno='".$lotp."' ORDER BY pnpslipsub_id ASC") or die(mysqli_error($link));
	$tot_pnp=mysqli_num_rows($sql_pnp);
	$row_pnp=mysqli_fetch_array($sql_pnp);
	$sql_pnpm=mysqli_query($link,"select * from tbl_pnpslipmain where pnpslipmain_id='".$row_pnp['pnpslipmain_id']."'") or die(mysqli_error($link));
	$row_pnpm=mysqli_fetch_array($sql_pnpm);
	
	$sql_promac1=mysqli_query($link,"select * from tbl_rm_promac where promac_id='".$row_pnpm['pnpslipmain_promachcode']."'")or die(mysqli_error($link));
	$row_promac1=mysqli_fetch_array($sql_promac1);
	
	$sql_proopr1=mysqli_query($link,"select * from tbl_rm_proopr where proopr_id='".$row_pnpm['pnpslipmain_proopr']."'")or die(mysqli_error($link));
...
<?php 
	//$lotp=$lotno1."P";
	//echo "select * from tbl_pnpslipsub where pnpslipsub_plotno='".$lotp."' ORDER BY pnpslipsub_id ASC";
	$sql_pnp1=mysqli_query($link,"select * from tbl_pnpslipsub where pnpslipsub_plotno='".$lotp."' and  pnpslipsub_id!='".$row_pnp['pnpslipsub_id']."' ORDER BY pnpslipsub_id ASC") or die(mysqli_error($link));
	$tot_pnp1=mysqli_num_rows($sql_pnp1);
	$row_pnp1=mysqli_fetch_array($sql_pnp1);
	$sql_pnpm1=mysqli_query($link,"select * from tbl_pnpslipmain where pnpslipmain_id='".$row_pnp1['pnpslipmain_id']."'") or die(mysqli_error($link));
	$row_pnpm1=mysqli_fetch_array($sql_pnpm1);
	
	$sql_promac11=mysqli_query($link,"select * from tbl_rm_promac where promac_id='".$row_pnpm1['pnpslipmain_promachcode']."'")or die(mysqli_error($link));
	$row_promac11=mysqli_fetch_array($sql_promac11);
	
	$sql_proopr11=mysqli_query($link,"select * from tbl_rm_proopr where proopr_id='".$row_pnpm1['pnpslipmain_proopr']."'")or die(mysqli_error($link));
...
$sql_packrv=mysqli_query($link,"select * from tbl_lot_ldg_pack where lotno='".$lotnop."' and trtype='PACKRV' and lotldg_rvflg=0 order by lotdgp_id asc") or die(mysqli_error($link));
...
{
	$sql_rv=mysqli_query($link,"select * from tbl_revalidate where rv_id='".$row_packrv['lotldg_id']."' and rv_dorvp='".$row_packrv['lotldg_trdate']."' and rv_lotno='".$lotnop."' order by rv_id asc") or die(mysqli_error($link));
...
$lotnop1=$lotno1."P";
$lotnop24=$lotno1."C";
$sql_packing=mysqli_query($link,"select * from tbl_pnpslipsub where pnpslipsub_orlot='".$lotno1."' and pnpslipsub_packtype='P' order by pnpslipsub_id asc") or die(mysqli_error($link));
$tot_packing=mysqli_num_rows($sql_packing);
//($row_packing=mysqli_fetch_array($sql_packing)

$sql_process=mysqli_query($link,"select * from tbl_proslipsub where proslipsub_orlot='".$lotno1."' and proslipsub_processtype='P' order by proslipsub_id asc") or die(mysqli_error($link));
$tot_process=mysqli_num_rows($sql_process);
//$row_processing=mysqli_fetch_array($sql_processing)

$sql_reprint=mysqli_query($link,"select * from tbl_revalidate where rv_lotno='".$lotnop1."' and rv_rvtyp='partial' order by rv_id asc") or die(mysqli_error($link));
$tot_reprint=mysqli_num_rows($sql_reprint);
//$row_reprint=mysqli_fetch_array($sql_reprint)

$sql_p2c=mysqli_query($link,"select * from tbl_psunpp2c where unp_lotno='".$lotnop1."' and unp_p2ctype='partial' order by unp_id asc") or die(mysqli_error($link));
$tot_p2c=mysqli_num_rows($sql_p2c);
//$row_p2c=mysqli_fetch_array($sql_p2c)

$sql_ivt=mysqli_query($link,"select * from tbl_ivtsub where ivts_olotno='".$lotnop24."' order by ivts_id asc") or die(mysqli_error($link));
...
{
	$pakdate="";
	$sql_pkmain=mysqli_query($link,"select * from tbl_pnpslipmain where pnpslipmain_id='".$row_packing['pnpslipmain_id']."'") or die(mysqli_error($link));
//$tot_p2c=mysqli_num_rows($sql_p2c);
...
{
	$prokdate="";
	$sql_prsmain=mysqli_query($link,"select * from tbl_proslipmain where proslipmain_id='".$row_process['proslipmain_id']."'") or die(mysqli_error($link));
//$tot_p2c=mysqli_num_rows($sql_p2c);
...
{
	$sql_p2cs=mysqli_query($link,"select * from tbl_psunpp2c_sub where unp_id='".$row_p2c['unp_id']."'") or die(mysqli_error($link));
//$tot_p2c=mysqli_num_rows($sql_p2c);
...
{
	$sql_p2cs=mysqli_query($link,"select * from tbl_ivtmain where ivt_id='".$row_ivt['ivt_id']."'") or die(mysqli_error($link));
	//$tot_p2c=mysqli_num_rows($sql_p2c);
	$row_p2cs=mysqli_fetch_array($sql_p2cs);
	$p2cdate="";
...
<?php 
$lotno12=$lotno1."P";
$nolp=0; $smc=0; $lmc=0; $mmc=0; $barcode=0; $nolpqty=0; $ups="";
//echo "select * from tbl_lot_ldg_pack where lotno='".$lotno12."' and balnomp>0 order by lotdgp_id asc";
$sql_nolpqty=mysqli_query($link,"select * from tbl_lot_ldg_pack where lotno='".$lotno12."' and balnomp>0 order by lotdgp_id asc LIMIT 0 , 1") or die(mysqli_error($link));
...
$sql_pack=mysqli_query($link,"select * from tbl_lot_ldg_pack where lotno='".$lotno12."' and balnomp>0 order by lotdgp_id asc") or die(mysqli_error($link));
while($row_pack=mysqli_fetch_array($sql_pack))
{
	if($row_pack['trtype']=="PACKSMC" || $row_pack['trtype']=="PNPSLIP")
	{
		$sql_smc=mysqli_query($link,"select * from tbl_mpmain where mpmain_trid='".$row_pack['lotldg_id']."' and mpmain_lotno='".$lotno12."'") or die(mysqli_error($link));
...
$alqtymain=0;
$sql_alss=mysqli_query($link,"SELECT  * FROM tbl_dallocsub_sub where dallocss_lotno='".$lotno12."' order by dallocss_id asc") or die(mysqli_error($link));
...
$sql_allocss=mysqli_query($link,"SELECT  DISTINCT `dallocs_id` FROM tbl_dallocsub_sub where dallocss_lotno='".$lotno12."' order by dallocss_id asc") or die(mysqli_error($link));
$tot_allocss=mysqli_num_rows($sql_allocss);
while($row_allocss=mysqli_fetch_array($sql_allocss))
{
	$sql_alsub=mysqli_query($link,"SELECT  * FROM tbl_dalloc_sub where dallocs_id='".$row_allocss['dallocs_id']."' and dallocs_dflg=0 order by dallocs_id asc") or die(mysqli_error($link));
...
$sql_allocss1=mysqli_query($link,"SELECT  * FROM tbl_dallocsub_sub where dallocs_id='".$row_allocss['dallocs_id']."' and dallocss_lotno='".$lotno12."' order by dallocs_id asc") or die(mysqli_error($link));
...
while($row_allocss1=mysqli_fetch_array($sql_allocss1))
{
	...
	//echo "SELECT  * FROM tbl_dallocsub_sub3 where dallocss_id='".$row_allocss1['dallocss_id']."' and dallocss3_lotno='".$lotno12."' and dallocss3_dflg=0 order by dallocss3_id asc";
		$sql_allocbar=mysqli_query($link,"SELECT  * FROM tbl_dallocsub_sub3 where dallocss_id='".$row_allocss1['dallocss_id']."' and dallocss3_lotno='".$lotno12."' and dallocss3_dflg=0 order by dallocss3_id asc") or die(mysqli_error($link));
	...
	if($albarcode>0)
	{
		$sql_allocwh=mysqli_query($link,"SELECT  * FROM tbl_dallocsub_sub4 where dalloc_id='".$row_allocss1['dalloc_id']."' order by dallocss4_id asc") or die(mysqli_error($link));
	...
	$sql_alloc=mysqli_query($link,"SELECT  * FROM tbl_dalloc where dalloc_id='".$row_allocss1['dalloc_id']."' order by dalloc_id asc") or die(mysqli_error($link));
...
$sql_pakdisp=mysqli_query($link,"select distinct lotldg_id from tbl_lot_ldg_pack where orlot='".$lotno1."' and (trtype='Qty-Rem' or trtype='Dispatch' or trtype='Dispatch TDF' or trtype='Stock Transfer Out' or trtype='Dispatch Bulk') order by lotldg_id asc") or die(mysqli_error($link));
...
$sql_packm=mysqli_query($link,"select * from tbl_lot_ldg_pack where lotldg_id='".$row_pakdisp['lotldg_id']."' and orlot='".$lotno1."' order by lotldg_id asc") or die(mysqli_error($link));
...
$sql_disp=mysqli_query($link,"select * from tbl_disp where disp_id='".$row_packm['lotldg_id']."'") or die(mysqli_error($link));
...
if($row_packm['trtype']=="Dispatch TDF")
{
	...
	$sql_disp=mysqli_query($link,"select * from tbl_dtdf where dtdf_id='".$row_pakdisp['lotldg_id']."'") or die(mysqli_error($link));
	$tot_disp=mysqli_num_rows($sql_disp);
	$row_disp=mysqli_fetch_array($sql_disp); 
	...
	$sql_code1=mysqli_query($link,"SELECT * FROM tbl_dispnote where dnote_trid='".$row_disp['dtdf_id']."' and dnote_trtype='Dispatch TDF Seed'") or die(mysqli_error($link));
	$row_code1=mysqli_fetch_array($sql_code1);
	...
	$sql_disps=mysqli_query($link,"select * from tbl_dtdf_sub where dtdf_id='".$row_disp['dtdf_id']."'") or die(mysqli_error($link));
	$row_disps=mysqli_fetch_array($sql_disps);
	...
	$sql_dispss=mysqli_query($link,"select * from tbl_dtdfsub_sub where dtdf_id='".$row_disp['dtdf_id']."' and dbss_lotno='".$lotno12."' order by dbss_id asc") or die(mysqli_error($link));
	while($row_dispss=mysqli_fetch_array($sql_dispss))
	{
		$dqty=$dqty+$row_dispss['dbss_qty'];
		$disptype="Dispatch TDF";
		$sql_disps=mysqli_query($link,"select * from tbl_dtdf_sub where dtdfs_id='".$row_disps['dtdfs_id']."'") or die(mysqli_error($link));
		$dups=$row_disps['dtdfs_ups'];
	}
}
...
if($row_packm['trtype']=="Stock Transfer Out")
{
	...
	$disptype=$dbarcode;
	$sql_stout=mysqli_query($link,"select * from tbl_stoutm where stoutm_id='".$row_disp['lotldg_id']."'") or die(mysqli_error($link));
...
if($row_packm['trtype']=="Qty-Rem")
{
	...
	$sql_qty=mysqli_query($link,"select * from tbl_pswrem where pswrem_id='".$row_packm['lotldg_id']."'") or die(mysqli_error($link));
...
if($row_packm['trtype']=="Dispatch Bulk")
{
	...
	$sql_bulk=mysqli_query($link,"select * from tbl_dbulk where dbulk_id='".$row_disp['lotldg_id']."'") or die(mysqli_error($link));
	...
	$sql_code1=mysqli_query($link,"SELECT * FROM tbl_dispnote where dnote_trid='".$row_disp['stoutm_id']."' and dnote_trtype='Dispatch Bulk Seed'") or die(mysqli_error($link));
	$row_code1=mysqli_fetch_array($sql_code1);
...
$sql_packl=mysqli_query($link,"select * from tbl_lot_ldg where lotldg_trid='".$row_pakdisp1['lotldg_trid']."' and orlot='".$lotno1."' order by lotldg_id asc") or die(mysqli_error($link));
while($row_packl=mysqli_fetch_array($sql_packl))
{
if($row_packl['lotldg_trtype']=="Dispatch TDF")
{
	$sql_disp=mysqli_query($link,"select * from tbl_dtdf where dtdf_id='".$row_packl['lotldg_trid']."'") or die(mysqli_error($link));
	$tot_disp=mysqli_num_rows($sql_disp);
	$row_disp=mysqli_fetch_array($sql_disp); 
	...
	$sql_dispss=mysqli_query($link,"select * from tbl_dtdfsub_sub where dbss_id='".$row_disp['dtdf_id']."' and dbss_lotno='".$lotno12."' order by dbss_id asc") or die(mysqli_error($link));
	while($row_dispss=mysqli_fetch_array($sql_dispss))
	{
		//$dqty=$dqty+$row_dispss['dbss_qty'];
...
if($row_packl['lotldg_trtype']=="Stock Transfer Out")
{
	...
	$sql_stout=mysqli_query($link,"select * from tbl_stoutm where stoutm_id='".$row_packl['lotldg_trid']."'") or die(mysqli_error($link));
	$row_stout=mysqli_fetch_array($sql_stout);
	...
	$sql_code1=mysqli_query($link,"SELECT * FROM tbl_dispnote where dnote_trid='".$row_packl['lotldg_trid']."' and dnote_trtype='Dispatch TDF Seed'") or die(mysqli_error($link));
	$row_code1=mysqli_fetch_array($sql_code1);
...
if($row_packl['lotldg_trtype']=="Qty-Rem")
{
	...
	$sql_qty=mysqli_query($link,"select * from tbl_rswrem where rswrem_id='".$row_packl['lotldg_trid']."'") or die(mysqli_error($link));
	...
	if($tot_disp==0)
	{
		$sql_disp=mysqli_query($link,"select * from tbl_cswrem where rswrem_id='".$row_packl['lotldg_trid']."'") or die(mysqli_error($link));
		$tot_disp=mysqli_num_rows($sql_disp);
		$row_disp=mysqli_fetch_array($sql_disp);
...
if($row_packl['lotldg_trtype']=="Dispatch Bulk")
{
	...
	$sql_bulk=mysqli_query($link,"select * from tbl_dbulk where dbulk_id='".$row_packl['lotldg_trid']."'") or die(mysqli_error($link));
	$row_bulk=mysqli_fetch_array($sql_bulk);
	$sql_stparty=mysqli_query($link,"select * from tbl_partymaser where p_id='".$row_bulk['dbulk_party']."'") or die(mysqli_error($link));
	$row_stparty=mysqli_fetch_array($sql_stparty);
	$partyname=$row_stparty['business_name'];
	...
	$sql_code1=mysqli_query($link,"SELECT * FROM tbl_dispnote where dnote_trid='".$row_packl['lotldg_trid']."' and dnote_trtype='Dispatch Bulk Seed'") or die(mysqli_error($link));
	$row_code1=mysqli_fetch_array($sql_code1);
...
<?php 
$sql_discs=mysqli_query($link,"select * from tbl_discard_sub where lotnumber='".$lotno1."'") or die(mysqli_error($link));
...
{
  $sql_discss=mysqli_query($link,"select * from tbl_discard_sloc where discard_id='".$row_discs['did']."'") or die(mysqli_error($link));
  $row_discss=mysqli_fetch_array($sql_discss);
  
  $sql_disc=mysqli_query($link,"select * from tbl_discard where tid='".$row_discs['did_s']."'") or die(mysqli_error($link));
...
<br />
<br />
<table align="center" cellpadding="5" cellspacing="5" border="0" width="800">
<tr >
