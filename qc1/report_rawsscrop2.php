...
<?php
	...
	if($txtstage!="ALL")
	{
		...
		{
			$qry2="select Distinct lotldg_crop from tbl_lot_ldg_pack where lotdgp_id!=0 and lotldg_trdate>='$sdate' and lotldg_trdate<='$edate' and (lotldg_qc='Fail' OR lotldg_got='Fail')";
		}
		else
		{
			$qry="select Distinct lotldg_crop from tbl_lot_ldg where lotldg_id!=0 and lotldg_trdate>='$sdate' and lotldg_trdate<='$edate' and (lotldg_qc='Fail' OR lotldg_got='Fail')";
			$qry2="select Distinct lotldg_crop from tbl_lot_ldg_pack where lotdgp_id!=0 and lotldg_trdate>='$sdate' and lotldg_trdate<='$edate' and (lotldg_qc='Fail' OR lotldg_got='Fail')";
		}
	}
	else
...
if($crval<>"")
{
	...
	if($txtstage!="ALL")
	{
		...
		{
			$qry2="select Distinct lotldg_variety from tbl_lot_ldg_pack where lotdgp_id!=0 and lotldg_trdate>='$sdate' and lotldg_trdate<='$edate' and (lotldg_qc='Fail' OR lotldg_got='Fail') and lotldg_crop='".$crval."'";
		}
		else
		{
			$qry="select Distinct lotldg_variety from tbl_lot_ldg where lotldg_id!=0 and lotldg_trdate>='$sdate' and lotldg_trdate<='$edate' and (lotldg_qc='Fail' OR lotldg_got='Fail') and lotldg_crop='".$crval."'";
			$qry2="select Distinct lotldg_variety from tbl_lot_ldg_pack where lotdgp_id!=0 and lotldg_trdate>='$sdate' and lotldg_trdate<='$edate' and (lotldg_qc='Fail' OR lotldg_got='Fail') and lotldg_crop='".$crval."'";
		}
	}
	else
	...
	else
	{
		...
		{  
			...
			while($row_is=mysqli_fetch_array($sql_is))
			{ 
				$sql_is1=mysqli_query($link,"select max(lotldg_id) from tbl_lot_ldg where lotldg_subbinid='".$row_is['lotldg_subbinid']."' and lotldg_binid='".$row_is['lotldg_binid']."' and lotldg_crop='".$crval."' and lotldg_variety='".$verval."' and (lotldg_qc='Fail' OR lotldg_got='Fail') and lotldg_trdate>='$sdate' and lotldg_trdate<='$edate' and lotldg_lotno='".$row_arhome['lotldg_lotno']."'  order by lotldg_id desc ") or die(mysqli_error($link));
				$row_is1=mysqli_fetch_array($sql_is1); 
				$sql_istbl=mysqli_query($link,"select * from tbl_lot_ldg where lotldg_id='".$row_is1[0]."' and lotldg_balqty > 0 and lotldg_trdate>='$sdate' and lotldg_trdate<='$edate' order by lotldg_id asc") or die(mysqli_error($link)); 
				$t=mysqli_num_rows($sql_istbl);
				if($t > 0)
		...
		if($txtstage!="Pack")
		{
			...
			{  
				...
				{ 
					...
					$sql_issuetbl=mysqli_query($link,"select * from tbl_lot_ldg where lotldg_id='".$row_issue1[0]."' and lotldg_balqty > 0 and lotldg_trdate>='$sdate' and lotldg_trdate<='$edate' and (lotldg_qc='Fail' OR lotldg_got='Fail') and lotldg_sstage='$txtstage' order by lotldg_id asc") or die(mysqli_error($link)); 
...
<?php
	...
	else
	{
		...
		{  
			$wareh=""; $binn=""; $subbinn=""; $slups=0; $slqty=0;	 $cnt=0;
			$totqty=0; $totnob=0; $totqc=""; $totdot=""; $totmost=""; $totgemp=""; $totgot=""; $reserve=""; $totsst=""; $sloc=""; $genpp=""; $dogr=""; $stage="";
			$sql_issue=mysqli_query($link,"select distinct subbinid, whid, binid from tbl_lot_ldg_pack where lotno='".$row_arr_home['lotno']."' and (lotldg_qc='Fail' OR lotldg_got='Fail') and lotldg_trdate>='$sdate' and lotldg_trdate<='$edate' group by subbinid order by lotdgp_id asc") or die(mysqli_error($link));
			...
			{ 
				...
				$sql_issuetbl=mysqli_query($link,"select * from tbl_lot_ldg_pack where lotdgp_id='".$row_issue1[0]."' and balqty > 0 and (lotldg_qc='Fail' OR lotldg_got='Fail') and lotldg_trdate>='$sdate' and lotldg_trdate<='$edate' order by lotdgp_id asc") or die(mysqli_error($link)); 
				$t=mysqli_num_rows($sql_issuetbl);
				if($t > 0)
				{
					while($row_issuetbl=mysqli_fetch_array($sql_issuetbl))
...
else
{
	...
	{  
		...
		{ 
			...
			$sql_issue1=mysqli_query($link,"select max(lotldg_id) from tbl_lot_ldg where lotldg_subbinid='".$row_issue['lotldg_subbinid']."' and lotldg_binid='".$row_issue['lotldg_binid']."' and lotldg_whid='".$row_issue['lotldg_whid']."' and lotldg_lotno='".$row_arr_home['lotldg_lotno']."' and (lotldg_qc='Fail' OR lotldg_got='Fail') and lotldg_trdate>='$sdate' and lotldg_trdate<='$edate' order by lotldg_id asc ") or die(mysqli_error($link));
			$row_issue1=mysqli_fetch_array($sql_issue1); 
