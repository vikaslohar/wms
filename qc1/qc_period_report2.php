...
$row_dept=mysqli_fetch_array($quer2);
	...
	{
		$quer3=mysqli_query($link,"SELECT * FROM tblvariety where varietyid ='".$vv."' and actstatus='Active'"); 
...
<tr class="tblsubtitle" height="25">
			...
			<td width="62" align="center" valign="middle" class="tblheading">Previous QC Status</td>
...
<td align="center" valign="middle" class="tblheading"><?php echo $srno?></td>
		...
		<!--  <td width="68" align="center" valign="middle" class="tblheading"><?php echo $sstage;?></td>-->
		 ...
		 <td align="center" valign="middle" class="tblheading"><?php echo $extqcresult?></td>
