<?php
	...
	echo "<script>window.location='report_crop_wise1.php?sdate=$sdate&txtcrop=$cid&txtvariety=$itemid'</script>";
	}
?>
   ...
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#cc30cc" >
	  ...
	  <form name="frmaddDepartment" method="post" action="<?php $_SERVER['PHP_SELF']; ?>" > 
	    ...
	    <table  border="0" cellspacing="0" cellpadding="0" align="center" width="974"  style="border-collapse:collapse">
          ...
          <tr>
            <td width="30"></td>
            <td><table align="center" border="1" width="574" cellspacing="0" cellpadding="0" bordercolor="#cc30cc" style="border-collapse:collapse" >
           ...
           <td align="right" width="50%" height="30" valign="middle" class="tblheading">&nbsp;Select&nbsp;Date&nbsp;</td>
           <td align="left"  valign="middle" >&nbsp;<input name="sdate" id="sdate" type="text" size="10" class="tbltext" tabindex="0" readonly="true"  value="<?php echo date("d-m-Y", time());?>" style="background-color:#EFEFEF" />&nbsp;<font color="#FF0000" >*</font></td></tr>
                <?php
 /*$code="";
...
<!--/*<tr class="Light" height="25">
     ...
     <td align="left"  valign="middle" ><input type="radio" name="reptyp" value="hold" onclick="holdchk(this.value);" />&nbsp;Yes&nbsp;&nbsp;<input type="radio" name="reptyp" value="unhold" onclick="holdchk(this.value);"  />&nbsp;No</td>
                </tr>*/-->
              </table>
                <table width="974" cellpadding="5" cellspacing="5" border="0" >
                  <tr >
                    <td valign="top" align="center">&nbsp;<a href="report_pending.php"><img src="../images/back.gif" border="0"  style="display:inline;cursor:pointer;"/></a>&nbsp;<input name="Submit" type="image" src="../images/submit_1.gif" alt="Submit Value"  border="0" style="display:inline;cursor:pointer;" onClick="return mySubmit();" />
