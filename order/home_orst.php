...
$sql_tbl=mysqli_query($link,"select * from tbl_orderm where plantcode='$plantcode' and order_trtype='Order Stock' and orderm_tflag=0 and logid='".$logid."' ") or die(mysqli_error($link));
while($row_tbl=mysqli_fetch_array($sql_tbl))
{
	...
	$s_sub="delete from tbl_orderm where  order_trtype='Order Stock' and orderm_tflag=0 and logid='".$logid."'";
	mysqli_query($link,$s_sub) or die(mysqli_error($link));	
	...
	if(isset($_POST['frm_action'])=='submit')
	{
		...
		if($sdate!="" && $edate!="")
		{
		echo "<script>window.location='home_orst1.php?sdate=$sdate&edate=$edate'</script>";
		}
		else
		 {?>
		 <script>
...
<title>Order- Transaction - Order-Stock Transfer</title>
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#cc30cc" >
	  ...
	  <table width="820" border="0" cellpadding="0" cellspacing="0" bordercolor="#cc30cc" style="border-bottom:solid; border-bottom-color:#cc30cc" >
	    <tr >
	      <td width="820" height="25" > &nbsp; Transaction - Stock Transfer</td>
	    </tr></table></td>
...
<td align="center" width="100" valign="middle" class="tblbutn" style="cursor:Pointer;"><?php if($flg==0 && $flg1==0 && $flg2==0) { ?><a href="add_order_Stock.php" style="text-decoration:none; color:#000000">Add </a><?php } else { ?><a href="Javascript:void(0);" onClick="alert('Can not perform Transaction.\nReason:\n1. Todays date is not in Active Current Financial Year.\n2. Transaction after todays date has been made.\n3. Cycle Inventory transaction is under process.');" style="text-decoration:none; color:#000000">Add </a><?php } ?></td>
</tr>
</table></td>
...
<?php
  ...
  $sql_arr_home=mysqli_query($link,"select * from tbl_orderm where plantcode='$plantcode' and order_trtype='Order Stock' and orderm_tflag=1 and orderm_supflag=0 and orderm_cancelflag=0 order by orderm_id desc LIMIT $start, $limit") or die(mysqli_error($link));
...
$query = "select * from tbl_orderm where plantcode='$plantcode' and order_trtype='Order Stock' and orderm_tflag=1 and orderm_supflag=0 and orderm_cancelflag=0 order by orderm_id desc";
...
/*if(!isset($_GET['page'])) { 
	...
	$sql_arr_home=mysqli_query($link,"select * from tbl_orderm where order_trtype='Order Stock' and orderm_tflag=1 and orderm_supflag=0 and orderm_cancelflag=0 order by orderm_id desc LIMIT $from, $max_results") or die(mysqli_error($link));
$tot_arr_home=mysqli_num_rows($sql_arr_home);


$total_results3 =mysqli_query($link,"SELECT COUNT(*)  FROM tbl_orderm where order_trtype='Order Stock' and orderm_tflag=1 and orderm_supflag=0 and	orderm_cancelflag=0");
$total_results2 = mysqli_fetch_array($total_results3);
$total_results = $total_results2[0]; */
...
<tr class="Light" height="20">
  <td colspan="6" align="center" class="tblheading"> Order-Stock Transfer</td>
</tr>
</table>
<table align="center" border="1" cellspacing="0" cellpadding="0" width="970" bordercolor="#cc30cc" style="border-collapse:collapse">
  <tr class="tblsubtitle" height="20">
    ...
    <td width="11%" align="center" valign="middle" class="tblheading">Order Number</td>
	<td width="7%" align="center" valign="middle" class="tblheading"> Party Order Ref. No.</td>
    <td width="7%" align="center" valign="middle" class="tblheading"> Party Type</td>
    ...
    <td width="14%" align="center" valign="middle" class="tblheading">Consignee Location</td>
    <td width="14%" align="center" valign="middle" class="tblheading">Order By</td>
    <td width="5%" align="center" valign="middle" class="tblheading">Var. No.</td>
...
?>
  <tr class="Light">
    ...
    <td width="11%" align="center" valign="middle" class="smalltbltext"><?php echo $row_arr_home['orderm_porderno'];?></td>
	<td width="7%" align="center" valign="middle" class="smalltbltext"><?php echo $row_arr_home['orderm_partyrefno'];?></td>
    <td width="7%" align="center" valign="middle" class="smalltbltext"><?php echo $row_arr_home['orderm_party_type'];?></td>
    <td width="17%" align="center" valign="middle" class="smalltbltext"><?php echo $row3['business_name'];?></td>
    <td width="15%" align="center" valign="middle" class="smalltbltext"><?php echo $row3['city'];?>, <?php echo $row3['state'];?></td>
    <td width="14%" align="center" valign="middle" class="smalltbltext"><?php if($row_arr_home['orderm_consigneeapp']=="Yes"){?><?php echo $row_arr_home['orderm_concity'];?>, <?php echo $row_arr_home['orderm_constate'];}?></td>
    <td width="14%" align="center" valign="middle" class="smalltbltext"><?php echo $row_arr_home['orderm_placedby'];?></td>
    <td width="5%" align="center" valign="middle" class="smalltbltext"><?php echo $subtbltot;?></td>
    <td width="5%" align="center" valign="middle" class="smalltbltext"><a href="Javascript:void(0)" onClick="openslocpopprint('<?php echo $row_arr_home['orderm_id'];?>');">TON</a></td>
  </tr>
  <?php
}
else
