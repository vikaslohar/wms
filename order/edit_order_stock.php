...
<title>Order- Transaction - Edit Order-Stock Transfer</title>
...
<tr class="tblsubtitle" height="20">
  <td colspan="6" align="center" class="tblheading">Edit Order - Stock Transfer</td>
</tr>
<tr height="15"><td colspan="6" align="right" class="tblheading"><font color="#FF0000" >* </font>indicates required field&nbsp;</td></tr>

 <tr class="Dark" height="30">
<td width="205" align="right" valign="middle" class="tblheading">&nbsp;Transaction Id&nbsp;</td>
<td width="256"  align="left" valign="middle" class="tbltext">&nbsp;<input name="txttranid" type="text" size="16" class="tbltext" tabindex=""    maxlength="16"  value="<?php echo "TOT".$row_tbl['orderm_code']."/".$ycode."/".$lgnid;?>" style="background-color:#CCCCCC" readonly="true"/>&nbsp;</td>
...
<?php
$sql_month=mysqli_query($link,"select * from tblclassification where plantcode='$plantcode' and main='Stock Transfer'  order by classification")or die(mysqli_error($link));
...
<?php
$sql_month=mysqli_query($link,"select * from tblproductionlocation where plantcode='$plantcode' and state='".$row_tbl['orderm_locstate']."' order by productionlocation")or die(mysqli_error($link));
?>	
...
<option value="" selected>--Select--</option>
<?php while($noticia3 = mysqli_fetch_array($sql_month)) { ?>
...
<td align="left"  valign="middle" class="tbltext" colspan="3" id="vaddress">&nbsp;<?php echo $row33['address'];?><?php if($row33['city']!=""){ echo ", ".$row33['city'];}?>, <?php echo $row33['state'];?><input type="hidden" name="adddchk" value="" />  </td>
</tr>
</table>
 <table align="center" border="1" width="850" cellspacing="0" cellpadding="0" bordercolor="#cc30cc" style="border-collapse:collapse" > 
 ...
 <td width="206"  align="right"  valign="middle" class="tblheading">&nbsp;Consignee Applicable&nbsp;</td>
   <td width="638" colspan="3" align="left"  valign="middle"><input name="txt12" type="radio" class="tbltext" value="Yes" onClick="clkp(this.value);" <?php if($row_tbl['orderm_consigneeapp']=="Yes"){ echo "Checked";} ?> />&nbsp;Yes&nbsp;&nbsp;<input name="txt12" type="radio" class="tbltext" value="No" onClick="clkp(this.value);" <?php if($row_tbl['orderm_consigneeapp']=="No"){ echo "Checked";} ?>  />&nbsp;No&nbsp;&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
</tr>
</table> 
<div id="fill" style="display:<?php if($row_tbl['orderm_consigneeapp']=="Yes"){ echo "block";} else { echo "none"; }?>">
<table align="center" border="1" width="850" cellspacing="0" cellpadding="0" bordercolor="#cc30cc" style="border-collapse:collapse"  > 
<tr class="Light" height="25">
           <td width="205"  align="right"  valign="middle" class="tblheading">Consignee Name&nbsp;</td>
           <td align="left"  valign="middle" colspan="3" >&nbsp;<input name="txtparty" type="text" size="35" class="tbltext" tabindex="" maxlength="35" value="<?php echo $row_tbl['orderm_consigneename'];?>"  onBlur="javascript:this.value=FirstCharCap(this.value);" onkeypress="return isCharKey(event)"/>&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
         </tr>
 <tr class="Dark" height="30">
...
<tr class="Dark" height="30"  >
   <td align="right" width="205" valign="middle" class="tblheading" >&nbsp;Phone No.&nbsp;</td>
    <td align="left"  valign="middle" class="tbltext" colspan="4">&nbsp;<input name="pstd" type="text" size="5" class="tbltext" tabindex="7" maxlength="5" onkeypress="return isNumberKey1(event)" value="<?php echo $row_tbl['orderm_conphonestd'];?>"/>&nbsp;&nbsp;<input name="pphno" type="text" size="15" class="tbltext" tabindex="" maxlength="12" value="<?php echo $row_tbl['orderm_conphoneno'];?>" onkeypress="return isNumberKey(event)"/>&nbsp;STD | Phone</td>
  </tr>
<tr class="Light" height="25">
...
<td align="left"  valign="middle" class="tbltext" colspan="3">&nbsp;<input name="txtorderplby" type="text" size="20" class="tbltext" tabindex=""  value="<?php echo $row_tbl['orderm_placedby'];?>"  maxlength="20" onchange="orplchk();" onBlur="javascript:this.value=FirstCharCap(this.value);" onkeypress="return isCharKey(event)"/>&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
</tr>
<tr class="Dark" height="25">
...
<table align="center" border="1" width="850" cellspacing="0" cellpadding="0" bordercolor="#cc30cc" style="border-collapse:collapse" > 
<tr class="Light" height="30">
<td align="right" width="207" valign="middle" class="tblheading" style="border-color:#cc30cc">&nbsp;Transport Name&nbsp;</td>
<td align="left"  valign="middle" class="tbltext" style="border-color:#cc30cc">&nbsp;<input name="txttname" type="text" size="35" class="tbltext" tabindex="" maxlength="35" value="<?php echo $row_tbl['orderm_trname'];?>" />  &nbsp;<font color="#FF0000">*</font>&nbsp;</td>
<!--<td width="136" align="right"  valign="middle" class="tblheading" style="border-color:#cc30cc">Lorry Receipt No.&nbsp;</td>
<td align="left" width="227" valign="middle" class="tbltext" colspan="3" style="border-color:#cc30cc">&nbsp;
  <input name="txtlrn" type="text" size="15" class="tbltext" tabindex="" value="<?php echo $row_tbl['orderm_lrno'];?>"  maxlength="15"/>&nbsp;</td>-->
</tr>

<!--/*<tr class="Dark" height="25">
<td align="right" width="207" valign="middle" class="tblheading" style="border-color:#cc30cc">&nbsp;Vehicle No.&nbsp;</td>
<td align="left" width="270" valign="middle" class="tbltext"  style="border-color:#cc30cc">&nbsp;<input name="txtvn" type="text" size="12" class="tbltext" tabindex="" maxlength="12" value="<?php echo $row_tbl['orderm_vehno'];?>"  />&nbsp;<font color="#FF0000">*</font>&nbsp; </td>
...
<option value="" selected="selected">Select</option>
<option <?php if($row_tbl['orderm_paymode']=="TBB"){ echo "Selected";} ?> value="TBB">TBB</option>
<option <?php if($row_tbl['orderm_paymode']=="ToPay"){ echo "Selected";} ?> value="ToPay" >To Pay</option>
<option <?php if($row_tbl['orderm_paymode']=="Paid"){ echo "Selected";} ?> value="Paid">Paid</option>
...
<!--<td align="right" width="136" valign="middle" class="tblheading" style="border-color:#cc30cc">&nbsp;Docket No.&nbsp;</td>
<td align="left" width="227" valign="middle" class="tbltext" colspan="3" style="border-color:#cc30cc">&nbsp;<input name="txtdc" type="text" size="15" class="tbltext" tabindex="" maxlength="15" value="<?php echo $row_tbl['orderm_docno'];?>"   />&nbsp;<font color="#FF0000">*</font></td>-->
</tr>
