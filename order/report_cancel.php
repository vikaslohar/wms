<?php
	...
	if(isset($_POST['frm_action'])=='submit')
	{
		...
		$edate = $_POST['edate'];
		//exit;
		echo "<script>window.location='report_cancel1.php?sdate=$sdate&edate=$edate'</script>";
	}
?>
...
<title>Order - Report - Cancel Order Report</title>
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#cc30cc" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#cc30cc" style="border-bottom:solid; border-bottom-color:#cc30cc" >
	    <tr >
	      <td width="813" height="30"class="Mainheading"  >&nbsp;Cancel Order Report  
	        </td>
	    </tr></table></td>
	  </tr>
	  </table></td></tr>
...
<tr class="tblsubtitle" height="25">
  <td colspan="4" align="center" class="tblheading">Cancel Order Report</td>
</tr>
