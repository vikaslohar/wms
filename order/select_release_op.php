...
<title>Order- Transaction - Order Release-Select output</title>
...
function openslocpopprint(val1,val2,val3,val4,val5,val6,val7,val8)
{
winHandle=window.open('ronop.php?itmid='+val1+'&txttype='+val2+'&txtpp='+val3+'&txtptype='+val4+'&txtlocationsl='+val5+'&txtstatesl='+val6+'&txtcountrysl='+val7+'&oid='+val8,'WelCome','top=170,left=180,width=820,height=450,scrollbars=yes');
if(winHandle==null){
...
<table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" >
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" style="border-bottom:solid; border-bottom-color:#cc30cc" >
	    <tr >
	      <td width="813" height="25" class="Mainheading">&nbsp;Transaction:Order - Release - Output Selection </td>
	    </tr></table></td>
	  </tr>
	  </table></td></tr>
 ...
 <input name="frm_action" value="submit" type="hidden">
   <input name="txttype" value="<?php echo $type;?>" type="hidden"> 
 <input type="hidden" name="txtitem" value="<?php echo $pid?>" />
 
 <br />

<table align="center" border="0" width="750" cellspacing="0" cellpadding="0" bordercolor="#cc30cc" style="border-collapse:collapse" > 
<tr height="25">
...
<tr class="Light" height="25">
    ...
    <td align="center"  valign="middle" class="tblheading">&nbsp;<a href="Javascript:void(0)" onclick="openslocpopprint('<?php echo $pid;?>','<?php echo $type;?>','<?php echo $txtpp?>','<?php echo $txtptype?>','<?php echo $txtlocationsl;?>','<?php echo $txtstatesl?>','<?php echo $txtcountrysl?>','<?php echo $oid?>');"> Release Order Note (RON)</a></td>
</tr>
<!--<tr class="Light" height="25">
...
$sql_tbl=mysqli_query($link,"select * from tbl_lot_ldg where plantcode='$plantcode' and lotldg_trtype='StockTransfer Arrival' and lotldg_trid='".$pid."'") or die(mysqli_error($link));
/*$row_tbl=mysqli_fetch_array($sql_tbl);			
...
?>
  <tr class="tblsubtitle" height="25">
    <td width="33" align="center" class="tblheading" valign="middle">#</td>
	  <td width="134" align="center" class="tblheading" valign="middle">Lot Number</td>
	  <td width="142" align="center" class="tblheading" valign="middle">Crop</td>
    <td width="210" align="center" class="tblheading" valign="middle">Variety</td>
    <td width="57" align="center" class="tblheading" valign="middle">Bags</td>
    <td width="53" align="center" class="tblheading" valign="middle">Qty</td>
	<td width="65" align="center" class="tblheading" valign="middle">Moisture % </td>
    <td width="59" align="center" class="tblheading" valign="middle">QC</td>
    <td width="45" align="center" class="tblheading" valign="middle">GOT</td>
	  <td width="85" align="center" class="tblheading" valign="middle">Seed Status</td>
	  <td width="105" align="center" class="tblheading" valign="middle">SLOC</td>
    </tr>
...
{ 
$sql_class=mysqli_query($link,"select * from tblarrival_sub where plantcode='$plantcode' and arrival_id='".$arrival_id."'") or die(mysqli_error($link));
...
?>
<tr class="Light" height="25">
    <td width="33" align="center" valign="middle" class="tblheading"><?php echo $srno;?></td>
	<td width="134" align="center" valign="middle" class="tblheading"><?php echo $row_tbl_sub['lotldg_lotno'];?></td>
	<td width="142" align="center" valign="middle" class="tblheading"><?php echo $row31['cropname'];?></td>
	

    <td width="210" align="center" valign="middle" class="tblheading"><?php echo $rowvv['popularname'];?></td>
	...
	<td width="65" align="center" valign="middle" class="tblheading"><?php echo $row_class['moisture'];?></td>
    <td width="59" align="center" valign="middle" class="tblheading"><?php echo $row_class['qc'];?></td>
    <td align="center" valign="middle" class="tblheading"><?php echo $row_class['got'];?></td>
    <td align="center" valign="middle" class="tblheading"><?php echo $row_class['sstatus'];?></td>
<?php
$wareh=""; $binn=""; $subbinn=""; $sups="";$sqty=0; $slocs=""; $gd="";

$sql_whouse=mysqli_query($link,"select perticulars from tbl_warehouse where plantcode='$plantcode' and whid='".$row_tbl_sub['lotldg_whid']."'") or die(mysqli_error($link));
...
<tr >
<td valign="top" align="center"><a href="home_release1.php"><img src="../images/back.gif" border="0"style="display:inline;cursor:Pointer;" /></a>&nbsp;&nbsp;&nbsp;</td>	
</tr>
</table>
