...
<tr class="tblsubtitle" height="20">
		...
		<td width="10%" align="center" valign="middle" class="tblheading">&nbsp;PV Variety</td>
		...
		<td width="5%" align="center" valign="middle" class="tblheading">L.Qty (Kgs.)</td>
		...
		<td width="7%" align="center" valign="middle" class="tblheading">NoWB</td>
...
<tr class="Light" height="20">
        ...
        <td width="6%" align="center" valign="middle" class="smalltblheading"><?php echo $vtype;?></td>
        <td width="10%" align="center" valign="middle" class="smalltblheading">&nbsp;<?php echo $variety;?></td>
		<td width="10%" align="center" valign="middle" class="smalltblheading">&nbsp;<?php echo $pvvariety;?></td>
		<td width="4%" align="center" valign="middle" class="smalltblheading"><?php echo $up1;?></td>
		<td width="5%" align="center" valign="middle" class="smalltblheading"><?php echo $up;?></td>
		...
		<td width="5%" align="center" valign="middle" class="smalltblheading"><?php echo $lqty;?></td>
		...
		<td width="7%" align="center" valign="middle" class="smalltblheading"><?php echo $nowbp;?></td>
		<td width="6%" align="center" valign="middle" class="smalltblheading"><?php echo $nompp;?></td>
