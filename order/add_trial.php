...
$sql_code="SELECT MAX(orderm_code) FROM tbl_orderm where plantcode='$plantcode' and order_trtype='Order TDF' and yearcode='$ycode' ORDER BY orderm_code DESC";
...
<title>Order- Transaction -Trial/Demo/Free</title>
...
<input name="frm_action" value="submit" type="hidden"> 
		...
		<input type="hidden" name="txtslflchk" value="" />
		<input type="hidden" name="txtptyp" value="" />
...
<tr class="tblsubtitle" height="20">
  <td colspan="6" align="center" class="tblheading">Add Order-Trial/Demo/Free</td>
</tr>
<tr height="15"><td colspan="6" align="right" class="tblheading"><font color="#FF0000" >* </font>indicates required field&nbsp;</td></tr>

 <tr class="Dark" height="30">
<td width="201" align="right" valign="middle" class="tblheading">&nbsp;Transaction Id&nbsp;</td>
<td width="260"  align="left" valign="middle" class="tbltext">&nbsp;<input name="txttranid" type="text" size="16" class="tbltext" tabindex=""  readonly="true"   maxlength="16"  value="<?php echo $code1?>" style="background-color:#CCCCCC" />&nbsp;</td>

<td width="169" align="right" valign="middle" class="tblheading">&nbsp;Date&nbsp;</td>
<td width="210" align="left" valign="middle" class="tbltext">&nbsp;<input name="date" type="text" size="10" class="tbltext" tabindex="0" readonly="true"  style="background-color:#CCCCCC" value="<?php echo date("d-m-Y");?>" maxlength="10"/>&nbsp;</td>
</tr>

<tr class="Light" height="30">
<td align="right"  valign="middle" class="tblheading">Order No.&nbsp;</td>
<td align="left"  valign="middle" class="tbltext" >&nbsp;<input name="txtordno" type="text" size="16" class="tbltext" tabindex="" readonly="true" maxlength="16"  value="<?php echo $code12?>" style="background-color:#CCCCCC" />&nbsp;&nbsp;</td>
<td align="right"  valign="middle" class="tblheading">Party Order Ref. No.&nbsp;</td>
<td align="left"  valign="middle" class="tbltext">&nbsp;<input name="txtporf" type="text" size="20" class="tbltext" tabindex=""   maxlength="20"  />&nbsp;</td>
           </tr>

		<tr class="Dark" height="25">
<td width="202" align="right"  valign="middle" class="tblheading">&nbsp;Party&nbsp;</td>
   <td width="642" colspan="3" align="left"  valign="middle" >&nbsp;<input name="txtpt" type="radio" class="tbltext" value="selectp" onClick="clkparty(this.value);" />&nbsp;Select From Master&nbsp;&nbsp;<input name="txtpt" type="radio" class="tbltext" value="fillp" onClick="clkparty(this.value);"  />&nbsp;Fill&nbsp;&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
...
<tr class="Light" height="25">
 <td width="202" align="right"  valign="middle" class="tblheading">&nbsp;Select&nbsp;</td>
  <td width="642" colspan="3" align="left"  valign="middle" class="tbltext">&nbsp;<input name="txtptselect" type="radio" class="tbltext" value="Channel" onClick="clkpartytyp(this.value);" />&nbsp;Channel&nbsp;&nbsp;<input name="txtptselect" type="radio" class="tbltext" value="Stock Transfer" onClick="clkpartytyp(this.value);" />&nbsp;Stock Transfer&nbsp;&nbsp;<input name="txtptselect" type="radio" class="tbltext" value="TDF - Individual" onClick="clkpartytyp(this.value);" />&nbsp;Individual-TDF&nbsp;&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
</tr>
</table>
</div>
<div id="selectpartytype"style="display:none" ></div>	
<div id="selectpartylocation"style="display:none" ></div>
<div id="selectparty"style="display:none" ></div>
<div id="fill2" style="display:none">
<table align="center" border="1" width="850" cellspacing="0" cellpadding="0" bordercolor="#cc30cc" style="border-collapse:collapse"   > 
<tr class="Light" height="25">
           <td width="201"  align="right"  valign="middle" class="tblheading" >Party Name&nbsp; </td>
           <td align="left"  valign="middle" colspan="6" >&nbsp;<input name="txtparty1" type="text" size="35" class="tbltext" tabindex="" maxlength="35" onchange="pnamechk(this.value);"  onBlur="javascript:this.value=FirstCharCap(this.value);"  />&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
         </tr>
 <tr class="Dark" height="30">
<td width="201" align="right"  valign="middle" class="tblheading" >&nbsp;Address&nbsp;</td>
<td align="left"  valign="middle" class="tbltext" colspan="3">&nbsp;<textarea name="txtadd1" cols="50" rows="3" tabindex=""  class="tbltext" onchange="paddchk(this.value);" onBlur="javascript:this.value=FirstCharCap(this.value);"></textarea>&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
</tr>

<tr class="Light" height="30">
<td width="201" align="right"  valign="middle" class="tblheading" >&nbsp;City/Town/Village&nbsp;</td>
<td align="left"  valign="middle" class="tbltext" colspan="4">&nbsp;<input type="text" class="tbltext" name="txtcity1" size="20" maxlength="20" onchange="pcitychk(this.value);" onkeypress="return isCharKey(event)" onBlur="javascript:this.value=FirstCharCap(this.value);" >&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
</tr>
<tr class="Dark" height="30">
<td width="201" align="right"  valign="middle" class="tblheading" >&nbsp;Pin Code&nbsp;</td>
<td align="left"  valign="middle" class="tbltext"  colspan="4">&nbsp;<input type="text" class="tbltext" name="txtpin1" size="6" maxlength="6" onkeypress="return isNumberKey_OnlyNo(event)" >&nbsp;</td>
</tr>
<?php
...
<tr class="Dark" height="30"  >
   <td align="right" width="201" valign="middle" class="tblheading" >&nbsp;Phone No.&nbsp;</td>
    <td align="left"  valign="middle" class="tbltext" colspan="4">&nbsp;<input name="pstd1" type="text" size="5" class="tbltext" tabindex="" maxlength="5" onkeypress="return isNumberKey_OnlyNo(event)"  value="0"/>&nbsp;&nbsp;<input name="pphno1" type="text" size="15" class="tbltext" tabindex="" maxlength="12"  onkeypress="return isNumberKey_OnlyNo(event)" />&nbsp;STD | Phone</td>
  </tr>
<tr class="Light" height="25">
          <td width="201"  align="right"  valign="middle" class="tblheading" > Mobile&nbsp;No.&nbsp;</td>
           <td colspan="5" align="left"  valign="middle" >&nbsp;<input name="txtcontact1" type="text" size="16" class="tbltext" tabindex="0" maxlength="15"  onkeypress="return isNumberKey_OnlyNo(event)" />&nbsp;</td>
		   </tr>
		   <tr class="Dark" height="30">
<td align="right" width="201" valign="middle" class="tblheading" >TIN&nbsp;</td>
<td width="218" align="left"  valign="middle" class="tbltext">&nbsp;<input name="txttin" type="text" size="16" class="tbltext" tabindex=""   maxlength="15" on/>&nbsp;&nbsp;</td>

<td align="right" width="205" valign="middle" class="tblheading">PAN&nbsp;</td>
<td width="216" align="left"  valign="middle" class="tbltext">&nbsp;<input name="txtpan" type="text" size="16" class="tbltext" tabindex="" maxlength="15" >&nbsp;&nbsp;</td>
</tr>
</table>
</div>
 <table align="center" border="1" width="850" cellspacing="0" cellpadding="0" bordercolor="#cc30cc" style="border-collapse:collapse" > 
<tr class="Light" height="25">
 <td width="201"  align="right"  valign="middle" class="tblheading">&nbsp;Consignee Applicable&nbsp;</td>
  <td width="643" align="left"  valign="middle" class="tbltext" >&nbsp;<input name="contxt" type="radio" class="tbltext" value="Yes1" onClick="clkp(this.value);" />&nbsp;Yes&nbsp;&nbsp;<input name="contxt" type="radio" class="tbltext" value="No1" onClick="clkp(this.value);"  />&nbsp;No&nbsp;&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
</tr>
</table> 
<div id="fill22"style="display:none" >
<table align="center" border="1" width="850" cellspacing="0" cellpadding="0" bordercolor="#cc30cc" style="border-collapse:collapse"   > 
<tr class="Dark" height="25">
           <td width="201"  align="right"  valign="middle" class="tblheading" >Consignee Name&nbsp; </td>
           <td align="left"  valign="middle" colspan="3" >&nbsp;<input name="txtparty2" type="text" size="35" class="tbltext" tabindex="" maxlength="35" onchange="cnamechk(this.value);"  onBlur="javascript:this.value=FirstCharCap(this.value);"  />&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
         </tr>
 <tr class="Light" height="30">
<td width="201" align="right"  valign="middle" class="tblheading" >&nbsp;Address &nbsp;</td>
<td align="left"  valign="middle" class="tbltext" colspan="3">&nbsp;<textarea name="txtadd2" cols="50" rows="3" tabindex=""  onchange="caddchk(this.value);" onBlur="javascript:this.value=FirstCharCap(this.value);"  class="tbltext"></textarea>&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
</tr>

<tr class="Light" height="30">
<td width="201" align="right"  valign="middle" class="tblheading" >&nbsp;City/Town/Village&nbsp;</td>
<td align="left"  valign="middle" class="tbltext"  colspan="4">&nbsp;<input type="text" class="tbltext" name="txtcity2" size="20" maxlength="20" onchange="ccitychk(this.value);" onkeypress="return isCharKey(event)" onBlur="javascript:this.value=FirstCharCap(this.value);" >&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
</tr>
<tr class="Dark" height="30">
<td width="201" align="right"  valign="middle" class="tblheading" >&nbsp;Pin Code&nbsp;</td>
<td align="left"  valign="middle" class="tbltext" colspan="4">&nbsp;<input type="text" class="tbltext" name="txtpin2" size="6" maxlength="6" onkeypress="return isNumberKey_OnlyNo(event)" >&nbsp;</td>
</tr>
<?php
...
<tr class="Dark" height="30"  >
   <td align="right" width="201" valign="middle" class="tblheading" >&nbsp;Phone No.&nbsp;</td>
    <td align="left"  valign="middle" class="tbltext" colspan="4">&nbsp;<input name="pstd2" type="text" size="5" class="tbltext" tabindex="" maxlength="5" onkeypress="return isNumberKey_OnlyNo(event)"  value="0"/>&nbsp;&nbsp;<input name="pphno2" type="text" size="15" class="tbltext" tabindex="" maxlength="12"  onkeypress="return isNumberKey_OnlyNo(event)"  />&nbsp;STD | Phone</td>
  </tr>
<tr class="Dark" height="25">
          <td width="201"  align="right"  valign="middle" class="tblheading" >Mobile&nbsp;No.&nbsp;</td>
           <td colspan="5" align="left"  valign="middle" >&nbsp;<input name="txtcontact2" type="text" size="16" class="tbltext" tabindex="0" maxlength="15"  onkeypress="return isNumberKey_OnlyNo(event)" />&nbsp;</td>
		   </tr>
		   <tr class="Light" height="30">
<td align="right" width="201" valign="middle" class="tblheading" >TIN&nbsp;</td>
<td width="218" align="left"  valign="middle" class="tbltext">&nbsp;
  <input name="txttin2" type="text" size="16" class="tbltext" tabindex=""   maxlength="15" />&nbsp;&nbsp;</td>

<td align="right" width="205" valign="middle" class="tblheading" >PAN&nbsp;</td>
<td width="216" align="left"  valign="middle" class="tbltext">&nbsp;<input name="txtpan2" type="text" size="16" class="tbltext" tabindex="" maxlength="15"  >&nbsp;&nbsp;</td>
</tr>
</table>
</div>
<div id="fill22country"style="display:none" >
<table align="center" border="1" width="850" cellspacing="0" cellpadding="0" bordercolor="#cc30cc" style="border-collapse:collapse"   > 
<tr class="Dark" height="25">
           <td width="201"  align="right"  valign="middle" class="tblheading" >Consignee Name&nbsp; </td>
           <td align="left"  valign="middle" colspan="3" >&nbsp;<input name="txtparty2country" type="text" size="35" class="tbltext" tabindex="" maxlength="35" onchange="cnamechkcountry(this.value);"  onBlur="javascript:this.value=FirstCharCap(this.value);"  />&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
         </tr>
 <tr class="Light" height="30">
<td width="201" align="right"  valign="middle" class="tblheading" >&nbsp;Address &nbsp;</td>
<td align="left"  valign="middle" class="tbltext" colspan="3">&nbsp;<textarea name="txtadd2country" cols="50" rows="3" tabindex=""  onchange="caddchkcountry(this.value);" onBlur="javascript:this.value=FirstCharCap(this.value);"  class="tbltext"></textarea>&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
</tr>

<tr class="Light" height="30">
<td width="201" align="right"  valign="middle" class="tblheading" >&nbsp;City/Town&nbsp;</td>
<td align="left"  valign="middle" class="tbltext"  colspan="4">&nbsp;<input type="text" class="tbltext" name="txtcity2country" size="20" maxlength="20" onchange="ccitychkcountry(this.value);" onkeypress="return isCharKey(event)" onBlur="javascript:this.value=FirstCharCap(this.value);" >&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
</tr>
<tr class="Dark" height="30">
<td width="201" align="right"  valign="middle" class="tblheading" >&nbsp;Zip&nbsp;</td>
<td align="left"  valign="middle" class="tbltext" colspan="4">&nbsp;<input type="text" class="tbltext" name="txtpin2country" size="6" maxlength="6" onkeypress="return isNumberKey_OnlyNo(event)" >&nbsp;</td>
</tr>
<tr class="Light" height="30">
<td width="201" align="right"  valign="middle" class="tblheading" >&nbsp;State&nbsp;</td>
<td align="left"  valign="middle" class="tbltext" colspan="3">&nbsp;<input type="text" class="tbltext" name="txtstate2country" size="20" maxlength="20" onchange="cstatechkcountry(this.value);" onkeypress="return isCharKey(event)" onBlur="javascript:this.value=FirstCharCap(this.value);" >&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
</tr>
<tr class="Light" height="30">
<td width="205"  align="right"  valign="middle" class="tblheading">Country&nbsp;</td>
<td align="left"  valign="middle" class="tbltext" colspan="3">&nbsp;<input name="txtcountry1" type="text" size="16" class="tbltext" tabindex=""  value=""  maxlength="15" />
	&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
</tr>
<tr class="Dark" height="30"  >
   <td align="right" width="201" valign="middle" class="tblheading" >&nbsp;Phone No.&nbsp;</td>
    <td align="left"  valign="middle" class="tbltext" colspan="4">&nbsp;<input name="pstd2country" type="text" size="5" class="tbltext" tabindex="" maxlength="5" onkeypress="return isNumberKey_OnlyNo(event)"  value="0"/>&nbsp;&nbsp;<input name="pphno2country" type="text" size="15" class="tbltext" tabindex="" maxlength="12"  onkeypress="return isNumberKey_OnlyNo(event)"  />&nbsp;STD | Phone</td>
  </tr>
<tr class="Dark" height="25">
          <td width="201"  align="right"  valign="middle" class="tblheading" >Mobile&nbsp;No.&nbsp;</td>
           <td colspan="5" align="left"  valign="middle" >&nbsp;<input name="txtcontact2country" type="text" size="16" class="tbltext" tabindex="0" maxlength="15"  onkeypress="return isNumberKey_OnlyNo(event)" />&nbsp;</td>
		   </tr>
		   <tr class="Light" height="30">
<td align="right" width="201" valign="middle" class="tblheading" >UDF 1&nbsp;</td>
<td width="218" align="left"  valign="middle" class="tbltext">&nbsp;<input name="txttin2country" type="text" size="16" class="tbltext" tabindex=""   maxlength="15" />&nbsp;&nbsp;</td>

<td align="right" width="205" valign="middle" class="tblheading" >UDF 2&nbsp;</td>
<td width="216" align="left"  valign="middle" class="tbltext">&nbsp;<input name="txtpan2country" type="text" size="16" class="tbltext" tabindex="" maxlength="15"  >&nbsp;&nbsp;</td>
</tr>
</table>
</div>
<table align="center" border="1" width="850" cellspacing="0" cellpadding="0" bordercolor="#cc30cc" style="border-collapse:collapse" > 
<tr class="Light" height="30">
<td align="right" width="202" valign="middle" class="tblheading" >Order Placed By&nbsp;</td>
<td width="642" colspan="3" align="left"  valign="middle" class="tbltext">&nbsp;<input name="txtorderplby" type="text" size="20" class="tbltext" tabindex="" onkeypress="return isCharKey(event)" onBlur="javascript:this.value=FirstCharCap(this.value);" maxlength="20" onchange="orpbchk(this.value);"/>&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
</tr>

<tr class="Dark" height="25">
<td width="202" align="right"  valign="middle" class="tblheading">&nbsp;Mode of Dispatch&nbsp;</td>
 <td width="642" colspan="3" align="left"  valign="middle" class="tbltext" >&nbsp;<input name="txt1" type="radio" class="tbltext" value="Transport" onClick="clk(this.value);" />Transport&nbsp;<input name="txt1" type="radio" class="tbltext" value="Courier" onClick="clk(this.value);" />Courier&nbsp;<input name="txt1" type="radio" class="tbltext" value="By Hand" onClick="clk(this.value);" />Hand Delivery&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
</tr>
</table>
...
<td align="left"  valign="middle" class="tbltext" colspan="3" >&nbsp;<input name="txttname" type="text" size="35" class="tbltext" tabindex="" maxlength="35" onchange="trnamechk(this.value);" onBlur="javascript:this.value=FirstCharCap(this.value);" />  &nbsp;<font color="#FF0000">*</font>&nbsp;</td>
</tr>
</table>
</div>
...
<td align="left" width="642" valign="middle" class="tbltext" colspan="3" >&nbsp;<input name="txtcname" type="text" size="35" class="tbltext" tabindex="" onchange="crnamechk(this.value);"  maxlength="35" onBlur="javascript:this.value=FirstCharCap(this.value);" />&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
</tr>
</table>
</div>
...
<td width="642" colspan="3" align="left" valign="middle" class="tbltext">&nbsp;<input name="txtpname" type="text" size="35" class="tbltext" tabindex=""  maxlength="35" onkeypress="return isCharKey(event)" onchange="prnamechk(this.value);" onBlur="javascript:this.value=FirstCharCap(this.value);" />&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
</tr>
</table>
</div>
<br />
...
<table align="center" border="1" cellspacing="0" cellpadding="0" width="850" bordercolor="#cc30cc" style="border-collapse:collapse">
            <tr class="tblsubtitle" height="20">
              <td width="1%"  align="center" valign="middle" class="tblheading">#</td>
			 <td width="18%" align="center"  valign="middle" class="tblheading">Crop</td>
			  ...
			  <td width="9%" align="center" valign="middle" class="tblheading">UPS</td>
                <td  align="center" valign="middle" class="tblheading">Quantity (Kgs.)</td>
				<td width="12%"  align="center" valign="middle" class="tblheading">NoP</td>
                          <td width="11%"  align="center" valign="middle" class="tblheading">Edit</td>
...
<input type="hidden" name="itmdchk" value="" /><input type="hidden" name="itmdchk1" value="" />
</table>
 <table align="center" border="1" width="850" cellspacing="0" cellpadding="0" bordercolor="#cc30cc" style="border-collapse:collapse" > 
...
<input name="txtupschk" value="" type="hidden"> 
</table> 
