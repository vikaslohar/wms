...
<title>Order-Party wise -Order Search</title>
...
function openslocpopprint(itmid)
{
//alert(itmid);

winHandle=window.open('booked_order_details.php?itmid='+itmid,'WelCome','top=170,left=180,width=820,height=450,scrollbars=yes');
if(winHandle==null){
...
<table width="1003" height="600" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  <tr>
    <td valign="top"><table width="1003" height="72" border="0" cellspacing="0" cellpadding="0" align="center">
        <tr>
          <td valign="top">&nbsp;
          <?php require_once("../include/arr_order.php");?></td>
        </tr>
      </table>
...
$srno=1;
//$txtlot1;
$sqlt="select * from tbl_orderm where plantcode='$plantcode' and  orderm_porderno like '%".$a."%' and orderm_tflag=1";
$sql_tbl=mysqli_query($link,$sqlt)or die(mysqli_error($link));
  ...
  if($tot_crop > 0)
{
	while($row_arr=mysqli_fetch_array($sql_tbl))
	{
		...
		else if( $row_arr['orderm_cancelflag']==0 && $row_arr['orderm_supflag']==0 && $row_arr['orderm_tflag']==1 && $row_arr['orderm_holdflag']==0 && $sql_tbl2['order_sub_hold_flag']==0 && $row_arr['orderm_dispatchflag']==0)
		{
		  $dispatch="Live";
		}
		...
		else if($row_arr['orderm_dispatchflag']==2)
		{
...
<tr class="Light" height="20">
          ...
          <td align="center" valign="middle" class="smalltblheading">&nbsp;<a href="Javascript:void(0)" onClick="openslocpopprint('<?php echo $arrival_id;?>');">View</a></td>
...
<tr >
<td valign="top" align="right"><a href="utility_ordersearch.php"><img src="../images/back.gif" alt="Back" border="0" style="display:inline;cursor:hand;" /></a>&nbsp;&nbsp;</td>
</tr>
</table>
</form> 
</td>
