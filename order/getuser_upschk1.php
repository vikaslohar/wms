...
<td width="105" align="center"  valign="middle" class="smalltbltext" >&nbsp;<select name="txtuptypchk_<?php echo $srn?>" id="txtuptypchk_<?php echo $srn?>" class="smalltbltext" style="width:55px;" onchange="uptypchk(this.value,'<?php echo $srn?>','<?php echo $c;?>');">
	<?php if($mtyp[$cnt]=="Yes") { ?>
	...
	</select>&nbsp;<div id="stdpt_<?php echo $srn?>" style="display:inline;" class="smalltbltext"><input type="text" name="stdptval_<?php echo $srn;?>" class="smalltbltext" id="stdptval_<?php echo $srn;?>" value="<?php if($mtyp[$cnt]=="Yes") { echo $wtmp[$cnt];} else if($wbtype[$cnt]=="Yes") {echo $wtnop[$cnt];} else { echo $row_var['uom'];}?>" size="2" readonly="true" style="background-color:#F0F0F0" /></div>
</td>
...
<td width="60"  align="left"  valign="middle" class="smalltbltext"  >&nbsp;<input name="txtnopdc_<?php echo $srn?>" id="txtnopdc_<?php echo $srn?>" type="text" size="4" class="smalltbltext" tabindex="" maxlength="6" readonly="true" style="background-color:#CCCCCC"  />&nbsp;&nbsp;</td>
