...
/*$sql_tbl=mysqli_query($link,"select * from tblarrival where arr_role='".$logid."' and  arrival_type='StockTransfer Arrival' and arrtrflag=0") or die(mysqli_error($link));
...
$ycode=$noticia3['ycode'];		
	if(isset($_POST['frm_action'])=='submit')
	{
		...
		if($sdate1!="" && $edate1!="")
		{
		echo "<script>window.location='home_hold1.php?sdate=$sdate1&edate=$edate1'</script>";
		}
		else
		{
...
$sql_arr_home=mysqli_query($link,"select * from tblarrival where plantcode='$plantcode' and arrival_type='StockTransfer Arrival' and arrtrflag=1 order by arr_code desc LIMIT $from, $max_results") or die(mysqli_error($link));
$tot_arr_home=mysqli_num_rows($sql_arr_home);
...
<table align="center" border="1" cellspacing="0" cellpadding="0" width="970" bordercolor="#cc30cc" style="border-collapse:collapse">
  <tr class="tblsubtitle" height="20">
    ...
    <td width="12%" align="center" valign="middle" class="tblheading">Order Number</td>
    <td width="11%" align="center" valign="middle" class="tblheading">Party Order Ref. No.</td>
    <td width="13%" align="center" valign="middle" class="tblheading">Party Name</td>
    <td width="10%" align="center" valign="middle" class="tblheading">Party Location </td>
    <td width="6%" align="center" valign="middle" class="tblheading">Consignee Location</td>
    <td width="5%" align="center" valign="middle" class="tblheading">Order By</td>
    <td width="6%" align="center" valign="middle" class="tblheading">Number of Varieties</td>
...
$quer3=mysqli_query($link,"SELECT * FROM tblcrop  where cropid='".$row_tbl_sub['lotcrop']."'"); 
	$row31=mysqli_fetch_array($quer3);
	 //$crop=$row31['cropname'];
		...
		$lrole=$row_arr_home['arr_role'];
	$quer3=mysqli_query($link,"SELECT business_name FROM tbl_partymaser where plantcode='$plantcode' and p_id='".$row_arr_home['party_id']."'"); 
...
?>
  <tr class="Light">
    ...
    <td width="10%" align="center" valign="middle" class="smalltblheading"><?php echo "AS".$row_arr_home['arr_code']."/".$ycode."/".$lrole;?></td>
 ...
 <!--   <td width="7%" align="center" valign="middle" class="smalltblheading"><?php echo $qc?></td>
    ...
    <td width="4%" align="center" valign="middle" class="smalltblheading"><a href="Javascript:void(0)" onclick="openslocpopprint('<?php echo $row_arr_home['arrival_id'];?>');">SON</a></td>
  </tr>
  <?php
}
else
