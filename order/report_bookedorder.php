<?php
	...
	if(isset($_POST['frm_action'])=='submit')
	{
		...
		$txtups = $_POST['txtups'];
		$txtordersts = $_POST['txtordersts'];
		//exit;
		echo "<script>window.location='report_bookedorder1.php?sdate=$sdate&edate=$edate&txtstatesl=$txtstatesl&txtlocationsl=$txtlocationsl&txtparty=$txtparty&txtcrop=$txtcrop&txtvariety=$txtvariety&txtordertyp=$txtordertyp&txtups=$txtups&txtordersts=$txtordersts'</script>";
	}
?>
...
<title>Order - Report - Booked Order Status Report</title>
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#cc30cc" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#cc30cc" style="border-bottom:solid; border-bottom-color:#cc30cc" >
	    <tr >
	      <td width="813" height="30"class="Mainheading"  >&nbsp;Booked Order Status Report  
	        </td>
	    </tr></table></td>
	  </tr>
	  </table></td></tr>
...
<tr class="tblsubtitle" height="25">
  <td colspan="4" align="center" class="tblheading">Booked Order Status Report</td>
</tr>
...
<td align="right"  valign="middle" class="tblheading">Order Status&nbsp;</td>
<td align="left"  valign="middle" class="tbltext">&nbsp;<select class="tbltext" name="txtordersts" style="width:170px;" onchange="ortpchk();">
<option value="ALL" selected>ALL</option>
<option value="pending">Pending Orders</option>
<option value="dispatch">Dispatched Orders</option>
<option value="suspend">Suspended Orders</option>
<option value="cancel">Canceled Orders</option>
</select>&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
</tr>
   <?php
