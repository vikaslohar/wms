...
var txtordersts=document.frmaddDepartment.txtordersts.value;

winHandle=window.open('report_bookedorder2.php?sdate='+sdate+'&edate='+edate+'&txtstatesl='+txtstatesl+'&txtlocationsl='+txtlocationsl+'&txtparty='+txtparty+'&txtcrop='+txtcrop+'&txtvariety='+txtvariety+'&txtordertyp='+txtordertyp+'&txtups='+txtups+'&txtordersts='+txtordersts,'WelCome','top=20, left=80, width=1000, height=900, scrollbars=yes');
if(winHandle==null){
  ...
  <tr><td>
   ...
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#cc30cc" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#cc30cc" style="border-bottom:solid; border-bottom-color:#cc30cc" >
	    <tr >
	      <td width="813" height="25">&nbsp;Booked Order Status Report</td>
	    </tr></table></td>
	  </tr>
	  </table></td></tr>
	...
	<input name="txtordersts" value="<?php echo $txtordersts;?>" type="hidden"> 
...
if($txtvariety!="ALL")
{
	$sql_mont=mysqli_query($link,"select varietyid, popularname from tblvariety where varietyid='".$txtvariety."'  order by popularname")or die(mysqli_error($link));
...
{
$trdate=""; $orno=""; $porrefno=""; $party=""; $loca=""; $statee=""; $crp1=""; $ver1="";
...
{	
	...
	//if($txtups!="ALL")
	//$sqlsubsub=mysqli_query($link,"select * from tbl_order_sub_sub where orderm_id='".$row_arr_home['orderm_id']."' and order_sub_id='".$row_subor['order_sub_id']."' and order_sub_sub_ups='$txtups' group by order_sub_sub_ups") or die(mysqli_error($link));
//	else
...
//echo $c." =  ".$oqt."<br />";
//echo $orno."  -  ".$row_arr_home['orderm_dispatchflag']."  ".$row_arr_home['orderm_cancelflag']."  ".$row_arr_home['orderm_supflag']."<br />";
...
<tr >
<td align="center" valign="middle"><a href="report_bookedorder.php"><img src="../images/back.gif" border="0"  style="display:inline;cursor:pointer;"/></a>&nbsp;&nbsp;<img src="../images/printpreview.gif" onclick="openprint()" style="cursor:pointer" border="0" /><input type="hidden" name="txtinv" /></td>
</tr>
</table>
</td><td ></td>
</tr>
