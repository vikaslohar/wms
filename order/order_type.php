...
//$a="c";
	//$a="c";
	$sql_code="SELECT MAX(arrival_code) FROM tblarrival where arrival_type='StockTransfer Arrival'  ORDER BY arrival_code DESC";
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#a8a09e" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#a8a09e" style="border-bottom:solid; border-bottom-color:#a8a09e" >
	    <tr >
	      <td width="813" height="25" class="Mainheading">&nbsp;Transaction - Order Type </td>
	    </tr></table></td>
...
<table align="center" border="1" width="252" cellspacing="0" cellpadding="0" bordercolor="#a8a09e" style="border-collapse:collapse" > 

<tr class="tblsubtitle" height="25">
  <td colspan="4" align="center" class="tblheading">Order Types</td>
</tr>
<tr class="Light" height="25">
  <td width="248" align="center"  valign="middle" class="tblheading"  >&nbsp;&nbsp; &nbsp;&nbsp;<a href="add_order_bulk.php">Sales Bulk</a> </td>
</tr>
<tr class="Dark" height="25">
 <td width="248" align="center"  valign="middle" class="tblheading">&nbsp;&nbsp;&nbsp;&nbsp;<a href="add_sales_channel.php">Sales Channel</a></td >
 </tr>
 <tr class="Light" height="25">
 <td width="248" align="center"  valign="middle" class="tblheading">&nbsp;&nbsp;&nbsp;<a  href="add_tdf.php"> Trial/Demo/Free</a></td>  
</tr>
 <tr class="Light" height="25">
 <td width="248" align="center"  valign="middle" class="tblheading">&nbsp;&nbsp;&nbsp;<a  href="add_stocktransfer.php">Stock Transfer</a></td>  
</tr>
</table>
