...
<table width="1003" height="600" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    ...
    <td valign="top"><table width="1003" height="72" border="0" cellspacing="0" cellpadding="0" align="center">
      ...
      <table width="100%" style=" z-index:-1;" height="auto" align="center" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td width="100%" valign="top" height="470" align="center"  class="midbgline">
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#cc30cc" >
	  ...
	  <table width="820" border="0" cellpadding="0" cellspacing="0" bordercolor="#cc30cc" style="border-bottom:solid; border-bottom-color:#cc30cc" >
	    <tr >
	      <td width="820" height="25" > &nbsp; Transaction - Holding - Unholding </td>
	    </tr></table></td>
...
<td align="center" width="100" valign="middle" class="tblbutn" style="cursor:Pointer;"><?php if($flg==0 && $flg1==0 && $flg2==0) { ?><a href="add_hold.php" style="text-decoration:none; color:#000000">Add </a><?php } else { ?><a href="Javascript:void(0);" onClick="alert('Can not perform Transaction.\nReason:\n1. Todays date is not in Active Current Financial Year.\n2. Transaction after todays date has been made.\n3. Cycle Inventory transaction is under process.');" style="text-decoration:none; color:#000000">Add </a><?php } ?></td>
</tr>
</table></td>
...
<?php
/*
$sql_arr_home=mysqli_query($link,"select * from tblarrival where arrival_type='StockTransfer Arrival' and arrtrflag=1") or die(mysqli_error($link));
...
<?php
  ...
  $sql_arr_home=mysqli_query($link,"select * from tblarrival where arrival_date >='$tdate' and arrival_date <='$pdate' and arrival_type='StockTransfer Arrival' and arrtrflag=1 order by arr_code desc LIMIT $start, $limit") or die(mysqli_error($link));
 $tot_arr_home=mysqli_num_rows($sql_arr_home);
...
$query = "select * from tblarrival where arrival_date >='$tdate' and arrival_date <='$pdate' and arrival_type='StockTransfer Arrival' and arrtrflag=1 order by arr_code desc";
...
$sql_arr_home=mysqli_query($link,"select * from tblarrival where arrival_date >='$tdate' and arrival_date <='$pdate' and arrival_type='StockTransfer Arrival' and arrtrflag=1 order by arr_code desc LIMIT $from, $max_results") or die(mysqli_error($link));
$tot_arr_home=mysqli_num_rows($sql_arr_home);

$total_results3 =mysqli_query($link,"SELECT COUNT(*)  FROM tblarrival where arrival_date >='$tdate' and arrival_date <='$pdate'  and arrival_type='StockTransfer Arrival' and arrtrflag=1");
$total_results2 = mysqli_fetch_array($total_results3);
$total_results = $total_results2[0]; 
...
<tr class="Light" height="20">
  <td colspan="6" align="center" class="tblheading">Holding -Unholding</td>
</tr>
</table>
<table align="center" border="1" cellspacing="0" cellpadding="0" width="970" bordercolor="#cc30cc" style="border-collapse:collapse">
            ...
            <tr class="tblsubtitle" height="20">
			 ...
			 <td width="9%" align="center" valign="middle" class="tblheading">Transaction Id</td>
              ...
              <td width="6%" align="center" valign="middle" class="tblheading">Seed Stage</td>
...
$acn=$row_tbl_sub['act1'];
	...
	$quer3=mysqli_query($link,"SELECT * FROM tblvariety where varietyid ='".$row_tbl_sub['lotvariety']."'"); 
...
<tr class="Light">
         ...
         <td width="9%" align="center" valign="middle" class="smalltblheading"><?php echo "AS".$row_arr_home['arr_code']."/".$ycode."/".$lrole;?></td>
