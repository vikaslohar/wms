...
/*$sql_tbl=mysqli_query($link,"select * from tblarrival where arr_role='".$logid."' and  arrival_type='Fresh Seed with PDN' and arrtrflag=0") or die(mysqli_error($link));
while($row_tbl=mysqli_fetch_array($sql_tbl))
{
	...
	$s_sub="delete from tblarrival where arr_role='".$logid."' and arrival_type='Fresh Seed with PDN' and arrtrflag=0";
	mysqli_query($link,$s_sub) or die(mysqli_error($link));	
*/
...
$sql_arr_home=mysqli_query($link,"select * from tblarrival where plantcode='$plantcode' and arrival_type='Fresh Seed with PDN' and arrtrflag=1 order by arr_code desc LIMIT $from, $max_results") or die(mysqli_error($link));
$tot_arr_home=mysqli_num_rows($sql_arr_home);

$total_results3 =mysqli_query($link,"SELECT COUNT(*)  FROM tblarrival where plantcode='$plantcode' and arrival_type='Fresh Seed with PDN' and arrtrflag=1");
...
<table align="center" border="1" cellspacing="0" cellpadding="0" width="970" bordercolor="#F1B01E" style="border-collapse:collapse">
            ...
            <tr class="tblsubtitle" height="20">
			 ...
			 <td width="9%" align="center" valign="middle" class="tblheading">Trans. Id</td>
              ...
              <td colspan="2" align="center" valign="middle" class="tblheading">Output</td>
...
<tr class="Light">
         ...
         <td width="9%" align="center" valign="middle" class="smalltblheading"><?php echo "AF".$row_arr_home['arr_code']."/".$ycode."/".$lrole;?></td>
         ...
         <td width="4%" align="center" valign="middle" class="smalltblheading"><a href="Javascript:void(0)" onClick="openslocpopprint('<?php echo $row_arr_home['arrival_id'];?>');">FRN</a></td>
		</tr>
<?php
}
else
