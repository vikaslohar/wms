<?php
	...
	$p_id=trim($_POST['maintrid']);
		...
		//echo $party=str_replace("C&F","CandF",$party);
		...
		echo "<script>window.location='add_orderstock_preview.php?p_id=$p_id&remarks=$remarks&txtconchk=$txtconchk&txtupschk=$txtupschk&txtordno=$txtordno&txtporf=$txtporf&txtstfp=$txtstfp&txt12=$txt12&txtparty=$txtparty&txtadd=$txtadd&txtcity=$txtcity&txtstate=$txtstate&pstd=$pstd&pphno=$pphno&txtcontact=$txtcontact&txtctin=$txtctin&txtccst=$txtccst&txtpin=$txtpin&txtorderplby=$txtorderplby&txt11=$txt11&txttname=$txttname&txtlrn=$txtlrn&txtvn=$txtvn&txt13=$txt13&txtcname=$txtcname&txtdc=$txtdc&txtpname=$txtpname&txtpp=$party&txtstatesl=$txtstatesl&txtlocationsl=$txtlocationsl'</script>";	
...
$ycode=$noticia3['ycode'];
	...
	$sql_code="SELECT MAX(orderm_code) FROM tbl_orderm where plantcode='$plantcode' and order_trtype='Order Stock' and yearcode='$ycode' ORDER BY orderm_code DESC";
...
<title>Order- Transaction -Stock Transfer</title>
...
/*if(classval=="C&F")
	...
	(classval="CandF")
		...
		showUser(classval,'vitem1','item1',loc,'','','','',classval);
		}*/
}
function cropchk()
{
	...
	if(document.frmaddDepartment.txtconchk.value=="Yes")
{
	...
	{	
		...
		//alert(a);
		//document.frmaddDepartment.abc.value=a;
...
*/							if(val3=="Gms")
					...
					{	
						...
						/*	alert("The entered quantity is not a divisible number by standard weight of Master Pack\nYou need to enter: either\n1) "+parseFloat(rndd4)+"\n       OR\n2) "+parseFloat(rndu4)+"\nor any other qty divisble by standard weight of the selected pack type");
							document.getElementById('txtnopdc_'+[val4]).value="";
							document.getElementById('txtqtydc_'+[val4]).value="";
							document.getElementById('txtnopwb_'+[val4]).value="";
							document.getElementById('txtnopmp_'+[val4]).value="";
...
function clk(opt)
{
	...
	if(opt!="")
	{
		if(opt=="Transport")
		{
			...
			document.frmaddDepartment.txtcname.value="";
			//document.frmaddDepartment.txtdc.value="";
			document.frmaddDepartment.txtpname.value="";
		}
		else if(opt=="Courier")
		{
			...
			//document.frmaddDepartment.txtlrn.value="";
			//document.frmaddDepartment.txtvn.value="";
			//document.getElementById('txt13').SelectedIndex=0;
			document.frmaddDepartment.txtpname.value="";
		}	
		else 
		{
...
function stateslchk(valloc)
{
	...
	{
		classval=document.frmaddDepartment.txtpp.value;
		if(classval=="C&F")
		{
		(classval="CandF")
		}
		//var loc=document.frmaddDepartment.txtlocationsl.value;
		showUser(classval,'vitem1','item1',valloc,'','','','',classval);
	}
}
function itemcheck()
{
...
<tr class="tblsubtitle" height="20">
  <td colspan="6" align="center" class="tblheading">Add Order - Stock Transfer</td>
</tr>
...
<td align="left"  valign="middle" class="tbltext"  colspan="3">&nbsp;<select class="tbltext" name="txtpp" style="width:80px;" onchange="modetchk1(this.value)">
...
<td align="left"  valign="middle" class="tbltext">&nbsp;<select class="tbltext" name="txtstatesl" style="width:160px;" onchange="locslchk(this.value)">
...
<td align="left"  valign="middle" class="tbltext"  colspan="3" id="vitem1">&nbsp;<select class="tbltext" id="itm1" name="txtstfp" style="width:220px;" onchange="showUser(this.value,'vaddress','vendor','','','','','');" tabindex="0" >
...
<tr class="Light" height="25">
           ...
           <td align="left"  valign="middle" colspan="3" >&nbsp;<input name="txtparty" type="text" size="35" class="tbltext" tabindex="" maxlength="35"  onBlur="javascript:this.value=FirstCharCap(this.value);" onkeypress="return isCharKey(event)"/>&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
         </tr>
 <tr class="Dark" height="30">
<td width="206" align="right"  valign="middle" class="tblheading">&nbsp;Address&nbsp;</td>
<td align="left"  valign="middle" class="tbltext"  colspan="3">&nbsp;<textarea name="txtadd" cols="50" rows="3" tabindex=""  class="tbltext" onchange="caddchk(this.value);" onBlur="javascript:this.value=FirstCharCap(this.value);"></textarea>&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
</tr>
...
<tr class="Dark" height="30"  >
   <td align="right" width="206" valign="middle" class="tblheading" >&nbsp;Phone No.&nbsp;</td>
    <td align="left"  valign="middle" class="tbltext" colspan="4">&nbsp;<input name="pstd" type="text" size="5" class="tbltext" tabindex="" maxlength="5" onkeypress="return isNumberKey(event)" value="0"/>&nbsp;&nbsp;<input name="pphno" type="text" size="15" class="tbltext" tabindex="" maxlength="12" onkeypress="return isNumberKey(event)"/>&nbsp;STD | Phone</td>
  </tr>
<tr class="Light" height="25">
...
<table align="center" border="1" width="850" cellspacing="0" cellpadding="0" bordercolor="#cc30cc" style="border-collapse:collapse" > 
<tr class="Light" height="30">
<td align="right" width="207" valign="middle" class="tblheading" >Order Placed By&nbsp;</td>
<td align="left"  valign="middle" class="tbltext" colspan="3">&nbsp;<input name="txtorderplby" type="text" size="20" class="tbltext" tabindex=""   maxlength="20" onchange="orplchk();"onkeypress="return isCharKey(event)"onBlur="javascript:this.value=FirstCharCap(this.value);" />&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
</tr>
<tr class="Dark" height="25">
<td width="207" align="right"  valign="middle" class="tblheading">&nbsp;Preferred Mode of Dispatch&nbsp;</td>
 <td width="637" colspan="3" align="left"  valign="middle" class="tbltext" ><input name="txt1" type="radio" class="tbltext" value="Transport" onClick="clk(this.value);" />Transport&nbsp;<input name="txt1" type="radio" class="tbltext" value="Courier" onClick="clk(this.value);" />Courier&nbsp;<input name="txt1" type="radio" class="tbltext" value="By Hand" onClick="clk(this.value);" />Hand Delivery&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
</tr>
</table>
...
<td width="125" align="right"  valign="middle" class="tblheading">Select Crop&nbsp;</td>
<td width="191" align="left"  valign="middle" class="tbltext" >&nbsp;<select class="tbltext" name="txtcrop" style="width:170px;" onchange="modetchk(this.value)">
...
<option value="" selected>--Select Variety-</option>
 ...
 <table align="center" border="1" width="850" cellspacing="0" cellpadding="0" bordercolor="#cc30cc" style="border-collapse:collapse" > 
		...
		<tr class="Light" height="25">
<td align="right" width="126" valign="middle" class="tblheading" style="border-color:#cc30cc">&nbsp;Select UPS Type&nbsp;</td>
   <td width="718" colspan="3" align="left"  valign="middle" ><input name="txtup" type="radio" class="tbltext" value="Yes" onClick="clkp1(this.value);" />&nbsp;Standard&nbsp;&nbsp;<input name="txtup" type="radio" class="tbltext" value="No" onClick="clkp1(this.value);"  />&nbsp;Non-Standard&nbsp;&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
</tr>
...
<td width="656" align="left"  valign="middle" class="tbltext">&nbsp;<input type="text" name="txtremarks" class="tbltext" size="120" maxlength="90" ></td>
</tr>
</table>

<table align="center" width="850" cellpadding="5" cellspacing="5" border="0" >
<tr >
<td valign="top" align="right"><a href="home_orst.php" tabindex="20"><img src="../images/cancel.gif" border="0"style="display:inline;cursor:hand;" onclick="return confirm('Do You wish to Cancel this Transaction?');" /></a>&nbsp;&nbsp;<input name="Submit" type="image" src="../images/preview.gif" alt="Submit Value"  border="0" style="display:inline;cursor:hand;" tabindex="" onClick="return mySubmit();">&nbsp;&nbsp;</td>
</tr>
</table>
</td><td width="30"></td>
</tr>
