...
$a123456=mysqli_query($link,$sql_main) or die(mysqli_error($link));
	...
	if(isset($_POST['frm_action'])=='submit')
	{
		...
		$sql_code="SELECT MAX(orderm_trcode) FROM tbl_orderm where plantcode='$plantcode' and order_trtype='Order Sales' and yearcode='$ycode' ORDER BY orderm_trcode DESC";
		...
		$sql_code12="SELECT MAX(orderm_ncode) FROM tbl_orderm where plantcode='$plantcode' and order_trtype='Order Sales' and yearcode='$ycode' ORDER BY orderm_ncode DESC";
	...
	$a123456=mysqli_query($link,$sql_main) or die(mysqli_error($link));
		...
		echo "<script>window.location='select_ordersale_op.php?p_id=$pid'</script>";	
	}
?>
...
<title>Order Transaction - Order Sales- Preview</title>
...
winHandle=window.open('order_view.php?itmid='+itm+'&remarks='+remarks,'WelCome','top=170,left=180,width=820,height=350,scrollbars=yes');
if(winHandle==null){
...
<tr class="tblsubtitle" height="20">
  <td colspan="6" align="center" class="tblheading">Order - Sales Preview </td>
</tr>
<tr height="15"><td colspan="6" align="right" class="tblheading"><font color="#FF0000" >* </font>indicates required field&nbsp;</td></tr>

 <tr class="Dark" height="30">
<td width="196" align="right" valign="middle" class="tblheading">&nbsp;Transaction Id&nbsp;</td>
<td width="216"  align="left" valign="middle" class="tbltext">&nbsp;<?php echo "TOS".$row_tbl['orderm_code']."/".$ycode."/".$lgnid;?></td>

<td width="231" align="right"  valign="middle" class="tblheading" >&nbsp;Date&nbsp;</td>
<td align="left" width="297" valign="middle" class="tbltext" colspan="3">&nbsp;<?php echo $tdate;?></td>
</tr>
<?php
	$quer3=mysqli_query($link,"SELECT * FROM tbl_partymaser where p_id='".$row_tbl['orderm_party']."'"); 
	$row3=mysqli_fetch_array($quer3);
?>
<tr class="Ligit" height="30">
<td align="right" width="196" valign="middle" class="tblheading">&nbsp;Order No.&nbsp;</td>
<td align="left" width="216" valign="middle" class="tbltext">&nbsp;<?php echo $row_tbl['orderm_porderno'];?></td>
<td align="right" width="231" valign="middle" class="tblheading">&nbsp;Party Order Ref. No.&nbsp;</td>
<td align="left" width="297" valign="middle" class="tbltext">&nbsp;<?php echo $row_tbl['orderm_partyrefno'];?></td>
</tr>
...
<td align="left" width="216" valign="middle" class="tbltext">&nbsp;<?php echo $row_tbl['orderm_locstate'];?></td>
<td align="right" width="231" valign="middle" class="tblheading">&nbsp;Location&nbsp;</td>
<td align="left" width="297" valign="middle" class="tbltext">&nbsp;<?php echo $noticia['productionlocation'];?></td>
</tr>
<?php
}
else
...
<td align="left"  valign="middle" class="tbltext" colspan="6" id="vaddress"><div style="padding-left:4px"><?php echo $row3['address'];?><?php if($row3['city']!=""){ echo ", ".$row3['city'];}?> - <?php echo $row3['state'];?><?php if($row_tbl['orderm_country']!=""){ echo ", ".$row_tbl['orderm_country'];}?><?php if($row3['pin']!=0 && $row3['pin']!=""){echo ", Pin no.-".$row3['pin'];}?><?php if($row3['mob']!="" && $row3['mob']!=0){echo ", Mob no.-".$row3['mob'];}?><?php if($row3['phone']!=""){echo ", Phone no. ".$row3['std']."-".$row3['phone'];}?><?php if($row3['tin']!=""){echo ", Tin no.-".$row3['tin'];}?><?php echo ".";?></div></td>
</tr>
<tr class="Dark" height="30">
...
?>
<tr class="Light" height="30">
<td align="right" width="196" valign="middle" class="tblheading">&nbsp;Consignee Name&nbsp;</td>
...
<td align="right"  width="196" valign="middle" class="tblheading">Address&nbsp;</td>
...
?>
<tr class="Dark" height="30">
<td align="right" width="196" valign="middle" class="tblheading">&nbsp;Order Placed By&nbsp;</td>
...
<td width="878" colspan="20" align="left"  valign="middle" class="tbltext"><div style="padding:5px, 5px, 5px, 5px;">&nbsp;<?php echo $remarks;?></div></td>
</tr>
</table> 
<table align="center" width="950" cellpadding="5" cellspacing="5" border="0" >
<tr >
<td valign="top" align="right"><a href="edit_order.php?p_id=<?php echo $p_id;?>"><img src="../images/edit.gif" border="0"style="display:inline;cursor:Pointer;" /></a>&nbsp;&nbsp;<a href="Javascript:void(0)" onclick="openslocpopprint();"><img src="../images/printpreview.gif" border="0"style="display:inline;cursor:Pointer;" /></a>&nbsp;&nbsp;<input name="Submit" type="image" src="../images/finalsubmit.gif" alt="Submit Value"  border="0" style="display:inline;cursor:Pointer;" tabindex="" onClick="return mySubmit();">&nbsp;&nbsp;</td>
</tr>
</table>
</td><td width="30"></td>
</tr>
