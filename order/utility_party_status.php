...
<title>Order-Utlity-Hold Status-Party Wise </title>
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#cc30cc" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#cc30cc" style="border-bottom:solid; border-bottom-color:#cc30cc" >
	    <tr >
	      <td width="813" height="30"class="Mainheading"  >&nbsp;Utility -Holding Status-Party wise</td>
	    </tr></table></td>
	  </tr>
	  </table></td></tr>
...
$typ = $_REQUEST['typ'];
	...
	$sql_arr_home=mysqli_query($link,"select * from tblarrival where plantcode='$plantcode' and arrival_type='$typ' and  arrival_date ='$sdate' and arrtrflag=1 order by arrival_date asc ") or die(mysqli_error($link));
...
<table align="center" border="1" width="850" cellspacing="0" cellpadding="0" bordercolor="#cc30cc" style="border-collapse:collapse" >
                <tr class="tblsubtitle" height="25">
                  <td colspan="4" align="center" class="tblheading">Party-wise-Holding Status		
</td>
                </tr>
                <tr height="15">
...
<table align="center" border="1" width="850" cellspacing="0" cellpadding="0" bordercolor="#cc30cc" style="border-collapse:collapse" >
	...
	<tr class="Light" height="25">
    	<td align="right" height="30" valign="middle" class="tblheading">&nbsp;Trial /Demo/Free&nbsp;(TDF)&nbsp;</td>
...
<div id="categorytyp" style="display:none"></div>		
                ...
                <table width="850" align="center" cellpadding="5" cellspacing="5" border="0" >
                  <tr >
                    <td valign="top" align="center"><a href="utility_hold.php"><img src="../images/back.gif" border="0"  style="display:inline;cursor:pointer;"/></a>&nbsp;<input name="Submit" type="image" src="../images/next.gif" alt="next Value"  border="0" style="display:inline;cursor:pointer;" onClick="return mySubmit();" />
