...
$up=""; $qt=""; $qt1=""; $np=""; $nowbp=""; $nompp=""; $ptp=""; $stdptv="";
...
<td width="105" align="center"  valign="middle" class="smalltbltext" >&nbsp;<select name="txtuptypchk_<?php echo $srn?>" id="txtuptypchk_<?php echo $srn?>" class="smalltbltext" style="width:55px;" onchange="uptypchk(this.value,'<?php echo $srn?>','<?php echo $row_tbl_sub['order_sub_variety'];?>');">
	<?php if($mtyp[$cnt]=="Yes") { ?>
...
<td width="111"  align="center"  valign="middle" class="smalltbltext"  >&nbsp;<input name="txtqtydc_<?php echo $srn?>" id="txtqtydc_<?php echo $srn?>" type="text" size="7" class="smalltbltext" tabindex="" maxlength="9" value="<?php echo $qt;?>" style="background-color:#CCCCCC" />&nbsp;Kgs.&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
...
{
if($row_tbl['orderm_party_type']=="Bulk")
{
?>
<?php
$snn=0;
$sql_sloc=mysqli_query($link,"select * from tbl_order_sub_sub where plantcode='$plantcode' and orderm_id='".$b."' and order_sub_id='".$a."' order by order_sub_sub_id") or die(mysqli_error($link));
$tsubsub=mysqli_num_rows($sql_sloc);
?>
<table align="center" border="1" width="850" cellspacing="0" cellpadding="0" bordercolor="#cc30cc" style="border-collapse:collapse" > 
<?php
while($row_sloc=mysqli_fetch_array($sql_sloc))
...
<td width="737" align="left"  valign="middle" class="smalltbltext" >&nbsp;<input name="txtqtydc_<?php echo $snn?>" id="txtqtydc_<?php echo $snn?>" type="text" size="9" class="smalltbltext" tabindex="" maxlength="9" value="<?php echo $qt1;?>" onkeypress="return isNumberKey1(event)" onchange="nopchk(this.value,'','','<?php echo $snn?>')"   />&nbsp;Kgs.&nbsp;<font color="#FF0000">*</font>&nbsp;<input name="txtupsdc_1" id="txtupsdc_1" type="hidden" size="10" class="smalltbltext" tabindex="" maxlength="9" onkeypress="return isNumberKey1(event)" /><input name="txtnopdc_1" id="txtnopdc_1" type="hidden" size="9" class="smalltbltext" tabindex="" maxlength="9" readonly="true" style="background-color:#CCCCCC"  /></td>
</tr>
<?php
}
if($tsubsub==0)
