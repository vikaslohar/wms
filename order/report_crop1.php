<?php
	...
	echo "<script>window.location='report_crop_wise1.php?sdate=$sdate&edate=$edate&txtstatesl=$txtstatesl&txtlocationsl=$txtlocationsl&txtparty=$txtparty&txtcrop=$txtcrop&txtvariety=$txtvariety&txtordertyp=$txtordertyp&txtups=$txtups'</script>";
	}
?>
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#cc30cc" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#cc30cc" style="border-bottom:solid; border-bottom-color:#cc30cc" >
	    <tr >
	      <td width="813" height="30"class="Mainheading"  >&nbsp;Crop Variety wise Compiled Pending Order Report </td>
	    </tr></table></td>
	  </tr>
	  </table></td></tr>
          ...
          <tr>
            ...
            <td><table align="center" border="1" width="850" cellspacing="0" cellpadding="0" bordercolor="#cc30cc" style="border-collapse:collapse" >
                <tr class="tblsubtitle" height="25">
                  <td colspan="4" align="center" class="tblheading">Crop Variety wise Compiled Pending Order Report </td>
                </tr>
                <tr height="15">
...
<td align="left"  valign="middle" class="tbltext" colspan="3">&nbsp;<select class="tbltext" name="txtordertyp" style="width:170px;" onchange="ortpchk();">
<option value="ALL" selected>ALL</option>
<option value="sales">Order Sales</option>
<option value="stock">Order Stock Transfer</option>
<option value="salesandstock">Order Sales &amp; Order Stock Transfer</option>
<option value="tdf">Order TDF</option>
...
<option value="ALL" selected>ALL</option>
    ...
    <td align="left"  valign="middle" class="tbltext" id="vitem">&nbsp;<select class="tbltext" name="txtvariety" id="itm1" style="width:170px;" onchange="upssel(this.value)" >
<option value="ALL" selected>ALL</option>
</select>&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
                </tr>
 <tr class="Light" height="25">
<td align="right"  valign="middle" class="tblheading">UPS&nbsp;</td>
<td align="left"  valign="middle" class="tbltext" colspan="3"  id="upsitem">&nbsp;<select class="tbltext" name="txtups" style="width:170px;">
<option value="ALL" selected>ALL</option>
</select>&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
</tr>
<?php
...
<td width="137"  align="right"  valign="middle" class="tblheading">State&nbsp;</td>
<td width="283" align="left"  valign="middle" class="tbltext">&nbsp;
  <select class="tbltext" name="txtstatesl" style="width:120px;" onchange="locslchk(this.value)">
...
<?php } ?>  
	...
	<td width="78"  align="right"  valign="middle" class="tblheading">Location&nbsp;</td>
<td width="342" align="left"  valign="middle" class="tbltext" id="locations">&nbsp;<select class="tbltext" name="txtlocationsl" style="width:160px;" onchange="stateslchk(this.value)">
<option value="ALL" selected>ALL</option>
</select>&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
  </tr><input type="hidden" name="locationname" value="" />
  
   <tr class="Dark" height="30">
<td width="137" align="right"  valign="middle" class="tblheading" >Party Name&nbsp;</td>
<td colspan="3" align="left"  valign="middle" class="tbltext" id="selectparty">&nbsp;<select class="tbltext" name="txtparty" style="width:220px;" onchange="locchk()"  >
<option value="ALL" selected="selected">ALL</option>
</select>&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
</tr>
              </table>
                <table align="center" width="850" cellpadding="5" cellspacing="5" border="0" >
                  <tr >
                    <td valign="top" align="center">&nbsp;<a href="report_pending.php"><img src="../images/back.gif" border="0"  style="display:inline;cursor:pointer;"/></a>&nbsp;<input name="Submit" type="image" src="../images/next.gif" alt="Submit Value"  border="0" style="display:inline;cursor:pointer;" onClick="return mySubmit();" /></td>
                  </tr>
              </table></td>
            <td ></td>
          </tr>
