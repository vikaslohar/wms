<?php
	...
	if(isset($_POST['frm_action'])=='submit')
	{
		...
		echo "<script>window.location='../order/utilit_ordersearch1.php?txtlot=$lot&txtlot1=$lot1&txtlot2=$lot2'</script>";	
	}	
?>
...
<title>Order-Utility-Order Number wise</title>
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#cc30cc" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#cc30cc" style="border-bottom:solid; border-bottom-color:#cc30cc" >
	    <tr >
	      <td width="813" height="30"class="Mainheading"  >&nbsp;Utility - Order Search
	        </td>
	    </tr></table></td>
	  </tr>
	  </table></td></tr>
...
?>	
<?php
$quer4=mysqli_query($link,"SELECT yearsid, ycode FROM tblfnyears where years_status!='u' order by ycode asc"); 
?>	
<table align="center" border="1" cellspacing="0" cellpadding="0" width="574" bordercolor="#cc30cc" style="border-collapse:collapse">
<tr class="Light" height="25">
	<td width="188"  align="right"  valign="middle" class="tblheading">&nbsp; Select Order Search&nbsp; </td>
	<td colspan="3" align="left"  valign="middle">&nbsp;<select name="txtlot" class="tbltext" tabindex="0">
		   ...
		   &nbsp;<input name="txtlot1" type="text" size="6" class="tbltext" tabindex="0" maxlength="5" onkeypress="return isNumberKey(event)" />&nbsp;<select class="tbltext" name="txtlot2" style="width:40px;">
    <option value="" selected="selected">--Select--</option>
...
<tr >
<td valign="top" align="center"><a href="select_order.php"><img src="../images/back.gif" alt="Back" border="0" style="display:inline;cursor:hand;" /></a>&nbsp;&nbsp;<input name="Submit" type="image" src="../images/next.gif" alt="Submit Value" onClick="return mySubmit();"  border="0" style="display:inline;cursor:pointer;"></td>
</tr>
</table>
</td>
<td ></td>
