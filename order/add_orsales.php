...
$ycode=$noticia3['ycode'];
	...
	$sql_code="SELECT MAX(orderm_code) FROM tbl_orderm where plantcode='$plantcode' and order_trtype='Order Sales' and yearcode='$ycode' ORDER BY orderm_code DESC";
...
{	
	...
	document.getElementById('frmbutn').innerHTML="<img src='../images/processing2.gif' border='0' style='display:inline;cursor:wait;' />&nbsp;&nbsp	;";
	if(document.frmaddDepartment.txtpp.value=="")
	{					
		alert("Please select Party Type");
		//document.frmaddDepartment.txtpp.focus();
...
<tr class="tblsubtitle" height="20">
  <td colspan="6" align="center" class="tblheading">Add Order - Sales</td>
</tr>
<tr height="15"><td colspan="6" align="right" class="tblheading"><font color="#FF0000" >* </font>indicates required field&nbsp;</td></tr>

 <tr class="Light" height="30">
<td width="205" align="right" valign="middle" class="tblheading">&nbsp;Transaction Id&nbsp;</td>
<td width="256"  align="left" valign="middle" class="tbltext">&nbsp;<input name="txttranid" type="text" size="16" class="tbltext" tabindex=""    maxlength="16"  value="<?php echo $code1?>" style="background-color:#CCCCCC" readonly="true"/>&nbsp;</td>
...
<td align="left"  valign="middle" class="tbltext" >&nbsp;<input name="txtordno" type="text" size="16" class="tbltext" tabindex=""    maxlength="16"  value="<?php echo $code12?>" style="background-color:#CCCCCC" readonly="true"/>&nbsp;&nbsp;</td>
...
<?php
$quer3=mysqli_query($link,"SELECT * FROM tblclassification  where main='Channel'  order by classification"); //
?>		   
			     <tr class="Dark" height="30">
...
<div id="selectparty"style="display:none" >
 <table align="center" border="1" width="850" cellspacing="0" cellpadding="0" bordercolor="#cc30cc" style="border-collapse:collapse" >   
 <tr class="Light" height="30">
<td width="206"  align="right"  valign="middle" class="tblheading">Invoice To&nbsp;</td>
...
<td align="left"  valign="middle" class="tbltext" colspan="3" id="vaddress">&nbsp;<input type="hidden" name="adddchk" value="" />  </td>
 ...
 <td width="206"  align="right"  valign="middle" class="tblheading">&nbsp;Consignee Applicable&nbsp;</td>
   <td width="638" colspan="3" align="left"  valign="middle"><input name="txt12" type="radio" class="tbltext" value="Yes" onClick="clkp(this.value);" />&nbsp;Yes&nbsp;&nbsp;<input name="txt12" type="radio" class="tbltext" value="No" onClick="clkp(this.value);"  />&nbsp;No&nbsp;&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
</tr>
</table> 
<div id="fill" style="display:none">
<table align="center" border="1" width="850" cellspacing="0" cellpadding="0" bordercolor="#cc30cc" style="border-collapse:collapse"  > 
<tr class="Dark" height="25">
           <td width="206"  align="right"  valign="middle" class="tblheading">Consignee Name&nbsp;</td>
           <td align="left"  valign="middle" colspan="3" >&nbsp;<input name="txtparty" type="text" size="35" class="tbltext" tabindex="" maxlength="36"  onBlur="javascript:this.value=FirstCharCap(this.value);"  />&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
         </tr>
 <tr class="Light" height="30">
<td width="206" align="right"  valign="middle" class="tblheading">&nbsp;Address&nbsp;</td>
<td align="left"  valign="middle" class="tbltext"  colspan="3">&nbsp;<textarea name="txtadd" cols="50" rows="3" tabindex=""  class="tbltext" onBlur="javascript:this.value=FirstCharCap(this.value);" onchange="caddchk(this.value);" ></textarea>&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
</tr>

<tr class="Dark" height="30">
<td width="206" align="right"  valign="middle" class="tblheading" >&nbsp;City/Town/Village&nbsp;</td>
<td align="left"  valign="middle" class="tbltext"  colspan="4">&nbsp;<input type="text" class="tbltext" name="txtcity" size="20" maxlength="20"onkeypress="return isCharKey(event)" onBlur="javascript:this.value=FirstCharCap(this.value);" >&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
</tr>
<tr class="Light" height="30">
<td width="206" align="right"  valign="middle" class="tblheading" >&nbsp;Pin&nbsp;</td>
<td align="left"  valign="middle" class="tbltext" colspan="4">&nbsp;<input type="text" class="tbltext" name="txtpin" size="6" maxlength="6" onkeypress="return isNumberKey(event)" >&nbsp;</td>
</tr>
<?php
...
<tr class="Light" height="30"  >
   <td align="right" width="206" valign="middle" class="tblheading" >&nbsp;Phone No.&nbsp;</td>
    <td align="left"  valign="middle" class="tbltext" colspan="4">&nbsp;<input name="pstd" type="text" size="5" class="tbltext" tabindex="7" maxlength="5" onkeypress="return isNumberKey(event)" value="0"/>&nbsp;&nbsp;<input name="pphno" type="text" size="15" class="tbltext" tabindex="" maxlength="12" onkeypress="return isNumberKey(event)"/>&nbsp;STD | Phone</td>
  </tr>
<tr class="Dark" height="25">
          <td width="206"  align="right"  valign="middle" class="tblheading" >Mobile&nbsp;No.&nbsp;</td>
           <td colspan="5" align="left"  valign="middle" style=" border-color:#cc30cc">&nbsp;<input name="txtcontact" type="text" size="16" class="tbltext" tabindex="0" maxlength="15"  onkeypress="return isNumberKey(event)" />&nbsp;</td>
		   </tr>
		   <tr class="Dark" height="30">
<td align="right" width="206" valign="middle" class="tblheading" >TIN&nbsp;</td>
<td width="213" align="left"  valign="middle" class="tbltext">&nbsp;<input name="txtctin" type="text" size="16" class="tbltext" tabindex=""   maxlength="15" />&nbsp;&nbsp;</td>

<td align="right" width="205" valign="middle" class="tblheading" >CST&nbsp;</td>
<td width="216" align="left"  valign="middle" class="tbltext">&nbsp;<input name="txtccst" type="text" size="16" class="tbltext" tabindex="" maxlength="15" >&nbsp;&nbsp;</td>
</tr></table>
</div>
<div id="fillcountry" style="display:none">
<table align="center" border="1" width="850" cellspacing="0" cellpadding="0" bordercolor="#cc30cc" style="border-collapse:collapse"  > 
<tr class="Dark" height="25">
           <td width="206"  align="right"  valign="middle" class="tblheading">Consignee Name&nbsp;</td>
           <td align="left"  valign="middle" colspan="3" >&nbsp;<input name="txtpartycountry" type="text" size="35" class="tbltext" tabindex="" maxlength="36"  onBlur="javascript:this.value=FirstCharCap(this.value);"  />&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
         </tr>
 <tr class="Light" height="30">
<td width="206" align="right"  valign="middle" class="tblheading">&nbsp;Address&nbsp;</td>
<td align="left"  valign="middle" class="tbltext"  colspan="3">&nbsp;<textarea name="txtaddcountry" cols="50" rows="3" tabindex=""  class="tbltext" onBlur="javascript:this.value=FirstCharCap(this.value);" onchange="caddchk(this.value);" ></textarea>&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
</tr>

<tr class="Dark" height="30">
<td width="206" align="right"  valign="middle" class="tblheading" >&nbsp;City/Town&nbsp;</td>
<td align="left"  valign="middle" class="tbltext"  colspan="4">&nbsp;<input type="text" class="tbltext" name="txtcitycountry" size="20" maxlength="20"onkeypress="return isCharKey(event)" onBlur="javascript:this.value=FirstCharCap(this.value);" >&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
</tr>
<tr class="Light" height="30">
<td width="206" align="right"  valign="middle" class="tblheading" >&nbsp;Zip&nbsp;</td>
<td align="left"  valign="middle" class="tbltext" colspan="4">&nbsp;<input type="text" class="tbltext" name="txtpincountry" size="6" maxlength="6" onkeypress="return isNumberKey(event)" >&nbsp;</td>
</tr>
<tr class="Dark" height="30">
<td width="206" align="right"  valign="middle" class="tblheading" >&nbsp;State&nbsp;</td>
<td align="left"  valign="middle" class="tbltext" colspan="3">&nbsp;<input type="text" class="tbltext" name="txtstatecountry" size="20" maxlength="20"onkeypress="return isCharKey(event)" onBlur="javascript:this.value=FirstCharCap(this.value);" >&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
</tr>
<tr class="Light" height="30">
<td width="205"  align="right"  valign="middle" class="tblheading">Country&nbsp;</td>
<td align="left"  valign="middle" class="tbltext" colspan="3">&nbsp;<input name="txtcountry1" type="text" size="25" class="tbltext" tabindex=""  value=""  maxlength="25" />
	&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
</tr>
<tr class="Light" height="30"  >
   <td align="right" width="206" valign="middle" class="tblheading" >&nbsp;Phone No.&nbsp;</td>
    <td align="left"  valign="middle" class="tbltext" colspan="4">&nbsp;<input name="pstdcountry" type="text" size="5" class="tbltext" tabindex="7" maxlength="5" onkeypress="return isNumberKey(event)" value="0"/>&nbsp;&nbsp;<input name="pphnocountry" type="text" size="15" class="tbltext" tabindex="" maxlength="12" onkeypress="return isNumberKey(event)"/>&nbsp;STD | Phone</td>
  </tr>
<tr class="Dark" height="25">
          <td width="206"  align="right"  valign="middle" class="tblheading" >Mobile&nbsp;No.&nbsp;</td>
           <td colspan="5" align="left"  valign="middle" style=" border-color:#cc30cc">&nbsp;<input name="txtcontactcountry" type="text" size="16" class="tbltext" tabindex="0" maxlength="15"  onkeypress="return isNumberKey(event)" />&nbsp;</td>
		   </tr>
		   <tr class="Dark" height="30">
<td align="right" width="206" valign="middle" class="tblheading" >UDF 1&nbsp;</td>
<td width="213" align="left"  valign="middle" class="tbltext">&nbsp;<input name="txtctincountry" type="text" size="16" class="tbltext" tabindex=""   maxlength="15" />&nbsp;&nbsp;</td>

<td align="right" width="205" valign="middle" class="tblheading" >UDF 2&nbsp;</td>
<td width="216" align="left"  valign="middle" class="tbltext">&nbsp;<input name="txtccstcountry" type="text" size="16" class="tbltext" tabindex="" maxlength="15" >&nbsp;&nbsp;</td>
</tr></table>
</div>
<table align="center" border="1" width="850" cellspacing="0" cellpadding="0" bordercolor="#cc30cc" style="border-collapse:collapse" > 
<tr class="Light" height="30">
<td align="right" width="206" valign="middle" class="tblheading" >Order Placed By&nbsp;</td>
<td align="left"  valign="middle" class="tbltext" colspan="3">&nbsp;<input name="txtorderplby" type="text" size="20" class="tbltext" tabindex=""   maxlength="20" onkeypress="return isCharKey(event)" onchange="orplchk();" onBlur="javascript:this.value=FirstCharCap(this.value);" />&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
</tr>
<tr class="Dark" height="25">
<td width="206" align="right"  valign="middle" class="tblheading">&nbsp;Preferred Mode of Dispatch&nbsp;</td>
...
<table align="center" border="1" width="850" cellspacing="0" cellpadding="0" bordercolor="#cc30cc" style="border-collapse:collapse" > 
<tr class="Light" height="30">
<td align="right" width="206" valign="middle" class="tblheading" style="border-color:#cc30cc">&nbsp;Transport Name&nbsp;</td>
<td align="left"  valign="middle" class="tbltext" style="border-color:#cc30cc">&nbsp;<input name="txttname" type="text" size="35" class="tbltext" tabindex="" maxlength="35" onBlur="javascript:this.value=FirstCharCap(this.value);" />  &nbsp;<font color="#FF0000">*</font>&nbsp;</td>
<!--<td width="123" align="right"  valign="middle" class="tblheading" style="border-color:#cc30cc">Lorry Receipt No.&nbsp;</td>
<td align="left" width="240" valign="middle" class="tbltext" colspan="3" style="border-color:#cc30cc">&nbsp;<input name="txtlrn" type="text" size="15" class="tbltext" tabindex=""  maxlength="15"/>&nbsp;</td>-->
</tr>

<!--<tr class="Dark" height="25">
<td align="right" width="206" valign="middle" class="tblheading" style="border-color:#cc30cc">&nbsp;Vehicle No.&nbsp;</td>
<td align="left" width="271" valign="middle" class="tbltext"  style="border-color:#cc30cc">&nbsp;<input name="txtvn" type="text" size="12" class="tbltext" tabindex="" maxlength="12"  />&nbsp;<font color="#FF0000">*</font>&nbsp; </td>
<td align="right"  valign="middle" class="tblheading" style="border-color:#cc30cc">&nbsp;Payment Mode&nbsp;</td>
 <td align="left"  valign="middle" class="tbltext"colspan="3" style="border-color:#cc30cc">&nbsp;<select class="tbltext" name="txt13" id="txt13" style="width:70px;" onchange="clk1(this.value);" >
<option value="" selected="selected">Select</option>
...
<td align="left" width="639" valign="middle" class="tbltext" style="border-color:#cc30cc">&nbsp;<input name="txtcname" type="text" size="35" class="tbltext" tabindex=""  maxlength="35" onBlur="javascript:this.value=FirstCharCap(this.value);"  />&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
...
<table align="center" border="1" width="850" cellspacing="0" cellpadding="0" bordercolor="#cc30cc" style="border-collapse:collapse" > 
<tr class="Light" height="30">
<td align="right" width="207" valign="middle" class="tblheading" style="border-color:#cc30cc">&nbsp;Name of Person&nbsp;</td>
<td width="637" colspan="8" align="left" valign="middle" class="tbltext" style="border-color:#cc30cc">&nbsp;<input name="txtpname" type="text" size="35" class="tbltext" tabindex=""  maxlength="35" onkeypress="return isCharKey(event)"onBlur="javascript:this.value=FirstCharCap(this.value);" //>&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
</tr>
</table>
</div>
<br />
...
<td width="656" align="left"  valign="middle" class="tbltext">&nbsp;<input type="text" name="txtremarks" class="tbltext" size="120" maxlength="90"onBlur="javascript:this.value=FirstCharCap(this.value);"  ></td>
</tr>
</table>
