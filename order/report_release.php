<?php
	...
	if(isset($_POST['frm_action'])=='submit')
	{
		...
		$edate = $_POST['edate'];
		//exit;
		echo "<script>window.location='report_release1.php?sdate=$sdate&edate=$edate'</script>";
	}
?>
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#cc30cc" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#cc30cc" style="border-bottom:solid; border-bottom-color:#cc30cc" >
	    <tr >
	      <td width="813" height="30"class="Mainheading"  >&nbsp;Release Order Report  
	        </td>
	    </tr></table></td>
	  </tr>
	  </table></td></tr>
...
<tr class="tblsubtitle" height="25">
  <td colspan="4" align="center" class="tblheading">Release Order Report</td>
</tr>
...
?>
     ...
     <td align="left"  valign="middle" ><input name="sdate" id="sdate" type="text" size="10" class="tbltext" tabindex="0" readonly="true"  value="<?php echo date("d-m-Y", time());?>" style="background-color:#EFEFEF" />&nbsp;<a href="javascript:void(0)" onClick="showCalendar('sdate')" tabindex="6"><img src="../images/cal.gif" alt="Calender" border="0" align="absmiddle"></a>&nbsp;<font color="#FF0000" >*</font></td>
           <td align="right" width="201" height="30" valign="middle" class="tblheading">&nbsp;To&nbsp;</td>
...
<tr >
<td valign="top" align="center"><!--<a href="report_pending.php"><img src="../images/back.gif" border="0"  style="display:inline;cursor:pointer;"/></a>&nbsp;--><input name="Submit" type="image" src="../images/next.gif" alt="Submit Value"  border="0" style="display:inline;cursor:pointer;" onClick="return mySubmit();"><input type="hidden" name="flagcode" value=""/></td>
</tr>
</table>
</td><td ></td>
</tr>
