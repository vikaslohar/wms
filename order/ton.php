...
<title>Order-Transfer Order Note- TON</title>
...
<table width="750" height="282" border="0" align="center" cellpadding="0" cellspacing="0" >
 ...
 <?php 
$tid=$itmid;
$sql_tbl=mysqli_query($link,"select * from tbl_orderm where plantcode='$plantcode' and  order_trtype='Order Stock' and orderm_id='".$tid."'") or die(mysqli_error($link));
$row_tbl=mysqli_fetch_array($sql_tbl);			
$arrival_id=$row_tbl['orderm_id'];
$a=mysqli_num_rows($sql_tbl);
...
<td align="left"  valign="middle" class="tbltext" colspan="6" id="vaddress">&nbsp;<div style="padding-left:4px"><?php echo $row3['address'];?><?php if($row3['city']!=""){ echo " ".$row3['city'];}?>, <?php echo $row3['state'];?> - <?php echo $row3['pin'];?><?php if($row3['tin']!=""){?>, TIN: <?php echo $row3['tin'];}?><?php if($row3['cst']!=""){?>, CST: <?php echo $row3['cst'];}?><?php if($row3['mob']!="" && $row3['mob']!=0){echo ", Mob no.-".$row3['mob'];}?><?php if($row3['phone']!=""){echo ", Phone no. ".$row3['std']."-".$row3['phone'];}?></div></td>
</tr>
<tr class="Light" height="30">
...
<td align="right"  valign="middle" class="tblheading">Address&nbsp;</td>
<td align="left"  valign="middle" class="tbltext" colspan="6" id="vaddress"><div style="padding-left:4px"><?php if($row_tbl['orderm_conadd']!=""){?>&nbsp;<?php echo $row_tbl['orderm_conadd'];}?>&nbsp;<?php if($row_tbl['orderm_concity']!=""){?>,&nbsp;<?php echo $row_tbl['orderm_concity'];}?>&nbsp<?php if($row_tbl['orderm_country']!=""){?>,&nbsp;<?php echo $row_tbl['orderm_country'];}?> <?php if($pin!=""){?>Pin<?php echo $pin;}?>&nbsp;<?php if($row_tbl['orderm_constate']!=""){?>,&nbsp;<?php echo $row_tbl['orderm_constate'];}?></div></td>
</tr>
<tr class="Dark" height="30">
...
$up=""; $qt=""; $np=""; $qt1=""; $nowbp=""; $nompp=""; $nowb=""; $nomp=""; $ptp=""; $stdptv=""; $pt=""; $stdpt="";$zz="";$up1="";  $vtype=""; $smcqty=""; $lqty="";
