...
<tr class="Light" height="25">
<td width="377" align="right"  valign="middle" class="tblheading" >Party Name Search&nbsp;</td>
<td width="467" align="left"  valign="middle" class="tbltext" ><input type="radio" name="orsearch" value="partysearch" onclick="ordersrchk(this.value)" /></td>
</tr>
