  ...
  <tr><td>
   ...
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#cc30cc" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#cc30cc" style="border-bottom:solid; border-bottom-color:#cc30cc" >
	    <tr >
	      <td width="813" height="25">&nbsp;Item on Hold Report</td>
	    </tr></table></td>
	  </tr>
	  </table></td></tr>
...
<tr class="Dark" height="30">
<td align="right" valign="middle" class="tblheading">Party Name&nbsp;</td>
<td align="left" valign="middle" class="smalltblheading" colspan="3">&nbsp;<?php echo $partyname;?></td>
</tr>
<?php
}
?>
...
<?php
	$up=""; $up1=""; $qt=""; $qt1=""; $zz=""; $np="";
	$sql_sloc=mysqli_query($link,"select * from tbl_order_sub_sub where plantcode='$plantcode' and plantcode='$plantcode' and orderm_id='".$row_main['orderm_id']."' and order_sub_id='".$row_sub['order_sub_id']."' order by order_sub_sub_id") or die(mysqli_error($link));
...
<?php
	$up=""; $up1=""; $qt=""; $qt1=""; $zz=""; $np="";
	$sql_sloc=mysqli_query($link,"select * from tbl_order_sub_sub where plantcode='$plantcode' and plantcode='$plantcode' and orderm_id='".$row_main['orderm_id']."' and order_sub_id='".$row_main['order_sub_id']."' order by order_sub_sub_id") or die(mysqli_error($link));
	while($row_sloc=mysqli_fetch_array($sql_sloc))
	{
	$zz=explode(" ",$row_sloc['order_sub_sub_ups']);
	$dq=explode(".",$zz[0]);
...
<tr >
<td height="49" align="center" valign="top"><a href="report_hold.php"><img src="../images/back.gif" border="0"  style="display:inline;cursor:pointer;"/></a>&nbsp;&nbsp;<img src="../images/printpreview.gif" onclick="openprint('<?php echo $cdate?>','<?php echo $txttypchk?>','<?php echo $txt11?>','<?php echo $txtcrop?>','<?php echo $txtvariety?>','<?php echo $txtpartycat1?>','<?php echo $fillpartyname1?>','<?php echo $orsrval?>','<?php echo $orderno?>','<?php echo $txtlot?>','<?php echo $txtlot1?>','<?php echo $txtlot2?>','<?php echo $partyname_org?>','<?php echo $txtpartycat?>','<?php echo $fillpartyname?>','<?php echo $txtpp?>','<?php echo $txtstatesl?>','<?php echo $txtlocationsl?>','<?php echo $txtcountrysl?>','<?php echo $txtptype?>','<?php echo $txtparty?>','<?php echo $sdate?>','<?php echo $edate?>')" style="cursor:pointer" border="0" />
