...
if(tp=="item1")
{
var url="getuser_partycancel.php";
url=url+"?a="+str;
url=url+"&b="+d; 
url=url+"&sid="+Math.random();
xmlHttp.onreadystatechange=stateChanged ;
...
if(tp=="get")
{
var url="getuser_detail_release.php";
url=url+"?a="+str;
url=url+"&b="+d;
url=url+"&c="+e;
url=url+"&f="+i
...
if(tp=="orderdetails")
{
var url="getuser_orddetail_release.php";
url=url+"?a="+str;
url=url+"&b="+d;
url=url+"&c="+e;
url=url+"&f="+i;
...
if(tp=="vendor")
{
var url="getuser_vaddresschkorel.php";
url=url+"?a="+str;
url=url+"&b="+d; 
url=url+"&sid="+Math.random();
xmlHttp.onreadystatechange=stateChanged ;
...
if(tp=="partytyp")
{
var url="getuser_partytypeorrel.php";
url=url+"?a="+str;
url=url+"&sid="+Math.random();
xmlHttp.onreadystatechange=stateChanged ;
xmlHttp.open("GET",url,true);
