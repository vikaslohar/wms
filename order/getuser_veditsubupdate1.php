...
if($maintrid == 0)
{
	...
	if(mysqli_query($link,$sql_main) or die(mysqli_error($link)))
	{
		...
		$totq=0;$otq=0;$oltq=0;
 		$sql_sub="insert into tbl_order_sub (orderm_id, order_sub_crop, order_sub_variety, order_sub_ups_type, plantcode) values ('$mainid','$txtcrop','$txtvariety','$txtup', '$plantcode')";
