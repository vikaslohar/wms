<?php
	...
	if(isset($_POST['frm_action'])=='submit')
	{
		...
		if($sdate!="" && $edate!="")
		{
		echo "<script>window.location='utility_order_status1.php?sdate=$sdate&edate=$edate'</script>";
		}
		else
		 {?>
		 <script>
...
<table align="center" border="1" cellspacing="0" cellpadding="0" width="700" bordercolor="#cc30cc" style="border-collapse:collapse">
  <tr class="tblsubtitle" height="20"><td colspan="10" align="center" class="subheading">Date wise Order Search</td></tr>
...
<tr >
<td valign="top" align="right"><a href="select_order.php"><img src="../images/back.gif" alt="Back" border="0" style="display:inline;cursor:hand;" /></a>&nbsp;&nbsp;</td>
</tr>
</table>  
