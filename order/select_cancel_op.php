...
<title>Order- Transaction - Order Cancel-Select output</title>
...
{
winHandle=window.open('conop.php?itmid='+val1+'&txttype='+val2+'&txtpp='+val3+'&txtptype='+val4+'&txtlocationsl='+val5+'&txtstatesl='+val6+'&txtcountrysl='+val7,'WelCome','top=170,left=180,width=820,height=450,scrollbars=yes');
if(winHandle==null){
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" style="border-bottom:solid; border-bottom-color:#cc30cc" >
	    <tr >
	      <td width="813" height="25" class="Mainheading">&nbsp;Transaction:Order - Cancel - Output Selection </td>
	    </tr></table></td>
	  </tr>
	  </table></td></tr>
...
<tr class="Light" height="25">
    ...
    <td align="center"  valign="middle" class="tblheading">&nbsp;<a href="Javascript:void(0)" onclick="openslocpopprint('<?php echo $pid;?>','<?php echo $type;?>','<?php echo $txtpp?>','<?php echo $txtptype?>','<?php echo $txtlocationsl;?>','<?php echo $txtstatesl?>','<?php echo $txtcountrysl?>');"> Cancel Order Note (CON)</a></td>
</tr>
<!--<tr class="Light" height="25">
...
<tr >
<td valign="top" align="center"><a href="home_hold.php"><img src="../images/back.gif" border="0"style="display:inline;cursor:Pointer;" /></a>&nbsp;&nbsp;&nbsp;</td>	
</tr>
</table>-->
