  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#cc30cc" >
	  ...
	  <table width="820" border="0" cellpadding="0" cellspacing="0" bordercolor="#cc30cc" style="border-bottom:solid; border-bottom-color:#cc30cc" >
	    <tr >
	      <td width="820" height="25">&nbsp;Transaction - Order-Stock Transfer</td>
	    </tr></table></td>
...
$targetpage = $_SERVER['PHP_SELF']; 
  ...
  $sql_arr_home=mysqli_query($link,"select * from tbl_orderm where plantcode='$plantcode' and orderm_date >='$tdate' and orderm_date <='$pdate' and  order_trtype='Order Stock' and orderm_tflag=1 and orderm_supflag=0 and orderm_cancelflag=0 order by orderm_id desc LIMIT $start, $limit") or die(mysqli_error($link));
...
$query = "select * from tbl_orderm where plantcode='$plantcode' and orderm_date >='$tdate' and orderm_date <='$pdate' and  order_trtype='Order Stock' and orderm_tflag=1 and orderm_supflag=0 and orderm_cancelflag=0 order by orderm_id desc";
...
$sql_arr_home=mysqli_query($link,"select * from tbl_orderm where orderm_date >='$tdate' and orderm_date <='$pdate' and  order_trtype='Order Stock' and orderm_tflag=1 and orderm_supflag=0 and orderm_cancelflag=0 order by orderm_id desc") or die(mysqli_error($link));
$tot_arr_home=mysqli_num_rows($sql_arr_home);

$total_results3 =mysqli_query($link,"SELECT COUNT(*)  FROM tbl_orderm where orderm_date >='$tdate' and orderm_date <='$pdate' and  order_trtype='Order Stock' and orderm_supflag=1");
$total_results2 = mysqli_fetch_array($total_results3);
$total_results = $total_results2[0]; */
...
<tr >
<td valign="top" align="right"><a href="home_orst.php"><img src="../images/back.gif" border="0"style="display:inline;cursor:Pointer;" /></a></td>
</tr>
</table>
</form> 
