...
<td align="right" width="106" valign="middle" class="tblheading" style="border-color:#cc30cc">&nbsp;Select UPS Type&nbsp;</td>
   <td colspan="5" align="left"  valign="middle" ><input name="txtup" type="radio" class="tbltext" value="Yes" <?php if($row_tbl_sub['order_sub_ups_type']=="Yes"){ echo "Checked";} ?> onClick="clkp1(this.value);" />&nbsp;Standard&nbsp;&nbsp;<input name="txtup" type="radio" class="tbltext" value="No" <?php if($row_tbl_sub['order_sub_ups_type']=="No"){ echo "Checked";} ?> onClick="clkp1(this.value);"  />&nbsp;Non-Standard&nbsp;&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
</tr>
...
<?php
$sql_month=mysqli_query($link,"select * from tblups_tdf")or die(mysqli_error($link));
...
if($val<>"")
{ 
if($val==$row_tbl_sub['order_sub_crop'])
{
...
if($stdptv=="")$stdptv=$row_month['uom'];
?>
<tr class="Dark" height="30">
...
<input type="hidden" name="stdptval_<?php echo $srn;?>" id="stdptval_<?php echo $srn;?>" value="<?php echo $stdptv;?>" size="9" readonly="true" style="background-color:#F0F0F0" />
<td align="right" width="60" valign="middle" class="tblheading" >Quantity&nbsp;</td>
<td width="242"  align="left"  valign="middle" class="tbltext"  >&nbsp;<input name="txtqtydc_<?php echo $srn?>" id="txtqtydc_<?php echo $srn?>" type="text" size="9" class="tbltext" tabindex="" maxlength="9" value="<?php echo $qt;?>" onkeypress="return isNumberKey_Nowithdot(event)" onchange="nopchk(this.value,'<?php echo $row_month['ups']?>','<?php echo $row_month['wt'];?>','<?php echo $srn?>')"  />&nbsp;Kgs.&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
<td align="right" width="59" valign="middle" class="tblheading" >NoP&nbsp;</td>
<td width="155"  align="left"  valign="middle" class="tbltext"  >&nbsp;<input name="txtnopdc_<?php echo $srn?>" id="txtnopdc_<?php echo $srn?>" type="text" size="6" class="tbltext" tabindex="" maxlength="6" readonly="true" style="background-color:#CCCCCC" value="<?php echo $np;?>"   />&nbsp;&nbsp;</td>
</tr>
<?php 
}
}
...
<td width="119" align="left" valign="middle" class="tbltext" >&nbsp;<input name="txtupdc_<?php echo $snn;?>" id="txtupdc_<?php echo $snn;?>" type="text" size="9" class="tbltext" tabindex="" maxlength="9" onkeypress="return isNumberKey1(event)" value="<?php echo $row_sloc['order_sub_sub_ups']?>" />
</td>
<td width="119" align="left" valign="middle" class="tbltext" >&nbsp;<select name="upssizetyp_<?php echo $snn;?>" id="upssizetyp_<?php echo $snn;?>" style="size:70px" onchange="updmerg(this.value,'<?php echo $snn;?>');">
...
<td width="119" align="left" valign="middle" class="tbltext" >&nbsp;<input name="txtqtydc_<?php echo $snn;?>" id="txtqtydc_<?php echo $snn;?>" type="text" size="9" class="tbltext" tabindex="" maxlength="9" value="<?php echo $qt;?>" onkeypress="return isNumberKey1(event)"  onchange="nopntchk(this.value,'ermsg_1','','<?php echo $snn;?>')"  />
</td>
<td align="right" width="119" valign="middle" class="tblheading" >NoP&nbsp;</td>
<td width="119" align="left"  valign="middle" class="tbltext"  >&nbsp;<input name="txtnopdc_<?php echo $snn;?>" id="txtnopdc_<?php echo $snn;?>" type="text" size="9" class="tbltext" tabindex="" maxlength="9" readonly="true" value="<?php echo $np;?>" style="background-color:#CCCCCC"  />&nbsp;
</td>
</tr>
<?php
}
...
<tr >
<td valign="top" align="right"><img src="../images/update.gif" border="0"style="display:inline;cursor:hand;" onclick="pformedtup();" />&nbsp;&nbsp;</td>
</tr>
</table>