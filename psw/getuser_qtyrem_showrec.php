...
$sql_issue=mysqli_query($link,"select distinct whid, binid, subbinid  from tbl_lot_ldg_pack where plantcode='$plantcode' and lotldg_crop ='".$b."' and lotldg_variety='".$c."' and lotno='$a'") or die(mysqli_error($link));
...
$sql_issue1=mysqli_query($link,"select max(lotdgp_id) from tbl_lot_ldg_pack where plantcode='$plantcode' and subbinid='".$row_issue['subbinid']."' and binid='".$row_issue['binid']."' and whid='".$row_issue['whid']."'  and lotldg_crop ='".$b."' and lotldg_variety='".$c."' and lotno='$a'") or die(mysqli_error($link));
...
<td align="left"  valign="middle" class="tbltext" >&nbsp;<?php echo $upspacktype;?><input type="hidden" name="wtinmp_<?php echo $srno;?>" id="wtinmp_<?php echo $srno;?>" value="<?php echo $wtinmp;?>" /><input type="hidden" name="upspacktype_<?php echo $srno;?>" id="upspacktype_<?php echo $srno;?>" value="<?php echo $upspacktype;?>" /></td>
 ...
 <td align="left"  valign="middle" class="tbltext" >&nbsp;<input name="txtrecnomp_<?php echo $srno;?>" id="txtrecnomp_<?php echo $srno;?>" type="text" size="5" class="tbltext" tabindex=""   maxlength="5" onkeypress="return isNumberKey1(event)"  onchange="nompchk1(this.value,'<?php echo $srno;?>');" value="0" readonly="true" style="background-color:#CCCCCC"  />&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
  <td align="left"  valign="middle" class="tbltext">&nbsp;<input name="recqtyp_<?php echo $srno;?>" id="recqtyp_<?php echo $srno;?>" type="text" size="9" class="tbltext" tabindex="" maxlength="9"  onkeypress="return isNumberKey(event)" onchange="qtychk1(this.value,'<?php echo $srno;?>');" style="background-color:#CCCCCC" readonly="true"  />&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
