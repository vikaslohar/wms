...
<table width="1003" height="600" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  ...
  <tr><td>
   <?php
	...
	$crp="ALL"; $ver="ALL";
	//$qry="select * from tbl_lot_ldg where lotldg_sstage='Pack' and lotldg_resverstatus=1 and lotldg_trdate<='$edate'";	
 
  $qry="select * from tbl_lot_ldg where plantcode='$plantcode' and lotldg_sstage='Pack' and lotldg_balqty > 0 and lotldg_resverstatus=1";
