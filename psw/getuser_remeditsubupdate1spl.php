...
if($z1 == 0)
{
    $sql_main="insert into tbl_pswrem(pswrem_tcode, pswrem_date, logid, yearcode, pswrem_typ, pswrem_dcno, pswrem_dcdate, plantcode)values('$txtid', '$tdate1', '$logid', '$yearid_id', 'splrelease', '$txtdcno', '$tdate2', '$plantcode')";
...
<td width="229" colspan="3" align="left" valign="middle" class="tbltext">&nbsp;<input name="date" type="text" size="10" class="tbltext" tabindex="0" readonly="true"  style="background-color:#CCCCCC" value="<?php echo $tdate1;?>" maxlength="10"/>&nbsp;</td>
</tr>
