...
$sql_iss23=mysqli_query($link,"select distinct (subbinid)  from tbl_lot_ldg_pack where plantcode='$plantcode' and whid='".$b."' and binid='".$c."' order by subbinid") or die(mysqli_error($link));
$tot23=mysqli_num_rows($sql_iss23);
while($row_iss23=mysqli_fetch_array($sql_iss23))
{ 
$a=$row_iss23['subbinid'];
$sql_iss=mysqli_query($link,"select distinct (lotno)  from tbl_lot_ldg_pack where plantcode='$plantcode' and whid='".$b."' and binid='".$c."' and subbinid='".$a."'") or die(mysqli_error($link));
$tot=mysqli_num_rows($sql_iss);
while($row_iss=mysqli_fetch_array($sql_iss))
{ 

$sql_issue1=mysqli_query($link,"select max(lotdgp_id) from tbl_lot_ldg_pack where plantcode='$plantcode' and subbinid='".$a."' and binid='".$c."' and whid='".$b."' and lotno='".$row_iss['lotno']."' ") or die(mysqli_error($link));
...
<?php
$cntflg=0;
$sql_iss23=mysqli_query($link,"select distinct (lotldg_subbinid)  from tbl_lot_ldg where plantcode='$plantcode' and lotldg_whid='".$b."' and lotldg_binid='".$c."' order by lotldg_subbinid") or die(mysqli_error($link));
$tot23=mysqli_num_rows($sql_iss23);
while($row_iss23=mysqli_fetch_array($sql_iss23))
{ 
$a=$row_iss23['lotldg_subbinid'];
$sql_iss=mysqli_query($link,"select distinct (lotldg_lotno)  from tbl_lot_ldg where plantcode='$plantcode' and lotldg_whid='".$b."' and lotldg_binid='".$c."' and lotldg_subbinid='".$a."'") or die(mysqli_error($link));
$tot=mysqli_num_rows($sql_iss);
while($row_iss=mysqli_fetch_array($sql_iss))
{ 

$sql_issue1=mysqli_query($link,"select max(lotldg_id) from tbl_lot_ldg where plantcode='$plantcode' and lotldg_subbinid='".$a."' and lotldg_binid='".$c."' and lotldg_whid='".$b."' and lotldg_lotno='".$row_iss['lotldg_lotno']."' ") or die(mysqli_error($link));
$row_issue1=mysqli_fetch_array($sql_issue1); 
