...
<?php	
	...
	$sql_arr_home=mysqli_query($link,"select distinct(sampleno) from tbl_qctest where plantcode='$plantcode' and testdate='$sdate' and trstage='Pack' order by crop asc, variety asc, oldlot asc") or die(mysqli_error($link));
...
while($row_arr_home2=mysqli_fetch_array($sql_arr_home))
{
	...
	$sql_arr_home2=mysqli_query($link,"select MAX(tid) from tbl_qctest where plantcode='$plantcode' and sampleno='".$row_arr_home2['sampleno']."' and trstage='Pack' and testdate='$sdate' order by crop asc, variety asc, oldlot asc") or die(mysqli_error($link));
