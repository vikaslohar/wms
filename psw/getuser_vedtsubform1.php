...
<table align="center" border="1" width="850" cellspacing="0" cellpadding="0" bordercolor="#0BC5F4" style="border-collapse:collapse" >
  ...
  <tr class="Light" height="30">
    ...
    <td align="left"  valign="middle" class="tbltext" >&nbsp;<input name="txtlotno" type="text" size="18" class="tbltext"  maxlength="18" style="background-color:#CCCCCC" value="<?php echo $row['lotno'];?>"/></td>
