...
/*$sql_arr_home=mysqli_query($link,"select * from tbl_psw_main arr_role='$logid'and arrtrflag=1") or die(mysqli_error($link));
...
$sql_arr_home=mysqli_query($link,"select * from tbl_psw_main  where plantcode='$plantcode' and arrival_date >='$tdate' and arrival_date <='$pdate' and arrtrflag=1 order by arr_code desc LIMIT $from, $max_results") or die(mysqli_error($link));
$tot_arr_home=mysqli_num_rows($sql_arr_home);

$total_results3 =mysqli_query($link,"SELECT COUNT(*)  FROM tbl_psw_main where plantcode='$plantcode' and arrival_date >='$tdate' and arrival_date <='$pdate'  and arrtrflag=1");
