...
*/
	...
	{ 
		...
		//exit;
	 	$sql_in1="insert into tbl_sloc_binw (code, sldate, wh, bin, subbin, yearcode, surole,stage, plantcode) values ('$code', '$tdate', '$who', '$bino', '$subbino', '$yearid_id', '$lgnid','$stageo', '$plantcode')";
