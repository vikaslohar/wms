...
<title>psw - Transaction - SLOC Updation-Lot wise - Output</title>
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#0BC5F4" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#0BC5F4" style="border-bottom:solid; border-bottom-color:#0BC5F4" >
	    <tr >
	      <td width="813" height="25" class="Mainheading">&nbsp;Transaction: SLOC Updation - Lot wise - Output </td>
	    </tr></table></td>
	  </tr>
	  </table></td></tr>
...
<table align="center" border="1" cellspacing="0" cellpadding="0" width="750" bordercolor="#0BC5F4" style="border-collapse:collapse">
  <tr class="tblsubtitle" height="25">
    <td width="34" align="center" class="tblheading" valign="middle">#</td>
	  <td width="125" align="center" class="tblheading" valign="middle">Crop</td>
    <td width="190" align="center" class="tblheading" valign="middle">Variety</td>
	<td width="102" align="center" class="tblheading" valign="middle">Lotno</td>
	<td width="57" align="center" class="tblheading" valign="middle">NoP</td>
    <td width="59" align="center" class="tblheading" valign="middle">NoMP</td>
    <td width="55" align="center" class="tblheading" valign="middle">Qty</td>
	<td width="110" align="center" class="tblheading" valign="middle">SLOC</td>
    </tr>
	 <input name="tp" value="SUO" type="hidden"> 

<?php
$sql_tbl=mysqli_query($link,"select * from tbl_lot_ldg_pack where plantcode='$plantcode' and trtype='PSWSUO' and lotldg_id='".$pid."'") or die(mysqli_error($link));
...
<tr class="Light" height="25">
	...
	<td width="125" align="center" valign="middle" class="tblheading"><?php echo $row_class['cropname'];?></td>
    <td width="190" align="center" valign="middle" class="tblheading"><?php echo $var;?></td>
	<td align="center" valign="middle" class="tblheading"><?php echo $row_tbl_sub['lotno'];?></td>
	<td align="center" valign="middle" class="tblheading"><?php echo $row_tbl_sub['balnop'];?></td>
    <td align="center" valign="middle" class="tblheading"><?php echo $row_tbl_sub['balnomp'];?></td>
    <td align="center" valign="middle" class="tblheading"><?php echo $row_tbl_sub['balqty'];?></td>
<?php
...
$subbinn="<a href='Javascript:void(0)' onclick='openprintsubbin($row_tbl_sub[subbinid],$row_tbl_sub[binid],$row_tbl_sub[whid],$row_tbl_sub[lotdgp_id])'>$row_subbinn[sname]</a>";
...
?>	
	<td width="110" align="center" valign="middle" class="tblheading"><?php echo $slocs;?></td>
  </tr>
  <?php
	}
	else
...
<?php
$sql_tbl=mysqli_query($link,"select * from tbl_lot_ldg_pack where plantcode='$plantcode' and trtype='PSWSUC' and lotldg_id='".$pid."'") or die(mysqli_error($link));
...
<tr >
<td valign="top" align="center"><a href="add_sloc.php"><img src="../images/back.gif" border="0"style="display:inline;cursor:pointer;" /></a>&nbsp;&nbsp;&nbsp;
