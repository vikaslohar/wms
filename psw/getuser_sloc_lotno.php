...
$a="";
$qr="select distinct(lotno) from tbl_lot_ldg_pack where plantcode='$plantcode' and lotldg_crop='".$crop."' and lotldg_variety='".$variety."' and lotldg_sstage='".$tp."' and balqty > 0  $sss";
...
{
$qr1="select max(lotdgp_id) from tbl_lot_ldg_pack where plantcode='$plantcode' and lotldg_crop='".$crop."' and lotldg_variety='".$variety."' and lotno='".$row2['lotno']."'  order by lotdgp_id desc";
...
$ccnt=0;
$sql_is=mysqli_query($link,"select distinct subbinid, binid, whid from tbl_lot_ldg_pack where plantcode='$plantcode' and  lotno='".$row['lotno']."' group by subbinid, binid order by lotdgp_id asc") or die(mysqli_error($link));
