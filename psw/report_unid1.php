...
<title>psw-Report - Unidentified Pack Seed Report</title>
...
<table width="1003" height="600" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  ...
  <?php
	...
	$qry="select * from tbl_lot_ldg where plantcode='$plantcode' and lotldg_sstage='Pack' and lotldg_trtype='Unidentified' and lotldg_trdate<='$edate'";	
...
?>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#0BC5F4" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#0BC5F4" style="border-bottom:solid; border-bottom-color:#0BC5F4" >
	    <tr >
	      <td width="813" height="25">&nbsp;Unidentified Pack Seed Report - As on Date: <?php echo date("d-m-Y");?></td>
	    </tr></table></td>
	  </tr>
	  </table></td></tr>
...
while($row_arr_home=mysqli_fetch_array($sql_arr_home))
{
	...
	$sql_tbl_sub=mysqli_query($link,"select * from tbl_lot_ldg where plantcode='$plantcode' and lotldg_id ='".$arrival_id."'") or die(mysqli_error($link));
