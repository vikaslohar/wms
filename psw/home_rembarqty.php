...
$sql_tbl=mysqli_query($link,"select * from tbl_pswrem where plantcode='$plantcode' and logid='$logid' and  pswrem_tflg=0 and pswrem_typ='barcodes'") or die(mysqli_error($link));
while($row_tbl=mysqli_fetch_array($sql_tbl))
{
	...
	$s_sub_sub2="delete from tbl_pswrem_bar where pswrem_id='".$arrival_id."'";
	mysqli_query($link,$s_sub_sub2) or die(mysqli_error($link));
	
}

	$s_sub="delete from tbl_pswrem where logid='$logid' and  pswrem_tflg=0 and pswrem_typ='barcodes'";
	mysqli_query($link,$s_sub) or die(mysqli_error($link));	
...
<title>psw - Transaction - Packaged Seed Release - Home Page</title>
...
function openprint(itm)
{
winHandle=window.open('brn_print.php?pid='+itm,'WelCome','top=170,left=180,width=820,height=350,scrollbars=yes');
if(winHandle==null){
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#0BC5F4" >
	  ...
	  <table width="820" border="0" cellpadding="0" cellspacing="0" bordercolor="#0BC5F4" style="border-bottom:solid; border-bottom-color:#0BC5F4" >
	    <tr >
	      <td width="820" height="25">&nbsp;Transaction - Packaged Seed Release</td>
	    </tr></table></td>
...
<td align="center" width="100" valign="middle" class="tblbutn" style="cursor:Pointer;"><?php if($flg==0 && $flg1==0 && $flg2==0) { ?><a href="trn_qty_rembar.php" style="text-decoration:none; color:#000000">Add </a><?php } else { ?><a href="Javascript:void(0);" onclick="alert('Can not perform Transaction.\nReason:\n1. Todays date is not in Active Current Financial Year.\n2. Transaction after todays date has been made.\n3. Cycle Inventory transaction is under process.');" style="text-decoration:none; color:#000000">Add </a><?php } ?></td>
</tr>
</table></td>
...
$targetpage = $_SERVER['PHP_SELF']; 
  ...
  $sql_arr_home=mysqli_query($link,"select * from tbl_pswrem where plantcode='$plantcode' and pswrem_tflg=1 and pswrem_typ='barcodes'  order by pswrem_code desc LIMIT $start, $limit") or die(mysqli_error($link));
...
$query = "select * from tbl_pswrem where plantcode='$plantcode' and pswrem_tflg=1 and pswrem_typ='barcodes'  order by pswrem_code desc";
...
$pagination = "";
	if($lastpage > 1)
	{	
		$pagination .= "<div class=\"pagination\" align=\"right\" style=\"width:860px\">";
		//previous button
		if ($page > 1) 
...
$sql_arr_home=mysqli_query($link,"select * from tbl_pswrem where pswrem_tflg=1 and pswrem_typ='barcodes'  order by pswrem_code desc LIMIT $from, $max_results") or die(mysqli_error($link));
$tot_arr_home=mysqli_num_rows($sql_arr_home);

 $total_results3 =mysqli_query($link,"SELECT COUNT(*)  FROM tbl_pswrem where pswrem_tflg=1 and pswrem_typ='barcodes'");
$total_results2 = mysqli_fetch_array($total_results3);
$total_results = $total_results2[0]; */
...
<tr class="tblsubtitle" height="20">
	...
	<td width="14%" align="center" valign="middle" class="tblheading">DC No</td>
	<td width="10%" align="center" valign="middle" class="tblheading">DC Date</td>
	<td width="38%" align="center" valign="middle" class="tblheading">Party Name</td>
	<td width="10%" align="center" valign="middle" class="tblheading">Output</td>
</tr>
<?php
//$srno=1;
$crop=""; $variety=""; 
...
while($row_arr_home=mysqli_fetch_array($sql_arr_home))
{
	...
	$quer3=mysqli_query($link,"SELECT * FROM tbl_partymaser where plantcode='$plantcode' and p_id='".$row_arr_home['pswrem_party']."'"); 
	$row3=mysqli_fetch_array($quer3);
	
	$tdate1=$row_arr_home['pswrem_dcdate'];
...
<tr class="Light">
	...
	<td width="14%" align="center" valign="middle" class="tblheading"><?php echo $row_arr_home['pswrem_dcno']?></td>
	<td width="10%" align="center" valign="middle" class="tblheading"><?php echo $tdate2?></td>
	<td width="38%" align="center" valign="middle" class="tblheading"><?php echo $row3['business_name']?></td>
	<td width="10%" align="center" valign="middle" class="tblheading"><a href="Javascript:void(0);" onclick="openprint('<?php echo $row_arr_home['pswrem_id']?>')">BRN</a></td>
</tr>
<?php
}
else
...
{
?>
<table align="center" border="1" cellspacing="0" cellpadding="0" width="800" bordercolor="#ffffff" style="border-collapse:collapse">
