...
<title>psw-Transaction -Bin card</title>
...
$quer3=mysqli_query($link,"SELECT * FROM tblvariety where varietyid ='".$row_tbl123['lotldg_variety']."'"); 
...
<?php
$srno=1;
$sql_tbl=mysqli_query($link,"select lotldg_subbinid, lotldg_variety from tbl_lot_ldg where plantcode='$plantcode' and lotldg_whid='".$wid."' and lotldg_binid='".$bid."' group by lotldg_subbinid, lotldg_variety order by lotldg_subbinid") or die(mysqli_error($link));   
//echo $t=mysqli_num_rows($sql_tbl);
while($row_tbl=mysqli_fetch_array($sql_tbl))
{

$sql_tbl1=mysqli_query($link,"select max(lotldg_id) from tbl_lot_ldg where plantcode='$plantcode' and lotldg_whid='".$wid."' and lotldg_binid='".$bid."' and lotldg_subbinid='".$row_tbl['lotldg_subbinid']."' and lotldg_variety='".$row_tbl['lotldg_variety']."' and lotldg_crop='".$row_tbl['lotldg_crop']."'") or die(mysqli_error($link));  
