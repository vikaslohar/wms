...
$quer4=mysqli_query($link,"SELECT varietyid, popularname FROM tblvariety where varietyid='$vrids' and actstatus='Active'"); 
...
if($owhid=="WH-RO"){if($rowbarcode1['mpmain_wh']<12){if($flg==0)$flg=11;}}
if($owhid=="Deorjhal"){if($rowbarcode1['mpmain_wh']==12){if($flg==0)$flg=11;}}
