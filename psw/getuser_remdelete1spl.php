...
$s_sub="delete from tbl_pswrem_sub where pswremsub_id='".$b."'";
mysqli_query($link,$s_sub) or die(mysqli_error($link));

$s_sub_sub="delete from tbl_pswremsub_sub where pswremsub_id='".$b."'";
mysqli_query($link,$s_sub_sub) or die(mysqli_error($link));

$sql_t_sub=mysqli_query($link,"select * from tbl_pswrem_sub where plantcode='$plantcode' and pswrem_id='".$a."'") or die(mysqli_error($link));
...
{
$s_sub1="delete from tbl_pswrem where pswrem_id='".$a."'";
...
$tdate=$row_tbl['pswrem_date'];
	...
	if($tdate1=="" || $tdate1=="--" || $tdate1=="00-00-0000")$tdate1=date("d-m-Y");
