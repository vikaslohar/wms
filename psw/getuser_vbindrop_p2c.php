...
?>
&nbsp;<select class="tbltext" id="<?php echo $nid;?>" name="<?php echo $id;?>" style="width:60px;" <?php if($b=="bing1"){?>onchange="bin(this.value,'1');"<?php }if($b=="bing2"){?>onchange="bin(this.value,'2');"<?php } ?>   >
