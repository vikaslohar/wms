...
$sql_tbl=mysqli_query($link,"select * from tbl_sloc_psw where plantcode='$plantcode' and surole='".$logid."' and supflg=0") or die(mysqli_error($link));
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#0BC5F4" >
	  ...
	  <table width="809" border="0" cellpadding="0" cellspacing="0" bordercolor="#0BC5F4" style="border-bottom:solid; border-bottom-color:#0BC5F4" >
	    <tr >
	      <td width="810" height="25">&nbsp;Transaction - SLOC Updation - Lot wise</td>
	    </tr></table></td>
...
<td align="center" width="100" valign="middle" class="tblbutn" style="cursor:hand;"><?php if($flg==0 && $flg1==0 && $flg2==0) { ?><a href="add_sloc.php" style="text-decoration:none; color:#000000">Add </a><?php } else { ?><a href="Javascript:void(0);" onclick="alert('Can not perform Transaction.\nReason:\n1. Todays date is not in Active Current Financial Year.\n2. Transaction after todays date has been made.\n3. Cycle Inventory transaction is under process.');" style="text-decoration:none; color:#000000">Add </a><?php } ?></td>
</tr>
...
<?php
 ...
 $targetpage = $_SERVER['PHP_SELF']; 
  ...
  $sql_arr_home=mysqli_query($link,"select * from tbl_sloc_psw where plantcode='$plantcode' and supflg=1 order by slid desc LIMIT $start, $limit") or die(mysqli_error($link));
...
$query = "select * from tbl_sloc_psw where plantcode='$plantcode' and supflg=1 order by slid desc";
...
<tr class="Light">
         ...
         <td width="10%" align="center" valign="middle" class="tblheading"><?php echo "SU".$row_arr_home['scode']."/".$row_arr_home['yearcode']."/".$srole;?></td>
         ...
         <td width="21%" align="center" valign="middle" class="tblheading"><?php echo $row_arr_home['lotno']?></td>
</tr>
<?php
}
else
