...
if(tp=="subformedt")
{ 
var url="getuser_remedtsubform1spl.php";
url=url+"?a="+str;
url=url+"&sid="+Math.random();
xmlHttp.onreadystatechange=stateChanged ;
xmlHttp.open("GET",url,true);
...
if(tp=="mform")
{ 
var url="getuser_remupdateform1spl.php";
url=url+"?"+str; 
//alert(str);
url=url+"&sid="+Math.random();
xmlHttp.onreadystatechange=stateChanged ;
...
if(tp=="mformsubedt")
{ 
var url="getuser_remeditsubupdate1spl.php";
url=url+"?"+str; 
url=url+"&sid="+Math.random();
xmlHttp.onreadystatechange=stateChanged ;
xmlHttp.open("GET",url,true);
...
if(tp=="delete")
{
var url="getuser_remdelete1spl.php";
url=url+"?a="+str;
url=url+"&b="+d;
url=url+"&c="+e;
url=url+"&sid="+Math.random();
...
{
	//alert(tp); 
var url="getuser_qtyrem_showrecspl.php";
url=url+"?a="+str;
url=url+"&b="+d;
url=url+"&c="+e;
url=url+"&h="+i;
