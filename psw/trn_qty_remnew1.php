<?php
	...
	//exit;
		...
		//$sql_main="insert into tbl_pswrem(pswrem_tcode, pswrem_date, logid, yearcode)values('$txtid','$tdate1','$logid', '$yearid_id')";
...
{	
	...
	{
				alert("Please only upload files that end in type: .xls or .xlsx "
				+ "\nPlease select a new "
				+ "file to upload and submit again.");
				document.frmaddDepartment.txtbrowse.focus();
				return false;
...
{ 
	...
	var dtarr=dt.split("-");
	var cdate=(dtarr[0]+dtarr[1]+dtarr[2]).trim();
		alert(document.frmaddDepartment.txtdcno.value);
		alert(filechk);
	if(document.frmaddDepartment.txtbrowse.value != "")
	{
		var extArray = new Array(".xls",".xlsx");
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#0BC5F4" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#0BC5F4" style="border-bottom:solid; border-bottom-color:#0BC5F4" >
	    <tr >
	      <td width="813" height="25" class="Mainheading">&nbsp;Transaction - Pack Seed Release</td>
	    </tr></table></td>
...
<td width="229" align="left" valign="middle" class="tbltext">&nbsp;<input name="txtdcno" type="text" size="20" class="tbltext" tabindex="" maxlength="20" onChange="dcdchk();"/>&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
</tr>
<?php
...
<table align="center" border="1" width="850" cellspacing="0" cellpadding="0" bordercolor="#0BC5F4" style="border-collapse:collapse" > 
<tr class="tblsubtitle" height="20">
  <td colspan="4" align="center" class="tblheading">Upload Barcodes Excel</td>
</tr>

<tr class="Dark" height="25">
<td width="206"  align="right"  valign="middle" class="tblheading">Barcodes&nbsp;</td>
<td align="left"  valign="middle" colspan="3" class="tbltext">&nbsp;<input name="txtbrowse" class="tbltext" type="file" size="30"   />&nbsp;<font color="#FF0000" >*</font>&nbsp;</td></tr>
</table>
