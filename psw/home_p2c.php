<?php
	...
	$s_sub="delete from tbl_pspunpp2c where unp_logid='".$logid."' and unp_tflg=0";
...
<title>PSW - Transaction - Pack Seed Unpacking - Pack to Condition (P2C) - Home</title>
...
<!--<table align="center" border="1" cellspacing="0" cellpadding="0" width="700" bordercolor="#0BC5F4" style="border-collapse:collapse">
  ...
  $sql_arr_home=mysqli_query($link,"select * from tbl_pspunpp2c where plantcode='$plantcode' and unp_tflg=1 LIMIT $start, $limit") or die(mysqli_error($link));
...
$query = "select * from tbl_pspunpp2c where plantcode='$plantcode' and  unp_tflg=1";
...
$sql_arr_home=mysqli_query($link,"select * from tbl_pspunpp2c where unp_tflg=1 and unp_logid='$logid' LIMIT $from, $max_results") or die(mysqli_error($link));
$tot_arr_home=mysqli_num_rows($sql_arr_home);
//$tot_arr_home=0;

$total_results3 =mysqli_query($link,"SELECT COUNT(*)  FROM tbl_pspunpp2c where unp_tflg=1 and unp_logid='$logid'");
$total_results2 = mysqli_fetch_array($total_results3);
$total_results = $total_results2[0]; 
*/
    if($tot_arr_home >0) { 
?>
<table align="center" border="0" width="850" cellspacing="0" cellpadding="0" bordercolor="#0BC5F4" style="border-collapse:collapse" > 
...
while($row_arr_home=mysqli_fetch_array($sql_arr_home))
{
	...
	$sql_sub2=mysqli_query($link,"Select * from tbl_pspunpp2c_sub2 where plantcode='$plantcode' and unp_id='$arrival_id'") or die(mysqli_error($link));
...
<tr class="Light">
    ...
    <td align="center" valign="middle" class="smalltbltext"><a href="Javascript:void(0)" onclick="openslocpopprint('<?php echo $arrival_id;?>');">SP-P2C Note</a></a></td>
</tr>
<?php
}
else
