<?php
	...
	if(isset($_POST['frm_action'])=='submit')
	{
		...
		echo "<script>window.location='report_whwise1.php?txtslwhg=$txtslwhg&txtslbing=$txtslbing&txtslsubbing2=$txtslsubbing2'</script>";
	}
...
<title>psw-Report - Warehouse wise Report</title>
...
{	
	...
	{
	document.getElementById("txtslbing").selectedIndex=0;
	document.getElementById("txtslbing").options.length = 1;
	document.getElementById("txtslsubbing2").selectedIndex=0;
	document.getElementById("txtslsubbing2").options.length = 1;
	}
}
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#0BC5F4" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#0BC5F4" style="border-bottom:solid; border-bottom-color:#0BC5F4" >
	    <tr >
	      <td width="813" height="30"class="Mainheading"  >Warehouse wise Pack Seed Report</td>
	    </tr></table></td>
	  </tr>
	  </table></td></tr>
	  ...
	  <input type="hidden" name="slck" value="yes" />
	    <table  border="0" cellspacing="0" cellpadding="0" align="center" width="974"  style="border-collapse:collapse">
          ...
          <tr>
            <td width="30"></td>
            <td>
<table align="center" border="1" width="600" cellspacing="0" cellpadding="0" bordercolor="#0BC5F4" style="border-collapse:collapse" >
<tr class="tblsubtitle" height="25">
	<td colspan="2" align="center" class="tblheading">Warehouse wise Pack Seed Report</td>
</tr>
<tr height="15">
