...
$sss="";
$qr="select distinct lotldg_lotno, lotldg_alflg, lotldg_dispflg, lotldg_rvflg from tbl_lot_ldg where plantcode='$plantcode' and lotldg_crop='".$crop."' and lotldg_variety='".$variety."' and lotldg_sstage='".$tp."' and lotldg_balqty > 0 $sss ";
