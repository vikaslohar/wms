...
?>
    ...
    <td width="158"  align="left"  valign="middle" class="tbltext" id="vitem2">&nbsp;<input type="text" class="tbltext" name="txtups"  value="<?php echo $row['upssize'];?>" size="15" readonly="true" style="background-color:#CCCCCC"  />&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
           </tr>
</table>		   
<table align="center" border="1" width="970" cellspacing="0" cellpadding="0" bordercolor="#0BC5F4" style="border-collapse:collapse" >
<tr class="tblsubtitle" height="20">
...
$sql_binn=mysqli_query($link,"select binname from tbl_bin where plantcode='$plantcode' andbinid='".$row_issue['binid']."' and whid='".$row_issue['whid']."'") or die(mysqli_error($link));
