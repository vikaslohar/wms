...
*/
	...
	{ 
		...
		$code=trim($_POST['code']);
	 	...
	 	$sql_in1="insert into tbl_sloc_binw2 (code, sldate, wh, bin, yearcode, surole,stage, plantcode) values ('$code', '$tdate', '$who', '$bino', '$yearid_id', '$lgnid','$stageo', '$plantcode')";
...
?>                 
    ...
    <td width="194"  align="left"  valign="middle" class="tbltext" id="bing2">&nbsp;<select class="tbltext" name="txtslbing2" style="width:80px;"  >
     <option value="" selected>--Bin--</option>
    </select>&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
	
	    <!--<td width="117" height="30" align="right" valign="middle" class="tblheading">Select Sub Bin&nbsp;</td>
                  
    <td width="197"  align="left"  valign="middle" class="tbltext" id="sbing2">&nbsp;<select class="tbltext" name="txtslsubbing2" style="width:80px;"  >
