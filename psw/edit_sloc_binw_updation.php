<?php
	...
	$a="TBU";
	$sql_code="SELECT MAX(code) FROM tbl_sloc_binw  where  plantcode='$plantcode' and yearcode='$yearid_id'  ORDER BY code DESC";
...
<title>PSW -Transaction  - Sloc Update SubBin wise</title>
...
{ 
	...
	//alert(document.frmaddDepartment.olots.value);
	...
	if(document.frmaddDepartment.olots.value=="")
	{
		alert("Please select Lot to update SLOC");
		return false;
	}
	return true;	 
}
...
<table align="center" border="1" width="750" cellspacing="0" cellpadding="0" bordercolor="#0BC5F4" style="border-collapse:collapse"  cols="2">
  <tr class="tblsubtitle">
    <td width="70" align="center" valign="middle" class="tblheading" >Select</td>
...
<tr class="Light" height="30">
	...
	<td width="256"  align="center"  valign="middle">&nbsp;<?php echo $lot;?>&nbsp;</td>
</tr>
 <?php
}
else
...
<tr >
<td valign="top" align="right"><a href="home_sloc3.php"><img src="../images/cancel.gif" border="0"  style="display:inline;cursor:pointer;" onclick="return confirm('Do You wish to Cancel this Transaction?');"/></a>&nbsp;<input name="Submit" type="image" src="../images/preview.gif" alt="Submit Value" onClick="return mySubmit();"  border="0" style="display:inline;cursor:pointer;" />&nbsp;&nbsp;</td>
</tr>
</table>
</div>
<?php
...
<table align="center" width="750" cellpadding="5" cellspacing="5" border="0" >
<tr >
<td valign="top" align="right"><a href="home_sloc3.php"><img src="../images/cancel.gif" border="0"  style="display:inline;cursor:pointer;" onclick="return confirm('Do You wish to Cancel this Transaction?');"/></a>&nbsp;</td>
</tr>
</table> 
</div>
<?php
