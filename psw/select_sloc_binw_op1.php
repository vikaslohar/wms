...
<title>PSW -Transaction: SLOC Updation Bin wise - Output</title>
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#0BC5F4" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#0BC5F4" style="border-bottom:solid; border-bottom-color:#0BC5F4" >
	    <tr >
	      <td width="813" height="25" class="Mainheading">&nbsp;Transaction: SLOC Updation Bin wise - Output </td>
	    </tr></table></td>
	  </tr>
	  </table></td></tr>
...
<?php
$sql_tbl=mysqli_query($link,"select * from tbl_lot_ldg_pack where plantcode='$plantcode' and trtype='SBWSUO' and lotldg_id='".$pid."'") or die(mysqli_error($link));
...
<?php
$sql_tbl=mysqli_query($link,"select * from tbl_lot_ldg_pack where plantcode='$plantcode' and trtype='SBWSUC' and lotldg_id='".$pid."'") or die(mysqli_error($link));
...
<tr >
<td valign="top" align="center"><a href="home_sloc2.php"><img src="../images/back.gif" border="0"style="display:inline;cursor:pointer;" /></a>&nbsp;&nbsp;&nbsp;
