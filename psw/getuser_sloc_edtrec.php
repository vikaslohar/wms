...
$sql_in1=mysqli_query($link,"select * from tbl_sloc_psw where plantcode='$plantcode' and slid=$trid") or die(mysqli_error($link));
...
$sql_subtbl=mysqli_query($link,"select * from tbl_sloc_psw_sub where plantcode='$plantcode' and slocid='".$trid."' and rowid='".$stldgid."'") or die(mysqli_error($link));
...
<?php
$whi=0;$bni=0;$sbni=0;
/*$sql_issue=mysqli_query($link,"select distinct whid, subbinid, binid from tbl_lot_ldg_pack where lotldg_crop='".$c."' and lotldg_variety='".$b."'") or die(mysqli_error($link));
...
$sql_issuetbl=mysqli_query($link,"select * from tbl_lot_ldg_pack where plantcode='$plantcode' and lotdgp_id='".$stldgid."' and balqty > 0") or die(mysqli_error($link)); 
...
$nop2;
$zz=str_split($row_issuetbl['lotno']);
...
$sql_mps=mysqli_query($link,"Select * from tbl_mpmain where plantcode='$plantcode' and mpmain_trtype='PACKSMC' and mpmain_lotno='".$row_issuetbl['lotno']."' and mpmain_dflg!=1 and mpmain_upflg=0") or die(mysqli_error($link));
...
if($tot_mps > 0)
{
	while($row_mps=mysqli_fetch_array($sql_mps))
	{
		...
		{
			if($row_issuetbl['lotno']==$lotarr[$i] && $ups==$upsarr)
			{
				$nops=$nops+$noparr[$i];
				$ct++;
				$up=explode(" ", $ups);
...
if($tot_mpm > 0)
{
	while($row_mpm=mysqli_fetch_array($sql_mpm))
	{
		...
		for ($i=0; $i<count($lotarr); $i++)
		{
			if($row_issuetbl['lotno']==$lotarr[$i] && $ups==$upsarr[$i])
			{
				$nopm=$nopm+$noparr[$i];
				$ct++;
				$up=explode(" ", $ups);
...
$sql_mpns=mysqli_query($link,"Select * from tbl_mpmain where plantcode='$plantcode' and mpmain_trtype='PACKNMC' and mpmain_lotno='".$row_issuetbl['lotno']."' and mpmain_dflg!=1 and mpmain_upflg=0") or die(mysqli_error($link));
...
$sql_issue=mysqli_query($link,"select distinct whid, subbinid, binid from tbl_lot_ldg_pack where plantcode='$plantcode' and lotldg_crop='".$c."' and lotldg_variety='".$b."' and lotno='".$txtlot1."'") or die(mysqli_error($link));
...
$totBags=0; $totqty=0; $cnt=0; $whid="";$binid="";$subbinid="";
 ...
 $sql_issue1=mysqli_query($link,"select max(lotdgp_id) from tbl_lot_ldg_pack where plantcode='$plantcode' and subbinid='".$row_issue['subbinid']."' and binid='".$row_issue['binid']."' and whid='".$row_issue['whid']."' and lotldg_variety='".$b."' and lotno='".$txtlot1."'") or die(mysqli_error($link));
...
if($trid > 0)
{
$sql_subtb=mysqli_query($link,"select * from tbl_sloc_psw_sub where plantcode='$plantcode' and slocid='".$trid."' and subbinid='".$row_issue['subbinid']."' and  binid='".$row_issue['binid']."' and  whid='".$row_issue['whid']."'") or die(mysqli_error($link));
$row_subtb=mysqli_num_rows($sql_subtb);
}
else
{
//$sql_subtb=mysqli_query($link,"select * from tbl_sloc_psw_sub where gid='".$trid."' and rowid!='".$row_issue1[0]."'") or die(mysqli_error($link));
$row_subtb=0;
}
//echo $row_subtb;
...
// echo $row_issuetbl['stld_whid']."/".$row_issuetbl['stld_binid']."/".$row_issuetbl['stld_subbinid']."<br>";
 ...
 /*$sql_subtb=mysqli_query($link,"select * from tbl_sloc_psw_sub where gid='".$trid."' and rowid='".$stldgid."'") or die(mysqli_error($link));
 $tot_subt=mysqli_num_rows($sql_subtb);
 $row_subt=mysqli_fetch_array($sql_subtb);
 if($tot_subt == 0)
{*/
 $cnt++;
 $whid=$row_issuetbl['whid'];$binid=$row_issuetbl['binid'];$subbinid=$row_issuetbl['subbinid'];
...
?>
    <td width="75" align="center"  valign="middle" class="tbltext">&nbsp;<select class="tbltext" name="txtslwhg<?php echo $srno?>" style="width:59px;" onchange="wh<?php echo $srno?>(this.value);"  >
          <option value="" selected>WH</option>
          <?php while($noticia_whg1 = mysqli_fetch_array($whg1_query)) { ?>
          <option <?php if($row_issuetbl['whid']==$noticia_whg1['whid']) echo "selected";?> value="<?php echo $noticia_whg1['whid'];?>" />  
          <?php echo $noticia_whg1['perticulars'];?>
          <?php } ?>
    </select>&nbsp;<font color="#FF0000">*</font></td>
    <?php
$bing1_query=mysqli_query($link,"select binid, binname from tbl_bin where plantcode='$plantcode' and whid='".$row_issuetbl['whid']."'") or die(mysqli_error($link));
?>
    <td width="60" align="center"  valign="middle" class="tbltext" id="bing<?php echo $srno?>">&nbsp;<select class="tbltext" name="txtslbing<?php echo $srno?>" style="width:43px;" onchange="bin<?php echo $srno?>(this.value);" >
          <option value="" selected>Bin</option>
		  <?php while($noticia_bing1 = mysqli_fetch_array($bing1_query)) { ?>
          <option <?php if($row_issuetbl['binid']==$noticia_bing1['binid']) echo "selected";?> value="<?php echo $noticia_bing1['binid'];?>" />  
          <?php echo $noticia_bing1['binname'];?>
          <?php } ?>
    </select>&nbsp;<font color="#FF0000">*</font></td>
    <?php
$subbing1_query=mysqli_query($link,"select sid, sname from tbl_subbin where plantcode='$plantcode' and whid='".$row_issuetbl['whid']."' and binid='".$row_issuetbl['binid']."'") or die(mysqli_error($link));
?>
    <td width="59" align="center"  valign="middle" class="tbltext" id="sbing<?php echo $srno?>">&nbsp;<select class="tbltext" name="txtslsubbg<?php echo $srno?>" style="width:40px;" onchange="subbin<?php echo $srno?>(this.value);"  >
          <option value="" selected>SBin</option>
		  <?php while($noticia_subbing1 = mysqli_fetch_array($subbing1_query)) { ?>
          <option <?php if($row_issuetbl['subbinid']==$noticia_subbing1['sid']) echo "selected";?> value="<?php echo $noticia_subbing1['sid'];?>" />  
...
<td width="32%" align="center" valign="middle" class="tblheading"><input type="text" name="exnopsg<?php echo $srno;?>" class="smalltbltext" value="<?php echo $row_issuetbl['balnop'];?>" readonly="true" style="background:#CCCCCC" size="6" /></td>
...
<td  align="left" width="60"  valign="middle" class="smalltbltext">&nbsp;<input name="txtslnopsg<?php echo $srno;?>" id="nops<?php echo $srno;?>" type="text" size="4" class="smalltbltext" tabindex="" maxlength="6" onkeypress="return isNumberKey(event)" onchange="nopsf<?php echo $srno;?>(this.value);" value="<?php echo $row_issuetbl['balnop'];?>"  />&nbsp;<font color="#FF0000">*</font></td>	
...
<td align="center" valign="middle" class="smalltbltext"><input type="text" name="balnopg<?php echo $srno;?>" class="smalltbltext" value=""  size="6" readonly="true" style="background:#CCCCCC" /></td>
<td align="center" valign="middle" class="smalltbltext"><input type="text" name="balnompg<?php echo $srno;?>" class="smalltbltext" value=""  size="5" readonly="true" style="background:#CCCCCC" /></td>
<td align="center" valign="middle" class="smalltbltext"><input type="text" name="balqtyg<?php echo $srno;?>" class="smalltbltext" value="" readonly="true" style="background:#CCCCCC" size="6" /></td> <input type="hidden" name="dorowig<?php echo $srno;?>" value="<?php echo $row_issuetbl['lotdgp_id'];?>" />
</tr>
 <?php
 }
 else
...
<table align="center" height="27" width="100%"  border="1" cellspacing="0" cellpadding="0" bordercolor="#0BC5F4" style="border-collapse:collapse" >	
<td width="32%" align="center" valign="middle" class="tblheading"><input type="text" name="exnopsg<?php echo $srno;?>" class="smalltbltext" value="<?php echo $row_issuetbl['balnop'];?>" readonly="true" style="background:#CCCCCC" size="6" /></td>
<td width="30%" align="center" valign="middle" class="tblheading"><input type="text" name="exBagsg<?php echo $srno;?>" class="smalltbltext" value="<?php echo $row_issuetbl['balnomp'];?>" readonly="true" style="background:#CCCCCC" size="5" /></td>
<td width="38%" align="center" valign="middle" class="tblheading"><input type="text" name="exqtyg<?php echo $srno;?>" class="smalltbltext" value="<?php echo $row_issuetbl['balqty'];?>" readonly="true" style="background:#CCCCCC" size="7" /></td>
</table>
</div>
</td>
...
$numrec=count($p1_array);
 $ct=0;$up=0;$qt=0; $Bags=0; $qty=0; $blBags=0; $blqty=0;$blnop1=0; $onop1=0;$nop1=0;
 $sql_gddist=mysqli_query($link,"select distinct whid, binid, subbinid from tbl_sloc_psw_sub where plantcode='$plantcode' andslocid='".$trid."' order by slocsubid") or die(mysqli_error($link));
while($t_gddist=mysqli_fetch_array($sql_gddist))
 {
 $sql_gdsum=mysqli_query($link,"select sum(nop), sum(nomp), sum(qty) from tbl_sloc_psw_sub where plantcode='$plantcode' and slocid='".$trid."' and whid='".$t_gddist['whid']."' and binid='".$t_gddist['binid']."' and subbinid='".$t_gddist['subbinid']."' order by slocsubid") or die(mysqli_error($link));
$t_gdsum=mysqli_fetch_array($sql_gdsum);
/*$up=$t_gdsum[0];
$qt=$t_gdsum[1];*/
//echo $p1_array[$ct];
/*$sql_iss=mysqli_query($link,"select max(slocsubid) from tbl_sloc_psw_sub where gid='".$trid."' and whid='".$t_gddist['whid']."' and binid='".$t_gddist['binid']."' and subbinid='".$t_gddist['subbinid']."'") or die(mysqli_error($link));
 $t=mysqli_fetch_array($sql_iss);*/
//$srno=1;
//echo $t[0];
$sql_issue=mysqli_query($link,"select * from tbl_sloc_psw_sub where plantcode='$plantcode' and slocsubid='".$p1_array[$ct]."' order by slocsubid") or die(mysqli_error($link));
$totBags=0; $totqty=0; $totnop=0;
 while($row_issue=mysqli_fetch_array($sql_issue))
 { 
	$onop1=$row_issue['opnop'];
	$up=$row_issue['opnomp'];
	$qt=$row_issue['opqty'];
	$nop1=$row_issue['nop'];
	$Bags=$row_issue['nomp'];
	$qty=$row_issue['qty'];
	$blnop1=$row_issue['balnop'];
	$blBags=$row_issue['balnomp'];
	$blqty=$row_issue['balqty'];
	...
	$totnop=$totnop+$row_issue['nop'];
	$totBags=$totBags+$row_issue['nomp'];
...
<div id="slcrow<?php echo $srno?>">
<table align="center" height="27" width="100%"  border="1" cellspacing="0" cellpadding="0" bordercolor="#0BC5F4" style="border-collapse:collapse" >	
<td width="32%" align="center" valign="middle" class="tblheading"><input type="text" name="exnopsg<?php echo $srno;?>" class="smalltbltext" value="<?php echo $onop1;?>" readonly="true" style="background:#CCCCCC" size="6" /></td>
...
<td align="right" width="51"  valign="middle" class="smalltblheading">&nbsp;NoMP&nbsp;</td>
<td  align="left" width="53"  valign="middle" class="smalltbltext">&nbsp;<input name="txtslBagsg<?php echo $srno;?>" id="Bags<?php echo $srno;?>" type="text" size="3" class="smalltbltext" tabindex="" maxlength="5" onkeypress="return isNumberKey(event)" onchange="Bagsf<?php echo $srno;?>(this.value);" value="<?php echo $Bags;?>"   />&nbsp;<font color="#FF0000">*</font></td>	
<td  align="right" width="31"  valign="middle" class="smalltblheading">&nbsp;Qty&nbsp;</td>
<td width="65" align="left"  valign="middle" class="smalltbltext">&nbsp;<input name="txtslqtyg<?php echo $srno;?>" id="qty<?php echo $srno;?>" type="text" size="5" class="smalltbltext" tabindex="" maxlength="7" onkeypress="return isNumberKey(event)" value="<?php echo $qty;?>"  readonly="true" style="background:#CCCCCC"  />&nbsp;<font color="#FF0000">*</font></td>
</tr></table></div></td>
<td align="center" valign="middle" class="smalltbltext"><input type="text" name="balnopg<?php echo $srno;?>" class="smalltbltext" value="<?php echo $blnop1;?>"  size="6" readonly="true" style="background:#CCCCCC" /></td>
<td align="center" valign="middle" class="smalltbltext"><input type="text" name="balnompg<?php echo $srno;?>" class="smalltbltext" value="<?php echo $blBags;?>"  size="5" readonly="true" style="background:#CCCCCC" /></td>
<td align="center" valign="middle" class="smalltbltext"><input type="text" name="balqtyg<?php echo $srno;?>" class="smalltbltext" value="<?php echo $blqty;?>" readonly="true" style="background:#CCCCCC" size="6" /></td> <input type="hidden" name="dorowig1" value="<?php echo $row_issue['rowid'];?>" />
</tr>
 <?php
 }
 else
 ...
 <tr class="Dark" height="25">
  <?php
$whg1_query=mysqli_query($link,"select whid, perticulars from tbl_warehouse where plantcode='$plantcode' and order by perticulars") or die(mysqli_error($link));
?>
    <td width="75" align="center"  valign="middle" class="tbltext">&nbsp;<select class="tbltext" name="txtslwhg<?php echo $srno?>" style="width:59px;" onchange="wh<?php echo $srno?>(this.value);"  >
          <option value="" selected>WH</option>
          <?php while($noticia_whg1 = mysqli_fetch_array($whg1_query)) { ?>
...
<?php
$whd2_query=mysqli_query($link,"select whid, perticulars from tbl_warehouse where plantcode='$plantcode' and order by perticulars") or die(mysqli_error($link));
?>
