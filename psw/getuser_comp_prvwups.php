...
$cnt24=0;
$sql_iss240=mysqli_query($link,"select distinct (lotldg_subbinid)  from tbl_lot_ldg where plantcode='$plantcode' and lotldg_whid='".$b24."' and lotldg_binid='".$c24."' and lotldg_subbinid='".$a24."' ") or die(mysqli_error($link));
...
$sql_iss240=mysqli_query($link,"select distinct (subbinid)  from tbl_lot_ldg_pack where plantcode='$plantcode' and whid='".$b24."' and binid='".$c24."' and subbinid='".$a24."' ") or die(mysqli_error($link));
$tot240=mysqli_num_rows($sql_iss240);
while($row_iss240=mysqli_fetch_array($sql_iss240))
{ 
...
<table align="center" width="750" cellpadding="5" cellspacing="5" border="0" >
<tr >
<td valign="top" align="right" class="tblheading"><font color="#FF0000">Veriety/Stage not matching in selected SLOC. Select another Bin.</font>&nbsp;&nbsp;<a href="home_sloc1.php"><img src="../images/cancel.gif" border="0"  style="display:inline;cursor:pointer;" onclick="return confirm('Do You wish to Cancel this Transaction?');"/></a>&nbsp;</td>
</tr>
</table> 
<?php
}
