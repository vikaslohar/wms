...
$sql_tbl=mysqli_query($link,"select * from tbl_pswrem where plantcode='$plantcode' and logid='$logid' and  pswrem_tflg=0 and pswrem_typ='splrelease'") or die(mysqli_error($link));
while($row_tbl=mysqli_fetch_array($sql_tbl))
{
	...
	$s_sub="delete from tbl_pswrem where logid='$logid' and  pswrem_tflg=0 and pswrem_typ='splrelease'";
	mysqli_query($link,$s_sub) or die(mysqli_error($link));	
...
<title>PSW - Transaction - Pack Seed SP Release</title>
...
{
winHandle=window.open('pssrnd_print.php?pid='+itm,'WelCome','top=170,left=180,width=820,height=350,scrollbars=yes');
if(winHandle==null){
alert("While Launching New Window...\nYour browser maybe blocking up Popup windows. \n\n  Please check your Popup Blocker Settings or ..\n Please hold Ctrl Key and Click on link to open new Browser"); }
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#0BC5F4" >
	  ...
	  <table width="820" border="0" cellpadding="0" cellspacing="0" bordercolor="#0BC5F4" style="border-bottom:solid; border-bottom-color:#0BC5F4" >
	    <tr >
	      <td width="820" height="25">&nbsp;Transaction - Pack Seed SP Release</td>
	    </tr></table></td>
...
<td align="center" width="100" valign="middle" class="tblbutn" style="cursor:Pointer;"><?php if($flg==0 && $flg1==0 && $flg2==0) { ?><a href="trn_qty_removalspld.php" style="text-decoration:none; color:#000000">Add </a><?php } else { ?><a href="Javascript:void(0);" onclick="alert('Can not perform Transaction.\nReason:\n1. Todays date is not in Active Current Financial Year.\n2. Transaction after todays date has been made.\n3. Cycle Inventory transaction is under process.');" style="text-decoration:none; color:#000000">Add </a><?php } ?></td>
</tr>
</table></td>
...
$targetpage = $_SERVER['PHP_SELF']; 
  ...
  $sql_arr_home=mysqli_query($link,"select * from tbl_pswrem where plantcode='$plantcode' and pswrem_tflg=1 and pswrem_typ='splrelease' order by pswrem_code desc LIMIT $start, $limit") or die(mysqli_error($link));
...
$query = "select * from tbl_pswrem where plantcode='$plantcode' and pswrem_tflg=1 and pswrem_typ='splrelease' order by pswrem_code desc";
...
$sql_arr_home=mysqli_query($link,"select * from tbl_pswrem where pswrem_tflg=1 and pswrem_typ='splrelease' order by pswrem_code desc LIMIT $from, $max_results") or die(mysqli_error($link));
$tot_arr_home=mysqli_num_rows($sql_arr_home);

 $total_results3 =mysqli_query($link,"SELECT COUNT(*)  FROM tbl_pswrem where pswrem_tflg=1 and pswrem_typ='splrelease'");
$total_results2 = mysqli_fetch_array($total_results3);
$total_results = $total_results2[0]; 
   */
?>
...
<tr class="Light" height="20">
  <td colspan="6" align="center" class="tblheading">Pack Seed SP Release</td>
</tr>
</table>
...
<tr class="tblsubtitle" height="20">
	...
	<td width="8%" align="center" valign="middle" class="tblheading">Output</td>
</tr>
<?php
//$srno=1;
$crop=""; $variety=""; 
...
<tr class="Light">
	...
	<td width="8%" align="center" valign="middle" class="tblheading"><a href="Javascript:void(0);" onclick="openprint('<?php echo $arrival_id?>')">PSSPRN</a></td>
</tr>
<?php
}
else
