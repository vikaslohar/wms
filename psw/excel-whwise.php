...
session_start();
	...
	{	
	$qry.="Select Distinct lotldg_binid from tbl_lot_ldg where plantcode='$plantcode' and lotldg_sstage='Pack' and lotldg_subbinid='$txtslsubbing2' and lotldg_binid='$txtslbing' and lotldg_whid='$txtslwhg'";
	}
	else if($txtslbing!="ALL" && $txtslsubbing2=="ALL")
	{	
	$qry.="Select Distinct lotldg_binid from tbl_lot_ldg where plantcode='$plantcode' and lotldg_sstage='Pack' and lotldg_binid='$txtslbing' and lotldg_whid='$txtslwhg'";
	}
	else
	{
	$qry.="Select Distinct lotldg_binid from tbl_lot_ldg where plantcode='$plantcode' and lotldg_sstage='Pack' and lotldg_whid='$txtslwhg'";
	}
...
if($txtslsubbing2=='ALL')
{ 
  $sql_tb="select distinct(lotldg_subbinid) from tbl_lot_ldg where plantcode='$plantcode' and lotldg_whid='".$txtslwhg."' and lotldg_binid='".$row_arr_home1['lotldg_binid']."' and lotldg_sstage='Pack' order by lotldg_subbinid";  
}
 else
{
$sql_tb="select distinct(lotldg_subbinid) from tbl_lot_ldg where plantcode='$plantcode' and lotldg_whid='".$txtslwhg."' and lotldg_binid='".$row_arr_home1['lotldg_binid']."' and lotldg_subbinid='".$txtslsubbing2."'  and lotldg_sstage='Pack' order by lotldg_subbinid";  
 }
...
{
$sql_tbl1=mysqli_query($link,"select max(lotldg_id) from tbl_lot_ldg where plantcode='$plantcode' and lotldg_whid='".$txtslwhg."' and lotldg_binid='".$row_arr_home1['lotldg_binid']."' and lotldg_subbinid='".$row_tbl['lotldg_subbinid']."' and lotldg_sstage='Pack' group by lotldg_lotno order by lotldg_id desc") or die(mysqli_error($link));  
...
$data1[$cnt][$d]=array($subbin,$lotn,$crop,$variet.$stage,$bags,$qty,$qc,$trdate1,$moist,$gemp,$got,$sststus); 
$d++;
}
}
}
