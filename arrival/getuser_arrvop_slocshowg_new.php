...
$sql_issue1=mysqli_query($link,"select * from tbl_lot_ldg where orlot='".$f."' and plantcode='$plantcode'") or die(mysqli_error($link));
$t=mysqli_num_rows($sql_issue1);
$sql_i="select * from tblarrival_sub where orlot='".$f."' and arrsub_id!='".$rid."' and plantcode='$plantcode'";
...
{
?>
<table align="center" border="1" width="950" cellspacing="0" cellpadding="0" bordercolor="#F1B01E" style="border-collapse:collapse" ><tr>
