...
?>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#F1B01E" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#F1B01E" style="border-bottom:solid; border-bottom-color:#F1B01E" >
	    <tr >
	      <td width="813" height="25">&nbsp;Fresh Arrival  With PDN</td>
	    </tr></table></td>
	  </tr>
	  </table></td></tr>
...
<tr class="tblsubtitle" height="25">
			<td width="19" align="center" valign="middle" class="tblheading" rowspan="3">#</td>
			<td width="64" align="center" valign="middle" class="tblheading" rowspan="3">Date Of Arrival </td>
			<td width="103"  align="center" valign="middle" class="tblheading" rowspan="3">Crop</td>
			<td width="84" align="center" valign="middle" class="tblheading" rowspan="3">Variety </td>
			<td width="50"  align="center" valign="middle" class="tblheading" rowspan="3">PDN </td>
			<td width="66"  align="center" valign="middle" class="tblheading" rowspan="3">Lot No.</td>
			  <td colspan="2"  align="center" valign="middle" class="tblheading" rowspan="3">Diff</td>
			<td width="55"  align="center" valign="middle" class="tblheading" colspan="2">Qty</td>
			<td width="103" align="center" valign="middle" class="tblheading" colspan="2">Actual</td>
			<td width="38"  align="center" valign="middle" class="tblheading" colspan="2">Difference</td>
			<td width="80" align="center" valign="middle" class="tblheading" rowspan="3">Organiser </td>
			<td width="82" align="center" valign="middle" class="tblheading" rowspan="3">Farmaer </td>
			
  </tr>
			<tr class="tblsubtitle">
			  <td rowspan="2" align="center" valign="middle" class="tblheading">Bag</td>
			  <td rowspan="2" align="center" valign="middle" class="tblheading">Qty</td>
               <td rowspan="2" align="center" valign="middle" class="tblheading">Bag</td>
			  <td rowspan="2" align="center" valign="middle" class="tblheading">Qty</td>
			  <td rowspan="2" align="center" valign="middle" class="tblheading">Bag</td>
			  <td rowspan="2" align="center" valign="middle" class="tblheading">Qty</td>
...
$sql_tbl_sub=mysqli_query($link,"select * from tblarrival_sub where lotnoid='".$lid."'") or die(mysqli_error($link));
...
$sql_tbl_sub=mysqli_query($link,"select * from tblarrival_sub where arid='".$row['arid']."' order by lotnoid desc") or die(mysqli_error($link));
			...
			foreach($flnid as $fid)
		  	{	
				...
				{ 
					...
					$sql_dst=mysqli_query($link,"select * from tbldestination where did='".$fid."'") or die(mysqli_error($link));
...
$per=$row_pro['productionpersonnel'];
	...
	else
	{
		$oldlot = $row['oldlot'];
				...
				$sql_usr=mysqli_query($link,"select * from tbluser where scode='".$row['logid']."'") or die(mysqli_error($link));
				$row_usr=mysqli_fetch_array($sql_usr);
				
				$sql_opr1=mysqli_query($link,"select * from tblopr where id='".$row_usr['uid']."'") or die(mysqli_error($link));
