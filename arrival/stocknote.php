<?php
	...
	$sql_code="SELECT MAX(arr_code) FROM tblarrival where yearcode='$yearid_id'and arrival_type='Fresh Seed with PDN' ORDER BY arrival_code DESC";
...
<td width="196"  align="left" valign="middle" class="tbltext">&nbsp;<?php echo "STR".$row_tbl['ncode']."/".$row_tbl['yearcode']."/".$row_tbl['arr_role'];?></td>
...
$sql_tbl=mysqli_query($link,"select * from tblarrival where arrival_type='StockTransfer Arrival' and arrival_id='".$tid."'") or die(mysqli_error($link));
$row_tbl=mysqli_fetch_array($sql_tbl);
