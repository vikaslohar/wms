...
$a123456=mysqli_query($link,$sql_main) or die(mysqli_error($link));
	...
	$sql_code="SELECT MAX(arr_code) FROM tblarrival where yearcode='$yearid_id' and arrival_type='Unidentified' and plantcode='$plantcode' ORDER BY arr_code DESC";
	$res_code=mysqli_query($link,$sql_code)or die(mysqli_error($link));
		...
		$sql_code1="SELECT MAX(ncode) FROM tblarrival where yearcode='$yearid_id' and arrival_type='Unidentified' and plantcode='$plantcode' ORDER BY ncode DESC";
	$res_code1=mysqli_query($link,$sql_code1)or die(mysqli_error($link));
...
<title>Arrival -Transaction -Unidentified Arrival - Preview</title>
