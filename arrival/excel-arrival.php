...
function cleanData(&$str)
    ...
    $datatitle2 = array("","","","","","","","","","PP","Moist %","","","","");
	 $datatitle3 = array("#","Transaction ID","Crop","Variety","Lot No.","NoB","Qty"," Stage","Production Location","Preliminary QC","","QC Status","GOT Status","Seed Status","SLOC");
$d=1;
...
if($tot_arr_home > 0)			
{
$data1[$d]=array($d,$transid,$crop,$variety,$lotno,$bags,$qty,$stage,$loc1,$per,$per1,$qc,$got,$sstatus,$slocs); 
$d++;
}
}
}
