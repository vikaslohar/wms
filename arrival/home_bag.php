<?php
	...
	$sql_tbl=mysqli_query($link,"select * from tblarrival where arr_role='".$logid."' and  arrival_type='Unidentified' and arrtrflag=0") or die(mysqli_error($link));
...
<title>Arrival- Transaction - Unidentified Bag</title>
...
$sql_arr_home=mysqli_query($link,"select * from tblarrival where arrival_type='Unidentified' and plantcode='$plantcode' and arrtrflag=1") or die(mysqli_error($link));
...
$targetpage = $_SERVER['PHP_SELF']; 
  ...
  $sql_arr_home=mysqli_query($link,"select * from tblarrival where arrival_type='Unidentified' and plantcode='$plantcode' and arrtrflag=1 order by arrival_date desc, arr_code desc LIMIT $start, $limit") or die(mysqli_error($link));
 $tot_arr_home=mysqli_num_rows($sql_arr_home);
...
$query = "select * from tblarrival where arrival_type='Unidentified' and arrtrflag=1 and plantcode='$plantcode' order by arrival_date desc, arr_code desc";
...
$sql_arr_home=mysqli_query($link,"select * from tblarrival where arrival_type='Unidentified' and arrtrflag=1 order by arrival_date desc, arr_code desc LIMIT $from, $max_results") or die(mysqli_error($link));
$tot_arr_home=mysqli_num_rows($sql_arr_home);

$total_results3 =mysqli_query($link,"SELECT COUNT(*)  FROM tblarrival where arrival_type='Unidentified' and arrtrflag=1"),0);*/ 
