...
$sql_tbl_sub=mysqli_query($link,"select * from tbl_stlotimp where stlotimp_impflg=0 and stlotimp_trflg=0 and plantcode='$plantcode' $sss order by stlotimp_lotno") or die(mysqli_error($link));
...
if($tot_arrival)
{
	...
	{
		$sql_tbl_sub1=mysqli_query($link,"select * from tblarrival_sub where arrival_id='".$row_arrival['arrival_id']."' and plantcode='$plantcode'") or die(mysqli_error($link));
