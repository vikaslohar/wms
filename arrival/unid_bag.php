...
//$a="c";
	//$a="c";
	$sql_code="SELECT MAX(arrival_code) FROM tblarrival where arrival_type='Unidentified arrival' ORDER BY arrival_code DESC";
...
<td align="left" width="366" valign="middle" class="tblheading" style="border-color:#F1B01E">&nbsp;<a href="javascript:void(0);" onclick="getdetails(this.value);" >Get Details</a>&nbsp;(After selection of lot no. click on 'Get Details')</td>
</tr>
