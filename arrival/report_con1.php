...
<title>Arrival-Report -Period Wise trading Report</title>
...
$sdate = $_REQUEST['sdate'];
	...
	$sql_arr_home=mysqli_query($link,"select * from tblarrival where arrival_type='Trading' and  arrival_date <= '$edate' and arrival_date >= '$sdate' and arrtrflag=1 order by arrival_date asc ") or die(mysqli_error($link));
