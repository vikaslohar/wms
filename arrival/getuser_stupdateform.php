...
/*$sql_sub="insert into tblarrival_sub (arrival_id, qty, act, diff, qty1, act1, diff1, qc, lotno) values('$mainid', '$txtdisp', '$recqtyp', '$txtdqtyp', '$txtrawp', '$txtrecbagp', '$txtdbagp', '$txtqtystat', '$txtlotp')";
*/ 
  $sql_sub="insert into tblarrival_sub (arrival_id, qty, act, diff, qty1, act1, diff1, qc, lotno,moisture,vchk,sstatus,got,qcstatus,gemp,got1,orlot,lotcrop, lotvariety,sstage,remarks,testd,gotdate,dc_date, lotimpid, leduration, leupto, plantcode) values('$mainid', '$txtdisp', '$recqtyp', '$txtdqtyp', '$txtrawp', '$txtrecbagp', '$txtdbagp', '$txtqtystat', '$txtlotp','$txtmoist','$txtvisualck','$status','$txtgot','$txtqtystat','$txtgermi','$gotstatus','$olot', '$txtcrop', '$txtvariety', '$sstage','$txtreason','$ddate','$ddate12','$tdate1', '$txtlotnoid','$leduration','$ledate', '$plantcode')";
...
{
$sql_main="update tblarrival set yearcode='$yearid_id', arrival_type='StockTransfer Arrival', arrival_code='$txtid', arrival_date='$tdate', lotcrop='$txtcrop', lotvariety='$txtvariety', sstage='$sstage', party_id='$txtstfp', nolot='$txtlot', tmode='$txt1', trans_name='$txttname', trans_lorryrepno='$txtlrn', trans_vehno='$txtvn', trans_paymode='$txt13', courier_name='$txtcname', docket_no='$txtdc', pname_byhand='$txtpname', remarks='$txtremarks', dc_date='$tdate1',dcno='$txtdcno',arr_role='$logid'  where arrival_id = '$z1'";
	 ...
	 <td align="center" valign="middle" class="tblheading"><?php echo $slocs;?></td>
	     ...
	     <td width="36" align="center" valign="middle" class="tblheading"><?php echo $act;?></td>
			 <td width="31" align="center" valign="middle" class="tblheading"><img src="../images/edit.png" border="0" style="display:inline;cursor:Pointer;" onclick="editrec('<?php echo $row_tbl_sub['arrsub_id'];?>','<?php echo $tid;?>');" /></td>
 		     <td width="38" align="center" valign="middle" class="tblheading"><img border="0" src="../images/delete.png"  onclick="deleterec(<?php echo $tid?>,<?php echo $row_tbl_sub['arrsub_id'];?>,'StockTransfer Arrival');"   /></td>
 </tr>
<?php
}
else
