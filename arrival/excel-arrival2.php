...
$tot_arr_home=mysqli_num_rows($sql_arr_home);
	...
	/* $s = "select stores_item,uom from tbl_stores where items_id = $itemid";
		...
		$sql_loc=mysqli_query($link,"select did, dest from tbldestination where did='$cid'"); 
...
function cleanData(&$str)
	 ...
	 $datatitle3 = array("#","Transaction ID","Crop","Variety"," V. Lot No."," Vendor Name"," Lot No.","NoB","Qty"," Stage","SLOC","QC","","QC Status","GOT Status","Seed Status","SLOC");
	 $d=1;
if($typ=="Trading")
{ 
...
if($tot_arr_home > 0)			
{
$data1[$d]=array($d,$transid,$crop,$variety,$lotoldlot,$loc1,$lotno,$bags,$qty,$stage,$slocs,$vchk,$per1,$qc,$got,$sstatus,$slocs); 
$d++;
}
}
}
