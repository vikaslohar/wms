...
$sql_subbinn=mysqli_query($link,"select sname from tbl_subbin where sid='".$row_tbl_sub['lotldg_subbinid']."' and binid='".$bid."' and plantcode='$plantcode' and whid='".$wid."'") or die(mysqli_error($link));
...
//echo $t1=mysqli_num_rows($sql_tbl1);
//echo $row_tbl1[0];
$sql1=mysqli_query($link,"select * from tbl_lot_ldg_pack where lotdgp_id='".$row_tbl1[0]."' and plantcode='$plantcode' and balqty > 0")or die(mysqli_error($link));
