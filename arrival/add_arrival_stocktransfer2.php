...
$sql_tbl=mysqli_query($link,"select * from tblarrival where arr_role='".$logid."' and  arrival_type='StockTransfer Arrival' and arrtrflag=0 and plantcode='$plantcode'") or die(mysqli_error($link));
while($row_tbl=mysqli_fetch_array($sql_tbl))
{
	...
	$s_sub="delete from tblarrival where arr_role='".$logid."' and arrival_type='StockTransfer Arrival' and arrtrflag=0 and plantcode='$plantcode'";
	mysqli_query($link,$s_sub) or die(mysqli_error($link));	
...
$targetpage = $_SERVER['PHP_SELF']; 
  ...
  $sql_arr_home=mysqli_query($link,"select * from tblarrival where arrival_type='StockTransfer Arrival' and arrtrflag=1 and plantcode='$plantcode' order by arrival_date desc, arr_code desc LIMIT $start, $limit") or die(mysqli_error($link));
 $tot_arr_home=mysqli_num_rows($sql_arr_home);
...
$query = "select * from tblarrival where arrival_type='StockTransfer Arrival' and arrtrflag=1 and plantcode='$plantcode' order by arrival_date desc, arr_code desc";
