<?php
	...
	if(isset($_REQUEST['typval']))
	{
	$typval = $_REQUEST['typval'];
	}
...
<title>Arrival-Transaction- Fresh Arrival With PDN - FRN</title>
...
if($typ=="organiser")
{
$sql_tbl_sub11=mysqli_query($link,"select * from tblarrival_sub where arrival_id='".$tid."' and organiser='".$typval."' and plantcode='$plantcode'") or die(mysqli_error($link));
}
else if($typ=="farmer")
{
$sql_tbl_sub11=mysqli_query($link,"select * from tblarrival_sub where arrival_id='".$tid."' and farmer='".$typval."' and plantcode='$plantcode'") or die(mysqli_error($link));
}
else 
{
$sql_tbl_sub11=mysqli_query($link,"select * from tblarrival_sub where arrival_id='".$tid."' and plantcode='$plantcode'") or die(mysqli_error($link));
}
$subtbltot11=mysqli_num_rows($sql_tbl_sub11);
$frn="";
if($subtbltot11 > 0)
{
$row_tbl_sub11=mysqli_fetch_array($sql_tbl_sub11);
$frn="FRN/".$row_tbl['yearcode']."/".$row_tbl_sub11['ncode'];
}
else
{
$frn="FRN/".$row_tbl['yearcode']."/1";
}
//echo $frn;
?>
...
<td align="left"  valign="middle" class="tbltext" >&nbsp;<?php echo $tdate2;?></td>
    ...
    <td align="left"  valign="middle" class="tbltext">&nbsp;<?php echo $frn;?></td>
...
<td align="right"  valign="middle" class="tblheading">&nbsp;Dispatch Date&nbsp;</td>
 <td align="left"  valign="middle" class="tbltext" colspan="3" >&nbsp;<?php//=$tdate2;?></td>
</tr>-->
<tr class="Light" height="25">
...
<?php
$sql_tbl=mysqli_query($link,"select * from tblarrival where arrival_type='Fresh Seed with PDN' and arrival_id='".$tid."' and plantcode='$plantcode'") or die(mysqli_error($link));
$row_tbl=mysqli_fetch_array($sql_tbl);
...
if($typ=="organiser")
{
$sql_tbl_sub=mysqli_query($link,"select * from tblarrival_sub where arrival_id='".$arrival_id."' and organiser='".$typval."' and plantcode='$plantcode'") or die(mysqli_error($link));
}
else if($typ=="farmer")
{
$sql_tbl_sub=mysqli_query($link,"select * from tblarrival_sub where arrival_id='".$arrival_id."' and farmer='".$typval."' and plantcode='$plantcode'") or die(mysqli_error($link));
}
else 
{
...
<tr class="tblsubtitle" height="20">
    ...
    <td width="10%" align="center" rowspan="2" valign="middle" class="tblheading">Variety</td>
    <td width="10%" align="center" rowspan="2" valign="middle" class="tblheading">Lot No.</td>
	<td width="10%" align="center" rowspan="2" valign="middle" class="tblheading">Organiser</td>
	<td width="10%" align="center" rowspan="2" valign="middle" class="tblheading">Farmer</td>
	<td width="10%" align="center" rowspan="2" valign="middle" class="tblheading">Prod. Loc.</td>
	<td width="2%" align="center" rowspan="2" valign="middle" class="tblheading">Prod. Grade</td>
...
*/	
//echo $row_tbl_sub['lotvariety'];
/*$varchk=$row_tbl_sub['lotcrop']."-"."Coded";
$varty="";
if($row_tbl_sub['lotvariety']!=$varchk)
{		
	$sql_veriety=mysqli_query($link,"select * from tblvariety where varietyid='".$row_tbl_sub['lotvariety']."' and actstatus='Active' and vertype='PV'") or die(mysqli_error($link));
...
?>
<tr class="Light" height="20">
    <td align="right" valign="middle" class="tblheading" colspan="8">Total&nbsp;&nbsp;</td>
...
<td width="650" colspan="11" align="left"  valign="middle" class="tbltext">&nbsp;<?php echo $row_tbl['remarks'];?></td>
</tr>
</table>
<!--<table align="center" border="0" width="750" cellspacing="0" cellpadding="0" bordercolor="#4ea1e1" style="border-collapse:collapse" >
<tr class="Light" height="20">
