...
if($god1==1)
{
$sql_sub_sub="insert into tblarr_sloc (arr_type, arr_tr_id, arr_id, whid, binid, subbin, rowid, qty, bags, balqty, balbags, lotcrop, lotvariety) values('Unidentified', '$mainid', '$subid', '$y', '$z', '$a1',  '$rowid1', '$b1', '$c1', '$b1', '$c1', '$o', '$p')";
mysqli_query($link,$sql_sub_sub) or die(mysqli_error($link));
}
if($god2==1)
{
$sql_sub_sub="insert into tblarr_sloc (arr_type, arr_tr_id, arr_id, whid, binid, subbin, rowid, qty, bags, balqty, balbags, lotcrop, lotvariety) values('Unidentified', '$mainid', '$subid', '$d1', '$e1', '$f1',  '$rowid1', '$g1', '$h1', '$g1', '$h1', '$o', '$p')";
mysqli_query($link,$sql_sub_sub) or die(mysqli_error($link));
}
}
...
{
$mainid=$z1;
   $sql_sub="update tblarrival_sub set sstage='$st',sample='$sample',sstatus='$status',arrival_id='$mainid',lotno='$n',qty='$txtdcqty', act='$txtactqty', diff='$txtdiffqty', qty1='$txtdcnob', act1='$txtdcqty', diff1='$txtdiffnob',  moisture='$w',vchk='$x',qc='$qc',orlot='$orlot',lotoldlot='$oldlot',got='$got',got1='$got1',lotcrop='$o',lotvariety='$p',remarks='$remarks' ,ploc='$loc', party_id='$party' ,gssample='$gs1' where arrsub_id='$subtrid'";
if(mysqli_query($link,$sql_sub) or die(mysqli_error($link)))
{
 $subid=$subtrid;
