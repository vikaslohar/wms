  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#F1B01E" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#F1B01E" style="border-bottom:solid; border-bottom-color:#F1B01E" >
	    <tr >
	      <td width="813" height="25" class="Mainheading">&nbsp;Transaction - Opening Stock Add</td>
	    </tr></table></td>
...
<tr class="tblsubtitle" height="20">
  <td colspan="6" align="center" class="tblheading">Opening Stock Add</td>
</tr>
...
<td align="right"  valign="middle" class="tblheading">Lot Number &nbsp;</td>
   ...
   <option value="" >--Select--</option>
	 <?php while($row_month = mysqli_fetch_array($quer6)) { ?>
    <option value="<?php echo $row_month['code'];?>" />  
    <?php echo $row_month['code'];?>
    <?php } ?>
