...
$sql_whouse=mysqli_query($link,"select * from tblarrival_sub where orlot='".$txtlot1."'") or die(mysqli_error($link));
...
$pp=$vchk;
	...
	$nob=0; $qty=0;
	$sql_tbl=mysqli_query($link,"select * from tblarr_sloc where arr_id='".$row_whouse['arrsub_id']."' and arr_tr_id='".$sql_tb2['arrival_id']."'")or die(mysqli_error($link));
...
<table align="center" border="1" bordercolor="#F1B01E" cellspacing="0" cellpadding="0" width="800" style="border-collapse:collapse">
