<?php
	...
	/*$sql_code="SELECT MAX(arrival_code) FROM tblarrival_unld  ORDER BY arrival_code DESC";
...
function openlotupdate(trid, subid, exlotno, tp, crop)
{
var itm="Fresh Seed with PDN";
winHandle=window.open('getuser_fpdnunld_lotnoupd.php?tp='+itm+'&trid='+trid+'&subid='+subid+'&exlotno='+exlotno+'&crop='+crop,'WelCome','top=170,left=180,width=420,height=350,scrollbars=yes');
if(winHandle==null){
...
function gidtchk(sdate)
{
	document.frmaddDepartment.sdate.value='';
	showCalendar('sdate');
	//var ledurmth = document.frmaddDepartment.leduration.value;
	//setTimeout('showledur('+ledurmth+')', 2000);
}

function showledur(led)
{
	var sdt=document.frmaddDepartment.sdate.value;
	if(sdt=="")
	{
...
<td width="229" align="left" valign="middle" class="tbltext">&nbsp;<input name="dateofarrival" type="text" size="10" class="tbltext" tabindex="0" readonly="true"  style="background-color:#CCCCCC" value="<?php echo $tdate;?>" maxlength="10"/>&nbsp;</td>
</tr>
...
<!--</table>
<table id="organiser" align="center" border="1" width="950" cellspacing="0" cellpadding="0" bordercolor="#F1B01E" style="display:none; border-color:#F1B01E" > 
<?php 
//$organizer=mysqli_query($link,"select orgid , orgname from  tblorganiser order by orgid ") or die(mysqli_error($link));
?>
<tr class="Dark" height="30">-->
<!--<td align="right" width="202" valign="middle" class="tblheading" style="border-color:#F1B01E">&nbsp;Organiser&nbsp;</td>
<td align="left" width="275" valign="middle" class="tbltext" style="border-color:#F1B01E">&nbsp;<select class="tbltext" name="txtorganizer" style="width:180px;" >
...
<td align="right" valign="middle" class="tblheading" style="border-color:#F1B01E">&nbsp;No.Of PDN &nbsp;</td>
<td align="left" valign="middle" class="tbltext" colspan="3" style="border-color:#F1B01E">&nbsp;<input name="noofpdn" type="text" size="15" class="tbltext" tabindex="" maxlength="15" onchange="showtbl()"  onkeypress="return isNumberKey(event)"  />&nbsp;<font color="#FF0000">*</font></td>
</tr>
</table>-->
<!--<table id="farmer" align="center" border="1" width="950" cellspacing="0" cellpadding="0" bordercolor="#F1B01E" style="display:none; border-color:#F1B01E" > -->
<?php 
//$farmer1=mysqli_query($link,"select farmerid , farmername from  tblfarmer order by farmerid ") or die(mysqli_error($link));
?>
<!--<tr class="Dark" height="30">
<td align="right" width="202" valign="middle" class="tblheading" style="border-color:#F1B01E">&nbsp;Farmer&nbsp;</td>
<td align="left" width="275" valign="middle" class="tbltext" style="border-color:#F1B01E">&nbsp;<select class="tbltext" name="txtfarmer" style="width:180px;" 	>
<option value="" selected>--Select--</option>
...
<td align="right" width="99" valign="middle" class="tblheading" style="border-color:#F1B01E">&nbsp;No.Of PDN &nbsp;</td>
<td align="left" width="264" valign="middle" class="tbltext" colspan="3" style="border-color:#F1B01E">&nbsp;<input name="noofpdn1" type="text" size="15" class="tbltext" tabindex="" maxlength="15"  onchange="showtbl(this.value)"  onkeypress="return isNumberKey(event)" />&nbsp;<font color="#FF0000">*</font></td>
</tr>
</table>
<table align="center" border="1" width="950" cellspacing="0" cellpadding="0" bordercolor="#F1B01E" style="border-collapse:collapse" > -->
<tr class="Dark" height="30">
...
<td width="275" align="left"  valign="middle" class="tbltext" >&nbsp;<input name="dcdate" id="dcdate" type="text" size="10" class="tbltext" tabindex="0" readonly="true"  style="background-color:#EFEFEF" value="<?php echo $tdate1;?>" maxlength="10"/>&nbsp;<a href="javascript:void(0)" onClick="showCalendar('dcdate')" tabindex="6"><img src="../images/cal.gif" alt="Calender" border="0" align="absmiddle"></a>&nbsp;&nbsp;</td>
	<td width="130" align="right"  valign="middle" class="tblheading">DC No.&nbsp;</td>
    <td width="230" align="left"  valign="middle" class="tbltext">&nbsp;<input name="txtdcnumber" type="text" size="20" class="tbltext" tabindex=""   onkeypress="return isNumberKey(event)" value="<?php echo $row_tbl['dcno'];?>"  maxlength="20" onchange="noofpdnchk();" readonly="true"  style="background-color:#EFEFEF"/>&nbsp;</td>
           </tr>
<tr class="Light" height="25">
<td align="right"  valign="middle" class="tblheading">&nbsp;Mode of Transit&nbsp;</td>
 <td align="left"  valign="middle" class="tbltext" colspan="6">&nbsp;<?php echo $row_tbl['tmode']; ?><input name="text" type="hidden" class="tbltext" value="<?php echo $row_tbl['tmode']; ?>"  />&nbsp;</td>
</tr>
</table>
...
<td align="left"  valign="middle" class="tbltext">&nbsp;<input name="txttname" type="text" size="25" class="tbltext" tabindex="" maxlength="25" value="<?php echo $row_tbl['trans_name'];?>" readonly="true"  style="background-color:#EFEFEF" />  &nbsp;<font color="#FF0000">*</font>&nbsp;</td>
<td width="150" align="right"  valign="middle" class="tblheading">Lorry Receipt No.&nbsp;</td>
<td align="left" width="257" valign="middle" class="tbltext" colspan="3">&nbsp;<input name="txtlrn" type="text" size="15" class="tbltext" tabindex="" value="<?php echo $row_tbl['trans_lorryrepno'];?>"  maxlength="15" readonly="true"  style="background-color:#EFEFEF"/>&nbsp;</td>
</tr>

<tr class="Light" height="25" >
<td align="right" width="230" valign="middle" class="tblheading">&nbsp;Vehicle No.&nbsp;</td>
<td align="left" width="303" valign="middle" class="tbltext" >&nbsp;<input name="txtvn" type="text" size="12" class="tbltext" tabindex="" maxlength="12" value="<?php echo $row_tbl['trans_vehno'];?>"  readonly="true"  style="background-color:#EFEFEF" />&nbsp;<font color="#FF0000">*</font>&nbsp; </td>
<td align="right"  valign="middle" class="tblheading">&nbsp;Payment Mode&nbsp;</td>
 <td align="left"  valign="middle" class="tbltext"colspan="3">&nbsp;<input name="txt13" type="text" size="12" class="tbltext" tabindex="" maxlength="12" value="<?php echo $row_tbl['trans_paymode'];?>"  readonly="true"  style="background-color:#EFEFEF" /><!--<select class="tbltext" name="txt13" style="width:100px;" onchange="clk1(this.value);"  > 
...
<td align="left" width="304" valign="middle" class="tbltext">&nbsp;<input name="txtcname" type="text" size="20" class="tbltext" tabindex=""  maxlength="20" value="<?php echo $row_tbl['courier_name'];?>" readonly="true"  style="background-color:#EFEFEF"  />&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
<td align="right" width="150" valign="middle" class="tblheading">&nbsp;Docket No.&nbsp;</td>
<td align="left" width="257" valign="middle" class="tbltext" colspan="3">&nbsp;<input name="txtdc" type="text" size="15" class="tbltext" tabindex="" maxlength="15" value="<?php echo $row_tbl['docket_no'];?>" readonly="true"  style="background-color:#EFEFEF"  />&nbsp;<font color="#FF0000">*</font></td>
</tr>
...
<table align="center" border="1" width="950" cellspacing="0" cellpadding="0" bordercolor="#F1B01E" style="border-collapse:collapse" > 
<tr class="Dark" height="30" style="border-color:#F1B01E">
<td align="right" width="229" valign="middle" class="tblheading">&nbsp;Name of Person&nbsp;</td>
<td width="715" colspan="8" align="left" valign="middle" class="tbltext">&nbsp;<input name="txtpname" type="text" size="20" class="tbltext" tabindex=""  maxlength="20" value="<?php echo $row_tbl['pname_byhand'];?>" readonly="true"  style="background-color:#EFEFEF"  />&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
</tr>
</table>
</div>
<br />
...
<?php
/*$sql_tbl=mysqli_query($link,"select * from tblarrival_unld where arr_role='".$logid."' and arrival_type='Fresh Seed with PDN' and arrival_id='".$pid."'") or die(mysqli_error($link));
$row_tbl=mysqli_fetch_array($sql_tbl);
...
$sql_item=mysqli_query($link,"select * from tblarrsub_sub_unld where arrival_id='".$arrival_id."' and arrsub_id='".$row_tbl_sub['arrsub_id']."' order by arrsubsub_id") or die(mysqli_error($link));
...
$sql_sloc=mysqli_query($link,"select * from tblarr_sloc_unld where arr_tr_id='".$arrival_id."' and arr_id='".$row_tbl_sub['arrsub_id']."'  order by arrsloc_id") or die(mysqli_error($link));
