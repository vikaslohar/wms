...
$targetpage = $_SERVER['PHP_SELF']; 
  ...
  $sql_arr_home=mysqli_query($link,"select * from tblarrival where arrival_type='Opening Stock' and plantcode='$plantcode' and arrtrflag=1 order by arrival_date desc, arr_code desc LIMIT $start, $limit") or die(mysqli_error($link));
...
$query = "select * from tblarrival where arrival_type='Opening Stock' and arrtrflag=1 and plantcode='$plantcode' order by arrival_date desc, arr_code desc";
...
$sql_arr_home=mysqli_query($link,"select * from tblarrival where arrival_type='Opening Stock' and arrtrflag=1 order by arrival_date desc, arr_code desc LIMIT $from, $max_results") or die(mysqli_error($link));
$tot_arr_home=mysqli_num_rows($sql_arr_home);

$total_results3 =mysqli_query($link,"SELECT COUNT(*)  FROM tblarrival where arrival_type='Opening Stock' and arrtrflag=1"),0);*/ 
