...
function cleanData(&$str)
 ...
 $datatitle2 = array("","","","","","","","","","PP","Moist %","Germ %","","","","","");
	 $datatitle3 = array("#","Stock Transfer From Plant ","Transaction ID","Crop","Variety","Lot No.","NoB","Qty","Stage","QC","","","QC Status","Last Test Date"," Got Status", "GOT Test Date","SLOC");
...
if($tot_arr_home > 0)			
{
$data1[$d]=array($d,$loc1,$transid,$crop,$variety,$lotno,$bags,$qty,$stage,$vk,$moist,$gemp,$got1,$tdate12,$got,$tdate13,$slocs); 
$d++;
}
}
}
