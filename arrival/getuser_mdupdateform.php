...
if($z1 == 0)
{
$sql_main="insert into tblarrival (yearcode, arrival_type, arrival_code, arrival_date,  party_id, nolot, tmode, trans_name, trans_lorryrepno, trans_vehno, trans_paymode, courier_name, docket_no, pname_byhand, remarks, arr_role,dc_date,dcno, plantcode) values ('$yearid_id', 'Maize Dry Arrival', '$txtid', '$tdate', '$txtstfp', '$txtlot', '$txt1', '$txttname', '$txtlrn', '$txtvn', '$txt13', '$txtcname', '$txtdc', '$txtpname', '$txtremarks', '$logid','$tdate1','$txtdcno', '$plantcode')";

if(mysqli_query($link,$sql_main) or die(mysqli_error($link)))
{
$mainid=mysqli_insert_id($link);

  $sql_sub="insert into tblarrival_sub (arrival_id, qty, act, diff, qty1, act1, diff1, qc, lotno, moisture, vchk, sstatus, got, qcstatus, gemp, got1, sample, qcsample, orlot, gssample, lotcrop, lotvariety, sstage, remarks, testd, gotdate, dc_date, lotimpid, plantcode) values('$mainid', '$txtdisp', '$recqtyp', '$txtdqtyp', '$txtrawp', '$txtrecbagp', '$txtdbagp', '$qc', '$txtlotp','$txtmoist','$txtvisualck','$status','$txtgstat','$qc','$txtgermi','$gotstatus', '$gscheckbox','$qc2','$olot','$gs1', '$txtcrop', '$txtvariety', '$sstage','$txtreason','$ddate','$ddate12','$tdate1', '$txtlotnoid', '$plantcode')";
if(mysqli_query($link,$sql_sub) or die(mysqli_error($link)))
{
$subid=mysqli_insert_id($link);
if($god1==1)
{
$sql_sub_sub="insert into tblarr_sloc (arr_type, arr_tr_id, arr_id, whid, binid, subbin, rowid, qty, bags, balqty, balbags, lotcrop, lotvariety, plantcode) values('Maize Dry Arrival', '$mainid', '$subid', '$y', '$z', '$a1',  '$rowid1', '$b1', '$c1', '$balqty1', '$balbags1', '$txtcrop', '$txtvariety', '$plantcode')";
mysqli_query($link,$sql_sub_sub) or die(mysqli_error($link));
}
if($god2==1)
{
$sql_sub_sub="insert into tblarr_sloc (arr_type, arr_tr_id, arr_id, whid, binid, subbin, rowid, qty, bags, balqty, balbags, lotcrop, lotvariety, plantcode) values('Maize Dry Arrival', '$mainid', '$subid', '$d1', '$e1', '$f1',  '$rowid1', '$g1', '$h1', '$balqty2', '$balbags2', '$txtcrop', '$txtvariety', '$plantcode')";
mysqli_query($link,$sql_sub_sub) or die(mysqli_error($link));
}
...
{
$sql_main="update tblarrival set yearcode='$yearid_id', arrival_type='Maize Dry Arrival', arrival_code='$txtid', arrival_date='$tdate', lotcrop='$txtcrop', lotvariety='$txtvariety', sstage='$sstage', party_id='$txtstfp', nolot='$txtlot', tmode='$txt1', trans_name='$txttname', trans_lorryrepno='$txtlrn', trans_vehno='$txtvn', trans_paymode='$txt13', courier_name='$txtcname', docket_no='$txtdc', pname_byhand='$txtpname', remarks='$txtremarks', dc_date='$tdate1',dcno='$txtdcno',arr_role='$logid'  where arrival_id = '$z1'";
...
?>
<?php
$sql_tbl=mysqli_query($link,"select * from tblarrival where arr_role='".$logid."' and arrival_type='Maize Dry Arrival' and arrival_id='".$tid."' and plantcode='$plantcode'") or die(mysqli_error($link));
...
<table align="center" border="1" width="950" cellspacing="0" cellpadding="0" bordercolor="#F1B01E" style="border-collapse:collapse" >
  ...
  <tr class="Dark" height="30">
    ...
    <td width="262"  align="left" valign="middle" class="tbltext">&nbsp;
        <?php echo "TAS".$row_tbl['arrival_code']."/".$yearid_id."/".$lgnid;?></td>
    <td width="192" align="right" valign="middle" class="tblheading">&nbsp;Date &nbsp;</td>
    <td width="258" align="left" valign="middle" class="tbltext">&nbsp;
        <input name="date" type="text" size="10" class="tbltext" bndex="0" readonly="true"  style="background-color:#CCCCCC" value="<?php echo date("d-m-Y");?>" maxlength="10"/>
      &nbsp;</td>
  </tr>
  <?php
...
?>
  <!--<tr class="light" height="30">
    ...
    <td align="left"  valign="middle" class="tbltext"  colspan="3">&nbsp;
        <input name="txtstfp1" type="text" size="40" class="tbltext" tabindex="" maxlength="40" value="<?php echo $row31['business_name'];?>"  style="background-color:#CCCCCC" readonly="true"/>
        <font color="#FF0000">*</font>&nbsp;
      <input type="hidden" name="adddchk" value="<?php echo $row31['stcode'];?>" /></td>
    <input type="hidden" name="txtstfp" value="<?php echo $row31['p_id'];?>" />
  </tr>-->
  <?php 
...
?>
 ...
 <tr class="Light" height="30">
  ...
  <tr class="Light" height="25">
    ...
    <td align="left"  valign="middle" class="tbltext" colspan="6"><input name="txt1" type="radio" class="tbltext" value="Transport" onclick="clk(this.value);" <?php if($row_tbl['tmode']=="Transport"){ echo "checked"; }?> />
      Transport&nbsp;
      <input name="txt1" type="radio" class="tbltext" value="Courier" onclick="clk(this.value);" <?php if($row_tbl['tmode']=="Courier"){ echo "checked"; }?> />
      Courier&nbsp;
      <input name="txt1" type="radio" class="tbltext" value="By Hand" onclick="clk(this.value);" <?php if($row_tbl['tmode']=="By Hand"){ echo "checked"; }?> />
...
<td width="715" colspan="8" align="left" valign="middle" class="tbltext">&nbsp;<input name="txtpname" type="text" size="20" class="tbltext" tabindex=""  maxlength="20" value="<?php echo $row_tbl['pname_byhand'];?>" />  &nbsp;<font color="#FF0000">*</font>&nbsp;</td>
</tr>
</table>
</div>
...
?>
			 <tr class="tblsubtitle" height="20">
              <td width="17" rowspan="2" align="center" valign="middle" class="tblheading">#</td>
			  	 <td width="27" align="center" rowspan="2" valign="middle" class="tblheading">Crop</td>
              <td width="40" rowspan="2" align="center" valign="middle" class="tblheading">Variety</td>
			 <td width="59" align="center" rowspan="2" valign="middle" class="tblheading">Lot No.</td>
              <td colspan="2" align="center" valign="middle" class="tblheading">Dispatch</td>
				...
				<td width="36" rowspan="2" align="center" valign="middle" class="tblheading">Stage </td>
                <td width="49" rowspan="2" align="center" valign="middle" class="tblheading">Quality Status</td>
				<td width="23" rowspan="2" align="center" valign="middle" class="tblheading">PP</td>
			   ...
			   <td width="37" rowspan="2" align="center" valign="middle" class="tblheading">Germ. %</td>
			    <td width="47" rowspan="2" align="center" valign="middle" class="tblheading">GOT Type</td>
			    <td width="51" rowspan="2" align="center" valign="middle" class="tblheading">Seed Status </td>
				<td colspan="3" align="center" valign="middle" class="tblheading">SLOC</td>
                  <td width="31" rowspan="2" align="center" valign="middle" class="tblheading">Edit</td>
              <td width="38" rowspan="2" align="center" valign="middle" class="tblheading">Delete</td>
  </tr>
			<tr class="tblsubtitle">
			  ...
			  <td width="103" align="center" valign="middle" class="tblheading">WH</td>
			   <td width="32" align="center" valign="middle" class="tblheading">NoB</td>
			  <td width="38" align="center" valign="middle" class="tblheading">Qty</td>
...
?>			  
 <tr class="Light" height="20">
    ...
    <td width="59" align="center" valign="middle" class="tblheading"><?php echo $row_tbl_sub['lotno'];?></td>
    <td width="37" align="center" valign="middle" class="tblheading"><?php echo $dcn;?></td>
    <td align="center" valign="middle" class="tblheading"><?php echo $dcq;?></td>
	<td width="40" align="center" valign="middle" class="tblheading"><?php echo $acn;?></td>
    <td width="34" align="center" valign="middle" class="tblheading"><?php echo $ac;?></td>
 	<td width="48" align="center" valign="middle" class="tblheading"><?php echo $difn;?></td>
    <td width="45" align="center" valign="middle" class="tblheading"><?php echo $difq;?></td>
	<td width="36" align="center" valign="middle" class="tblheading"><?php echo $row_tbl_sub['sstage'];?></td>
    <td width="49" align="center" valign="middle" class="tblheading"><?php echo $row_tbl_sub['qc'];?></td>
    <td width="23" align="center" valign="middle" class="tblheading"><?php echo $cc;?></td>
...
?>	
	 <td align="center" valign="middle" class="tblheading"><?php echo $slocs;?></td>
	     <td width="29" align="center" valign="middle" class="tblheading"><?php echo $act1;?></td>
	     <td width="36" align="center" valign="middle" class="tblheading"><?php echo $act;?></td>
			 <td width="31" align="center" valign="middle" class="tblheading"><img src="../images/edit.png" border="0" style="display:inline;cursor:Pointer;" onclick="editrec('<?php echo $row_tbl_sub['arrsub_id'];?>','<?php echo $tid;?>');" /></td>
 		     <td width="38" align="center" valign="middle" class="tblheading"><img border="0" src="../images/delete.png"  onclick="deleterec(<?php echo $tid?>,<?php echo $row_tbl_sub['arrsub_id'];?>,'Maize Dry Arrival');"   /></td>
 </tr>
<?php
}
else
...
<div id="subsubdivgood" style="display:block"><br />
