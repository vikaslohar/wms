...
$s_sub="delete from tblarrival_sub_unld where arrsub_id='".$b."' and plantcode='$plantcode'";
mysqli_query($link,$s_sub) or die(mysqli_error($link));
$s_sub_sub="delete from tblarr_sloc_unld where arr_id='".$b."' and plantcode='$plantcode'";
mysqli_query($link,$s_sub_sub) or die(mysqli_error($link));

$sql_t_sub=mysqli_query($link,"select * from tblarrival_sub_unld where arrival_id='".$a."' and plantcode='$plantcode'") or die(mysqli_error($link));
