<?php
	...
	if(isset($_POST['frm_action'])=='submit')
	{
		...
		if($sdate!="" && $edate!="")
		{
			echo "<script>window.location='add_arrival_maizedry2.php?sdate=$sdate&edate=$edate'</script>";
		}
		else
		 {?>
		 <script>
...
{
winHandle=window.open('maizedrynote.php?itmid='+tid,'WelCome','top=170,left=180,width=820,height=450,scrollbars=yes');
if(winHandle==null){
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#F1B01E" >
	  ...
	  <table width="820" border="0" cellpadding="0" cellspacing="0" bordercolor="#F1B01E" style="border-bottom:solid; border-bottom-color:#F1B01E" >
	    <tr >
	      <td width="820" height="25" class="Mainheading">&nbsp;Transaction - Arrival Maize-Dried Seed</td>
	    </tr></table></td>
...
<td align="center" width="100" valign="middle" class="tblbutn" style="cursor:Pointer;"><?php if($flg==0 && $flg1==0 && $flg2==0) { ?><a href="add_arrival_maizedry.php" style="text-decoration:none; color:#000000">Add </a><?php } else { ?><a href="Javascript:void(0);" onClick="alert('Can not perform Transaction.\nReason:\n1. Todays date is not in Active Current Financial Year.\n2. Transaction after todays date has been made.\n3. Cycle Inventory transaction is under process.');" style="text-decoration:none; color:#000000">Add </a><?php } ?></td>
</tr>
</table></td>
...
$sql_arr_home=mysqli_query($link,"select * from tblarrival where arrival_type='Maize Dry Arrival' and arrtrflag=1 and plantcode='$plantcode'") or die(mysqli_error($link));
...
$targetpage = $_SERVER['PHP_SELF']; 
  ...
  $sql_arr_home=mysqli_query($link,"select * from tblarrival where arrival_date >='$tdate' and arrival_date <='$pdate' and arrival_type='Maize Dry Arrival' and arrtrflag=1 and plantcode='$plantcode' order by arrival_date desc, arr_code desc LIMIT $start, $limit") or die(mysqli_error($link));
 $tot_arr_home=mysqli_num_rows($sql_arr_home);
...
$query = "select * from tblarrival where arrival_date >='$tdate' and arrival_date <='$pdate' and arrival_type='Maize Dry Arrival' and arrtrflag=1 and plantcode='$plantcode' order by arrival_date desc, arr_code desc";
...
$sql_arr_home=mysqli_query($link,"select * from tblarrival where arrival_date >='$tdate' and arrival_date <='$pdate' and arrival_type='Maize Dry Arrival' and arrtrflag=1 order by arrival_date desc, arr_code desc LIMIT $from, $max_results") or die(mysqli_error($link));
$tot_arr_home=mysqli_num_rows($sql_arr_home);

$total_results3 =mysqli_query($link,"SELECT COUNT(*)  FROM tblarrival where arrival_date >='$tdate' and arrival_date <='$pdate'  and arrival_type='Maize Dry Arrival' and arrtrflag=1");
$total_results2 = mysqli_fetch_array($total_results3);
$total_results = $total_results2[0]; 
*/
    if($tot_arr_home >0) { 
...
<tr class="Light" height="20">
  <td colspan="6" align="center" class="tblheading">Arrival Maize-Dried Seed</td>
</tr>
</table>
...
<tr class="Light">
         ...
         <td width="4%" align="center" valign="middle" class="smalltblheading"><a href="Javascript:void(0)" onClick="openslocpopprint('<?php echo $row_arr_home['arrival_id'];?>');">MDSRN</a></td>
</tr>
<?php
}
else
...
<tr >
<td valign="top" align="right"><a href="add_arrival_maizedry2.php"><img src="../images/back.gif" border="0"style="display:inline;cursor:Pointer;" /></a></td>
</tr>
</table>
