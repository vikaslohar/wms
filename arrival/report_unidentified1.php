...
<title>Arrival-Report -Period Wise Unidentified Report</title>
...
$sdate = $_REQUEST['sdate'];
	...
	$sql_arr_home=mysqli_query($link,"select * from tblarrival where arrival_type='Unidentified' and  arrival_date <= '$edate' and arrival_date >= '$sdate' and arrtrflag=1 order by arrival_date asc ") or die(mysqli_error($link));
$tot_arr_home=mysqli_num_rows($sql_arr_home);
...
<table align="center" border="0" cellspacing="0" cellpadding="0" width="974" style="border-collapse:collapse">
  ...
  <table  border="1" cellspacing="0" cellpadding="0" width="750" bordercolor="#F1B01E" style="border-collapse:collapse" align="center">
