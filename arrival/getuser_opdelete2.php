...
$s_sub="delete from tbl_opspa_sub where opspasub_id='".$b."' and plantcode='$plantcode'";
mysqli_query($link,$s_sub) or die(mysqli_error($link));
$s_sub_sub="delete from tbl_opspasub_sub where opspasub_id='".$b."' and plantcode='$plantcode'";
mysqli_query($link,$s_sub_sub) or die(mysqli_error($link));

$sql_t_sub=mysqli_query($link,"select * from tbl_opspa_sub where opspa_id='".$a."' and plantcode='$plantcode'") or die(mysqli_error($link));
