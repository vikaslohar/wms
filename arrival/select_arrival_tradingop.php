...
<title>Arrival - Transction Trading Arrival-Select output</title>
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" style="border-bottom:solid; border-bottom-color:#F1B01E" >
	    <tr >
	      <td width="813" height="25" class="Mainheading">&nbsp;Transaction: Trading  Arrival-Output Selection </td>
	    </tr></table></td>
	  </tr>
	  </table></td></tr>
...
<tr class="Light" height="25">
    ...
    <td align="center"  valign="middle" class="tblheading">&nbsp;<a href="Javascript:void(0)" onclick="openslocpopprint();">Trading Seed Receipt Note - Internal (TRN-I)</a></td>
</tr>
<tr class="Light" height="25">

    <td align="center"  valign="middle" class="tblheading">&nbsp;<a href="Javascript:void(0)" onclick="openslocpopprint2();">Trading Seed Receipt Note - Party (TRN-P)</a></td>
</tr>
<tr class="Light" height="25">

    <td align="center"  valign="middle" class="tblheading">&nbsp;<a href="Javascript:void(0)" onclick="openslocpopprint1();">Old Lot To New Lot Note (OLNL)</a></td>
</tr>
</table>
<?php
...
?>
<?php
 $sql_tbl=mysqli_query($link,"select * from tbl_lot_ldg where lotldg_trtype='Trading' and lotldg_trid='".$pid."'") or die(mysqli_error($link));
?>
...
<tr >
<td valign="top" align="center"><a href="home_trading.php"><img src="../images/back.gif" border="0"style="display:inline;cursor:Pointer;" /></a>&nbsp;&nbsp;&nbsp;</td>	
</tr>
</table>
