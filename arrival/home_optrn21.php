...
$sql_arr_home=mysqli_query($link,"select * from tbl_opspa where opspa_date>='$tdate' and opspa_date<='$pdate' and plantcode='$plantcode' and opspa_tflg=1 order by opspa_date desc, opspa_code desc LIMIT $from, $max_results") or die(mysqli_error($link));
$tot_arr_home=mysqli_num_rows($sql_arr_home);

$total_results3 =mysqli_query($link,"SELECT COUNT(*)  FROM tbl_opspa where opspa_date>='$tdate' and opspa_date<='$pdate' and plantcode='$plantcode' and opspa_tflg=1");
