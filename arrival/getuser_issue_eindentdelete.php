...
?>
<?php
	 $sql1=mysqli_query($link,"select * from tbl_ieindent  where flg=0")or die(mysqli_error($link));
...
$srno=1;
	while($row=mysqli_fetch_array($sql1))
	{
	 ...
	 $resettargetquery=mysqli_query($link,"select * from tbl_roles where id='".$row['id']."'");
