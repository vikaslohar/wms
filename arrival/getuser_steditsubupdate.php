...
{
$sql_main="update tblarrival set yearcode='$yearid_id', arrival_type='StockTransfer Arrival', arrival_code='$txtid', arrival_date='$tdate', party_id='$txtstfp', nolot='$txtlotp', tmode='$txt1', trans_name='$txttname', trans_lorryrepno='$txtlrn', trans_vehno='$txtvn', trans_paymode='$txt13', courier_name='$txtcname', docket_no='$txtdc', pname_byhand='$txtpname', remarks='$txtremarks', dc_date='$tdate1',dcno='$txtdcno',arr_role='$logid'  where arrival_id = '$z1'";

if(mysqli_query($link,$sql_main) or die(mysqli_error($link)))
{
$mainid=$z1;
 //$status;
 $sql_sub="update tblarrival_sub set arrival_id='$mainid', qty='$txtdisp', act='$recqtyp', diff='$txtdqtyp', qty1='$txtrawp', act1='$txtrecbagp', diff1='$txtdbagp', qc='$txtqtystat', moisture='$txtmoist',vchk='$txtvisualck',sstatus='$status',got='$txtgot',got1='$gotstatus',qcstatus='$txtqtystat',gemp='$txtgermi',lotno='$txtlotp', sstage='$sstage',lotcrop='$txtcrop', lotvariety='$txtvariety',remarks='$txtreason' ,testd='$ddate',gotdate='$ddate12', dc_date='$tdate1', orlot='$olot', leduration='$leduration', leupto='$ledate' where arrsub_id='$subtrid'";
if(mysqli_query($link,$sql_sub) or die(mysqli_error($link)))
{
$subid=$subtrid;
...
$sql_subbinn=mysqli_query($link,"select sname from tbl_subbin where sid='".$row_sloc['subbin']."' and binid='".$row_sloc['binid']."' and plantcode='$plantcode' and whid='".$row_sloc['whid']."'") or die(mysqli_error($link));
