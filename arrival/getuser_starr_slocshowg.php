...
$sql_subbinn=mysqli_query($link,"select sname from tbl_subbin where sid='".$row_sub_sloc['subbin']."' and binid='".$row_sub_sloc['binid']."' and plantcode='$plantcode' and whid='".$row_sub_sloc['whid']."'") or die(mysqli_error($link));
...
?>
  <tr class="Light" height="30" >
    ...
    <?php
$bing1_query=mysqli_query($link,"select binid, binname where plantcode='$plantcode' from tbl_bin") or die(mysqli_error($link));
?>
