...
<title>Arrival - Transction-Stock Transfer Plant-Select output</title>
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" style="border-bottom:solid; border-bottom-color:#F1B01E" >
	    <tr >
	      <td width="813" height="25" class="Mainheading">&nbsp;Transaction: Arrival Stock Transfer Plant - Output Selection </td>
	    </tr></table></td>
	  </tr>
	  </table></td></tr>
...
<table align="center" border="0" width="750" cellspacing="0" cellpadding="0" bordercolor="#F1B01E" style="border-collapse:collapse" > 
<tr height="25">
  <td colspan="4" align="center" class="Mainheading">Transaction Outputs</td>
</tr>
</table>
<table align="center" border="1" width="750" cellspacing="0" cellpadding="0" bordercolor="#F1B01E" style="border-collapse:collapse" > 

<tr class="Light" height="25">

    <td align="center"  valign="middle" class="tblheading">&nbsp;<a href="Javascript:void(0)" onclick="openslocpopprint();">Stock Transfer Receipt Note (STRN)</a></td>
</tr>
<!--<tr class="Light" height="25">
...
$sql_tbl=mysqli_query($link,"select * from tbl_lot_ldg_pack where trtype='Stock Transfer Arrival - Pack' and lotldg_id='".$pid."'") or die(mysqli_error($link));*/
/*$row_tbl=mysqli_fetch_array($sql_tbl);			
...
{ 
$sql_class=mysqli_query($link,"select * from tbl_arrpack_sub where arrpack_id='".$arrival_id."'") or die(mysqli_error($link));
...
$quer3=mysqli_query($link,"SELECT * FROM tblvariety where varietyid ='".$row_tbl_sub['lotldg_variety']."' and actstatus='Active' and vertype='PV'"); 
...
<tr class="Light" height="25">
    ...
    <td align="center" valign="middle" class="tblheading"><?php echo $row_tbl_sub['lotldg_sstatus'];?></td>
<?php
...
$binn="<a href='Javascript:void(0)' onclick='openprintbin($row_tbl_sub[binid],$row_tbl_sub[whid])'>$row_binn[binname]</a>"."/";
...
$subbinn="<a href='Javascript:void(0)' onclick='openprintsubbin($row_tbl_sub[subbinid],$row_tbl_sub[binid],$row_tbl_sub[whid],$row_tbl_sub[lotldg_id])'>$row_subbinn[sname]</a>";
...
<tr >
<td valign="top" align="center"><a href="add_arrival_stocktransfer1.php"><img src="../images/back.gif" border="0"style="display:inline;cursor:Pointer;" /></a>&nbsp;&nbsp;&nbsp;</td>	
</tr>
</table>
