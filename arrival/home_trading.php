<?php
	...
	$sql_tbl=mysqli_query($link,"select * from tblarrival where arr_role='".$logid."' and  arrival_type='Trading' and arrtrflag=0") or die(mysqli_error($link));
while($row_tbl=mysqli_fetch_array($sql_tbl))
{
	...
	$s_sub="delete from tblarrival where arr_role='".$logid."' and arrival_type='Trading' and arrtrflag=0";
	mysqli_query($link,$s_sub) or die(mysqli_error($link));	
	...
	if(isset($_POST['frm_action'])=='submit')
	{
		...
		{
		echo "<script>window.location='home_trading.php'</script>";
		}
	}
...
{
winHandle=window.open('trn.php?p_id='+itm,'WelCome','top=170,left=180,width=820,height=450,scrollbars=yes');
if(winHandle==null)
{
...
<table width="1003" height="600" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" >
	  ...
	  <table width="820" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" style="border-bottom:solid; border-bottom-color:#F1B01E" >
	    <tr >
	      <td width="820" height="25">&nbsp;Transaction - Trading Arrival </td>
	    </tr></table></td>
...
<td align="center" width="100" valign="middle" class="tblbutn" style="cursor:Pointer;"><?php if($flg==0 && $flg1==0 && $flg2==0) { ?><a href="trading_arrival.php" style="text-decoration:none; color:#000000">Add </a><?php } else { ?><a href="Javascript:void(0);" onclick="alert('Can not perform Transaction.\nReason:\n1. Todays date is not in Active Current Financial Year.\n2. Transaction after todays date has been made.\n3. Cycle Inventory transaction is under process.');" style="text-decoration:none; color:#000000">Add </a><?php } ?></td>
</tr>
</table></td>
...
$sql_arr_home=mysqli_query($link,"select * from tblarrival where arrival_type='Trading'  and plantcode='$plantcode'and arrtrflag=1") or die(mysqli_error($link));
...
$sql_arr_home=mysqli_query($link,"select * from tblarrival where arrival_type='Trading' and plantcode='$plantcode' and arrtrflag=1 order by arrival_date desc, arr_code desc LIMIT $from, $max_results") or die(mysqli_error($link));
$tot_arr_home=mysqli_num_rows($sql_arr_home);

$total_results3 =mysqli_query($link,"SELECT COUNT(*)  FROM tblarrival where arrival_type='Trading' and plantcode='$plantcode' and arrtrflag=1");
$total_results2 = mysqli_fetch_array($total_results3);
$total_results = $total_results2[0];  if($tot_arr_home >0) { 
?>


<table align="center" border="0" width="600" cellspacing="0" cellpadding="0" bordercolor="#4ea1e1" style="border-collapse:collapse" > 
<tr class="Light" height="20">
  <td colspan="6" align="center" class="tblheading">Trading Arrival</td>
</tr>
</table>
<table align="center" border="1" cellspacing="0" cellpadding="0" width="950" bordercolor="#F1B01E" style="border-collapse:collapse">
            ...
            <tr class="tblsubtitle" height="20">
              <td width="2%" height="37"align="center" valign="middle" class="tblheading">#</td>
			 <td width="9%" align="center" valign="middle" class="tblheading">Transaction Id</td>
              <td width="12%" align="center" valign="middle" class="tblheading">Party</td>
              ...
              <td width="7%" align="center" valign="middle" class="tblheading">Stage</td>
              ...
              <td align="center" valign="middle" class="tblheading">TRN-I</td>
			  
              <td align="center" valign="middle" class="tblheading">TRN-P</td>
            </tr>
<?php
$srno=1;
if($tot_arr_home > 0)
...
$quer3=mysqli_query($link,"SELECT * FROM tblcrop  where cropid='".$row_arr_home['lotcrop']."'"); 
	$rowpp=mysqli_fetch_array($quer3);
	 $rowpp['cropname'];
...
<tr class="Light">
         ...
         <td width="9%" align="center" valign="middle" class="tblheading"><a href="add_arrival_trading_viewpage.php?p_id=<?php echo $row_arr_home['arrival_id'];?>"><?php echo "AT".$row_arr_home['arr_code']."/".$row_arr_home['yearcode']."/".$lrole;?></a></td>
         <td width="12%" align="center" valign="middle" class="tblheading"><?php echo $row3['business_name'];?></td>
         <td width="8%" align="center" valign="middle" class="tblheading"><?php echo $trdate;?></td>
         <td width="10%" align="center" valign="middle" class="tblheading"><?php echo $row_arr_home['lotcrop'];?></td>
         <td width="12%" align="center" valign="middle" class="tblheading"><?php echo $row_arr_home['lotvariety'];?></td>
         <td width="12%" align="center" valign="middle" class="tblheading"><?php echo $lotno?></td>
         ...
         <td width="7%" align="center" valign="middle" class="tblheading"><?php echo $stage?></td>
         <td width="5%" align="center" valign="middle" class="tblheading"><?php echo $qc?></td>
		 <td width="9%" align="center" valign="middle" class="tblheading"><?php echo $got?></td>
         <td width="5%" align="center" valign="middle" class="tblheading"><a href="Javascript:void(0)" onClick="openslocpopprint('<?php echo $row_arr_home['arrival_id'];?>');">TRN-I</a></td>
         <td width="5%" align="center" valign="middle" class="tblheading"><a href="Javascript:void(0)" onClick="openslocpopprint1('<?php echo $row_arr_home['arrival_id'];?>');">TRN-P</a></td>
</tr>
<?php
}
else
...
<tr >
<td valign="top" align="right"><a href="select1.php"><img src="../images/back.gif" border="0"style="display:inline;cursor:Pointer;" /></a></td>
</tr>
</table>
<?php
}
