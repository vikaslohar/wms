...
<table width="1003" height="600" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#F1B01E" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#F1B01E" style="border-bottom:solid; border-bottom-color:#F1B01E" >
	    <tr >
	      <td width="813" height="25" class="Mainheading">&nbsp;Transaction - Trading Arrival- View</td>
	    </tr></table></td>
 ...
 <?php 
$tid=$pid;
$sql_tbl=mysqli_query($link,"select * from tblarrival where arrival_type='Trading' and arrival_id='".$tid."' and plantcode='$plantcode'") or die(mysqli_error($link));
...
<tr class="tblsubtitle" height="20">
  <td colspan="4" align="center" class="tblheading">Trading Arrival View</td>
</tr>

 <tr class="Dark" height="30">
<td width="204" align="right" valign="middle" class="tblheading">&nbsp;Transaction Id&nbsp;</td>
<td width="272"  align="left" valign="middle" class="tbltext">&nbsp;<?php echo "AT".$row_tbl['arr_code']."/".$yearid_id."/".$role;?></td>
