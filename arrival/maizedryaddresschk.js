...
if(tp=="get")
{
var url="getuser_maizedry_showrec.php";
url=url+"?a="+str;
url=url+"&b="+d;
url=url+"&c="+e;
url=url+"&sid="+Math.random();
...
if(tp=="vendor")
{
var url="getuser_mdddresschk.php";
url=url+"?a="+str;
url=url+"&sid="+Math.random();
xmlHttp.onreadystatechange=stateChanged ;
xmlHttp.open("GET",url,true);
...
if(tp=="subformedt")
{
var url="getuser_mdedtsubform.php";
url=url+"?a="+str;
url=url+"&b="+d; 
url=url+"&sid="+Math.random();
xmlHttp.onreadystatechange=stateChanged ;
...
if(tp=="mformsubedt")
{ 
var url="getuser_mdeditsubupdate.php";
url=url+"?a="+str;
url=url+"&b="+d; 
url=url+"&sid="+Math.random();
xmlHttp.onreadystatechange=stateChanged ;
...
if(tp=="mform")
{ 
var url="getuser_mdupdateform.php";
url=url+"?a="+str;
url=url+"&sid="+Math.random();
xmlHttp.onreadystatechange=stateChanged ;
xmlHttp.open("GET",url,true);
...
{ 
var url="getuser_mdarr_slocshowg.php";
url=url+"?a="+str;
url=url+"&b="+d;
url=url+"&c="+e;
url=url+"&f="+i;
...
if(tp=="showpostform")
{ 
var url="getuser_mdpostform.php";
url=url+"?a="+str;
url=url+"&b="+d;
url=url+"&c="+e;
url=url+"&sid="+Math.random();
...
if(tp=="delete")
{
var url="getuser_maizedrydelete.php";
url=url+"?a="+str;
url=url+"&b="+d;
url=url+"&c="+e;
url=url+"&sid="+Math.random();
