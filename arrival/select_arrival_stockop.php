...
winHandle=window.open('stocknote.php?itmid='+itm,'WelCome','top=170,left=180,width=820,height=450,scrollbars=yes');
if(winHandle==null){
...
$sql_tbl=mysqli_query($link,"select * from tbl_lot_ldg where lotldg_trtype='StockTransfer Arrival' and lotldg_trid='".$pid."'") or die(mysqli_error($link));
/*$row_tbl=mysqli_fetch_array($sql_tbl);			
...
{ 
$sql_class=mysqli_query($link,"select * from tblarrival_sub where arrival_id='".$arrival_id."'") or die(mysqli_error($link));
...
<tr >
<td valign="top" align="center"><a href="add_arrival_stocktransfer2.php"><img src="../images/back.gif" border="0"style="display:inline;cursor:Pointer;" /></a>&nbsp;&nbsp;&nbsp;</td>	
</tr>
</table>
