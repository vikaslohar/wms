<?php
	...
	if(isset($_POST['frm_action'])=='submit')
	{
		...
		echo "<script>window.location='add_arrival_maizedry_preview.php?cropid=$p_id&remarks=$remarks&txtlot=$txtlot&sstage=$sstage&txt11=$txt11&txttname=$txttname&txtlrn=$txtlrn&txtvn=$txtvn&txt14=$txt14&txtcname=$txtcname&txtdc=$txtdc&txtpname=$txtpname&txtcrop=$txtcrop&txtvariety=$txtvariety&txtsttp=$txtsttp&txtdcno=$txtdcno&dcdate=$dc'</script>";	
...
<script src="maizedryaddresschk.js"></script>
...
{
	//document.getElementById("postingsubtable").style.display="none";
	var itm="Maize Dry Arrival";
	var add='';
	winHandle=window.open('getuser_maizedry_lotno.php?tp='+itm+'&add='+add,'WelCome','top=170,left=180,width=420,height=350,scrollbars=yes');
	if(winHandle==null){
...
document.getElementById("rn5").style.backgroundColor="#FFFFFF";
}
else
{
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#F1B01E" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#F1B01E" style="border-bottom:solid; border-bottom-color:#F1B01E" >
	    <tr >
	      <td width="813" height="25" class="Mainheading">&nbsp;Transaction - Arrival Maize-Dried Seed</td>
	    </tr></table></td>
...
<tr class="tblsubtitle" height="20">
  <td colspan="6" align="center" class="tblheading">Edit Arrival Maize-Dried Seed</td>
</tr>
<tr height="15"><td colspan="6" align="right" class="tblheading"><font color="#FF0000" >* </font>indicates required field&nbsp;</td></tr>

 <tr class="Dark" height="30">
<td width="205" align="right" valign="middle" class="tblheading">&nbsp;Transaction Id &nbsp;</td>
<td width="272"  align="left" valign="middle" class="tbltext">&nbsp;<?php echo "TAS".$row_tbl['arrival_code']."/".$yearid_id."/".$lgnid;?></td>

<td width="152" align="right" valign="middle" class="tblheading">&nbsp;Date&nbsp;</td>
<td width="211" colspan="3" align="left" valign="middle" class="tbltext">&nbsp;<input name="date" type="text" size="10" class="tbltext" tabindex="0" readonly="true"  style="background-color:#CCCCCC" value="<?php echo $tdate;?>" maxlength="10"/>&nbsp;</td>
</tr>
<?php
...
<td align="left"  valign="middle" class="tbltext"  colspan="6">&nbsp;<input name="txtstfp1" type="text" size="40" class="tbltext" tabindex="" maxlength="40" value="<?php echo $row31['business_name'];?>" readonly="true"  style="background-color:#CCCCCC"/>  <font color="#FF0000">*</font>&nbsp;<input type="hidden" name="adddchk" value="<?php echo $row31['stcode'];?>" /></td><input type="hidden" name="txtstfp" value="<?php echo $row31['p_id'];?>" />
	</tr>
	<?php
	$quer3=mysqli_query($link,"SELECT * FROM tbl_partymaser  where p_id='".$row_tbl['party_id']."'"); 
