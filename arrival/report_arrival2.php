...
<tr >
<td width="527" align="right">&nbsp;&nbsp;<a href="excel-arrival.php?typ=<?php echo $typ;?>&sdate=<?php echo $_REQUEST['sdate'];?>&edate=<?php echo $_REQUEST['edate'];?>" target="_blank"><img src="../images/excelicon1.jpg" border="0" height="30" width="30" class="butn" alt="Export to Excel" style="display:inline;cursor:pointer;" /></a>&nbsp;&nbsp;<img src="../images/Vista-printer.png" border="0" class="butn" height="29" width="35" alt="Print" style="display:inline;cursor:pointer;" onclick="javascript:window.print();" />&nbsp;&nbsp;<!--&nbsp;<a href="word_class.php?classification_id=<?php echo $classification_id?>"><img src="../images/mswordicon.jpg" border="0" class="butn" height="30" width="30" alt="Export to MS-Word" /></a>&nbsp;&nbsp;&&nbsp;<img src="../images/close_icon2.jpg" border="0" class="butn" height="30"  alt="Close" style="display:inline;cursor:pointer;" onClick="window.close()" /></td>
</tr>
</table>
-->
<?php
...
<tr class="tblsubtitle" height="25">
			...
			<td width="90"  align="center" valign="middle" class="tblheading" rowspan="2">Transaction ID</td>
...
while($row_arr_home=mysqli_fetch_array($sql_arr_home))
{
	...
	$transid="AF".$row_arr_home['arr_code']."/".$yearcode."/".$lrole;
...
<td align="center" valign="middle" class="tblheading"><?php echo $srno?></td>
		<td width="90" align="center" valign="middle" class="smalltbltext"><?php echo $transid?></td>
...
while($row_arr_home=mysqli_fetch_array($sql_arr_home))
{
	...
	$arrival_id=$row_arr_home['arrival_id'];
	$yearcode=$row_arr_home['yearcode'];
	$transid="AT".$row_arr_home['arr_code']."/".$yearcode."/".$lrole;
...
$sql_variety=mysqli_query($link,"select * from tblvariety where popularname='".$row_arr_home['lotvariety']."'  and vertype='PV'") or die(mysqli_error($link));
...
<table align="center" border="1" cellspacing="0" cellpadding="0" width="950" bordercolor="#F1B01E" style="border-collapse:collapse">
 ...
 <td colspan="3" align="center" valign="middle" class="tblheading">QC</td>
    ...
    <td width="64"  align="center" valign="middle" class="tblheading" rowspan="2">Last Test Date</td>
    <td width="54" align="center" valign="middle" class="tblheading" rowspan="2">GOT Status</td>
    <td width="66" align="center" valign="middle" class="tblheading" rowspan="2">GOT Test Date</td>
...
while($row_arr_home=mysqli_fetch_array($sql_arr_home))
{
	...
	$arrival_id=$row_arr_home['arrival_id'];
	$yearcode=$row_arr_home['yearcode'];
	$transid="AS".$row_arr_home['arr_code']."/".$yearcode."/".$lrole;
...
while($row_arr_home=mysqli_fetch_array($sql_arr_home))
{
	...
	$arrival_id=$row_arr_home['arrival_id'];
	$yearcode=$row_arr_home['yearcode'];
	$transid="AU".$row_arr_home['arr_code']."/".$yearcode."/".$lrole;
...
<table align="center" border="1" cellspacing="0" cellpadding="0" width="700" bordercolor="#ffffff" style="border-collapse:collapse">
  ...
  <tr  height="25">
    <td colspan="10" align="center" class="subheading">No Records found for selected Date </td>
  </tr>
  </table>
<?php
}
