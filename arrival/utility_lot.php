...
$tot_row=0;
$lotqry=mysqli_query($link,"select * from tblarrival_sub where lotno='".$a."' and lotcrop='".$crop."' and lotvariety='".$variet."'")or die (mysqli_error($link));
...
$lot=$row['lotcrop'];	
 ...
 $sql_arr_home=mysqli_query($link,"select * from tblarrival where arrival_type='Fresh Seed with PDN' and  arrival_date <= '$edate' and arrival_date >= '$sdate' and lotcrop='".$itemid."' and lotvariety='".$vv."' and arrtrflag=1 order by arrival_date asc ") or die(mysqli_error($link));
