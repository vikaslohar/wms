...
<table align="center" border="0" cellspacing="0" cellpadding="0" width="974" style="border-collapse:collapse">
  ...
  <table  border="1" cellspacing="0" cellpadding="0" width="684" bordercolor="#F1B01E" style="border-collapse:collapse" align="center">
    <tr class="tblsubtitle" height="25">
      <td width="17" align="center" valign="middle" class="tblheading" rowspan="3">#</td>
      <td width="57" align="center" valign="middle" class="tblheading" rowspan="3">Date Of Arrival </td>
      <td width="84"  align="center" valign="middle" class="tblheading" rowspan="3">Crop</td>
      <!--<td width="79" align="center" valign="middle" class="tblheading" colspan="3">Vendor</td>-->
      <td width="45"  align="center" valign="middle" class="tblheading" rowspan="3">Variety </td>
      <td width="59"  align="center" valign="middle" class="tblheading" rowspan="3"> No.of bags </td>
      <!--<td  align="center" valign="middle" class="tblheading" colspan="2">STN</td>
    ...
    <tr class="tblsubtitle">
      <td width="33" rowspan="2" align="center" valign="middle" class="tblheading">QTY</td>
      <td width="40" rowspan="2" align="center" valign="middle" class="tblheading">stage of arival</td>
      <td width="39" rowspan="2" align="center" valign="middle" class="tblheading">% Moisture</td>
      <td width="37" rowspan="2" align="center" valign="middle" class="tblheading">Got Status </td>
      <!-- <td width="37" rowspan="2" align="center" valign="middle" class="tblheading">Bag</td>
      <td width="53" rowspan="2" align="center" valign="middle" class="tblheading">Qty</td>
      <td width="37" rowspan="2" align="center" valign="middle" class="tblheading">Bag</td>
      <td width="53" rowspan="2" align="center" valign="middle" class="tblheading">Qty</td>
      <td width="63" rowspan="2" align="center" valign="middle" class="tblheading">Bag</td>-->
    </tr>
    <?php 
/*$srno=1;
