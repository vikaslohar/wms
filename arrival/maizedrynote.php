...
<title>Arrival-Transaction-Maize-Dried Seed- STRN</title>
...
$sql_tbl=mysqli_query($link,"select * from tblarrival where arrival_type='Maize Dry Arrival' and arrival_id='".$tid."'") or die(mysqli_error($link));
$row_tbl=mysqli_fetch_array($sql_tbl);
