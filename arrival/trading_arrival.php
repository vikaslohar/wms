...
//$a="c";
	//$a="c";
	$sql_code="SELECT MAX(arrival_code) FROM tblarrival where arrival_type='Trading'  ORDER BY arrival_code DESC";
...
<table align="center" border="1" width="950" cellspacing="0" cellpadding="0" bordercolor="#F1B01E"  style="border-collapse:collapse" > 
<tr class="Light" height="30">
<td align="right" width="230" valign="middle" class="tblheading" style="border-color:#F1B01E">&nbsp;Transport Name&nbsp;</td>
<td align="left"  valign="middle" class="tbltext" style="border-color:#F1B01E">&nbsp;<input name="txttname" type="text" size="25" class="tbltext" tabindex="" maxlength="25" />  &nbsp;<font color="#FF0000">*</font>&nbsp;</td>
<td width="155" align="right"  valign="middle" class="tblheading" style="border-color:#F1B01E">Lorry Receipt No.&nbsp;</td>
<td align="left" width="248" valign="middle" class="tbltext" colspan="3" style="border-color:#F1B01E">&nbsp;<input name="txtlrn" type="text" size="15" class="tbltext" tabindex=""  maxlength="15"/>&nbsp;</td>
</tr>

<tr class="Dark" height="25">
<td align="right" width="230" valign="middle" class="tblheading" style="border-color:#F1B01E">&nbsp;Vehicle No.&nbsp;</td>
<td align="left" width="307" valign="middle" class="tbltext"  style="border-color:#F1B01E">&nbsp;<input name="txtvn" type="text" size="12" class="tbltext" tabindex="" maxlength="12"  />&nbsp;<font color="#FF0000">*</font>&nbsp; </td>
...
<table  align="center" border="1" width="950" cellspacing="0" cellpadding="0" bordercolor="#F1B01E" style="border-collapse:collapse" > 
<tr class="Dark" height="30">
<td align="right" width="230" valign="middle" class="tblheading" style="border-color:#F1B01E">&nbsp;Courier Name&nbsp;</td>
<td align="left" width="308" valign="middle" class="tbltext" style="border-color:#F1B01E">&nbsp;<input name="txtcname" type="text" size="20" class="tbltext" tabindex=""  maxlength="20" />&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
<td align="right" width="153" valign="middle" class="tblheading" style="border-color:#F1B01E">&nbsp;Docket No.&nbsp;</td>
<td align="left" width="249" valign="middle" class="tbltext" colspan="3" style="border-color:#F1B01E">&nbsp;<input name="txtdc" type="text" size="15" class="tbltext" tabindex="" maxlength="15"   />&nbsp;<font color="#FF0000">*</font></td>
</tr>
</table></div>
<div id="byhand" style="display:none; width:850">
<table align="center" border="1" width="950" cellspacing="0" cellpadding="0" bordercolor="#F1B01E" style="border-collapse:collapse" > 
<tr class="Dark" height="30">
<td align="right" width="229" valign="middle" class="tblheading" style="border-color:#F1B01E">&nbsp;Name of Person&nbsp;</td>
<td width="715" colspan="8" align="left" valign="middle" class="tbltext" style="border-color:#F1B01E">&nbsp;<input name="txtpname" type="text" size="31" class="tbltext" tabindex=""  maxlength="30" />&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
</tr>
</table>
</div>
...
<td align="left" width="272" valign="middle" class="tbltext" style="border-color:#F1B01E">&nbsp;<input name="txtlot1" type="text" size="6" class="tbltext" tabindex=""  maxlength="6"  value="" onchange="ltchk(this.value);" readonly="true" style="background-color:#CCCCCC" onBlur="javascript:this.value=this.value.toUpperCase();">&nbsp;<font color="#FF0000">*</font>&nbsp;<a href="Javascript:void(0);" onclick="openslocpop();">Select</a></td>
