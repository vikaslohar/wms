<?php
	...
	if(isset($_POST['frm_action'])=='submit')
	{
		...
		if($sdate!="" && $edate!="")
		{
		echo "<script>window.location='add_arrival_stocktransfer11.php?sdate=$sdate&edate=$edate'</script>";
		}
		else
		 {?>
		 <script>
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#F1B01E" >
	  ...
	  <table width="820" border="0" cellpadding="0" cellspacing="0" bordercolor="#F1B01E" style="border-bottom:solid; border-bottom-color:#F1B01E" >
	    <tr >
	      <td width="820" height="25" class="Mainheading">&nbsp;Transaction - Arrival Pack Seed Stock Transfer - Plant</td>
	    </tr></table></td>
...
<tr class="Light" height="20">
  <td colspan="6" align="center" class="tblheading">Arrival Pack Seed Stock Transfer-Plant </td>
</tr>
</table>
<table align="center" border="1" cellspacing="0" cellpadding="0" width="970" bordercolor="#F1B01E" style="border-collapse:collapse">
            ...
            <tr class="tblsubtitle" height="20">
			 ...
			 <td width="9%" align="center" valign="middle" class="tblheading">Transaction Id</td>
              ...
              <td width="6%" align="center" valign="middle" class="tblheading">NoP</td>
              <td width="6%" align="center" valign="middle" class="tblheading">NoMP</td>
...
<tr class="Light">
         ...
         <td width="9%" align="center" valign="middle" class="smalltblheading"><a href="add_arrival_packstock_viewpage.php?cropid=<?php echo $row_arr_home['arrival_id'];?>"><?php echo "AS".$row_arr_home['arr_code']."/".$yearid_id."/".$lrole;?></a></td>
...
<tr >
<td valign="top" align="right"><a href="add_arrival_stocktransfer1.php"><img src="../images/back.gif" border="0"style="display:inline;cursor:Pointer;" /></a></td>
</tr>
</table>
