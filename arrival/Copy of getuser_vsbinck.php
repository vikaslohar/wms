...
/*$sql_ii=mysqli_query($link,"select * from tbl_stores where items_id='".$b."'")or die("Error:".mysqli_error($link));
...
/*$sql_tr=mysqli_query($link,"select * from tblarr_sloc where arr_tr_id='".$trid."' and crop_id!='".$class."' and subbin='".$a."'") or die(mysqli_error($link));
...
{
	$trflg=0;
	$sql_t=mysqli_query($link,"select * from tblarr_sloc where arr_tr_id='".$trid."' and classification_id='".$class."' and subbin='".$a."'") or die(mysqli_error($link));
...
/*if($tpmflg==0)
{
	...
	{
		$s_good=mysqli_query($link,"select distinct stlg_whid, stlg_subbinid, stlg_binid from tbl_stldg_good where stlg_subbinid='".$a."' and stlg_trclassid!='".$class."'") or die(mysqli_error($link));
		//$r_good=mysqli_fetch_array($s_good);
		$cnt=0;
		while($row_issueg=mysqli_fetch_array($s_good))
 	{ 
	$sql_issueg1=mysqli_query($link,"select max(stlg_id) from tbl_stldg_good where stlg_subbinid='".$row_issueg['stlg_subbinid']."' and stlg_binid='".$row_issueg['stlg_binid']."' and stlg_whid='".$row_issueg['stlg_whid']."'") or die(mysqli_error($link));
	$row_issueg1=mysqli_fetch_array($sql_issueg1); 
	
	$sql_issuetblg=mysqli_query($link,"select * from tbl_stldg_good where stlg_id='".$row_issueg1[0]."' and stlg_balqty > 0") or die(mysqli_error($link)); 
...
$s_good=mysqli_query($link,"select distinct stld_whid, stld_subbinid, stld_binid, stld_tritemid from tbl_stldg_damage where stld_subbinid='".$a."' and stld_trclassid!='".$class."' group by stld_subbinid, stld_tritemid order by stld_subbinid") or die(mysqli_error($link));
		...
		while($row_issueg=mysqli_fetch_array($s_good))
 { 
	$sql_issueg1=mysqli_query($link,"select max(stld_id) from tbl_stldg_damage where stld_subbinid='".$row_issueg['stld_subbinid']."' and stld_binid='".$row_issueg['stld_binid']."' and stld_whid='".$row_issueg['stld_whid']."' and stld_tritemid='".$row_issueg['stld_tritemid']."'") or die(mysqli_error($link));
	$row_issueg1=mysqli_fetch_array($sql_issueg1); 
	
	$sql_issuetblg=mysqli_query($link,"select * from tbl_stldg_damage where stld_id='".$row_issueg1[0]."' and stld_balqty > 0") or die(mysqli_error($link)); 
...
/*$sql_month=mysqli_query($link,"select * from tbl_stldg_damage where stld_subbinid='".$a."' and stld_trclassid!='".$class."'")or die("Error:".mysqli_error($link));
...
elseif(($tp=="Good") && ($typ=="Empty" || $typ=="Good"))
	{ 
		...
		$s_good=mysqli_query($link,"select distinct stld_whid, stld_subbinid, stld_binid from tbl_stldg_damage where stld_subbinid='".$a."' and stld_trclassid!='".$class."'") or die(mysqli_error($link));
		//$r_good=mysqli_fetch_array($s_good);
		$cnt=0;
while($row_issueg=mysqli_fetch_array($s_good))
{ 
	$sql_issueg1=mysqli_query($link,"select max(stld_id) from tbl_stldg_damage where stld_subbinid='".$row_issueg['stld_subbinid']."' and stld_binid='".$row_issueg['stld_binid']."' and stld_whid='".$row_issueg['stld_whid']."'") or die(mysqli_error($link));
	$row_issueg1=mysqli_fetch_array($sql_issueg1); 
	...
	$totno=mysqli_num_rows($sql_issuetblg);
		...
		while($row_issueg=mysqli_fetch_array($s_good))
 { 
	$sql_issueg1=mysqli_query($link,"select max(stlg_id) from tbl_stldg_good where stlg_subbinid='".$row_issueg['stlg_subbinid']."' and stlg_binid='".$row_issueg['stlg_binid']."' and stlg_whid='".$row_issueg['stlg_whid']."' and stlg_tritemid='".$row_issueg['stlg_tritemid']."'") or die(mysqli_error($link));
	$row_issueg1=mysqli_fetch_array($sql_issueg1);
...
/*			$sql_month=mysqli_query($link,"select * from tbl_stldg_good where stlg_subbinid='".$a."' and stlg_trclassid!='".$class."'")or die(mysqli_error($link));
			$row_month=mysqli_num_rows($sql_month); 
			$row_ccc=mysqli_fetch_array($sql_month);
			$itmid=$row_ccc['stlg_tritemid'];
		}
...
//echo $tpflg;
$sql_iiii=mysqli_query($link,"select * from tbl_stores where items_id='".$itmid."'")or die("Error:".mysqli_error($link));
