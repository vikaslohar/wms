...
winHandle=window.open('report_arrival2.php?sdate='+sdate+'&edate='+edate+'&typ='+typ,'WelCome','top=20,left=80,width=1000,height=900,scrollbars=yes');
if(winHandle==null){
...
$sql_variety=mysqli_query($link,"select * from tblvariety where popularname='".$row_arr_home['lotvariety']."' and actstatus='Active' and vertype='PV'") or die(mysqli_error($link));
...
$sql_variety=mysqli_query($link,"select * from tblvariety where varietyid='".$row_tbl_sub['lotvariety']."' and actstatus='Active' and vertype='PV'") or die(mysqli_error($link));
$row_variety=mysqli_fetch_array($sql_variety);
...
<tr >
<td align="center" valign="top"><a href="report_arrival.php"><img src="../images/back.gif" border="0"  style="display:inline;cursor:pointer;"/></a>&nbsp;&nbsp;<img src="../images/printpreview.gif" onclick="openprint()" style="cursor:pointer" border="0" />
