...
$sql_class13=mysqli_query($link,"select sum( qty ) from tblarrival_sub_unld where arrival_id='".$arrival_id."' ") or die(mysqli_error($link));
$row_class13=mysqli_fetch_array($sql_class13);

$sql_class15=mysqli_query($link,"select * from tblarrival_sub_unld where arrival_id='".$arrival_id."' ") or die(mysqli_error($link));
$row_class15=mysqli_fetch_array($sql_class15);
...
$logo="<img src='../help/vnrlogo17.jpg' width='57' align='middle' />";

$html=$html.'<table align="center" border="0" width="780" cellspacing="0" cellpadding="0" style="border-collapse:collapse" > 
<tr ><td align="center" valign="middle" width="50" class="Mainheading" rowspan="2" >';$html=$html.$logo;$html=$html.'</td><td align="center" class="Mainheading" style="font-size:14pt; color:#000000"><font size="+3" face="Verdana, Arial, Helvetica, sans-serif"><b>';$html=$html.$row_param['company_name'];$html=$html.'</b></font></td>
...
<tr class="Light" height="20">
<td align="right" width="187" valign="middle" class="tblheading">Production Grade&nbsp;</td>
<td align="left" valign="middle" class="tbltext" colspan="3">';$html=$html.$row_class15['prodgrade'];$html=$html.'</td>
</tr>
</table><br />';
...
<td align="center" valign="middle" class="smalltblheading" width="8%" colspan="2">SP Code</td>
 ...
 <td align="center" valign="middle" class="smalltblheading" width="1%" rowspan="2">Prod Grade</td>
...
{ 
$moist=''; $remarks='';
$sql_class=mysqli_query($link,"select grosswt from tblarrsub_sub_unld where arrival_id='".$arrival_id."' and arrsub_id='".$row_tbl_sub['arrsub_id']."' order by grosswt ASC ") or die(mysqli_error($link));
...
$prodgrade=$row_tbl_sub['prodgrade'];
...
<tr class="Light" height="20">
	 ...
	 $bagarray = array();
	 $sql_class2=mysqli_query($link,"select arrsubsub_id,grosswt from tblarrsub_sub_unld where arrival_id='".$arrival_id."' and arrsub_id='".$row_tbl_sub['arrsub_id']."' order by grosswt ASC LIMIT $start,$end") or die(mysqli_error($link));
...
$html=$html.'</table></td>
	 ...
	 <td align="center" valign="middle" class="smalltbltext" width="1%">';$html=$html.$prodgrade;$html=$html.'</td>
...
$html=$html.'<tr class="Light" height="20">
	...
	<td align="center" valign="middle" class="smalltbltext" width="1%"></td>
	<td align="center" valign="middle" class="tbltext" width="5%">';$html=$html.$remarks;$html=$html.'</td>
</tr></table>';
$html=$html.'<table align="center" border="0" width="1000" cellspacing="0" cellpadding="0" style="border-collapse:collapse" >
<tr class="Light" height="10">
<td width="127" align="right"  valign="middle" class="smalltbltext">&nbsp;<font color=RED>*</font>&nbsp;System generated report wherein weighment data is sorted in ascending order irrespective of its unloading sequence.&nbsp;</td>
</tr>
</table>';
$html=$html.'<table align="center" border="1" width="1000" cellspacing="0" cellpadding="0" style="border-collapse:collapse" >
<tr class="Light" height="20">
