...
function cleanData(&$str)
 ...
 $datatitle2 = array("","","","","","","","","","","PP","Moist %","","","");
	 $datatitle3 = array("#","Transaction ID","Arrived In","Arrived From","Crop","Variety","Lot No.","NoB","Qty","Stage"," Prel.QC","","QC Status"," Got Status", "SLOC");
...
if($tot_arr_home > 0)			
{
$data1[$d]=array($d,$transid,$loc1,$location,$crop,$variety,$lotno,$bags,$qty,$stage,$vk,$moist,$qc,$got1,$slocs); 
$d++;
}
}
}
