...
//$a="c";
	//$a="c";
	$sql_code="SELECT MAX(arrival_code) FROM tblarrival where arrival_type='Maize Dry Arrival' and plantcode='$plantcode'  ORDER BY arrival_code DESC";
		...
		if(mysqli_num_rows($res_code) > 0)
			{
				...
				$t_code=$row_code['0'];
				$code=$t_code+1;
			$code1="TAM".$code."/".$yearid_id."/".$lgnid;
		}
		else
		{
			$code=1;
...
<title>Arrival- Transaction -Fresh Arrival Maize-Dried Seed</title>
