...
?>
<tr class="tblsubtitle" height="20">
              <td width="32" align="center" valign="middle" class="tblheading" rowspan="2">#</td>
			    <td width="189" align="center" valign="middle" class="tblheading"rowspan="2" >Crop</td>
			    <td width="201" align="center" valign="middle" class="tblheading"rowspan="2" >Variety</td>
			   <td width="124" align="center" valign="middle" class="tblheading"rowspan="2" >Lot No.</td>
			   <td align="center" valign="middle" class="tblheading" colspan="2">Quantity</td>
			    <td width="82" align="center" valign="middle" class="tblheading"rowspan="2" >Stage</td>
		        <td width="82" align="center" valign="middle" class="tblheading"rowspan="2" >QC Status</td>
		        <td width="82" align="center" valign="middle" class="tblheading"rowspan="2" >DoT</td>
		        <td width="82" align="center" valign="middle" class="tblheading"rowspan="2" >PP</td>
		        <td width="82" align="center" valign="middle" class="tblheading"rowspan="2" >Moist %</td>
		        <td width="82" align="center" valign="middle" class="tblheading"rowspan="2" >Gemp %</td>
		        <td width="82" align="center" valign="middle" class="tblheading"rowspan="2" >GOT Status</td>
		        <td width="82" align="center" valign="middle" class="tblheading"rowspan="2" >DoGT</td>
			    <td width="95" align="center" valign="middle" class="tblheading"rowspan="2" >SLOC</td>
	      </tr>
