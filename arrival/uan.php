...
<title>Arrival-Transaction- Unidentified Arriva Note -UAN</title>
...
<table width="750" height="282" border="0" align="center" cellpadding="0" cellspacing="0" >
  ...
  <?php 
$tid=$itmid;
$sql_tbl=mysqli_query($link,"select * from tblarrival where arrival_type='Unidentified' and arrival_id='".$tid."'") or die(mysqli_error($link));
