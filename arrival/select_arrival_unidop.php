...
<title>Arrival - Transction Unidntified Arrival-Select output</title>
...
<?php
 $sql_tbl=mysqli_query($link,"select * from tbl_lot_ldg where lotldg_trtype='Unidentified' and lotldg_trid='".$pid."'") or die(mysqli_error($link));
?>
<table align="center" border="1" cellspacing="0" cellpadding="0" width="750" bordercolor="#F1B01E" style="border-collapse:collapse">
  <tr height="25" >
