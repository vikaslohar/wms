...
if($varid11!=$varid && $varid!='0' )$varid11=$varid; //echo $varid11;
...
{	
	...
	{	
		...
		{
			$asdf="select * from tblarrival_sub where arrival_id='".$trid."' and lotvariety='".$varid."' and spcodef='".$spcdf."' and spcodem='".$spcdm."' and arrsub_id='".$row_tr['arr_id']."'";
