...
$sub_ary="";
$sql_ar_sub=mysqli_query($link,"select distinct organiser from tblarrival_sub where arrival_id='".$arrival_id."' and plantcode='$plantcode'")or die(mysqli_error($link));
...
<?php
$sql_tbl_sub=mysqli_query($link,"select * from tblarrival_sub where arrival_id='".$arrival_id."' and organiser='".$roq_ar_sub['organiser']."' and plantcode='$plantcode'") or die(mysqli_error($link));
