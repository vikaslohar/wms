<?php
	...
	if(isset($_POST['frm_action'])=='Submit')
	{
			...
			$txtlot1=$pcode.$ycodee.$txtlot2."/".$stcode."/".$stcode2;
		//exit;	  	
...
<table align="center" border="1" cellspacing="0" cellpadding="0" width="574" bordercolor="#F1B01E" style="border-collapse:collapse">
  ...
  isNumberKey(event)"  /> <font size="+1"><b>/</b></font> <input name="stcode" type="text" size="4" class="tbltext" tabindex="0" maxlength="5" onkeypress="return isNumberKey(event)"  value="00000" /> <font size="+1"><b>/</b></font> <input name="stcode2" type="text" size="2" class="tbltext" tabindex="0" maxlength="2" onkeypress="return isNumberKey(event)"  value="00" />
	   </select>&nbsp;<font color="#FF0000">*</font>&nbsp;<!--<input name="txtlot1" type="text" size="15" class="tbltext" tabindex="0" maxlength="14"/>&nbsp;<font color="#FF0000">*</font>&nbsp;--></td></tr>
