...
$sql_subbinn=mysqli_query($link,"select sname from tbl_subbin where sid='".$row_tbl_sub['stlg_subbinid']."' and plantcode='$plantcode' and binid='".$bid."' and whid='".$whid."'") or die(mysqli_error($link));
