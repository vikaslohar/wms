...
?>
<?php
$sql_tbl=mysqli_query($link,"select * from tblarrival where arrival_type='StockTransfer Arrival' and arrival_id='".$tid."' and plantcode='$plantcode'") or die(mysqli_error($link));
