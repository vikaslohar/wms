...
$sql_tbl_sub=mysqli_query($link,"select * from tblarrival_sub_unld where arrsub_id='".$a."' ") or die(mysqli_error($link));
...
<td align="left"  valign="middle" class="tbltext" >&nbsp;<input name="gcode" type="text" size="2" class="tbltext" tabindex=""    maxlength="3" onchange="gichk(this.value);" value="<?php echo $row_tbl_sub['gi'];?>" onkeypress="return isNumberKey1(event)"/>&nbsp;</td>
...
<td align="left"  valign="middle" class="tbltext">&nbsp;<input name="txtdcnob" type="text" size="4" class="tbltext" tabindex=""    maxlength="3" onchange="bagschk1();" onkeypress="return isNumberKey1(event)" style="background-color:#CCCCCC" readonly="true" value="<?php echo $dcn;?>"/>&nbsp;<font color="#FF0000">*</font> </td>

<td align="left"  valign="middle" class="tblheading">&nbsp;<input name="txtactnob" type="text" size="4" class="tbltext" tabindex=""    maxlength="3" onchange="bagschk2(this.value);" onkeypress="return isNumberKey1(event)" style="background-color:#CCCCCC" readonly="true" value="<?php echo $acn;?>"/>&nbsp;<font color="#FF0000">*</font></td>
<td align="left"  valign="middle" class="tbltext">&nbsp;<input name="txtdiffnob" type="text" size="10" class="tbltext" tabindex=""    maxlength="10" style="background-color:#CCCCCC" readonly="true"  onkeypress="return isNumberKey1(event)" value="<?php echo $differencenob;?>"/>&nbsp;</td>
</tr>
<tr class="Light" height="30">
<td align="right"  valign="middle" class="tblheading">Quantitiy&nbsp;</td>
<td align="left"  valign="middle" class="tbltext">&nbsp;<input name="txtdcqty" type="text" size="10" class="tbltext" tabindex=""    maxlength="9" onchange="qtychk1();" onkeypress="return isNumberKey(event)" style="background-color:#CCCCCC" readonly="true" value="<?php echo $dcq;?>"/>&nbsp;<font color="#FF0000">*</font></td>

<td align="left"  valign="middle" class="tblheading">&nbsp;<input name="txtactqty" type="text" size="10" class="tbltext" tabindex=""    maxlength="9" onchange="qtychk2(this.value);" onkeypress="return isNumberKey(event)"  style="background-color:#CCCCCC" readonly="true"value="<?php echo $ac;?>"/>&nbsp;<font color="#FF0000">*</font>	</td>
<td align="left"  valign="middle" class="tbltext">&nbsp;<input name="txtdiffqty" type="text" size="10" class="tbltext" tabindex=""    maxlength="9" style="background-color:#CCCCCC" readonly="true" onkeypress="return isNumberKey(event)" value="<?php echo $differenceqty;?>" />&nbsp;</td>
</tr>
...
<option value=""  <?php if($row_tbl_sub['prodgrade']=="" || $row_tbl_sub['prodgrade']=="null"){ echo "Selected";} ?>>Select</option>
<option value="A" <?php if($row_tbl_sub['prodgrade']=="A"){ echo "Selected";} ?>>A</option>
<option value="B" <?php if($row_tbl_sub['prodgrade']=="B"){ echo "Selected";} ?>>B</option>
<option value="C" <?php if($row_tbl_sub['prodgrade']=="C"){ echo "Selected";} ?>>C</option>
<option value="D" <?php if($row_tbl_sub['prodgrade']=="D"){ echo "Selected";} ?>>D</option>
<option value="GOT" <?php if($row_tbl_sub['prodgrade']=="GOT"){ echo "Selected";} ?>>GOT</option>
<option value="NA" <?php if($row_tbl_sub['prodgrade']=="NA"){ echo "Selected";} ?>>NA</option>
</select>&nbsp;<font color="#FF0000">*</font></td>
</tr>
</table>
<table align="center" border="1" width="950" cellspacing="0" cellpadding="0" bordercolor="#F1B01E" style="border-collapse:collapse" >
...
//$ba=0;
//$up=0;
$sql_sub_sloc=mysqli_query($link,"select * from tblarr_sloc_unld where arr_id='".$a."' and plantcode='$plantcode' order by arrsloc_id") or die(mysqli_error($link));
$tot_sub_sloc=mysqli_num_rows($sql_sub_sloc);
/*$sql_sub_sloc1=mysqli_query($link,"select whid,binid,subbin from tblarr_sloc_unld where arr_id='".$rid."' and qty_good=0 and ups_good=0") or die(mysqli_error($link));
