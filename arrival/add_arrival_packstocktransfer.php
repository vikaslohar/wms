...
{	
	...
	{
		if(document.frmaddDepartment.arrnop.value=="")
		{
			alert("Please enter Expected NoP");
			document.frmaddDepartment.arrnop.focus();
			return false;
		}
		if(document.frmaddDepartment.lossnop.value=="")
		{
			alert("Please enter Loss NoP");
			document.frmaddDepartment.lossnop.focus();
			return false;
		}	
...
function chkbarcode1(mltval)
{
	...
	//alert(document.frmaddDepartment.brchflg.value);
...
function showpmode(mltval)
{
	...
	{
		showUser(mltval,'slocchk','slocchk1','','','','','','')
		mltval="'"+mltval+"'";
		//alert(mltval);
		setTimeout('showpmode('+mltval+')', 1500);
	}
...
function intrloss1()
{
	...
	{
		document.frmaddDepartment.txtlossnop.value=parseInt(document.frmaddDepartment.txtbalnop.value);
		document.frmaddDepartment.txtlossqty.value=parseInt(document.frmaddDepartment.txtbalqty.value);
		document.frmaddDepartment.txtbalnop.value=0;
		document.frmaddDepartment.txtbalqty.value=0;
	}
	if(document.frmaddDepartment.lossbook.value=="Yes-Partial")
...
function lossnopcal12(nop)
{	
	//alert(nop);
	//alert(cls);
	if(nop>document.frmaddDepartment.txtbalnop.value)
	{
		alert("Invalid NoP");
		document.frmaddDepartment.lossnop.value="";
		document.frmaddDepartment.lossnop.focus();
		return false;
	}
	...
	if(ups1[1]=="Kgs")
	{
		document.frmaddDepartment.lossqty.value = parseFloat(ups1[0]) * parseFloat(nop);
	}
	if(ups1[1]=="Gms")
	{
		document.frmaddDepartment.lossqty.value = parseFloat(ups1[0]/1000) * parseFloat(nop);
	}
			
	document.frmaddDepartment.txtbalnop.value = parseInt(document.frmaddDepartment.txtbalnop.value) - parseInt(nop);
	document.frmaddDepartment.txtbalqty.value = parseFloat(document.frmaddDepartment.txtbalqty.value) - parseFloat(document.frmaddDepartment.lossqty.value);
	if(parseInt(document.frmaddDepartment.txtbalnop.value)<=0)document.frmaddDepartment.txtbalnop.value=0;
	if(parseInt(document.frmaddDepartment.txtbalnomp.value)<=0)document.frmaddDepartment.txtbalnomp.value=0;
	if(parseFloat(document.frmaddDepartment.txtbalqty.value)<=0)document.frmaddDepartment.txtbalqty.value=0.000;
}
...
<td width="262"  align="left" valign="middle" class="tbltext">&nbsp;<?php echo $code1;?><input type="hidden" class="tbltext" name="transactionid" value="<?php echo $code1;?>" /><input type="hidden" class="tbltext" name="tcode" value="<?php echo $code;?>" /> </td>
...
<tr class="Light" height="20">
	...
	<td width="10%" align="left" valign="middle" class="smalltbltext" id="wh<?php echo $srno;?>">&nbsp;<select class="smalltbltext" id="txtwhg_<?php echo $srno?>" name="txtwhg_<?php echo $srno?>" style="width:70px;" onchange="wh(this.value,'<?php echo $srno?>');"  >
<option value="" selected>WH</option>
	...
	<td width="10%" align="left" valign="middle" class="smalltbltext" id="bin<?php echo $srno;?>">&nbsp;
...
<option value="" selected>Bin</option>
		...
		<td width="10%" align="left" valign="middle" class="smalltbltext" id="subbin<?php echo $srno;?>">&nbsp;
...
<option value="" selected>SubBin</option>
		...
		<td width="7%" align="center" valign="middle" class="smalltbltext">NEW SLOC</td>
</tr>
<?php 
/*if($arrlot=="")
	$arrlot=$lotno;
