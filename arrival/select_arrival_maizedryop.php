...
<title>Arrival - Transction-Maize-Dried Seed-Select output</title>
...
winHandle=window.open('maizedrynote.php?itmid='+itm,'WelCome','top=170,left=180,width=820,height=450,scrollbars=yes');
if(winHandle==null){
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" style="border-bottom:solid; border-bottom-color:#F1B01E" >
	    <tr >
	      <td width="813" height="25" class="Mainheading">&nbsp;Transaction: Arrival Maize-Dried Seed - Output Selection </td>
	    </tr></table></td>
	  </tr>
	  </table></td></tr>
...
<tr class="Light" height="25">
    ...
    <td align="center"  valign="middle" class="tblheading">&nbsp;<a href="Javascript:void(0)" onclick="openslocpopprint();">Maize-Dried Seed Receipt Note (MDSRN)</a></td>
</tr>
<!--<tr class="Light" height="25">
...
$sql_tbl=mysqli_query($link,"select * from tbl_lot_ldg where lotldg_trtype='Maize Dry Arrival' and lotldg_trid='".$pid."'") or die(mysqli_error($link));
/*$row_tbl=mysqli_fetch_array($sql_tbl);			
...
<tr >
<td valign="top" align="center"><a href="add_arrival_maizedry2.php"><img src="../images/back.gif" border="0"style="display:inline;cursor:Pointer;" /></a>&nbsp;&nbsp;&nbsp;</td>	
</tr>
</table>
