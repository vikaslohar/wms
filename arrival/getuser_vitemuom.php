...
$sql_issue=mysqli_query($link,"select * from tbl_stldg_good where stlg_tritemid='".$a."'") or die(mysqli_error($link));
$tot=mysqli_num_rows($sql_issue);
$sql_issue1=mysqli_query($link,"select * from tbl_stldg_damage where stld_tritemid='".$a."'") or die(mysqli_error($link));
