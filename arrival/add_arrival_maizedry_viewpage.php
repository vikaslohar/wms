  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#F1B01E" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#F1B01E" style="border-bottom:solid; border-bottom-color:#F1B01E" >
	    <tr >
	      <td width="813" height="25" class="Mainheading">&nbsp;Transaction - Arrival Maize-Dried Seed - View</td>
	    </tr></table></td>
...
?>
<?php
$sql_tbl=mysqli_query($link,"select * from tblarrival where arrival_type='Maize Dry Arrival' and arrival_id='".$tid."' and  plantcode='$plantcode'") or die(mysqli_error($link));
...
<tr class="tblsubtitle" height="20">
  <td colspan="6" align="center" class="tblheading"> Arrival Maize-Dried Seed - View </td>
</tr>
