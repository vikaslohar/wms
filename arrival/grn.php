...
<title>Arrival-Transaction Trading Arrival- GRN</title>
...
<table width="750" height="282" border="0" align="center" cellpadding="0" cellspacing="0" >
 ...
 <?php 
$tid=$pid;
$sql_tbl=mysqli_query($link,"select * from tblarrival where arrival_type='Trading' and arrival_id='".$tid."'") or die(mysqli_error($link));
...
<tr  height="20">
  <td colspan="6" align="center" class="Mainheading"><font color="#000000">Trading Seed Receipt Note - Internal (TRN-I)</font></td>
</tr>
</table><br />
...
//$quer3=mysqli_query($link,"SELECT cropid, cropname FROM tblcrop  order by cropname Asc"); 
?>
<td align="right" width="118" valign="middle" class="tblheading">&nbsp;Variety&nbsp;</td>
<td align="left" width="203" valign="middle" class="tbltext">&nbsp;<?php echo $row_tbl['lotvariety'];?></td>
</tr>
<tr class="Dark" height="30">
...
<td align="right" width="118" valign="middle" class="tblheading">No. of Lots&nbsp;</td>
<td align="left" width="203" valign="middle" class="tbltext">&nbsp;<?php echo $row_tbl['nolot'];?></td>
</tr>
<tr class="Light" height="30">
...
?>  
<tr class="Light" height="20">
    <td align="right" valign="middle" class="tblheading" colspan="3">Total&nbsp;&nbsp;</td>
