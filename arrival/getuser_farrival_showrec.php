...
$tot_arrsub=0;
$fg=0;
$sql_tbl_sub=mysqli_query($link,"select * from tblarrival_sub where old='".$a."' and plantcode='$plantcode'") or die(mysqli_error($link));
$tot_arrsub=mysqli_num_rows($sql_tbl_sub);

$lotqry=mysqli_query($link,"select * from tbllotimp where lotnumber='".$a."' and lottrtype='Fresh Seed with PDN' and plantcode='$plantcode'")or die (mysqli_error($link));
...
<td width="208" align="right" valign="middle" class="tblheading">Organiser&nbsp;</td>
<td align="left" valign="middle" class="tbltext" colspan="3">&nbsp;
  <input name="organi" type="text" size="30" class="tbltext" tabindex="0" readonly="true"  style="background-color:#CCCCCC" value="<?php echo $row['lotorganiser'];?>" maxlength="30"/>&nbsp;</td>
</tr>
...
<td align="left"  valign="middle" class="tbltext" >&nbsp;<input name="txtpdno" type="text" size="10" class="tbltext" tabindex=""    maxlength="10" onchange="pdchk();" onkeypress="return isNumberKey2(event)" readonly="true" style="background-color:#CCCCCC" value="<?php echo $row['pdnno'];?>"/><input type="hidden" name="productiontype" value="<?php echo $row['prodtype'];?>" /></td>
	<td width="249" align="right" valign="middle" class="tblheading">PDN Date&nbsp;</td>
    ...
    <input name="txtpdndate" id="edate" type="text" size="10" class="tbltext" tabindex="0" readonly="true" style="background-color:#CCCCCC" value="<?php echo $pdndate2;?>" /></td>
  </tr>
...
<td width="208" align="right" valign="middle" class="tblheading">Crop&nbsp;</td>
<td width="248"  align="left" valign="middle" class="tbltext">&nbsp;
  <input name="txtcrop" type="text" size="20" class="tbltext" tabindex="0" readonly="true"  style="background-color:#CCCCCC" value="<?php echo $row['lotcrop'];?>" maxlength="10"/>&nbsp;<input type="hidden" name="cid" value="<?php echo $lot;?>" /></td>

<td width="249" align="right" valign="middle" class="tblheading">Variety&nbsp;</td>
<td width="235" align="left" valign="middle" class="tbltext">&nbsp;
  <input name="txtvariety" type="text" size="30" class="tbltext" tabindex="0" readonly="true"  style="background-color:#CCCCCC" value="<?php echo $variety;?>" maxlength="10"/>&nbsp;<input type="hidden" name="vid" value="<?php echo $x;?>" /></td>
</tr>
...
<td align="left"  valign="middle" class="tbltext" >&nbsp;<input name="gcode" type="text" size="2" class="tbltext" tabindex=""    maxlength="3" onchange="gichk(this.value);" onkeypress="return isNumberKey1(event)"/></td>
	<td align="right"  valign="middle" class="tblheading"> Harvest Date&nbsp;</td>
    <td align="left"  valign="middle" class="tbltext">&nbsp;<input name="sdate" id="sdate" type="text" size="10" class="tbltext" tabindex="0" readonly="true"  value="" style="background-color:#EFEFEF" onchange="showledur(this.value)"  />&nbsp;<a href="javascript:void(0)" onClick="gidtchk('sdate');" tabindex="6"><img src="../images/cal.gif" alt="Calender" border="0" align="absmiddle"></a>&nbsp;<font color="#FF0000">*</font>&nbsp;<input type="hidden" name="ledurmth" value="<?php echo $dt;?>" /></td>
...
<td align="left"  valign="middle" class="tblheading">&nbsp;<input name="txtactqty" type="text" size="9" class="tbltext" tabindex=""    maxlength="9" onchange="qtychk2(this.value);" onkeypress="return isNumberKey(event)"/>&nbsp;<font color="#FF0000">*</font>	&nbsp;&nbsp;Tare Weight&nbsp;<input name="txttareqty" type="text" size="7" class="tbltext" tabindex=""    maxlength="9" onchange="qtychk3();" onkeypress="return isNumberKey(event)"/>&nbsp;<font color="#FF0000">*</font></td>
...
<!--<tr class="Light" height="30">
<td align="right"  valign="middle" class="tblheading">Tare Weight&nbsp;</td>
<td align="left"  valign="middle" class="tbltext">&nbsp;<input name="txttareqty" type="text" size="9" class="tbltext" tabindex=""    maxlength="9" onchange="qtychk3();" onkeypress="return isNumberKey(event)"/>&nbsp;<font color="#FF0000">*</font></td>

<td align="left"  valign="middle" class="tblheading">&nbsp;Net Wt&nbsp;<input name="txtnetqty" type="text" size="9" class="tbltext" tabindex=""    maxlength="9" onchange="qtychk4(this.value);" onkeypress="return isNumberKey(event)"/>&nbsp;<font color="#FF0000">*</font>	</td>
<td align="left"  valign="middle" class="tbltext">&nbsp;<input name="txtfindiffqty" type="text" size="10" class="tbltext" tabindex=""    maxlength="9" style="background-color:#CCCCCC" readonly="true" onkeypress="return isNumberKey(event)" />&nbsp;</td>
</tr>-->
<tr class="tblsubtitle" height="20">
...
<tr class="light" height="20">
  <td colspan="4" align="left" class="tblheading">&nbsp;4. Lot number Variety In-Active - First Activate then only Arrival can happen</td>
</tr>
</table>
<?php
}
