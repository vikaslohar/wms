...
//$a="c";
	//$a="c";
	$sql_code="SELECT MAX(arrival_code) FROM tblarrival where arrival_type='StockTransfer Arrival' and plantcode='$plantcode'  ORDER BY arrival_code DESC";
...
<title>Arrival- Transaction -Fresh Arrival Stock Transfer Plant</title>
...
<?php
$quer3=mysqli_query($link,"SELECT p_id, business_name FROM tbl_partymaser  where classification='Stock Transfer-Plant' AND stcode!='$plantcode'"); 
?>
