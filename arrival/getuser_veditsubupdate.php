...
{
$mainid=$z1;
  $sql_sub="update tblarrival_sub set sample='$sample',sstatus='$status',arrival_id='$mainid',lotno='$n',qty='$txtdcqty', act='$txtactqty', diff='$txtdiffqty', qty1='$txtdcnob', act1='$txtactnob', diff1='$txtdiffnob', moisture='$w',vchk='$x',qc='$qc',glotno='$lotno',lotoldlot='$oldlot',got='$got',got1='$gotstatus',lotcrop='$crop',lotvariety='$variety',remarks='$remarks1',sstage='$st' ,gssample='$gs1', leduration='$leduration', leupto='$ledate' where arrsub_id='$subtrid'";
if(mysqli_query($link,$sql_sub) or die(mysqli_error($link)))
{
 $subid=$subtrid;
