...
$sql_sbin=mysqli_query($link,"select * from tbl_subbin where sid='".$a."'")or die("Error:".mysqli_error($link));
...
$sql_tr_222=mysqli_query($link,"select * from tblarr_sloc_unld where subbin='".$a."' order by arrsloc_id desc") or die(mysqli_error($link));
...
//echo $varid11;
if($varid11!=$varid && $varid!='0' )$varid11=$varid; 
//echo "select * from tblarr_sloc_unld where arr_tr_id='".$trid."' and lotvariety!='".$varid11."' and subbin='".$a."'";
$sql_tr=mysqli_query($link,"select * from tblarr_sloc_unld where arr_tr_id='".$trid."' and lotvariety!='".$varid11."' and subbin='".$a."'") or die(mysqli_error($link));
...
{	
	...
	$sql_t=mysqli_query($link,"select * from tblarr_sloc_unld where arr_tr_id='".$trid."' and lotvariety='".$varid11."' and subbin='".$a."'") or die(mysqli_error($link));
	...
	{	
		...
		{
			$asdf="select * from tblarrival_sub_unld where arrival_id='".$trid."' and lotvariety='".$varid."' and spcodef='".$spcdf."' and spcodem='".$spcdm."' and arrsub_id='".$row_tr['arr_id']."'";
		...
		if($varid11==$varid)
			$sql_sb=mysqli_query($link,"select * from tblarrival_sub_unld where arrival_id='".$trid."' and lotvariety='".$varid11."' and arrsub_id='".$row_tr['arr_id']."'")or die(mysqli_error($link));
		else
			$sql_sb=mysqli_query($link,"select * from tblarrival_sub_unld where arrival_id='".$trid."' and lotvariety='".$varid."' and arrsub_id='".$row_tr['arr_id']."'")or die(mysqli_error($link));
...
if($tpmflg==0)
{
	...
	while($row_issueg=mysqli_fetch_array($s_good))
 	{ 
		$sql_lot=mysqli_query($link,"select distinct lotldg_lotno from tbl_lot_ldg where lotldg_subbinid='".$a."' and lotldg_variety='".$row_issueg['lotldg_variety']."'") or die(mysqli_error($link));
		while($row_lot=mysqli_fetch_array($sql_lot))
		{ 
			$sql_issueg1=mysqli_query($link,"select max(lotldg_id) from tbl_lot_ldg where lotldg_subbinid='".$a."' and lotldg_variety='".$row_issueg['lotldg_variety']."' and lotldg_lotno='".$row_lot['lotldg_lotno']."'") or die(mysqli_error($link));
...
$xcflg=0;
$s_good_new=mysqli_query($link,"select distinct lotldg_lotno from tbl_lot_ldg where lotldg_subbinid='".$a."'") or die(mysqli_error($link));
...
//echo $row_issueg_new['lotldg_lotno'];
	$sql_issueg1_new=mysqli_query($link,"select max(lotldg_id) from tbl_lot_ldg where lotldg_subbinid='".$a."' and lotldg_lotno='".$row_issueg_new['lotldg_lotno']."'") or die(mysqli_error($link));
...
if($tpmflg==0)
{
	...
	$sql_lot=mysqli_query($link,"select distinct lotno from tbl_lot_ldg_pack where subbinid='".$a."' and lotldg_variety='".$row_issueg['lotldg_variety']."'") or die(mysqli_error($link));
	while($row_lot=mysqli_fetch_array($sql_lot))
 	{ 
	
	$sql_issueg1=mysqli_query($link,"select max(lotdgp_id) from tbl_lot_ldg_pack where subbinid='".$a."' and lotldg_variety='".$row_issueg['lotldg_variety']."' and lotno='".$row_lot['lotno']."'") or die(mysqli_error($link));
	$row_issueg1=mysqli_fetch_array($sql_issueg1); 
	...
	$totno=mysqli_num_rows($sql_issuetblg);
		...
		{	
			$tpflg=1;
			$sql_issuetblg2=mysqli_query($link,"select * from tbl_lot_ldg_pack where lotdgp_id='".$sa."' and balqty > 0") or die(mysqli_error($link));  
...
$xcflg=0;
$s_good_new=mysqli_query($link,"select distinct lotno from tbl_lot_ldg_pack where subbinid='".$a."'") or die(mysqli_error($link));
$zx=mysqli_num_rows($s_good_new);
//$r_good_new=mysqli_fetch_array($s_good_new);
while($row_issueg_new=mysqli_fetch_array($s_good_new))
{

	$sql_issueg1_new=mysqli_query($link,"select max(lotdgp_id) from tbl_lot_ldg_pack where subbinid='".$a."' and lotno='".$row_issueg_new['lotno']."'") or die(mysqli_error($link));
	$row_issueg1_new=mysqli_fetch_array($sql_issueg1_new); 
	
	$sql_issuetblg_new=mysqli_query($link,"select * from tbl_lot_ldg_pack where lotdgp_id='".$row_issueg1_new[0]."' and balqty > 0") or die(mysqli_error($link)); 
	$totno_new=mysqli_num_rows($sql_issuetblg_new);
