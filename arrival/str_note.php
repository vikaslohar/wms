...
<tr  height="20">
  <td colspan="6" align="center" class="Mainheading"><font color="#000000">Stock Transfe Receive Note (STRN) </font></td>
</tr>
</table><br />
<table align="center" border="1" width="750" cellspacing="0" cellpadding="0" bordercolor="#4ea1e1" style="border-collapse:collapse" > 
 <tr class="Dark" height="20">
<td align="right"  valign="middle" class="tblheading"> Stock Rec Adv No. &nbsp;</td>
 <td align="left"  valign="middle" class="tbltext" colspan="5">&nbsp;<?php echo $row_tbl['tmode'];?></td>
</tr>
 <tr class="Dark" height="20">
<td width="187" align="right" valign="middle" class="tblheading">Date Of Transfer &nbsp;</td>
<td width="263"  align="left" valign="middle" class="tbltext">&nbsp;<?php echo $tdate;?></td>

<td width="121" align="right" valign="middle" class="tblheading">&nbsp;Date Of Receipt&nbsp;</td>
...
?>
<tr class="Dark" height="20">
<td width="187" align="right" valign="middle" class="tblheading">Transfer From Plant &nbsp;</td>
<td width="263"  align="left" valign="middle" class="tbltext">&nbsp;<?php echo $tdate;?></td>

<td width="121" align="right" valign="middle" class="tblheading">&nbsp;Transfer to Plant&nbsp;</td>
<td width="219" colspan="3" align="left" valign="middle" class="tbltext">&nbsp;<?php echo "AV".$row_tbl['arr_code']."/".$yearid_id."/".$row_tbl['ncode'];?></td>
</tr>
<tr class="Dark" height="20">
<td width="187" align="right" valign="middle" class="tblheading">Crop &nbsp;</td>
<td width="263"  align="left" valign="middle" class="tbltext">&nbsp;<?php echo $tdate;?></td>

<td width="121" align="right" valign="middle" class="tblheading">&nbsp;Variety&nbsp;</td>
<td width="219" colspan="3" align="left" valign="middle" class="tbltext">&nbsp;<?php echo "AV".$row_tbl['arr_code']."/".$yearid_id."/".$row_tbl['ncode'];?></td>
</tr>
<tr class="Dark" height="20">
<td width="187" align="right" valign="middle" class="tblheading">Stage&nbsp;</td>
<td width="263"  align="left" valign="middle" class="tbltext">&nbsp;<?php echo $tdate;?></td>

<td width="121" align="right" valign="middle" class="tblheading">&nbsp;STN Ref No.&nbsp;</td>
<td width="219" colspan="3" align="left" valign="middle" class="tbltext">&nbsp;<?php echo "AV".$row_tbl['arr_code']."/".$yearid_id."/".$row_tbl['ncode'];?></td>
</tr>
<?php /*
...
<td align="right"  valign="middle" class="tblheading">Docket./Lorry No. &nbsp;</td>
...
<td align="right" width="187" valign="middle" class="tblheading">&nbsp;MS.&nbsp;</td>
...
?>
			<tr class="tblsubtitle" height="20">
			 ...
			 <td width="14%" align="center" rowspan="3" valign="middle" class="tblheading">Crop</td>
              <td width="19%" rowspan="3" align="center" valign="middle" class="tblheading">PDN No. </td>
                <td rowspan="3"  align="center" valign="middle" class="tblheading">Lot No </td>
          </tr>
			<tr class="tblsubtitle">
                    <td colspan="2" align="center" valign="middle" class="tblheading">As PerDC</td>
