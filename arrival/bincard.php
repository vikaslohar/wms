...
<title>Arrival - Transction-Bin status card</title>
...
$tid=$pid;
$sql_tbl=mysqli_query($link,"select * from tblarrival where arr_role='".$logid."' and arrival_type='$tp' and arrival_id='".$tid."' and plantcode='$plantcode'") or die(mysqli_error($link));
...
{ 
$sql_class=mysqli_query($link,"select * from tbl_classification where classification_id='".$row_tbl_sub['classification_id']."' and plantcode='$plantcode'") or die(mysqli_error($link));
$row_class=mysqli_fetch_array($sql_class);

$sql_item=mysqli_query($link,"select * from tbl_stores where items_id='".$row_tbl_sub['item_id']."' and plantcode='$plantcode'") or die(mysqli_error($link));
