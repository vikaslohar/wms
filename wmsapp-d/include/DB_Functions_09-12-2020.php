...
//	private $conn_vnr;
	...
	public function GetTrList($scode) {
        $stmt = $this->conn_ps->prepare("SELECT arrival_id, arrival_code, disp_date, arrsetupflag, setuplogid, arrunldflag, unldlogid, arrtrflag, logid FROM tblarrival_unld WHERE arrtrflag!=1");
        //$stmt->bind_param("ss", $email, $password);
        $stmt->execute();
        $stmt->store_result();
							...
							//return "SELECT arr_type, arr_tr_id, arr_id, whid, binid, subbin, rowid, qty, bags, balqty, balbags, lotcrop, lotvariety FROM tblarr_sloc_unld WHERE arr_tr_id = $trid AND arr_id = $arrsub_id ";
								...
								while($stmt_arsubsub->fetch())
								{
									...
									{  
										...
										$stmt_lotldg->bind_param("sssisssiiiisisisssisssssisis", $yearcode, $lotno, $trtype, $artrid, $arrival_date, $lotcrop, $lotvariety, $whid, $binid, $subbin, $zero, $zero1, $bags, $qty, $balbags, $balqty, $stage, $moisture, $gemp, $vchk, $qc, $got, $sstatus, $orlot, $gssample, $got1, $leduration, $leupto);
								...
								if($qc=="UT")
								{
									...
									$sql_sub_sub1244->bind_param("ssssssssssssss", $vchk, $moisture, $lotno, $arrival_date, $lotcrop, $lotvariety, $ncode1, $stage, $qc, $state,$one ,$orlot, $yearcode, $arr_role);
								...
								if($got1=="UT")
								{
									...
									$sql_sub_sub1245->bind_param("ssssssssss", $got1, $lotno, $arrival_date, $lotcrop, $lotvariety, $ncode1, $stage, $orlot, $yearcode, $arr_role);
