...
if (isset($_REQUEST['mobile1'])) {
	...
	$user_login = $db->GetSampleMoistUpdate($sampleno,$hmtype, $m1rep1, $m1rep2, $m1rep3, $m1rep4, $m2rep1,$m2rep2, $m2rep3, $m2rep4, $m3rep1, $m3rep2, $m3rep3, $m3rep4, $rep1moistper, $rep2moistper, $rep3moistper, $rep4moistper, $haommoistper, $mmrep1, $mmrep2, $mmrep3, $mmrmoistper, $scode);//, $oprid);
