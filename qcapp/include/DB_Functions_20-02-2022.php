...
public function GetSampleGempInfo($sampleno) {
	...
	public function GetGempSetupUpdate($sampleno, $testtype, $sgtnorep, $fgtnorep, $fgtmtype, $docsrefno) {
        ...
        if ($stmt->num_rows > 0) {
			...
			if ($stmtsamp->num_rows == 0) 
			{
				...
				$stmt_samp->bind_param("sssssssisi", $sampleno, $testtype, $seedsize, $nosior, $sgtnorep, $fgtmtype, $fgtnorep, $one, $sdt, $nosiorfgt, $docsrefno);
				$result_samp=$stmt_samp->execute();
				if($result_samp){$flg++;}
				$stmt_samp->close();
			}
        ...
        if ($stmt->num_rows > 0) {
			...
			if ($stmtsamp->num_rows > 0) 
			{
				...
				if($testtype=="Standard Germination Test")
				{
					...
					{
						$stmt_samp = $this->conn_ps->prepare("UPDATE tbl_qcgdata SET qcg_sgtnormal1=?, qcg_sgtnormal2=?, qcg_sgtnormal3=?, qcg_sgtnormal4=?, qcg_sgtnormal5=?, qcg_sgtnormal6=?, qcg_sgtnormal7=?, qcg_sgtnormal8=?, qcg_sgtnormalavg=?, qcg_sgtabnormal1=?, qcg_sgtabnormal2=?, qcg_sgtabnormal3=?, qcg_sgtabnormal4=?, qcg_sgtabnormal5=?, qcg_sgtabnormal6=?, qcg_sgtabnormal7=?, qcg_sgtabnormal8=?, qcg_sgtabnormalavg=?, qcg_sgthardfug1=?, qcg_sgthardfug2=?, qcg_sgthardfug3=?, qcg_sgthardfug4=?, qcg_sgthardfug5=?, qcg_sgthardfug6=?, qcg_sgthardfug7=?, qcg_sgthardfug8=?, qcg_sgthardfugavg=?, qcg_sgtdead1=?, qcg_sgtdead2=?, qcg_sgtdead3=?, qcg_sgtdead4=?, qcg_sgtdead5=?, qcg_sgtdead6=?, qcg_sgtdead7=?, qcg_sgtdead8=?, qcg_sgtdeadavg=?, qcg_sgtlogid=?, qcg_sgtdt=?, qcg_sgtgermp=?, qcg_sgtflg=?, qcg_sgtvremark=?, qcg_oprremark=?, qcg_germpflg=?, qcg_germpdatadt=? where qcg_sampleno=?  and qcg_germpflg!=1");
						$stmt_samp->bind_param("iiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiissiississ", $sgtnormal1, $sgtnormal2, $sgtnormal3, $sgtnormal4, $sgtnormal5, $sgtnormal6, $sgtnormal7, $sgtnormal8, $sgtnormalavg, $sgtabnormal1, $sgtabnormal2, $sgtabnormal3, $sgtabnormal4, $sgtabnormal5, $sgtabnormal6, $sgtabnormal7, $sgtabnormal8, $sgtabnormalavg, $sgthardfug1, $sgthardfug2, $sgthardfug3, $sgthardfug4, $sgthardfug5, $sgthardfug6, $sgthardfug7, $sgthardfug8, $sgthardfugavg, $sgtdead1, $sgtdead2, $sgtdead3, $sgtdead4, $sgtdead5, $sgtdead6, $sgtdead7, $sgtdead8, $sgtdeadavg, $scode, $sgtdt, $sgtgermp, $one, $sgtvremark, $oprremark, $two, $fdt, $sampleno);
						$result_samp=$stmt_samp->execute();
						if($result_samp){$flg++;}
						$stmt_samp->close();
					}
				...
				if($testtype=="Field Germination Test")
				{
					...
					{
						$stmt_samp = $this->conn_ps->prepare("UPDATE tbl_qcgdata SET qcg_vigtesttype=?, qcg_vignormal1=?, qcg_vignormal2=?, qcg_vignormal3=?, qcg_vignormal4=?, qcg_vignormal5=?, qcg_vignormal6=?, qcg_vignormal7=?, qcg_vignormal8=?, qcg_vignormalavg=?, qcg_vigabnormal1=?, qcg_vigabnormal2=?, qcg_vigabnormal3=?, qcg_vigabnormal4=?, qcg_vigabnormal5=?, qcg_vigabnormal6=?, qcg_vigabnormal7=?, qcg_vigabnormal8=?, qcg_vigabnormalavg=?, qcg_vigdead1=?, qcg_vigdead2=?, qcg_vigdead3=?, qcg_vigdead4=?, qcg_vigdead5=?, qcg_vigdead6=?, qcg_vigdead7=?, qcg_vigdead8=?, qcg_vigdeadavg=?, qcg_viglogid=?, qcg_vigdt=?, qcg_viggermp=?, qcg_vigflg=?, qcg_vigvremark=?, qcg_oprremark=?, qcg_germpflg=?, qcg_germpdatadt=? where qcg_sampleno=?  and qcg_germpflg!=1");
						$stmt_samp->bind_param("siiiiiiiiiiiiiiiiiiiiiiiiiiissiississ", $fgtmtype, $fgtnormal1, $fgtnormal2, $fgtnormal3, $fgtnormal4, $fgtnormal5, $fgtnormal6, $fgtnormal7, $fgtnormal8, $fgtnormalavg, $fgtabnormal1, $fgtabnormal2, $fgtabnormal3, $fgtabnormal4, $fgtabnormal5, $fgtabnormal6, $fgtabnormal7, $fgtabnormal8, $fgtabnormalavg, $fgtdead1, $fgtdead2, $fgtdead3, $fgtdead4, $fgtdead5, $fgtdead6, $fgtdead7, $fgtdead8, $fgtdeadavg, $scode, $fgtdt, $fgtgermp, $one, $fgtvremark, $oprremark, $two, $fdt, $sampleno);
						$result_samp=$stmt_samp->execute();
						if($result_samp){$flg++;}
						$stmt_samp->close();
					}
	...
	public function GetSampleDataInfoGot($sampleno) {
        ...
        if ($stmt->num_rows > 0) {
			...
			$stmtgsampack1->close();
			$fmvarray=array();
			$gotsow_dosow=''; $gotsow_nurplotno=''; $gotsow_noofseeds=''; $gotsow_sptype=''; $gotsow_state=''; $gotsow_loc=''; $gotsow_noofcellstray=''; $gotsow_nooftraylot=''; $gotsow_bedno=''; $gotsow_direction=''; $gotsow_noofrows=''; $gotsow_noofplants=''; $gottransp_date=''; $gottransp_state=''; $gottransp_loc=''; $gottransp_plotno=''; $gottransp_bedno=''; $gottransp_direction=''; $gottransp_noofrows=''; $gottransp_range=''; $gottransp_noofplants='';
			if($gotm_id>0)
			{
				$stmtgsow = $this->conn_ps->prepare("SELECT gotsow_dosow, gotsow_nurplotno, gotsow_noofseeds, gotsow_sptype, gotsow_state, gotsow_loc, gotsow_noofcellstray, gotsow_nooftraylot, gotsow_bedno, gotsow_direction, gotsow_noofrows, gotsow_noofplants FROM tbl_qcgotsowing WHERE gotm_id = ? ");
				$stmtgsow->bind_param("i", $gotm_id);
				$resultgsow=$stmtgsow->execute();
				$stmtgsow->store_result();
				if ($stmtgsow->num_rows > 0) 
				{
					$stmtgsow->bind_result($gotsow_dosow, $gotsow_nurplotno, $gotsow_noofseeds, $gotsow_sptype, $gotsow_state, $gotsow_loc, $gotsow_noofcellstray, $gotsow_nooftraylot, $gotsow_bedno, $gotsow_direction, $gotsow_noofrows, $gotsow_noofplants);
					//looping through all the records 
					$stmtgsow->fetch();
				}	
				$stmtgsow->close();
	...
	public function GetGoTSowingUpdate($sampleno, $dosow, $sow_nurplotno, $sow_noofseeds, $sow_sptype, $scode, $sow_state, $sow_loc, $sow_noofcellstray, $sow_nooftraylot, $sow_bedno, $sow_direction, $sow_noofrows, $sow_noofplants, $sow_nurrangeno) {
		$samno=str_split($sampleno);
		$sampno=$samno[2].$samno[3].$samno[4].$samno[5].$samno[6].$samno[7];
		$plantid=$samno[0];
		$yearid=$samno[1];
        ...
        if ($stmt->num_rows > 0) {
			...
			if($gotm_id>0)
			{
				...
				if ($stmtsamp->num_rows == 0) 
				{
					$stmt_samp = $this->conn_ps->prepare("Insert into tbl_qcgotsowing (gotm_id, gotsow_dosow, gotsow_nurplotno, gotsow_noofseeds, gotsow_sptype, gotsow_state, gotsow_loc, gotsow_noofcellstray, gotsow_nooftraylot, gotsow_bedno, gotsow_direction, gotsow_noofrows, gotsow_noofplants, gotsow_range) values(?,?,?,?,?,?,?,?,?,?,?,?,?,?) ");
					$stmt_samp->bind_param("ississsiissiis", $gotm_id, $dosow, $sow_nurplotno, $sow_noofseeds, $sow_sptype, $sow_state, $sow_loc, $sow_noofcellstray, $sow_nooftraylot, $sow_bedno, $sow_direction, $sow_noofrows, $sow_noofplants, $sow_nurrangeno);
					$result_samp=$stmt_samp->execute();
					if($result_samp){
	...
	public function GetGoTFMVUpdate($sampleno, $fmvdate, $fmv_crophealth, $fmv_reasons, $fmv_noofplants, $scode) {
		$samno=str_split($sampleno);
		$sampno=$samno[2].$samno[3].$samno[4].$samno[5].$samno[6].$samno[7];
		$plantid=$samno[0];
		$yearid=$samno[1];
        ...
        if ($stmt->num_rows > 0) {
			...
			if($gotm_id>0)
			{
				...
				//if ($stmtsamp->num_rows == 0) 
				{
					$stmt_samp = $this->conn_ps->prepare("Insert into tbl_qcgotfmv (gotm_id, gotfmv_date, gotfmv_crophealth, gotfmv_reasons, gotfmv_noofplants) values(?,?,?,?,?) ");
					$stmt_samp->bind_param("isssi", $gotm_id, $fmvdate, $fmv_crophealth, $fmv_reasons, $fmv_noofplants);
					$result_samp=$stmt_samp->execute();
					if($result_samp){
						$one=1; $two=2; $tplflg=0;
