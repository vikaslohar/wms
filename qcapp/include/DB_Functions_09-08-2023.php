...
//return "srf no2 ".$srf_tcode;
	...
	//return "INSERT INTO tbl_qcsrf (srf_date, srf_tcode, srf_code, srf_srfno, srf_tid, srf_lotno, srf_orlot, srf_sampleno, srf_logid, srf_yrcode, srf_year) VALUES ('$dt2','$srf_tcode','$srf_code','$srfno','$tid','$lotno','$oldlot','$sampleno','$scode','$ycode','$baryrcode') ";
					...
					if($qflg>0)
					{
						$stmt_crop = $this->conn_ps->prepare("UPDATE tbl_qctest SET spdate=?, sampcldate=?, sampclrole=?, bflg=?, cflg=?, qcrefno=? WHERE tid = ? ");
						$stmt_crop->bind_param("sssiisi", $smpdate, $dt, $scode, $one, $one, $srfno, $tid);
						$result_crop=$stmt_crop->execute();
						if($result_crop)
						{
							$flg=1;
	...
	public function GetSampleMoisFinalSubmit($sampleno, $scode, $new_retImageString_ret, $type, $remarks) {
		$samno=str_split($sampleno);
		$sampno=$samno[2].$samno[3].$samno[4].$samno[5].$samno[6].$samno[7];
		$plantid=$samno[0];
		$yearid=$samno[1];
        ...
        if ($stmt->num_rows > 0) {
			...
			while($stmt->fetch())
			{
				...
				if ($stmtsamp->num_rows > 0) 
				{
					...
					if($type=="MM")
					{
						$stmt_crop = $this->conn_ps->prepare("UPDATE tbl_qcmdata SET qcm_haomflg=?, qcm_mmrflg=?, qcm_moistflg=?, qcm_moistphoto=?, qcm_mmremarks=? WHERE qcm_sampno = ? ");
					}
					else
					{
						$stmt_crop = $this->conn_ps->prepare("UPDATE tbl_qcmdata SET qcm_haomflg=?, qcm_mmrflg=?, qcm_moistflg=?, qcm_hmoistphoto=?, qcm_hmremarks=? WHERE qcm_sampno = ? ");
					}
					$stmt_crop->bind_param("iiisss", $haoflg, $mmrflg, $two, $new_retImageString_ret, $remarks, $sampleno);
					$result_crop=$stmt_crop->execute();
					if($result_crop)
					{
						$flg=1;
        ...
        if ($stmt->num_rows > 0) {
			...
			if ($stmtsamp->num_rows > 0) 
			{
				...
				if($testtype=="SGT")
				{
					...
					{
						$stmt_samp = $this->conn_ps->prepare("UPDATE tbl_qcgdata SET qcg_sgtoobnormal1=?, qcg_sgtoobnormal2=?, qcg_sgtoobnormal3=?, qcg_sgtoobnormal4=?, qcg_sgtoobnormal5=?, qcg_sgtoobnormal6=?, qcg_sgtoobnormal7=?, qcg_sgtoobnormal8=?, qcg_sgtoobnormalavg=?, qcg_sgtoobnormaldt=?, qcg_sgtoobnormallogid=?, qcg_sgtoneobflg=?, qcg_sgtfcremark=?, qcg_sgtfcimage=? where qcg_sampleno=?  and qcg_germpflg!=1 and qcg_retestflg=0");
						$stmt_samp->bind_param("iiiiiiiiississs", $sgtoobnormal1, $sgtoobnormal2, $sgtoobnormal3, $sgtoobnormal4, $sgtoobnormal5, $sgtoobnormal6, $sgtoobnormal7, $sgtoobnormal8, $sgtoobnormalavg, $sgtoobnormaldt, $scode, $one, $remarks, $new_retImageString_ret, $sampleno);
						$result_samp=$stmt_samp->execute();
						if($result_samp){$flg++;}
						$stmt_samp->close();
					}
					...
					{
						$stmt_samp = $this->conn_ps->prepare("UPDATE tbl_qcgdata SET qcg_sgtnormal1=?, qcg_sgtnormal2=?, qcg_sgtnormal3=?, qcg_sgtnormal4=?, qcg_sgtnormal5=?, qcg_sgtnormal6=?, qcg_sgtnormal7=?, qcg_sgtnormal8=?, qcg_sgtnormalavg=?, qcg_sgtabnormal1=?, qcg_sgtabnormal2=?, qcg_sgtabnormal3=?, qcg_sgtabnormal4=?, qcg_sgtabnormal5=?, qcg_sgtabnormal6=?, qcg_sgtabnormal7=?, qcg_sgtabnormal8=?, qcg_sgtabnormalavg=?, qcg_sgthardfug1=?, qcg_sgthardfug2=?, qcg_sgthardfug3=?, qcg_sgthardfug4=?, qcg_sgthardfug5=?, qcg_sgthardfug6=?, qcg_sgthardfug7=?, qcg_sgthardfug8=?, qcg_sgthardfugavg=?, qcg_sgtdead1=?, qcg_sgtdead2=?, qcg_sgtdead3=?, qcg_sgtdead4=?, qcg_sgtdead5=?, qcg_sgtdead6=?, qcg_sgtdead7=?, qcg_sgtdead8=?, qcg_sgtdeadavg=?, qcg_sgtlogid=?, qcg_sgtdt=?, qcg_sgtgermp=?, qcg_sgtflg=?, qcg_sgtvremark=?, qcg_oprremark=?, qcg_germpflg=?, qcg_germpdatadt=?, qcg_sgtremark=?, qcg_sgtimage=? where qcg_sampleno=?  and qcg_germpflg!=1 and qcg_retestflg=0");
						$stmt_samp->bind_param("iiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiissiississss", $sgtnormal1, $sgtnormal2, $sgtnormal3, $sgtnormal4, $sgtnormal5, $sgtnormal6, $sgtnormal7, $sgtnormal8, $sgtnormalavg, $sgtabnormal1, $sgtabnormal2, $sgtabnormal3, $sgtabnormal4, $sgtabnormal5, $sgtabnormal6, $sgtabnormal7, $sgtabnormal8, $sgtabnormalavg, $sgthardfug1, $sgthardfug2, $sgthardfug3, $sgthardfug4, $sgthardfug5, $sgthardfug6, $sgthardfug7, $sgthardfug8, $sgthardfugavg, $sgtdead1, $sgtdead2, $sgtdead3, $sgtdead4, $sgtdead5, $sgtdead6, $sgtdead7, $sgtdead8, $sgtdeadavg, $scode, $sgtdt, $sgtgermp, $one, $sgtvremark, $oprremark, $two, $fdt, $remarks, $new_retImageString_ret, $sampleno);
						$result_samp=$stmt_samp->execute();
						if($result_samp){$flg++;}
						$stmt_samp->close();
					}
				...
				if($testtype=="FGT")
				{
					...
					{
						$stmt_samp = $this->conn_ps->prepare("UPDATE tbl_qcgdata SET qcg_vigtesttype=?, qcg_vigoobnormal1=?, qcg_vigoobnormal2=?, qcg_vigoobnormal3=?, qcg_vigoobnormal4=?, qcg_vigoobnormal5=?, qcg_vigoobnormal6=?, qcg_vigoobnormal7=?, qcg_vigoobnormal8=?, qcg_vigoobnormalavg=?, qcg_vigoobnormaldt=?, qcg_vigoobnormallogid=?, qcg_vigoneobflg=?, qcg_fgtfcremark=?, qcg_fgtfcimage=? where qcg_sampleno=?  and qcg_germpflg!=1 and qcg_retestflg=0");
						$stmt_samp->bind_param("siiiiiiiiississs", $fgtmtype, $fgtoobnormal1, $fgtoobnormal2, $fgtoobnormal3, $fgtoobnormal4, $fgtoobnormal5, $fgtoobnormal6, $fgtoobnormal7, $fgtoobnormal8, $fgtoobnormalavg, $fgtoobnormaldt, $scode, $one, $remarks, $new_retImageString_ret, $sampleno);
						$result_samp=$stmt_samp->execute();
						if($result_samp){$flg++;}
						$stmt_samp->close();
					}
					...
					{
						$stmt_samp = $this->conn_ps->prepare("UPDATE tbl_qcgdata SET qcg_vigtesttype=?, qcg_vignormal1=?, qcg_vignormal2=?, qcg_vignormal3=?, qcg_vignormal4=?, qcg_vignormal5=?, qcg_vignormal6=?, qcg_vignormal7=?, qcg_vignormal8=?, qcg_vignormalavg=?, qcg_vigabnormal1=?, qcg_vigabnormal2=?, qcg_vigabnormal3=?, qcg_vigabnormal4=?, qcg_vigabnormal5=?, qcg_vigabnormal6=?, qcg_vigabnormal7=?, qcg_vigabnormal8=?, qcg_vigabnormalavg=?, qcg_vigdead1=?, qcg_vigdead2=?, qcg_vigdead3=?, qcg_vigdead4=?, qcg_vigdead5=?, qcg_vigdead6=?, qcg_vigdead7=?, qcg_vigdead8=?, qcg_vigdeadavg=?, qcg_viglogid=?, qcg_vigdt=?, qcg_viggermp=?, qcg_vigflg=?, qcg_vigvremark=?, qcg_fgtoprremark=?, qcg_germpflg=?, qcg_germpdatadt=?, qcg_fgtremark=?, qcg_fgtimage=?  where qcg_sampleno=?  and qcg_germpflg!=1 and qcg_retestflg=0");
						$stmt_samp->bind_param("siiiiiiiiiiiiiiiiiiiiiiiiiiissiississss", $fgtmtype, $fgtnormal1, $fgtnormal2, $fgtnormal3, $fgtnormal4, $fgtnormal5, $fgtnormal6, $fgtnormal7, $fgtnormal8, $fgtnormalavg, $fgtabnormal1, $fgtabnormal2, $fgtabnormal3, $fgtabnormal4, $fgtabnormal5, $fgtabnormal6, $fgtabnormal7, $fgtabnormal8, $fgtabnormalavg, $fgtdead1, $fgtdead2, $fgtdead3, $fgtdead4, $fgtdead5, $fgtdead6, $fgtdead7, $fgtdead8, $fgtdeadavg, $scode, $fgtdt, $fgtgermp, $one, $fgtvremark, $oprremark, $two, $fdt, $remarks, $new_retImageString_ret, $sampleno);
						$result_samp=$stmt_samp->execute();
						if($result_samp){$flg++;}
						$stmt_samp->close();
					}
